...
## Russian Roulette Onchain

A simple Russian Roulette game utilizing ORAO VRF to decide the outcome when you pull that trigger.
Complete onchain program and game client source code available.

- [Tutorial](https://github.com/orao-network/solana-vrf/tree/master/rust/examples/cpi)
- [Source](https://github.com/orao-network/solana-vrf/tree/master/rust/examples/cpi)
