...
Compressed NFTs use [State Compression](/docs/advanced/state-compression) and
[merkle trees](/docs/advanced/state-compression#what-is-a-merkle-tree) to
...
[ledger](/docs/terminology#ledger), instead of in traditional
[accounts](/docs/terminology#account) like uncompressed NFTs, we will need to
...
- create a
  [concurrent merkle tree](/docs/advanced/state-compression#what-is-a-concurrent-merkle-tree)
...
[State Compression](/docs/advanced/state-compression) or
...
[how to setup your tree](/docs/advanced/state-compression#sizing-a-concurrent-merkle-tree).
...
> [State Compression](/docs/advanced/state-compression), including
> [how to size a tree](/docs/advanced/state-compression#sizing-a-concurrent-merkle-tree)
...
[Keypair](/docs/terminology#keypair) address for the tree to have:
...
> [concurrent merkle trees](/docs/advanced/state-compression#what-is-a-concurrent-merkle-tree)
...
> [address/public key](/docs/terminology#public-key-pubkey), they are not
> addresses.
...
- remove the proof values that are already stored on-chain in the
  [tree's canopy](/docs/advanced/state-compression#canopy-depth), and
