...
Below is the transaction details for a transaction including a single token
...
- Sender (wallet): `4fvXFPXSL9i7VbiRzoizuW4bhn1dMvRgQzQ6VevssYxw`
...
Note that the recipient (wallet) account and mint account are not required in a
token transfer instruction. For clarity, they are listed here as the address are
included in the parsed transaction metadata.

- Recipient: `8fjS2shNWY8xniiEMLNk1Aek4MAu8Qp2LCXJckVwTD4n`
