...
description:
  "Learn how to use transaction simulation to get the compute units consumed
...
[Compute Units (CU)](/docs/terminology#compute-units), which
measure the computational resources your transaction uses on the network. When
you pay
[priority fees](/developers/guides/advanced/how-to-use-priority-fees)
