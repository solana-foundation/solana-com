...
> [JSON RPC API](/docs/rpc) that reduced the need for rewriting common
...
[transaction](/docs/core/transactions) to the network. Each transaction
...
When executing a program using web3.js or from
[another Solana program](/docs/core/cpi), you will need to provide the
...
- [Interacting with Tokens and NFTs](/developers/courses/tokens)
- [Developer Guides](/developers/guides/)
- [Developing Games](/developers/guides/games/getting-started-with-game-development)
