...
CLI, the new
[Token Extensions program](/news/token-extensions-developer-guide)
and the
[Token Metadata extension](/developers/guides/token-extensions/metadata-pointer),
...
[install the Solana CLI](/docs/intro/installation).
...
this
[guide to get devnet SOL](/developers/guides/getstarted/solana-token-airdrop-and-faucets).
...
[token mint account](/docs/core/tokens#mint-account) for our new token:
...
[token extensions](/developers/guides/token-extensions/getting-started) to your
...
- [Filebase](https://filebase.com/) - 5GB free on IPFS, free CDN + Gateway, - 
  S3 compatible, supports IPNS
...
- [Token extensions](/developers/guides/token-extensions/getting-started) -
