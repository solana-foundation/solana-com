...
- [Programs](/docs/core/programs) - Solana's version of smart
  contracts
- [Accounts](/docs/core/accounts) - A record in the Solana
  ledger that either holds data (a data account) or is an executable program
- Various [fees](/docs/core/fees#why-pay-transaction-fees) -
  Such as base fee, priority fee, and rent
- [Transactions](/docs/core/transactions) - Interactions with
...
After
[installing the Solana command-line tools](/docs/intro/installation),
...
[clients in JS/TS](/de/docs/clients/javascript-reference).
