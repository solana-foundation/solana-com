...
use solana_system_client::{instructions::CreateAccountBuilder, ID as SYSTEM_PROGRAM_ID};
...
fn main() -> anyhow::Result<()> {
    ...
    // using ix builder from `solana_system_client` crate
    let create_acc_ix = CreateAccountBuilder::new()
        .payer(from_keypair.pubkey())
        .new_account(new_account_keypair.pubkey())
        .space(data_len as u64)
        .lamports(rent_exemption_amount)
