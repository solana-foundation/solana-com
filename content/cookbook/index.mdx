...
| [How to Partially Sign Transactions](/developers/cookbook/transactions/partial-sign)             | JavaScript, Python | Sign transactions incrementally |
...
| Guide                                                                                                     | Client           | Description                    |
| --------------------------------------------------------------------------------------------------------- | ---------------- | ------------------------------ |
| [How to Create a Token](/developers/cookbook/tokens/create-mint-account)                                  | JavaScript, Python       | Create new tokens              |
| [How to Get a Token Mint](/developers/cookbook/tokens/get-token-mint)                                     | JavaScript, Python       | Access token mints             |
| [How to Create a Token Account](/developers/cookbook/tokens/create-token-account)                         | JavaScript, Python       | Set up token accounts          |
| [How to Get a Token Account](/developers/cookbook/tokens/get-token-account)                               | JavaScript, Python       | Retrieve token accounts        |
| [How to Get a Token Account's Balance](/developers/cookbook/tokens/get-token-balance)                     | JavaScript, Rust, Python | Check token balances           |
| [How to Mint Tokens](/developers/cookbook/tokens/mint-tokens)                                             | JavaScript, Python       | Create new tokens              |
| [How to Transfer Tokens](/developers/cookbook/tokens/transfer-tokens)                                     | JavaScript, Python       | Move tokens between accounts   |
| [How to Burn Tokens](/developers/cookbook/tokens/burn-tokens)                                             | JavaScript, Python       | Remove tokens from circulation |
| [How to Close Token Accounts](/developers/cookbook/tokens/close-token-accounts)                           | JavaScript, Python       | Clean up token accounts        |
| [How to Set Authority on Token Accounts or Mints](/developers/cookbook/tokens/set-update-token-authority) | JavaScript, Python       | Manage token permissions       |
| [How to Delegate Token Accounts](/developers/cookbook/tokens/approve-token-delegate)                      | JavaScript, Python       | Set up token delegation        |
| [How to Revoke a Token Delegate](/developers/cookbook/tokens/revoke-token-delegate)                       | JavaScript, Python       | Remove delegates               |
| [How to Use Wrapped SOL](/developers/cookbook/tokens/manage-wrapped-sol)                                  | JavaScript, Python       | Work with wrapped SOL          |
| [How to Get All Token Accounts by Authority](/developers/cookbook/tokens/get-all-token-accounts)          | JavaScript, Python       | List token accounts            |
