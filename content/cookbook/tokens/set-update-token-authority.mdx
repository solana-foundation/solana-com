...
async fn main() -> anyhow::Result<()> {
    ...
    let mint_address = pubkey!("5JgqqJ4FzvEdCAL3pek8Ycoa7eKTSrsWdNiwsiqURaty");

    // set the mint authority to a new address
    let set_authority_ix = set_authority(
        &TOKEN_PROGRAM_ID,
        &mint_address,
        Some(&random_keypair.pubkey()), // to revoke authority, set to None
        AuthorityType::MintTokens,
    ...
    let mut transaction =
        Transaction::new_with_payer(&[set_authority_ix], Some(&authority_keypair.pubkey()));
