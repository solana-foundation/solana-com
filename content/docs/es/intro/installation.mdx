...
versión de software de tu lanzamiento deseado (por ejemplo, `v2.0.3`), o usar
...
registrado durante la instalación no persiste una vez que cierras tu terminal.
...
utilizada por Solana CLI para pagar las tarifas de transacción y desplegar
...
Si ya tienes una cartera de sistema de archivos guardada en la ubicación
