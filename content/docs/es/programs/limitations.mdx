...
- Acceso limitado a:
  - `std::hash`
  - `std::os`
- Bincode es extremadamente costoso computacionalmente tanto en ciclos como en
  profundidad de llamada y debe evitarse
- El formateo de cadenas debe evitarse ya que también es computacionalmente
  costoso.
- Sin soporte para `println!`, `print!`, usa el macro
...
Las invocaciones entre programas permiten a los programas invocar otros
