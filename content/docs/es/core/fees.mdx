...
- Límite personalizado: Puedes solicitar un límite específico de unidades de
  cómputo incluyendo una `SetComputeUnitLimit` instrucción en tu transacción.
...
- [API de tarifas de prioridad](https://docs.helius.dev/solana-apis/priority-fee-api)
  de Helius
- [Rastreador global de tarifas de prioridad](https://triton.one/solana-prioritization-fees/)
  de Triton
...
| SDK                            | Referencia al código fuente                                                                                                    |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ |
