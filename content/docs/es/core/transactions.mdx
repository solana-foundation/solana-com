...
remitente y del destinatario deben ser modificables (`is_writable`) ya que sus
...
- `header`: Especifica privilegios de lectura/escritura y firmante para las
...
- `recentBlockhash`: Blockhash usado para marcar la fecha y hora de la
  transacción
