...
[System Program](/docs/core/accounts#system-program). Solo el programa
propietario puede cambiar los datos de una cuenta, por lo que transferir SOL
requiere enviar una transacción para invocar al System Program.
...
manualmente la instrucción. Esto requiere que conozcas los detalles de
...
3. Instruction Data: Un array de bytes que especifica qué instrucción invocar en
   el programa y cualquier dato adicional requerido por la instrucción (ej.
...
- `recentBlockhash`: Blockhash utilizado para marcar la fecha y hora de la
  transacción
...
- `signatures`: Array que incluye firmas para todas las cuentas requeridas como
  ...
  el mensaje de transacción usando la clave privada correspondiente para una
  cuenta.
