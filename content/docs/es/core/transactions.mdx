...
- El límite de tamaño de la transacción es de
...
En la práctica, normalmente no tienes que construir un `Instruction`
...
- [Blockhash reciente](mention:recent-blockhash): Actúa como una marca de tiempo
  para la transacción.
