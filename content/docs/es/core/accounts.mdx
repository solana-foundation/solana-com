...
- `data`: Un array de bytes que almacena datos arbitrarios para una cuenta. Para
  cuentas no ejecutables, esto a menudo almacena el estado que está destinado a
  ser leído. Para cuentas de programa (contratos inteligentes), contiene el
  código del programa ejecutable. El campo de datos se conoce comúnmente como
  "datos de la cuenta".
