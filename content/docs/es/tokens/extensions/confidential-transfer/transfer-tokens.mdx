...
Para transferir tokens de forma confidencial de una token account a otra, tanto
...
confidenciales. La token account del remitente también debe tener un saldo
