...
Para ejecutar el ejemplo, inicie un validator local con el Token Extensions
Program clonado desde la mainnet usando el siguiente comando. Debe tener
instalado el CLI de Solana para usar el validator local.
...
<Callout type="info">
  ...
  habilitadas en el validator local predeterminado. Debe clonar el Token
