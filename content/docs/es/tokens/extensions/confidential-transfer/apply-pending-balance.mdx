...
Antes de que los tokens puedan transferirse confidencialmente, el saldo público
de tokens debe convertirse a un saldo confidencial. Esta conversión ocurre en
dos etapas:
...
`confidential_transfer_apply_pending_balance` que construye y
envía una transacción con la instrucción
`ApplyPendingBalance`, como se
...
<Callout type="info">
  ...
  habilitadas en el validator local predeterminado. Debes clonar el Programa de
  Extensiones de Token de la mainnet para ejecutar el código de ejemplo.
</Callout>
