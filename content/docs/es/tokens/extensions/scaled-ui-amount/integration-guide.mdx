...
| Seguimiento interno de saldos brutos            | Seguimiento de saldos brutos para transacciones en cadena en lugar de saldos escalados. Esto será más preciso y fácil de gestionar a largo plazo. | **P1**    |
| Adaptación de fuente de precios                 | En cualquier lugar donde se utilice una fuente de precios para mostrar el precio actual, proporcionar el precio escalado a los usuarios finales.  | **P1**    |
