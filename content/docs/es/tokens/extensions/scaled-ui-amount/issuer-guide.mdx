...
Para usar la extensión Scaled UI Amount, necesitas habilitarla en un mint de
token o en una token account. Ten en cuenta que una vez que se crea un token, no
puedes modificar qué extensiones están habilitadas.
...
### Actualizar el multiplicador de UI amount

Para actualizar el multiplicador de UI amount, necesitas usar el comando
`update-ui-amount-multiplier`. La marca de tiempo es opcional y puede usarse
