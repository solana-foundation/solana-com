...
Acuñar tokens se refiere al proceso de crear nuevas unidades de un token
mediante la invocación de la instrucción
...
en un Token Program. Solo la dirección especificada como autoridad de acuñación
en la mint account puede acuñar nuevos tokens. La instrucción también requiere
la existencia de una token account como destino de los tokens acuñados.
