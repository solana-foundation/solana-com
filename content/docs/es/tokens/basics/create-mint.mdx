...
mint `EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v`. Esta
dirección mint sirve como identificador único de USD Coin en todo el ecosistema
de Solana. Puedes ver detalles sobre esta cuenta mint en
