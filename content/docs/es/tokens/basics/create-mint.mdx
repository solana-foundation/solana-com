...
<Callout type="info">
  ...
  comparten la misma implementación base para la cuenta Mint.
</Callout>
...
Por ejemplo, el USD Coin (USDC) o dólar digital en Solana tiene la dirección
mint `EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v`. Esta dirección mint sirve
como identificador único de USD Coin en todo el ecosistema de Solana. Puedes ver
detalles sobre esta cuenta mint en
[Solana Explorer](https://explorer.solana.com/address/EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v).

## Cómo crear una cuenta Mint

Para crear una cuenta Mint, invoca la instrucción
...
La transacción para crear una cuenta mint necesita dos instrucciones:

1. Invocar el System Program para crear y asignar espacio para una cuenta mint y
   transferir la propiedad al Token Program.
2. Invocar el Token Program para inicializar los datos de la cuenta mint.
