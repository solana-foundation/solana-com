...
de mint debe firmar la transacción. La instrucción acuña tokens a un Token
...
Para detalles sobre Token Extensions, consulta la guía
[Guía de Introducción](/developers/guides/token-extensions/getting-started) y la
