...
keywords:
  ...
  - solana foundry
h1: Getting Started with the Solana Toolkit
---
...
(_`~/.config/solana/id.json`_) and print the pubkey that was generated._
...
Now let's [Create a Solana Project](/docs/toolkit/projects/overview)!
