...
Uma conta de stake na Solana pode ser usada para delegar tokens a validators na
rede para potencialmente ganhar recompensas para o proprietário da conta de
...
assinatura a qualquer momento. A autoridade de stake e a autoridade de saque
podem ser o mesmo endereço ou dois endereços diferentes.
...
contêm sejam retirados antes que uma data ou epoch específica seja alcançada.
