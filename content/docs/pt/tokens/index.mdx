...
tokens na Solana são chamados de SPL
...
O Token Program contém toda a lógica de instrução para interagir com tokens na
...
[Mint Account do USDC](https://explorer.solana.com/address/EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v).
...
![Relação de Conta](/assets/docs/core/tokens/token-account-relationship.svg)
