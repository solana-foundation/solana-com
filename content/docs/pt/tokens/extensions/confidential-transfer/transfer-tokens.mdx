...
1. Crie
   ...
   **Prova de Igualdade
   ...
   corresponde ao seu
   [compromisso Pedersen](https://en.wikipedia.org/wiki/Commitment_scheme)
...
2. Para cada prova:
   ...
   - Armazene os metadados específicos da prova em uma conta de "estado de
     contexto" de prova para usar em outras instruções.
...
4. Feche as contas de estado de contexto da prova para recuperar o SOL usado
   para criá-las.
...
Program clonado da mainnet usando o seguinte comando. Você deve ter o Solana CLI
