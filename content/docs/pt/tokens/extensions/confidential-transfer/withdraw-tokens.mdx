...
O diagrama a seguir mostra os passos envolvidos na retirada de tokens do saldo
...
- Gerar uma prova de igualdade e uma prova de intervalo do lado do cliente
...
clonado da mainnet usando o seguinte comando. Você deve ter o Solana CLI
instalado para iniciar o validator local.
...
<Callout type="info">
  ...
  no validator local padrão. Você deve clonar o Token Extension Program da
