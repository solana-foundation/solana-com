...
description:
  Aprenda como usar a extensão Scaled UI Amount para escalar a quantidade na
...
token ou em uma token account. Observe que, uma vez criado o token, você não
pode modificar quais extensões estão habilitadas.
...
### Atualizar o multiplicador de quantidade na UI

Para atualizar o multiplicador de quantidade na UI, você precisa usar o comando
