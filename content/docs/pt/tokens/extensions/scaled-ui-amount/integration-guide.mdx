...
| Requisito                                  | Descrição                                                                                                                                  | Prioridade |
| :----------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------- | :--------- |
| Rastrear Atualizações de Multiplicador     | Rastrear atualizações de multiplicador para tokens que usam a extensão de quantidade escalada na interface.                                | **P0**     |
| Exibir Saldos de Tokens Rebaseados         | Mostrar saldos escalados para negociação ou provisão de liquidez na interface. (backend ainda pode usar quantidades brutas)                | **P0**     |
