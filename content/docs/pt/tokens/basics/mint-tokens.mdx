...
Cunhar tokens refere-se ao processo de criar novas unidades de um token através
da invocação da instrução
...
no programa de token. Apenas o endereço especificado como autoridade de cunhagem
na mint account pode cunhar novos tokens. A instrução também requer a existência
de uma token account como destino dos tokens cunhados.
