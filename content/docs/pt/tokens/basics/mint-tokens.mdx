---
title: Mint Tokens
description: Aprenda como criar novas unidades de um token.
---

## Como fazer Mint de Tokens

Fazer mint de tokens refere-se ao processo de criar novas unidades de um token
invocando a instrução
...
em um token program. Apenas o endereço especificado como mint authority na mint
account pode criar novos tokens. A instrução também requer a existência de uma
token account como destino dos tokens criados.
