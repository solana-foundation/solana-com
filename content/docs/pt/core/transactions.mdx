...
- ---INLINE-CODE-PLACEHOLDER-a6e536fd2243a28539a4c5e69f9542eb---: Endereço da
  conta
...
O campo ---INLINE-CODE-PLACEHOLDER-7947c12a0cb1d36ca9b57bde51de9889--- contém os
seguintes campos:

- ---INLINE-CODE-PLACEHOLDER-28289343a245d382223c9dca090af4a5---: Especifica
  privilégios de leitura/escrita e assinatura para endereços no array
  ---INLINE-CODE-PLACEHOLDER-8d4960058576495469f38cdaffbefccd---

- ---INLINE-CODE-PLACEHOLDER-8d4960058576495469f38cdaffbefccd---: Array de todos
  os endereços de contas usados nas instruções da transação

- ---INLINE-CODE-PLACEHOLDER-484fd94be3ebc646463aa4da185f718d---: Blockhash
  usado para marcar o timestamp da transação

- ---INLINE-CODE-PLACEHOLDER-cef0cbeb0aa0415c6c312a6286058bf7---: Array de
  instruções a serem executadas. Cada
  ---INLINE-CODE-PLACEHOLDER-23d00a6ef54005c98c43ed4a47623699--- e
  ---INLINE-CODE-PLACEHOLDER-669c26d6b4d7f017d75ebf197ebb784a--- em uma
  instrução referencia o array
  ---INLINE-CODE-PLACEHOLDER-8d4960058576495469f38cdaffbefccd--- por índice.

- ---INLINE-CODE-PLACEHOLDER-32f8eb4ecd3b61a207fa77ec4bff1c65---: Array
  incluindo assinaturas para todas as contas exigidas como signatárias pelas
  instruções na transação. Uma assinatura é criada assinando a mensagem da
  transação usando a chave privada correspondente para uma conta.
...
Os exemplos a seguir mostram a saída da mensagem de transação dos trechos de
código anteriores. O formato exato difere dependendo do SDK, mas inclui as
mesmas informações.
...
semelhante ao trecho a seguir. Alternativamente, você pode inspecionar a
...
Você usa essa assinatura para procurar os detalhes da transação na rede. A
