...
- [API de Taxa de Prioridade](https://docs.helius.dev/solana-apis/priority-fee-api)
  da Helius
- [Rastreador Global de Taxas de Prioridade](https://triton.one/solana-prioritization-fees/)
  da Triton
...
Use estas instruções para definir o limite e o preço das unidades de computação
em uma transação:
...
unidades de computação com um preço de unidade de computação de 0 (sem taxa de
priorização).

A taxa prioritária depende do limite de unidades de computação que você solicita
para a transação, não das unidades de computação realmente utilizadas. Se você
definir um limite de unidades de computação muito alto ou usar a quantidade
padrão, poderá pagar por unidades de computação não utilizadas.

</Callout>

### Exemplos

Os exemplos a seguir mostram como definir o limite de unidades de computação e o
preço para uma transação.
