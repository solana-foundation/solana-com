...
- PDAs são endereços que estão fora da curva Ed25519 e **não têm chave privada
  correspondente**.
...
Um PDA é um ponto que é intencionalmente derivado para ficar fora da curva
Ed25519 usando um conjunto predefinido de entradas. Um ponto que não está na
curva Ed25519 não tem uma chave privada correspondente válida e não pode
...
A derivação de PDA requer um "bump seed", um byte extra anexado às seeds
