...
## !!steps Adicionar o código do programa
...
Adicione o seguinte código ao `examples/client.rs`. Este é um script cliente
...
novamente, o que gerará um novo arquivo de keypair.
