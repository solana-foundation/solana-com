...
Se você já tem uma carteira de sistema de arquivos salva no local padrão, este
comando não a substitui, a menos que você force explicitamente a substituição
usando a flag `--force`.
...
[Web Faucet](https://faucet.solana.com) em vez disso.
...
## Noções básicas da CLI do Anchor

Esta seção apresenta alguns comandos comuns da CLI do Anchor para ajudá-lo a
