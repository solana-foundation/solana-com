...
- Wywołać instrukcję
  [ConfidentialTransferInstruction::Withdraw](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L493)
  podając dwa konta dowodowe.
- Zamknąć dwa konta dowodowe, aby odzyskać rentę.
...
Aby uruchomić przykład, rozpocznij od uruchomienia lokalnego validatora z Token
Extensions Program sklonowanym z mainnetu za pomocą następującego polecenia.
Musisz mieć zainstalowane Solana CLI, aby uruchomić lokalnego validatora.
