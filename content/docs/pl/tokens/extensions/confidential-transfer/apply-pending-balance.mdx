...
Kiedy tokeny są "deponowane" z publicznego salda lub gdy tokeny są przesyłane
...
Pakiet `spl_token_client` zapewnia metodę
...
<Callout type="info">
  ...
  włączona w domyślnym lokalnym walidatorze. Musisz sklonować główną wersję
...
---CODE-PLACEHOLDER-2b8c1a5e3e8f4b6b9c3d7f8a9e0d1c2e---
