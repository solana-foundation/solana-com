...
description:
  Dowiedz się więcej o rozszerzeniu Poufne Transfery i jak go używać, aby dodać
  opcjonalne funkcje do tokenów i kont tokenów.
---
...
- [Książka kucharska Poufnych Salda](https://github.com/solana-developers/Confidential-Balances-Sample) -
  Fragmenty kodu pokazujące, jak używać rozszerzenia Poufne Transfery

### Jak to działa?

Rozszerzenie Poufne Transfery dodaje
...
1. Utwórz konto mint z rozszerzeniem poufnych transferów.
...
<Cards>
  ...
  >
    Jak utworzyć konto mint z rozszerzeniem Poufne Transfery
  </Card>
  <Card
    title="Utwórz konto tokenów"
    href="/docs/tokens/extensions/confidential-transfer/create-token-account"
  >
    Jak skonfigurować konto tokenów z rozszerzeniem Poufne Transfery
  </Card>
  <Card
    title="Wpłać tokeny"
...
| _rs`DisableConfidentialCredits`_    | Blokuje przychodzące poufne transfery, jednocześnie umożliwiając publiczne transfery.                                                                       |
