...
| Historyczne akcje nie powinny być przeskalowane | Historyczne akcje, takie jak transakcje, powinny być wyświetlane z dokładną zrebalansowaną kwotą i ceną w momencie akcji.                                   | **P1**    |
| Wewnętrzne śledzenie surowych sald              | Śledzenie surowych sald dla transakcji on-chain zamiast zrebalansowanych sald. Będzie to dokładniejsze i łatwiejsze do zarządzania w dłuższej perspektywie. | **P1**    |
| Adaptacja źródła cen                            | Wszędzie tam, gdzie źródło cen jest używane do wyświetlania bieżącej ceny, należy dostarczyć użytkownikom końcowym zrebalansowaną cenę.                     | **P1**    |
| Wyświetlanie wykresu historii cen               | Odzwierciedlenie zrebalansowanych cen na wykresie cen. Obejmuje to przeskalowanie historycznych cen do bieżącego mnożnika.                                  | **P1**    |
