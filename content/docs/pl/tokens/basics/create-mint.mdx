...
## Co to jest konto mint?

Konto mint to typ konta w Token Programs Solany, który unikalnie reprezentuje
...
Każdy token na Solanie istnieje jako konto mint, gdzie adres konta mint jest
...
unikalny identyfikator USD Coina w całym ekosystemie Solany. Szczegóły dotyczące
tego konta mint można zobaczyć na stronie
[Solana Explorer](https://explorer.solana.com/address/EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v).

## Jak utworzyć konto mint

Aby utworzyć konto mint, wywołaj instrukcję
...
Transakcja tworzenia konta mint wymaga dwóch instrukcji:

1. Wywołaj System Program, aby utworzyć i przydzielić miejsce dla konta mint
   oraz przenieść własność na Token Program.
2. Wywołaj Token Program, aby zainicjalizować dane konta mint.
