...
!typ string !wartości confirmed finalized !domyślne finalized
...
!typ string !wartości json jsonParsed base58 base64 !domyślne json
...
!typ string !wartości full accounts signatures none !domyślne full
