...
który określa, jak jest ona priorytetyzowana w stosunku do innych transakcji,
...
dla transakcji, a nie od rzeczywistej liczby użytych jednostek obliczeniowych.
Jeśli ustawisz zbyt wysoki limit jednostek obliczeniowych lub użyjesz domyślnej
