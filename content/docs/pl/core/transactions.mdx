...
"Podpis transakcji" jednoznacznie identyfikuje transakcję w Solana. Używasz go,
aby wyszukać szczegóły transakcji w sieci. Podpis transakcji to po prostu
pierwszy podpis w transakcji. Zauważ, że pierwszy podpis to także podpis
płatnika opłaty transakcyjnej.
