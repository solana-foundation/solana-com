...
- [Poproś o airdrop](mention:airdrop), aby zasilić keypair
...
Łącząc obie instrukcje w jednej transakcji, zapewniasz, że utworzenie i
inicjalizacja konta odbywają się atomowo. Albo obie instrukcje zakończą się
sukcesem, albo żadna z nich.

Takie podejście jest powszechne przy budowaniu bardziej złożonych transakcji na
