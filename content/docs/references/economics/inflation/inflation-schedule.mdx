...
![Example proposed inflation schedule graph](/assets/docs/references/economics/proposed_inflation_schedule.png)

In the above graph we see the annual inflation rate percentage over time, given
the inflation parameters proposed above.

![Example proposed total supply graph](/assets/docs/references/economics/proposed_total_supply.png)
...
![Example staked yields graph](/assets/docs/references/economics/example_staked_yields.png)
