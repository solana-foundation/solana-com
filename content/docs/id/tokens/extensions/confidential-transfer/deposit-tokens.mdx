...
## Cara melakukan deposit token ke saldo konfidensial tertunda
...
1. **Saldo Konfidensial Tertunda**: Awalnya, token "didepositkan" dari saldo
...
Bagian ini menjelaskan tahap pertama: melakukan deposit saldo token publik ke
saldo konfidensial tertunda.

Diagram berikut menunjukkan langkah-langkah yang terlibat dalam melakukan
deposit token dari saldo publik ke saldo konfidensial tertunda:
...
Contoh berikut menunjukkan cara melakukan deposit saldo token publik ke saldo
