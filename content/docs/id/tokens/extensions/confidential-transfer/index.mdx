...
| _rs`EnableConfidentialCredits`_     | Memungkinkan token account untuk menerima transfer token rahasia.                                                                                                 |
...
| _rs`DisableNonConfidentialCredits`_ | Memblokir transfer reguler untuk membuat account hanya menerima transfer rahasia.                                                                                 |
| _rs`TransferWithFee`_               | Mentransfer token antar token account secara rahasia dengan biaya.                                                                                                |
| _rs`ConfigureAccountWithRegistry`_  | Cara alternatif untuk mengkonfigurasi token account untuk transfer rahasia menggunakan akun _rs`ElGamalRegistry`_ alih-alih bukti _rs`VerifyPubkeyValidity`_.     |
