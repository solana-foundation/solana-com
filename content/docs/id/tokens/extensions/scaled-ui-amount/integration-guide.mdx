...
| Secara internal melacak saldo mentah           | Lacak saldo mentah untuk transaksi onchain alih-alih saldo yang diskalakan. Ini akan lebih akurat dan lebih mudah dikelola dalam jangka panjang. | **P1**    |
| Adaptasi Feed Harga                            | Di mana pun feed harga digunakan untuk menampilkan harga saat ini, berikan harga yang diskalakan kepada pengguna akhir.                          | **P1**    |
