...
Mint account adalah jenis akun dalam Token Programs Solana yang secara unik
mewakili token di jaringan dan menyimpan metadata global tentang token tersebut.
...
Setiap token di Solana ada sebagai mint account di mana alamat mint account
tersebut merupakan pengenal uniknya di jaringan.

Sebagai contoh, USD Coin (USDC) digital dollar di Solana memiliki alamat mint
`EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v`. Alamat mint ini berfungsi
sebagai pengenal unik USD Coin di seluruh ekosistem Solana. Anda dapat melihat
detail tentang akun mint ini di
[Solana Explorer](https://explorer.solana.com/address/EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v).

## Cara Membuat Mint Account

Untuk membuat Mint Account, panggil instruksi
...
[di sini](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/processor.rs#L79).

Transaksi untuk membuat mint account memerlukan dua instruksi:

1. Memanggil System Program untuk membuat dan mengalokasikan ruang untuk mint
   account dan mentransfer kepemilikan ke Token Program.
2. Memanggil Token Program untuk menginisialisasi data mint account.
