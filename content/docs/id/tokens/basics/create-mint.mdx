...
Mint account adalah jenis akun dalam Token Program Solana yang secara unik
...
merupakan pengenal uniknya di jaringan.
...
detail tentang mint account ini di
...
Anda dapat menemukan implementasi instruksi ini
