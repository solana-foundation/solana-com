...
sebagai alamat akun baru. Program contoh menggunakan
...
Batasan `init` menginstruksikan Anchor untuk memanggil System Program guna
...
lebih dari sekali menggunakan alamat `user` yang sama sebagai seed, maka
