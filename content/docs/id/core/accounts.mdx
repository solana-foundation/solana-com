...
Loader-v3 bekerja berbeda dari semua program BPF Loader lainnya. Akun program
hanya berisi alamat akun data program, yang menyimpan kode yang dapat dieksekusi
sebenarnya:
