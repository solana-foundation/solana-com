...
mengirimkan amplop untuk mendapatkan formulir diproses.
...
[System Program](/docs/core/accounts#system-program). Hanya program pemilik yang
...
- Instruction Data: Array byte yang menentukan instruksi yang akan dipanggil
  pada program dan argumen yang diperlukan oleh instruksi tersebut
...
- **ID Program**: Alamat program yang akan mengeksekusi instruksi.
- **Akun**: Daftar akun yang diperlukan oleh instruksi. Untuk setiap akun,
...
1. [Tanda tangan](https://github.com/anza-xyz/agave/blob/v2.1.13/sdk/signature/src/lib.rs#L30):
   Array tanda tangan yang disertakan pada transaksi.
2. [Pesan](https://github.com/anza-xyz/agave/blob/v2.1.13/sdk/program/src/message/legacy.rs#L131):
...
- [Header Pesan](/docs/core/transactions#message-header): Menentukan jumlah
  penandatangan dan akun hanya-baca.
- [Alamat Akun](/docs/core/transactions#array-of-account-addresses): Sebuah
  array alamat akun yang diperlukan oleh instruksi pada transaksi.
- [Blockhash Terbaru](/docs/core/transactions#recent-blockhash): Bertindak
  sebagai stempel waktu untuk transaksi.
- [Instruksi](/docs/core/transactions#array-of-instructions): Sebuah array
