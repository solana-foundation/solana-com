...
[Instal Dependensi](#install-dependencies) di bawah untuk petunjuk menginstal
setiap dependensi secara individual.
...
memungkinkan Anda menggunakan WSL dan VS Code bersama-sama.
...
Anda dapat mengganti `stable` dengan tag rilis yang sesuai dengan versi software
yang Anda inginkan (misalnya `v2.0.3`), atau gunakan salah satu dari tiga nama
channel simbolis: `stable`, `beta`, atau `edge`.
...
[Repo Github Agave](https://github.com/anza-xyz/agave/releases).
...
Bagian ini membahas beberapa perintah Solana CLI umum untuk membantu Anda
memulai.
...
Untuk mengirim transaksi menggunakan Solana CLI, Anda memerlukan dompet Solana
