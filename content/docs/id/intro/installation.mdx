...
Anda dapat memperbarui cluster CLI Solana menggunakan perintah berikut:
...
Untuk mendeploy proyek Anda, jalankan perintah berikut:

```terminal
$ anchor deploy
```

Perintah ini mendeploy program Anda ke `cluster` yang ditentukan dalam file
