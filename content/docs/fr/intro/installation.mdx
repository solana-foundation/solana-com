...
Cette section présente quelques commandes courantes de Solana CLI pour vous
aider à démarrer.
...
Vous pouvez mettre à jour le cluster Solana CLI en utilisant les commandes
suivantes :
...
Pour générer une paire de clés au chemin de paire de clés par défaut, exécutez
