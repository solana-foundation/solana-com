...
Avant que les jetons puissent être transférés confidentiellement, le solde
public des jetons doit être converti en solde confidentiel. Cette conversion se
...
Lorsque les jetons sont "déposés" depuis le solde public ou lorsque des jetons
sont transférés confidentiellement d'un compte de jetons à un autre, les jetons
sont initialement ajoutés au solde confidentiel en attente. Avant que les jetons
