...
description:
  Apprenez comment transférer des jetons de manière confidentielle d'un compte
  de jetons à un autre.
---
...
l'expéditeur et le destinataire doivent tous deux avoir des comptes de jetons
...
Pour transférer des jetons confidentiellement :
...
1. Créez
   ...
   **Preuve d'intervalle
   ...
   en bits bas/hauts) sont tous non négatifs et dans un intervalle spécifié.
...
4. Fermez les comptes d'état de contexte de preuve pour récupérer le SOL utilisé
   pour les créer.
...
- Fermer les trois comptes de preuve pour récupérer le loyer.
...
L'exemple suivant démontre comment transférer confidentiellement des tokens
entre des comptes de tokens.
