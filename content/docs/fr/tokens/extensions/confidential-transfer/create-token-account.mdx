...
pourrait envoyer répétitivement des jetons à un token account, bloquant ainsi la
capacité du propriétaire du token account à transférer des jetons. Le
propriétaire du token account serait incapable de transférer des jetons car le
...
<Callout type="info">
  **Division du solde en attente en parties haute/basse**
