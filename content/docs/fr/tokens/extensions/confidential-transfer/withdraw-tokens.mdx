...
description: Apprenez comment retirer des tokens de l'état confidentiel.
---
...
L'exemple suivant démontre comment retirer des tokens du solde confidentiel
...
avoir l'interface de ligne de commande Solana installée pour démarrer le
validator local.
...
---CODE-PLACEHOLDER-c9c01a4d8c7a7b6a7c6f542e2a8f6d9e---
