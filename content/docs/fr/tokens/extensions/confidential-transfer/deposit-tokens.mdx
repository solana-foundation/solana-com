...
2. **Solde confidentiel disponible** : Le solde en attente est ensuite
   "appliqué" au solde disponible, rendant les tokens disponibles pour des
...
Le module `spl_token_client` fournit une méthode `confidential_transfer_deposit`
...
---CODE-PLACEHOLDER-a9a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0---
