...
<Cards>
  ...
  >
    Comment déposer des tokens vers un solde confidentiel en attente
  </Card>
  <Card
  ...
  >
    Comment transférer confidentiellement des tokens entre des token accounts
  </Card>
</Cards>
...
avoir installé la CLI Solana pour utiliser le validator local.
...
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`InitializeMint`_                | Configure un compte mint pour les transferts confidentiels. Cette instruction doit être incluse dans la même transaction que l'instruction _rs`TokenInstruction::InitializeMint`_.     |
