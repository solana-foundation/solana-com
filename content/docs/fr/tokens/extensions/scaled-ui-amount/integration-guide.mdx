...
| Support pour les actions sur les tokens                         | Les utilisateurs finaux doivent saisir les montants d'action avec leurs soldes UiAmount (multiplicateur \* montant brut).                                 | **P0**   |
...
| Affichage du graphique d'historique des prix                    | Refléter les prix mis à l'échelle dans le graphique de prix. Cela inclut la remise à l'échelle des prix historiques selon le multiplicateur actuel.       | **P1**   |
| Mise à l'échelle du prix de revient                             | Le coût par action devrait être mis à l'échelle selon le multiplicateur actuel.                                                                           | **P1**   |
