---
title: Frapper des jetons
description: Apprenez comment frapper de nouvelles unités d'un jeton.
---

## Comment frapper des jetons

Frapper des jetons fait référence au processus de création de nouvelles unités
d'un jeton en invoquant l'instruction
...
sur un Token Program. Seule l'adresse spécifiée comme autorité de frappe sur le
mint account peut frapper de nouveaux jetons. L'instruction nécessite également
l'existence d'un token account comme destination des jetons frappés.
