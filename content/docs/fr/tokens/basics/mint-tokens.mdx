---
title: Minter des jetons
description: Apprenez comment minter de nouvelles unités d'un jeton.
---

## Comment minter des jetons

Le minting de jetons fait référence au processus de création de nouvelles unités
...
sur un programme de jetons. Seule l'adresse spécifiée comme autorité de mint sur
le compte mint peut créer de nouveaux jetons. L'instruction nécessite également
l'existence d'un compte de jetons comme destination des jetons mintés.
