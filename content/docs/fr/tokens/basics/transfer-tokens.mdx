...
Le transfert de jetons consiste à déplacer des jetons d'un compte de jetons à un
autre compte de jetons partageant le même émetteur. Le transfert de jetons
s'effectue lorsque vous invoquez l'instruction
...
sur un programme de jetons. Seule l'adresse spécifiée comme propriétaire
(autorité) du compte de jetons source peut transférer des jetons depuis ce
compte.
