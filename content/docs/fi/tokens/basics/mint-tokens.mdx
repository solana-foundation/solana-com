...
Tokenien luominen (minting) viittaa prosessiin, jossa luodaan uusia
token-yksiköitä kutsumalla
...
-ohjetta token-ohjelmassa. Vain mint account -tilin mint authority -osoitteeksi
määritetty taho voi luoda uusia tokeneita. Ohje vaatii myös token account -tilin
olemassaolon luotujen tokenien kohteena.
