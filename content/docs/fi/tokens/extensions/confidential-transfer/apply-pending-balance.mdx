...
description: Opi miten käyttää odottavaa saldoa varojen saamiseksi käyttöön.
---

## Miten käyttää odottavaa saldoa käytettävissä olevaan saldoon
...
2. **Luottamuksellinen käytettävissä oleva saldo**: Odottava saldo "käytetään"
   sitten käytettävissä olevaan saldoon, jolloin tokenit ovat käytettävissä
   luottamuksellisiin siirtoihin.

Tämä osio selittää toisen vaiheen: odottavan saldon käyttämisen käytettävissä
olevaan saldoon.
...
käyttää luottamuksellisiin siirtoihin, odottava saldo täytyy "käyttää"
...
Seuraava kaavio näyttää vaiheet, jotka liittyvät odottavan saldon käyttämiseen
käytettävissä olevaan saldoon:
...
Seuraava esimerkki näyttää, miten käyttää luottamuksellista odottavaa saldoa
...
Sinulla täytyy olla Solana CLI asennettuna käynnistääksesi paikallisen
validatorin.
