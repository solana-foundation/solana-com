...
4. Sulje todistuksen kontekstitilatilit SOL-varojen palauttamiseksi, jotka
   käytettiin niiden luomiseen.
...
- Generoi tasa-arvotodiste, salatekstin kelvollisuustodiste ja aluetodiste
  asiakaspuolella
- Kutsu Zk ElGamal -todistusohjelmaa todisteiden vahvistamiseksi ja
  "kontekstitila"-tilien alustamiseksi
- Kutsu
  [ConfidentialTransferInstruction::Transfer](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L604)
  -ohjetta tarjoamalla kolme todistetiliä
- Sulje kolme todistetiliä rent-maksun palauttamiseksi
