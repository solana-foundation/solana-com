...
lähettäjällä että vastaanottajalla täytyy olla token-tilit, jotka on määritetty
_rs`ConfidentialTransferAccount`_ -tilaan ja hyväksytty luottamuksellisiin
siirtoihin. Lähettäjän token-tilillä täytyy myös olla käytettävissä oleva
luottamuksellinen saldo siirtoa varten.
...
1. Luo
   ...
   **Yhtäläisyystodiste
   ...
   Varmistaa, että uusi käytettävissä oleva saldosalaus siirron jälkeen vastaa
   sen vastaavaa
   ...
   **Salatekstin pätevyystodiste
   ...
   Varmistaa, että siirtosumman salatekstit on asianmukaisesti luotu kaikille
...
2. Jokaiselle todisteelle:
   ...
   - Tallenna todistekohtaiset metatiedot todistuksen "kontekstitila"-tilille
...
3. Kutsu
   ...
   -ohjetta, tarjoten todistuksen kontekstitilatilit.

4. Sulje todistuksen kontekstitilatilit SOL:n palauttamiseksi, jota käytettiin
   niiden luomiseen.
...
- Generoi tasa-arvotodistus, salatekstin kelvollisuustodistus ja aluetodistus
  asiakaspuolella
- Kutsu Zk ElGamal -todistusohjelmaa todistusten vahvistamiseksi ja
  "kontekstitila"-tilien alustamiseksi
- Kutsu
  [ConfidentialTransferInstruction::Transfer](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L604)
  -ohjetta tarjoamalla kolme todistustiliä.
- Sulje kolme todistustiliä rent-maksun palauttamiseksi.
...
Seuraava esimerkki näyttää, miten tokeneita siirretään luottamuksellisesti token
accountien välillä.
