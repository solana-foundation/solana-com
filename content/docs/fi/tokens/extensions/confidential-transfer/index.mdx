...
Luottamukselliset siirrot mahdollistavat tokenien siirtämisen token-tilien
välillä ilman siirtosumman paljastamista. Tämä on hyödyllistä yksityisyyttä
suojaavissa tapahtumissa. Vain siirtosummat ja token-saldot ovat yksityisiä.
Token-tilien osoitteet pysyvät julkisina.
...
- [Luottamuksellisten saldojen keittokirja](https://github.com/solana-developers/Confidential-Balances-Sample) -
  Koodiesimerkkejä luottamuksellisen siirtolaajennuksen käytöstä

### Miten se toimii?

Luottamuksellinen siirtolaajennus lisää
...
tilien välillä paljastamatta siirtosummaa.
...
1. Luo mint account luottamuksellisella siirtolaajennuksella.
2. Luo token account luottamuksellisella siirtolaajennuksella lähettäjälle ja
   vastaanottajalle.
...
<Cards>
  ...
  >
    Miten luoda mint account luottamuksellisella siirtolaajennuksella
  </Card>
  <Card
    title="Luo token account"
    href="/docs/tokens/extensions/confidential-transfer/create-token-account"
  >
    Miten määrittää token account luottamuksellisella siirtolaajennuksella
  </Card>
  <Card
  ...
  <Card
    title="Sovella odottavaa saldoa"
    href="/docs/tokens/extensions/confidential-transfer/apply-pending-balance"
  >
    Miten soveltaa odottavaa saldoa käytettävissä olevaan luottamukselliseen
    saldoon
  </Card>
  <Card
  ...
  >
    Miten siirtää luottamuksellisesti tokeneita token-tilien välillä
  </Card>
</Cards>
...
Alla oleva Rust-esimerkki näyttää vaiheet luottamuksellisille tokenien
siirroille edellisen kaavion mukaisesti. Vaiheet on selkeyden vuoksi jaettu
apufunktioihin.
...
Sinulla täytyy olla Solana CLI asennettuna käyttääksesi paikallista validatoria.
...
<Callout type="info">
  Tätä kirjoitettaessa Confidential Transfers -ominaisuutta ei ole käytössä
...
| Ohje                                | Kuvaus                                                                                                                                                          |
| ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`InitializeMint`_                | Määrittää mint-tilin luottamuksellisia siirtoja varten. Tämä ohje on sisällytettävä samaan transaktioon kuin _rs`TokenInstruction::InitializeMint`_ -ohje.      |
| _rs`UpdateMint`_                    | Päivittää luottamuksellisten siirtojen asetuksia mintille.                                                                                                      |
| _rs`ConfigureAccount`_              | Määrittää token-tilin luottamuksellisia siirtoja varten.                                                                                                        |
| _rs`ApproveAccount`_                | Hyväksyy token-tilin luottamuksellisia siirtoja varten, jos mint vaatii hyväksynnän uusille token-tileille.                                                     |
| _rs`EmptyAccount`_                  | Tyhjentää odottavat ja käytettävissä olevat luottamukselliset saldot, jotta token-tili voidaan sulkea.                                                          |
...
| _rs`Transfer`_                      | Siirtää tokeneita token-tilien välillä luottamuksellisesti.                                                                                                     |
| _rs`ApplyPendingBalance`_           | Muuntaa odottavan saldon käytettävissä olevaksi saldoksi talletusten tai siirtojen jälkeen.                                                                     |
| _rs`EnableConfidentialCredits`_     | Sallii token-tilin vastaanottaa luottamuksellisia tokenien siirtoja.                                                                                            |
| _rs`DisableConfidentialCredits`_    | Estää saapuvat luottamukselliset siirrot, mutta sallii edelleen julkiset siirrot.                                                                               |
| _rs`EnableNonConfidentialCredits`_  | Sallii token-tilin vastaanottaa julkisia tokenien siirtoja.                                                                                                     |
| _rs`DisableNonConfidentialCredits`_ | Estää tavalliset siirrot, jotta tili vastaanottaa vain luottamuksellisia siirtoja.                                                                              |
| _rs`TransferWithFee`_               | Siirtää tokeneita token-tilien välillä luottamuksellisesti maksulla.                                                                                            |
| _rs`ConfigureAccountWithRegistry`_  | Vaihtoehtoinen tapa määrittää token-tilit luottamuksellisia siirtoja varten käyttäen _rs`ElGamalRegistry`_ -tiliä _rs`VerifyPubkeyValidity`_ -todisteen sijaan. |
