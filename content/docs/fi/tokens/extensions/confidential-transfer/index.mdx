...
description:
  Opi Confidential Transfer -laajennuksesta ja kuinka käyttää sitä lisätäksesi
  valinnaisia ominaisuuksia token-mintteihin ja -tileihin.
---
...
Luottamuksellisten tokenisiirtojen peruskulku on seuraava:

1. Luo mint account Confidential Transfer -laajennuksella.
2. Luo token-tilit Confidential Transfer -laajennuksella lähettäjälle ja
   vastaanottajalle.
...
5. **Sovella** lähettäjän odottava saldo **luottamukselliseen käytettävissä
   olevaan saldoon**.
6. Siirrä luottamuksellisesti tokeneita lähettäjän token-tililtä vastaanottajan
   token-tilille.
...
<Cards>
  ...
  >
    Kuinka määrittää token-tili Confidential Transfer -laajennuksella
  </Card>
  <Card
  ...
  >
    Kuinka soveltaa odottavaa saldoa käytettävissä olevaan luottamukselliseen
    saldoon
  </Card>
  <Card
  ...
  >
    Kuinka siirtää tokeneita luottamuksellisesti token-tilien välillä
  </Card>
</Cards>
...
| _rs`EmptyAccount`_                  | Tyhjentää odottavat ja käytettävissä olevat luottamukselliset saldot, jotta token account -tili voidaan sulkea.                                                          |
...
| _rs`Transfer`_                      | Siirtää tokeneita token account -tilien välillä luottamuksellisesti.                                                                                                     |
| _rs`ApplyPendingBalance`_           | Muuntaa odottavan saldon käytettävissä olevaksi saldoksi talletusten tai siirtojen jälkeen.                                                                              |
| _rs`EnableConfidentialCredits`_     | Sallii token account -tilin vastaanottaa luottamuksellisia tokenien siirtoja.                                                                                            |
| _rs`DisableConfidentialCredits`_    | Estää saapuvat luottamukselliset siirrot, mutta sallii edelleen julkiset siirrot.                                                                                        |
| _rs`EnableNonConfidentialCredits`_  | Sallii token account -tilin vastaanottaa julkisia tokenien siirtoja.                                                                                                     |
| _rs`DisableNonConfidentialCredits`_ | Estää tavalliset siirrot, jotta tili vastaanottaa vain luottamuksellisia siirtoja.                                                                                       |
| _rs`TransferWithFee`_               | Siirtää tokeneita token account -tilien välillä luottamuksellisesti maksulla.                                                                                            |
| _rs`ConfigureAccountWithRegistry`_  | Vaihtoehtoinen tapa määrittää token account -tilit luottamuksellisia siirtoja varten käyttäen _rs`ElGamalRegistry`_ -tiliä _rs`VerifyPubkeyValidity`_ -todisteen sijaan. |
