...
Käyttääksesi Scaled UI Amount -laajennusta, sinun täytyy ottaa se käyttöön token
mintissä tai token accountissa. Huomaa, että kun token on luotu, et voi muokata
käytössä olevia laajennuksia.
...
### Päivitä UI-määrän kerroin

Päivittääksesi UI-määrän kertoimen, sinun täytyy käyttää
`update-ui-amount-multiplier` komentoa. Aikaleima on valinnainen ja sitä voidaan
käyttää uuden kertoimen mukautetun aloitusajan asettamiseen. Jos aikaleimaa ei
anneta, käytetään nykyistä aikaleimaa.
