...
| ----------------- | --------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| Secp256r1-ohjelma | `Secp256r1SigVerify1111111111111111111111111` | Tarkistaa enintään 8 secp256r1-allekirjoitusta. Ottaa allekirjoituksen, julkisen avaimen ja viestin. Palauttaa virheen, jos jokin epäonnistuu. | [Ohjeet](https://docs.rs/solana-secp256k1-recover/latest/solana_secp256k1_recover/index.html) |
