...
rajaa, jonka laskentayksikön hinta on 0 (ei priorisointimaksua).

Priorisointimaksu riippuu transaktiota varten pyytämästäsi laskentayksikön
rajasta, ei todellisista käytetyistä laskentayksiköistä. Jos asetat liian
korkean laskentayksikön rajan tai käytät oletussummaa, saatat maksaa
