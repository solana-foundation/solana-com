---
title: लंबित शेष राशि लागू करें
description:
  धनराशि को उपलब्ध कराने के लिए लंबित शेष राशि को कैसे लागू करें, यह जानें।
---

## लंबित शेष राशि को उपलब्ध शेष राशि में कैसे लागू करें

टोकन को गोपनीय रूप से स्थानांतरित करने से पहले, सार्वजनिक टोकन शेष राशि को
गोपनीय शेष राशि में परिवर्तित करना होगा। यह रूपांतरण दो चरणों में होता है:

1. **गोपनीय लंबित शेष राशि**: प्रारंभ में, टोकन को सार्वजनिक शेष राशि से "लंबित"
   गोपनीय शेष राशि में "जमा" किया जाता है।
2. **गोपनीय उपलब्ध शेष राशि**: फिर लंबित शेष राशि को उपलब्ध शेष राशि में "लागू"
   किया जाता है, जिससे टोकन गोपनीय स्थानांतरण के लिए उपलब्ध हो जाते हैं।

यह खंड दूसरे चरण की व्याख्या करता है: लंबित शेष राशि को उपलब्ध शेष राशि में लागू
करना।

जब टोकन को सार्वजनिक शेष राशि से "जमा" किया जाता है या जब टोकन को गोपनीय रूप से
एक token account से दूसरे में स्थानांतरित किया जाता है, तो टोकन प्रारंभ में
गोपनीय लंबित शेष राशि में जोड़े जाते हैं। गोपनीय स्थानांतरण के लिए टोकन का उपयोग
करने से पहले, लंबित शेष राशि को उपलब्ध शेष राशि में "लागू" किया जाना चाहिए।
...
निम्नलिखित आरेख लंबित शेष राशि को उपलब्ध शेष राशि में लागू करने में शामिल चरणों
को दिखाता है:
...
लंबित शेष राशि को उपलब्ध शेष राशि में परिवर्तित करने के लिए,
...
निर्देश का आह्वान करें।

`spl_token_client` क्रेट एक `confidential_transfer_apply_pending_balance` विधि
प्रदान करता है जो `ApplyPendingBalance` निर्देश के साथ एक लेनदेन बनाता और भेजता
है, जैसा कि नीचे दिए गए उदाहरण में दिखाया गया है।

### उदाहरण कोड

निम्नलिखित उदाहरण दिखाता है कि गोपनीय लंबित शेष राशि को गोपनीय उपलब्ध शेष राशि
में कैसे लागू किया जाए।

उदाहरण चलाने के लिए, निम्नलिखित कमांड का उपयोग करके मेननेट से क्लोन किए गए Token
Extensions Program के साथ एक स्थानीय validator प्रारंभ करें। स्थानीय validator
प्रारंभ करने के लिए आपके पास Solana CLI इंस्टॉल होना चाहिए।
