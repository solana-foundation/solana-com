---
title: टोकन जमा करें
description: गोपनीय स्थिति में टोकन जमा करने का तरीका जानें।
---

## गोपनीय लंबित बैलेंस में टोकन कैसे जमा करें

टोकन को गोपनीय रूप से स्थानांतरित करने से पहले, सार्वजनिक टोकन बैलेंस को गोपनीय
बैलेंस में परिवर्तित करना होगा। यह रूपांतरण दो चरणों में होता है:

1. **गोपनीय लंबित बैलेंस**: प्रारंभ में, टोकन को सार्वजनिक बैलेंस से "लंबित"
   गोपनीय बैलेंस में "जमा" किया जाता है।
2. **गोपनीय उपलब्ध बैलेंस**: लंबित बैलेंस को फिर उपलब्ध बैलेंस में "लागू" किया
   जाता है, जिससे टोकन गोपनीय स्थानांतरण के लिए उपलब्ध हो जाते हैं।

यह खंड पहले चरण की व्याख्या करता है: सार्वजनिक टोकन बैलेंस को गोपनीय लंबित
बैलेंस में जमा करना।

निम्नलिखित आरेख सार्वजनिक बैलेंस से गोपनीय लंबित बैलेंस में टोकन जमा करने में
...
सार्वजनिक बैलेंस को गोपनीय लंबित बैलेंस में परिवर्तित करने के लिए,
...
निर्देश का उपयोग करें। प्रति जमा निर्देश
[अधिकतम राशि](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/mod.rs#L21)
2^48 तक सीमित है।

`spl_token_client` क्रेट एक `confidential_transfer_deposit` विधि प्रदान करता है
जो `Deposit` निर्देश के साथ एक लेनदेन बनाता और भेजता है, जैसा कि नीचे दिए गए
उदाहरण में दिखाया गया है।

### उदाहरण कोड

निम्नलिखित उदाहरण दिखाता है कि सार्वजनिक टोकन बैलेंस को गोपनीय लंबित बैलेंस में
कैसे जमा किया जाए।
