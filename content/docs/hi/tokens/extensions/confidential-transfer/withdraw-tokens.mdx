---
title: टोकन निकालें
description: गोपनीय स्थिति से टोकन निकालना सीखें।
---

## गोपनीय उपलब्ध बैलेंस से टोकन कैसे निकालें

गोपनीय उपलब्ध बैलेंस से सार्वजनिक बैलेंस में टोकन निकालने के लिए:

1. क्लाइंट साइड पर
   [दो प्रूफ](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/confidential-transfer/proof-generation/src/withdraw.rs#L22)
   बनाएँ:
   ...
   **इक्वैलिटी प्रूफ
   ...
   यह सत्यापित करता है कि निकासी के बाद शेष उपलब्ध बैलेंस साइफरटेक्स्ट उसके
   संबंधित [पेडरसन कमिटमेंट](https://en.wikipedia.org/wiki/Commitment_scheme) से
   मेल खाता है, यह सुनिश्चित करते हुए कि खाते का नया उपलब्ध बैलेंस सही ढंग से
   `remaining_balance = current_balance - withdraw_amount` के रूप में गणना किया
   गया है।
   ...
   **रेंज प्रूफ
   ...
   यह सत्यापित करता है कि निकासी के बाद शेष उपलब्ध बैलेंस गैर-नकारात्मक है और एक
   निर्दिष्ट सीमा के भीतर है।

2. प्रत्येक प्रूफ के लिए:

   - प्रूफ डेटा को सत्यापित करने के लिए ZK ElGamal प्रूफ प्रोग्राम को इनवोक
     करें।
   - अन्य निर्देशों में उपयोग करने के लिए प्रूफ-विशिष्ट मेटाडेटा को प्रूफ
     "कॉन्टेक्स्ट स्टेट" खाते में स्टोर करें।

3. दो प्रूफ खातों को प्रदान करते हुए
...
4. उन्हें बनाने के लिए उपयोग किए गए SOL को वापस पाने के लिए प्रूफ खातों को बंद
   करें।

निम्नलिखित आरेख गोपनीय उपलब्ध बैलेंस से सार्वजनिक बैलेंस में टोकन निकालने में
शामिल चरणों को दिखाता है:
...
गोपनीय उपलब्ध बैलेंस से सार्वजनिक बैलेंस में टोकन निकालने के लिए, आपको निम्न
करना होगा:

- क्लाइंट-साइड पर इक्वैलिटी प्रूफ और रेंज प्रूफ जनरेट करें
- प्रूफ को सत्यापित करने और "कॉन्टेक्स्ट स्टेट" खातों को इनिशियलाइज़ करने के लिए
  Zk ElGamal प्रूफ प्रोग्राम को इनवोक करें
- दो प्रूफ खातों को प्रदान करते हुए
  [ConfidentialTransferInstruction::Withdraw](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L493)
  निर्देश को इनवोक करें।
- rent वापस पाने के लिए दो प्रूफ खातों को बंद करें।
...
- `confidential_transfer_create_context_state_account` मेथड जो एक प्रूफ खाता
  बनाता है।
- `confidential_transfer_withdraw` मेथड जो `Withdraw` निर्देश को इनवोक करता है।
- `confidential_transfer_close_context_state_account` मेथड जो एक प्रूफ खाते को
  बंद करता है।

### उदाहरण कोड

निम्नलिखित उदाहरण दिखाता है कि गोपनीय उपलब्ध बैलेंस से सार्वजनिक बैलेंस में टोकन
कैसे निकालें।

उदाहरण चलाने के लिए, निम्न कमांड का उपयोग करके मेनेट से क्लोन किए गए Token
Extension Program के साथ एक स्थानीय validator शुरू करें। स्थानीय validator शुरू
करने के लिए आपके पास Solana CLI इंस्टॉल होना चाहिए।
...
<Callout type="info">
  ...
  है। उदाहरण कोड चलाने के लिए आपको मेनेट से Token Extension Program को क्लोन
  करना होगा।
</Callout>
