---
title: टोकन ट्रांसफर करें
description: एक टोकन अकाउंट से दूसरे में गोपनीय रूप से टोकन ट्रांसफर करना सीखें।
---

## एक टोकन अकाउंट से दूसरे में गोपनीय रूप से टोकन कैसे ट्रांसफर करें

एक टोकन अकाउंट से दूसरे में गोपनीय रूप से टोकन ट्रांसफर करने के लिए, भेजने वाले
और प्राप्तकर्ता दोनों के पास _rs`ConfidentialTransferAccount`_ स्थिति के साथ
कॉन्फ़िगर किए गए और गोपनीय ट्रांसफर के लिए स्वीकृत टोकन अकाउंट होने चाहिए। भेजने
वाले के टोकन अकाउंट में ट्रांसफर करने के लिए उपलब्ध गोपनीय बैलेंस भी होना चाहिए।

गोपनीय रूप से टोकन ट्रांसफर करने के लिए:

1. क्लाइंट साइड पर
   [तीन प्रूफ़](https://github.com/solana-program/token-2022/blob/d073cb89dbcd430387b5c6fb4b7157911351e4a3/confidential-transfer/proof-generation/src/transfer.rs#L35)
   बनाएँ:
   ...
   **इक्वैलिटी प्रूफ़
   ...
   यह सत्यापित करता है कि ट्रांसफर के बाद नया उपलब्ध बैलेंस साइफरटेक्स्ट उसके
   संबंधित [पेडरसन कमिटमेंट](https://en.wikipedia.org/wiki/Commitment_scheme) से
   मेल खाता है, यह सुनिश्चित करते हुए कि स्रोत अकाउंट का नया उपलब्ध बैलेंस सही
   ढंग से `new_balance = current_balance - transfer_amount` के रूप में गणना किया
   गया है।

   **साइफरटेक्स्ट वैलिडिटी प्रूफ़
   ...
   यह सत्यापित करता है कि ट्रांसफर राशि साइफरटेक्स्ट सभी तीन पक्षों (स्रोत,
   गंतव्य और ऑडिटर) के लिए उचित रूप से उत्पन्न किए गए हैं, यह सुनिश्चित करते हुए
   कि ट्रांसफर राशि प्रत्येक पक्ष की पब्लिक की के तहत सही ढंग से एन्क्रिप्ट की
   गई है।
   ...
   **रेंज प्रूफ़
   ...
   यह सत्यापित करता है कि नया उपलब्ध बैलेंस और ट्रांसफर राशि (लो/हाई बिट्स में
   विभाजित) सभी गैर-नकारात्मक हैं और एक निर्दिष्ट सीमा के भीतर हैं।

2. प्रत्येक प्रूफ़ के लिए:

   - प्रूफ़ डेटा को सत्यापित करने के लिए ZK ElGamal प्रूफ़ प्रोग्राम को इनवोक
     करें।
   - अन्य निर्देशों में उपयोग करने के लिए प्रूफ़-विशिष्ट मेटाडेटा को एक प्रूफ़
     "कॉन्टेक्स्ट स्टेट" अकाउंट में स्टोर करें।
...
3. [ConfidentialTransferInstruction::Transfer](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L604)
   निर्देश को इनवोक करें, प्रूफ़ कॉन्टेक्स्ट स्टेट अकाउंट्स प्रदान करते हुए।

4. उन्हें बनाने के लिए उपयोग किए गए SOL को पुनः प्राप्त करने के लिए प्रूफ़
   कॉन्टेक्स्ट स्टेट अकाउंट्स को बंद करें।

निम्नलिखित आरेख भेजने वाले के टोकन अकाउंट से प्राप्तकर्ता के टोकन अकाउंट में
टोकन ट्रांसफर करने में शामिल चरणों को दिखाता है।
...
एक टोकन अकाउंट से दूसरे में गोपनीय रूप से टोकन ट्रांसफर करने के लिए, आपको:

- समानता प्रमाण, सिफरटेक्स्ट वैधता प्रमाण, और रेंज प्रमाण क्लाइंट-साइड पर
  उत्पन्न करें
- प्रमाणों को सत्यापित करने और "context state" खातों को आरंभ करने के लिए Zk
  ElGamal प्रूफ प्रोग्राम को इनवोक करें
- तीन प्रूफ खातों को प्रदान करते हुए
  ...
  निर्देश को इनवोक करें
- rent वापस पाने के लिए तीनों प्रूफ खातों को बंद करें।

`spl_token_client` क्रेट निम्नलिखित मेथड्स प्रदान करता है:

- `confidential_transfer_create_context_state_account` मेथड जो एक प्रूफ खाता
  बनाता है।
- `confidential_transfer_transfer` मेथड जो `Transfer` निर्देश को इनवोक करता है।
- `confidential_transfer_close_context_state_account` मेथड जो प्रूफ खाते को बंद
  करता है।

### उदाहरण कोड

निम्नलिखित उदाहरण दिखाता है कि टोकन खातों के बीच गोपनीय रूप से टोकन कैसे
ट्रांसफर किए जाते हैं।

उदाहरण चलाने के लिए, निम्नलिखित कमांड का उपयोग करके मेननेट से क्लोन किए गए Token
Extensions Program के साथ एक लोकल वैलिडेटर शुरू करें। लोकल वैलिडेटर शुरू करने के
...
<Callout type="info">
  लेखन के समय, Confidential Transfers डिफ़ॉल्ट लोकल वैलिडेटर पर सक्षम नहीं है।
