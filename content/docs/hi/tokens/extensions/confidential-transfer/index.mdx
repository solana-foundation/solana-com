---
title: गोपनीय स्थानांतरण
description:
  गोपनीय स्थानांतरण एक्सटेंशन के बारे में जानें और इसका उपयोग टोकन मिंट्स और
  खातों में वैकल्पिक सुविधाएँ जोड़ने के लिए कैसे करें।
---

## गोपनीय स्थानांतरण क्या हैं?

गोपनीय स्थानांतरण आपको टोकन खातों के बीच स्थानांतरण राशि को प्रकट किए बिना टोकन
स्थानांतरित करने की सुविधा देते हैं। यह गोपनीयता-संरक्षित लेनदेन के लिए उपयोगी
है। केवल स्थानांतरण राशि और टोकन बैलेंस निजी रहते हैं। token account पते
सार्वजनिक रहते हैं।

- [प्रोटोकॉल अवलोकन](https://www.solana-program.com/docs/confidential-balances/overview) -
  अंतर्निहित क्रिप्टोग्राफिक प्रोटोकॉल पर विवरण
- [त्वरित प्रारंभ गाइड](https://www.solana-program.com/docs/confidential-balances#setup) -
  सेटअप और बुनियादी CLI कमांड्स
- [गोपनीय बैलेंस कुकबुक](https://github.com/solana-developers/Confidential-Balances-Sample) -
  गोपनीय स्थानांतरण एक्सटेंशन का उपयोग करने के लिए कोड स्निपेट्स

### यह कैसे काम करता है?

गोपनीय स्थानांतरण एक्सटेंशन Token Extensions Program में
[निर्देश](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/instruction.rs#L29)
जोड़ता है जो आपको स्थानांतरण राशि को प्रकट किए बिना खातों के बीच टोकन
...
गोपनीय टोकन स्थानांतरण का बुनियादी प्रवाह इस प्रकार है:

1. गोपनीय स्थानांतरण एक्सटेंशन के साथ एक mint account बनाएँ।
2. प्रेषक और प्राप्तकर्ता के लिए गोपनीय स्थानांतरण एक्सटेंशन के साथ token
   account बनाएँ।
3. प्रेषक खाते में टोकन मिंट करें।
4. प्रेषक के सार्वजनिक बैलेंस को **गोपनीय लंबित बैलेंस** में **जमा** करें।
5. प्रेषक के लंबित बैलेंस को **गोपनीय उपलब्ध बैलेंस** में **लागू** करें।
6. प्रेषक टोकन खाते से प्राप्तकर्ता टोकन खाते में गोपनीय रूप से टोकन
   **स्थानांतरित** करें।
7. प्राप्तकर्ता के लंबित बैलेंस को **गोपनीय उपलब्ध बैलेंस** में **लागू** करें।
8. प्राप्तकर्ता के गोपनीय उपलब्ध बैलेंस को **सार्वजनिक बैलेंस** में **निकालें**।

गोपनीय स्थानांतरण प्रवाह में चरणों के बारे में अधिक जानकारी के लिए, संबंधित
पृष्ठ देखें:

<Cards>
  <Card
    title="मिंट खाता बनाएँ"
    href="/docs/tokens/extensions/confidential-transfer/create-mint"
  >
    गोपनीय स्थानांतरण एक्सटेंशन के साथ mint account कैसे बनाएँ
  </Card>
  <Card
    title="टोकन खाता बनाएँ"
    href="/docs/tokens/extensions/confidential-transfer/create-token-account"
  >
    गोपनीय स्थानांतरण एक्सटेंशन के साथ token account कैसे कॉन्फ़िगर करें
  </Card>
  <Card
    title="टोकन जमा करें"
    href="/docs/tokens/extensions/confidential-transfer/deposit-tokens"
  >
    गोपनीय लंबित बैलेंस में टोकन कैसे जमा करें
  </Card>
  <Card
    title="लंबित बैलेंस लागू करें"
    href="/docs/tokens/extensions/confidential-transfer/apply-pending-balance"
  >
    लंबित बैलेंस को उपलब्ध गोपनीय बैलेंस में कैसे लागू करें
  </Card>
  <Card
    title="टोकन निकालें"
    href="/docs/tokens/extensions/confidential-transfer/withdraw-tokens"
  >
    गोपनीय उपलब्ध बैलेंस से टोकन कैसे निकालें
  </Card>
  <Card
    title="टोकन स्थानांतरित करें"
    href="/docs/tokens/extensions/confidential-transfer/transfer-tokens"
  >
    टोकन खातों के बीच गोपनीय रूप से टोकन कैसे स्थानांतरित करें
  </Card>
</Cards>

नीचे दिया गया आरेख गोपनीय टोकन हस्तांतरण के लिए बुनियादी प्रवाह का विस्तृत
अनुक्रम दिखाता है:
...
नीचे दिया गया Rust उदाहरण गोपनीय टोकन हस्तांतरण के लिए चरणों को दिखाता है जो
पिछले आरेख के अनुरूप हैं। स्पष्टता के लिए चरणों को सहायक फ़ंक्शन में विभाजित
किया गया है।

उदाहरण चलाने के लिए, निम्न कमांड का उपयोग करके मेननेट से क्लोन किए गए Token
Extension Program के साथ एक स्थानीय validator शुरू करें। स्थानीय validator का
उपयोग करने के लिए आपके पास Solana CLI इंस्टॉल होना चाहिए।
...
<Callout type="info">
  लेखन के समय, Confidential Transfers डिफ़ॉल्ट स्थानीय validator पर सक्षम नहीं
  है। उदाहरण कोड चलाने के लिए आपको मेननेट Token Extension Program को क्लोन करना
  होगा।
</Callout>
...
## Confidential Transfer निर्देश

Confidential Transfer एक्सटेंशन
[निर्देशों](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/instruction.rs#L29)
की पूरी सूची निम्नानुसार है:

| निर्देश                             | विवरण                                                                                                                                                             |
| ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`InitializeMint`_                | गोपनीय हस्तांतरण के लिए mint अकाउंट सेट करता है। इस निर्देश को _rs`TokenInstruction::InitializeMint`_ निर्देश के साथ एक ही transaction में शामिल किया जाना चाहिए। |
| _rs`UpdateMint`_                    | mint के लिए गोपनीय हस्तांतरण सेटिंग्स अपडेट करता है।                                                                                                              |
| _rs`ConfigureAccount`_              | गोपनीय हस्तांतरण के लिए token account सेट करता है।                                                                                                                |
| _rs`ApproveAccount`_                | यदि mint नए token account के लिए अनुमोदन की आवश्यकता है तो गोपनीय हस्तांतरण के लिए token account को मंजूरी देता है।                                               |
| _rs`EmptyAccount`_                  | token account को बंद करने की अनुमति देने के लिए लंबित और उपलब्ध गोपनीय बैलेंस को खाली करता है।                                                                    |
| _rs`Deposit`_                       | सार्वजनिक टोकन बैलेंस को लंबित गोपनीय बैलेंस में परिवर्तित करता है।                                                                                               |
| _rs`Withdraw`_                      | उपलब्ध गोपनीय बैलेंस को वापस सार्वजनिक बैलेंस में परिवर्तित करता है।                                                                                              |
| _rs`Transfer`_                      | गोपनीय रूप से token account के बीच टोकन ट्रांसफर करता है।                                                                                                         |
| _rs`ApplyPendingBalance`_           | जमा या हस्तांतरण के बाद लंबित बैलेंस को उपलब्ध बैलेंस में परिवर्तित करता है।                                                                                      |
| _rs`EnableConfidentialCredits`_     | token account को गोपनीय टोकन हस्तांतरण प्राप्त करने की अनुमति देता है।                                                                                            |
| _rs`DisableConfidentialCredits`_    | सार्वजनिक हस्तांतरण की अनुमति देते हुए भी आने वाले गोपनीय हस्तांतरण को ब्लॉक करता है।                                                                             |
| _rs`EnableNonConfidentialCredits`_  | token account को सार्वजनिक टोकन हस्तांतरण प्राप्त करने की अनुमति देता है।                                                                                         |
| _rs`DisableNonConfidentialCredits`_ | नियमित हस्तांतरण को ब्लॉक करके अकाउंट को केवल गोपनीय हस्तांतरण प्राप्त करने के लिए बनाता है।                                                                      |
| _rs`TransferWithFee`_               | शुल्क के साथ गोपनीय रूप से token account के बीच टोकन ट्रांसफर करता है।                                                                                            |
| _rs`ConfigureAccountWithRegistry`_  | _rs`VerifyPubkeyValidity`_ प्रूफ के बजाय _rs`ElGamalRegistry`_ अकाउंट का उपयोग करके गोपनीय हस्तांतरण के लिए token account को कॉन्फ़िगर करने का वैकल्पिक तरीका।    |
