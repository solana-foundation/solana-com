---
title: टोकन मिंट करें
description: टोकन के नए यूनिट्स कैसे मिंट करें, यह जानें।
---

## टोकन कैसे मिंट करें

टोकन मिंटिंग का अर्थ है टोकन प्रोग्राम पर
...
निर्देश को आमंत्रित करके टोकन की नई इकाइयां बनाने की प्रक्रिया। केवल वह पता जिसे
mint account पर मिंट अथॉरिटी के रूप में निर्दिष्ट किया गया है, नए टोकन मिंट कर
सकता है। इस निर्देश के लिए मिंट किए गए टोकन के गंतव्य के रूप में एक token
account का अस्तित्व भी आवश्यक है।
...
<Callout type="info">
  ...
  समान कार्यक्षमता प्राप्त करने के लिए समान कार्यान्वयन साझा करते हैं।
</Callout>
