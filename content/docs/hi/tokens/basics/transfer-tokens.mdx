...
description: टोकन अकाउंट्स के बीच टोकन ट्रांसफर करना सीखें।
---

## टोकन कैसे ट्रांसफर करें

टोकन ट्रांसफर करने में एक टोकन अकाउंट से दूसरे टोकन अकाउंट में टोकन भेजना शामिल
है जो एक ही mint से जुड़े हों। टोकन ट्रांसफर तब होता है जब आप टोकन प्रोग्राम पर
...
निर्देश को इनवोक करते हैं। केवल वह पता जो स्रोत token account के मालिक (अथॉरिटी)
के रूप में निर्दिष्ट है, अकाउंट से टोकन बाहर ट्रांसफर कर सकता है।
...
<Callout type="info">
  ...
  एक ही कार्यक्षमता प्राप्त करने के लिए समान कार्यान्वयन साझा करते हैं।
</Callout>
