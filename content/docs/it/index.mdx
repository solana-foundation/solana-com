...
Distribuisci la tua prima applicazione Solana - un semplice Counter Program
...
Gioca a 2048 su Solana dove ogni mossa invia una transazione. Clicca "Play" per
iniziare con un wallet devnet finanziato e usa i tasti freccia per giocare. Se
sei su mobile, scorri per controllare le tessere.
...
<Cards>
  ...
  <Card title="Cross Program Invocation" href="/docs/core/cpi">
    Come chiamare un program da un altro
  </Card>
</Cards>
...
aiutano a interagire con la rete nei linguaggi più popolari:
...
<Cards>
  ...
  >
    Requisiti hardware consigliati e SOL necessari per operare un validator
  </Card>
  <Card
