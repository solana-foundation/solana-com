...
| Provider                                | API per commissioni prioritarie                                                    |
| --------------------------------------- | ---------------------------------------------------------------------------------- |
...
L'approccio consigliato per impostare le commissioni prioritarie è prima
...
**Priorità = ((Limite unità di calcolo \* Prezzo unità di calcolo) + Commissione
...
- [`SetComputeUnitLimit`](https://github.com/anza-xyz/agave/blob/v2.1.13/sdk/src/compute_budget.rs#L42-L44)
  per impostare un limite di unità specifico.
...
di unità di calcolo con un prezzo per unità di calcolo pari a 0 (nessuna
