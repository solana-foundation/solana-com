...
Gli indirizzi derivati dai programmi (PDA) offrono agli sviluppatori su Solana
due principali casi d'uso:
...
I PDA sono indirizzi che derivano deterministicamente e sembrano chiavi
...
consente ai programmi di "firmare" per i PDA senza necessità di una chiave
privata.
