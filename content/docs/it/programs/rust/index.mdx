...
terminale. Questo comando stampa la chiave pubblica del keypair nel percorso
file specificato:
...
riutilizzato. Il tentativo di distribuire un programma con un program ID
...
aver chiuso un programma, devi generare un nuovo program ID. Per generare una
