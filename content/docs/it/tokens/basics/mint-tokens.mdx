...
su un Token Program. Solo l'indirizzo specificato come autorità di conio (mint
authority) sul mint account può coniare nuovi token. L'istruzione richiede anche
l'esistenza di un token account come destinazione dei token coniati.
