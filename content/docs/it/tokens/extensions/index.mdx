...
istruzioni aggiuntive chiamate estensioni. Le Extensions sono funzionalità
opzionali che puoi aggiungere a un mint token o a un token account. Puoi trovare
...
l'inizializzazione di uno dei due account, puoi abilitare specifiche estensioni
contemporaneamente per ottenere diverse funzionalità. La maggior parte delle
estensioni non può essere aggiunta dopo che un account è stato inizializzato.
Questa è una considerazione importante quando progetti il tuo token, poiché
dovrai pianificare in anticipo quali funzionalità vuoi che il tuo token
supporti. Le guide di integrazione per ciascuna estensione sono disponibili
nella
