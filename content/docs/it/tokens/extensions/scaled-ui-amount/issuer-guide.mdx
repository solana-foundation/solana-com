...
token o su un token account. Nota che una volta creato un token, non puoi
...
### Aggiornare il moltiplicatore UI amount

Per aggiornare il moltiplicatore UI amount, devi utilizzare il comando
