...
aggiungendo stati extra all'account mint. Questa sezione spiega come creare un
...
- **authority**: L'account che ha il permesso di modificare le impostazioni di
  confidential transfer per il mint e approvare nuovi account confidenziali se
  l'auto-approvazione è disabilitata.

- **auto_approve_new_accounts**: Quando impostato su true, gli utenti possono
  creare token account con i trasferimenti confidenziali abilitati di default.
...
Sebbene potresti scrivere queste istruzioni manualmente, il crate
