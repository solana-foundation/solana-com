...
aggiungendo stati aggiuntivi all'account mint. Questa sezione spiega come creare
...
- **auditor_elgamal_pubkey**: Un auditor opzionale che può decifrare gli importi
  ...
  conformità mantenendo al contempo la privacy rispetto al pubblico generale.
...
di Solana installata per avviare il validator locale.
