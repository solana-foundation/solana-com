...
I trasferimenti confidenziali ti permettono di trasferire token tra account
...
Il flusso base dei trasferimenti confidenziali di token è il seguente:
...
Solana installata per utilizzare il validator locale.
