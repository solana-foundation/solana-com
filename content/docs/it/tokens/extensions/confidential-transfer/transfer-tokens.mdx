...
confidenziali. L'account token del mittente deve anche avere un saldo
...
Il seguente diagramma mostra i passaggi coinvolti nel trasferimento di token da
un account token del mittente a un account token del destinatario.
