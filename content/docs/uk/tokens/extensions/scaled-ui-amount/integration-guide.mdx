...
| Відображення ребазованих балансів токенів   | Показ масштабованих балансів для торгівлі або надання ліквідності в інтерфейсі. (бекенд може продовжувати використовувати необроблені суми)                   | **P0**    |
| Підтримка дій з токенами                    | Кінцеві користувачі повинні вводити суми дій зі своїми балансами UiAmount (множник \* необроблена сума).                                                      | **P0**    |
...
| Внутрішнє відстеження необроблених балансів | Відстеження необроблених балансів для онлайн-транзакцій замість масштабованих балансів. Це буде точніше і простіше в управлінні в довгостроковій перспективі. | **P1**    |
...
| Відображення графіка історії цін            | Відображення масштабованих цін на графіку цін. Це включає перемасштабування історичних цін до поточного множника.                                             | **P1**    |
