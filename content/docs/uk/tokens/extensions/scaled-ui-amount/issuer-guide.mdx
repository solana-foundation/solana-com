...
не зможете змінити, які розширення активовані.
...
### Оновлення множника UI amount

Щоб оновити множник UI amount, вам потрібно використати команду
`update-ui-amount-multiplier`. Часова мітка є необов'язковою і може
використовуватися для встановлення власного часу початку для нового множника.
Якщо часова мітка не вказана, буде використано поточну часову мітку.
