...
1. **Конфіденційний очікуваний баланс**: Спочатку токени "депонуються" з
   публічного балансу до "очікуваного" конфіденційного балансу.
...
для конфіденційних переказів, очікуваний баланс має бути "застосований" до
доступного балансу.
...
Наступна діаграма показує кроки, пов'язані із застосуванням очікуваного балансу
...
<Callout type="info">
  ...
  локальному validator. Вам потрібно клонувати Token Extensions Program з
