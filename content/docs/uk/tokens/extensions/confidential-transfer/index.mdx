...
Для отримання додаткової інформації про кроки в процесі конфіденційного
...
Повний список інструкцій розширення Confidential Transfer
...
| Інструкція                          | Опис                                                                                                                                                                   |
| ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`InitializeMint`_                | Налаштовує mint account для конфіденційних переказів. Ця інструкція повинна бути включена в ту ж транзакцію, що й інструкція _rs`TokenInstruction::InitializeMint`_.   |
