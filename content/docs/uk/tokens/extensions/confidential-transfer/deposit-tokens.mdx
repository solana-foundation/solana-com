...
на одну інструкцію депозиту обмежена до 2^48.
...
<Callout type="info">
  На момент написання, конфіденційні перекази не активовані на стандартному
...
---CODE-PLACEHOLDER-a9c9c8a9c9c8a9c9c8a9c9c8a9c9c8a9---
