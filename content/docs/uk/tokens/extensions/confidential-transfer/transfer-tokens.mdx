...
_rs---INLINE-CODE-PLACEHOLDER-2915702bfb467dfedf86c5859c2822b4---_ та схвалені
для конфіденційних переказів. Token account відправника також повинен мати
доступний конфіденційний баланс для переказу.
...
1. Створіть
   ...
   **Доказ рівності
   ...
   Перевіряє, що новий доступний шифротекст балансу після переказу відповідає
   його відповідному
   [зобов'язанню Педерсена](https://en.wikipedia.org/wiki/Commitment_scheme),
   забезпечуючи правильне обчислення нового доступного балансу вихідного акаунта
   ...
   **Доказ діапазону
   ...
   низькі/високі біти) є невід'ємними та в межах вказаного діапазону.

2. Для кожного доказу:
   - Викликайте програму доказу ZK ElGamal для перевірки даних доказу.
   - Зберігайте метадані, специфічні для доказу, в акаунті "контекстного стану"
     доказу для використання в інших інструкціях.

3. Викликайте інструкцію
   ...
   надаючи акаунти контекстного стану доказу.

4. Закрийте акаунти контекстного стану доказу, щоб повернути SOL, використаний
   для їх створення.

Наступна діаграма показує кроки, необхідні для переказу токенів з token account
відправника на token account отримувача.
...
- Викликати програму доказу Zk ElGamal для перевірки доказів та ініціалізації
  рахунків "стану контексту"
- Викликати інструкцію
  [ConfidentialTransferInstruction::Transfer](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L604),
  надаючи три рахунки доказів
- Закрити три рахунки доказів, щоб повернути rent
...
клонованою з мейннету, використовуючи наступну команду. Для запуску локального
validator у вас має бути встановлений Solana CLI.
...
<Callout type="info">
  ...
  локальному validator. Ви повинні клонувати Token Extensions Program з
...
---CODE-PLACEHOLDER-a9e1c2d9c95e1edb0eed3aedf93b37e6---
