...
Переказ токенів передбачає переміщення токенів з одного token account на інший
...
у токен-програмі. Лише адреса, вказана як власник (authority) вихідного token
