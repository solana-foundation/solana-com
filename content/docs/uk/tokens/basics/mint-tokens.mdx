...
Карбування токенів — це процес створення нових одиниць токена шляхом виклику
інструкції
...
у токен-програмі. Лише адреса, вказана як mint authority у mint account, може
карбувати нові токени. Інструкція також вимагає наявності token account як місця
призначення для карбованих токенів.
