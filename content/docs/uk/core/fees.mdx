...
| Провайдер                               | API пріоритетних комісій                                                         |
| --------------------------------------- | -------------------------------------------------------------------------------- |
...
Рекомендований підхід для встановлення пріоритетних комісій — спочатку
[симулювати](/developers/guides/advanced/how-to-request-optimal-compute)
транзакцію для оцінки необхідних обчислювальних одиниць. Потім додати 10% запасу
безпеки до цієї оцінки та використовувати отримане значення як
`Compute Unit Limit`.
...
який визначає її пріоритетність відносно інших транзакцій, розраховується за
такою формулою:
...
Використовуйте ці інструкції для встановлення ліміту обчислювальних одиниць та
ціни для транзакції:
...
Якщо ви не надаєте ці інструкції, транзакція використовує стандартний ліміт
обчислювальних одиниць з ціною обчислювальної одиниці 0 (без комісії за
пріоритет).
