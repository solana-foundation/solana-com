...
- [Створити підключення](mention:connection)
- [Згенерувати keypair](mention:wallet) для оплати транзакції
- [Запросити airdrop](mention:airdrop) для фінансування keypair
...
Розрахуйте мінімальну кількість lamports, необхідну для mint account.

Функція `getMinimumBalanceForRentExemptMint` розраховує точну кількість SOL (у
