...
<Accordions>
<Accordion title="Демонстрація додатку">
...
## Спробуйте Solana: Гра 2048

Грайте в 2048 на Solana, де кожен хід відправляє транзакцію. Натисніть "Грати",
щоб почати з фінансованим гаманцем devnet, і використовуйте клавіші зі стрілками
для гри. Якщо ви на мобільному пристрої, проводьте пальцем, щоб керувати
плитками.
...
<Cards>
  ...
  >
    Рекомендовані вимоги до обладнання та кількість SOL, необхідна для роботи
    validator
  </Card>
  <Card
