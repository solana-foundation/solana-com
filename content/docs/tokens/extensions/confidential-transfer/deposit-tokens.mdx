...
To transfer tokens confidentially, you must first convert your public token
balance to a confidential balance. This conversion happens in two stages:
...
This section explains the first stage: depositing public tokens to the
confidential pending balance.

The following diagram shows the steps involved in depositing tokens to
confidential pending balance:
