...
accounts without revealing the token amount. This is useful for
...
```mermaid title="Confidential Transfer Detailed Flow"
sequenceDiagram
...
To use the Confidential Transfer extension, you need to enable it when creating
a token mint or token account.
