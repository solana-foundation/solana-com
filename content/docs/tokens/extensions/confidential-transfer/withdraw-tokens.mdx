...
1. Create
   ...
   **Equality Proof
   ...
   Verifies that the remaining balance ciphertext after the withdrawal matches
   its corresponding Pedersen commitment, ensuring the account's new available
   balance is correctly computed as
