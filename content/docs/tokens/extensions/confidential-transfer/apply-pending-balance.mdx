...
Before you can transfer tokens confidentially, you must first convert your
public token balance to a confidential balance. This conversion happens in two
stages:
...
participant CC as Receiver Token Account
...
async fn main() -> Result<()> {
    ...
    println!("Confidential transfer setup complete. Tokens are now in confidential state.");
    println!(
