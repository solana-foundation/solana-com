...
| 요구사항                         | 설명                                                                                                                  | 우선순위 |
| :------------------------------- | :-------------------------------------------------------------------------------------------------------------------- | :------- |
| 승수 업데이트 추적               | 스케일된 UI 금액 확장을 사용하는 토큰의 승수 업데이트를 추적합니다.                                                   | **P0**   |
...
| 과거 작업은 재조정되지 않아야 함 | 거래와 같은 과거 작업은 작업 시점의 정확한 스케일된 금액과 가격을 사용하여 표시해야 합니다.                           | **P1**   |
...
| 가격 기록 그래프 표시            | 가격 그래프에 스케일된 가격을 반영합니다. 여기에는 과거 가격을 현재 승수로 재조정하는 것이 포함됩니다.                | **P1**   |
