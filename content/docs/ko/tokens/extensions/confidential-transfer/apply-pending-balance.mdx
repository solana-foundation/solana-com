...
이 섹션에서는 두 번째 단계인 대기 잔액을 사용 가능한 잔액에 적용하는 방법을
설명합니다.
...
다음 다이어그램은 대기 잔액을 사용 가능한 잔액에 적용하는 과정의 단계를
보여줍니다:
...
<Callout type="info">
  작성 시점에서는 기본 로컬 검증자에서 기밀 전송이 활성화되어 있지 않습니다.
  예제 코드를 실행하려면 메인넷 토큰 익스텐션 프로그램을 복제해야 합니다.
</Callout>
