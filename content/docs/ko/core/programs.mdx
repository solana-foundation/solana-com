...
| 프로그램           | 프로그램 ID                                   | 설명                                                                                                   | 명령어                                                                                        |
| ------------------ | --------------------------------------------- | ------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------- |
| Secp256r1 프로그램 | `Secp256r1SigVerify1111111111111111111111111` | 최대 8개의 secp256r1 서명을 검증합니다. 서명, 공개 키 및 메시지를 받습니다. 실패 시 오류를 반환합니다. | [명령어](https://docs.rs/solana-secp256k1-recover/latest/solana_secp256k1_recover/index.html) |
