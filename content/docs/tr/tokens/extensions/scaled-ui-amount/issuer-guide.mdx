---
title: Ölçeklendirilmiş UI Miktar Yayınlayıcı Rehberi
description:
  Token'ın UI miktarını ölçeklendirmek için Ölçeklendirilmiş UI Miktar
...
`Mint` hesabındaki `scaled_ui_amount_extension` alanını `true` olarak
...
başlangıç zamanı belirlemek için kullanılabilir. Zaman damgası belirtilmezse,
mevcut zaman damgası kullanılacaktır.
