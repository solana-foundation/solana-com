...
hem de alıcının token hesapları
_rs---INLINE-CODE-PLACEHOLDER-2915702bfb467dfedf86c5859c2822b4---_ durumu ile
yapılandırılmış ve gizli transferler için onaylanmış olmalıdır. Gönderenin token
hesabında ayrıca transfer edilecek kullanılabilir gizli bakiye bulunmalıdır.
...
1. İstemci tarafında
   ...
   **Eşitlik Kanıtı
   ...
   şekilde `new_balance = current_balance - transfer_amount` olarak
   hesaplandığını sağlar.
   ...
   **Şifreli Metin Geçerlilik Kanıtı
   ...
   doğru şekilde oluşturulduğunu doğrular, transfer tutarının her tarafın açık
...
- Üç kanıt hesabını sağlayan
  [ConfidentialTransferInstruction::Transfer](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L604)
  talimatını çağırın
- Rent'i geri kazanmak için üç kanıt hesabını kapatın.
...
---CODE-PLACEHOLDER-c9c01a1e9c84e05c619c61e1c8f69048---
