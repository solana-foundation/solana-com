...
Token Extensions Program (Token 2022), uzantılar olarak adlandırılan ekstra
...
belirli bir durum ekler. Her iki hesabı başlatırken de, farklı işlevsellik için
belirli uzantıları aynı anda etkinleştirebilirsiniz. Çoğu uzantı, bir hesap
...
<Callout type="info">
  ...
  hesabında aynı anda etkinleştiremezsiniz. Örneğin, _rs`NonTransferable`_
...
Her uzantı, bir mint'e veya token hesabına ekstra durum ekleyerek özel
işlevsellik katar. Tüm uzantıya özgü durum, temel hesap veri türünü takip eden
