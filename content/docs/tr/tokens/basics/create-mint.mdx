...
Solana'daki her token, adresi ağ üzerindeki benzersiz tanımlayıcısı olan bir
mint account olarak var olur.
...
işlev görür. Bu mint hesabı hakkındaki detayları
...
1. Mint hesabı oluşturmak ve alan ayırmak için System Program'ı çağırın ve
   sahipliği Token Program'a aktarın.
2. Mint hesap verilerini başlatmak için Token Program'ı çağırın.
