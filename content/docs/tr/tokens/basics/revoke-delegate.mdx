---
title: Temsilciyi İptal Et
description: Token hesabı temsilcisini nasıl iptal edeceğinizi öğrenin.
---

## Temsilciyi nasıl iptal edersiniz

[`Revoke`](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/instruction.rs#L133C5-L133C11)
talimatı, şu anda onaylanmış temsilciden tüm transfer izinlerini kaldırır. İptal
işleminden sonra, temsilci artık hesabınızdan herhangi bir token aktaramaz.
Yalnızca token account sahibi bir temsilciyi iptal edebilir.

<Callout type="info">
  [Token
  Programı](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/instruction.rs#L140)
  ve [Token Extensions
  Programı](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/instruction.rs#L182)
