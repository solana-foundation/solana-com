...
2. Yeni hesabı fonlamak için
   [cüzdandan lamport transferi yapar](mention:lamports)
3. Hesabın [sahipliğini](mention:programId) Token Extensions programına
   (`TOKEN_2022_PROGRAM_ID`) atar
