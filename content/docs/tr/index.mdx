...
description:
  ...
  zinciridir. Solana'nın ölçeklenebilir blok zinciri uygulamaları geliştirmek
  isteyen geliştiriciler için neden en iyi seçenek olduğunu öğrenin.
---
...
İlk Solana uygulamanızı dağıtın - Anchor framework kullanılarak oluşturulmuş
...
<Cards>
  ...
  <Card title="Programlar" href="/docs/core/programs">
    Solana'daki smart contract'lar
  </Card>
  ...
  <Card title="Cross Program Invocation" href="/docs/core/cpi">
    Bir programdan diğerini nasıl çağıracağınız
  </Card>
</Cards>
