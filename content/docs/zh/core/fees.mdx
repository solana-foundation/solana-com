...
请参阅
[如何请求最佳计算](https://solana.com/zh/developers/guides/advanced/how-to-request-optimal-compute)
...
设置优先费用的推荐方法是首先
[模拟](https://solana.com/zh/developers/guides/advanced/how-to-request-optimal-compute)
