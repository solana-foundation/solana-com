...
SDK，该 SDK 已经在最近的 Solana 游戏创作活动中构建的多个游戏中使用。它支持 C#
`solnet`，C++ 和 Blueprints，支持铸造 Metaplex
NFT，提供游戏内钱包的支付处理示例等功能。
...
支持、一个 Anchor 程序、一个 React 应用程序以及一个已经配置好协同工作的 Unity 客户端。使用 Next.js 的一个好处是，您可以在后端和前端使用相同的代码，从而加快开发速度。
