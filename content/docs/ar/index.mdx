...
العب لعبة 2048 على سولانا حيث ترسل كل حركة معاملة. انقر على "العب" للبدء بمحفظة
...
إذا كنت تطور على جانب العميل، فإن مجموعات تطوير البرمجيات (SDK) التالية المساهم
