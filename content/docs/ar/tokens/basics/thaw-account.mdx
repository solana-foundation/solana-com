...
description: تعلم كيفية إلغاء تجميد حساب token مجمد.
---
...
تعكس عملية التجميد، مما يعيد الوظائف الكاملة لحساب token كان مجمدًا سابقًا. بعد
إلغاء التجميد، يمكن للحساب إرسال واستقبال الرموز بشكل طبيعي مرة أخرى. فقط سلطة
التجميد الخاصة بمنشئ الـtoken يمكنها إلغاء تجميد الحسابات.
