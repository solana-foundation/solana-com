...
تتضمن عملية تحويل الرموز نقل الرموز من حساب رمز إلى حساب رمز آخر يشتركان في نفس
العملة. يحدث تحويل الرموز عندما تقوم باستدعاء تعليمة
...
على برنامج الرموز. فقط العنوان المحدد كمالك (سلطة) لحساب الرمز المصدر يمكنه
