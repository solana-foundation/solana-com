...
description: تعلم كيفية إنشاء mint للرمز المميز SPL.
---

## ما هو حساب Mint؟

حساب mint هو نوع حساب في برامج Token على سولانا يمثل بشكل فريد الرمز المميز على
الشبكة ويخزن البيانات الوصفية العالمية حول الرمز المميز.
...
كل رمز مميز على سولانا موجود كحساب mint حيث يعتبر عنوان حساب mint هو المعرف
الفريد له على الشبكة.

على سبيل المثال، عملة الدولار الرقمية USD Coin (USDC) على سولانا لديها عنوان
mint `EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v`. يعمل عنوان mint هذا كمعرف
فريد لـ USD Coin عبر نظام سولانا البيئي بأكمله. يمكنك عرض تفاصيل حول حساب mint
هذا على
[Solana Explorer](https://explorer.solana.com/address/EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v).

## كيفية إنشاء حساب Mint

لإنشاء حساب Mint، قم باستدعاء تعليمة
...
يمكنك العثور على تنفيذات لهذه التعليمة
[هنا](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/processor.rs#L79).

تحتاج المعاملة لإنشاء حساب mint إلى تعليمتين:

1. استدعاء برنامج النظام لإنشاء وتخصيص مساحة لحساب mint ونقل الملكية إلى Token
   Program.
2. استدعاء Token Program لتهيئة بيانات حساب mint.
