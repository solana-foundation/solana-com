...
mint account هو نوع حساب في برامج Token Programs الخاصة بـسولانا يمثل بشكل فريد
الرمز المميز على الشبكة ويخزن البيانات الوصفية العالمية حول الرمز المميز.
...
كل رمز مميز على سولانا موجود كحساب عملة حيث يعتبر عنوان حساب العملة هو المعرف
الفريد له على الشبكة.

على سبيل المثال، عملة الدولار الرقمي USD Coin (USDC) على سولانا لديها عنوان
العملة `EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v`. يعمل عنوان العملة هذا
كمعرف فريد لـ USD Coin عبر نظام سولانا البيئي بأكمله. يمكنك عرض تفاصيل حول حساب
العملة هذا على
[Solana Explorer](https://explorer.solana.com/address/EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v).

## كيفية إنشاء حساب عملة

لإنشاء حساب عملة، قم باستدعاء التعليمة
...
تحتاج المعاملة لإنشاء حساب عملة إلى تعليمتين:

1. استدعاء System Program لإنشاء وتخصيص مساحة لحساب العملة ونقل الملكية إلى
   Token Program.
2. استدعاء Token Program لتهيئة بيانات حساب العملة.
