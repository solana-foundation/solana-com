...
لاستخدام امتداد مبلغ واجهة المستخدم المقياس، تحتاج إلى تمكينه على عملة رمزية أو
حساب رمزي. لاحظ أنه بمجرد إنشاء الرمز، لا يمكنك تعديل الامتدادات التي تم
تمكينها.
...
لتحديث مضاعف مبلغ واجهة المستخدم، تحتاج إلى استخدام الأمر
