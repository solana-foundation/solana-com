...
| عرض أرصدة الرموز المعاد تعيين قاعدتها       | إظهار الأرصدة المقياسية للتداول أو توفير السيولة على واجهة المستخدم. (يمكن للخادم الخلفي الاستمرار في استخدام المبالغ الأولية) | **P0**   |
| دعم إجراءات الرموز                          | يجب على المستخدمين النهائيين إدخال كميات الإجراءات بأرصدة واجهة المستخدم الخاصة بهم (المضاعف × المبلغ الأولي).                 | **P0**   |
| يجب ألا يتم إعادة تحجيم الإجراءات التاريخية | يجب عرض الإجراءات التاريخية مثل عمليات التداول باستخدام المبلغ المقياسي الدقيق والسعر في وقت الإجراء.                          | **P1**   |
