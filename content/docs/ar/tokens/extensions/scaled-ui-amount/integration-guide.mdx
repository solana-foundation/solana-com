...
| عرض أرصدة الرموز المعاد تعيين قاعدتها | عرض الأرصدة المقياسية للتداول أو توفير السيولة على واجهة المستخدم. (يمكن للخادم الخلفي الاستمرار في استخدام المبالغ الأولية) | **P0**   |
| دعم إجراءات الرموز                    | يجب على المستخدمين النهائيين إدخال مبالغ الإجراءات بأرصدة UiAmount الخاصة بهم (المضاعف \* المبلغ الأولي).                    | **P0**   |
| عدم إعادة تحجيم الإجراءات التاريخية   | يجب عرض الإجراءات التاريخية مثل عمليات التداول باستخدام المبلغ والسعر المقياسي الدقيق في وقت الإجراء.                        | **P1**   |
| تتبع الأرصدة الأولية داخليًا          | تتبع الأرصدة الأولية لمعاملات السلسلة بدلاً من الأرصدة المقياسية. سيكون هذا أكثر دقة وأسهل في الإدارة على المدى الطويل.      | **P1**   |
...
| عرض رسم بياني لتاريخ الأسعار          | عكس الأسعار المقياسية في الرسم البياني للسعر. يتضمن ذلك إعادة تحجيم الأسعار التاريخية إلى المضاعف الحالي.                    | **P1**   |
| تحجيم أساس التكلفة                    | يجب تحجيم التكلفة لكل سهم وفقًا للمضاعف الحالي.                                                                              | **P1**   |
