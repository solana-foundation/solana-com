...
يشرح هذا القسم المرحلة الأولى: إيداع رصيد الرموز العام إلى الرصيد السري المعلق.
...
يوضح المثال التالي كيفية إيداع رصيد الرموز العام إلى الرصيد السري المعلق.

لتشغيل المثال، قم بتشغيل validator محلي مع برنامج Token Extension مستنسخ من
الشبكة الرئيسية باستخدام الأمر التالي. يجب أن يكون لديك واجهة سطر أوامر Solana
مثبتة لبدء تشغيل validator المحلي.
...
<Callout type="info">
  في وقت كتابة هذا المقال، لم يتم تمكين التحويلات السرية على validator المحلي
