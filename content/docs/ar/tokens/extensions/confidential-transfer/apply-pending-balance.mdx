...
لتشغيل المثال، قم بتشغيل validator محلي مع Token Extensions Program المستنسخ من
الشبكة الرئيسية باستخدام الأمر التالي. يجب أن يكون لديك Solana CLI مثبتًا لبدء
تشغيل validator المحلي.
...
<Callout type="info">
  في وقت كتابة هذا المحتوى، لم يتم تفعيل التحويلات السرية على المصادق المحلي
