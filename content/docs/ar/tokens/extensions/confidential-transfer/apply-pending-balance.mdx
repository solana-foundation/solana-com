...
قبل أن يمكن تحويل الرموز بسرية، يجب تحويل رصيد الرموز العام إلى رصيد سري. تحدث
...
عندما يتم "إيداع" الرموز من الرصيد العام أو عندما يتم تحويل الرموز بسرية من
...
لتحويل الرصيد المعلق إلى رصيد متاح، قم باستدعاء التعليمة
...
لتشغيل المثال، قم بتشغيل validator محلي مع برنامج Token Extensions مستنسخ من
