...
تتيح لك التحويلات السرية نقل الرموز بين token account دون الكشف عن مبلغ التحويل.
هذا مفيد للمعاملات التي تحافظ على الخصوصية. فقط مبالغ التحويل وأرصدة الرموز هي
التي تكون خاصة. أما عناوين token account فتبقى عامة.
...
2. إنشاء token account مع ملحق التحويل السري للمرسل والمستلم.
3. سك الرموز في حساب المرسل.
...
<Cards>
  ...
  >
    كيفية تحويل الرموز بسرية بين token account
  </Card>
</Cards>
...
أوامر سولانا مثبتة لاستخدام الـ validator المحلي.
...
| _rs`UpdateMint`_                    | تحديث إعدادات التحويل السري لـ mint.                                                                                                |
| _rs`ConfigureAccount`_              | إعداد حساب token للتحويلات السرية.                                                                                                  |
| _rs`ApproveAccount`_                | الموافقة على حساب token للتحويلات السرية إذا كان الـ mint يتطلب موافقة لحسابات الـ token الجديدة.                                   |
| _rs`EmptyAccount`_                  | تفريغ الأرصدة السرية المعلقة والمتاحة للسماح بإغلاق حساب token.                                                                     |
| _rs`Deposit`_                       | تحويل رصيد الـ token العام إلى رصيد سري معلق.                                                                                       |
| _rs`Withdraw`_                      | تحويل الرصيد السري المتاح مرة أخرى إلى رصيد عام.                                                                                    |
| _rs`Transfer`_                      | تحويل الرموز بين حسابات الـ token بشكل سري.                                                                                         |
| _rs`ApplyPendingBalance`_           | تحويل الرصيد المعلق إلى رصيد متاح بعد الإيداعات أو التحويلات.                                                                       |
| _rs`EnableConfidentialCredits`_     | السماح لحساب token باستلام تحويلات الرموز السرية.                                                                                   |
| _rs`DisableConfidentialCredits`_    | حظر التحويلات السرية الواردة مع السماح بالتحويلات العامة.                                                                           |
| _rs`EnableNonConfidentialCredits`_  | السماح لحساب token باستلام تحويلات الرموز العامة.                                                                                   |
| _rs`DisableNonConfidentialCredits`_ | حظر التحويلات العادية لجعل الحساب يستقبل فقط التحويلات السرية.                                                                      |
| _rs`TransferWithFee`_               | تحويل الرموز بين حسابات الـ token بشكل سري مع رسوم.                                                                                 |
| _rs`ConfigureAccountWithRegistry`_  | طريقة بديلة لتكوين حسابات الـ token للتحويلات السرية باستخدام حساب _rs`ElGamalRegistry`_ بدلاً من إثبات _rs`VerifyPubkeyValidity`_. |
