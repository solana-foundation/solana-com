...
4. إغلاق حسابات الإثبات لاسترداد SOL المستخدم لإنشائها.
...
- إنشاء إثبات مساواة وإثبات نطاق من جانب العميل
...
أوامر Solana مثبتة لبدء تشغيل الـvalidator المحلي.
...
<Callout type="info">
  في وقت كتابة هذا النص، لم يتم تمكين التحويلات السرية (Confidential Transfers)
  على الـvalidator المحلي الافتراضي. يجب عليك استنساخ برنامج Token Extension
  Program من الشبكة الرئيسية لتشغيل كود المثال.
</Callout>
