...
<Callout type="info">
  لاحظ أن الشبكة على مستكشف سولانا يجب أن تكون أيضًا localhost. خيار "عنوان RPC
...
أضف الكود التالي إلى `examples/client.rs`. هذا هو نص برمجي لعميل Rust يقوم
بتمويل keypair جديد لدفع رسوم المعاملات ثم يستدعي برنامج مرحبا بالعالم.
...
لإغلاق برنامج، استخدم الأمر `solana program close <PROGRAM_ID>`. على سبيل
المثال:
...
محاولة nنشر برنامج بمعرف برنامج تم إغلاقه مسبقًا ستؤدي إلى حدوث خطأ.
...
عليك إنشاء معرّف برنامج جديد. لإنشاء زوج مفاتيح جديد للبرنامج، قم بتشغيل الأمر
التالي:
...
<Callout type="info">
  ...
  والذي سيقوم بإنشاء ملف زوج مفاتيح جديد.
</Callout>
