...
| ---------------- | --------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| برنامج Secp256r1 | `Secp256r1SigVerify1111111111111111111111111` | يتحقق من صحة ما يصل إلى 8 توقيعات secp256r1. يأخذ التوقيع والمفتاح العام والرسالة. يعيد خطأ في حالة فشل أي منها. | [التعليمات](https://docs.rs/solana-secp256k1-recover/latest/solana_secp256k1_recover/index.html) |
