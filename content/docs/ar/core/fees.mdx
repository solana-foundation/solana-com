...
النهج الموصى به لتعيين رسوم الأولوية هو أولاً
[محاكاة](/developers/guides/advanced/how-to-request-optimal-compute) المعاملة
لتقدير وحدات الحوسبة المطلوبة. ثم، إضافة هامش أمان بنسبة 10% إلى هذا التقدير
واستخدام القيمة الناتجة كـ `Compute Unit Limit`.
...
إذا لم تقدم هذه التعليمات، فإن المعاملة تستخدم حد وحدة الحوسبة الافتراضي مع سعر
...
| مجموعة أدوات تطوير البرمجيات   | مرجع الشفرة المصدرية                                                                                                           |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ |
