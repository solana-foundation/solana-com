...
Anweisung im Token-Programm. Nur die Adresse, die als Prägeautorität im mint
account angegeben ist, kann neue Tokens prägen. Die Anweisung erfordert auch die
Existenz eines token account als Ziel für die geprägten Tokens.
