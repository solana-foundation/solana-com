...
Das Prägen von Tokens bezieht sich auf den Prozess der Erstellung neuer
Token-Einheiten durch Aufruf der
...
Anweisung in einem Token-Programm. Nur die Adresse, die als mint authority im
mint account angegeben ist, kann neue Tokens prägen. Die Anweisung erfordert
auch die Existenz eines token account als Ziel für die geprägten Tokens.
