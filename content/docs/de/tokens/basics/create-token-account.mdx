...
1. Eine spezifische Mint (der Token-Typ, den der token account hält)
...
- Circle (der USD Coin-Emittent) hat einen token account unter
...
1. Rufen Sie das System Program auf, um Speicherplatz für ein token account zu
...
System Program auf, um das token account zu erstellen, und ruft das Token
