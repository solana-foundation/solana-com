...
Token-Mint oder ein token account aktivieren. Beachten Sie, dass Sie nach der
...
### Aktualisieren des UI-Amount-Multiplikators

Um den UI-Amount-Multiplikator zu aktualisieren, müssen Sie den Befehl
