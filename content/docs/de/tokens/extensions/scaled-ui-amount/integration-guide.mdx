...
liegenden Berechnungen und Überweisungen erfolgen alle mit den Rohbeträgen im
Programm.
...
- Klare und unkomplizierte Richtlinien für Teams bereitstellen, um eine
  ...
  schaffen
- Identifizierung und Planung von Arbeiten, um den Aufwand zu reduzieren, den
  Teams für die Integration mit der Scaled UI Amount-Erweiterung leisten müssen
...
- Wann immer Sie Beträge für Token anzeigen, die die skalierte
...
## Token-Beträge in Transaktionen (Überweisungen / Tauschgeschäfte usw.)
...
| Bildungsinhalte oder Erklärungen       | Kurze Beschreibungen oder Tooltips, die erklären, wie skalierte Token funktionieren.                                        | **P2**    |
