...
eines Kontos können Sie bestimmte Extensions gleichzeitig für verschiedene
Funktionalitäten aktivieren. Die meisten Extensions können nach der
...
`tlv_data` (das den Extension-Status enthält) entsprechend den spezifischen
Extension- Typen, die für dieses Konto aktiviert sind, weiter deserialisieren.
