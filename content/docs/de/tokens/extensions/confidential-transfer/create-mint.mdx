...
1. **Erstellen des Mint Accounts**: Rufen Sie die _rs`CreateAccount`_ Anweisung
   des System Programs auf, um den mint account zu erstellen.
...
3. **Initialisieren des Mints**: Rufen Sie die _rs`Instruction::InitializeMint`_
   Anweisung des Token Extensions Programs auf, um den Standard-Mint- Status zu
   initialisieren.
