...
1. Erstellen Sie
   ...
   **Gleichheitsnachweis
   ...
   Überprüft, ob der nach der Abhebung verbleibende Chiffretext des verfügbaren
   Guthabens mit dem entsprechenden
...
4. Schließen Sie die Nachweiskonten, um das für ihre Erstellung verwendete SOL
   zurückzugewinnen.
...
- Das Zk ElGamal-Nachweis-Programm aufrufen, um die Nachweise zu verifizieren
  und die "Kontext-Zustand"-Konten zu initialisieren
- Die
  [ConfidentialTransferInstruction::Withdraw](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L493)
...
<Callout type="info">
  ...
  Standard-lokalen validator nicht aktiviert. Sie müssen das Token Extension
