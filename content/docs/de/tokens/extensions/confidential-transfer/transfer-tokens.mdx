...
1. Erstellen Sie
   ...
   **Chiffretext-Gültigkeitsnachweis
   ...
   Überprüft, ob die Überweisungsbetrag-Chiffretexte für alle drei Parteien
...
3. Rufen Sie die
   ...
   Anweisung auf und geben Sie die Nachweis-Kontextstatus-Konten an.
...
Extensions Program, das von der Mainnet geklont wurde, mit dem folgenden Befehl.
Du musst die Solana CLI installiert haben, um den lokalen validator zu starten.
...
<Callout type="info">
  Zum Zeitpunkt des Schreibens sind die vertraulichen Transfers im
  Standard-Lokalvalidator nicht aktiviert. Du musst das Token Extensions Program
  von der Mainnet klonen, um den Beispielcode auszuführen.
</Callout>
