...
2. Für jeden Beweis:
   - Rufen Sie das ZK ElGamal-Beweisprogramm auf, um die Beweisdaten zu
     verifizieren.
   - Speichern Sie die beweispezifischen Metadaten in einem
     "Kontext-Status"-Konto, um sie in anderen Anweisungen zu verwenden.
...
einem Token-Konto des Absenders auf ein Token-Konto des Empfängers beteiligt
sind.
...
- Die
  [ConfidentialTransferInstruction::Transfer](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L604)
  Anweisung aufrufen und die drei Beweis-Konten bereitstellen.
...
Das folgende Beispiel zeigt, wie Token vertraulich zwischen Token-Konten
...
<Callout type="info">
  Zum Zeitpunkt der Erstellung sind die vertraulichen Übertragungen auf dem
