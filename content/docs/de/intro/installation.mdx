...
Dieser Abschnitt beschreibt die optionale Einrichtung von KI-Tools, die du zur
Beschleunigung deiner Solana-Entwicklung nutzen kannst.

| Tool     | Beschreibung                                                                                           | Link                        |
| -------- | ------------------------------------------------------------------------------------------------------ | --------------------------- |
| MCP      | MCP-Server, mit dem du dich verbinden kannst, um die KI-unterstützte Solana-Entwicklung zu verbessern. | https://mcp.solana.com/     |
| LLMs.txt | LLM-optimierte Dokumentation, die du zur Schulung von LLMs mit Solana-Dokumenten verwenden kannst.     | https://solana.com/llms.txt |
...
Um Transaktionen mit der Solana CLI zu senden, benötigst du eine mit SOL
finanzierte Solana-Wallet.
...
Um die Adresse (öffentlichen Schlüssel) Ihrer Wallet anzuzeigen, führen Sie
...
Fordern Sie einen Airdrop von SOL für Ihre Wallet an, um Transaktionen und
...
Fordern Sie dann einen Airdrop von Devnet-SOL an:
...
Devnet-Airdrops beschränken Anfragen auf 5 SOL pro Anfrage. Wenn Sie auf
Ratenbegrenzungen stoßen oder Fehler auftreten, versuchen Sie stattdessen den
[Web Faucet](https://faucet.solana.com) zu verwenden.

</Callout>

Um den SOL-Kontostand Ihrer Wallet zu überprüfen, führen Sie folgenden Befehl
aus:
...
Um Ihr Projekt zu deployen, führen Sie den folgenden Befehl aus:
...
Dieser Befehl baut, deployt und führt die Tests für dein Projekt aus.

Wenn du `localnet` als `cluster` in `Anchor.toml` verwendest, startet Anchor
automatisch einen lokalen Validator, deployt dein Programm, führt Tests aus und
