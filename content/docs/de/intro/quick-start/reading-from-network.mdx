...
vorstellen, wobei jeder Eintrag ein Konto mit demselben Basis-
...
Konto, das dem System-Programm gehört. Alle "Wallet"-Konten sind einfach Konten
im Besitz des System-Programms, die SOL halten und Transaktionen signieren
können.
...
gehört, welches eines der eingebauten Programme von Solana ist. Wallet-Konten
werden hauptsächlich verwendet, um SOL zu halten (verfolgt im `lamports` Feld)
und um Transaktionen zu signieren.
...
| `owner`      | Das Konto gehört einem Loader-Programm, einer Kategorie von eingebauten Programmen, die ausführbare program accounts auf Solana besitzen. (`BPFLoader2111111111111111111111111111111111`) |
...
Tokens berechtigt sind. Die Adresse des Mint accounts identifiziert einen Token
...
Dies sind die wichtigsten Punkte zu den Daten des Mint accounts:
