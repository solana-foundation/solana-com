...
mitteilt, was zu tun ist. Das Senden der Transaktion ist wie das Verschicken des
...
Program seinen lamport-Kontostand reduzieren kann. Das Sender- und
Empfängerkonto müssen beschreibbar sein (`is_writable`), da sich ihre
lamport-Kontostände ändern.

Nach dem Senden der Transaktion verarbeitet das System Program die Überweisungs-
Anweisung. Das System Program aktualisiert dann die lamport-Kontostände beider
...
nachzuschlagen. Die Transaktionssignatur ist einfach die erste Signatur der
