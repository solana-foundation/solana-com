...
Bei ausführbaren Konten enthält das Feld `owner` die Programm-ID eines
Loader-Programms. Loader-Programme sind integrierte Programme, die für das Laden
und Verwalten von ausführbaren Programmkonten verantwortlich sind.
...
müsste, um seine Daten im Netzwerk zu erhalten. Dieser
Rent-Erfassungsmechanismus wurde jedoch inzwischen eingestellt.
...
| [Programmbesitz zuweisen](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/system/src/system_processor.rs#L113) | Sobald das System Program ein Konto erstellt hat, kann es den festgelegten Programmbesitzer einem anderen program account zuweisen. So übernehmen benutzerdefinierte Programme die Eigentümerschaft neuer Konten, die vom System Program erstellt wurden. |
...
Beachte, dass alle "Wallet"-Konten auf Solana "System-Konten" sind, die dem
System Program gehören. Das lamport-Guthaben in diesen Konten zeigt die Menge an
SOL, die der Wallet gehört. Nur System-Konten können Fee bezahlen.
...
Führe den Code aus, um die Ausgabe zu sehen. Beachte, dass das `owner`Feld des
Konten das System Program mit der Adresse `11111111111111111111111111111111`
ist.
