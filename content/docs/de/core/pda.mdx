...
entsprechenden privaten Schlüssel und kann keine kryptografischen Operationen
...
#### Ableiten einer PDA mit optionalem Adress-seed
...
optionalen seeds angehängt wird. Die Ableitungsfunktion durchläuft Bump-Werte,
beginnend bei 255 und dekrementiert um 1, bis ein Wert eine gültige
