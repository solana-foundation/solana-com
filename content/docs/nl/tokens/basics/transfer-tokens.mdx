...
instructie aanroept op een token program. Alleen het adres dat is gespecificeerd
als de eigenaar (authority) van het bron-token account kan tokens uit het
account overmaken.
