...
1. Roep het System Program aan om ruimte te creëren en toe te wijzen voor een
   token account en draag het eigendom over aan het Token Program.
...
De instructie om een associated token account aan te maken roept automatisch het
System Program aan om het token account te creëren en roept het Token Program
