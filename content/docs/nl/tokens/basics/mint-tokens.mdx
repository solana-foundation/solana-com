...
Het minten van tokens verwijst naar het proces van het creëren van nieuwe
eenheden van een token door het aanroepen van de
...
instructie op een Token Program. Alleen het adres dat is gespecificeerd als de
mint authority op de mint account kan nieuwe tokens minten. De instructie
vereist ook het bestaan van een token account als bestemming voor de geminte
tokens.
