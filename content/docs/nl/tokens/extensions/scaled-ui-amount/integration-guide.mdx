...
| Vereiste                              | Beschrijving                                                                                                                                     | Prioriteit |
| :------------------------------------ | :----------------------------------------------------------------------------------------------------------------------------------------------- | :--------- |
| Volg vermenigvuldigingsfactor-updates | Volg vermenigvuldigingsfactor-updates voor tokens die de geschaalde ui-hoeveelheidsextensie gebruiken.                                           | **P0**     |
...
| Ondersteuning voor tokenacties        | Eindgebruikers moeten actie-hoeveelheden invoeren met hun UiAmount-saldi (vermenigvuldigingsfactor \* ruwe hoeveelheid).                         | **P0**     |
...
| Toon prijshistoriekgrafiek            | Weerspiegel de geschaalde prijzen in de prijsgrafiek. Dit omvat het herschalen van historische prijzen naar de huidige vermenigvuldigingsfactor. | **P1**     |
| Schaal kostenbasis                    | Kosten per aandeel moeten worden geschaald naar de huidige vermenigvuldigingsfactor.                                                             | **P1**     |
