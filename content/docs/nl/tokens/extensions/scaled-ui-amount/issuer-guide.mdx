...
### De UI amount multiplier bijwerken
...
en kan worden gebruikt om een aangepaste starttijd voor de nieuwe multiplier in
te stellen. Als er geen tijdstempel wordt opgegeven, wordt de huidige
tijdstempel gebruikt.
