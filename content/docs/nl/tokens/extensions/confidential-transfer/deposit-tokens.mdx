...
description: Leer hoe je tokens naar een vertrouwelijke status kunt storten.
---

## Hoe tokens naar een vertrouwelijk wachtend saldo te storten
...
1. **Vertrouwelijk wachtend saldo**: In eerste instantie worden tokens "gestort"
   van het openbare saldo naar een "wachtend" vertrouwelijk saldo.
...
Dit gedeelte legt de eerste fase uit: het storten van het openbare tokensaldo
naar het vertrouwelijke wachtende saldo.

Het volgende diagram toont de stappen die betrokken zijn bij het storten van
tokens van het openbare saldo naar het vertrouwelijke wachtende saldo:
...
Het volgende voorbeeld laat zien hoe je een openbaar tokensaldo naar een
vertrouwelijk wachtend saldo kunt storten.
...
<Callout type="info">
  ...
  ingeschakeld op de standaard lokale validator. Je moet het Token Extensions
...
---CODE-PLACEHOLDER-a9c6a1e8c0f9d9b8e8f9c0f9d9b8e8f9---
