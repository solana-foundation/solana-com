...
description: Leer hoe je tokens naar confidentiële status kunt storten.
---

## Hoe tokens naar confidentieel wachtend saldo te storten
...
1. **Confidentieel wachtend saldo**: In eerste instantie worden tokens "gestort"
   van openbaar saldo naar een "wachtend" confidentieel saldo.
2. **Confidentieel beschikbaar saldo**: Het wachtende saldo wordt vervolgens
   "toegepast" op het beschikbare saldo, waardoor de tokens beschikbaar worden
   voor confidentiële overdrachten.

Dit gedeelte legt de eerste fase uit: het storten van openbaar tokensaldo naar
het confidentiële wachtende saldo.

Het volgende diagram toont de stappen die betrokken zijn bij het storten van
tokens van het openbare saldo naar het confidentiële wachtende saldo:
...
Om een openbaar saldo om te zetten naar een confidentieel wachtend saldo, roep
je de
...
Het volgende voorbeeld laat zien hoe je openbaar tokensaldo naar confidentieel
