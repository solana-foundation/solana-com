...
_rs---INLINE-CODE-PLACEHOLDER-2915702bfb467dfedf86c5859c2822b4---_ status en
...
1. Creëer
   ...
   **Ciphertekst Validiteitsbewijs
   ...
   Verifieert dat de overboekingsbedrag-cipherteksten correct zijn gegenereerd
   voor alle drie partijen (bron, bestemming en auditor), wat verzekert dat het
   overboekingsbedrag correct is versleuteld onder de publieke sleutel van elke
   partij.
...
4. Sluit de bewijs context state accounts om de SOL te herstellen die gebruikt
   is om ze aan te maken.
...
- Roep de
  [ConfidentialTransferInstruction::Transfer](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L604)
  instructie aan en lever de drie bewijs-accounts.
- Sluit de drie bewijs-accounts om de rent terug te krijgen.
