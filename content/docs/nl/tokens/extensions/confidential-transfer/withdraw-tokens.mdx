...
1. Creëer
   ...
   **Gelijkheidsbewijsdata
   ...
   waardoor wordt gegarandeerd dat het nieuwe beschikbare saldo van de rekening
   correct wordt berekend als
...
<Callout type="info">
  ...
  de standaard lokale validator. Je moet het Token Extension Program van het
