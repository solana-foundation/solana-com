...
Het Keypair Path verwijst naar de standaard Solana-wallet (keypair) die door de
...
Om een keypair te genereren op het standaard Keypair Path, voer je het volgende
commando uit:
...
Vraag een airdrop van SOL aan voor je wallet om transacties en programma-
deployments te betalen.
