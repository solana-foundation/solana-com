...
### Implementeer je eerste Solana-applicatie
...
<Cards>
  ...
  >
    Implementeer je eerste Solana-applicatie op Vercel
  </Card>
  <Card
...
Implementeer je eerste Solana-applicatie - een eenvoudig tellerprogramma gebouwd
met het Anchor-framework. Dit voorbeeld behandelt alle kernconcepten van Solana
om te beginnen met bouwen op Solana. Bekijk de broncode
...
Speel 2048 op Solana waarbij elke zet een transactie verstuurt. Klik op "Spelen"
...
bijgedragen SDK's je om in populaire programmeertalen met het netwerk te
communiceren:
...
<Cards>
  ...
  >
    Een validator opzetten en voor het eerst verbinding maken met een cluster
  </Card>
</Cards>
