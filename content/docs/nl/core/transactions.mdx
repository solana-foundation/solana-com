...
Voer de onderstaande voorbeelden uit om de structuur te zien van een transactie
met een enkele SOL-overboekingsinstructie.
...
De volgende voorbeelden tonen de transactiebericht-output van de vorige
codefragmenten. Het exacte formaat verschilt afhankelijk van de SDK, maar bevat
dezelfde informatie.
...
structuur hebben die vergelijkbaar is met het volgende fragment. Je kunt de
transactie ook inspecteren met behulp van
