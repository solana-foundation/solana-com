...
- [Anchor](https://www.anchor-lang.com/docs): Een framework ontworpen voor
  ...
  om programma's te schrijven, met behulp van Rust macros om boilerplate code te
  verminderen. Voor beginners wordt aangeraden om te starten met het Anchor
  framework.
...
- [Native Rust](/docs/programs/rust): Deze benadering omvat het schrijven van
  ...
  meer flexibiliteit maar komt met verhoogde complexiteit.
...
- **Verificatietools**: De
  ...
  van Ellipsis Labs stelt gebruikers in staat om on-chain programma's
  onafhankelijk te verifiëren tegen gepubliceerde broncode.
...
| v4     | `LoaderV411111111111111111111111111111111111` | v4 zal naar verwachting de standaard loader worden                                  | [Instructies](https://docs.rs/solana-loader-v4-interface/latest/solana_loader_v4_interface/instruction/enum.LoaderV4Instruction.html)          |
...
programma omdat het accounteigendom van elk programma bij de loader berust.
...
neemt van de volgende struct die in de instructiedata is geserialiseerd:
...
Dit stelt de gebruiker in staat om willekeurige instructiedata in de transactie
te specificeren voor handtekening- en berichtgegevens. Door een speciale
instructions sysvar te specificeren, kan men ook gegevens ontvangen van de
transactie zelf.
...
| Programma         | Programma-ID                                  | Beschrijving                                                                                                                            | Instructies                                                                                         |
| ----------------- | --------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| Secp256r1 Program | `Secp256r1SigVerify1111111111111111111111111` | Verifieert maximaal 8 secp256r1 handtekeningen. Neemt een handtekening, publieke sleutel en bericht. Geeft een fout als er één mislukt. | [Instructions](https://docs.rs/solana-secp256k1-recover/latest/solana_secp256k1_recover/index.html) |
...
onbedoelde handtekeningveranderlijkheid te voorkomen.
...
| Programma                        | Programma-ID                                  | Beschrijving                                                                                                                                                                                                                                                                                                                                                                                | Instructies                                                                                                                                           |
| -------------------------------- | --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| **System Program**               | `11111111111111111111111111111111`            | Maak nieuwe accounts, wijs accountgegevens toe, wijs accounts toe aan eigenaarsprogramma's, draag lamports over van System Program-accounts en betaal transactiekosten.                                                                                                                                                                                                                     | [SystemInstruction](https://docs.rs/solana-program/latest/solana_program/system_instruction/enum.SystemInstruction.html)                              |
