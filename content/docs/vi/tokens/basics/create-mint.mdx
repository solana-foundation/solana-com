...
Mỗi token trên Solana tồn tại dưới dạng một mint account, trong đó địa chỉ của
mint account là định danh duy nhất của nó trên mạng.
...
Giao dịch để tạo một mint account cần hai lệnh:
