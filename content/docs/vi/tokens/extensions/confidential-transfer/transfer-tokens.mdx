...
1. Tạo
   ...
   **Bằng chứng về tính hợp lệ của mã hóa
   ...
   Xác minh rằng các mã hóa số lượng chuyển được tạo đúng cách cho cả ba bên
   (nguồn, đích và kiểm toán viên), đảm bảo số lượng chuyển được mã hóa chính
   xác dưới khóa công khai của mỗi bên.
