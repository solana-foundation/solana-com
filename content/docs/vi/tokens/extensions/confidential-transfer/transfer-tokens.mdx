...
Sơ đồ sau đây hiển thị các bước liên quan đến việc chuyển token từ tài khoản
...
- Tạo bằng chứng về tính bằng nhau, bằng chứng về tính hợp lệ của mã hóa, và
  bằng chứng về phạm vi ở phía client
...
---CODE-PLACEHOLDER-a9e1e2f5f9a9e5b5a9e1e2f5f9a9e5b5---
