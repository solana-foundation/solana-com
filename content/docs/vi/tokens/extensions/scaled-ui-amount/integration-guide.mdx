...
| Hiển thị số dư token đã được rebase       | Hiển thị số dư đã được chia tỷ lệ cho giao dịch hoặc cung cấp thanh khoản trên UI. (backend vẫn có thể sử dụng số lượng thô)          | **P0**  |
...
| Hành động lịch sử không nên được chia lại | Các hành động lịch sử như giao dịch nên được hiển thị bằng số lượng và giá đã chia tỷ lệ chính xác tại thời điểm thực hiện hành động. | **P1**  |
...
| Hiển thị biểu đồ lịch sử giá              | Phản ánh giá đã chia tỷ lệ trong biểu đồ giá. Điều này bao gồm việc chia lại tỷ lệ giá lịch sử theo hệ số nhân hiện tại.              | **P1**  |
