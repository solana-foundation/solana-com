...
| Yêu cầu                                         | Mô tả                                                                                                                                     | Ưu tiên |
| :---------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------- | :------ |
| Theo dõi cập nhật hệ số nhân                    | Theo dõi cập nhật hệ số nhân cho các token sử dụng phần mở rộng scaled ui amount.                                                         | **P0**  |
| Hiển thị số dư token đã được rebase             | Hiển thị số dư đã được điều chỉnh tỷ lệ cho giao dịch hoặc cung cấp thanh khoản trên giao diện. (backend vẫn có thể sử dụng số lượng thô) | **P0**  |
...
| Hành động lịch sử không nên được điều chỉnh lại | Các hành động lịch sử như giao dịch nên được hiển thị bằng số lượng và giá đã điều chỉnh tỷ lệ chính xác tại thời điểm hành động.         | **P1**  |
...
| Điều chỉnh nguồn cấp giá                        | Bất cứ nơi nào nguồn cấp giá được sử dụng để hiển thị giá hiện tại, cung cấp giá đã điều chỉnh tỷ lệ cho người dùng cuối.                 | **P1**  |
...
| Điều chỉnh tỷ lệ giá gốc                        | Chi phí trên mỗi cổ phần nên được điều chỉnh tỷ lệ theo hệ số nhân hiện tại.                                                              | **P1**  |
