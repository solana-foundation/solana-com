...
Phần này mô tả chi tiết việc thiết lập công cụ AI tùy chọn mà bạn có thể sử dụng
để đẩy nhanh quá trình phát triển Solana của mình.

| Công cụ  | Mô tả                                                                                       | Liên kết                    |
| -------- | ------------------------------------------------------------------------------------------- | --------------------------- |
| MCP      | Máy chủ MCP mà bạn có thể kết nối với con trỏ để cải thiện phát triển Solana có hỗ trợ AI.  | https://mcp.solana.com/     |
| LLMs.txt | Tài liệu được tối ưu hóa cho LLM mà bạn có thể sử dụng để đào tạo LLM trên tài liệu Solana. | https://solana.com/llms.txt |
...
đè lên nó trừ khi bạn buộc ghi đè bằng cách sử dụng `--force`.

</Callout>

Để xem địa chỉ ví của bạn (khóa công khai), hãy chạy:
...
hoặc lỗi, hãy thử sử dụng [Web Faucet](https://faucet.solana.com) thay thế.
...
Để xây dựng dự án của bạn, chạy lệnh sau:
...
Để kiểm tra dự án của bạn, hãy chạy lệnh sau:
...
Lệnh này sẽ xây dựng, triển khai và chạy các bài kiểm tra cho dự án của bạn.
