...
### Hiểu về các quyền hạn tài khoản

Một số loại tài khoản nhất định có thể có một hoặc nhiều _quyền hạn ký_ liên kết
với một tài khoản cụ thể. Quyền hạn tài khoản được sử dụng để ký một số giao
dịch cho tài khoản mà nó kiểm soát. Điều này khác với một số mạng blockchain
khác nơi người nắm giữ keypair liên kết với địa chỉ tài khoản kiểm soát tất cả
hoạt động của tài khoản.

Mỗi tài khoản stake có hai cơ quan ký được chỉ định bởi địa chỉ tương ứng của
họ, mỗi cơ quan được ủy quyền thực hiện các hoạt động nhất định trên tài khoản
stake.

_Stake authority_ được sử dụng để ký các giao dịch cho các hoạt động sau:
...
- Thiết lập stake authority mới

_Withdraw authority_ ký các giao dịch cho các hoạt động sau:

- Rút stake chưa được ủy thác vào địa chỉ ví
- Thiết lập withdraw authority mới
- Thiết lập stake authority mới

Stake authority và withdraw authority được thiết lập khi tài khoản stake được
tạo, và chúng có thể được thay đổi để ủy quyền cho một địa chỉ ký mới bất cứ lúc
nào. Stake authority và withdraw authority có thể là cùng một địa chỉ hoặc hai
địa chỉ khác nhau.

Cặp khóa withdraw authority nắm giữ nhiều quyền kiểm soát hơn đối với tài khoản
vì nó cần thiết để thanh lý token trong tài khoản stake, và có thể được sử dụng
để đặt lại stake authority nếu cặp khóa stake authority bị mất hoặc bị xâm phạm.

Bảo vệ withdraw authority khỏi mất mát hoặc trộm cắp là điều cực kỳ quan trọng
khi quản lý tài khoản stake.

### Nhiều ủy thác

Mỗi tài khoản stake chỉ có thể được sử dụng để ủy thác cho một validator tại một
thời điểm. Tất cả các token trong tài khoản hoặc là được ủy thác hoặc chưa được
ủy thác, hoặc đang trong quá trình trở thành được ủy thác hoặc hủy ủy thác. Để
ủy thác một phần token của bạn cho một validator, hoặc để ủy thác cho nhiều
...
Một ủy quyền hoặc hủy kích hoạt mất vài
...
quyền (delegate), hủy ủy quyền, hoặc chia nhỏ, và quyền stake authority của nó
vẫn có thể thay đổi bình thường. Chỉ có việc rút tiền vào ví khác hoặc cập nhật
withdraw authority là không được phép.

Khóa chỉ có thể được thêm khi tài khoản stake được tạo lần đầu, nhưng có thể
được sửa đổi sau đó bởi _lockup authority_ hoặc _custodian_, địa chỉ của những
quyền này cũng được thiết lập khi tài khoản được tạo.
