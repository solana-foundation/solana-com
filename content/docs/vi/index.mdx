...
seoTitle: Tìm hiểu cách hoạt động của blockchain Solana
description:
...
<Cards>
  ...
  >
    Thử ứng dụng đã được triển khai
  </Card>
</Cards>
...
Chơi 2048 trên Solana, nơi mỗi nước đi sẽ gửi một giao dịch. Nhấp vào "Play" để
bắt đầu với một ví devnet đã được nạp tiền và sử dụng các phím mũi tên để chơi.
Nếu đang sử dụng thiết bị di động, vuốt để điều khiển các ô.
...
<Cards>
  <Card title="Validators" href="https://docs.anza.xyz/validator/anatomy">
    Các node riêng lẻ bảo mật mạng Solana
  </Card>
  <Card
