...
---CODE-PLACEHOLDER-888ebf1b977da7d82fbe8c90319490b0---

---CODE-PLACEHOLDER-72ae94090f8d1c73f660022e72ea873e---

---CODE-PLACEHOLDER-5141cf838cd598e456a3a8cf35767d96---

</CodeTabs>

![Program Account](/assets/docs/core/accounts/program-account-simple.svg)

Để đơn giản hóa, bạn có thể coi tài khoản chương trình là chính bản thân chương
trình. Khi bạn gọi các lệnh của một chương trình, bạn chỉ định địa chỉ tài khoản
chương trình (thường được gọi là "Program ID").

Ví dụ sau đây lấy tài khoản Token Program để chỉ ra rằng các tài khoản chương
trình có cùng kiểu cơ sở `Account`, ngoại trừ trường `executable` được đặt thành
`true`. Vì tài khoản chương trình chứa mã thực thi trong trường dữ liệu của
chúng, chúng ta không giải mã dữ liệu.
...
Khi bạn triển khai một chương trình Solana, nó được lưu trữ trong một tài khoản
chương trình. Tài khoản chương trình thuộc sở hữu của một
[Loader Program](/docs/core/programs#loader-programs). Có nhiều phiên bản của
loader, nhưng tất cả ngoại trừ loader-v3 đều lưu trữ mã thực thi trực tiếp trong
tài khoản chương trình. Loader-v3 lưu trữ mã thực thi trong một "tài khoản dữ
liệu chương trình" riêng biệt và tài khoản chương trình chỉ trỏ đến nó. Khi bạn
triển khai một chương trình mới, Solana CLI sử dụng phiên bản loader mới nhất
theo mặc định.
...
buffer, nhưng chúng chỉ là các tài khoản chương trình thông thường.
...
Nói cách khác, việc tạo tài khoản dữ liệu cho một chương trình tùy chỉnh cần hai
bước:
...
Ví dụ sau đây cho thấy cách tạo và lấy tài khoản Token Mint được sở hữu bởi
