...
![New Project](/docs/intro/quickstart/pg-new-project.gif)
...
![Build and Deploy](/docs/intro/quickstart/pg-build-deploy.png)
...
![Run Test](/docs/intro/quickstart/pg-test.png)
