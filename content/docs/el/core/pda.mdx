...
- **Ντετερμινιστικές διευθύνσεις λογαριασμών**: Οι PDAs παρέχουν έναν μηχανισμό
  ...
  προαιρετικών "seeds" (προκαθορισμένων εισόδων) και ενός συγκεκριμένου
  αναγνωριστικού προγράμματος.
...
εκτέλεσης του Solana επιτρέπει στα προγράμματα να "υπογράφουν" για PDAs χωρίς να
...
![Διεύθυνση Πάνω στην Καμπύλη](/assets/docs/core/pda/address-on-curve.svg)
...
Μόλις βρεθεί ένα έγκυρο PDA, η λειτουργία επιστρέφει τόσο τη διεύθυνση (PDA) όσο
...
διευθύνσεις. Αυτό σημαίνει ότι με τα ίδια προαιρετικά seeds και program_id, ένα
...
Το πρόγραμμα περιλαμβάνει μια μοναδική initialize εντολή για τη δημιουργία ενός
νέου λογαριασμού χρησιμοποιώντας ένα PDA ως διεύθυνση του λογαριασμού. Ο νέος
λογαριασμός αποθηκεύει τη διεύθυνση του payer και το seed που χρησιμοποιήθηκε
...
να δημιουργήσει έναν νέο λογαριασμό χρησιμοποιώντας το PDA ως διεύθυνση. Το
...
ένα νέο λογαριασμό on-chain χρησιμοποιώντας το PDA ως διεύθυνση. Σε αυτό το
...
Το αρχείο δοκιμής δείχνει επίσης πώς να ανακτήσετε τον λογαριασμό on-chain που
δημιουργήθηκε σε αυτή τη διεύθυνση μόλις αποσταλεί η συναλλαγή.
