...
- Οι συναλλαγές Solana περιλαμβάνουν εντολές που καλούν προγράμματα στο δίκτυο.
- Οι συναλλαγές είναι **ατομικές** - αν οποιαδήποτε εντολή αποτύχει, ολόκληρη η
  συναλλαγή αποτυγχάνει και δεν πραγματοποιείται καμία αλλαγή.
...
- Κάθε εντολή απαιτεί τρία κομμάτια πληροφοριών:
  ...
  3. Τυχόν επιπλέον δεδομένα που απαιτούνται από την εντολή (π.χ., ορίσματα
     συνάρτησης)
