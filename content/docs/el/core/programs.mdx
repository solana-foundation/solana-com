...
| ------------------- | --------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| Πρόγραμμα Secp256r1 | `Secp256r1SigVerify1111111111111111111111111` | Επαληθεύει έως και 8 υπογραφές secp256r1. Λαμβάνει μια υπογραφή, δημόσιο κλειδί και μήνυμα. Επιστρέφει σφάλμα αν κάποιο αποτύχει. | [Οδηγίες](https://docs.rs/solana-secp256k1-recover/latest/solana_secp256k1_recover/index.html) |
