...
Για λόγους απλότητας, μπορείτε να αντιμετωπίζετε τον λογαριασμό προγράμματος ως
το ίδιο το πρόγραμμα. Όταν καλείτε τις οδηγίες ενός προγράμματος, καθορίζετε τη
διεύθυνση του λογαριασμού προγράμματος (συνήθως αποκαλείται "Program ID").

Το παρακάτω παράδειγμα ανακτά τον λογαριασμό του Token Program για να δείξει ότι
οι λογαριασμοί προγράμματος έχουν τον ίδιο βασικό τύπο `Account`, εκτός από το
πεδίο `executable` που έχει οριστεί σε `true`. Επειδή οι λογαριασμοί
προγράμματος περιέχουν εκτελέσιμο κώδικα στο πεδίο δεδομένων τους, δεν
αποσειριοποιούμε τα δεδομένα.
...
Όταν αναπτύσσετε ένα πρόγραμμα Solana, αποθηκεύεται σε έναν λογαριασμό
προγράμματος. Οι λογαριασμοί προγράμματος ανήκουν σε ένα
[Loader Program](/docs/core/programs#loader-programs). Υπάρχουν διάφορες
εκδόσεις του φορτωτή, αλλά όλες εκτός από το loader-v3 αποθηκεύουν τον
εκτελέσιμο κώδικα απευθείας στον λογαριασμό προγράμματος. Το loader-v3
αποθηκεύει τον εκτελέσιμο κώδικα σε έναν ξεχωριστό "λογαριασμό δεδομένων
προγράμματος" και ο λογαριασμός προγράμματος απλώς δείχνει σε αυτόν. Όταν
αναπτύσσετε ένα νέο πρόγραμμα, το Solana CLI χρησιμοποιεί την τελευταία έκδοση
φορτωτή από προεπιλογή.
...
loader-v4, εξακολουθούν να υπάρχουν buffers, αλλά είναι απλώς κανονικοί
λογαριασμοί προγράμματος.
