...
<Cards>
  ...
  <Card title="Χρεώσεις στο Solana" href="/docs/core/fees">
    Κόστη για την αποστολή συναλλαγών στο Solana
  </Card>
...
Εάν αναπτύσσετε στην πλευρά του πελάτη, τα ακόλουθα SDK που έχουν συνεισφέρει
από την κοινότητα σας βοηθούν να αλληλεπιδράσετε με το δίκτυο σε δημοφιλείς
γλώσσες:
