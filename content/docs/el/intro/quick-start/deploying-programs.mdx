...
Σε αυτήν την ενότητα, θα δημιουργήσετε, θα αναπτύξετε και θα δοκιμάσετε ένα απλό
...
- Απαιτεί μια παράμετρο _`data`_ ως είσοδο
- Δημιουργεί έναν νέο λογαριασμό
- Αποθηκεύει την τιμή της παραμέτρου _`data`_ στα δεδομένα του λογαριασμού
...
mod hello_anchor {
    ...
    pub fn initialize(ctx: Context<Initialize>, data: u64) -> Result<()> {
        ...
        msg!("My account data: {}", my_account.data);
        Ok(())
    }
}
...
Η μακροεντολή _`declare_id!`_ καθορίζει τη διεύθυνση του προγράμματός σας στο
blockchain. Το Solana Playground ενημερώνει αυτή τη διεύθυνση όταν δημιουργείτε
το έργο.
...
Τέλος, το κλείσιμο του προγράμματος επιτρέπει την πλήρη ανάκτηση του SOL που
έχει διατεθεί στο πρόγραμμα στο blockchain.
...
Αν κάποιος ανακαλέσει την αρχή αναβάθμισης, το πρόγραμμα γίνεται αμετάβλητο
