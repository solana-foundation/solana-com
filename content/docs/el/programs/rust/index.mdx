...
<Callout type="warn">
  Εάν δεν συμπεριλάβετε αυτή τη ρύθμιση, ο κατάλογος `target/deploy` δεν θα
...
Μπορείτε να επιθεωρήσετε το αναγνωριστικό του προγράμματος και την υπογραφή της
συναλλαγής στον
...
μπορεί να επαναχρησιμοποιηθεί. Η προσπάθεια τοποθέτησης ενός προγράμματος με ένα
...
## !!steps Επανατοποθέτηση ενός κλειστού προγράμματος
