...
από το crate `solana_program` για να ορίσετε το σημείο εισόδου στο πρόγραμμά
σας.
...
- Σειριοποίηση (Serialization): Μετατροπή των τύπων δεδομένων σας σε bytes για
  αποθήκευση στο πεδίο δεδομένων ενός λογαριασμού
- Αποσειριοποίηση (Deserialization): Μετατροπή των bytes που αποθηκεύονται σε
  έναν λογαριασμό πίσω στους τύπους δεδομένων σας
...
2. Εισάγετε τα χαρακτηριστικά Borsh και χρησιμοποιήστε το derive macro για να
   υλοποιήσετε τα χαρακτηριστικά για τις δομές σας:
...
προγράμματος. Αυτή η δομή θα χρησιμοποιηθεί τόσο στις εντολές αρχικοποίησης όσο
και στις εντολές αύξησης.
...
Οι εντολές αναφέρονται στις διαφορετικές λειτουργίες που μπορεί να εκτελέσει το
...
Σημειώστε ότι οι παραλλαγές των enum στη Rust αριθμούνται αυτόματα ξεκινώντας
από το 0.
...
Για τη μετατροπή των instruction data (bytes) σε μια παραλλαγή του enum, είναι
συνηθισμένο να υλοποιείται μια βοηθητική μέθοδος. Αυτή η μέθοδος:
...
1. Δημιουργεί και δεσμεύει χώρο για έναν νέο λογαριασμό για την αποθήκευση των
...
ορίζεται στο πρόγραμμα για την επιτυχή εκτέλεση της εντολής.

Ενώ τα ονόματα των μεταβλητών για τους λογαριασμούς δεν επηρεάζουν τη
...
2. Υπολογίσουμε το ελάχιστο υπόλοιπο "rent" που απαιτείται. Στο Solana, οι
   ...
   την ποσότητα δεδομένων που αποθηκεύονται στο λογαριασμό.
...
Μόλις οριστεί ο χώρος και υπολογιστεί το rent, δημιουργήστε το λογαριασμό
...
1. Δημιουργεί το νέο λογαριασμό
...
ένα Cross Program Invocation (CPI) μέσω της συνάρτησης `invoke`. Ένα CPI
...
λογαριασμός που αναφέρουμε ως `counter_account` ανήκει στο πρόγραμμα που
εκτελείται.
...
Για να δοκιμάσετε τις εντολές του προγράμματος, προσθέστε τις ακόλουθες
...
Κατά τη δημιουργία μιας εντολής, κάθε λογαριασμός πρέπει να παρέχεται ως
...
Για να δοκιμάσετε την εντολή αρχικοποίησης:

- Δημιουργήστε instruction data με παραλλαγή 0 (`InitializeCounter`) και αρχική
  τιμή
- Δημιουργήστε την εντολή με το αναγνωριστικό προγράμματος, τα δεδομένα εντολής
  και τους απαιτούμενους λογαριασμούς
- Στείλτε μια συναλλαγή με την εντολή αρχικοποίησης
...
Για να δοκιμάσετε την εντολή αύξησης:

- Δημιουργήστε την εντολή με το αναγνωριστικό προγράμματος, τα δεδομένα εντολής
  και τους απαιτούμενους λογαριασμούς
- Στείλτε μια συναλλαγή με την εντολή αύξησης
- Ελέγξτε ότι ο λογαριασμός αυξήθηκε στη σωστή τιμή

Σημειώστε ότι τα instruction data για την εντολή αύξησης είναι `[1]`, που
αντιστοιχεί στην παραλλαγή 1 (`IncrementCounter`). Εφόσον δεν υπάρχουν πρόσθετες
παράμετροι για την εντολή αύξησης, τα δεδομένα είναι απλώς η παραλλαγή της
εντολής.
