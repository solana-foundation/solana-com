...
Για να κάνετε ανάληψη tokens από το διαθέσιμο εμπιστευτικό υπόλοιπο στο δημόσιο
υπόλοιπο:
...
1. Δημιουργήστε
   ...
   **Απόδειξη Ισότητας
   ...
   Επαληθεύει ότι το κρυπτογραφημένο κείμενο του υπολειπόμενου διαθέσιμου
   υπολοίπου μετά την ανάληψη αντιστοιχεί στη σχετική
   ...
   **Απόδειξη Εύρους
   ...
   Επαληθεύει ότι το υπολειπόμενο διαθέσιμο υπόλοιπο μετά την ανάληψη είναι μη
...
το διαθέσιμο εμπιστευτικό υπόλοιπο στο δημόσιο υπόλοιπο:
...
- Να δημιουργήσετε μια απόδειξη ισότητας και μια απόδειξη εύρους από την πλευρά
  του πελάτη
- Να καλέσετε το πρόγραμμα απόδειξης Zk ElGamal για να επαληθεύσετε τις
  αποδείξεις και να αρχικοποιήσετε τους λογαριασμούς "κατάστασης πλαισίου"
- Να καλέσετε την εντολή
  [ConfidentialTransferInstruction::Withdraw](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L493)
  παρέχοντας τους δύο λογαριασμούς απόδειξης.
- Να κλείσετε τους δύο λογαριασμούς απόδειξης για να ανακτήσετε το rent.
...
Το παρακάτω παράδειγμα δείχνει πώς να κάνετε ανάληψη tokens από το διαθέσιμο
εμπιστευτικό υπόλοιπο στο δημόσιο υπόλοιπο.
...
<Callout type="info">
  ...
  το Token Extension Program από το mainnet για να εκτελέσετε τον κώδικα του
  παραδείγματος.
</Callout>
