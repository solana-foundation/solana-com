...
Οι εμπιστευτικές μεταφορές σας επιτρέπουν να μεταφέρετε tokens μεταξύ token
account χωρίς να αποκαλύπτετε το ποσό της μεταφοράς. Αυτό είναι χρήσιμο για
συναλλαγές που διαφυλάσσουν την ιδιωτικότητα. Μόνο τα ποσά μεταφοράς και τα
υπόλοιπα των token είναι ιδιωτικά. Οι διευθύνσεις των token account παραμένουν
δημόσιες.
...
- [Οδηγός Εμπιστευτικών Υπολοίπων](https://github.com/solana-developers/Confidential-Balances-Sample) -
  Αποσπάσματα κώδικα για το πώς να χρησιμοποιήσετε την επέκταση Εμπιστευτικής
  Μεταφοράς
...
στο πρόγραμμα Token Extensions που σας επιτρέπει να μεταφέρετε tokens μεταξύ
...
5. **Εφαρμόστε** το εκκρεμές υπόλοιπο του αποστολέα στο **εμπιστευτικό διαθέσιμο
   υπόλοιπο**.
6. Εμπιστευτικά **μεταφέρετε** tokens από τον token account του αποστολέα στον
...
<Cards>
  ...
  >
    Πώς να δημιουργήσετε ένα mint account με την επέκταση Εμπιστευτικής
    Μεταφοράς
  </Card>
  <Card
  ...
  >
    Πώς να διαμορφώσετε ένα token account με την επέκταση Εμπιστευτικής
    Μεταφοράς
  </Card>
  <Card
