...
accounts χωρίς να αποκαλύπτεται το ποσό της μεταφοράς. Αυτό είναι χρήσιμο για
...
- [Οδηγός Confidential Balances](https://github.com/solana-developers/Confidential-Balances-Sample) -
...
λογαριασμών χωρίς να αποκαλύπτεται το ποσό της μεταφοράς.
...
1. Δημιουργία ενός mint account με την επέκταση confidential transfer.
2. Δημιουργία token accounts με την επέκταση confidential transfer για τον
   αποστολέα και τον παραλήπτη.
3. Έκδοση tokens στον λογαριασμό του αποστολέα.
4. **Κατάθεση** του δημόσιου υπολοίπου του αποστολέα σε **εκκρεμές εμπιστευτικό
   υπόλοιπο**.
5. **Εφαρμογή** του εκκρεμούς υπολοίπου του αποστολέα σε **διαθέσιμο
   εμπιστευτικό υπόλοιπο**.
6. Εμπιστευτική **μεταφορά** tokens από τον token account του αποστολέα στον
   token account του παραλήπτη.
7. **Εφαρμογή** του εκκρεμούς υπολοίπου του παραλήπτη σε **διαθέσιμο
   εμπιστευτικό υπόλοιπο**.
8. **Ανάληψη** του διαθέσιμου εμπιστευτικού υπολοίπου του παραλήπτη σε **δημόσιο
   υπόλοιπο**.

Για περισσότερες λεπτομέρειες σχετικά με τα βήματα στη ροή της εμπιστευτικής
...
token που αντιστοιχούν στο προηγούμενο διάγραμμα. Τα βήματα χωρίζονται σε
...
<Callout type="info">
  ...
  το Token Extension Program του mainnet για να εκτελέσετε τον κώδικα του
  παραδείγματος.
</Callout>
...
## Εντολές Εμπιστευτικής Μεταφοράς

Η πλήρης λίστα των εντολών της επέκτασης Εμπιστευτικής Μεταφοράς
...
| Εντολή                              | Περιγραφή                                                                                                                                                                         |
| ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`InitializeMint`_                | Ρυθμίζει τον λογαριασμό mint για εμπιστευτικές μεταφορές. Αυτή η εντολή πρέπει να συμπεριληφθεί στην ίδια συναλλαγή με την εντολή _rs`TokenInstruction::InitializeMint`_.         |
...
| _rs`EmptyAccount`_                  | Αδειάζει τα εκκρεμή και διαθέσιμα εμπιστευτικά υπόλοιπα για να επιτρέψει το κλείσιμο ενός λογαριασμού token.                                                                      |
...
| _rs`Transfer`_                      | Μεταφέρει token μεταξύ λογαριασμών token εμπιστευτικά.                                                                                                                            |
...
| _rs`TransferWithFee`_               | Μεταφέρει token μεταξύ λογαριασμών token εμπιστευτικά με χρέωση.                                                                                                                  |
