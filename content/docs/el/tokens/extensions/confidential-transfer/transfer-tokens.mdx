...
1. Δημιουργήστε
   ...
   **Απόδειξη Ισότητας
   ...
   Επαληθεύει ότι το νέο διαθέσιμο κρυπτογράφημα υπολοίπου μετά τη μεταφορά
   αντιστοιχεί στη σχετική
   ...
   **Απόδειξη Εγκυρότητας Κρυπτογραφήματος
   ...
   Επαληθεύει ότι τα κρυπτογραφήματα του ποσού μεταφοράς δημιουργούνται σωστά
   για όλα τα τρία μέρη (προέλευση, προορισμός και ελεγκτής), διασφαλίζοντας ότι
   το ποσό μεταφοράς κρυπτογραφείται σωστά με το δημόσιο κλειδί κάθε μέρους.
   ...
   **Απόδειξη Εύρους
   ...
   Επαληθεύει ότι το νέο διαθέσιμο υπόλοιπο και το ποσό μεταφοράς (διαχωρισμένο
   σε χαμηλά/υψηλά bits) είναι όλα μη αρνητικά και εντός συγκεκριμένου εύρους.
...
2. Για κάθε απόδειξη:
   ...
   - Αποθηκεύστε τα συγκεκριμένα μεταδεδομένα απόδειξης σε έναν λογαριασμό
     "κατάστασης πλαισίου" απόδειξης για χρήση σε άλλες οδηγίες.

3. Καλέστε την οδηγία
   ...
   παρέχοντας τους λογαριασμούς κατάστασης πλαισίου απόδειξης.

4. Κλείστε τους λογαριασμούς κατάστασης πλαισίου απόδειξης για να ανακτήσετε το
...
έναν token account του αποστολέα σε έναν token account του παραλήπτη.
...
- Δημιουργία απόδειξης ισότητας, απόδειξης εγκυρότητας κρυπτογραφημένου κειμένου
  και απόδειξης εύρους από την πλευρά του πελάτη
- Κλήση του προγράμματος Zk ElGamal proof για επαλήθευση των αποδείξεων και
  αρχικοποίηση των λογαριασμών "context state"
- Κλήση της εντολής
  [ConfidentialTransferInstruction::Transfer](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L604)
  παρέχοντας τους τρεις λογαριασμούς απόδειξης.
- Κλείσιμο των τριών λογαριασμών απόδειξης για ανάκτηση του rent.

Το `spl_token_client` crate παρέχει τις ακόλουθες μεθόδους:

- Μέθοδος `confidential_transfer_create_context_state_account` που δημιουργεί
  έναν λογαριασμό απόδειξης.
- Μέθοδος `confidential_transfer_transfer` που καλεί την εντολή `Transfer`.
...
<Callout type="info">
  ...
  το Token Extensions Program από το mainnet για να εκτελέσετε τον κώδικα του
  παραδείγματος.
</Callout>
