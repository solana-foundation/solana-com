...
1. Δημιουργήστε
   ...
   **Απόδειξη Εγκυρότητας Κρυπτογραφημένου Κειμένου
   ...
   διασφαλίζοντας ότι το ποσό μεταφοράς κρυπτογραφείται σωστά με το δημόσιο
   κλειδί κάθε μέρους.
...
- Κλήση του προγράμματος Zk ElGamal proof για την επαλήθευση των αποδείξεων και
  την αρχικοποίηση των λογαριασμών "context state"
- Κλήση της εντολής
  [ConfidentialTransferInstruction::Transfer](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L604)
  παρέχοντας τους τρεις λογαριασμούς απόδειξης.
- Κλείσιμο των τριών λογαριασμών απόδειξης για την ανάκτηση του rent.
