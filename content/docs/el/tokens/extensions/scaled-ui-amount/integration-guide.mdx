...
| Εμφάνιση υπολοίπων rebased token                        | Εμφάνιση κλιμακωμένων υπολοίπων για συναλλαγές ή παροχή ρευστότητας στο UI. (το backend μπορεί να συνεχίσει να χρησιμοποιεί raw amounts)                 | **P0**        |
