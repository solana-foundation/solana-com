...
description: Μάθετε πώς να μεταφέρετε tokens μεταξύ token accounts.
---

## Πώς να μεταφέρετε Tokens

Η μεταφορά tokens περιλαμβάνει τη μετακίνηση tokens από ένα token account σε ένα
άλλο token account που μοιράζονται το ίδιο mint. Η μεταφορά tokens συμβαίνει
όταν καλείτε την
...
εντολή σε ένα token program. Μόνο η διεύθυνση που έχει οριστεί ως ιδιοκτήτης
(authority) του token account προέλευσης μπορεί να μεταφέρει tokens από τον
λογαριασμό.
