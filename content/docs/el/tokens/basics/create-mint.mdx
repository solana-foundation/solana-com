...
Ένα mint account είναι ένας τύπος λογαριασμού στα Token Programs της Solana που
...
Για να δημιουργήσετε ένα Mint Account, καλέστε την εντολή
...
2. Κλήση του Token Program για την αρχικοποίηση των δεδομένων του mint account.
