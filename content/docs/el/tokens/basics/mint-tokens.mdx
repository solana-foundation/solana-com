...
Η έκδοση tokens αναφέρεται στη διαδικασία δημιουργίας νέων μονάδων ενός token
καλώντας την εντολή
...
σε ένα token program. Μόνο η διεύθυνση που έχει οριστεί ως mint authority στο
mint account μπορεί να εκδώσει νέα tokens. Η εντολή απαιτεί επίσης την ύπαρξη
ενός token account ως προορισμό για τα νεοεκδοθέντα tokens.
