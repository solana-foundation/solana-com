...
!тип строка !значения confirmed finalized !по умолчанию finalized
...
!тип строка !значения json jsonParsed base58 base64 !по умолчанию json
...
!тип строка !значения full accounts signatures none !по умолчанию full
