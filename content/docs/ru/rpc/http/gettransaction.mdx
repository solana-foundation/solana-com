...
!тип number !значения 0 !по умолчанию 0
...
!тип string !значения json jsonParsed base64 base58 !по умолчанию json
