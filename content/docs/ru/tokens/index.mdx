...
Playground и выполните команду _sh`solana airdrop`_ в терминале Playground. Вы
...
инструкций. Например, команда _sh`create-token`_ выводит адрес mint account с
вашим кошельком Playground в качестве mint authority.
...
Account и увеличивает общее предложение на Mint Account. Вот пример на
Javascript на
