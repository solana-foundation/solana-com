...
транзакции. Для пользователей Solana Playground, впервые использующих платформу,
создайте кошелек Playground и запустите команду _sh`solana airdrop`_ в терминале
...
Найдите больше примеров в документации _sh`spl-token`_
...
увеличивает общее предложение на Mint Account. Вот пример на Javascript в
...
Для получения подробной информации о Token Extensions, смотрите
[Руководство по началу работы](/developers/guides/token-extensions/getting-started)
с Token Extensions и
[документацию SPL](https://www.solana-program.com/docs/token-2022/extensions).
