...
Например, цифровой доллар USD Coin (USDC) на Solana имеет адрес mint-аккаунта
`EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v`. Этот адрес mint-аккаунта служит
уникальным идентификатором USD Coin во всей экосистеме Solana. Вы можете
просмотреть подробную информацию об этом mint-аккаунте на
