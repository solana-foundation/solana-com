...
<Callout type="info">
  ...
  используют одну и ту же базовую реализацию для Mint account.
</Callout>
...
Транзакция для создания mint account требует двух инструкций:

1. Вызов System Program для создания и выделения пространства для mint account и
   передачи права собственности Token Program.
2. Вызов Token Program для инициализации данных mint account.
