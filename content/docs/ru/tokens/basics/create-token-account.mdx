...
<Callout type="info">
  ...
  (Cross-Program Invocation) либо к Token Program, либо к Token Extensions
  Program. Токеновая программа владеет созданным аккаунтом, который имеет ту же
  структуру типа `Account`,
  как определено в токеновой программе. Associated Token Program не хранит
