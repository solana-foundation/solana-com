...
| Отображение балансов ребейз-токенов             | Отображение масштабируемых балансов для торговли или предоставления ликвидности в пользовательском интерфейсе. (бэкенд может использовать необработанные суммы) | **P0**    |
...
| Исторические действия не должны пересчитываться | Исторические действия, такие как сделки, должны отображаться с использованием точной масштабируемой суммы и цены на момент действия.                            | **P1**    |
| Внутренний учет необработанных балансов         | Учет необработанных балансов для ончейн-транзакций вместо масштабируемых балансов. Это будет более точно и проще в долгосрочной перспективе.                    | **P1**    |
