...
Чтобы использовать расширение Scaled UI Amount, вам нужно включить его для
токена mint или токен аккаунта. Обратите внимание, что после создания токена вы
не сможете изменить, какие расширения включены.
...
### Обновление множителя UI amount

Чтобы обновить множитель UI amount, вам нужно использовать команду
