...
Прежде чем токены могут быть переведены конфиденциально, их публичный баланс
должен быть преобразован в конфиденциальный баланс. Это преобразование
...
конфиденциально переводятся с одного токен-аккаунта на другой, токены изначально
добавляются в конфиденциальный ожидаемый баланс. Прежде чем токены могут быть
использованы для конфиденциальных переводов, ожидаемый баланс должен быть
...
---CODE-PLACEHOLDER-2e2b1b5b6b7c4c3e8f9d6a7e8f9d6a7e---
