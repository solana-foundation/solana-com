...
1. **Конфиденциальный ожидающий баланс**: Сначала токены "депонируются" с
...
Этот раздел объясняет первый этап: внесение публичного баланса токенов в
конфиденциальный ожидающий баланс.

Следующая диаграмма показывает шаги, связанные с внесением токенов с публичного
...
Чтобы конвертировать публичный баланс в конфиденциальный ожидающий баланс,
вызовите инструкцию
...
Extension, клонированной с основной сети, используя следующую команду. Для
...
<Callout type="info">
  ...
  локальный валидатор. Вы должны клонировать программу Token Extension с
...
---CODE-PLACEHOLDER-1c2b3e5d4f6a7b8c9d0e123456789abc---
