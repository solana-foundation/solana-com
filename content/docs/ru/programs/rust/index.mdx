...
Чтобы просмотреть ID программы, выполните следующую команду в вашем терминале.
Эта команда выводит открытый ключ keypair, расположенного по указанному пути к
файлу:
...
Запустите тест, используя команду `cargo test-sbf`. В журнале программы
...
`cargo build-sbf`, что создаст новый файл keypair.
