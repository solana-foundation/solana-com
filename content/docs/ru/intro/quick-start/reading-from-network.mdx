...
| Поле         | Описание                                                                                                                        |
| ------------ | ------------------------------------------------------------------------------------------------------------------------------- |
| `executable` | Это поле имеет значение `false`, поскольку mint account хранит состояние, а не исполняемый код.                                 |
...
данных, определенный программой, которой принадлежит аккаунт.
...
| `mintAuthority`   | Полномочие, разрешающее выпускать новые токены                                 |
...
| `freezeAuthority` | Полномочие, разрешающее замораживать token accounts                            |
| `tlvData`         | Дополнительные данные для Token Extensions (требуют дальнейшей десериализации) |
