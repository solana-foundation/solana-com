...
Запросите аирдроп SOL для финансирования `sender`.
...
Порядок инструкций здесь имеет значение. `createAccountInstruction` должен идти
...
создания и инициализации аккаунта. Либо обе инструкции выполняются успешно, либо
ни одна из них. Этот подход распространен при создании более сложных транзакций
Solana, так как он гарантирует, что все инструкции выполняются вместе.
