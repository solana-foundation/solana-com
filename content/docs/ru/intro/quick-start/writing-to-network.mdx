...
- [Создайте подключение](mention:connection)
- [Сгенерируйте пару ключей](mention:wallet) для оплаты транзакции
- [Запросите airdrop](mention:airdrop) для пополнения пары ключей
...
Сгенерируйте пару ключей для mint аккаунта.
...
так как он гарантирует выполнение всех инструкций вместе.
