...
указывает адрес вашей программы в блокчейне. Solana Playground обновляет этот
адрес при сборке проекта.
...
определяет структуру, которая представляет тип данных для аккаунтов, которые эта
программа может создавать и которыми владеет.
...
Тело функции
[устанавливает поле `data` объекта `new_account`](mention:three)
...
- Атрибут
  ...
  программа создает и которыми владеет.
