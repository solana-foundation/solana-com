...
В этом разделе рассматриваются некоторые основные команды Solana CLI, чтобы
...
Для отправки транзакций с использованием Solana CLI вам нужен кошелек Solana,
пополненный SOL.
...
Запросите airdrop SOL на ваш кошелёк, чтобы оплачивать транзакции и
...
В этом разделе рассматриваются некоторые распространённые команды Anchor CLI,
чтобы помочь вам начать работу. Для получения дополнительной информации о Anchor
CLI см. [документацию Anchor](https://www.anchor-lang.com/docs).
