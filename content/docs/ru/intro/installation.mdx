...
Если при установке
`protobuf-compiler` вы столкнетесь со
следующей ошибкой, убедитесь, что сначала выполнили
...
требует Node.js и Yarn. (Шаблон теста на Rust доступен с помощью
