...
トークンの転送とは、同じミントを共有する一つのトークンアカウントから別のトークンアカウントへトークンを移動させることです。トークンの転送は、トークンプログラム上で
...
instructionsを呼び出すことで行われます。送信元のトークンアカウントのオーナー（権限者）として指定されたアドレスのみが、そのアカウントからトークンを転送できます。
