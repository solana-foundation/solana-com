---
title: Solana ドキュメント
seoTitle: Solana ブロックチェーンの仕組みを学ぶ
description:
  Solana
  は大規模採用のために設計された高性能ブロックチェーンです。スケーラブルなブロックチェーンアプリケーションを構築しようとする開発者がSolanaを選ぶ理由を学びましょう。
---
...
<Cards>
  ...
  >
    最初のSolanaアプリケーションをVercelにデプロイする
  </Card>
  <Card
    title="Vercelプレビュー"
...
最初のSolanaアプリケーション -
Anchorフレームワークを使用して構築されたシンプルなカウンタープログラムをデプロイしましょう。この例では、Solanaでの開発を始めるために必要なすべての基本的なSolanaの概念をカバーしています。ソースコードは[こちら](https://github.com/solana-developers/anchor-web3js-nextjs)で確認できます。
...
Solana上で2048をプレイしましょう。ゲーム内の各移動がトランザクションを送信します。「プレイ」をクリックして、資金が提供されたdevnetウォレットで開始し、矢印キーを使ってプレイします。モバイルの場合は、スワイプしてタイルを操作します。
...
Solana Foundation
DevRelチームの[Jonas](https://x.com/SolPlay_jonas)によって構築されました。
...
Solana
validatorを運用してネットワークの安全性を確保するために必要なことを探ります。
...
<Cards>
  ...
  >
    validatorを設定し、初めてクラスターに接続する方法
  </Card>
</Cards>

## サポートを受ける

[Solana StackExchange](https://solana.stackexchange.com)でSolanaコミュニティからサポートを受けましょう。
