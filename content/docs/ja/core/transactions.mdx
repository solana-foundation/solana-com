...
- ---INLINE-CODE-PLACEHOLDER-a6e536fd2243a28539a4c5e69f9542eb---：アカウントのアドレス
...
---INLINE-CODE-PLACEHOLDER-7947c12a0cb1d36ca9b57bde51de9889--- フィールドには以下のフィールドが含まれています：

- ---INLINE-CODE-PLACEHOLDER-28289343a245d382223c9dca090af4a5---：---INLINE-CODE-PLACEHOLDER-8d4960058576495469f38cdaffbefccd--- 配列内のアドレスの読み取り/書き込みおよび署名者権限を指定します

- ---INLINE-CODE-PLACEHOLDER-8d4960058576495469f38cdaffbefccd---：トランザクションのinstructionsで使用されるすべてのアカウントアドレスの配列

- ---INLINE-CODE-PLACEHOLDER-484fd94be3ebc646463aa4da185f718d---：トランザクションのタイムスタンプに使用されるブロックハッシュ

- ---INLINE-CODE-PLACEHOLDER-cef0cbeb0aa0415c6c312a6286058bf7---：実行するinstructionsの配列。各instructionの ---INLINE-CODE-PLACEHOLDER-23d00a6ef54005c98c43ed4a47623699--- と ---INLINE-CODE-PLACEHOLDER-669c26d6b4d7f017d75ebf197ebb784a--- は、インデックスによって ---INLINE-CODE-PLACEHOLDER-8d4960058576495469f38cdaffbefccd--- 配列を参照します。

- ---INLINE-CODE-PLACEHOLDER-32f8eb4ecd3b61a207fa77ec4bff1c65---：トランザクションのinstructionsによって署名者として必要とされるすべてのアカウントの署名を含む配列。署名は、アカウントの対応する秘密鍵を使用してトランザクションメッセージに署名することで作成されます。
...
以下の例を実行して、単一のSOL送金instructionを含むトランザクションの構造を確認してください。
...
RPCメソッドを使用してその詳細を取得できます。レスポンスは以下のスニペットに似た構造になります。または、[Solana Explorer](https://explorer.solana.com)を使用してトランザクションを検査することもできます。

<Callout type="info">

「トランザクション署名」はSolana上のトランザクションを一意に識別します。このシグネチャを使用して、ネットワーク上のトランザクションの詳細を検索できます。トランザクション署名は単にトランザクションの最初の署名です。最初の署名はトランザクション手数料支払者の署名でもあることに注意してください。
