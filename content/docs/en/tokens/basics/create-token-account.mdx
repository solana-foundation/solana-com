...
1. The token account "owner" - This is an address stored in the token account's
   ...
   [Account](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/state.rs#L91)
...
[here](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/processor.rs#L83).
