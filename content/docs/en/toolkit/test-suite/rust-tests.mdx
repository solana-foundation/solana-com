...
h1: Rust Testing Framework for Solana
---
...
than alternatives like [`solana-program-test`](/docs/toolkit/test-suite/basics)
and [`solana-test-validator`](/docs/toolkit/local-validator). In a further break
