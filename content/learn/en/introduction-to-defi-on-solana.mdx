...
Decentralized Finance (DeFi) refers to financial services built on Solana. These
...
available on Solana and how they work.
...
DeFi applications use smart contracts (programs on Solana) to provide financial
services:
...
applications. The next chapter covers the Solana ecosystem in detail, showing
