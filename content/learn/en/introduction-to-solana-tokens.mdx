...
description: Learn about tokens - the different types of digital assets on Solana including stablecoins, wrapped tokens, and project tokens.
---
...
{/* Illustration recommendation: Visual showing SOL as the base layer with various tokens (USDC, USDT, project tokens) built on top */}
...
{/* Illustration recommendation: Step-by-step visual of receiving, viewing, and sending tokens */}
...
{/* Illustration recommendation: Simple flowchart showing token creation process */}
...
{/* Illustration recommendation: Common token operations workflow */}
