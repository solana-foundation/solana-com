...
[creating NFTs with Metaplex](/developers/courses/tokens-and-nfts/nfts-with-metaplex)!
...
[Token Program](/developers/courses/tokens-and-nfts/token-program).
...
[Transferring Tokens](/developers/courses/tokens-and-nfts/token-program#transferring-tokens)
...
```typescript title="delegate-tokens.ts"
...
[Token Program](/developers/courses/tokens-and-nfts/token-program#create-the-token-mint).
...
![Delegate Tokens](/assets/courses/unboxed/delegate-token.png)
...
```typescript title="revoke-approve-tokens.ts"
import "dotenv/config";
import {
  getExplorerLink,
  getKeypairFromEnvironment,
...
![Revoke Approve Tokens](/assets/courses/unboxed/revoke-approve-tokens.png)
...
![Burn Tokens](/assets/courses/unboxed/burn-tokens.png)
