...
[NFTs with Metaplex lesson](/developers/courses/tokens-and-nfts/nfts-with-metaplex#add-the-nft-to-a-collection)
...
```typescript title="create-tree.ts"
import { dasApi } from "@metaplex-foundation/digital-asset-standard-api";
import { createTree, mplBubblegum } from "@metaplex-foundation/mpl-bubblegum";
...
![Solana Explorer with details about created Merkle tree](/assets/courses/unboxed/solana-explorer-create-tree.png)
...
```typescript title="mint-compressed-nft-to-collection.ts"
import { dasApi } from "@metaplex-foundation/digital-asset-standard-api";
import {
  findLeafAssetIdPda,
  LeafSchema,
...
Find the code to create a Metaplex Collection NFT in our [NFTs with Metaplex lesson](/developers/courses/tokens-and-nfts/nfts-with-metaplex#add-the-nft-to-a-collection).
...
```typescript title="fetch-cnft-details.ts"
import { dasApi } from "@metaplex-foundation/digital-asset-standard-api";
...
```typescript title="transfer-asset.ts"
import { dasApi } from "@metaplex-foundation/digital-asset-standard-api";
import {
  getAssetWithProof,
  mplBubblegum,
...
![Solana Explorer showing logs of the transfer cnft instruction](/assets/courses/unboxed/solana-explorer-showing-cnft-transfer-logs.png)
