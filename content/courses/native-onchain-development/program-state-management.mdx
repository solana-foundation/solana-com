...
instructions in the
[first part of deserialize instruction data lesson](/developers/courses/native-onchain-development/deserialize-instruction-data#enumerations).
...
In
[the previous lesson deserialize instruction data](/developers/courses/native-onchain-development/deserialize-instruction-data),
...
![Gif Build and Deploy Program](/assets/courses/unboxed/movie-review-pt2-build-deploy.gif)
...
built in the
[Deserialize Custom Instruction Data lesson](/developers/courses/native-onchain-development/deserialize-custom-data-frontend).
...
we created in the
[Page, Order, and Filter Program Data lesson](/developers/courses/native-onchain-development/paging-ordering-filtering-data-frontend).
