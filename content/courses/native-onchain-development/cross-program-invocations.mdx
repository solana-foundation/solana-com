...
In the
[program derived addresses lesson](/developers/courses/native-onchain-development/program-derived-addresses),
...
[Token Program lesson](/developers/courses/tokens-and-nfts/token-program) before
...
the
[previous PDA lesson](/developers/courses/native-onchain-development/program-derived-addresses).
...
[Token Program lesson](/developers/courses/tokens-and-nfts/token-program).
...
```typescript title="initialize-review-token-mint.ts"
