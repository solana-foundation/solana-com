...
[deserialize instruction data](/developers/courses/native-onchain-development/deserialize-instruction-data)
and
[program state management](/developers/courses/native-onchain-development/program-state-management),
