...
![Global state using a PDA](/assets/courses/unboxed/pdas-global-state.svg)
...
![Per user state](/assets/courses/unboxed/pdas-per-user-state.svg)
...
![Global state using a PDA](/assets/courses/unboxed/pdas-note-taking-program.svg)
...
![Ed25519 curve showing Movie Review Program](/assets/courses/unboxed/movie-review-program.svg)
