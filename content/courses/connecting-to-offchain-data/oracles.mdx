...
![Oracle Jobs](/assets/courses/unboxed/oracle-jobs.png)
...
[Advanced Program Architecture lesson](/developers/courses/program-optimization/program-architecture),
...
![Oracle Configs](/assets/courses/unboxed/oracle-configs.png)
...
```typescript title="burry-escrow.ts"
