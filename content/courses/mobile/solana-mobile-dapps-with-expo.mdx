...
[Introduction to Solana Mobile lesson](/developers/courses/mobile/intro-to-solana-mobile).
...
- `@solana/web3.js`: Solana Web Library for interacting with the Solana network
  through the [JSON RPC API](/docs/rpc/http/).
...
[there are many good solutions for long-term image storage](/developers/guides/getstarted/how-to-create-a-token#create-and-upload-image-and-offchain-metadata).
...
it to run. We use 5GB of ram on our side.
...
[Mobile Wallet Adapter lesson](/developers/courses/mobile/mwa-deep-dive) we
...
[first Mobile lesson](/developers/courses/mobile/intro-to-solana-mobile). We
