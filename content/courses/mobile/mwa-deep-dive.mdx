...
[in the previous lesson](/developers/courses/mobile/intro-to-solana-mobile).
...
completed the
[Introduction to Solana Mobile lab](/developers/courses/mobile/intro-to-solana-mobile),
