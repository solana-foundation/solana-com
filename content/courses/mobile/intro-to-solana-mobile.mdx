...
referenced by a
[public key](/docs/terminology#public-key-pubkey).
...
![Transacting](/assets/courses/unboxed/basic-solana-mobile-transact.png)
...
- [The official Solana Developer Docs](/docs) for in-depth
