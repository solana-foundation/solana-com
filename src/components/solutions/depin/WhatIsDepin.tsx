...
export default function WhatIsDepin() {
  return (
    <section className="w-full bg-[#080d17] py-10 md:py-20 flex justify-center">
      <div className="flex flex-col md:flex-row items-left gap-8 max-w-5xl w-full px-4">
        <div className="relative w-full md:w-[488px] h-[240px] rounded-2xl bg-[#181F2B] flex items-center justify-center overflow-hidden">
          <Image
            src={worldMapDots}
            alt="World map"
            fill
