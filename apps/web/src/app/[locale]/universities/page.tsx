...
export default async function Page(_props: Props) {
  ...
  const translations = {
    ...
    hackathonCtaEyebrowText: t("universities.hackathonCta.eyebrowText"),
    hackathonCtaTitle: t("universities.hackathonCta.title"),
    hackathonCtaDescription: t("universities.hackathonCta.description"),
    hackathonCtaLabel: t("universities.hackathonCta.ctaLabel"),
