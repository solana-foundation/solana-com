...
interface GeneralModalData {
  title: string;
  websiteUrl: string;
  imageUrl: string | null;
}

interface RampsProps {
  fiatAssets: FilterOption[];
  countries: FilterOption[];
  paymentRails: FilterOption[];
  ramps: PlaceholderRamp[];
  resetFilters: () => void;
}
...
const Ramps = ({
  ...
  const [generalModalData, setGeneralModalData] = useState<GeneralModalData>({
    title: "Ramp",
    websiteUrl: "",
    imageUrl: "",
  });

  const handleShowModal = (ramp: PlaceholderRamp) => {
