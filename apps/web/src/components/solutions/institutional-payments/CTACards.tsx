      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center py-8">
            ...
            >
              {t("institutional-payments.cta.reportTitle")}
            </h3>
            <Button
              variant="default"
              className="text-lg p-5 rounded-xl transition-colors duration-200 shadow-md"
              aria-label={t("institutional-payments.cta.downloadReport")}
              onClick={onEmailClick}
            >
              {t("institutional-payments.cta.downloadReport")}{" "}
        ...
        <div className="bg-[#303742] rounded-2xl flex flex-col shadow-lg max-h-[400px] pt-6 px-6 pb-0 overflow-hidden">
          <h4 className="text-2xl font-semibold text-white mb-3">
            {t("institutional-payments.cta.learnTitle")}
          </h4>
          <p className="text-white/80 mb-6">
            {t("institutional-payments.cta.learnDescription")}
          </p>
          <div className="flex flex-col gap-3 mb-6">
            ...
            >
              {t("institutional-payments.cta.learnTokens")}
            ...
            <Link
              ...
              className="text-white flex items-center gap-1 hover:underline transition text-sm"
            >
              {t("institutional-payments.cta.learnWallets")}
            ...
            <div className="flex flex-col h-full justify-end items-end mt-6">
              ...
              >
                {t("institutional-payments.cta.startLearning")}
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#212030] rounded-2xl p-6 flex flex-col shadow-lg min-h-[280px]">
          <h4 className="text-2xl font-semibold text-white mb-3">
            {t("institutional-payments.cta.whatElseTitle")}
          </h4>
          <p className="text-white/80 mb-6">
            {t("institutional-payments.cta.whatElseDescription")}
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <BannerCTA
              href="/solutions/solana-permissioned-environments"
              label={t("institutional-payments.cta.items.0.label")}
              description={t.rich(
                "institutional-payments.cta.items.0.description",
                {
                  br: () => <br />,
                },
              )}
            ...
            <BannerCTA
              ...
              label={t("institutional-payments.cta.items.1.label")}
              description={t.rich(
                "institutional-payments.cta.items.1.description",
                {
                  br: () => <br />,
                },
              )}
            ...
            <BannerCTA
              ...
              label={t("institutional-payments.cta.items.2.label")}
              description={t.rich(
                "institutional-payments.cta.items.2.description",
                {
                  br: () => <br />,
                },
              )}
