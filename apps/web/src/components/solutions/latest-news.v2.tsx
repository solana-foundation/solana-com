    ...
    <section className="relative bg-black text-white text-left font-brand">
      <div className="max-w-[1440px] mx-auto px-[20px] md:px-[32px] xl:px-[40px] py-[64px] md:py-[112px] xl:py-[160px] flex flex-col xl:flex-row max-xl:gap-6 xl:gap-20">
        <div className={cn("w-full", isOneItem ? "xl:w-full" : "xl:w-7/12")}>
          {title && (
            <h2 className="font-brand font-medium leading-none text-[32px] md:text-[40px] xl:text-[64px] mb-[32px] xl:mb-[48px] tracking-[-1.28px] md:tracking-[-1.6px] xl:tracking-[-2.56px]">
              {title}
            </h2>
          )}
              ...
              {items.slice(1).map((item) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <h4 className="text-base md:text-2xl font-medium group-hover:underline mb-0 tracking-[-0.48px] md:tracking-[-0.72px] leading-[1.5] md:leading-[1.33]">
                      {item.title}
                    </h4>
                  </div>
                </Link>
