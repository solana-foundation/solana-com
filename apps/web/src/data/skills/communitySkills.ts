...
export const COMMUNITY_SKILLS: CommunitySkill[] = [
  ...
  },
  {
    ...
    title: "Covenant",
    description:
      "Give an agent scoped authority on Solana: actions clear a capability check and budget before signing, with a hash-chained audit, untrusted-input tagging, and an on-chain witness anyone can recompute. Devnet reference implementation.",
