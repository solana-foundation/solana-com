...
export const PAGES_TO_COMPARE: PageConfig[] = [
  ...
  {
    route: "/developers/migrate-to-solana/ethereum",
    name: "EVM to SVM Index",
    category: "developers",
  },
  {
    route: "/developers/migrate-to-solana/accounts",
    name: "EVM to SVM - Accounts",
    category: "developers",
  },
  {
    route: "/developers/migrate-to-solana/client-differences",
  ...
  {
    route: "/developers/migrate-to-solana/consensus",
    name: "EVM to SVM - Consensus",
    category: "developers",
  },
  {
    route: "/developers/migrate-to-solana/eip2612",
    name: "EVM to SVM - EIP2612",
    category: "developers",
  },
  {
    route: "/developers/migrate-to-solana/erc20",
    name: "EVM to SVM - ERC20",
    category: "developers",
  },
  {
    route: "/developers/migrate-to-solana/erc3643",
    name: "EVM to SVM - ERC3643",
    category: "developers",
  },
  {
    route: "/developers/migrate-to-solana/erc4337",
    name: "EVM to SVM - ERC4337",
    category: "developers",
  },
  {
    route: "/developers/migrate-to-solana/erc4626",
    name: "EVM to SVM - ERC4626",
    category: "developers",
  },
  {
    route: "/developers/migrate-to-solana/erc721",
    name: "EVM to SVM - ERC721",
    category: "developers",
  },
  {
    route: "/developers/migrate-to-solana/smart-contracts",
