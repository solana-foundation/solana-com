...
instrucción. (Esto permite que las transacciones ejecuten instrucciones en
paralelo, siempre que no modifiquen la misma cuenta.)
...
- [is_signer](mention:is-signer): Establecido en `true` si la cuenta debe firmar
  la transacción
- [is_writable](mention:is-writable): Establecido en `true` si la instrucción
...
contiene las mismas tres piezas de información requeridas:
...
<Callout type="info">
  ...
  biblioteca disponible, puedes construir manualmente la instrucción.
</Callout>
