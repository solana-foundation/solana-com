...
actualización es revocada y establecida como `None`, el programa ya no puede ser
actualizado.
...
contiene un recuento del número de firmas a verificar, seguido de un byte de
relleno. Después de eso, se serializa la siguiente estructura, una para cada
firma a verificar.
