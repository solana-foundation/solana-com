...
validators por procesar la transacción. También puedes pagar una tarifa de
...
La tarifa base es el costo de enviar una transacción. El costo es de 5000
...
precio actual de unidades de cómputo:
...
El enfoque recomendado para establecer tarifas de prioridad es primero
...
**Prioridad = ((Límite de Unidades de Cómputo × Precio por Unidad de Cómputo) +
Tarifa Base) / (1 + Límite de Unidades de Cómputo + CUs de Firma + CUs de
...
- [`SetComputeUnitLimit`](https://github.com/anza-xyz/agave/blob/v2.1.13/sdk/src/compute_budget.rs#L42-L44)
  para establecer un límite de unidades específico.
...
unidades de cómputo predeterminado con un precio de unidad de cómputo de 0 (sin
tarifa de priorización).

La tarifa de prioridad depende del límite de unidades de cómputo que solicites
para la transacción, no de las unidades de cómputo realmente utilizadas. Si
estableces un límite de unidades de cómputo demasiado alto o utilizas la
cantidad predeterminada, podrías pagar por unidades de cómputo no utilizadas.

</Callout>

### Ejemplos

Los siguientes ejemplos muestran cómo establecer el límite y precio de unidades
de cómputo para una transacción.
