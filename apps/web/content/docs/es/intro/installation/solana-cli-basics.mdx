...
- **URL de RPC y URL de Websocket**: el clúster de Solana al que la CLI realiza
  solicitudes
- **Ruta del keypair**: la ruta al monedero predeterminado de Solana (keypair)
  utilizado para pagar las tarifas de transacción e implementar programas. Por
  defecto, este archivo se almacena en `~/.config/solana/id.json`.
