---
title: Sincronizar SOL nativo
description: Aprende cómo convertir SOL nativo a SOL envuelto.
---

## Sincronizar SOL nativo

SOL envuelto (WSOL) es una cuenta de token que rastrea la cantidad de lamports
en la cuenta como el saldo del token. WSOL permite la integración con protocolos
DeFi para transferir SOL como un token SPL.
...
sincroniza el saldo de una cuenta de token SOL envuelto (WSOL) con los SOL
(lamports) reales almacenados en ella. Cuando transfieres SOL nativo a una
