...
está asociada exactamente con un mint y hace seguimiento de tu saldo de tokens y
...
account de cualquier wallet para un mint determinado. Consulta la
...
La creación de una Cuenta de Token Asociada (ATA) requiere la instrucción
