...
tu cuenta. Para el Token Program, solo el propietario de la cuenta de token
puede revocar un delegado. Para el Token Extension Program, el propietario de la
cuenta de token y el delegado actual pueden revocar la delegación.
