...
designa un mint como mint de grupo (como un NFT de colección) apuntando a una
cuenta que contiene
...
designa un mint como mint miembro (como un NFT en una colección) apuntando a una
cuenta que contiene
...
[Interfaz de Token Group](https://github.com/solana-program/token-group)
directamente, permitiendo que tanto los datos del grupo como los del miembro se
almacenen en la propia cuenta mint. Cuando las extensiones de puntero apuntan al
propio mint, las extensiones
