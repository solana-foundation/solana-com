...
extensión permite que las cuentas mint sean cerradas y su rent sea recuperado.
Esta extensión debe inicializarse cuando se crea el mint.

Solo la autoridad de cierre designada puede cerrar la cuenta mint. Similar a
cómo las token account solo pueden cerrarse cuando el saldo de tokens es cero,
las mint account con esta extensión solo pueden cerrarse cuando todo el
suministro de tokens se ha reducido a cero.
