...
protege las cuentas de tokens de transferencias inesperadas a través de Cross
Program Invocations (CPIs). Cuando está habilitada, esta extensión asegura que
los tokens solo puedan transferirse mediante llamadas directas a la instrucción
de transferencia del Token Extensions Program, bloqueando a todos los demás
programas de transferir tokens a través de CPI.
