...
1. Crea
   ...
   **Prueba de igualdad
   ...
   retiro coincida con su correspondiente
   [compromiso de Pedersen](https://en.wikipedia.org/wiki/Commitment_scheme),
   asegurando que el nuevo saldo disponible de la cuenta se calcule
   correctamente como `remaining_balance = current_balance - withdraw_amount`.
...
instalada la CLI de Solana para iniciar el validator local.
