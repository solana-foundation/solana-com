...
establece un estado predeterminado para todas las nuevas cuentas de token
creadas para un mint. Cuando está habilitada, esta extensión inicializa
automáticamente cada nueva cuenta de token con un estado especificado, como
congelado. Esto permite a los creadores de tokens aplicar comportamientos
específicos, como requerir que todas las cuentas nuevas estén congeladas de
forma predeterminada hasta que se descongelen explícitamente.
