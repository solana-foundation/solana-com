...
interés se acumula continuamente basado en la marca de tiempo de la red, pero el
saldo real de tokens almacenado en cada token account permanece sin cambios. El
valor total (saldo de tokens

- interés acumulado) es solo un cálculo. No se acuñan nuevos tokens con esta
  extensión.
