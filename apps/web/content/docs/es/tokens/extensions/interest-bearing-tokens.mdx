...
permite establecer una tasa de interés directamente en una cuenta mint. El
interés se capitaliza continuamente según la marca de tiempo de la red, pero el
saldo de tokens real almacenado en cada token account permanece sin cambios. El
valor total (saldo de tokens más interés acumulado) es solo un cálculo. No se
