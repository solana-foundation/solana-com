...
- **الحالة**: البيانات المقصود قراءتها والاحتفاظ بها. على سبيل المثال، معلومات
  عن الرموز، بيانات المستخدم، أو بيانات أخرى محددة ضمن البرنامج.
- **البرامج القابلة للتنفيذ**: حسابات تحتوي على الشفرة الفعلية لبرامج سولانا.
  تخزن هذه الحسابات التعليمات التي يمكن للمستخدمين استدعاؤها.
...
تحتوي حسابات البرامج القابلة للتنفيذ أيضًا على برنامج محدد كـ `owner` للحساب.
