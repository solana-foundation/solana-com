...
بتعيين مفوض دائم لا رجعة فيه مع صلاحية على جميع حسابات الرموز لعملة معينة. على
عكس المفوضين العاديين الذين يمكن لأصحاب حساب الرمز إلغاؤهم، لا يمكن تغيير المفوض
الدائم أو إزالته. يمكن للمفوض الدائم نقل وحرق وتجميد الرموز في أي حساب token
account لتلك العملة.
