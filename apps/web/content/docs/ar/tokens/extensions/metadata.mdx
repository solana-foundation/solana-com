...
لحساب mint تحديد عنوان حساب البيانات الوصفية الخاص به. يمكن لهذا المؤشر الإشارة
إلى أي حساب مملوك لبرنامج ينفذ
...
بشكل مباشر، مما يسمح بتخزين البيانات الوصفية على حساب mint نفسه. وهذا يشمل اسم
الرمز، ورمزه، وعنوان URI، وبيانات وصفية إضافية. عندما تشير امتدادات المؤشر إلى
mint نفسه، يمكن استخدام امتداد
...
لتخزين جميع البيانات الوصفية في حساب mint.
