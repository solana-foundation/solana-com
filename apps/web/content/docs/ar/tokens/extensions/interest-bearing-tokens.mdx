...
تعيين معدل فائدة مباشرة على حساب mint. تتراكم الفائدة بشكل مستمر بناءً على
الطابع الزمني للشبكة، لكن رصيد الرمز الفعلي المخزن في كل حساب رمز يظل دون تغيير.
القيمة الإجمالية (رصيد الرمز بالإضافة إلى الفائدة المستحقة) هي مجرد عملية
حسابية. لا يتم إنشاء رموز جديدة مع هذا الامتداد.
