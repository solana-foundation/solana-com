...
بتعيين معدل فائدة مباشرة على mint account. تتراكم الفائدة باستمرار بناءً على
الطابع الزمني للشبكة، ولكن رصيد العملات الفعلي المخزن في كل token account يظل
دون تغيير. القيمة الإجمالية (رصيد العملات بالإضافة إلى الفائدة المتراكمة) هي
مجرد حساب. لا يتم إنشاء عملات جديدة مع هذا الامتداد.
