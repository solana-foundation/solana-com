...
والمستقبل حسابات رموز مهيأة بحالة `ConfidentialTransferAccount` ومعتمدة
للتحويلات السرية. يجب أيضاً أن يكون لدى حساب رمز المرسل رصيد سري متاح للتحويل
منه.
...
1. قم بإنشاء
   ...
   **إثبات المساواة
   ...
   مما يضمن حساب الرصيد المتاح الجديد لحساب المصدر بشكل صحيح كـ
