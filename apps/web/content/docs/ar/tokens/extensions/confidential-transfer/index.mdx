...
| التعليمة                            | الوصف                                                                                                                                    |
| ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`InitializeMint`_                | تُعِد حساب السك للتحويلات السرية. يجب تضمين هذه التعليمة في نفس المعاملة مع تعليمة _rs`TokenInstruction::InitializeMint`_.               |
| _rs`UpdateMint`_                    | تُحدِّث إعدادات التحويل السري لحساب السك.                                                                                                |
| _rs`ConfigureAccount`_              | تُعِد حساب الرمز المميز للتحويلات السرية.                                                                                                |
| _rs`ApproveAccount`_                | توافق على حساب رمز مميز للتحويلات السرية إذا كان حساب السك يتطلب الموافقة على حسابات الرموز المميزة الجديدة.                             |
| _rs`EmptyAccount`_                  | تُفرِغ الأرصدة السرية المعلقة والمتاحة للسماح بإغلاق حساب الرمز المميز.                                                                  |
| _rs`Deposit`_                       | تُحوِّل رصيد الرمز المميز العام إلى رصيد سري معلق.                                                                                       |
| _rs`Withdraw`_                      | تُحوِّل الرصيد السري المتاح مرة أخرى إلى رصيد عام.                                                                                       |
| _rs`Transfer`_                      | تُحوِّل الرموز المميزة بين حسابات الرموز المميزة بشكل سري.                                                                               |
| _rs`ApplyPendingBalance`_           | تُحوِّل الرصيد المعلق إلى رصيد متاح بعد الإيداعات أو التحويلات.                                                                          |
| _rs`EnableConfidentialCredits`_     | تسمح لحساب الرمز المميز باستقبال تحويلات الرموز المميزة السرية.                                                                          |
| _rs`DisableConfidentialCredits`_    | تحظر التحويلات السرية الواردة مع السماح بالتحويلات العامة.                                                                               |
| _rs`EnableNonConfidentialCredits`_  | تسمح لحساب الرمز المميز باستقبال تحويلات الرموز المميزة العامة.                                                                          |
| _rs`DisableNonConfidentialCredits`_ | تحظر التحويلات العادية لجعل الحساب يستقبل التحويلات السرية فقط.                                                                          |
| _rs`TransferWithFee`_               | تُحوِّل الرموز المميزة بين حسابات الرموز المميزة بشكل سري مع رسوم.                                                                       |
| _rs`ConfigureAccountWithRegistry`_  | طريقة بديلة لتكوين حسابات الرموز المميزة للتحويلات السرية باستخدام حساب _rs`ElGamalRegistry`_ بدلاً من إثبات _rs`VerifyPubkeyValidity`_. |
