...
بتعيين mint كـ mint مجموعة (مثل Collection NFT) من خلال الإشارة إلى حساب يحتوي
على
...
مما يسمح بتخزين بيانات المجموعة والعضو في حساب mint نفسه. عندما تشير امتدادات
المؤشر إلى mint نفسه، يمكن استخدام امتدادات
