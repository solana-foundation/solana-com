...
عملة السك كعملة مجموعة (مثل NFT للمجموعة) من خلال الإشارة إلى حساب يحتوي على
...
مثل صلاحية التحديث والحجم الأقصى.
...
عملة السك كعملة عضو (مثل NFT في مجموعة) من خلال الإشارة إلى حساب يحتوي على
