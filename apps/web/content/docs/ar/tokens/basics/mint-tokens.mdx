...
سك الرموز يشير إلى عملية إنشاء وحدات جديدة من الرمز عن طريق استدعاء تعليمة
...
في Token Program. فقط العنوان المحدد كسلطة السك على mint account يمكنه سك رموز
جديدة. تتطلب التعليمة أيضًا وجود token account كوجهة للرموز المسكوكة.
