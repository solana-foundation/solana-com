...
من تحويل أي رموز مميزة من حسابك. يمكن لمالك token account فقط إلغاء المفوض.

<Callout type="info">
  يشترك [برنامج الرمز
  المميز](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/instruction.rs#L140)
  و[برنامج Token
  Extensions](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/instruction.rs#L182)
