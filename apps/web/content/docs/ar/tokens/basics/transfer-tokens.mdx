...
تتضمن عملية تحويل الرموز نقل الرموز من token account إلى token account آخر
يشتركان في نفس العملة. يحدث تحويل الرموز عندما تقوم باستدعاء تعليمة
...
على Token Program. فقط العنوان المحدد كمالك (سلطة) لحساب الرمز المصدر يمكنه
تحويل الرموز خارج الحساب.
...
<Callout type="info">
  ...
  في تنفيذات متشابهة لتحقيق نفس الوظائف.
</Callout>
