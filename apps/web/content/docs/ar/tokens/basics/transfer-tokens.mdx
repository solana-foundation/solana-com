---
title: تحويل الرموز
description: تعلم كيفية تحويل الرموز بين حسابات token account.
---

## كيفية تحويل الرموز

تنقل عمليات تحويل الرموز الرموز بين token accounts من نفس العملة باستخدام تعليمة
...
- يجب أن يحتوي كلا حسابي الرموز على نفس نوع العملة (mint)
- يمكن فقط لمالك الحساب المصدر أو المفوض أن يصرح بالتحويلات

<Callout type="info">
  يشترك [برنامج الرموز (Token
  ...
  و[برنامج امتدادات الرموز (Token Extension
