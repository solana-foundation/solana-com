...
## ما هو حساب Mint Account؟

يمثل mint account بشكل فريد الرمز المميز على سولانا ويخزن البيانات الوصفية
العالمية الخاصة به.
...
كل رمز مميز على سولانا لديه حساب mint، وعنوان mint يعمل كمعرف فريد للرمز المميز.
