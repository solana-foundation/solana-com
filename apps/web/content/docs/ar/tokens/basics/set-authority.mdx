---
title: تعيين السلطة
description: تعلم كيفية تعيين السلطة لحسابات العملات أو حسابات الرموز.
---

## فهم سلطات الرموز

### سلطات حساب العملة (Mint Account)

- **سلطة الإصدار (Mint Authority)**: تتحكم في إنشاء رموز جديدة. يمكنها إصدار
  رموز لأي حساب رمز. غالبًا ما يتم إلغاؤها بعد إنشاء المعروض الأولي لإنشاء رمز
  ذو معروض ثابت.
- **سلطة التجميد (Freeze Authority)**: تتحكم في القدرة على تجميد وإذابة حسابات
  الرموز. يمكنها منع أي حساب رمز من تحويل الرموز. غالبًا ما يتم إلغاؤها لضمان أن
  رموز المستخدمين لا يمكن تجميدها.

### سلطات حساب الرمز (Token Account)

- **مالك الحساب (Account Owner)**: لديه سيطرة كاملة على حساب الرمز. يمكنه تحويل
  الرموز، وحرق الرموز، والموافقة على المفوضين، وإغلاق الحساب عندما يكون الرصيد
  صفرًا.
- **سلطة الإغلاق (Close Authority)**: يمكنها إغلاق حساب الرمز عندما يكون رصيده
  صفرًا. بشكل افتراضي، هذا هو مالك الحساب ولكن يمكن تفويضه لحساب آخر.
...
تغير أو تلغي السلطات على حسابات العملات وحسابات الرموز. فقط السلطة الحالية
يمكنها نقل صلاحياتها إلى عنوان جديد أو إلغائها بشكل دائم عن طريق تعيين السلطة
إلى قيمة فارغة. بمجرد الإلغاء، لا يمكن استعادة السلطة.
...
<Callout type="info">
  ...
  يشتركان في تنفيذات متشابهة لتحقيق نفس الوظائف.
</Callout>
