...
description: تعلم كيفية تحويل SOL الأصلي إلى SOL المغلف.
---

## مزامنة SOL الأصلي

SOL المغلف (WSOL) هو حساب رمز يتتبع كمية اللامبورت في الحساب كرصيد للرمز. يتيح
WSOL التكامل مع بروتوكولات التمويل اللامركزي (DeFi) لنقل SOL كرمز SPL.
...
تقوم بمزامنة رصيد حساب رمز SOL المغلف (WSOL) مع SOL الفعلي (لامبورت) المخزن فيه.
عندما تقوم بتحويل SOL الأصلي إلى حساب رمز WSOL، لا يتم تحديث رصيد الرمز
