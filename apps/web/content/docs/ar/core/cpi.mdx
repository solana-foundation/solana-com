...
عندما يتطلب استدعاء CPI موقع PDA، يتم استخدام دالة
...
[PDAs](<(/docs/core/pda)>) الموقعة. يستدعي وقت تشغيل سولانا داخلياً
[`create_program_address`](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/bpf_loader/src/syscalls/cpi.rs#L552)
باستخدام `signers_seeds` و`program_id` الخاص بالبرنامج المستدعي. عند التحقق من
PDA، يتم
