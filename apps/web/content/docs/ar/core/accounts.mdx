...
كل حساب في سولانا له [برنامج](/docs/core/programs) معيّن كمالك له. مالك الحساب
هو البرنامج الوحيد الذي يمكنه تغيير `data` الخاص بالحساب أو خصم lamports، كما هو
موضح في تعليمات البرنامج.
...
- إذا كان `false`: الحساب هو حساب بيانات
...
رؤية عنوان `owner` الخاص بالحساب وهو `11111111111111111111111111111111` (برنامج
