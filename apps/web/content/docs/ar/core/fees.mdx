...
- **رسوم الأولوية** (اختيارية) هي رسوم إضافية تدفعها للمصادق لزيادة فرصة معالجة
  قائد الشبكة الحالي لمعاملتك.
- رسوم الأولوية تساوي: **(حد وحدات الحوسبة × سعر وحدة الحوسبة)**.
- **حد وحدات الحوسبة** هو الحد الأقصى لوحدات الحوسبة التي يمكن أن تستخدمها
  معاملتك.
...
**الأولوية = ((حد وحدات الحوسبة × سعر وحدة الحوسبة) + الرسوم الأساسية) / (1 + حد
وحدات الحوسبة + وحدات حوسبة التوقيع + وحدات حوسبة قفل الكتابة)**
