...
[بشكل افتراضي](https://github.com/anza-xyz/agave/blob/v2.1.13/compute-budget/src/compute_budget.rs#L149-L197)،
يتم تخصيص
[200,000 وحدة حسابية](https://github.com/anza-xyz/agave/blob/v2.1.13/compute-budget/src/compute_budget_limits.rs#L10)
لكل تعليمة ويتم تخصيص
[1.4 مليون وحدة حسابية](https://github.com/anza-xyz/agave/blob/v2.1.13/compute-budget/src/compute_budget_limits.rs#L14)
لكل معاملة. يمكنك تغيير هذه الإعدادات الافتراضية من خلال تضمين تعليمة
...
سعر الوحدة الحسابية هو مبلغ اختياري من
[الميكرو-لامبورت](/docs/references/terminology#micro-lamports) يُدفع مقابل كل
وحدة حسابية مطلوبة. يمكنك اعتبار سعر الوحدة الحسابية بمثابة إكرامية لتشجيع
المدقق على إعطاء الأولوية لمعاملتك. لتعيين سعر الوحدة الحسابية، قم بتضمين تعليمة
