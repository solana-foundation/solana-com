...
مملوك لـ System Program. تنقسم الرسوم الأساسية كما يلي:
...
- **50% يتم توزيعها:** النصف الآخر يتم
  [دفعه للمدقق](https://github.com/anza-xyz/agave/blob/e621336acad4f5d6e5b860eaa1b074b01c99253c/runtime/src/bank/fee_distribution.rs#L58-L62)
  الذي عالج المعاملة.
...
يمكن تعيين رسوم الأولوية عن طريق ضبط سعر وحدة
[الحوسبة](/docs/references/terminology#compute-units) (CU) للمعاملة وحد وحدة
الحوسبة. (انظر
...
1. قم بتقدير وحدات CU المطلوبة عن طريق
   [محاكاة](/developers/guides/advanced/how-to-request-optimal-compute) المعاملة
2. أضف هامش أمان بنسبة 10% إلى هذا التقدير

<Callout type="warn">
  يتم تحديد رسوم الأولوية من خلال حد وحدة الحوسبة المطلوب للمعاملة، *وليس* العدد
  الفعلي لوحدات الحوسبة المستخدمة. إذا قمت بتعيين حد وحدة حوسبة مرتفع جدًا أو
  استخدمت المقدار الافتراضي، فقد تدفع مقابل وحدات حوسبة غير مستخدمة.
</Callout>

#### سعر وحدة الحوسبة

سعر وحدة الحوسبة هو مبلغ اختياري من
[ميكرو-لامبورت](/docs/references/terminology#micro-lamports) يُدفع مقابل كل وحدة
CU مطلوبة. يمكنك اعتبار سعر CU كإكرامية لتشجيع الـvalidator على إعطاء الأولوية
لمعاملتك. لتعيين سعر CU، قم بتضمين تعليمة
...
للمساعدة في تحديد أفضل سعر CU لمعاملتك، راجع توصية سعر CU في الوقت الفعلي
