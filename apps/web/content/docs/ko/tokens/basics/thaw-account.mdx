---
title: 계정 해동
description: 동결된 토큰 계정을 해동하는 방법을 알아보세요.
---
...
명령어는 동결을 해제하여 이전에 동결된 토큰 계정의 모든 기능을 복원합니다. 해동
후 계정은 다시 정상적으로 토큰을 송수신할 수 있습니다. 토큰의 민트에 대한 동결
권한을 가진 사람만 계정을 해동할 수 있습니다.
...
<Callout type="info">
  ...
  은 동일한 기능을 달성하기 위해 유사한 구현을 공유합니다.
</Callout>
