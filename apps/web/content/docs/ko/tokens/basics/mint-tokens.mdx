...
명령을 호출하여 새로운 토큰 단위를 생성하는 과정을 말합니다. mint account에
지정된 발행 권한(mint authority)을 가진 주소만이 새 토큰을 발행할 수 있습니다.
이 명령을 실행하려면 발행된 토큰의 목적지로 사용될 token account가 존재해야
합니다.

<Callout type="info">
  [Token
  Program](https://github.com/solana-program/token/blob/3daf44899f0bd71c879d28dffdfb788dd944f3c5/program/src/processor.rs#L521)과
  [Token Extensions
  Program](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/processor.rs#L973)은
