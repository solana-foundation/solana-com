---
title: 영구 위임자
description: InitializePermanentDelegate 확장 기능을 구현하는 방법을 알아보세요.
---

## InitializePermanentDelegate 확장 기능 구현 방법
...
민트의 모든 토큰 계정에 대한 권한을 가진 취소 불가능한 위임자를 지정합니다. 토큰
계정 소유자가 취소할 수 있는 일반 위임자와 달리, 영구 위임자는 변경하거나 제거할
수 없습니다. 영구 위임자는 해당 민트의 모든 토큰 계정에서 토큰을 전송, 소각 및
동결할 수 있습니다.
