...
확장 기능을 사용하면 민트 계정을 닫고 rent를 회수할 수 있습니다. 이 확장 기능은
민트가 생성될 때 초기화되어야 합니다.

지정된 닫기 권한이 있는 사람만 민트 계정을 닫을 수 있습니다. 토큰 잔액이 0일
때만 토큰 계정을 닫을 수 있는 것과 유사하게, 이 확장 기능이 있는 민트 계정은
