...
| _rs`EmptyAccount`_                  | token account를 닫을 수 있도록 보류 중인 기밀 잔액과 사용 가능한 기밀 잔액을 비웁니다.                                                       |
| _rs`Deposit`_                       | 공개 토큰 잔액을 보류 중인 기밀 잔액으로 변환합니다.                                                                                         |
| _rs`Withdraw`_                      | 사용 가능한 기밀 잔액을 다시 공개 잔액으로 변환합니다.                                                                                       |
| _rs`Transfer`_                      | token account 간에 토큰을 기밀로 전송합니다.                                                                                                 |
| _rs`ApplyPendingBalance`_           | 입금 또는 전송 후 보류 중인 잔액을 사용 가능한 잔액으로 변환합니다.                                                                          |
...
| _rs`TransferWithFee`_               | 수수료와 함께 token account 간에 토큰을 기밀로 전송합니다.                                                                                   |
