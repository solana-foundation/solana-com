...
[Sava Engineering](https://sava.engineering/)によって構築された[Java SDK](https://sava.software/welcome)があり、Solanaとやり取りするための大部分の機能をサポートしています。SolanaプログラムにAnchorを使用している場合、idlと共に[anchor-src-gen](https://sava.software/utilities/anchor-src-gen)を使用してJava互換のクライアントを生成することができます。
