---
title: ミントのクローズ
description: MintCloseAuthority拡張機能の有効化方法を学びます。
---
...
拡張機能により、mint
accountをクローズしてrentを回収することが可能になります。この拡張機能はmintの作成時に初期化する必要があります。

指定されたクローズ権限を持つ者だけがmint accountをクローズできます。token
accountがトークン残高がゼロの場合にのみクローズできるのと同様に、この拡張機能を持つmint
