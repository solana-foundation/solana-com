...
[`InitializePermanentDelegate`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L678)は、ミントのすべてのトークンアカウントに対する取り消し不能な委任者を割り当てます。トークンアカウント所有者が取り消すことができる通常の委任者とは異なり、永続的な委任者は変更または削除することができません。永続的な委任者は、そのミントの任意のトークンアカウントでトークンの転送、焼却、凍結を行うことができます。
