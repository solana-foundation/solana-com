...
[`TransferFeeExtension`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L579)は、すべてのトークン転送時に自動的に手数料を徴収することを可能にします。手数料は受信者のtoken
accountに蓄積され、mint
