---
title: トークングループとメンバー
description: GroupPointerExtensionとGroupMemberPointerExtensionの有効化方法について学びます。
---

## GroupPointerExtensionとGroupMemberPointerExtensionの有効化方法
