---
title: 不変の所有者
description: ImmutableOwner拡張機能の有効化方法を学びます。
---

## ImmutableOwner拡張機能を有効にする方法

[`ImmutableOwner`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L511)拡張機能は、token
accountの所有権変更を防止します。この拡張機能を使用してtoken
accountが初期化されると、指定された所有者は永続的となり、別のアカウントに転送することはできません。
