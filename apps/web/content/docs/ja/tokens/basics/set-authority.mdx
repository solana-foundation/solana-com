---
title: 権限の設定
description: ミントやトークンアカウントの権限を設定する方法を学びましょう。
---
...
<Callout type="info">
  [トークンプログラム](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/instruction.rs#L153)と[トークン拡張プログラム](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/instruction.rs#L195)は同じ機能を実現するために類似の実装を共有しています。
</Callout>
