...
ミンティングは、[`MintTo`](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/instruction.rs#L174)命令を使用してトークンの新しい単位を作成します。
