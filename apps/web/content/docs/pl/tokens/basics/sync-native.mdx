---
title: Synchronizuj Native
description: Dowiedz się, jak przekonwertować natywne SOL na opakowane SOL.
---

## Synchronizuj Native SOL

Opakowane SOL (WSOL) to konto tokenowe, które śledzi liczbę lamportów na koncie
...
synchronizuje saldo konta tokenowego opakowanego SOL (WSOL) z rzeczywistym SOL
(lamportami) przechowywanym na nim. Gdy przesyłasz natywne SOL na konto tokenowe
