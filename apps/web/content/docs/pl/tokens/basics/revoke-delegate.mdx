...
cofnięciu delegowania delegat nie może już przenosić żadnych tokenów z twojego
konta. Tylko właściciel konta tokenów może cofnąć delegowanie.

<Callout type="info">
  [Program Tokenów
  ](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/instruction.rs#L140)
  oraz [Program Rozszerzeń Tokenów
  ](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/instruction.rs#L182)
