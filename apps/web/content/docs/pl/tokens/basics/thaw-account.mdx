...
description: Dowiedz się, jak odblokować zamrożone konto tokenów.
---
...
tokenów. Po odblokowaniu konto może ponownie normalnie wysyłać i odbierać
tokeny. Tylko autorytet zamrażania tokena może odblokować konta.

<Callout type="info">
  [Program Tokenów
  ](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/instruction.rs#L243)
  oraz [Program Rozszerzeń Tokenów
  ](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/instruction.rs#L306)
