...
Możesz zobaczyć szczegóły tego konta tokena na stronie
...
Podczas pracy z kontami tokenów "właściciel" zazwyczaj odnosi się do autorytetu,
...
każdego portfela dla danego tokena (mint). Zobacz
...
Utworzenie powiązanego konta tokena (ATA) wymaga użycia
[instrukcji](https://github.com/solana-program/associated-token-account/blob/c78722ee39ebf6741cdfa81dffd52135370a5015/program/src/instruction.rs#L18).
Zobacz
