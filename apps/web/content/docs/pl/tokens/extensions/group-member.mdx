...
wyznacza mint jako grupowy mint (np. kolekcję NFT), wskazując na konto
zawierające
...
wyznacza mint jako członkowski mint (np. NFT w kolekcji), wskazując na konto
zawierające
...
członkowskich bezpośrednio w koncie mint. Gdy rozszerzenia wskaźników wskazują
na sam mint,
