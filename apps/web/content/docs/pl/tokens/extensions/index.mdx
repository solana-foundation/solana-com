...
które występuje po bazowym typie danych konta. Należy dodatkowo zdeserializować
`tlv_data` (zawierające stan rozszerzenia) zgodnie z typami rozszerzeń
włączonymi dla danego konta.
