...
dla mintu. W przeciwieństwie do zwykłych delegatów, których właściciele kont
tokenów mogą odwołać, stały delegat nie może zostać zmieniony ani usunięty.
Stały delegat może przenosić, palić i zamrażać tokeny na dowolnym koncie tokenów
tego mintu.
