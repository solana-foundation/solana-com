...
przypisuje delegata z uprawnieniami do wszystkich token account dla danego
mintu. W przeciwieństwie do zwykłych delegatów, których właściciele token
account mogą odwołać, stałego delegata nie można zmienić ani usunąć przez
właścicieli token account. Stały delegat może transferować lub spalać tokeny na
dowolnym token account tego mintu. Rola stałego delegata może zostać przekazana
nowemu kontu przez obecnego stałego delegata.
