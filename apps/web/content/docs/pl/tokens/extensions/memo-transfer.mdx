...
wymaga, aby wszystkie przychodzące transfery tokenów zawierały dołączoną notatkę
(memo), gdy ta opcja jest włączona na token account. To rozszerzenie może być
włączone lub wyłączone przez właściciela token account.
