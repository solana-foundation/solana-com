...
extensja uniemożliwia zmianę właściciela token account. Gdy token account
zostanie zainicjowane z tą rozszerzoną funkcjonalnością, wskazany właściciel
jest stały i nie może zostać przeniesiony na inne konto.
