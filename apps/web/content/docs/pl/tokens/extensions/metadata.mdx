...
dając elastyczność w wyborze miejsca przechowywania metadanych.
...
bezpośrednio, umożliwiając przechowywanie metadanych bezpośrednio na koncie
mint. Obejmuje to nazwę tokena, symbol, URI i dodatkowe dane opisowe. Gdy
rozszerzenia wskaźnika wskazują na sam mint,
