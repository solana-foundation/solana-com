...
- Jeśli potrzebujesz poznać wartość UI Amount dla dowolnej kwoty, możesz uzyskać
  ...
  - Uwaga: amountToUiAmount wymaga symulacji transakcji, co oznacza, że
    ...
    się tego używać jako domyślnej metody pobierania salda.

#### Wywołania RPC

- `getTokenAccountBalance`
  - Zwraca saldo token account oraz informacje o monecie (mint info)
...
- Użytkownicy powinni wprowadzać kwoty interpretowane jako skalowane “UIAmount”.
  Aplikacja, która to przetwarza, powinna przekonwertować je na surową wartość
  tokena do transakcji.
  - Jeśli pojawią się problemy z zaokrągleniem, zaokrąglij w dół i zostaw
    niewielką ilość "kurzu" (dust), zamiast ryzykować niepowodzenie transakcji.
  - Do tej konwersji możesz użyć funkcji
    [`uiAmountToAmountForMintWithoutSimulation`](https://github.com/solana-program/token-2022/blob/main/clients/js-legacy/src/actions/amountToUiAmount.ts#L312C23-L312C63)
    (web3.js v1) lub symulacji transakcji z użyciem amountToUiAmount.
