...
- [Nagłówek wiadomości](mention:message-header): Określa liczbę sygnatariuszy
  oraz kont tylko do odczytu.
- [Adresy kont](mention:account-addresses): Tablica adresów kont wymaganych
  przez instrukcje w transakcji.
- [Niedawny Blockhash](mention:recent-blockhash): Działa jako znacznik czasu dla
  transakcji.
