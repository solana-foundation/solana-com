...
seoTitle: Integracja portfela Solana z Next.js i @solana/react-hooks
description:
  Skonfiguruj integrację portfela Solana w Next.js za pomocą @solana/client i
  @solana/react-hooks, aby wysyłać transfery SOL.
---
...
![Aplikacja Next.js Hooks](/assets/docs/frontend/01-hero-wallet.webp)

## Zasoby

- [Repozytorium Framework Kit](https://github.com/solana-foundation/framework-kit)
...
To otacza całą aplikację kontekstem Solana, dzięki czemu wszystkie komponenty
potomne mają dostęp do stanu portfela i hooków.
...
![Opcje rozwijanego portfela](/assets/docs/frontend/02-wallet-dropdown-options.webp)

![Portfel połączony - rozwijane opcje](/assets/docs/frontend/03-wallet-dropdown-connected.webp)
...
![Wypełniony formularz przelewu SOL](/assets/docs/frontend/04-sol-transfer-filled.webp)

![Sukces przelewu SOL](/assets/docs/frontend/05-sol-transfer-success.webp)

Konektory to ten sam zestaw Wallet Standard
(Phantom/Solflare/Backpack/auto-discovery); po połączeniu przelewy SOL używają
połączonego podpisującego.
