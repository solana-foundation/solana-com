...
[типа аккаунта](/docs/core/accounts#account-structure), а дополнительное поле в
ответе.
...
[_ts`getMint()`_](mention:one) для десериализации поля mint аккаунта `data` в
тип данных
...
созданных с помощью [Token Extension Program](/docs/tokens/extensions)
(Token2022).
