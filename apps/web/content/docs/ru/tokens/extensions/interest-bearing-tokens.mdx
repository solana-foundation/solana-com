...
позволяет установить процентную ставку непосредственно на аккаунт выпуска (mint
...
неизменным. Общая стоимость (баланс токенов плюс начисленные проценты) — это
только расчет. Новые токены не создаются с использованием этого расширения.
