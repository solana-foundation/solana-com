...
позволяет закрывать mint аккаунты и возвращать их rent. Это расширение должно
быть инициализировано при создании mint.

Только назначенный close authority может закрыть mint аккаунт. Аналогично тому,
как token аккаунты могут быть закрыты только при нулевом балансе токенов, mint
аккаунты с этим расширением могут быть закрыты только тогда, когда весь объем
токенов сведен к нулю.
