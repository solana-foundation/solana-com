...
расширение предотвращает изменение владельца для token account. Когда token
account инициализируется с этим расширением, назначенный владелец становится
постоянным и не может быть передан другому аккаунту.
