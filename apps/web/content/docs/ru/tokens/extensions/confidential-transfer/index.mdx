...
использования локального валидатора необходимо установить Solana CLI.
...
| _rs`UpdateMint`_                    | Обновляет параметры конфиденциальных переводов для mint.                                                                                                                       |
...
| _rs`EmptyAccount`_                  | Очищает ожидающие и доступные конфиденциальные балансы, чтобы закрыть token account.                                                                                           |
| _rs`Deposit`_                       | Конвертирует публичный баланс токенов в ожидающий конфиденциальный баланс.                                                                                                     |
| _rs`Withdraw`_                      | Конвертирует доступный конфиденциальный баланс обратно в публичный баланс.                                                                                                     |
| _rs`Transfer`_                      | Переводит токены между token account конфиденциально.                                                                                                                          |
| _rs`ApplyPendingBalance`_           | Конвертирует ожидающий баланс в доступный после депозита или перевода.                                                                                                         |
| _rs`EnableConfidentialCredits`_     | Позволяет token account принимать конфиденциальные переводы токенов.                                                                                                           |
| _rs`DisableConfidentialCredits`_    | Блокирует входящие конфиденциальные переводы, но разрешает публичные переводы.                                                                                                 |
| _rs`EnableNonConfidentialCredits`_  | Позволяет token account принимать публичные переводы токенов.                                                                                                                  |
| _rs`DisableNonConfidentialCredits`_ | Блокирует обычные переводы, чтобы аккаунт принимал только конфиденциальные переводы.                                                                                           |
| _rs`TransferWithFee`_               | Переводит токены между token account конфиденциально с комиссией.                                                                                                              |
