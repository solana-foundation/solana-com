...
1. **Создайте аккаунт минта**: Вызовите инструкцию System Program
   _rs`CreateAccount`_ для создания аккаунта минта.

1. **Инициализируйте расширение Confidential Transfer**: Вызовите инструкцию
   ...
   программы Token Extension для настройки состояния
   _rs`ConfidentialTransferMint`_ для минта.

1. **Инициализируйте минт**: Вызовите инструкцию программы Token Extension
