...
Чтобы конфиденциально перевести токены с одного токенного аккаунта на другой, у
отправителя и получателя должны быть токенные аккаунты, настроенные с состоянием
_rs`ConfidentialTransferAccount`_ и одобренные для конфиденциальных переводов. У
токенного аккаунта отправителя также должен быть доступный конфиденциальный
баланс для перевода.
...
1. Создайте
   ...
   **Доказательство равенства
   ...
   Проверяет, что новое шифротекстовое значение доступного баланса после
   перевода соответствует соответствующему
