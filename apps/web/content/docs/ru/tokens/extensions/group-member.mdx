...
обозначает mint аккаунт как групповой mint (например, коллекция NFT), указывая
на аккаунт, содержащий
...
[данные об участниках](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67),
такие как адрес группы и номер участника.

Программа Token Extensions Program напрямую реализует
...
могут быть использованы для хранения всех данных коллекции и участников в самом
mint аккаунте.
