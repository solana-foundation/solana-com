...
токен аккаунта. После разморозки аккаунт снова может отправлять и получать
токены в обычном режиме. Только freeze authority (владелец права заморозки)
токена может размораживать аккаунты.
