...
изменяет или отзывает полномочия для выпусков токенов (mint) и токен-аккаунтов.
Только текущий владелец полномочий может передать свои права новому адресу или
навсегда отозвать их, установив значение authority в null. После отзыва
полномочия восстановить их невозможно.
