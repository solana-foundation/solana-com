...
- **Полномочия на выпуск (Mint Authority)**: Контролируют создание новых
  ...
  создания начального запаса для создания токена с фиксированным запасом.
...
- **Владелец аккаунта (Account Owner)**: Имеет полный контроль над token
  аккаунтом. Может переводить токены, сжигать токены, одобрять делегатов и
...
текущий обладатель полномочий может передать свои права новому адресу или
отозвать их навсегда, установив полномочия в null. После отзыва полномочия не
