...
description: Узнайте, как конвертировать native SOL в wrapped SOL.
---

## Синхронизация Native SOL

Wrapped SOL (WSOL) — это токен-аккаунт, который отслеживает количество лампортов
в аккаунте как баланс токенов. WSOL позволяет интеграцию с DeFi-протоколами для
перевода SOL в виде SPL-токена.
...
синхронизирует баланс токен-аккаунта wrapped SOL (WSOL) с фактическим
количеством SOL (лампортов), хранящихся в нем. Когда вы переводите native SOL на
