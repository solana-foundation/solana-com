...
- [Header Pesan](mention:message-header): Menentukan jumlah penandatangan dan
  akun hanya-baca.
- [Alamat Akun](mention:account-addresses): Sebuah array alamat akun yang
  diperlukan oleh instruksi pada transaksi.
- [Blockhash Terbaru](mention:recent-blockhash): Bertindak sebagai stempel waktu
  untuk transaksi.
- [Instruksi](mention:instructions): Sebuah array instruksi yang akan
  dijalankan.
