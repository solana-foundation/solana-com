...
memungkinkan Anda untuk menetapkan suku bunga secara langsung pada mint account.
Bunga terus bertambah secara majemuk berdasarkan timestamp jaringan, tetapi
saldo token aktual yang disimpan di setiap token account tetap tidak berubah.
Nilai total (saldo token ditambah bunga yang terakumulasi) hanyalah sebuah
perhitungan. Tidak ada token baru yang dicetak dengan ekstensi ini.
