...
menetapkan mint sebagai grup mint (seperti Collection NFT) dengan menunjuk ke
akun yang berisi
...
menetapkan mint sebagai anggota mint (seperti NFT dalam koleksi) dengan menunjuk
ke akun yang berisi
...
sendiri. Ketika pointer extension menunjuk ke mint itu sendiri, ekstensi
