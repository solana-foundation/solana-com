...
| Instruksi                           | Deskripsi                                                                                                                                                              |
| ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`InitializeMint`_                | Menyiapkan mint account untuk transfer konfidensial. Instruksi ini harus disertakan dalam transaksi yang sama dengan instruksi _rs`TokenInstruction::InitializeMint`_. |
| _rs`UpdateMint`_                    | Memperbarui pengaturan transfer konfidensial untuk mint.                                                                                                               |
| _rs`ConfigureAccount`_              | Menyiapkan token account untuk transfer konfidensial.                                                                                                                  |
| _rs`ApproveAccount`_                | Menyetujui token account untuk transfer konfidensial jika mint memerlukan persetujuan untuk token account baru.                                                        |
| _rs`EmptyAccount`_                  | Mengosongkan saldo konfidensial pending dan available untuk memungkinkan penutupan token account.                                                                      |
| _rs`Deposit`_                       | Mengonversi saldo token publik menjadi saldo konfidensial pending.                                                                                                     |
| _rs`Withdraw`_                      | Mengonversi saldo konfidensial available kembali menjadi saldo publik.                                                                                                 |
| _rs`Transfer`_                      | Mentransfer token antar token account secara konfidensial.                                                                                                             |
| _rs`ApplyPendingBalance`_           | Mengonversi saldo pending menjadi saldo available setelah deposit atau transfer.                                                                                       |
| _rs`EnableConfidentialCredits`_     | Memungkinkan token account untuk menerima transfer token konfidensial.                                                                                                 |
| _rs`DisableConfidentialCredits`_    | Memblokir transfer konfidensial masuk sambil tetap mengizinkan transfer publik.                                                                                        |
| _rs`EnableNonConfidentialCredits`_  | Memungkinkan token account untuk menerima transfer token publik.                                                                                                       |
| _rs`DisableNonConfidentialCredits`_ | Memblokir transfer reguler untuk membuat account hanya menerima transfer konfidensial.                                                                                 |
| _rs`TransferWithFee`_               | Mentransfer token antar token account secara konfidensial dengan biaya.                                                                                                |
| _rs`ConfigureAccountWithRegistry`_  | Cara alternatif untuk mengonfigurasi token account untuk transfer konfidensial menggunakan account _rs`ElGamalRegistry`_ alih-alih proof _rs`VerifyPubkeyValidity`_.   |
