...
menetapkan delegasi dengan otoritas atas semua token account untuk sebuah mint.
Tidak seperti delegasi reguler yang dapat dicabut oleh pemilik token account,
delegasi permanen tidak dapat diubah atau dihapus oleh pemilik token account.
Delegasi permanen dapat mentransfer atau membakar token di token account mana
pun dari mint tersebut. Peran delegasi permanen dapat diubah ke akun baru oleh
delegasi permanen saat ini.
