...
mengharuskan semua transfer token yang masuk menyertakan memo pendamping saat
diaktifkan pada token account. Ekstensi ini dapat diaktifkan atau dinonaktifkan
oleh pemilik token account.
