...
{/* CODE_PLACEHOLDER_e093028e2f124c07a47e07b36d7e871e */}
...
Bidang `space` menunjukkan jumlah byte yang terdapat dalam bidang `data`. Ini
bukan bidang dalam [tipe Account](/docs/core/accounts#account-structure) itu
sendiri, tetapi disertakan dalam respons.

Dalam contoh ini, bidang `space` bernilai 0 karena bidang `data` berisi 0 byte
data.
