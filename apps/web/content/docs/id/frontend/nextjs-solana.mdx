...
seoTitle: Integrasi dompet Solana dengan Next.js dan @solana/react-hooks
description:
  Siapkan integrasi dompet Solana di Next.js dengan @solana/client dan
  @solana/react-hooks untuk mengirim transfer SOL.
---
...
![Aplikasi Next.js Hooks](/assets/docs/frontend/01-hero-wallet.webp)

## Sumber daya

- [Repositori Framework Kit](https://github.com/solana-foundation/framework-kit)
...
anak dapat mengakses state dompet dan hooks.

## !!steps 3. Tombol koneksi dompet
...
![Dropdown dompet terhubung](/assets/docs/frontend/03-wallet-dropdown-connected.webp)
...
![Formulir transfer SOL terisi](/assets/docs/frontend/04-sol-transfer-filled.webp)

![Transfer SOL berhasil](/assets/docs/frontend/05-sol-transfer-success.webp)

Konektor adalah set Wallet Standard yang sama (Phantom/Solflare/Backpack/deteksi
otomatis); setelah terhubung, transfer SOL menggunakan penandatangan yang
terhubung.
