...
altera ou revoga autoridades em mints e contas de token. Apenas a autoridade
atual pode transferir suas permissões para um novo endereço ou revogá-las
permanentemente ao definir a autoridade como nula. Uma vez revogada, a
autoridade não pode ser restaurada.
