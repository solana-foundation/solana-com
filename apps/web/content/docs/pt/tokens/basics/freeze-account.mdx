...
token específica. Uma vez congelada, a conta não pode enviar tokens, receber
tokens ou ser fechada até ser descongelada. Apenas a autoridade de congelamento
do mint do token pode congelar contas. Se a autoridade de congelamento for
revogada (definida como nula) na conta do mint, os tokens nunca poderão ser
congelados.
