...
exige que todas as transferências de tokens recebidas incluam um memorando
acompanhante quando ativada numa conta de token. Esta extensão pode ser ativada
ou desativada pelo proprietário da conta de token.
