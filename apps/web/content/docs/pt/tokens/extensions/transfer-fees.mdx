...
description: Aprenda como implementar a TransferFeeExtension.
---

## Como implementar a TransferFeeExtension
...
acumulam-se nas contas de token do destinatário e podem ser retiradas pela
