...
atribui um delegado com autoridade sobre todas as token accounts de um mint. Ao
contrário dos delegados regulares que os proprietários de token accounts podem
revogar, um delegado permanente não pode ser alterado ou removido pelos
proprietários de token accounts. O delegado permanente pode transferir ou
queimar tokens em qualquer token account desse mint. A função de delegado
