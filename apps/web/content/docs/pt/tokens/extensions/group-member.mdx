...
designa uma mint como uma mint de grupo (como um NFT de coleção) apontando para
uma conta contendo
...
designa uma mint como uma mint de membro (como um NFT numa coleção) apontando
para uma conta contendo
