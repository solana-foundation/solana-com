...
compostos continuamente com base no timestamp da rede, mas o saldo de tokens
armazenado em cada token account permanece inalterado. O valor total (saldo de
tokens mais juros acumulados) é apenas um cálculo. Nenhum novo token é criado
com esta extensão.
