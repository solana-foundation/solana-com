...
description: Aprenda como habilitar a InterestBearingMintExtension.
---

## Como habilitar a InterestBearingExtension
...
continuamente compostos com base no timestamp da rede, mas o saldo real de
tokens armazenado em cada token account permanece inalterado. O valor total
(saldo de tokens + juros acumulados) é apenas um cálculo. Nenhum novo token é
criado com esta extensão.
