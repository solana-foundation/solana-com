...
### Construa mais rápido com os modelos de desenvolvedor Solana

<Card title="Explorar modelos de desenvolvedor" href="/developers/templates">
...
jogar. Se estiver no celular, deslize para controlar as peças.
...
Criado por [Jonas](https://x.com/SolPlay_jonas), da equipe DevRel da Solana
Foundation.
...
<Cards>
  ...
  <Card title="Invocação entre programas" href="/docs/core/cpi">
    Como chamar um programa de outro
  </Card>
</Cards>
