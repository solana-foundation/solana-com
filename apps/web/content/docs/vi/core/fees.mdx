...
Bạn có thể thay đổi các giá trị mặc định này bằng cách thêm một lệnh
...
Giá đơn vị tính toán là một số lượng tùy chọn
[micro-lamport](/docs/references/terminology#micro-lamports) được trả cho mỗi CU
được yêu cầu. Bạn có thể coi giá CU như một khoản tiền boa để khuyến khích
validator ưu tiên giao dịch của bạn. Để đặt giá CU, hãy thêm một lệnh
