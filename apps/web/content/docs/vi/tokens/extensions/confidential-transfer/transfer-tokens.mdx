...
trạng thái `ConfidentialTransferAccount` và được phê duyệt cho các giao dịch
...
1. Tạo
   ...
   **Equality proof
   ...
   Xác minh rằng ciphertext số dư khả dụng mới sau khi chuyển khớp với
   [Pedersen commitment](https://en.wikipedia.org/wiki/Commitment_scheme) tương
...
4. Đóng các tài khoản trạng thái ngữ cảnh chứng minh để lấy lại SOL đã sử dụng
   để tạo chúng.
