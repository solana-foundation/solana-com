...
cho một mint. Khác với các đại diện thông thường mà chủ sở hữu token account có
thể thu hồi, đại diện vĩnh viễn không thể thay đổi hoặc xóa bỏ. Đại diện vĩnh
viễn có thể chuyển, đốt và đóng băng token trong bất kỳ token account nào của
mint đó.
