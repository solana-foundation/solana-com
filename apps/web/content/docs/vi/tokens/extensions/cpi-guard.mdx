...
bảo vệ các token account khỏi các giao dịch chuyển token không mong muốn thông
qua Cross Program Invocation (CPI). Khi được kích hoạt, tiện ích mở rộng này đảm
bảo rằng token chỉ có thể được chuyển thông qua các lệnh gọi trực tiếp đến hướng
dẫn chuyển token của Token Extensions Program, chặn tất cả các chương trình khác
