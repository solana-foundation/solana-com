...
trữ trong mỗi token account vẫn không thay đổi. Tổng giá trị (số dư token + lãi
tích lũy) chỉ là một phép tính. Không có token mới nào được tạo ra với tiện ích
mở rộng này.
