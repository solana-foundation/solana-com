...
account mới với một trạng thái cụ thể, chẳng hạn như đóng băng (frozen). Điều
này cho phép người tạo token áp dụng các hành vi cụ thể, như yêu cầu tất cả các
tài khoản mới phải được đóng băng theo mặc định cho đến khi được mở băng một
cách rõ ràng.
