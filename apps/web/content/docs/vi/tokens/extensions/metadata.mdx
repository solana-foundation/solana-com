...
cho phép lưu trữ metadata trên chính mint account. Điều này bao gồm tên token,
ký hiệu, URI và dữ liệu mô tả bổ sung. Khi các tiện ích mở rộng con trỏ trỏ đến
chính mint, tiện ích mở rộng
