...
loại bỏ tất cả quyền chuyển từ delegate hiện được phê duyệt. Sau khi thu hồi,
delegate không thể chuyển bất kỳ token nào từ tài khoản của bạn nữa. Đối với
Token Program, chỉ chủ sở hữu token account mới có thể thu hồi delegate. Đối với
Token Extension Program, cả chủ sở hữu token account và delegate hiện tại đều có
thể thu hồi quyền ủy quyền.
