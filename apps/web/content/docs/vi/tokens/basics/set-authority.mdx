...
- **Quyền mint**: Kiểm soát việc tạo ra token mới. Có thể mint token vào bất kỳ
  token account nào. Thường bị thu hồi sau khi lượng cung ban đầu được tạo ra để
  tạo token có lượng cung cố định.
- **Quyền đóng băng**: Kiểm soát khả năng đóng băng và giải đóng token account.
...
- **Chủ sở hữu tài khoản**: Có toàn quyền kiểm soát token account. Có thể chuyển
  token, đốt token, phê duyệt ủy quyền và đóng tài khoản khi số dư bằng không.
- **Quyền đóng**: Có thể đóng token account khi số dư bằng không. Theo mặc định,
  đây là chủ sở hữu tài khoản nhưng có thể được ủy quyền cho tài khoản khác.
...
tại mới có thể chuyển quyền của họ sang địa chỉ mới hoặc thu hồi vĩnh viễn bằng
cách đặt quyền hạn thành null. Một khi bị thu hồi, quyền hạn không thể được khôi
phục.
