...
| Testnet | `https://api.testnet.solana.com` | Kiểm thử validator và stress testing | Có thể gián đoạn theo từng thời điểm |
...
- Sự khác biệt chính giữa Devnet và Mainnet:
  - Token Devnet **không có giá trị thực**
  - Devnet bao gồm faucet token để airdrop cho việc kiểm thử ứng dụng
  - Devnet có thể bị reset sổ cái
  - Devnet thường chạy cùng phiên bản nhánh phát hành phần mềm với Mainnet Beta,
    nhưng có thể chạy phiên bản phát hành nhỏ mới hơn so với Mainnet.
...
- Token Testnet **không có giá trị thực**
- Testnet có thể bị reset sổ cái.
- Testnet bao gồm faucet token để airdrop cho việc kiểm thử ứng dụng
