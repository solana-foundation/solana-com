...
olarak belirlenmesi gerekir. (Genellikle programı ilk olarak
[dağıtan](/docs/programs/deploying) hesapla aynıdır.) Yükseltme yetkisi iptal
...
System Program'ın adresi `11111111111111111111111111111111` şeklindedir.
...
aşağıdaki yapı serileştirilir ve kontrol edilecek her imza için bir tane
oluşturulur.
