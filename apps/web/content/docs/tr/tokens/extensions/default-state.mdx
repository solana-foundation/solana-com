...
## DefaultAccountStateExtension nasıl etkinleştirilir
...
bir mint için oluşturulan tüm yeni token account'ları için varsayılan bir durum
belirler. Etkinleştirildiğinde, bu uzantı otomatik olarak her yeni token
account'ını dondurulmuş gibi belirli bir durumla başlatır. Bu, token
oluşturucularının, açıkça çözülene kadar tüm yeni hesapların varsayılan olarak
dondurulması gibi belirli davranışları uygulamasına olanak tanır.
