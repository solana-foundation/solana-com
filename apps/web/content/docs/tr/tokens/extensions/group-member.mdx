...
bir mint'i (Koleksiyon NFT'si gibi) grup mint'i olarak belirler ve güncelleme
yetkisi ve maksimum boyut gibi
[grup yapılandırmalarını](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16)
içeren bir hesaba işaret eder.
...
bir mint'i (bir koleksiyondaki NFT gibi) üye mint'i olarak belirler ve grup
adresi ve üye numarası gibi
...
doğrudan uygular ve hem grup hem de üye verilerinin mint hesabının kendisinde
