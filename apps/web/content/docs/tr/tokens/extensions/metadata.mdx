...
bir mint account'un metadata hesabının adresini belirtmesini sağlar. Bu
işaretçi,
...
[Token Metadata Interface](https://github.com/solana-program/token-metadata/blob/main/interface/src/instruction.rs)'i
doğrudan uygular ve metadata'nın mint hesabının kendisinde saklanmasına olanak
tanır. Bu, token'ın adını, sembolünü, URI'sini ve ek açıklayıcı verileri içerir.
İşaretçi uzantıları mint'in kendisine işaret ettiğinde,
