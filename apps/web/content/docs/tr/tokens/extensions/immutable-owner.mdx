---
title: Değişmez Sahip
description: Değişmez Sahip Uzantısını nasıl etkinleştireceğinizi öğrenin.
---

## Değişmez Sahip Uzantısını nasıl etkinleştirirsiniz
...
uzantısı, token hesapları için sahiplik değişikliklerini engeller. Bir token
hesabı bu uzantı ile başlatıldığında, belirlenen sahip kalıcıdır ve başka bir
hesaba aktarılamaz.
