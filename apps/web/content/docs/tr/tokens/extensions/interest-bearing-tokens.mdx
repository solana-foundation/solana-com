...
account'ta saklanan gerçek token bakiyesi değişmeden kalır. Toplam değer (token
bakiyesi artı tahakkuk eden faiz) sadece bir hesaplamadır. Bu uzantıyla yeni
token'lar basılmaz.
