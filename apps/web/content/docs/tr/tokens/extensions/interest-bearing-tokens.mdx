...
## InterestBearingExtension'ı nasıl etkinleştirirsiniz
...
doğrudan bir mint account üzerinde faiz oranı belirlemenize olanak tanır. Faiz,
ağ zaman damgasına göre sürekli olarak bileşik şekilde işler, ancak her token
account'ta saklanan gerçek token bakiyesi değişmez. Toplam değer (token
bakiyesi + tahakkuk eden faiz) sadece bir hesaplamadır. Bu uzantıyla yeni
tokenler basılmaz.
