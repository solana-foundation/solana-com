...
uzantısı, doğrudan bir mint hesabı üzerinde faiz oranı belirlemenize olanak
tanır. Faiz, ağ zaman damgasına göre sürekli olarak bileşik hale gelir, ancak
her token hesabında saklanan gerçek token bakiyesi değişmeden kalır. Toplam
değer (token bakiyesi artı tahakkuk eden faiz) yalnızca bir hesaplamadır. Bu
uzantı ile yeni token basılmaz.
