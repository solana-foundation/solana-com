---
title: Hesabı Çözme
description: Dondurulmuş bir token hesabını nasıl çözeceğinizi öğrenin.
---
...
account'a tam işlevselliğini geri kazandırır. Çözme işleminden sonra, hesap
tekrar normal şekilde token gönderip alabilir. Yalnızca token'ın mint'inin
dondurma yetkisine sahip kişi hesapları çözebilir.
