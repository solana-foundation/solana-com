...
Bir mint account, Solana üzerinde bir tokeni benzersiz şekilde temsil eder ve
global meta verilerini saklar.
...
Solana'daki her tokenin bir mint hesabı vardır ve mint'in adresi, tokenin
...
Mint hesabı oluşturmak için iki talimatı çağırmanız gerekir:

1. System Program: Mint hesabı için ayrılmış alana sahip bir hesap oluşturun ve
   sahipliği Token Program'a aktarın.
2. Token Program: Mint hesap verilerini başlatın
