...
seoTitle: Next.js ve @solana/react-hooks ile Solana cüzdan entegrasyonu
description:
  SOL transferleri göndermek için @solana/client ve @solana/react-hooks
  kullanarak Next.js'te Solana cüzdan entegrasyonunu kurun.
---
...
![Next.js Hooks Uygulaması](/assets/docs/frontend/01-hero-wallet.webp)

## Kaynaklar

- [Framework Kit Deposu](https://github.com/solana-foundation/framework-kit)
...
## !!steps 1. Solana sağlayıcısı oluşturma
...
Bu, tüm uygulamayı Solana bağlamıyla sarar, böylece tüm alt bileşenler cüzdan
durumuna ve hook'lara erişebilir.

## !!steps 3. Cüzdan bağlantı düğmesi
...
![Cüzdan açılır menü bağlı](/assets/docs/frontend/03-wallet-dropdown-connected.webp)
...
![SOL transfer formu doldurulmuş](/assets/docs/frontend/04-sol-transfer-filled.webp)

![SOL transfer başarılı](/assets/docs/frontend/05-sol-transfer-success.webp)

Bağlayıcılar aynı Wallet Standard setidir (Phantom/Solflare/Backpack/otomatik
keşif); bağlandıktan sonra SOL transferleri bağlı imzalayıcıyı kullanır.
