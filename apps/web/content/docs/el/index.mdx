...
Τα ακόλουθα SDKs είναι τα επίσημα SDKs για το Solana που αναπτύχθηκαν από την
[Anza](https://anza.xyz).
...
Εξερευνήστε τι χρειάζεται για να λειτουργήσετε έναν validator του Solana και να
