...
καταστρέφει μόνιμα tokens μειώνοντας το υπόλοιπο σε έναν λογαριασμό token. Τα
καμένα tokens αφαιρούνται από την κυκλοφορία και μειώνουν το `supply` που
παρακολουθείται στον λογαριασμό mint. Μόνο ο κάτοχος του λογαριασμού token
μπορεί να κάψει tokens από τον λογαριασμό του.
