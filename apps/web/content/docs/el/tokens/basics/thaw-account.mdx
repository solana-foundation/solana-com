---
title: Αποδέσμευση λογαριασμού
description: Μάθετε πώς να αποδεσμεύσετε έναν παγωμένο λογαριασμό token.
---
...
αντιστρέφει μια παγίωση, αποκαθιστώντας την πλήρη λειτουργικότητα σε έναν
παγωμένο λογαριασμό token. Μετά την αποδέσμευση, ο λογαριασμός μπορεί και πάλι
να στέλνει και να λαμβάνει tokens κανονικά. Μόνο η αρχή παγώματος του mint του
token μπορεί να αποδεσμεύσει λογαριασμούς.
...
<Callout type="info">
  ...
  έχουν παρόμοιες υλοποιήσεις για να επιτύχουν την ίδια λειτουργικότητα.
</Callout>
