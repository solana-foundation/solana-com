...
αφαιρεί όλες τις άδειες μεταφοράς από τον τρέχοντα εγκεκριμένο αντιπρόσωπο. Μετά
την ανάκληση, ο αντιπρόσωπος δεν μπορεί πλέον να μεταφέρει tokens από τον
λογαριασμό σας. Για το Token Program, μόνο ο κάτοχος του token account μπορεί να
ανακαλέσει έναν αντιπρόσωπο. Για το Token Extension Program, ο κάτοχος του token
account και ο τρέχων αντιπρόσωπος μπορούν να ανακαλέσουν την εξουσιοδότηση.
