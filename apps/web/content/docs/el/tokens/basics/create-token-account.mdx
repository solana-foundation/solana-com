...
<Callout type="info">
  Σημειώστε ότι στον πηγαίο κώδικα, οι προγραμματιστές αναφέρονται σε έναν
  λογαριασμό Token ως τύπο `Account`. Τόσο το [Token
...
- Λογαριασμός token της Circle: `3emsAVdmGKERbHjmGfQ6oZ1e35dkf5iYcS6U4CPKFVaa`
- Αυτός ο λογαριασμός κατέχει μόνο tokens USDC
- Η Circle ελέγχει το token μέσω της εξουσίας κατόχου του λογαριασμού token:
