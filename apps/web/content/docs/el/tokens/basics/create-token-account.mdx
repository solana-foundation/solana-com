...
εύρεση του token account οποιουδήποτε πορτοφολιού για ένα συγκεκριμένο mint.
Δείτε την
...
1. System Program: Δημιουργία ενός λογαριασμού με κατανεμημένο χώρο για ένα
   token account και μεταφορά ιδιοκτησίας στο Token Program
