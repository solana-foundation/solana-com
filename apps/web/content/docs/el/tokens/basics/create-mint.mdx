...
## Τι είναι ένα Mint Account;

Ένα mint account αντιπροσωπεύει μοναδικά ένα token στο Solana και αποθηκεύει τα
...
<Callout type="info">
  ...
  μοιράζονται την ίδια βασική υλοποίηση για το Mint account.
</Callout>

Κάθε token στο Solana έχει ένα mint account, και η διεύθυνση του mint λειτουργεί
ως ο μοναδικός αναγνωριστικός κωδικός του token.
...
μοναδικά το USDC σε ολόκληρο το οικοσύστημα του Solana. Μπορείτε να δείτε αυτό
το mint στον
...
Πρέπει να εκτελέσετε δύο εντολές για να δημιουργήσετε ένα mint account:

1. System Program: Δημιουργία ενός λογαριασμού με κατανεμημένο χώρο για ένα mint
