...
Η διαδικασία minting δημιουργεί νέες μονάδες ενός token χρησιμοποιώντας την
εντολή
...
- Μόνο η αρχή έκδοσης (mint authority) μπορεί να δημιουργήσει νέα tokens
- Πρέπει να υπάρχει ένα token account προορισμού για να λάβει τα νέα tokens
