...
αποτρέπει τη μεταφορά tokens μεταξύ λογαριασμών tokens μετά τη δημιουργία τους.
Μόλις δημιουργηθούν, τα tokens παραμένουν μόνιμα στον λογαριασμό tokens. Ωστόσο,
ο κάτοχος του λογαριασμού tokens μπορεί ακόμα να καταστρέψει tokens και να
κλείσει τον λογαριασμό tokens όταν το υπόλοιπο φτάσει στο μηδέν.
