...
με τον τρόπο που τα token account μπορούν να κλείσουν μόνο όταν το υπόλοιπο των
token είναι μηδέν, τα mint account με αυτή την επέκταση μπορούν να κλείσουν μόνο
όταν ολόκληρη η προσφορά token έχει μειωθεί στο μηδέν.
