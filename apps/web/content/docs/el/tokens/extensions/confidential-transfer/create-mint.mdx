...
1. **Δημιουργία του mint account**: Καλέστε την εντολή _rs`CreateAccount`_ του
   System Program για να δημιουργήσετε το mint account.

1. **Αρχικοποίηση της επέκτασης Confidential Transfer**: Καλέστε την εντολή
...
1. **Αρχικοποίηση του mint**: Καλέστε την εντολή
   _rs`Instruction::InitializeMint`_ του Token Extension Program για να
