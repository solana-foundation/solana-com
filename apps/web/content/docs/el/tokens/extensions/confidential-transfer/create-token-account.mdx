...
Το _rs`ConfidentialTransferAccount`_ περιέχει πολλά πεδία για τη διαχείριση
...
- **maximum_pending_balance_credit_counter**: Το όριο μέτρησης των εκκρεμών
  πιστώσεων πριν απαιτηθεί μια εντολή _rs`ApplyPendingBalance`_ για τη μετατροπή
...
υπόλοιπο. Οι κάτοχοι λογαριασμών token πρέπει να χρησιμοποιήσουν την εντολή
...
1. Ο πελάτης αναζητά τα τρέχοντα εκκρεμή και διαθέσιμα υπόλοιπα, κρυπτογραφεί το
   ...
   χρησιμοποιώντας το κλειδί AES του κατόχου του λογαριασμού token.

2. Οι αναμενόμενοι και πραγματικοί μετρητές πίστωσης εκκρεμών παρακολουθούν τις
...
Οι αντίστοιχοι μετρητές αναμενόμενων/πραγματικών υποδεικνύουν ότι το
...
αναμενόμενων/πραγματικών εκκρεμών υπολοίπων απαιτούν από τον πελάτη να
αναζητήσει πρόσφατες οδηγίες κατάθεσης/μεταφοράς που ταιριάζουν με τη διαφορά
των μετρητών για να υπολογίσει το σωστό υπόλοιπο.

**Διαδικασία συμφωνίας υπολοίπου**

Όταν οι αναμενόμενοι και οι πραγματικοί μετρητές εκκρεμών υπολοίπων διαφέρουν,
...
2. Ανακτήστε τις πιο πρόσφατες συναλλαγές που περιλαμβάνουν οδηγίες κατάθεσης
   και μεταφοράς μέχρι τη διαφορά των μετρητών (πραγματικός - αναμενόμενος):
   - Προσθέστε δημόσια ποσά από οδηγίες κατάθεσης
   - Αποκρυπτογραφήστε και προσθέστε κρυπτογραφημένα ποσά προορισμού από οδηγίες
     μεταφοράς
