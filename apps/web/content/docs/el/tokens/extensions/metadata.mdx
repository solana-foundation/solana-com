---
title: Επεκτάσεις Μεταδεδομένων & Δείκτη Μεταδεδομένων
description:
  Μάθετε πώς να ενεργοποιήσετε την επέκταση MetadataPointerExtension και την
  επέκταση TokenMetadata.
---

## Πώς να ενεργοποιήσετε την επέκταση MetadataPointerExtension και την επέκταση TokenMetadata
