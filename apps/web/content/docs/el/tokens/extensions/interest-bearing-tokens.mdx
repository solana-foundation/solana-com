...
σας επιτρέπει να ορίσετε ένα επιτόκιο απευθείας σε έναν λογαριασμό mint. Ο τόκος
ανατοκίζεται συνεχώς με βάση τη χρονική σήμανση του δικτύου, αλλά το πραγματικό
υπόλοιο τοκενς που αποθηκεύεται σε κάθε λογαριασμό token παραμένει αμετάβλητο. Η
συνολική αξία (υπόλοιο τοκενς συν δεδουλευμένος τόκος) είναι μόνο ένας
υπολογισμός. Δεν δημιουργούνται νέα tokens με αυτήν την επέκταση.
