...
ορίζει έναν αμετάκλητο αντιπρόσωπο με εξουσία σε όλους τους token account για
ένα mint. Σε αντίθεση με τους κανονικούς αντιπροσώπους που οι ιδιοκτήτες των
token account μπορούν να ανακαλέσουν, ένας μόνιμος αντιπρόσωπος δεν μπορεί να
αλλάξει ή να αφαιρεθεί. Ο μόνιμος αντιπρόσωπος μπορεί να μεταφέρει, να κάψει και
να παγώσει tokens σε οποιονδήποτε token account αυτού του mint.
