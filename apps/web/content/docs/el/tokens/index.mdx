...
προσδιορίζει ποιος έχει εξουσιοδότηση πάνω στο token account. Αυτό διαφέρει από
τον κάτοχο προγράμματος που καθορίζεται στον βασικό τύπο
...
και τέλη συναλλαγών. Για χρήστες του Solana Playground που το χρησιμοποιούν για
...
devnet SOL από τη δημόσια [web faucet](https://faucet.solana.com/).
...
τερματικό του Playground σας όταν ακολουθείτε. Για παράδειγμα, η εντολή
...
Σημείωση: `<TOKEN_ADDRESS>` καθορίζει τον λογαριασμό mint για τον λογαριασμό
token.
...
Η εντολή _rs`MintTo`_ στο Token Program δημιουργεί νέα tokens. Η εξουσία mint
πρέπει να υπογράψει τη συναλλαγή. Η εντολή δημιουργεί tokens σε έναν λογαριασμό
token και αυξάνει τη συνολική προσφορά στον λογαριασμό mint. Ακολουθεί ένα
παράδειγμα Javascript στο
...
κάτοχος του λογαριασμού token του αποστολέα πρέπει να υπογράψει τη συναλλαγή. Η
εντολή μεταφέρει tokens μεταξύ λογαριασμών token. Ακολουθεί ένα παράδειγμα
Javascript στο
