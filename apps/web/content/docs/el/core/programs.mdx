...
του παρόντος, υπάρχουν πέντε προγράμματα φόρτωσης:
...
| v1       | `BPFLoader1111111111111111111111111111111111` | Οι εντολές διαχείρισης είναι απενεργοποιημένες, αλλά τα προγράμματα εξακολουθούν να εκτελούνται                                              | —                                                                                                                                          |
| v2       | `BPFLoader2111111111111111111111111111111111` | Οι εντολές διαχείρισης είναι απενεργοποιημένες, αλλά τα προγράμματα εξακολουθούν να εκτελούνται                                              | [Οδηγίες](https://docs.rs/solana-loader-v2-interface/latest/solana_loader_v2_interface/enum.LoaderInstruction.html)                        |
