...
κλειδιού και [ανακτά τα δεδομένα του λογαριασμού](mention:info) για το
νεοχρηματοδοτημένο πορτοφόλι.
...
Το πεδίο `owner` δείχνει το πρόγραμμα που κατέχει τον λογαριασμό. Για τα
...
λογαριασμών πορτοφολιού και λογαριασμών προγραμμάτων. Ο λογαριασμός προγράμματος
αποθηκεύει τον μεταγλωττισμένο κώδικα byte για τον
...
Κάθε program account ανήκει στο αντίστοιχο
...
τον αριθμό των δεκαδικών ψηφίων και τους λογαριασμούς που έχουν εξουσιοδότηση να
δημιουργούν ή να παγώνουν tokens. Η διεύθυνση του mint account προσδιορίζει
μοναδικά ένα token στο δίκτυο Solana.

Το παρακάτω παράδειγμα ανακτά τον λογαριασμό Mint του USD Coin για να δείξει πώς
η κατάσταση ενός προγράμματος αποθηκεύεται σε έναν ξεχωριστό λογαριασμό.
...
όπως την αρχή mint, τη συνολική προσφορά, τον αριθμό των δεκαδικών ψηφίων.

Για να διαβάσετε από έναν λογαριασμό mint, πρέπει να αποσειριοποιήσετε το πεδίο
`data` στον τύπο δεδομένων `Mint`, που παρουσιάζεται στο
...
το πεδίο `data` του μπορεί να τροποποιηθεί μόνο από τις οδηγίες του Token
Program.
...
ερμηνευθούν με νόημα, πρέπει να αποσειριοποιηθούν. Ο κατάλληλος τύπος δεδομένων
ορίζεται από το πρόγραμμα που κατέχει τον λογαριασμό. Τα περισσότερα προγράμματα
Solana παρέχουν βιβλιοθήκες πελάτη με βοηθητικές συναρτήσεις που αφαιρούν τη
διαδικασία αποσειριοποίησης. Αυτές οι συναρτήσεις μετατρέπουν τα ακατέργαστα
bytes του λογαριασμού σε δομημένους τύπους δεδομένων, διευκολύνοντας την εργασία
