...
- **Κατάσταση (State)**: Δεδομένα που προορίζονται για ανάγνωση και διατήρηση.
  Για παράδειγμα, πληροφορίες σχετικά με tokens, δεδομένα χρηστών ή άλλα
  δεδομένα που ορίζονται εντός ενός προγράμματος.
- **Εκτελέσιμα Προγράμματα**: Λογαριασμοί που περιέχουν τον πραγματικό κώδικα
  των program accounts στο Solana. Αυτοί οι λογαριασμοί αποθηκεύουν οδηγίες που
  μπορούν να επικαλεστούν οι χρήστες.
