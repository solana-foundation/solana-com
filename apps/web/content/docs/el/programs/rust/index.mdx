...
Στη συνέχεια, προσθέστε το παρακάτω απόσπασμα στο `Cargo.toml`.
...
<CodePlaceholder title="Cargo.toml">
  Το αρχείο `Cargo.toml` θα πρέπει να μοιάζει με το παρακάτω:
</CodePlaceholder>
...
Στη συνέχεια, αντικαταστήστε τα περιεχόμενα του `src/lib.rs` με τον παρακάτω
κώδικα. Αυτό είναι ένα ελάχιστο πρόγραμμα Solana που εκτυπώνει "Hello, world!"
στο αρχείο καταγραφής του προγράμματος όταν το πρόγραμμα καλείται.

Η μακροεντολή `msg!` χρησιμοποιείται σε προγράμματα Solana για να εκτυπώσει ένα
μήνυμα στο αρχείο καταγραφής του προγράμματος.
...
Προσθέστε το ακόλουθο test στο `src/lib.rs`, κάτω από τον κώδικα του
...
Ενώ εκτελείται ο test validator, εκτελέστε την εντολή `solana program deploy` σε
ξεχωριστό terminal για να αναπτύξετε το πρόγραμμα στον τοπικό validator.
...
Προσθέστε τα ακόλουθα στο `Cargo.toml`.
...
Τα προγράμματα Solana μπορούν να ενημερωθούν με επανανάπτυξη στο ίδιο program
ID. Ενημερώστε το πρόγραμμα στο `src/lib.rs` ώστε να εμφανίζει "Hello, Solana!"
αντί για "Hello, world!".
...
Επαναναπτύξτε το πρόγραμμα χρησιμοποιώντας την ίδια εντολή
