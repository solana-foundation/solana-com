...
- The array length (encoded as [compact-u16](https://github.com/anza-xyz/agave/blob/v2.1.13/short-vec/src/lib.rs))
- The array items listed one after another

![Compact array format](/assets/docs/core/transactions/compact_array_format.png)

Compact array format is used to encode both the [account addresses](/docs/core/transactions#account-addresses) array
and the [instructions](/docs/core/transactions#instructions) array in transaction messages.
