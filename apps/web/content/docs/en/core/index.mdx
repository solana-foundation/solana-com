...
There are two main use cases for Program Derived Addresses (PDAs) on Solana:
...
[Clusters](/docs/references/clusters). Each of these clusters serves a different purpose and
