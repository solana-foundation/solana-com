...
To create an [`Instruction`](https://github.com/anza-xyz/agave/blob/v2.1.13/sdk/instruction/src/lib.rs#L94),
...
but notice that each instruction contains the same three pieces of required information:
- [`program_id`](mention:program-id)
- [`accounts`](mention:accounts)
- [`data`](mention:data)
