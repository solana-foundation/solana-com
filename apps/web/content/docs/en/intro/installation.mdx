...
Set up your local Solana development environment.
Learn how to install Rust, the Solana CLI, and Anchor Framework on Windows (WSL), Linux, and Mac.

## Prerequisites

- **Windows**: To develop Solana programs on Windows you **must** use
[Windows Subsystem for Linux](https://learn.microsoft.com/en-us/windows/wsl/install) (WSL)

## Quick installation

Use the command below to install all the necessary dependencies with a single command.
If preferred, you may [install each dependency individually](#install-dependencies).
...
[//]: # (do we want to add the --version commands for each so people can check theat it all installed properly?)
[//]: # (When I was completing this step, it failed, but something did install, so it could have been nice to have a qukck check.)

### Next steps

Once you have installed all the necessary dependencies, you are ready to review the [Solana CLI Basics](/core/solana-cli-basics) and [Anchor CLI Basics](#anchor-cli-basics).

## Install dependencies

This section provides instructions on how to install the necessary dependencies individually.
If you have successfully completed the [quick installation](#quick-installation), skip the steps in this section.
...
[//]: # (How critical is it that these steps be completed in order?)
<Steps>
<Step>
