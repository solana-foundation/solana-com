...
- Install [Rust](#install-rust), the [Solana CLI](/docs/intro/installation/solana-cli-basics), and the [Anchor CLI](/docs/intro/installation/anchor-cli-basics) individually, as described below
