...
description: Learn how to implement non-transferrable tokens.
---

## How to implement non-transferrable tokens

The non-transferrable extension is a mint extension that allows token creators to configure tokens that cannot be transferred between accounts after minting. These tokens are permanently bound to the recipient's account, making them ideal for use cases such as certificates, credentials, achievements, identity tokens, or other assets that should remain with the original holder. Once minted to an account, non-transferrable tokens cannot be moved, sold, or transferred to any other wallet. This extension can be enabled using the [`NonTransferableExtension`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L647)

<Callout type="info">
 Only the [Token Extension Program](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L647) has this implementation.
</Callout>
