---
title: Close Mint
description: Learn how to close the mint account.
---

## How to Close Mint Account

Token 2022 allows users to close the mint account by initializing it with the [`MintCloseAuthority`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L569) extension. This allows the close authority to close the mint authority when the token supply is zero. Changing the authority requires the approval of the previous one.

**Note:** Just like closing the token account requires the token balance to be zero, closing the mint account also requires the token supply to be zero.

<Callout type="info">
  Only the [Token Extension
  Program](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L569)
...
// construction instruction to close the mint account
