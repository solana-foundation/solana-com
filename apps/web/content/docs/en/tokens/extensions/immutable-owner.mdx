...
description: Learn how to make a token account immutable.
---

## How to make a token account immutable

Token 2022 allows immutable ownership of token account when initialized with the [`ImmutableOwner`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L511) extension. _Immutable Ownership_ in this case refers to initializing the token account with a single owner without the possibility of changing this owner in the future.



<Callout type="info">
  Only the [Token Extension
  Program](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L511)
