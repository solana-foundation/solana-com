---
title: CPI Guard
description: Learn how to lock certain operations within a CPI.
---

## How to lock certain operations withing a CPI
The CPI guard extension is a token account extension that prevents Cross-Program Invocation (CPI) calls from transferring tokens out of the account. For example, a token holder may wish to ensure that only direct program calls (not CPIs from other programs) can move their tokens, providing an additional layer of security against malicious or unexpected token transfers initiated by intermediate programs. This extension can be enabled using the [`CpiGuardExtension`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L661)


<Callout type="info">
  Only the [Token Extension
  Program](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L661)
