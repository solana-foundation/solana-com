...
description: Learn how to implement interest bearing tokens using token extensions.
---
## How to implement interest bearing tokens

The interest bearing extension is a mint extension that allows token creators to configure tokens that automatically accrue interest over time. For example, a token creator may wish to design a stablecoin that increases in value relative to the underlying asset at a fixed annual rate, or enable savings-like behavior for holders. Token balances grow as interest accrues, without requiring explicit actions from holders. This extension can be enabled using the [`InterestBearingExtension`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L654)

<Callout type="info">
  Only the [Token Extension
  Program](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L654)
