...
指令。查看
[实现细节](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/processor.rs#L27)。

您需要调用两个指令来创建一个 mint 账户：

1. System Program：创建一个分配了 mint 账户空间的账户，并将所有权转移给 Token
   Program。
