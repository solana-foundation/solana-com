---
title: Next.js + хуки Solana React
seoTitle: Інтеграція гаманця Solana з Next.js та @solana/react-hooks
description:
  Налаштуйте інтеграцію гаманця Solana у Next.js з @solana/client та
  @solana/react-hooks для відправлення SOL-переказів.
---
...
- [Репозиторій Framework Kit](https://github.com/solana-foundation/framework-kit)
...
## !!steps 1. Створення провайдера Solana
...
Це обгортає весь застосунок контекстом Solana, щоб усі дочірні компоненти могли
отримати доступ до стану гаманця та хуків.
...
![Опції випадаючого меню гаманця](/assets/docs/frontend/02-wallet-dropdown-options.webp)

![Випадаюче меню гаманця підключено](/assets/docs/frontend/03-wallet-dropdown-connected.webp)
...
![Форма переказу SOL заповнена](/assets/docs/frontend/04-sol-transfer-filled.webp)

![Успішний переказ SOL](/assets/docs/frontend/05-sol-transfer-success.webp)

Конектори — це той самий набір Wallet Standard
(Phantom/Solflare/Backpack/автовиявлення); після підключення перекази SOL
використовують підключений підписувач.
...
Відкрийте http://localhost:3000, підключіть гаманець Devnet і надішліть переказ
SOL.
