...
description:
  Дізнайтеся, як встановлювати повноваження для mint-акаунтів або token account.
---
...
- **Freeze Authority**: Контролює можливість заморожування та розморожування
  ...
  Часто відкликається для гарантування користувачам, що їхні токени не можуть
  бути заморожені.

### Повноваження token account

- **Власник акаунта**: Має повний контроль над token account. Може переказувати
  токени, спалювати токени, затверджувати делегатів та закривати акаунт, коли
  баланс дорівнює нулю.
- **Close Authority**: Може закрити token account, коли його баланс дорівнює
  нулю. За замовчуванням це власник акаунта, але може бути делеговано іншому
  акаунту.
...
змінює або відкликає повноваження на mint-акаунтах та token account. Тільки
