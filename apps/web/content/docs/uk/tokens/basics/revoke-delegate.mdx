...
відкликання делегат більше не може переказувати жодні токени з вашого облікового
запису. Для Token Program лише власник token account може відкликати делегата.
Для Token Extension Program власник token account і поточний делегат можуть
відкликати делегування.
