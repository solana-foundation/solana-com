...
скасовує заморожування, відновлюючи повну функціональність раніше замороженого
token account. Після розморожування рахунок знову може надсилати та отримувати
токени у звичайному режимі. Лише орган заморожування (freeze authority)
токенового мінту може розморожувати рахунки.
