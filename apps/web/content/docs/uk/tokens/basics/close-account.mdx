...
назавжди закриває токен-акаунт і переказує всі залишки SOL (rent) на вказаний
акаунт призначення. Баланс токен-акаунта має бути нульовим перед закриттям.
Тільки власник токен-акаунта або призначений орган закриття може виконати цю
інструкцію.
