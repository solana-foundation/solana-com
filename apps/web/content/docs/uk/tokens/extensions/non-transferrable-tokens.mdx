...
запобігає передачі токенів між токен-акаунтами після карбування. Після
карбування токени залишаються назавжди в токен-акаунті. Однак власник
токен-акаунта все ще може спалювати токени та закривати токен-акаунт, коли
баланс досягає нуля.
