...
запобігає зміні власника для token account. Коли token account ініціалізується з
цим розширенням, призначений власник стає постійним і не може бути переданий
