...
нараховуються безперервно на основі мітки часу мережі, але фактичний баланс
токенів, що зберігається в кожному token account, залишається незмінним.
Загальна вартість (баланс токенів + нараховані відсотки) є лише розрахунком. За
допомогою цього розширення нові токени не створюються.
