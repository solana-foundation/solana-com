---
title: Розширення Metadata та Metadata Pointer
description:
...
покажчик може посилатися на будь-який обліковий запис, яким володіє програма, що
реалізує
...
дозволяючи зберігати метадані безпосередньо в mint account. Це включає назву
токена, символ, URI та додаткові описові дані. Коли розширення покажчика
вказують на сам mint, можна використовувати розширення
...
для зберігання всіх метаданих у mint account.
