...
дозволяє автоматичний збір комісій при кожному переказі токенів. Комісії
накопичуються в токен-акаунтах одержувачів і можуть бути виведені уповноваженою
особою для зняття коштів, встановленою на міnt-акаунті.
