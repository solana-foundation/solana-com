...
монети. Коли увімкнено, це розширення автоматично ініціалізує кожен новий token
account із вказаним станом, наприклад, замороженим. Це дозволяє творцям токенів
забезпечувати певну поведінку, наприклад, вимагати, щоб усі нові облікові записи
були заморожені за замовчуванням, доки їх явно не розморозять.
