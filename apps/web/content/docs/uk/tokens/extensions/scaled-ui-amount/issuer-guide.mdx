...
команду `update-ui-amount-multiplier`. Часова мітка в секундах від початку епохи
Unix є необов'язковою і може використовуватися для встановлення користувацького
