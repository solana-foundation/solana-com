...
бути встановлений Solana CLI для використання локального validator.
...
| _rs`EmptyAccount`_                  | Очищає очікувані та доступні конфіденційні баланси, щоб дозволити закриття token account.                                                                              |
| _rs`Deposit`_                       | Конвертує публічний баланс токенів у очікуваний конфіденційний баланс.                                                                                                 |
| _rs`Withdraw`_                      | Конвертує доступний конфіденційний баланс назад у публічний баланс.                                                                                                    |
| _rs`Transfer`_                      | Переказує токени між token accounts конфіденційно.                                                                                                                     |
| _rs`ApplyPendingBalance`_           | Конвертує очікуваний баланс у доступний баланс після депозитів або переказів.                                                                                          |
| _rs`EnableConfidentialCredits`_     | Дозволяє token account отримувати конфіденційні перекази токенів.                                                                                                      |
| _rs`DisableConfidentialCredits`_    | Блокує вхідні конфіденційні перекази, але все ще дозволяє публічні перекази.                                                                                           |
| _rs`EnableNonConfidentialCredits`_  | Дозволяє token account отримувати публічні перекази токенів.                                                                                                           |
| _rs`DisableNonConfidentialCredits`_ | Блокує звичайні перекази, щоб account отримував лише конфіденційні перекази.                                                                                           |
| _rs`TransferWithFee`_               | Переказує токени між token accounts конфіденційно з комісією.                                                                                                          |
