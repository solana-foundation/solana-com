...
призначає mint як груповий mint (наприклад, Collection NFT) шляхом вказування на
...
такі як повноваження на оновлення та максимальний розмір.
...
призначає mint як mint учасника (наприклад, NFT у колекції) шляхом вказування на
обліковий запис, що містить
...
дозволяючи зберігати дані як групи, так і учасників безпосередньо в самому
обліковому записі mint. Коли розширення-вказівники вказують на сам mint,
розширення
...
можуть використовуватися для зберігання всіх даних колекції та членства в
обліковому записі mint.
