...
ініціалізувати під час створення mint.

Тільки призначений authority для закриття може закрити mint account. Подібно до
того, як token account можна закрити лише коли баланс токенів дорівнює нулю,
mint account з цим розширенням можна закрити лише коли весь обсяг токенів було
зменшено до нуля.
