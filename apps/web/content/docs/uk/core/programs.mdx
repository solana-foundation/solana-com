...
[акаунт](/docs/core/accounts#program-account), який містить виконуваний код. Цей
код організовано у функції, які називаються інструкціями. Користувачі
взаємодіють з програмою, надсилаючи [транзакцію](/docs/core/transactions), яка
...
Щоб
[змінити](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/bpf_loader/src/lib.rs#L704)
існуючу програму, обліковий запис має бути призначений як
...
та встановлено в `None`, програму більше не можна оновити.
...
| [Переказ SOL](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/system/src/system_processor.rs#L215)                        | Переказує лампорти (SOL) з облікових записів системи на інші облікові записи.                                                                                                                                                               |
...
цього наступна структура серіалізується, по одній для кожного підпису, який
потрібно перевірити.
