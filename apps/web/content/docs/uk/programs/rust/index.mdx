...
Перейдіть до директорії проєкту. Ви побачите стандартні файли `src/lib.rs` та
`Cargo.toml`
...
Solana, яка виводить "Hello, world!" у лог програми, коли програма викликається.
...
Програми Solana можна оновлювати, повторно розгортаючи їх за тим самим
