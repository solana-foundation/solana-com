...
[transactie](/docs/core/transactions) te verzenden die een of meer
...
(Meestal hetzelfde account dat oorspronkelijk
[het programma heeft gedeployed](/docs/programs/deploying).) Als de upgrade
authority wordt ingetrokken en ingesteld op `None`, kan het programma niet meer
worden bijgewerkt.
...
| --------------- | --------------------------------------------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| Ed25519 Program | `Ed25519SigVerify111111111111111111111111111` | Verifieert ed25519-handtekeningen. Als een handtekening mislukt, wordt een fout geretourneerd. | [Instructies](https://docs.rs/solana-ed25519-program/latest/solana_ed25519_program/index.html) |
