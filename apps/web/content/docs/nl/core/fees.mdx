...
Standaard krijgt
[elke instructie](https://github.com/anza-xyz/agave/blob/v2.1.13/compute-budget/src/compute_budget.rs#L149-L197)
[200.000 CU's](https://github.com/anza-xyz/agave/blob/v2.1.13/compute-budget/src/compute_budget_limits.rs#L10)
toegewezen en elke transactie
...
aan te moedigen om je transactie te prioriteren. Om de CU-prijs in te stellen,
neem je een
