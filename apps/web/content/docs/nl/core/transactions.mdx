...
- [Accountadressen](mention:account-addresses): Een array van accountadressen
  die vereist zijn voor de instructies in de transactie.
- [Recente Blockhash](mention:recent-blockhash): Fungeert als een tijdstempel
  voor de transactie.
- [Instructies](mention:instructions): Een array van instructies die moeten
  worden uitgevoerd.
