...
wijst een gemachtigde toe met autoriteit over alle token accounts voor een mint.
In tegenstelling tot reguliere gemachtigden die eigenaren van token accounts
kunnen intrekken, kan een permanente gemachtigde niet worden gewijzigd of
verwijderd door eigenaren van token accounts. De permanente gemachtigde kan
tokens in elk token account van die mint overdragen of verbranden. De rol van
permanente gemachtigde kan worden gewijzigd naar een nieuw account door de
huidige permanente gemachtigde.
