...
wijst een mint aan als een groep mint (zoals een collectie NFT) door te
verwijzen naar een account met
[groepconfiguraties](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16)
zoals update authority en maximale grootte.
...
wijst een mint aan als een lid mint (zoals een NFT in een collectie) door te
verwijzen naar een account met
...
zoals groepsadres en lidnummer.
