...
goedgekeurd zijn voor vertrouwelijke overdrachten. Het token account van de
...
1. Creëer
   ...
   **Gelijkheidsbewijs
   ...
   Verifieert dat de nieuwe beschikbare saldo-cijfertekst na de overdracht
   overeenkomt met de bijbehorende
   [Pedersen commitment](https://en.wikipedia.org/wiki/Commitment_scheme),
   waardoor wordt gegarandeerd dat het nieuwe beschikbare saldo van het
   bronaccount correct wordt berekend als
...
4. Sluit de proof context state accounts om de SOL te herstellen die gebruikt is
   om ze aan te maken.
