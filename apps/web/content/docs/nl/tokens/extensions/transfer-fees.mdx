...
## Hoe je de TransferFeeExtension implementeert
...
maakt automatische inning van kosten mogelijk bij elke token-overdracht. Kosten
worden verzameld in de ontvanger token accounts en kunnen worden opgenomen door
de opname-autoriteit die is ingesteld op het mint account.
