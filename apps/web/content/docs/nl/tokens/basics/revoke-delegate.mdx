---
title: Gemachtigde intrekken
description: Leer hoe je de gemachtigde van een token account kunt intrekken.
---

## Hoe een gemachtigde intrekken
...
gemachtigde. Na intrekking kan de gemachtigde geen tokens meer overmaken vanaf
je account. Alleen de eigenaar van het token account kan een gemachtigde
intrekken.
