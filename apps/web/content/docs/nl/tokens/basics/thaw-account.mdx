...
instructie keert een bevriezing om, waardoor de volledige functionaliteit van
een eerder bevroren token account wordt hersteld. Na het ontdooien kan het
account weer normaal tokens verzenden en ontvangen. Alleen de freeze authority
van de token's mint kan accounts ontdooien.
