...
- Tapahtuman **perusmaksu** on 5000 lamportia per allekirjoitus tapahtumassa.
- **Priorisointimaksu** (valinnainen) on ylimääräinen maksu, jonka maksat
  validatorille lisätäksesi mahdollisuutta, että nykyinen johtaja käsittelee
  tapahtumasi.
- Priorisointimaksu on: **(laskentayksikön raja × laskentayksikön hinta)**.
- **Laskentayksikön raja** on enimmäismäärä laskentayksiköitä, joita tapahtumasi
  voi käyttää.
- **Laskentayksikön hinta** on hinta per laskentayksikkö mikro-lamporteissa.
- 1 000 000 mikro-lamportia = 1 lamport
- Tapahtumamaksun maksajan on oltava System Programin omistama tili.
...
<Callout>1 000 000 mikro-lamportia = 1 lamport</Callout>
