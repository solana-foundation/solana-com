...
<Callout>
  ...
  erikseen. Sen sijaan tilin käyttöoikeudet määritetään käyttämällä `header`- ja
  `account_keys`-kenttiä.
</Callout>
...
- [`num_required_signatures`](mention:num_required_signatures): allekirjoitusten
  kokonaismäärä, jonka transaktio vaatii
- [`num_readonly_signed_accounts`](mention:num_readonly_signed_accounts): vain
  luku -oikeudella olevien tilien kokonaismäärä, jotka vaativat allekirjoituksia
