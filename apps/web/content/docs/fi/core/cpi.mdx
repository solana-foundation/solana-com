...
-funktiota käytetään. Se ottaa vastaan
[allekirjoittajan siemenet](mention:signer-seeds), joita käytetään
allekirjoittaja-[PDA:iden](<(/docs/core/pda)>) johdattamiseen.
...
-funktiota käyttäen `signers_seeds` -parametria ja kutsuvan ohjelman
`program_id` -parametria. Kun PDA on vahvistettu, se
