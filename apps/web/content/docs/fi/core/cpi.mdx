...
-funktiota käytetään. Se ottaa vastaan [allekirjoittajien siemenet](mention:signer-seeds),
joita käytetään allekirjoittaja-[PDA:iden](/docs/core/pda) johtamiseen. Solanan ajonaikainen
ympäristö kutsuu sisäisesti
[`create_program_address`](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/bpf_loader/src/syscalls/cpi.rs#L552)
-funktiota käyttäen `signers_seeds`- ja kutsuvan ohjelman `program_id`-arvoja. Kun PDA
vahvistetaan, se
