...
[muokkaamiseen](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/bpf_loader/src/lib.rs#L704)
tili on määritettävä
[päivitysvaltuutetuksi](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/bpf_loader/src/lib.rs#L894).
(Tyypillisesti sama tili, joka alun perin
[julkaisi ohjelman](/docs/programs/deploying).) Jos päivitysvaltuutus
...
System Program -ohjelman osoite on `11111111111111111111111111111111`.
...
| v3      | `BPFLoaderUpgradeab1e11111111111111111111111` | Ohjelmia voidaan päivittää julkaisun jälkeen. Ohjelman suoritettava tallennetaan erilliselle program data -tilille | [Ohjeet](https://docs.rs/solana-loader-v3-interface/latest/solana_loader_v3_interface/instruction/enum.UpgradeableLoaderInstruction.html) |
| v4      | `LoaderV411111111111111111111111111111111111` | Kehitysvaiheessa (julkaisematon)                                                                                   | [Ohjeet](https://docs.rs/solana-loader-v4-interface/latest/solana_loader_v4_interface/instruction/enum.LoaderV4Instruction.html)          |
...
| --------------- | --------------------------------------------- | ------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| Ed25519-ohjelma | `Ed25519SigVerify111111111111111111111111111` | Varmistaa ed25519-allekirjoitukset. Jos jokin allekirjoitus epäonnistuu, palautetaan virhe. | [Ohjeet](https://docs.rs/solana-ed25519-program/latest/solana_ed25519_program/index.html) |

Ed25519-ohjelma käsittelee ohjetta. Ohjeen ensimmäinen `u8` sisältää
tarkistettavien allekirjoitusten määrän, jota seuraa yhden tavun täyte. Tämän
jälkeen seuraava rakenne serialisoidaan, yksi jokaiselle tarkistettavalle
allekirjoitukselle.
...
rakenne luodaan kullekin allekirjoitukselle, sitten sarjallistetaan ja lisätään
ohjedataan.
...
| Ohjelma                  | Ohjelmatunnus                                 | Kuvaus                                                                                                                                                                                                                                                                                                                                  | Ohjeet                                                                                                                                                |
| ------------------------ | --------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| **System**               | `11111111111111111111111111111111`            | Luo uusia tilejä, varaa tilidata, määritä tilit omistajaohjelmille, siirrä lamporteja System Program -omistamista tileistä ja maksa transaktiomaksuja                                                                                                                                                                                   | [SystemInstruction](https://docs.rs/solana-program/latest/solana_program/system_instruction/enum.SystemInstruction.html)                              |
