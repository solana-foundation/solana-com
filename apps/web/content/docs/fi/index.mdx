...
<Card title="Tutustu kehittäjämalleihin" href="/developers/templates">
  Rakenna nopeammin tuotantovalmiilla malleilla dApp-sovelluksiin,
  DeFi-protokolliin, NFT-markkinapaikkoihin ja muuhun. Aloita
...
<Cards>
  <Card title="Validatorit" href="https://docs.anza.xyz/validator/anatomy">
    Yksittäiset nodet, jotka turvaavat Solana-verkkoa
  </Card>
  <Card
