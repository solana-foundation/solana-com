---
title: Aseta valtuus
description: Opi asettamaan valtuus mint-tileille tai token account -tileille.
---

## Token-valtuuksien ymmärtäminen

### Mint account -valtuudet

- **Mint-valtuus**: Hallinnoi uusien tokenien luomista. Voi mintata tokeneita
  mihin tahansa token account -tilille. Usein peruutetaan alkuperäisen tarjonnan
  luomisen jälkeen kiinteän tarjonnan tokenin luomiseksi.
- **Jäädytysvaltuus**: Hallinnoi kykyä jäädyttää ja sulattaa token account
  -tilejä. Voi estää minkä tahansa token account -tilin siirtämästä tokeneita.
  Usein peruutetaan takaamaan käyttäjille, että heidän tokeneitaan ei voida
  jäädyttää.

### Token account -valtuudet

- **Tilin omistaja**: Hallinnoi täysin token account -tiliä. Voi siirtää
  tokeneita, polttaa tokeneita, hyväksyä valtuutettuja ja sulkea tilin, kun
  saldo on nolla.
- **Sulkemisvaltuus**: Voi sulkea token account -tilin, kun sen saldo on nolla.
...
-ohje muuttaa tai peruuttaa valtuuksia mint- ja token account -tileillä. Vain
nykyinen valtuutettu voi siirtää oikeutensa uuteen osoitteeseen tai peruuttaa ne
