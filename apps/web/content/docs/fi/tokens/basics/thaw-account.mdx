---
title: Sulauta tili
description: Opi miten sulautetaan jäädytetty token account.
---
...
-toiminto kumoaa jäädytyksen, palauttaen täyden toiminnallisuuden aiemmin
jäädytetylle token account -tilille. Sulatuksen jälkeen tilillä voi jälleen
lähettää ja vastaanottaa tokeneita normaalisti. Vain tokenin mintin
jäädytysvaltuutettu voi sulauttaa tilejä.
