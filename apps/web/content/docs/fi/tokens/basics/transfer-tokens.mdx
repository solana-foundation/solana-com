...
Token-siirrot siirtävät tokeneita saman minting-lähteen token accountien välillä
käyttäen
...
- Molempien token accountien on sisällettävä samantyyppisiä tokeneita (mint)
