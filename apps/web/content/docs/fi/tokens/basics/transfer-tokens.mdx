...
description: Opi siirtämään tokeneita token-tililtä toiselle.
---

## Kuinka siirtää tokeneita

Tokenien siirtäminen tarkoittaa tokenien siirtämistä yhdeltä token-tililtä
toiselle token-tilille, joilla on sama mint. Tokenien siirto tapahtuu kun kutsut
...
ohjetta token-ohjelmassa. Vain lähde-token-tilin omistajaksi (valtuutetuksi)
määritetty osoite voi siirtää tokeneita tililtä.
