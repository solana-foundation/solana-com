...
`BurnChecked`-käsky tuhoaa tokeneja pysyvästi vähentämällä token-tilin saldoa.
Poltetut tokenit poistetaan liikkeestä ja vähentävät mint-tilillä seurattavaa
`supply`-arvoa. Vain token-tilin omistaja voi polttaa tokeneita tililtään.
