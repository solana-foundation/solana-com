---
title: Valtuutetun kumoaminen
description: Opi kumoamaan token-tilin valtuutettu.
---

## Kuinka kumota valtuutettu

[`Revoke`](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/instruction.rs#L133C5-L133C11)
-ohje poistaa kaikki siirto-oikeudet nykyiseltä hyväksytyltä valtuutetulta.
Kumoamisen jälkeen valtuutettu ei voi enää siirtää mitään tokeneita tililtäsi.
Vain token account -tilin omistaja voi kumota valtuutetun.
