...
[`Revoke`](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/interface/src/instruction.rs#L133C5-L133C11)-käsky
poistaa kaikki siirto-oikeudet tällä hetkellä hyväksytyltä delegaatilta.
Peruutuksen jälkeen delegaatti ei voi enää siirtää mitään tokeneita tililtäsi.
Token Programissa vain token accountin omistaja voi peruuttaa delegaatin. Token
Extension Programissa token accountin omistaja ja nykyinen delegaatti voivat
peruuttaa delegoinnin.
