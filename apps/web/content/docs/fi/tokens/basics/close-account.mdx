...
[`CloseAccount`](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/instruction.rs#L212C5-L212C17)-käsky
sulkee token accountin pysyvästi ja siirtää kaikki jäljellä olevat SOL:t (rent)
määritettylle kohdetilille. Token accountin saldon on oltava nolla ennen
sulkemista. Vain token accountin omistaja tai nimetty sulkemisvaltuutettu voi
suorittaa tämän käskyn.
