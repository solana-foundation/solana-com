...
määrittää mint accountin ryhmän mint accountiksi (kuten kokoelman NFT)
osoittamalla tiliin, joka sisältää
...
määrittää mint accountin jäsenen mint accountiksi (kuten kokoelmaan kuuluva NFT)
osoittamalla tiliin, joka sisältää
...
tallentamisen itse mint accountiin. Kun osoitinlaajennukset osoittavat itse mint
accountiin,
...
-laajennuksia voidaan käyttää kaikkien kokoelma- ja jäsenyystietojen
tallentamiseen mint accountissa.
