...
1. Luo
   ...
   **Tasa-arvotodistus
   ([CiphertextCommitmentEqualityProofData](https://github.com/anza-xyz/agave/blob/8b33d6d311c95780362a7d235919e7b8d2345939/zk-token-sdk/src/instruction/ciphertext_commitment_equality.rs#L56))**:
   Varmistaa, että jäljellä olevan käytettävissä olevan saldon salausteksti
   noston jälkeen vastaa sen vastaavaa
   [Pedersen-sitoumusta](https://en.wikipedia.org/wiki/Commitment_scheme),
...
4. Sulje todistustilit saadaksesi takaisin SOL, jota käytettiin niiden
   luomiseen.
...
- `confidential_transfer_create_context_state_account`-metodi, joka luo
  todistustilin.
- `confidential_transfer_withdraw`-metodi, joka kutsuu `Withdraw` -käskyä.
