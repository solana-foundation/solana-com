...
description:
  Opi ottamaan käyttöön MetadataPointerExtension ja TokenMetadata -laajennus.
---

## Kuinka ottaa käyttöön MetadataPointerExtension ja TokenMetadata -laajennus
...
mahdollistaa mint account -tilin määrittää metatietotilin osoitteen. Tämä
...
-rajapintaa toteuttava ohjelma, mikä tarjoaa joustavuutta metatietojen
tallennuspaikan suhteen.

Token Extensions Program toteuttaa suoraan
[Token Metadata Interface](https://github.com/solana-program/token-metadata/blob/main/interface/src/instruction.rs)
-rajapinnan, mikä mahdollistaa metatietojen tallentamisen itse mint account
-tilille. Tämä sisältää tokenin nimen, symbolin, URI:n ja lisäkuvaukset. Kun
osoitinlaajennukset osoittavat itse mint account -tiliin,
...
-laajennuksia voidaan käyttää kaikkien metatietojen tallentamiseen mint account
-tilille.
