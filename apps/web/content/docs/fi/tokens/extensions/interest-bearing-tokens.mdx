...
jatkuvasti verkon aikaleiman perusteella, mutta jokaisessa token accountissa
säilytetty todellinen token-saldo pysyy muuttumattomana. Kokonaisarvo
(token-saldo plus kertynyt korko) on vain laskutoimitus. Tällä laajennuksella ei
luoda uusia tokeneita.
