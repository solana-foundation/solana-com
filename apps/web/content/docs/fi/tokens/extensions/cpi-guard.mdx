...
-kutsujen kautta. Kun tämä laajennus on käytössä, se varmistaa, että tokeneita
voidaan siirtää vain suorilla kutsuilla Token Extensions Program -ohjelman
siirto-ohjeeseen, estäen kaikkia muita ohjelmia siirtämästä tokeneita CPI:n
kautta.
