...
-laajennus mahdollistaa mint-tilien sulkemisen ja niiden rentin palauttamisen.
Tämä laajennus täytyy alustaa, kun mint luodaan.

Vain nimetty sulkemisvaltuutettu voi sulkea mint-tilin. Samalla tavalla kuin
token-tilit voidaan sulkea vain kun token-saldo on nolla, mint-tilit tällä
laajennuksella voidaan sulkea vain kun koko token-tarjonta on vähennetty
nollaan.
