...
mahdollistaa automaattisen maksun keräämisen jokaisesta token-siirrosta. Maksut
kertyvät vastaanottajan token account -tileihin ja ne voidaan nostaa mint
account -tilille asetetun nostoviranomaisen toimesta.
