...
description: Opi toteuttamaan InitializePermanentDelegate-laajennus.
---

## Kuinka toteuttaa InitializePermanentDelegate-laajennus
...
account -tileihin tietyssä rahakkeessa. Toisin kuin tavalliset valtuutetut,
joiden valtuudet token account -tilin omistajat voivat peruuttaa, pysyvää
valtuutettua ei voi muuttaa tai poistaa. Pysyvä valtuutettu voi siirtää, polttaa
ja jäädyttää rahakkeita missä tahansa kyseisen rahakkeen token account -tilissä.
