...
pysyvää delegaattia eivät token-tilin omistajat voi muuttaa tai poistaa. Pysyvä
delegaatti voi siirtää tai polttaa tokeneita missä tahansa kyseisen mintin
token-tilissä. Nykyinen pysyvä delegaatti voi vaihtaa pysyvän delegaatin roolin
uudelle tilille.
