...
määrittää delegaatin, jolla on valtuudet kaikkiin token-tileihinsä tietylle
mintille. Toisin kuin tavalliset delegaatit, jotka token-tilin omistajat voivat
peruuttaa, pysyvää delegaattia ei voi muuttaa tai poistaa token-tilin omistajat.
Pysyvä delegaatti voi siirtää tai polttaa tokeneita missä tahansa kyseisen
mintin token-tilissä. Pysyvän delegaatin rooli voidaan vaihtaa uuteen tiliin
nykyisen pysyvän delegaatin toimesta.
