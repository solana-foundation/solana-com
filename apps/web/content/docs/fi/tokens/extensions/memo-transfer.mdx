...
vaatii, että kaikkiin saapuviin token-siirtoihin liitetään muistio, kun tämä
laajennus on käytössä token account -tilillä. Token account -tilin omistaja voi
