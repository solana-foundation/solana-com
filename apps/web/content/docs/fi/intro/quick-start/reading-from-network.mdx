...
Mint accountista lukemiseksi sinun on deserialisoitava `data` -kenttä `Mint`
...
että sen `data` -kenttää voivat muokata vain Token Programin ohjeet.
...
strukturoiduiksi tietotyypeiksi, mikä helpottaa tilin datan käsittelyä.
