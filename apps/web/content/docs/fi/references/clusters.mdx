...
- Keskeiset erot Devnetin ja Mainnetin välillä:
  ...
  - Devnet käyttää tyypillisesti samaa ohjelmistojulkaisuhaaran versiota kuin
    Mainnet Beta, mutta saattaa käyttää uudempaa minor-julkaisuversiota kuin
    Mainnet.
...
- Testnet käyttää tyypillisesti uudempaa ohjelmistojulkaisuhaaraa kuin sekä
  Devnet että Mainnet
...
- `https://api.mainnet.solana.com` - Solana Labsin isännöimä API-solmujen
  klusteri, kuormantasaajan tukema; nopeusrajoitettu
