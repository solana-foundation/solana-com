...
seoTitle: Solana Wallet-Integration mit Next.js und @solana/react-hooks
description:
  Richten Sie die Solana Wallet-Integration in Next.js mit @solana/client und
  @solana/react-hooks ein, um SOL-Überweisungen zu senden.
---
...
Dies umschließt die gesamte App mit dem Solana-Kontext, sodass alle
untergeordneten Komponenten auf den Wallet-Status und die Hooks zugreifen
können.
...
![SOL-Überweisungsformular ausgefüllt](/assets/docs/frontend/04-sol-transfer-filled.webp)

![SOL-Überweisung erfolgreich](/assets/docs/frontend/05-sol-transfer-success.webp)

Die Connectors sind dieselben wie im Wallet Standard
(Phantom/Solflare/Backpack/automatische Erkennung); nach der Verbindung
verwenden SOL-Überweisungen den verbundenen Signer.
...
Öffnen Sie http://localhost:3000, verbinden Sie ein Devnet-Wallet und senden Sie
eine SOL-Überweisung.
