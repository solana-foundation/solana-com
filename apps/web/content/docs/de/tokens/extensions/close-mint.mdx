...
Erweiterung ermöglicht es, mint account zu schließen und deren rent
zurückzufordern. Diese Erweiterung muss bei der Erstellung des mint
initialisiert werden.

Nur die festgelegte Schließungsautorität kann das mint account schließen.
Ähnlich wie token account nur geschlossen werden können, wenn der Token-Saldo
null ist, können mint account mit dieser Erweiterung nur geschlossen werden,
wenn die gesamte Token-Versorgung auf null reduziert wurde.
