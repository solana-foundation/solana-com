...
Im Gegensatz zu regulären Delegierten, die Token-Konten-Inhaber widerrufen
können, kann ein permanenter Delegierter nicht von Token-Konten-Inhabern
geändert oder entfernt werden. Der permanente Delegierte kann Tokens in jedem
