...
ermöglicht die automatische Gebührenerhebung bei jedem Token-Transfer. Gebühren
sammeln sich in den Empfänger-Token-Konten an und können von der
Abhebungsberechtigung, die auf dem Mint-Konto festgelegt ist, abgehoben werden.
