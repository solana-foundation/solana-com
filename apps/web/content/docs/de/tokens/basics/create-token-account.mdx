...
<Callout type="info">
  ...
  teilen sich die gleiche Basisimplementierung für den Token Account.
</Callout>
...
- Circle kontrolliert die Tokens durch die Token Account Owner-Autorität:
...
2. **Program Owner**: Das Programm, dem das Konto gehört (immer das Token
...
Autorität, die Tokens übertragen kann, nicht auf das Programm, dem das Konto
gehört.
...
<Callout type="info">
  Nur Token Konten, die vom Associated Token Program erstellt wurden, werden
