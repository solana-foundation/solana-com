...
Token-Transfers bewegen Tokens zwischen Tokenaccounts derselben Mint mithilfe
der
...
- Beide token accounts müssen denselben Token-Typ (Mint) enthalten
- Nur der Besitzer des Quellkontos oder ein Bevollmächtigter kann Transfers
  autorisieren
