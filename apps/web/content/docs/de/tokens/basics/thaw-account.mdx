...
Anweisung hebt ein Einfrieren auf und stellt die volle Funktionalität eines
zuvor eingefrorenen Token-Kontos wieder her. Nach dem Auftauen kann das Konto
wieder wie gewohnt Token senden und empfangen. Nur die Freeze-Autorität des
Token-Mints kann Konten auftauen.
