...
Anweisung synchronisiert den Kontostand eines Wrapped SOL (WSOL) token account
mit den tatsächlich darin gespeicherten SOL (Lamports). Wenn Sie natives SOL an
