...
Anweisung zerstört Token dauerhaft, indem sie den Saldo in einem Token-Konten
reduziert. Verbrannte Token werden aus dem Umlauf entfernt und verringern das
`supply`, das im Mint-Konten verfolgt wird. Nur der Besitzer des Token-Kontens
kann Token von seinem Konten verbrennen.
