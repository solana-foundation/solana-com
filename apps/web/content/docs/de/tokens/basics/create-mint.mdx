...
<Callout type="info">
  ...
  die gleiche Basisimplementierung für das Mint-Konto teilen.
</Callout>

Jeder Token auf Solana hat ein Mint-Konto, und die Adresse des Mints dient als
...
## Wie man ein Mint-Konto erstellt
...
Sie müssen zwei Anweisungen ausführen, um ein Mint-Konto zu erstellen:

1. System Program: Erstellen Sie ein Konto mit zugewiesenem Speicherplatz für
   ein Mint-Konto und übertragen Sie die Eigentümerschaft an das Token Program.
2. Token Program: Initialisieren Sie die Mint-Kontodaten
