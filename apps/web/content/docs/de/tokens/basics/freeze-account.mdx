...
Anweisung verhindert alle Token-Transfers oder Token-Burns von einem bestimmten
Token-Konto. Sobald eingefroren, kann das Konto keine Token senden, empfangen
oder geschlossen werden, bis es wieder aufgetaut wird. Nur die Freeze-Authority
des Token-Mints kann Konten einfrieren. Wenn die Freeze-Authority auf dem
Mint-Konto widerrufen wird (auf null gesetzt), können Token niemals eingefroren
werden.
