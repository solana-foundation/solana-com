...
Struktur. Sie enthält folgende Informationen:

- [`num_required_signatures`](mention:num_required_signatures): Die Gesamtanzahl
  der für die Transaktion erforderlichen Signaturen
- [`num_readonly_signed_accounts`](mention:num_readonly_signed_accounts): Die
  Gesamtanzahl der schreibgeschützten Konten, die Signaturen erfordern
- [`num_readonly_unsigned_accounts`](mention:num_readonly_unsigned_accounts):
  Die Gesamtanzahl der schreibgeschützten Konten, die keine Signaturen erfordern
