...
seoTitle: Integrazione wallet Solana con Next.js e @solana/react-hooks
description:
  Configura l'integrazione del wallet Solana in Next.js con @solana/client e
  @solana/react-hooks per inviare trasferimenti SOL.
---
...
- [Repository Framework Kit](https://github.com/solana-foundation/framework-kit)
...
componenti figli possano accedere allo stato del wallet e agli hooks.

## !!steps 3. Pulsante connessione wallet
...
![Opzioni dropdown del wallet](/assets/docs/frontend/02-wallet-dropdown-options.webp)

![Dropdown del wallet connesso](/assets/docs/frontend/03-wallet-dropdown-connected.webp)
...
![Trasferimento SOL riuscito](/assets/docs/frontend/05-sol-transfer-success.webp)

I connettori sono lo stesso set Wallet Standard
(Phantom/Solflare/Backpack/rilevamento automatico); una volta connesso, i
trasferimenti SOL utilizzano il firmatario connesso.
