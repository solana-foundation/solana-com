...
account di qualsiasi wallet per un dato mint. Vedi l'
[implementazione della derivazione qui](https://github.com/solana-program/associated-token-account/blob/c78722ee39ebf6741cdfa81dffd52135370a5015/interface/src/address.rs#L56).
...
Vedi l'
[implementazione qui](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/processor.rs#L83).
...
account e la sua inizializzazione attraverso Cross Program Invocation (CPI).
