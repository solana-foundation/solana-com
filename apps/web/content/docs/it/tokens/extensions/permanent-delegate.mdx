...
assegna un delegato con autorità su tutti i token account per un mint. A
differenza dei delegati regolari che i proprietari dei token account possono
revocare, un delegato permanente non può essere modificato o rimosso dai
proprietari dei token account. Il delegato permanente può trasferire o bruciare
token in qualsiasi token account di quel mint. Il ruolo di delegato permanente
può essere trasferito a un nuovo account dal delegato permanente corrente.
