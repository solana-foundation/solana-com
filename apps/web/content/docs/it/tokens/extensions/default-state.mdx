...
token account con uno stato specifico, come ad esempio congelato. Questo
permette ai creatori di token di imporre comportamenti specifici, come
richiedere che tutti i nuovi account siano congelati per impostazione
predefinita fino a quando non vengono esplicitamente scongelati.
