...
description:
  Scopri come abilitare l'estensione MetadataPointerExtension e l'estensione
  TokenMetadata.
---

## Come abilitare l'estensione MetadataPointerExtension e l'estensione TokenMetadata
...
offrendo flessibilità su dove vengono archiviati i metadati.

Il Token Extensions Program implementa direttamente
l'[Interfaccia Token Metadata](https://github.com/solana-program/token-metadata/blob/main/interface/src/instruction.rs),
consentendo di memorizzare i metadati direttamente nel mint account stesso.
...
può essere utilizzata per memorizzare tutti i metadati nel mint account.
