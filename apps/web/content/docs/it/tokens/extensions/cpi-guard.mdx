...
protegge i token account da trasferimenti imprevisti attraverso Cross Program
Invocation (CPIs). Quando abilitata, questa estensione garantisce che i token
