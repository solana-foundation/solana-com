...
attribue un délégué avec autorité sur tous les token accounts d'un mint.
Contrairement aux délégués réguliers que les propriétaires de token accounts
peuvent révoquer, un délégué permanent ne peut pas être modifié ou supprimé par
les propriétaires de token accounts. Le délégué permanent peut transférer ou
brûler des tokens dans n'importe quel token account de ce mint. Le rôle de
délégué permanent peut être transféré à un nouveau compte par le délégué
permanent actuel.
