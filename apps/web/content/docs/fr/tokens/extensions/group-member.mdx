---
title: Groupes de jetons et membres
description:
...
désigne un mint comme mint de groupe (comme un NFT de collection) en pointant
...
désigne un mint comme mint membre (comme un NFT dans une collection) en pointant
vers un compte contenant des
...
permettant de stocker les données du groupe et des membres sur le mint account
...
d'adhésion dans le mint account.
