...
désigne un mint comme un mint de groupe (tel qu'un NFT de collection) en
...
telles que l'autorité de mise à jour et la taille maximale.
...
désigne un mint comme un mint membre (tel qu'un NFT dans une collection) en
pointant vers un compte contenant des
[données d'appartenance](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67)
telles que l'adresse du groupe et le numéro de membre.
