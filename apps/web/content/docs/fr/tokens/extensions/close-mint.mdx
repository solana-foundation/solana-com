...
permet de fermer les comptes mint et de récupérer leur rent. Cette extension
doit être initialisée lors de la création du mint.

Seule l'autorité de fermeture désignée peut fermer le compte mint. Similaire à
la façon dont les token accounts ne peuvent être fermés que lorsque le solde de
jetons est à zéro, les mint accounts avec cette extension ne peuvent être fermés
que lorsque l'ensemble de l'approvisionnement en jetons a été réduit à zéro.
