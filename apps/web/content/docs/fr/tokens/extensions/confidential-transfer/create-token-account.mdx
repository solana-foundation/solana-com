...
- **approved** : le statut d'approbation du compte pour les transferts
  confidentiels. Si la configuration `auto_approve_new_accounts` du compte mint
  est définie sur `true`, tous les comptes de jetons sont automatiquement
...
2. Les compteurs de crédits en attente attendus et réels suivent les changements
...
différentes nécessitent que le client recherche les instructions récentes de
