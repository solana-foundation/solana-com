...
permet la collecte automatique de frais sur chaque transfert de token. Les frais
s'accumulent dans les comptes de token du destinataire et peuvent être retirés
par l'autorité de retrait définie sur le compte mint.
