...
protège les comptes de jetons contre les transferts inattendus via les Cross
Program Invocations (CPIs). Lorsqu'elle est activée, cette extension garantit
que les jetons ne peuvent être transférés que par des appels directs à
l'instruction de transfert du Token Extensions Program, bloquant ainsi tous les
autres programmes qui tenteraient de transférer des jetons via CPI.
