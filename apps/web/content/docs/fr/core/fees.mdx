...
Vous pouvez également définir les frais de priorisation en utilisant
[`ComputeBudgetProgram.setComputeUnitPrice`](/docs/clients/javascript-reference#computebudgetprogramsetcomputeunitprice).
