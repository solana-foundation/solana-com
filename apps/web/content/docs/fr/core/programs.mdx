...
Sur Solana, un smart contract est appelé un programme. Un programme est un
...
[autorité de mise à niveau](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/bpf_loader/src/lib.rs#L894).
(Généralement le même compte qui a initialement
[déployé le programme](/docs/programs/deploying).) Si l'autorité de mise à
niveau est révoquée et définie sur `None`, le programme ne peut plus être mis à
jour.
...
| Chargeur | ID du programme                               | Notes                                                                                                                              | Lien des instructions                                                                                                                           |
| -------- | --------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
...
En plus des programmes de chargement, Solana fournit les programmes précompilés
suivants.
