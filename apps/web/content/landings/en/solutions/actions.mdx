...
seoDescription: >
  Bring your app everywhere with Solana Actions. Interface with users anywhere
  you can post a link.
seoImage: "/src/img/landings/assets_2Fce0c7323a97a4d91bd0baa7490ec9139_2F567b4abec41445208b6196b426ee599d.png"
---
...
>
  <Hero
    ...
    headline="Bring Crypto to the People with Solana Actions and Blockchain Links"
...
>
  <Section maxWidth={1200} lazyLoad={false}>
    <Columns
      space={50}
    ...
    >
      ...
      <HtmlParser
        rawHtml={`<video autoplay muted loop controls width="575" height="325">
        <source
      ...
      />
      <HtmlParser
        rawHtml={`<p>Using Solana Actions, you can turn any transaction into a blockchain link that can be shared anywhere on the internet — no third party application required. Request a payment in a text message. Vote on governance in a chatroom. Buy an NFT on social media. It's all possible.</p>`}
      />
...
>
  <Section noPadding>
    <HtmlParser rawHtml="<h2 style='textAlign:center'>Meet users where they are, with blinks.</h2>" />
    {/* Desktop/Tablet image - visible on medium (768px+), hidden on small */}
    <ResponsiveBox
      responsiveStyles={{
        small: {
          display: "none"
    ...
    {/* Mobile image - visible on small (< 768px), hidden on medium+ */}
    <ResponsiveBox
      responsiveStyles={{
        small: {
          display: "flex",
    ...
    <HtmlParser
      rawHtml={`<p style='textAlign:center'>Make a donation with <strong>Sphere</strong>. Purchase an NFT with <strong>Tensor.</strong> Vote on proposals with<strong> Realms. </strong></p>`}
    />
  </Section>
</ResponsiveBox>
...
>
  <HtmlParser
    rawHtml={`<p><em>Blockchain links are an interface. <span class="ql-cursor">﻿</span>Solana Actions are the APIs to deliver transactions on many surfaces.</em></p>`}
  />
</ResponsiveBox>
...
>
  <Section maxWidth={1200} lazyLoad={false}>
    ...
    <HtmlParser rawHtml="<h2>With Solana Actions, request transactions with…</h2>" />
    ...
    cards={[
      {
        image: {
          alt: "",
          src: "/src/img/landings/assets_2Fce0c7323a97a4d91bd0baa7490ec9139_2F4c8f1f0f555e4c1ca8f7d5f86ad13d5c.png"
        },
        button: {
          label: "More from Dialect",
          hierarchy: "outline",
      ...
      },
      {
        image: {
          alt: "",
          src: "/src/img/landings/assets_2Fce0c7323a97a4d91bd0baa7490ec9139_2Ffc09e2ce4b1a4059b22c144f1a071de4.png"
        },
        button: {
          label: "More from Dialect",
          hierarchy: "outline",
      ...
      },
      {
        image: {
          alt: "",
          src: "/src/img/landings/assets_2Fce0c7323a97a4d91bd0baa7490ec9139_2F47161c34d2b04f25aca2961505231909.png"
        },
        button: {
          label: "More from Dialect",
          hierarchy: "outline",
      ...
      },
      {
        image: {
          alt: "",
          src: "/src/img/landings/assets_2Fce0c7323a97a4d91bd0baa7490ec9139_2F5cd936f2074b42a1913350cc8c97b9eb.png"
        },
        button: {
          label: "More from Dialect",
          hierarchy: "outline",
      ...
      },
      {
        image: {
          alt: "",
          src: "/src/img/landings/assets_2Fce0c7323a97a4d91bd0baa7490ec9139_2F0bd981475b1848608afba5c49c3ca48a.png"
        },
        button: {
          label: "More from Dialect",
          hierarchy: "outline",
      ...
      },
      {
        image: {
          alt: "",
          src: "/src/img/landings/assets_2Fce0c7323a97a4d91bd0baa7490ec9139_2Ff873cab6d1d34e65be121662945e6976.png"
        },
        button: {
          label: "More from Dialect",
          hierarchy: "outline",
...
>
    ...
    <FeatureHighlight
      cards={[{ stat: { stat: "3,751", description: "Transactions per second", value: { statType: "none", dynamicValueSource: "Explorer API", dynamicValueEndpoint: "Transactions per second" } }, button: { label: "" }, feature: "FAST", body: "Solana has slot times of 400 milliseconds.", eyebrow: "", variant: "none", color: "aqua" }, { stat: { stat: "3,751", description: "Average fee", value: { statType: "none", dynamicValueSource: "Explorer API", dynamicValueEndpoint: "Transactions per second", staticValue: "$0.0025" } }, button: { label: "" }, feature: "SCALABLE", body: "Solana processes more transactions than every other major blockchain combined.", eyebrow: "", variant: "none", color: "orange" }, { stat: { stat: "3,751", description: "Active Developers", value: { statType: "none", dynamicValueSource: "Explorer API", dynamicValueEndpoint: "Transactions per second", staticValue: "3000+" } }, button: { label: "" }, feature: "INNOVATIVE", body: "Thousands of developers are building unique tools — from enterprise-friendly token extensions to highly scalable state compression.", eyebrow: "", variant: "none", color: "purple" }, { stat: { stat: "3,751", description: "Net Carbon Impact", value: { statType: "none", dynamicValueSource: "Explorer API", dynamicValueEndpoint: "Transactions per second", staticValue: "0" } }, button: { label: "" }, feature: "EFFICIENT", body: "Each Solana transaction uses about the same energy as a few Google searches.", eyebrow: "", variant: "none", color: "green" }]}
