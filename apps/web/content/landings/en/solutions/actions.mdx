...
<Section>
  <div class="tw-html_parser" style={{ textAlign: "center" }}>
    <h2>Meet users where they are, with blinks.</h2>
  </div>
  <ResponsiveBox
    responsiveStyles={{
      small: {
  ...
  <div class="tw-html_parser" style={{ textAlign: "center" }}>
    Make a donation with <strong>Sphere</strong>. Purchase an NFT with{" "}
    <strong>Tensor.</strong> Vote on proposals with<strong> Realms. </strong>
  </div>
</Section>
...
<div class="tw-html_parser" style={{ textAlign: "center" }}>
  <em>
    Blockchain links are an interface. <span class="ql-cursor">﻿</span>Solana
    Actions are the APIs to deliver transactions on many surfaces.
  </em>
</div>
...
>
  <Section>
    <div class="tw-html_parser" style={{ textAlign: "center" }}>
      <h2>With Solana Actions, request transactions with…</h2>
    </div>
  </Section>
</ResponsiveBox>
