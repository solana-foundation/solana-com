...
| [Crossmint](#crossmint)                 | Yes           | Payments, wallets; agentic finance; not x402-specific      | [crossmint.com](https://www.crossmint.com/)                   |
...
rails — including wallets, onramps, stablecoin orchestration, and more. Payments via x402 on Solana chain are supported on Crossmint via the Faremeter facilitator. Example [here](https://github.com/Crossmint/crossmint-agentic-finance/tree/main/ping-faremeter-crossmint-solana). Read more about Crossmint [here](https://docs.crossmint.com).
