...
A wallet is your primary tool for using Solana. It stores your digital assets,
...
No, assets are stored on Solana. Your wallet stores the keys that prove
ownership.

## What's Next

With your wallet set up, you're ready to start using Solana. In the next
chapter, we'll explore transaction fees and why they matter for accessibility.
You'll learn why Solana's low fees enable use cases that aren't practical on
other networks.

Remember: everyone was new once. Take time to get comfortable with your wallet
before moving large amounts. The Solana community is here to help if you have
questions.