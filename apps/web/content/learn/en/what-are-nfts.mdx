...
1. **Asset Account**: Unique identifier on Solana that stores important information about the NFT (owner, name, image, traits)
2. **Plugins**: Extensions to baseline functionality to support additional features (royalties, extra data, provenance, etc.)
...
- Technical standards for NFT creation ([Metaplex Token Metadata](https://developers.metaplex.com/token-metadata), [Metaplex Core](https://developers.metaplex.com/core))
