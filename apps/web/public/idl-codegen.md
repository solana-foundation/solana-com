...
Never hand-maintain multiple program clients by manually re-implementing
serializers. Prefer an IDL-driven, code-generated workflow.
...
- Do not hand-write Borsh layouts for programs you own; use the IDL/codegen
  pipeline.
