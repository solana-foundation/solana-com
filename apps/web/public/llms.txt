...
- [إلغاء تجميد الحساب](https://solana.com/docs/ar/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية إلغاء تجميد حساب token مجمد.
...
- [تعيين السلطة](https://solana.com/docs/ar/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية تعيين السلطة لحسابات العملات أو حسابات الرموز.
...
- [Autorität festlegen](https://solana.com/docs/de/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie Autoritäten für Mints oder Token-Konten festlegen.
...
- [Konten auftauen](https://solana.com/docs/de/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie ein eingefrorenes Token-Konto auftauen können.
...
- [Αποδέσμευση λογαριασμού](https://solana.com/docs/el/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να αποδεσμεύσετε έναν παγωμένο λογαριασμό token.
...
- [Establecer autoridad](https://solana.com/docs/es/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo establecer autoridad para mints o token accounts.
...
- [Sincronizar SOL nativo](https://solana.com/docs/es/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo convertir SOL nativo a SOL envuelto.
...
- [Aseta valtuus](https://solana.com/docs/fi/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi asettamaan valtuus mint-tileille tai token account -tileille.
...
- [Sulauta tili](https://solana.com/docs/fi/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi miten sulautetaan jäädytetty token account.
...
- [Valtuutetun kumoaminen](https://solana.com/docs/fi/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi kumoamaan token-tilin valtuutettu.
...
- [Révoquer le délégué](https://solana.com/docs/fr/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment révoquer le délégué d'un token account.
...
- [Sync Native](https://solana.com/docs/fr/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment convertir des SOL natifs en SOL encapsulés.
...
- [Imposta autorità](https://solana.com/docs/it/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri come impostare l'autorità per i mint account o i token account.
...
- [委任の取り消し](https://solana.com/docs/ja/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): トークンアカウントの委任を取り消す方法を学びます。
...
- [権限の設定](https://solana.com/docs/ja/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): ミントやトークンアカウントの権限を設定する方法を学びましょう。
...
- [계정 해동](https://solana.com/docs/ko/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): 동결된 토큰 계정을 해동하는 방법을 알아보세요.
...
- [Autoriteit instellen](https://solana.com/docs/nl/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je autoriteit instelt voor mints of token accounts.
...
- [Gemachtigde intrekken](https://solana.com/docs/nl/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je de gemachtigde van een token account kunt intrekken.
...
- [Odblokowanie konta](https://solana.com/docs/pl/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak odblokować zamrożone konto tokenów.
...
- [Synchronizuj Native](https://solana.com/docs/pl/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak przekonwertować natywne SOL na opakowane SOL.
...
- [Ustawianie autorytetu](https://solana.com/docs/pl/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak ustawić autorytet dla mintów lub token account.
...
- [Definir Autoridade](https://solana.com/docs/pt/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como definir autoridade para mints ou token accounts.
...
- [Hesabı Çözme](https://solana.com/docs/tr/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dondurulmuş bir token hesabını nasıl çözeceğinizi öğrenin.
...
- [Sync Native](https://solana.com/docs/tr/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Native SOL'u wrapped SOL'a dönüştürmeyi öğrenin.
...
- [Temsilciyi İptal Et](https://solana.com/docs/tr/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Token hesabı temsilcisini nasıl iptal edeceğinizi öğrenin.
...
- [Встановлення повноважень](https://solana.com/docs/uk/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як встановлювати повноваження для mint-акаунтів або token account.
...
- [Розморожування рахунку](https://solana.com/docs/uk/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як розморозити заморожений token account.
...
- [Thiết lập quyền hạn](https://solana.com/docs/vi/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách thiết lập quyền hạn cho mint hoặc token account.
...
- [同步原生 SOL](https://solana.com/docs/zh/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何将原生 SOL 转换为封装 SOL。
