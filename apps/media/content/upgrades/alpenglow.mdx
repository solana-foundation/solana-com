...
not registered a BLS pubkey on-chain are now excluded from the admitted
validator set under Alpenglow consensus. See [BLS Pubkeys and the Validator Admission Ticket](/upgrades/bls-pubkey-vat)
