...
decrements gated by successive feature activations. The first reduction, to a
350ms target, activated on Mainnet in August 2026. The network will not advance
to the next decrement if block skip rates are too high.
