...
<StatusBadgeGroup>
  <StatusBadge color="green">Devnet Live</StatusBadge>
  <StatusBadge color="yellow">Target Mainnet: May 2026</StatusBadge>
</StatusBadgeGroup>

<MetricCardGroup>
  <MetricCard value="95-98%" label="Reduction in Compute Units" />
  <MetricCard value="10%" label="More Total Block Space" />
</MetricCardGroup>
