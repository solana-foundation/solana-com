...
description: >-
  ...
  90% reduction, rolled out through five feature-gated steps with a fallback to
  protect against unexpected state growth.
...
additionalResources:
  - label: Technical Deep Dive
    url: https://solana.com/news/rent-reduction-deep-dive
