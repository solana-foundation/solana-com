...
<StatusBadgeGroup>
  <StatusBadge color="green">🟢 Agave 4.x + Opt in</StatusBadge>
  <StatusBadge color="purple">🟢 Firedancer: Default on</StatusBadge>
</StatusBadgeGroup>

<MetricCardGroup>
  <MetricCard value="200x" label="Latency Reduction vs. Standard Networking" />
  <MetricCard value="100M" label="Compute Units per Block (Enabled by XDP)" />
</MetricCardGroup>
