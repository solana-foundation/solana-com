...
Agave 4.0.0 and later versions supports XDP for block propagation. Agave
validator clients must explicitly enable the feature. The Firedancer client
uses XDP by default.
...
**Learn more:** [Solana Upgrades](/news/solana-network-upgrades)
