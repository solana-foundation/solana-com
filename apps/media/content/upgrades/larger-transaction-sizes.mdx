...
targets mainnet feature activation in **Agave v4.2**, following devnet activation
the week of July 13. This lands alongside the first stage of
[reduced slot times](/upgrades/reduced-slot-times) and a rent reduction. Anza's
schedule is explicitly tentative and subject to change.

|                                  |                                                  |
| -------------------------------- | ------------------------------------------------ |
| Expected Mainnet Activation Date | Targeted for Agave v4.2 (tentative)              |
