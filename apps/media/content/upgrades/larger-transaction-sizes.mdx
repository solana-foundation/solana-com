...
badges:
  - text: "Target Mainnet: Aug 17, 2026"
    color: green
    variant: text
metrics:
  - value: "4096"
...
targets mainnet feature activation for **August 17, 2026**, alongside the
first stage of [reduced slot times](/upgrades/reduced-slot-times) and a rent
reduction, following devnet/testnet activation the week of July 13 and a
general-adoption recommendation on August 10. Anza's schedule is explicitly
tentative and subject to change.

|                                  |                                                  |
| -------------------------------- | ------------------------------------------------ |
| Expected Mainnet Activation Date | Targeted Aug 17, 2026 (tentative, Agave 4.2)     |
