...
<Figure src="/uploads/posts/resource-and-inclusion-fee-digging-into-data/cdf_cost_unit_overequest.png" alt="Distribution of Cost Unit excess per transaction">
...
<Figure src="/uploads/posts/resource-and-inclusion-fee-digging-into-data/cdf_fee_impact.png" alt="Distribution of the base fee increase with SGP-0003.">
...
<Figure src="/uploads/posts/resource-and-inclusion-fee-digging-into-data/burn_rate_forecast.png" alt="SOL burn rate under SGP-0003.">
...
<Figure src="/uploads/posts/resource-and-inclusion-fee-digging-into-data/summary_stats_cost_unit_excess.png" alt="Summary statistics of Cost Unit excess for each transaction topology">
  Fig. 2: Summary statistics of Cost Unit excess for each transaction topology. Source: [Dune](https://dune.com/queries/8228815).
</Figure>
...
<Figure src="/uploads/posts/resource-and-inclusion-fee-digging-into-data/daily_fraction_consumed_requested.png" alt="Fraction of Cost Unit Consumed over Requested">
  Fig. 3: Fraction of Cost Unit Consumed over Requested. Source: [Dune](https://dune.com/queries/7659730/11705506).
</Figure>
...
<Figure src="/uploads/posts/resource-and-inclusion-fee-digging-into-data/cdf_fee_impact.png" alt="Distribution of the base fee increase with SGP-0003">
  Fig. 4: Distribution of the base fee increase with SGP-0003. Here we display the CDF of base fee increase expressed as percentage. The value on y-axis represents the probability to find a tx with a percent increase on base fee lower than the value on the x-axis. Source: [Dune](https://dune.com/queries/8358726/12390118).
</Figure>
...
<Figure src="/uploads/posts/resource-and-inclusion-fee-digging-into-data/fee_impact_on_transfers.png" alt="Fee impact on Transfer.">
  Fig. 5: Fee impact on Transfer. Distribution of SOL increase in base fee per transaction. Source: [Dune](https://dune.com/queries/8359805/?utm_source=share\&utm_medium=copy\&utm_campaign=query).
</Figure>

<Figure src="/uploads/posts/resource-and-inclusion-fee-digging-into-data/fee_impact_on_account_creation.png" alt="Fee impact on account creation.">
  Fig. 6: Fee impact on account creation. Distribution of SOL increase in base fee per transaction. Source: [Dune](https://dune.com/queries/8387099/?utm_source=share\&utm_medium=copy\&utm_campaign=query).
</Figure>
...
<Figure src="/uploads/posts/resource-and-inclusion-fee-digging-into-data/fee_impact_on_propAMM.png" alt="Distribution of base fee change after SGP-0003 for propAMMs’ oracle updates">
  Fig. 7: Distribution of base fee change after SGP-0003 for propAMMs’ oracle updates. Source: [Dune](https://dune.com/queries/8371306/?utm_source=share\&utm_medium=copy\&utm_campaign=query).
</Figure>
...
<Figure src="/uploads/posts/resource-and-inclusion-fee-digging-into-data/fee_impact_on_MMs.png" alt="Distribution of fee difference post SGP-0003 for market making activity">
  Fig. 8: Distribution of fee difference post SGP-0003 for market making activity. Source: [Dune](https://dune.com/queries/8371701/?utm_source=share\&utm_medium=copy\&utm_campaign=query).
</Figure>
...
<Figure src="/uploads/posts/resource-and-inclusion-fee-digging-into-data/fee_impact_on_routers.png" alt="Distribution of fee increase for Aggregators">
  Fig. 9: Distribution of fee increase for Aggregators. Source: [Dune](https://dune.com/queries/8360126/12361273?sidebar=none).
</Figure>
...
<Figure src="/uploads/posts/resource-and-inclusion-fee-digging-into-data/effects_on_arbs.png" alt="effects on arbs">
  &#x20;
</Figure>
...
<Figure src="/uploads/posts/resource-and-inclusion-fee-digging-into-data/fee_impact_on_block_rewards.png" alt="Change in SOL rewards per block distribution">
  Fig. 10: Change in SOL rewards per block distribution. Source: [Dune](https://dune.com/queries/8387471/12390812).
</Figure>
...
<Figure src="/uploads/posts/resource-and-inclusion-fee-digging-into-data/burn_rate_forecast.png" alt="SOL burn rate under SGP-0003.">
  Fig. 11: SOL burn rate under SGP-0003. Orange line represents the optimized setup, where on average all resources are reduced by 10%. Gray line represents the current cost units usage with an excess in requested resources equal to the p75 of excess showed by txs specifying both CU and loaded data size. Pink line represent the current Cost Unit consumption with no excess. Blue line is the current burn rate. Source: [Dune](https://dune.com/queries/8370858).
</Figure>
