...
Indeed, under SGP-0003, protocol fee revenue is unchanged for single-signer transactions but decreases for multi-signer transactions. This produces the distribution of losses per block displayed in Fig. 8. Given the current snapshot, the expected value of SOL decrease per block is 0.00015 SOL.
