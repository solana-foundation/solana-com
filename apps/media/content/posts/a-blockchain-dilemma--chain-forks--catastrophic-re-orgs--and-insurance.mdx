...
slug: a-blockchain-dilemma--chain-forks--catastrophic-re-orgs--and-insurance
date: "2019-10-21"
categories:
...
seo:
  ...
  noFollow: false
  openGraph:
    ogTitle: "A Blockchain Dilemma: Chain Forks, Catastrophic Re-orgs, and Insurance"
    ogUrl: >-
      https://www.solana.com/blog/a-blockchain-dilemma--chain-forks--catastrophic-re-orgs--and-insurance
    ogDescription: >

      An analysis of a critical issue that blockchain networks must address, and
      a look at potential solutions
    ogImage: null
    ogType:
      - article
  twitter:
    twitterTitle: "A Blockchain Dilemma: Chain Forks, Catastrophic Re-orgs, and Insurance"
    twitterImage: null
    twitterDescription: >
