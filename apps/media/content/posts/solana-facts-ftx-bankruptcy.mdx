...
categories:
  - category: finance
heroImage: /uploads/posts/solana-facts-ftx-bankruptcy/31a9c00e8b004e74a56346ed52dc5970.webp
status: published
...
- Locked tokens are deposited into locked stake accounts and they cannot be transferred onchain until the lock has expired. Locked tokens can be staked, and broken into smaller stake accounts, but the tokens within stake accounts cannot be transferred onchain until the lock has expired.
