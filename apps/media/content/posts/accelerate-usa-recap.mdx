...
status: published
heroImage: /uploads/posts/accelerate-usa-recap/heroImage.png
description: >
...
<video background="bg-default" color="default" url="https://youtu.be/T6x_TIoZWPY" autoPlay={false} loop={false} controls muted={false} />
...
<video background="bg-default" color="default" url="https://www.youtube.com/watch?v=NLwfchHo5gM" autoPlay={false} loop={false} controls muted={false} />
...
* **Jito's Lucas Bruder (buffalu) unveiled jtx\_trade**, a self-custodial trading platform with CEX-grade execution
...
<video background="bg-default" color="default" url="https://youtu.be/Rf8v-vh620I" autoPlay={false} loop={false} controls muted={false} />
...
<video background="bg-default" color="default" url="https://www.youtube.com/playlist?list=PLilwLeBwGuK79-7R_6dGN3qZs9lVzDi_m" autoPlay={false} loop={false} controls muted={false} />
