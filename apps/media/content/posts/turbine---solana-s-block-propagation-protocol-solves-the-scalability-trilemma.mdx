...
slug: turbine---solana-s-block-propagation-protocol-solves-the-scalability-trilemma
date: "2019-07-10"
categories:
...
seo:
  title: >-
    Turbine — Solana’s Block Propagation Protocol Solves the Scalability
    Trilemma
  description: >
    Understand 1 of 8 key technologies that make Solana the most performant
    blockchain in the world
  ...
  openGraph:
    ogTitle: >-
      ...
      Trilemma
    ogUrl: >-
      https://www.solana.com/blog/turbine---solana-s-block-propagation-protocol-solves-the-scalability-trilemma
    ogDescription: >
...
### **Understand 1 of 8 key technologies that make** [**Solana**](https://solana.com/?ref=solana.ghost.io) **the most performant blockchain in the world**

![](/uploads/builder/turbine---solana-s-block-propagation-protocol-solves-the-scalability-trilemma/image-1.jpg)

[Solana](https://solana.com/?ref=solana.ghost.io) is the most performant permissionless blockchain in the world. On current iterations of the Solana Testnet, a network of 200 physically distinct nodes supports a sustained throughput of more than 50,000 transactions per second when running with GPUs. Achieving this requires the implementation of several optimizations and new technologies, and the result is a breakthrough in network capacity that signals a new phase in blockchain development.
...
- [**Pipelining**](https://solana.com/pipelining-in-solana-the-transaction-processing-unit/?ref=solana.ghost.io) — a Transaction Processing Unit for validation optimization
- [**Cloudbreak**](https://medium.com/solana-labs/cloudbreak-solanas-horizontally-scaled-state-architecture-9a86679dcbb1?ref=solana.ghost.io) — Horizontally-Scaled Accounts Database; and
- [**Archivers**](https://solana.com/archivers/?ref=solana.ghost.io) — Distributed ledger store
...
![](/uploads/builder/turbine---solana-s-block-propagation-protocol-solves-the-scalability-trilemma/image-2.jpg)
...
![](/uploads/builder/turbine---solana-s-block-propagation-protocol-solves-the-scalability-trilemma/image-3.jpg)
...
![](/uploads/builder/turbine---solana-s-block-propagation-protocol-solves-the-scalability-trilemma/image-4.jpg)

Each neighborhood is responsible for transmitting a portion of its data to each neighborhood below it.

![](/uploads/builder/turbine---solana-s-block-propagation-protocol-solves-the-scalability-trilemma/image-5.jpg)
...
How do we deal with this kind of [eclipse attack](https://www.radixdlt.com/post/what-is-an-eclipse-attack/?ref=solana.ghost.io)? Our fanout algorithm generates a stake-weighted tree for every packet using a random source based on the digital signature of the packet. Since each packet takes a different path, and the path is not known in advance, a neighborhood-level eclipse attack would require nearly full control of the network.

![](/uploads/builder/turbine---solana-s-block-propagation-protocol-solves-the-scalability-trilemma/image-7.jpg)
...
Solana will soon launch a public beta incentivizing validators to run nodes via [Tour de SOL](https://medium.com/solana-labs/solana-announces-tour-de-sol-an-incentivized-testnet-event-b26372a58a51?ref=solana.ghost.io) — analogous to Cosmos’s Game of Stakes — that challenges the public at large to test the limits of the Solana network while earning tokens for doing so.

![](/uploads/builder/turbine---solana-s-block-propagation-protocol-solves-the-scalability-trilemma/image-8.jpg)

![](/uploads/builder/turbine---solana-s-block-propagation-protocol-solves-the-scalability-trilemma/image-9.jpg)

![](/uploads/builder/turbine---solana-s-block-propagation-protocol-solves-the-scalability-trilemma/image-10.jpg)

![](/uploads/builder/turbine---solana-s-block-propagation-protocol-solves-the-scalability-trilemma/image-11.jpg)

![](/uploads/builder/turbine---solana-s-block-propagation-protocol-solves-the-scalability-trilemma/image-12.jpg)

![](/uploads/builder/turbine---solana-s-block-propagation-protocol-solves-the-scalability-trilemma/image-13.jpg)
