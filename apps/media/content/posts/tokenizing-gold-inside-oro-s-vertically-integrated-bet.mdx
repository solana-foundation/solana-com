...
status: published
heroImage: >-
  /uploads/posts/tokenizing-gold-inside-oro-s-vertically-integrated-bet/heroImage.png
description: >-
...
<video background="bg-default" color="default" url="https://www.youtube.com/shorts/iYWSV_ZtrUU" autoPlay={false} loop={false} controls muted={false} />
...
*This article draws from our conversation with Usman Saleem, Founder of Oro, on Bits to Bricks. For the full discussion,[ listen to the complete episode](https://solana.com/podcasts/bits-to-bricks-with-amira-valliani/episodes/how-tokenized-gold-is-disrupting-traditional-markets-with-usman-oro-e3jrll2).*
