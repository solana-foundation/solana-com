...
slug: announcing-real-time-emissions-measurement-on-the-solana-blockchain
date: "2023-04-21"
categories:
...
seo:
  title: Announcing real time emissions measurement on the Solana blockchain
  description: >-
    Trycarbonara enables users to see emissions data down to the validator
    level.
  image: >-
    /uploads/builder/announcing-real-time-emissions-measurement-on-the-solana-blockchain/03b17b5641bd473ba1997be1066a94de.jpg
  noIndex: false
  noFollow: false
  openGraph:
    ogTitle: Announcing real time emissions measurement on the Solana blockchain
    ogUrl: ""
    ogDescription: >-
      Trycarbonara enables users to see emissions data down to the validator
      level.
    ogType:
      - article
  twitter:
    twitterTitle: Announcing real time emissions measurement on the Solana blockchain
    twitterDescription: >-
      Trycarbonara enables users to see emissions data down to the validator
      level.
...
A snapshot of the climate impact of the Solana network, taken April 20, 2023. Source: [solanaclimate.com](https://solanaclimate.com/?ref=solana.ghost.io)
...
[Click here to see the full data set,](https://solanaclimate.com/?ref=solana.ghost.io) automatically updated on a biweekly basis, including:
...
A snapshot of the climate impact of the Solana network compared to other common use cases, taken April 19, 2023. Source: [solanaclimate.com](https://solanaclimate.com/?ref=solana.ghost.io)
...
Since November 2021, the Solana Foundation has regularly commissioned [independent third-party assessments](https://solana.com/news/solanas-energy-use-report-september-2022?ref=solana.ghost.io) of the emissions of the Solana network. The Foundation is committed to making these measurements more accurate and comprehensive over time.
...
[Information and Computing Technology (ICT) accounts for up to 3.9% of global carbon emissions](https://www.sciencedirect.com/science/article/pii/S2666389921001884?ref=solana.ghost.io) – more than that [of the airline industry](https://www.weforum.org/agenda/2022/12/aviation-net-zero-emissions/?ref=solana.ghost.io#:~:text=For%20many%20of%20us%2C%20the,aircraft%20powered%20by%20jet%20gasoline.). Accurate measurement with realtime carbon data is the first step towards cutting emissions. We hope the Solana Foundation's efforts will inspire other blockchain networks and projects to take similar steps towards measuring their emissions and building a more regenerative on-chain community. If you’re interested in engaging or learning about these efforts, [contact us here.](mailto:climate@solana.org)

Trycarbonara is a venture-backed company headquartered in Seattle. Its real-time carbon data platform automatically quantifies the climate impact of technology assets to empower all organizations to create sustainable value. Learn more at: [trycarbonara.com](https://trycarbonara.com/?ref=solana.ghost.io)
