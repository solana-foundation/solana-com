...
<gallery
  ...
  images={[
    {
      heading: "RWA-2B",
      button: { type: "default", link: "https://app.rwa.xyz/networks/solana" },
      size: "large",
      image: {
        src: "/uploads/posts/solana-ecosystem-roundup-march-2026/RWA 2B.png",
        alt: "RWA Value on Solana hits $2 billion"
      },
      square: false
    }
  ]}
