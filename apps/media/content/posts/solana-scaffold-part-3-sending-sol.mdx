...
categories:
  ...
  - category: developers
heroImage: >-
  /uploads/posts/solana-scaffold-part-3-sending-sol/cc4aee157e2c404389094cbbeccb02ac.webp
status: published
...
**This is part 3 of the** [**Scaffold Series**](https://solana.com/news/solana-scaffold-part-1-wallet-adapter)
...
![](/uploads/posts/solana-scaffold-part-3-sending-sol/image-1.gif)
...
How do we start? Let's take advantage of the companion we introduced before. Instead of googling it, we will cookglig it. Ok, that's weird. Anyway! Head to [https://solanacookbook.com](https://solanacookbook.com/) and search for **(or Command+K)** "send SOL".

**... (Don't look)**

The recipe is here: [https://solanacookbook.com/references/basic-transactions.html#how-to-send-sol](https://solanacookbook.com/references/basic-transactions.html#how-to-send-sol).
...
![](/uploads/posts/solana-scaffold-part-3-sending-sol/image-2.gif)
...
What is that SystemProgram? Solana comes equipped with a number of programs that serve as core building blocks for onchain interactions. These programs are divided into [Native Programs](https://docs.solana.com/developing/runtime-facilities/programs#bpf-loader) and [Solana Program Library (SPL) Programs](https://spl.solana.com/).
...
![](/uploads/posts/solana-scaffold-part-3-sending-sol/image-3.webp)

What is the difference between the native ones and the library ones?

- Native Programs are the essential programs that a Validator Node needs. I listed the System Program in the diagram, but there are other ones: [https://docs.solana.com/developing/runtime-facilities/programs](https://docs.solana.com/developing/runtime-facilities/programs)
...
Once again, Solana cookbook to the rescue! [https://solanacookbook.com/core-concepts/transactions.html#transactions](https://solanacookbook.com/core-concepts/transactions.html#transactions)
...
![](/uploads/posts/solana-scaffold-part-3-sending-sol/image-4.webp)
...
![](/uploads/posts/solana-scaffold-part-3-sending-sol/image-5.webp)

Can't go to definition? Here's the code: [https://github.com/solana-labs/solana/blob/master/web3.js/src/system-program.ts#L769](https://github.com/solana-labs/solana/blob/master/web3.js/src/system-program.ts#L769)
...
![](/uploads/posts/solana-scaffold-part-3-sending-sol/image-6.webp)

A transaction has a long way to go before being processed by the Solana runtime, not as long as [Marco Polo Travels](https://en.wikipedia.org/wiki/The_Travels_of_Marco_Polo), but it goes like this:
...
In [Learning How To Learn](https://www.coursera.org/learn/learning-how-to-learn), Professor Barbara Oakley explained that the human brain can only hold in its Short Term Memory storage 7 items at a time! Our RAM as humans is terrible! (Well, neuroscience is as volatile as cryptocurrencies so maybe they will figure out it's actually a little less or more...)

So, it's not time for you to learn about instruction yet my [Padawan](https://www.starwars.com/news/what-is-a-padawan#:~:text=A%20Padawan%20was%20an%20apprentice,Temple%20bustled%20with%20Padawan%20learners.). There is a time for everything, but since you are asking, here's what's in our next adventures:
...
**Before moving on, let's do some** [**mnemonics**](https://en.wikipedia.org/wiki/Mnemonic)**:**
...
The final code is here: [https://github.com/mwrites/dapp-scaffold/commit/60d7191b7f392c9b633424d626887b185729566a](https://github.com/mwrites/dapp-scaffold/commit/60d7191b7f392c9b633424d626887b185729566a)
...
Cool, but about the other errors? Where can I read about them and understand what is going on? Errors are defined here: [https://github.com/solana-labs/solana-program-library/blob/master/token/program/src/error.rs](https://github.com/solana-labs/solana-program-library/blob/master/token/program/src/error.rs).

### **Where To Ask Questions?**

- [https://stackoverflow.com/questions/tagged/solana](https://stackoverflow.com/questions/tagged/solana)
- Come vote on [https://area51.stackexchange.com/proposals/126615/solana](https://area51.stackexchange.com/proposals/126615/solana) to have our dedicated Solana stack exchange!
...
![](/uploads/posts/solana-scaffold-part-3-sending-sol/image-7.webp)
