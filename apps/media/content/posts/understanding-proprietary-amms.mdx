...
slug: understanding-proprietary-amms
date: "2025-01-20"
categories:
  - category: content/categories/defi.mdx
heroImage: /uploads/propamm-explainer/image.png
status: published
seo:
  title: "Understanding Proprietary AMMs"
  description: >-
    A guide to how PropAMMs solve the fundamental problem of market making on-chain
  image: /uploads/propamm-explainer/image.png
  noIndex: false
  noFollow: false
...
![Market makers updating orders](/uploads/propamm-explainer/image.png)
...
![Uniswap v1/v2 diagram](/uploads/propamm-explainer/uniswap-v1-v2.svg)
...
![Uniswap v3 diagram](/uploads/propamm-explainer/uniswap-v3.svg)
...
|                               | Uniswap V1/V2               | Uniswap V3                                                                   | Orderbook                                              | PropAMM                                                                                                                          |
| ----------------------------- | --------------------------- | ---------------------------------------------------------------------------- | ------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------- |
| Frequency of updates from LPs | Zero                        | Medium-High                                                                  | High. Price is updated in realtime, in single digit ms | High. Price is updated in realtime (when shreds are immediately broadcast). Price can be updated multiple times in a single slot |
| Amount of data to update      | Zero                        | Medium                                                                       | High                                                   | Low                                                                                                                              |
| Type of MM                    | Passive, LPs are picked off | Semi active, LPs generally picked off unless actively rebalancing liquidity  | Active, LPs can react to toxic flow                    | Active, LPs can react to toxic flow                                                                                              |
| Expressiveness of liquidity   | Forced to xy=k              | Bucket allocation is expressive. Intra-bucket liquidity is forced expression | Every price can have a different liquidity             | Fully programmable                                                                                                               |
...
_Special thanks to Matt/Evan from Helius, Mauro from QuickNode, Solomon/Aaron from Foundation for reviewing this post._
