...
status: published
heroImage: >-
  /uploads/posts/how-meow-built-agentic-banking-and-agent-payment-rails-with-brandon-arvanaghi/heroImage.webp
description: >-
...
This article draws from a conversation with Brandon Arvanaghi on [Bits to Bricks](https://solana.com/podcasts/bits-to-bricks-with-amira-valliani/episodes/). Listen to the [full episode](https://solana.com/podcasts/bits-to-bricks-with-amira-valliani/episodes/the-future-of-banking-with-ai-agents-meow-e3mtica) for the discussion on Meow, agentic banking, stablecoins, and payment rails.
