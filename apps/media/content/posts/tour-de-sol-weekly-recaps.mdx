...
slug: tour-de-sol-weekly-recaps
date: "2020-03-03"
categories:
  - category: content/categories/upgrades.mdx
  - category: content/categories/finance.mdx
heroImage: /uploads/builder/tour-de-sol-weekly-recaps/c8243bcdb44d41b48a2e51139f3f50a5.png
status: published
seo:
  title: Tour de SOL Weekly Recaps
  description: >
    Solana’s incentivized testnet event. An opportunity to flex their validation
    skills, earn tokens, and secure the Solana network.
  image: /uploads/builder/tour-de-sol-weekly-recaps/c8243bcdb44d41b48a2e51139f3f50a5.png
  noIndex: false
  noFollow: false
  openGraph:
    ogTitle: Tour de SOL Weekly Recaps
    ogUrl: "https://www.solana.com/blog/tour-de-sol-weekly-recaps"
    ogDescription: >

      Solana’s incentivized testnet event. An opportunity to flex their
      validation skills, earn tokens, and secure the Solana network.
    ogImage: >-
      https://solana.ghost.io/content/images/downloaded_images/Tour-de-SOL-Weekly-Recaps/1-yCOpj9ql4gbh4k0ewHc15g-1.png
    ogType:
      - article
  twitter:
    twitterTitle: Tour de SOL Weekly Recaps
    twitterDescription: >
...
![](/uploads/builder/tour-de-sol-weekly-recaps/image-1.jpg)
...
- [Bootstrap leader sending bad snapshots](https://github.com/solana-labs/solana/issues/8130?ref=solana.ghost.io) — Closed
- [Gossip not filtering out duplicate IP’s](https://github.com/solana-labs/solana/issues/8141?ref=solana.ghost.io) — Closed
- [Validator uptime calculation incorrect](https://github.com/solana-labs/solana/issues/7425?ref=solana.ghost.io) — Closed
- [Validators picking up outdated snapshots from delinquent Validators](https://github.com/solana-labs/solana/issues/8292?ref=solana.ghost.io) — Closed
- [Issue with the ‘solana catch-up’ command](https://github.com/solana-labs/solana/issues/8407?ref=solana.ghost.io)
- [Unreasonable writes to disk with RocksDB](https://github.com/solana-labs/solana/issues/8116?ref=solana.ghost.io)
- [Validators falling behind in slots in v0.23.6](https://github.com/solana-labs/solana/issues/8406?ref=solana.ghost.io)
- [tds.solana.com OOMs shortly after restarting](https://github.com/solana-labs/solana/issues/8131?ref=solana.ghost.io)
- [Snapshots are taking too long to unpack and process](https://github.com/solana-labs/solana/issues/8168?ref=solana.ghost.io)
- [Resistance to multi-hour network outage](https://github.com/solana-labs/solana/issues/8156?ref=solana.ghost.io)
- [Loss of consensus in TdS](https://github.com/solana-labs/solana/issues/8189?ref=solana.ghost.io)

**\# of Critical — 2**

- [DoS attack by Certus One](https://github.com/solana-labs/solana/issues/8175?ref=solana.ghost.io) — Fixed
- [Bogus genesis.tar.bz2 files can DoS cluster boot](https://github.com/solana-labs/solana/issues/8432?ref=solana.ghost.io) by Chorus One — Closed
- [Zero-stuffing genesis/snapshot compressed archives to fill up the disk](https://github.com/solana-labs/solana/issues/8427?ref=solana.ghost.io) by Certus One
...
- [Snapshots loading very slowly](https://github.com/solana-labs/solana/issues/8168?ref=solana.ghost.io): Snapshots are taking over 1000 slots to unpack and process across both TdS and SLP due to the large number of account files in them. Thereby slowing down Validators from being able to quickly boot and restart
- [Validators can accidentally fetch snapshots from delinquent Validators](https://github.com/solana-labs/solana/issues/8292?ref=solana.ghost.io): When a validator comes up and looks for a snapshot over RPC, it can easily pick a delinquent validator and thus get a very old snapshot.
- [Intermittent Consensus Issue 1](https://github.com/solana-labs/solana/issues/8189?ref=solana.ghost.io)

### **NETWORK UPGRADES**

### **Tofino v0.23.4**

The cluster was restarted on the 12th of February with version [v0.23.4](https://github.com/solana-labs/solana/releases/tag/v0.23.4?ref=solana.ghost.io), capturing fixes in the following areas:
...
We followed up with another version on the 14th of February with [another update](https://github.com/solana-labs/solana/releases/tag/v0.23.5?ref=solana.ghost.io) to rectify a long-standing out-of-memory issue that was affecting some Validators
...
[Link to issue 9](https://github.com/solana-labs/solana/issues/8175?ref=solana.ghost.io)
...
![](/uploads/builder/tour-de-sol-weekly-recaps/image-2.jpg)
...
7.  The RPC entrypoint for the [tds.solana.com](http://tds.solana.com/?ref=solana.ghost.io) Validator was added to gossip multiple times, leading to excessive inbound traffic, inefficient management of the additional traffic eventually lead to our the Validator to run out of memory.
