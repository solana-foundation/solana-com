...
slug: archivers---solana-s-solution-to-petabytes-of-blockchain-data-storage
date: "2019-07-17"
categories:
...
seo:
  ...
  noFollow: false
  openGraph:
    ogTitle: Archivers — Solana’s Solution to Petabytes of Blockchain Data Storage
    ogUrl: >-
      https://www.solana.com/blog/archivers---solana-s-solution-to-petabytes-of-blockchain-data-storage
    ogDescription: >

      Learn more about 1 of the 8 innovations that make Solana the most
      performant blockchain in the world.
    ogImage: null
    ogType:
      - article
  twitter:
    twitterTitle: Archivers — Solana’s Solution to Petabytes of Blockchain Data Storage
    twitterImage: null
    twitterDescription: >
...
The basic idea of Proof of Replication is to encrypt a dataset with a public symmetric key using CBC encryption, and then hash the encrypted dataset. This method is explained in detail in [Filecoin’s Proof of Replication Technical Report](https://filecoin.io/proof-of-replication.pdf?ref=solana.ghost.io). Unfortunately, the problem with this approach is that it is vulnerable to attack.
