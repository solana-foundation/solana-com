...
slug: looking-forward-what-the-solana-community-will-tackle-in-2023-and-beyond
date: "2022-12-23"
categories:
...
seo:
  ...
  noFollow: false
  openGraph:
    ogTitle: "Looking forward: What the Solana community will tackle in 2023 and beyond"
    ogUrl: ""
    ogDescription: >-
      At Breakpoint 2022, Solana co-founder Anatoly Yakovenko outlined the
      engineering challenges his team is working on — and wants to take on next.
    ogType:
      - article
  twitter:
    twitterTitle: "Looking forward: What the Solana community will tackle in 2023 and beyond"
    twitterDescription: >-
      At Breakpoint 2022, Solana co-founder Anatoly Yakovenko outlined the
      engineering challenges his team is working on — and wants to take on next.
...
That’s the north star that Solana co-founder Anatoly Yakovenko said he was following at his “Looking Back, Looking Forward” keynote at [Breakpoint 2022](https://solana.com/breakpoint?ref=solana.ghost.io) in Lisbon, Portugal. And even today, after the recent industry turmoil, that has not changed.
...
The [Solana Mobile Stack,](https://solanamobile.com/news/solana-mobile-stack-reveal?ref=solana.ghost.io) developed by [Solana Mobile](https://solanamobile.com/?ref=solana.ghost.io) and coming first on the Android-compatible Saga phone, aims to make mobile more crypto-friendly. The **seed vault**, for example, uses the secure element built into every phone to store the seed phrase in a way that cannot be read by Android, allowing dApps to seamlessly connect with wallets. And the **Solana dApp Store** will be a permissionless marketplace for mobile dApps.

DVT-1, the first developer devices, [started shipping](https://twitter.com/solanamobile/status/1603498506085289985?ref=solana.ghost.io) in mid-December. The Solana dApp Store will [accept the first applications](https://twitter.com/solanamobile/status/1605668888175206400?ref=solana.ghost.io) in January, and Saga devices for the general public will ship in early 2023.
...
[Network upgrades](https://solana.com/upgrades?ref=solana.ghost.io) are already in the process of being rolled out, if not already:
...
But there’s still some major moves on the horizon. [**Token-22,**](https://youtu.be/Gr0cSdqIjD4?ref=solana.ghost.io) a new token standard, will enable the development of new applications, like collecting royalties on transfers and ownership and confidential payments. Token-22 is coming soon.
...
And while Solana’s massive increase in the [**number of validators**](https://solanabeach.io/?ref=solana.ghost.io) has made the network more secure and censorship resistant, there are still improvements that are needed before widespread adoption.
