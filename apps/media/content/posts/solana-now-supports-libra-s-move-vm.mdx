...
slug: solana-now-supports-libra-s-move-vm
date: "2019-08-25"
categories:
...
seo:
  ...
  noFollow: false
  openGraph:
    ogTitle: Solana Now Supports Libra’s Move VM
    ogUrl: "https://www.solana.com/blog/solana-now-supports-libra-s-move-vm"
    ogDescription: >

      Move is Solana compatible, enabling projects to utilize the transactional
      speed and capacity of the Solana network.
    ogImage: >-
      https://solana.ghost.io/content/images/downloaded_images/Solana-Now-Supports-Libra-s-Move-VM/0-JVApa16wi1wzXS_t.png
    ogType:
      - article
  twitter:
    twitterTitle: Solana Now Supports Libra’s Move VM
    twitterDescription: >
...
[Solana](http://solana.com/?ref=solana.ghost.io) is a high-performance blockchain with 400ms blocks and a flexible runtime that allows computation to scale with validator hardware. On current iterations of the Solana Testnet, a network of 200 physically distinct nodes supports a sustained throughput of more than 50,000 transactions per second when running with GPUs. We believe it to be the most performant blockchain in the world.
...
We found this factor particularly interesting because the Solana team made the same design decision in our runtime — [Sealevel](https://medium.com/solana-labs/pipeline-vm-parallel-processing-thousands-of-smart-contracts-7d31c0c53fd0?ref=solana.ghost.io). We recognized immediately that Move is a smart contracts language that could not only scale, but share compatibility with Solana. This suggested to us that Move code could be utilized on Solana, and take further advantage of the highly optimized environment of the Solana network.
...
If you’re a web developer or working on blockchain and smart contracts, the Move programming language has a lot to offer. You can check out Solana’s Move SDK example [here](https://github.com/solana-labs/example-move?ref=solana.ghost.io), and run benchmarking for the Move VM on Solana [here](https://github.com/solana-labs/solana/blob/d5fb493aa4011e6df36864b5957e2886d0b559c7/net/net.sh?ref=solana.ghost.io). If you’d like to learn more about Solana and the core innovations that make it the world’s first web-scale blockchain, this [blog post](https://solana.com/7-innovations-that-make-solana-the-first-web-scale-blockchain/?ref=solana.ghost.io) is a great place to start.
