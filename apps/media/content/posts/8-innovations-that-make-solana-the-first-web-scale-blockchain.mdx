...
description: >
  ...
  network possible
slug: 8-innovations-that-make-solana-the-first-web-scale-blockchain
date: "2019-07-28"
categories:
...
seo:
  ...
  openGraph:
    ogDescription: >
      ...
      network possible
    ogImage: null
    ogTitle: 8 Innovations that Make Solana the First Web-Scale Blockchain
    ogType:
      - article
    ogUrl: >-
      https://www.solana.com/blog/8-innovations-that-make-solana-the-first-web-scale-blockchain
  twitter:
    twitterDescription: >
      ...
      network possible
    twitterImage: null
    twitterTitle: 8 Innovations that Make Solana the First Web-Scale Blockchain
