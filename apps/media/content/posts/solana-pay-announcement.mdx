...
categories:
  - category: finance
heroImage: /uploads/posts/solana-pay-announcement/3bda396cb20d4966b611f712d2dadfe1.webp
status: published
...
It’s also important to note that this is bigger than enabling consumers to “pay with crypto.” Rather, this is about a vision where all currencies – including U.S. dollars – are onchain and used for a wide range of transactions. Merchants have been able to accept crypto currencies for years, but acceptance usually means settling in non-stable currencies, swapping out one intermediary for another, and duct-taping together square pegs and round holes. It doesn’t need to be like this.

When a customer buys something, it’s a vote of support. A merchant should reward that support with personalized offers, onchain loyalty programs, and unique virtual goods to accompany physical purchases. The opportunities are limitless, but only if there’s a new approach to payments.

Merchants should benefit from all of the advantages that onchain decentralized payments can provide, such as network cost savings, DeFi yield generation, zero fraud liability, instant settlement, and ownership of the customer relationship.
