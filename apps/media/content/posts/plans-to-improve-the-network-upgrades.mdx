...
This blog post first appeared on the [Solana Labs medium](https://medium.com/solana-labs?ref=solana.ghost.io)
...
Both [status.solana.com](http://status.solana.com/?ref=solana.ghost.io) and [@SolanaStatus](https://twitter.com/SolanaStatus?ref=solana.ghost.io), will continue to be used to signal the upgrade sprints and the status.
