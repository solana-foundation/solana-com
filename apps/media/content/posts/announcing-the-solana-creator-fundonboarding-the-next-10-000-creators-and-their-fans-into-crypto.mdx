...
seo:
  ...
  noFollow: false
  openGraph:
    ogTitle: Announcing the Solana Creator Fund
    ogUrl: >-
      https://www.solana.com/blog/announcing-the-solana-creator-fundonboarding-the-next-10-000-creators-and-their-fans-into-crypto
    ogDescription: Announcing the Solana Creator Fund
    ogImage: >-
      https://solana.ghost.io/content/images/2021/07/blog_Creator-fund_V01-01-1.png
    ogType:
      - article
  twitter:
    twitterTitle: Announcing the Solana Creator Fund
    twitterDescription: Announcing the Solana Creator Fund
    twitterImage: >-
      https://solana.ghost.io/content/images/2021/07/blog_Creator-fund_V01-01-1.png
...
[**Apply here**](https://solanalabs.typeform.com/to/dSZNeWr8?ref=solana.ghost.io)**.**
...
[Audius](https://audius.co/?ref=solana.ghost.io) is a digital streaming service that connects fans directly with artists and exclusive new music. It does this by being fully decentralized: Audius is owned and run by the community that makes it special. Audius is now one of the most popular music platforms on Earth with nearly 5 million monthly active users.

[Metaplex](https://www.metaplex.com/?ref=solana.ghost.io) enables artists and brands to build direct relationships with their audiences by launching their own NFT storefronts. In the words of Grammy Award Winner [RAC](https://twitter.com/RAC?ref=solana.ghost.io), “Metaplex will do for NFTs what Shopify did for commerce, but takes it one step further by not acting as the middleman.”

The Solana Creator Fund is just one of the many community initiatives empowering creators, so be sure to follow [Solana on Twitter](https://twitter.com/solana?ref=solana.ghost.io) for future announcements. And if you’re a creator who wants to join the crypto revolution, get in touch [here](https://solanalabs.typeform.com/to/dSZNeWr8?ref=solana.ghost.io).
