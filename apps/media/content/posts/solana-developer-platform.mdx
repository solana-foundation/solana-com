---
title: ' Solana Foundation Launches Solana Developer Platform, a One-Stop-Shop for Institutions and Enterprises to Build on Solana'
status: published
heroImage: /uploads/posts/solana-developer-platform/heroImage.png
description: |
  Solana Foundation launches Solana Developer Platform,
  a one-stop-shop for institutions and enterprises to build on Solana
...
| **Node Infrastructure**  | *Abstracts away blockchain complexity from the user experience, making it easy for enterprises to start building with no-code or low-code* |   |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ | - |
| **Wallets**              | *Provides a rich selection of custody solutions so enterprises can experiment with various offerings and use cases*                        |   |
| **Compliance**           | *Ensures institutions remain compliant from day-one, across KYC / KYB / Travel Rule, etc.*                                                 |   |
| **Ramps**                | *Enables different payment flows for on/off ramp and stablecoin payments within the payments module.*                                      |   |
