...
The Solana Foundation has decided to release the monthly newsletters as blog posts. As always, subscribers to our email list will receive information and news first, so make sure to [subscribe](http://solana.com/newsletter).
...
This auction was unique because of the [Staker Price Guarantee](http://solana.com/priceguarantee) program. Any participant in the program enjoys a guarantee for 90% of the Auction Clearing Price, redeemable at any time for 12 months from the start of the registration period (April 7, 2020).

[**Register for Price Guarantee By July 7**](https://solana.com/priceguarantee)
...
[**Trade on Binance Now**](https://www.binance.com/en/trade/SOL_BUSD)
...
**Origin Protocol** launched a Dshop to sell merchandise and other physical goods at [store.solana.com](https://store.solana.com/). The site is a decentralized e-commerce site leveraging Ethereum, IPFS, ENS and PGP. All content is hosted on IPFS. Payments can be made with Eth, DAI or Credit Card.
...
To get these newsletters directly to your inbox, [subscribe here](http://solana.com/newsletter).

LINKS:

Follow us on [Twitter](https://twitter.com/solana)

Join the discussion on [Telegram](https://t.me/solanaio)

Trade on [Binance](https://www.binance.com/en/trade/SOL_BTC)

Trade on [Gate io](https://www.gate.io/trade/SOL_USDT)
