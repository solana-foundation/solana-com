...
status: published
heroImage: /uploads/posts/transaction-v1-and-the-alt-trade-off/heroImage.png
description: >-
...
<Figure src="/uploads/posts/transaction-v1-and-the-alt-trade-off/serialized_size_pdf_all.webp" alt="Empirical probability density function of the serialized size of transactions.">
...
<Figure src="/uploads/posts/transaction-v1-and-the-alt-trade-off/account_and_instruction_headroom.webp" alt="Remaining v1 account slots, decomposed by top-level instruction headroom. ">
...
<Figure src="/uploads/posts/transaction-v1-and-the-alt-trade-off/serialized_size_pdf_lookup_entries.webp" alt="Empirical PDF of serialized lookup-entry bytes per transaction">
...
<Figure src="/uploads/posts/transaction-v1-and-the-alt-trade-off/serialized_size_pdf_lookup_entries_tail.webp" alt="Zoom of Fig. 3 over the 60-1232 byte range.">
...
<Figure src="/uploads/posts/transaction-v1-and-the-alt-trade-off/serialized_size_lookup_vs_writes_and_reads.webp" alt="Writable and read-only addresses loaded through ALT versus serialized lookup-entry size.">
...
<Figure src="/uploads/posts/transaction-v1-and-the-alt-trade-off/serialized_size_lookup_table.webp" alt="Most frequently ALT-loaded accounts.">
...
<Figure src="/uploads/posts/transaction-v1-and-the-alt-trade-off/lookup_tables_reference.webp" alt="ALT usage by account-frequency quantile.">
...
<Figure src="/uploads/posts/transaction-v1-and-the-alt-trade-off/lookup_tables_reference_frequency.webp" alt="ALT usage by absolute account frequency. ">
...
<Figure src="/uploads/posts/transaction-v1-and-the-alt-trade-off/lookup_tables_reference_vs_accounts.webp" alt="ALT-loaded addresses by number of referenced lookup tables.">
...
<Figure src="/uploads/posts/transaction-v1-and-the-alt-trade-off/concentration_of_alt_usage.webp" alt="Concentration of ALT usage. ">
...
<Figure src="/uploads/posts/transaction-v1-and-the-alt-trade-off/avg_addresses_loaded _from_table_per_use.webp" alt="Average addresses loaded per ALT use.">
...
<Figure src="/uploads/posts/transaction-v1-and-the-alt-trade-off/n_of_alt_by_event_type.webp" alt="Daily ALT usage and lifecycle activity.">
...
<Figure src="/uploads/posts/transaction-v1-and-the-alt-trade-off/lookup_tables_v1_conversion_cdf.webp" alt="Empirical CDF of the ALT-to-v1 account-encoding delta.">
