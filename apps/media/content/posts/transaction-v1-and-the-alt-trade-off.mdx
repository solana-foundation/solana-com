...
<Figure
  src="/uploads/posts/transaction-v1-and-the-alt-trade-off/serialized_size_pdf_all.png"
...
<Figure
  src="/uploads/posts/transaction-v1-and-the-alt-trade-off/serialized_size_pdf_lookup_entries.png"
...
<Figure
  src="/uploads/posts/transaction-v1-and-the-alt-trade-off/serialized_size_pdf_lookup_entries_tail.png"
...
<Figure
  src="/uploads/posts/transaction-v1-and-the-alt-trade-off/serialized_size_lookup_vs_writes_and_reads.png"
...
<Figure
  src="/uploads/posts/transaction-v1-and-the-alt-trade-off/serialized_size_lookup_table.png"
...
<Figure
  src="/uploads/posts/transaction-v1-and-the-alt-trade-off/lookup_tables_reference.png"
...
>
  **Fig. 12:** Empirical CDF of the ALT-to-v1 account-encoding delta. The delta compares the
...
<Figure
  ...
  alt="Counterfactual v1 serialized-size PDF for the sampled legacy and v0 workload."
>
  **Fig. 13:** Counterfactual v1 serialized-size PDF for the sampled legacy and v0 workload. Static
...
<Figure
  ...
  alt="Remaining v1 account slots, decomposed by top-level instruction headroom. "
>
  Fig. 14: Remaining v1 account slots, decomposed by top-level instruction headroom. Bar height
