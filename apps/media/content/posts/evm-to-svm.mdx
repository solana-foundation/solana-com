...
categories:
  - category: developers
heroImage: /uploads/posts/evm-to-svm/46b339797f274b5ab7afed94f110bb84.webp
status: published
...
An [account](https://solana.com/developers/migrate-to-solana/accounts) on Solana is a record in the Solana ledger that either holds data (a data account) or is an executable program (a smart contract or [_program_](https://solana.com/developers/migrate-to-solana/smart-contracts) on Solana).
...
![](/uploads/posts/evm-to-svm/image-1.webp)
...
- Mapping does not directly exist on Solana. Instead, use [program-derived addresses.](https://solanacookbook.com/core-concepts/pdas.html#facts) Like mapping, program-derived addresses give the ability to create a map from a key or account to a value stored onchain.
...
For more information on programs and how to deploy, [check out this guide](https://solana.com/developers/migrate-to-solana/smart-contracts) .
...
- A more detailed look at the differences [between developing on Ethereum and Solana](https://solana.com/developers/migrate-to-solana/complete-guide)
