...
<Figure src="/uploads/posts/rent-reduction-deep-dive/image.webp" alt="USD price per byte stored on Solana">
...
<Figure src="/uploads/posts/rent-reduction-deep-dive/Screenshot_2026-07-01_alle_19.33.21.webp" alt="Total live account data and total AccountsDB storage footprint">
...
<Figure src="/uploads/posts/rent-reduction-deep-dive/sol_account_corr.webp" alt="SOL price denominated in USD compared with number of accounts">
...
<Figure src="/uploads/posts/rent-reduction-deep-dive/rolling_sol_account_correlation_lag84h.webp" alt="SOL price in USD shifted by 84 hours compared with number of accounts">
...
<Figure src="/uploads/posts/rent-reduction-deep-dive/image 1.webp" alt="Scatter plot of daily change in USD per account state versus new account creation">
...
<Figure src="/uploads/posts/rent-reduction-deep-dive/image 2.webp" alt="30-day rolling correlation between daily change in USD per account state and new account creation">
...
<Figure src="/uploads/posts/rent-reduction-deep-dive/image 3.webp" alt="Daily requested space from account creation divided by category">
...
<Figure src="/uploads/posts/rent-reduction-deep-dive/image 4.webp" alt="Duration buckets of non-deduplicated closed-account events over 180 days">
...
<Figure src="/uploads/posts/rent-reduction-deep-dive/image 5.webp" alt="Daily newly created accounts grouped by account type">
...
<Figure src="/uploads/posts/rent-reduction-deep-dive/image 6.webp" alt="Survival rate for newly created accounts by account type">
...
<Figure src="/uploads/posts/rent-reduction-deep-dive/image 7.webp" alt="Closure rate for accounts created on June 1 and July 1, 2026">
...
<Figure src="/uploads/posts/rent-reduction-deep-dive/accountsdb_growth_two_subpanels.webp" alt="AccountsDB growth-rate fit and two-year size forecasts">
...
<Figure src="/uploads/posts/rent-reduction-deep-dive/account_storage_vs_snapshot_size_dark.webp" alt="Account storage size compared with snapshot size">
...
<Figure src="/uploads/posts/rent-reduction-deep-dive/program_accounts_treemap_dark.webp" alt="Treemap of Solana account data size by program at epoch 997">
...
<Figure src="/uploads/posts/rent-reduction-deep-dive/image 8.webp" alt="Distribution of account-creation costs on Tempo and Solana under current and reduced rent schedules">
