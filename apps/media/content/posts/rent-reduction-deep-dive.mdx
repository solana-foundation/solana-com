...
![**Fig.1:** USD price per byte stored on Solana. Source: [Dune query](https://dune.com/queries/7856217/11831859).](/uploads/posts/rent-reduction-deep-dive/image.png)
...
![**Fig.2:** Left: total live account data (`accounts_data_len`), measuring the cumulative size of account data currently stored on-chain. Right: total AccountsDB storage footprint (`accounts_db-stores.total_bytes`), including the physical storage occupied by AccountsDB files.](/uploads/posts/rent-reduction-deep-dive/Screenshot_2026-07-01_alle_19.33.21.png)
...
![**Fig.3:** Top: SOL price denominated in USD compared with N° of Accounts. Bottom: 24h rolling correlation at 1h resolution.](/uploads/posts/rent-reduction-deep-dive/sol_account_corr.png)
...
![**Fig.4:** Top: SOL price denominated in USD and shifted by 84h compared with N° of Accounts. Bottom: 24h rolling correlation at 1h resolution.](/uploads/posts/rent-reduction-deep-dive/rolling_sol_account_correlation_lag84h.png)
...
![**Fig.5:** Scatter plot of daily change in USD per account state vs new account creation (not-deduplicated). Source: [Dune query](https://dune.com/queries/7856217/11830502).](/uploads/posts/rent-reduction-deep-dive/image%201.png)
...
![**Fig.6:** 30 days rolling correlation between daily change in USD per account state and new account creation (not-deduplicate). Source: [Dune query](https://dune.com/queries/7856217/11831013).](/uploads/posts/rent-reduction-deep-dive/image%202.png)
...
![**Fig.7:** Daily requested space by account creation divided by category. Source: [Dune query.](https://dune.com/queries/7840582/11820308).](/uploads/posts/rent-reduction-deep-dive/image%203.png)
...
![**Fig.8:** Duration buckets of non-deduplicated closed-account events over the last 180 days. The chart includes only accounts that were effectively closed. Source: [Dune query](https://dune.com/queries/7847716/11823905).](/uploads/posts/rent-reduction-deep-dive/image%204.png)
...
![**Fig.9:** Daily newly created accounts by account type. Counts are not deduplicated by account address. Source: [Dune query.](https://dune.com/queries/7840582/11820308).](/uploads/posts/rent-reduction-deep-dive/image%205.png)
...
![**Fig.10:** Survival rate for accounts created. Source: [Dune query](https://dune.com/queries/7897132/11876566). This doesn’t change based on the day, see [here](https://dune.com/queries/7904252/11881847).](/uploads/posts/rent-reduction-deep-dive/image%206.png)
...
![**Fig.11:** Rate of closed account for accounts created from 1st of June 2026 and 1st of July 2026. Source: [Dune query](https://dune.com/queries/7857491/11831837).](/uploads/posts/rent-reduction-deep-dive/image%207.png)
...
![**Fig.12:** Left Panel: Fit of the current growth rate of AccountsDB size, taking only the rapidly growing case. Right Panel: Forecasted AccountsDB size over time under different growth rate.](/uploads/posts/rent-reduction-deep-dive/accountsdb_growth_two_subpanels.png)
...
![**Fig.13:** Account size and snapshot size.](/uploads/posts/rent-reduction-deep-dive/account_storage_vs_snapshot_size_dark.png)
...
![**Fig.14:** Solana Account Data Size Snapshot at epoch 997.](/uploads/posts/rent-reduction-deep-dive/program_accounts_treemap_dark.png)
