---
title: Solana Validators Adopt the v1.17 Update
description: What you can expect in v1.17.
slug: solana-validators-v1-17-update
date: "2024-01-19"
categories:
  - category: content/categories/upgrades.mdx
heroImage: /uploads/builder/solana-validators-v1-17-update/1874ed15459645e7b8f3afb21a38041f.jpg
status: published
seo:
  title: Solana Validators Adopt the v1.17 Update
  description: What you can expect in v1.17.
  image: /uploads/builder/solana-validators-v1-17-update/1874ed15459645e7b8f3afb21a38041f.jpg
  noIndex: false
  noFollow: false
...
Solana Labs operates canary nodes on mainnet-beta including seven that run the beta branch (currently v1.17). Those v1.17 nodes have been stable for several months. To follow the canaries in real time checkout the #canaries-monitoring channel on the [Solana Tech Discord](https://solana.com/discord).
...
Version 1.17 has been audited by multiple external auditors. Reports will be published to the [security-audits](https://github.com/solana-labs/security-audits) repo as they become available.
