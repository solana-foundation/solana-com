...
categories:
  - category: finance
heroImage: /uploads/posts/case-study-xstocks/5d1b3d15dfec41c39a0e610dc67a2526.webp
status: published
cta: case-study-xstocks-cta
switchback: case-study-xstocks-switchback
...
xStocks brings U.S. stocks and ETFs onchain as tokens on Solana. Each token is backed 1:1 by a real share held with a regulated custodian. Non-U.S. traders get 24/7 market access, instant onchain settlement, fractional ownership, and the ability to use stock exposure inside DeFi (lending, AMMs, collateral).
...
![Image source: XStocks](/uploads/posts/case-study-xstocks/image-1.webp)
...
![Image source: Kamino](/uploads/posts/case-study-xstocks/image-2.webp)
...
- xStocks can be traded continuously on Solana. Self-custody enables 24/7 trading onchain. There is instant settlement as the trades execute onchain immediately rather than waiting for clearing houses.
- Each xStock can be divided onchain. So that gives the flexibility of fractional ownership, which otherwise would have been prohibitive. Users can start with a small amount without having to buy a whole share. There is no minimum amount and no management fees.
...
![](/uploads/posts/case-study-xstocks/image-3.webp)
...
- **Onchain integrations**: Within hours of launch, xStocks were live on major DeFi venues. Raydium became the primary AMM for onchain liquidity, with Jupiter aggregating the best quotes. Kamino added xStock collateral pools so users could borrow against positions like AAPLx or TSLAx. Wallets such as Phantom, Solflare displayed the tickers natively alongside regular tokens.
...
![](/uploads/posts/case-study-xstocks/image-4-updated.webp)
...
![](/uploads/posts/case-study-xstocks/image-5-rwaxyz.webp)
