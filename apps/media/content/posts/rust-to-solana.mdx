...
heroImage: /uploads/builder/rust-to-solana/099d607233a0479bb4f50320a12cdbfe.jpg
status: published
seo:
  title: Moving from Rust to Solana
  description: >-
  ...
  image: /uploads/builder/rust-to-solana/099d607233a0479bb4f50320a12cdbfe.jpg
  noIndex: false
  noFollow: false
...
![](/uploads/builder/rust-to-solana/image-1.jpg)
...
![](/uploads/builder/rust-to-solana/image-2.jpg)
...
![](/uploads/builder/rust-to-solana/image-3.jpg)
...
![](/uploads/builder/rust-to-solana/image-4.jpg)
...
So far, this article has covered the key details of developing **on-chain Solana programs** in Rust. However, it’s also possible to develop **off-chain Solana clients** in Rust. This can be done by using the [solana_sdk crate.](https://docs.rs/solana-sdk/latest/solana_sdk/) This contains the [solana_client crate](https://docs.rs/solana-client/latest/solana_client/) that allows Rust programs to interact with a Solana node via the JSON RPC API.
