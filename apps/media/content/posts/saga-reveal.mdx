---
title: "Solana Mobile debuts Saga, a flagship Android phone for web3"
description: >-
  Flagship Android phone from Solana Mobile showcases innovations needed to
  bring web3 to billions of mobile users
slug: saga-reveal
date: "2022-06-22"
categories:
  - category: content/categories/finance.mdx
  - category: content/categories/developers.mdx
heroImage: /uploads/builder/saga-reveal/dbefcc5c6c7043e293b2d10e8a9c8941.png
status: published
seo:
  title: "Solana Mobile debuts Saga, a flagship Android phone for web3"
  description: >-
    Flagship Android phone from Solana Mobile showcases innovations needed to
    bring web3 to billions of mobile users
  image: /uploads/builder/saga-reveal/dbefcc5c6c7043e293b2d10e8a9c8941.png
  noIndex: false
  noFollow: false
  openGraph:
    ogTitle: "Solana Mobile debuts Saga, a flagship Android phone for web3"
    ogUrl: ""
    ogDescription: >-
      Flagship Android phone from Solana Mobile showcases innovations needed to
      bring web3 to billions of mobile users
    ogType:
      - article
  twitter:
    twitterTitle: "Solana Mobile debuts Saga, a flagship Android phone for web3"
    twitterDescription: >-
      Flagship Android phone from Solana Mobile showcases innovations needed to
      bring web3 to billions of mobile users
...
Saga was introduced at an event in New York today, which also included the introduction of the Solana Mobile Stack, a framework for Android allowing developers to create rich mobile experiences for wallets and apps on Solana and create a “Secure Element” for private key management ([read more here](https://solana.com/news/solana-mobile-stack-reveal?ref=solana.ghost.io)). The Solana Mobile Stack SDK is available to developers now and Saga is available for pre-orders starting today, with delivery in early 2023.
...
- [Solana Mobile Stack SDK](https://github.com/solana-mobile/solana-mobile-stack-sdk?ref=solana.ghost.io)
- [Solana Mobile Stack begins new era of web3 with mobile-first Android platform](https://solana.com/news/solana-mobile-stack-reveal?ref=solana.ghost.io)
