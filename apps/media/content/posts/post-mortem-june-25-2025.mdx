...
description: >-
  Read the June 2025 post mortem on a responsibly disclosed ZK ElGamal Proof
  Program vulnerability, its Token-2022 mitigation, validator action, and
  impact.
publishedAt: 2025-06-25T00:00:00.000Z
categories:
  - category: upgrades
  - category: developers
heroImage: /uploads/posts/post-mortem-june-25-2025/38950347b28743dfad81ae9fd90ded85.webp
status: published
...
In the onchain ZK ElGamal Proof program, a component was not included in a hash used to generate a transcript for the Fiat-Shamir Transformation. A sophisticated attacker could use this unhashed component to develop a forged proof of an unauthorized action that passes verification. This vulnerability only affects Token-2022 confidential tokens and allows an attacker to perform unauthorized actions such as minting unlimited tokens or draining a victim’s confidential balance.
