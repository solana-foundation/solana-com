...
Solana core developers have been working on a number of new network upgrades aimed at strengthening the network in the face of massive user growth and adoption. [Follow the status of these upgrades.](https://solana.com/upgrades)
...
As major proposed upgrades are rolled out, the Solana Foundation will update the community on its progress on [the upgrades page.](https://solana.com/upgrades) The Solana Foundation will continue to monitor the performance of the Solana network and use reports like this one to help the community track its development over time.
