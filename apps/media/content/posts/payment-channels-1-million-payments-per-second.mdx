...
status: published
heroImage: /uploads/posts/payment-channels-1-million-payments-per-second/heroImage.png
description: >-
...
Inference has been one of the most in demand use cases across agentic payment protocols. We are excited to be launching payment channels with @alibaba\_cloud. Their API endpoints are live today with Payment Channels. Your agent authorizes once and consumes these APIs at scale. No account setup, no per-call approvals.
