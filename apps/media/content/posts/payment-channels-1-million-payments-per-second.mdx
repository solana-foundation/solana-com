...
The per-call model quietly breaks agent autonomy and economics:
...
Sessions remove all three. You set a cap. Your agent spends against it. Settlement happens in batches. Funds stay non-custodial the entire time.
...
- SDK + quickstart: [pay.sh/docs/sdk/typescript](http://pay.sh/docs/sdk/typescript)
