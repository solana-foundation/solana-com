...
slug: loom--encoding-time-as-data
date: "2020-12-31"
categories:
...
seo:
  ...
  noFollow: false
  openGraph:
    ogTitle: "Loom, Encoding Time as Data"
    ogUrl: "https://www.solana.com/blog/loom--encoding-time-as-data"
    ogDescription: |
    ...
    ogType:
      - article
  twitter:
    twitterTitle: "Loom, Encoding Time as Data"
    twitterImage: null
    twitterDescription: |
...
![](/uploads/builder/loom--encoding-time-as-data/image-1.png)
...
Learn more about Loom checkout [https://loomprotocol.com](http://loomprotocol.com/?ref=solana.ghost.io)
