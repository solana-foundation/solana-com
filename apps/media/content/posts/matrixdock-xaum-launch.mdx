---
title: >-
  Matrixdock Brings XAUm to Solana, Expanding Institutional-Grade Tokenized Gold
  Access
status: published
heroImage: /uploads/posts/matrixdock-xaum-launch/heroImage.webp
description: >
  Matrixdock deploys XAUm, Asia's largest tokenized gold product, on Solana,
  enabling institutional-grade tokenized gold with near-instant settlement and
  DeFi integration.
...
<video background="bg-default" color="default" url="https://youtu.be/h8MC3eSp-Zw" autoPlay={false} loop={false} controls muted={false} />
...
* **Institutional Transparency** - Monthly vault statements are published and logged onchain. Bi-annual audits are conducted by Bureau Veritas, auditor of GLD, the world's largest gold ETF.
...
![Matrixdock x Le Freeport](/uploads/posts/matrixdock-xaum-launch/matrixdock-le-freeport.webp)
