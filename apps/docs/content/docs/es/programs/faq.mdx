...
- [Puntos de entrada de programas Rust](/docs/programs/rust#program-entrypoint)
...
- [Deserialización de parámetros de programa en Rust](/docs/programs/rust#parameter-deserialization)
