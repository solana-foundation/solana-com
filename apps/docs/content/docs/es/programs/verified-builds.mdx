...
El uso de [compilaciones verificadas en Solana](/docs/programs/verified-builds) garantiza la integridad y confiabilidad de tus programas en la red, y permite a los desarrolladores encontrar tus SDKs directamente desde un Explorador de Solana. Al aprovechar herramientas como Solana Verify CLI y Docker, puedes mantener compilaciones verificables y seguras que se corresponden con tu código fuente. Toma siempre las precauciones necesarias para usar entornos consistentes y considera soluciones de gobernanza para actualizaciones y despliegues seguros.
