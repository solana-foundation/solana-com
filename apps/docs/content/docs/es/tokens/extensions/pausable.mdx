...
description: Aprende cómo habilitar la PausableMintExtension.
---

## Cómo habilitar la PausableExtension
...
permite que una autoridad de pausa designada detenga toda la actividad de tokens
en una acuñación. La autoridad de pausa puede pausar o reanudar la acuñación en
cualquier momento.

Cuando está pausado, el programa Token-2022 rechaza todas las transferencias,
acuñaciones y quemas para ese token. Cuando se reanuda, las operaciones normales
continúan.

Este es un patrón común tanto en sistemas de tokens blockchain como en las
finanzas tradicionales, donde la capacidad de congelar la actividad es necesaria
para el cumplimiento normativo, respuesta a incidentes o control administrativo.
