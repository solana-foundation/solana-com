...
description:
  Cree un mint del Programa de Extensiones de Token con una tasa de interés en la cadena, actualice esa tasa y convierta cantidades de tokens en una cantidad UI con interés.
...
<Callout type="info" title="Conversión de cantidad de UI fuera de cadena y en cadena">
