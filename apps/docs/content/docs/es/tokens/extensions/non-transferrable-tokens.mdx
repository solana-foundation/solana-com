...
impide que los tokens sean transferidos entre cuentas de tokens después de la
acuñación. Una vez acuñados, los tokens permanecen permanentemente en la cuenta
de tokens. Sin embargo, el propietario de la cuenta de tokens aún puede quemar
tokens y cerrar la cuenta de tokens cuando el saldo llegue a cero.
