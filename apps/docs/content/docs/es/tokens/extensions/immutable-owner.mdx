...
extensión previene cambios de propiedad para las cuentas de tokens. Cuando una
cuenta de token se inicializa con esta extensión, el propietario designado es
permanente y no puede ser transferido a otra cuenta.
