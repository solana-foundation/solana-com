...
designa un mint como un mint de grupo (como un NFT de colección) apuntando a una
cuenta que contiene
...
designa un mint como un mint de miembro (como un NFT en una colección) apuntando
a una cuenta que contiene
