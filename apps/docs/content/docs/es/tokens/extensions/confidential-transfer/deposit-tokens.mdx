...
público de tokens debe convertirse en un saldo confidencial. Esta conversión
ocurre en dos etapas:

1. **Saldo Pendiente Confidencial**: Inicialmente, los tokens se "depositan"
...
Esta sección explica la primera etapa: depositar el saldo público de tokens en
el saldo pendiente confidencial.

El siguiente diagrama muestra los pasos involucrados en el depósito de tokens
desde el saldo público al saldo pendiente confidencial:
...
Para convertir un saldo público en un saldo pendiente confidencial, invoca la
instrucción
...
El
[monto máximo](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/mod.rs#L21)
por instrucción de depósito está limitado a 2^48.
...
El siguiente ejemplo demuestra cómo depositar el saldo público de tokens en el
saldo pendiente confidencial.
...
Ejecuta el ejemplo con uno de ellos (el código usa devnet) con un pagador con fondos,
