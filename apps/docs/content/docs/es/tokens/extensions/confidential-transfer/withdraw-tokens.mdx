...
El siguiente ejemplo retira tokens del saldo confidencial disponible de vuelta
al saldo público. La cuenta ya debe estar configurada para transferencias
confidenciales y tener un saldo confidencial disponible.
...
[Surfpool](https://surfpool.run) sí lo hace. Ejecuta el ejemplo en uno de esos
entornos (el código usa devnet) con un pagador con fondos, y reemplaza los
marcadores de posición con tu mint y token account.
