...
description: Aprende cómo aplicar el saldo pendiente para hacer que los fondos estén disponibles.
---
...
2. **Saldo Disponible Confidencial**: El saldo pendiente se "aplica" entonces al
...
transfieren de forma confidencial de un token account a otro, los tokens se
añaden inicialmente al saldo confidencial pendiente. Antes de que los tokens
puedan usarse para transferencias confidenciales, el saldo pendiente debe
"aplicarse" al saldo disponible.
...
transacción con la instrucción `ApplyPendingBalance`, como se muestra en el
ejemplo a continuación.

## Código de Ejemplo

El siguiente ejemplo demuestra cómo aplicar el saldo confidencial pendiente al
saldo confidencial disponible.
