...
transfieren confidencialmente de un token account a otro, los tokens se añaden
...
El siguiente diagrama muestra los pasos involucrados en aplicar el saldo
...
Program clonado desde mainnet usando el siguiente comando. Debes tener instalada
la CLI de Solana para iniciar el validador local.
