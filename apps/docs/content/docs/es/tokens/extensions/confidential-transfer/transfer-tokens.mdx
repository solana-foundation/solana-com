...
1. Crea
   ...
   **Prueba de validez de texto cifrado
   ...
   Verifica que los textos cifrados del monto de transferencia se generen
   ...
   **Prueba de rango
   ...
   en bits bajos/altos) sean todos no negativos y estén dentro de un rango
   especificado.
...
4. Cerrar las cuentas de estado de contexto de prueba para recuperar el SOL
...
instalado el Solana CLI para iniciar el validador local.
