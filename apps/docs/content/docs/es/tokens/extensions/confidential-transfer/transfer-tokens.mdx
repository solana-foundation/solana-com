...
otra. Ambas cuentas deben estar configuradas previamente para transferencias
confidenciales, y el remitente debe contar con un saldo confidencial disponible.
