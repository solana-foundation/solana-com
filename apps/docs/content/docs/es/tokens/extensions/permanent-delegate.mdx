...
asigna un delegado con autoridad sobre todas las cuentas de tokens para un mint.
A diferencia de los delegados regulares que los propietarios de cuentas de
tokens pueden revocar, un delegado permanente no puede ser cambiado o eliminado
por los propietarios de cuentas de tokens. El delegado permanente puede
transferir o quemar tokens en cualquier cuenta de tokens de ese mint. El rol de
delegado permanente puede ser cambiado a una nueva cuenta por el delegado
permanente actual.
