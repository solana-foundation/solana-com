...
title: Sync Native
description:
  Actualizar el monto de una cuenta de tokens de SOL envuelto después de
  transferir SOL a la cuenta.
...
## ¿Qué es el SOL envuelto?

El SOL envuelto (WSOL) es SOL mantenido en una token account para el mint nativo
del Token Program. El mint nativo es la dirección de mint que el Token Program
utiliza para las cuentas de tokens que envuelven SOL. El mint nativo permite que
SOL sea utilizado a través de las instrucciones del Token Program.
