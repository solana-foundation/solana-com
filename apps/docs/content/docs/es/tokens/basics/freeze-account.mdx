...
description:
  ...
  bloquear transferencias, quemas y cambios de delegados.
...
Solo un mint que aún tenga una autoridad de congelación puede congelar cuentas
de tokens. Si se revoca la autoridad de congelación de un mint, las cuentas de
ese mint ya no pueden congelarse.
...
el estado de la cuenta de tokens de inicializada a congelada.

Las [cuentas de tokens nativos](/docs/tokens/basics/sync-native) no admiten
congelación.
