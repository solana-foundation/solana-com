...
evita todas las transferencias de tokens o quemas de tokens desde una cuenta de
tokens específica. Una vez congelada, la cuenta no puede enviar tokens ni
...
de tokens puede congelar cuentas. Si la autoridad de congelación es revocada
(establecida en nulo) en la mint account, los tokens nunca podrán ser
congelados.
