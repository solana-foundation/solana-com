...
de token específica. Una vez congelada, la cuenta no puede enviar tokens,
recibir tokens, o ser cerrada hasta que sea descongelada. Solo la autoridad de
congelación del mint del token puede congelar cuentas. Si la autoridad de
congelación es revocada (establecida como nula) en la cuenta del mint, los
tokens nunca podrán ser congelados.
