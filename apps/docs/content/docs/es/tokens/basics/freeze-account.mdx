...
previene todas las transferencias de tokens o quemas de tokens desde una cuenta
de tokens específica. Una vez congelada, la cuenta no puede enviar tokens ni
recibir tokens hasta que se descongele. Una cuenta congelada aún puede cerrarse
si tiene un saldo de tokens de cero. Solo la autoridad de congelación del mint
del token puede congelar cuentas. Si la autoridad de congelación se revoca (se
establece en null) en la mint account, los tokens nunca podrán ser congelados.
