...
Congelar una token account mantiene el mismo propietario, mint y saldo, pero
impide que la token account reciba, transfiera o queme tokens hasta que la token
account sea descongelada.
