...
description:
  Elimina el delegado actual de una cuenta de tokens y borra su asignación
  delegada restante.
...
La revocación de un delegado elimina el delegado actual de la cuenta de tokens y
...
La revocación de un delegado utiliza la instrucción _rs`Revoke`_ del Token
Program.
...
| _rs`process_revoke`_ | Lógica compartida del procesador para la revocación del delegado.             | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L395-L420)     | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L643-L674)     |
