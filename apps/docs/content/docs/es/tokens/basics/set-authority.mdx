...
description:
  Cambiar o revocar roles de autoridad en una cuenta de acuñación o cuenta de
  tokens, incluyendo autoridad de acuñación, congelación, propietario y cierre.
...
## ¿Qué Hace Establecer una Autoridad?

Establecer una autoridad cambia o revoca roles de autoridad específicos en una
cuenta de acuñación o token account.

Las cuentas de acuñación pueden almacenar una autoridad de acuñación y una
autoridad de congelación. Las token accounts almacenan un propietario y pueden
almacenar opcionalmente una autoridad de cierre. Cada rol controla un conjunto
específico de permisos, y establecer una autoridad como _rs`None`_ elimina
permanentemente el rol de autoridad seleccionado.

El Token Extensions Program también define tipos de autoridad adicionales para
extensiones específicas.

## Cómo Establecer una Autoridad

Cambiar una autoridad utiliza la instrucción _rs`SetAuthority`_ del Token
Program.

Cada llamada actualiza un tipo de autoridad en una cuenta de acuñación o token
account. La autoridad actual firma el cambio, y la nueva autoridad puede ser
otra dirección o _rs`None`_ para revocar la autoridad seleccionada de forma
permanente.
...
| --------------------------- | --------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                  | El estado de acuñación almacena _rs`mint_authority`_ y _rs`freeze_authority`_.                | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)           |
| _rs`Account`_               | El estado de token account almacena _rs`owner`_ y _rs`close_authority`_.                      | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)          |
