...
description:
  Cambia o revoca roles de autoridad en una cuenta de mint o token account,
  incluyendo autoridad de mint, congelación, propietario y cierre.
...
## ¿Qué hace establecer autoridad?

Establecer autoridad cambia o revoca roles de autoridad específicos en una
cuenta de mint o token account.

Las cuentas de mint pueden almacenar una autoridad de mint y una autoridad de
congelación. Las token accounts almacenan un propietario y opcionalmente pueden
almacenar una autoridad de cierre. Cada rol controla un conjunto de permisos
específico, y establecer una autoridad como _rs`None`_ elimina permanentemente
el rol de autoridad seleccionado.

El Token Extensions Program también define tipos de autoridad adicionales para
extensiones específicas.

## Cómo establecer autoridad

Cambiar una autoridad utiliza la instrucción _rs`SetAuthority`_ del Token
Program.

Cada llamada actualiza un tipo de autoridad en una cuenta de mint o token
account. La autoridad actual firma el cambio, y la nueva autoridad puede ser
otra dirección o _rs`None`_ para revocar la autoridad seleccionada
permanentemente.
...
| --------------------------- | ---------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                  | El estado del mint almacena _rs`mint_authority`_ y _rs`freeze_authority`_.               | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)           |
| _rs`Account`_               | El estado de la token account almacena _rs`owner`_ y _rs`close_authority`_.              | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)          |
| _rs`AuthorityType`_         | Los roles de autoridad que _rs`SetAuthority`_ puede actualizar.                          | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L739-L751) | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L1116-L1157) |
| _rs`SetAuthority`_          | Una instrucción que cambia o revoca una autoridad en una cuenta de mint o token account. | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L141-L158) | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L183-L200)   |
| _rs`process_set_authority`_ | Lógica compartida del procesador para actualizaciones de autoridad.                      | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L423-L518)     | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L677-L978)       |
