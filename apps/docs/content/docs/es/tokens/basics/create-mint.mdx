...
único del token a través de billeteras, aplicaciones y exploradores.
...
no esté ya inicializada y esté exenta de rent. Luego, el Token Program escribe
la autoridad de acuñación, la autoridad de congelación, los decimales y la
bandera _rs`is_initialized`_ en los datos de la cuenta mint.
...
decimales, autoridades). Para añadir metadatos legibles como nombre, símbolo e
imagen a tu token, tienes dos opciones:

<Cards>
  <Card title="Metaplex Token Metadata" href="/docs/tokens/metaplex">
   Añade metadatos usando el Metaplex Token Metadata Program. Funciona con ambos, el Token Program original y Token-2022.
  </Card>
  ...
  <Card title="Token Extensions Metadata" href="/docs/tokens/extensions/metadata">
   ...
   Para añadir metadatos a mint accounts creadas con el Token Program original, usa el Metaplex Token Metadata Program.
  </Card>
</Cards>
