...
description:
  Crea un token mint y configura los decimales del mint, la autoridad de
...
Una cuenta mint define e identifica de forma única un token en Solana, y
...
de forma única al USDC en todo el ecosistema de Solana. Puedes ver este mint en
...
no esté ya inicializada y esté exenta de rent. El Token Program luego escribe la
autoridad del mint, la autoridad de congelación, los decimales y el indicador
...
| _rs`InitializeMint`_           | Una instrucción de inicialización de mint que espera la cuenta sysvar de rent en su lista de cuentas.      | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L24-L44)   | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L50-L74)   |
| _rs`InitializeMint2`_          | Una instrucción de inicialización de mint que no requiere la cuenta sysvar de rent en su lista de cuentas. | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L401-L414) | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L471-L486) |
| _rs`_process_initialize_mint`_ | Lógica de procesador compartida para la inicialización del mint.                                           | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L27-L60)       | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L87-L130)      |
| _rs`process_initialize_mint`_  | Controlador público para _rs`InitializeMint`_.                                                             | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L62-L70)       | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L132-L140)     |
| _rs`process_initialize_mint2`_ | Controlador público para _rs`InitializeMint2`_.                                                            | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L72-L81)       | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L142-L151)     |
...
decimales, autoridades). Para añadir metadatos legibles para humanos como
nombre, símbolo e imagen a tu token, tienes dos opciones:

<Cards>
  <Card title="Metaplex Token Metadata" href="/docs/tokens/metaplex">
   Añade metadatos utilizando el Metaplex Token Metadata Program. Funciona tanto con el Token Program original como con Token-2022.
  </Card>
  ...
  <Card title="Token Extensions Metadata" href="/docs/tokens/extensions/metadata">
   ...
   Para añadir metadatos a mint accounts creadas con el Token Program original, utiliza el Metaplex Token Metadata Program.
  </Card>
</Cards>
