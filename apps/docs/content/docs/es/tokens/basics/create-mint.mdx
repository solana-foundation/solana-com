...
forma única USDC en todo el ecosistema de Solana. Puedes ver este mint en
...
Crear un mint account requiere la instrucción
...
## Próximos Pasos: Añadir Metadatos
...
<Cards>
  <Card title="Metadatos de Token de Metaplex" href="/docs/tokens/metaplex">
   Añade metadatos usando el Programa de Metadatos de Token de Metaplex. Funciona tanto con el Token Program original como con Token-2022.
  </Card>

  <Card title="Extensión de Metadatos de Token" href="/docs/tokens/extensions/metadata">
   Usa la extensión de metadatos integrada con Token-2022. 
   La extensión de metadatos solo está disponible para mint accounts creadas con Token-2022.
   Para añadir metadatos a mint accounts creadas con el Token Program original, usa el Programa de Metadatos de Token de Metaplex.
  </Card>
</Cards>
