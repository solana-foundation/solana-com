...
description:
  Cerrar una cuenta de token y devolver los lamports de la cuenta a una cuenta
  de destino.
...
Cerrar una cuenta de token elimina la cuenta y devuelve los lamports de renta de
la cuenta de token a una cuenta de destino.

El saldo de tokens debe ser cero antes de que la cuenta pueda cerrarse. Una
cuenta congelada todavía puede cerrarse si el saldo de tokens de la cuenta
congelada es cero. Las cuentas de token de SOL envuelto son la excepción y
pueden cerrarse con un saldo de tokens para recuperar el SOL subyacente. El
propietario de la cuenta o la autoridad de cierre de la cuenta firma la
