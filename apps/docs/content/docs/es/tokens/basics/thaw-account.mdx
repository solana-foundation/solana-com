...
description:
  Descongela una cuenta de tokens congelada para que puedan reanudarse las
  transferencias, quemas y cambios de delegación.
...
Después de que un descongelamiento se completa con éxito, la cuenta puede
recibir, transferir y quemar tokens nuevamente. Solo la autoridad de
congelamiento del mint puede descongelar cuentas de tokens.
...
mint y que el firmante sea la autoridad de congelación del mint, luego cambia el
estado de la cuenta de tokens de congelado de vuelta a inicializado.
...
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                          | El estado del mint almacena la autoridad de congelación opcional utilizada para descongelar cuentas de tokens. | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`AccountState`_                  | Los estados de la cuenta de tokens, incluyendo _rs`Frozen`_ y _rs`Initialized`_.                               | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L185-L195)       | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L203-L213)       |
| _rs`ThawAccount`_                   | Una instrucción que cambia una cuenta de tokens congelada de vuelta al estado inicializado.                    | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L229-L243) | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L292-L306) |
| _rs`process_toggle_freeze_account`_ | Lógica de procesador compartida para congelar y descongelar cuentas de tokens.                                 | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L713-L754)     | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1293-L1341)   |
