...
revierte un congelamiento, restaurando la funcionalidad completa a una cuenta de
tokens previamente congelada. Después de descongelar, la cuenta puede nuevamente
enviar y recibir tokens con normalidad. Solo la autoridad de congelamiento del
mint del token puede descongelar cuentas.
