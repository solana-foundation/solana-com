...
description:
  Descongele una cuenta de tokens congelada para que puedan reanudarse las
  transferencias, quemas y cambios de delegado.
...
## ¿Qué hace descongelar una cuenta de tokens?

Descongelar cambia una cuenta de tokens del estado congelado de vuelta al estado
inicializado.

Después de que un descongelamiento tiene éxito, la cuenta puede transferir,
quemar y cerrar tokens nuevamente. Solo la autoridad de congelamiento del mint
puede descongelar cuentas de tokens.

## Cómo descongelar una cuenta de tokens

Descongelar una cuenta de tokens utiliza la instrucción _rs`ThawAccount`_ del
Token Program.

La instrucción _rs`ThawAccount`_ verifica que la cuenta de tokens pertenezca al
mint y que el firmante sea la autoridad de congelamiento del mint, luego cambia
el estado de la cuenta de tokens de congelado de vuelta a inicializado.

[Las cuentas de tokens nativas](/docs/tokens/basics/sync-native) no admiten
descongelamiento.
...
| ----------------------------------- | ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                          | El estado del mint almacena la autoridad de congelamiento opcional utilizada para descongelar cuentas de tokens. | [Código fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Código fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`AccountState`_                  | Los estados de cuenta de tokens, incluyendo _rs`Frozen`_ y _rs`Initialized`_.                                    | [Código fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L185-L195)       | [Código fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L203-L213)       |
| _rs`ThawAccount`_                   | Una instrucción que cambia una cuenta de tokens congelada de vuelta al estado inicializado.                      | [Código fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L229-L243) | [Código fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L292-L306) |
| _rs`process_toggle_freeze_account`_ | Lógica compartida del procesador para congelar y descongelar cuentas de tokens.                                  | [Código fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L713-L754)     | [Código fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1293-L1341)   |

### Typescript

Los siguientes ejemplos de `Kit` muestran el enfoque recomendado usando
