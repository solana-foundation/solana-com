...
Después de que la descongelación tiene éxito, la cuenta puede transferir, quemar
y cerrar tokens nuevamente. Solo la autoridad de congelación del mint puede
descongelar cuentas de tokens.
