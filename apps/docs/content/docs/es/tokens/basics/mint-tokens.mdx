...
title: Acuñar tokens
description:
  Acuña nuevas unidades de tokens en una cuenta de tokens con la autoridad de
  acuñación.
...
La acuñación crea nuevas unidades de un token existente y aumenta el suministro
total de la acuñación.

Solo la autoridad de acuñación puede acuñar nuevos tokens. La cuenta de tokens
de destino debe existir previamente y debe pertenecer a la misma acuñación.

## Cómo Acuñar Tokens

La acuñación de tokens utiliza la instrucción _rs`MintTo`_ o _rs`MintToChecked`_
del Token Program.

Los ejemplos a continuación usan _rs`MintToChecked`_, que requiere que el
solicitante proporcione los decimales de la acuñación para que la instrucción
pueda verificar la precisión esperada del token antes de acuñar.

La [acuñación nativa](/docs/tokens/basics/sync-native) no admite la acuñación.

### Referencia del Código Fuente

| Elemento              | Descripción                                                                                                                                                                        | Token Program                                                                                                  | Token Extensions Program                                                                                             |
| --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_            | El estado de la acuñación almacena la autoridad de acuñación y el suministro total de tokens.                                                                                      | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_         | El estado de la token account almacena el saldo de destino actualizado mediante la acuñación.                                                                                      | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`MintTo`_          | Una instrucción de acuñación que acuña tokens en una token account existente sin requerir que el solicitante proporcione los decimales de la acuñación.                            | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L159-L177) | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L202-L220) |
| _rs`MintToChecked`_   | Una instrucción de acuñación que requiere que el solicitante proporcione los decimales de la acuñación y verifica ese valor antes de acuñar tokens en una token account existente. | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L301-L325) | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L367-L391) |
| _rs`process_mint_to`_ | Lógica compartida del procesador para acuñar tokens.                                                                                                                               | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L521-L583)     | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L981-L1067)    |
