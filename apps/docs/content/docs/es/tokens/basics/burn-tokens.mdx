...
title: Quemar tokens
description:
  Quemar tokens de una cuenta de tokens y reducir el suministro total del mint.
...
Los ejemplos a continuación utilizan _rs`BurnChecked`_, que requiere que el
llamador proporcione los decimales del mint para que la instrucción pueda
verificar la precisión esperada del token antes de quemar.

El [native mint](/docs/tokens/basics/sync-native) no admite la quema. Utiliza
...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_         | El estado del mint almacena el suministro total de tokens.                                                                                                                               | [Código](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Código](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_      | El estado de la token account almacena el saldo de tokens reducido por una quema.                                                                                                        | [Código](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Código](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Burn`_         | Una instrucción de quema que disminuye el saldo de una token account y el suministro del mint sin requerir que el llamador proporcione los decimales del mint.                           | [Código](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L178-L196) | [Código](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L221-L239) |
| _rs`BurnChecked`_  | Una instrucción de quema que requiere que el llamador proporcione los decimales del mint y verifica ese valor antes de disminuir el saldo de una token account y el suministro del mint. | [Código](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L326-L350) | [Código](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L393-L417) |
| _rs`process_burn`_ | Lógica de procesamiento compartida para quemas de tokens.                                                                                                                                | [Código](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L586-L668)     | [Código](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1070-L1194)   |
