...
La quema de tokens utiliza la instrucción _rs`Burn`_ o _rs`BurnChecked`_ del
Token Program.

Los ejemplos a continuación utilizan _rs`BurnChecked`_, que requiere que el
solicitante proporcione los decimales del mint para que la instrucción pueda
...
| _rs`Burn`_         | Una instrucción de quema que disminuye el saldo de una token account y el suministro del mint sin requerir que el solicitante proporcione los decimales del mint.                           | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L178-L196) | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L221-L239) |
| _rs`BurnChecked`_  | Una instrucción de quema que requiere que el solicitante proporcione los decimales del mint y verifica ese valor antes de disminuir el saldo de una token account y el suministro del mint. | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L326-L350) | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L393-L417) |
| _rs`process_burn`_ | Lógica compartida del procesador para quemas de tokens.                                                                                                                                     | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L586-L668)     | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1070-L1194)   |
