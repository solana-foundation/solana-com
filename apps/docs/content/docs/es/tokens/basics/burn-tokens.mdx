...
destruye permanentemente tokens al reducir el saldo en una token account. Los
tokens quemados se eliminan de la circulación y disminuyen el `supply` rastreado
