...
description:
  Autorizar a otra dirección para transferir o quemar una cantidad limitada de
  tokens de una cuenta de token.
...
Aprobar un delegado permite que otra dirección transfiera o queme una cantidad
limitada de tokens de una cuenta de token en nombre del propietario de la cuenta
de token.

Una cuenta de token almacena un delegado actual y una cantidad delegada a la
vez. Aprobar un nuevo delegado reemplaza al delegado anterior y la asignación en
la cuenta.

## Cómo Aprobar un Delegado

Aprobar un delegado utiliza la instrucción _rs`Approve`_ o _rs`ApproveChecked`_
del Token Program.

Los ejemplos a continuación utilizan _rs`ApproveChecked`_, que requiere que el
...
El propietario de la cuenta de token firma la aprobación.

### Referencia de Código Fuente

| Elemento              | Descripción                                                                                                                                                                        | Token Program                                                                                                         | Token Extensions Program                                                                                                    |
| --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_         | El estado de la cuenta de token almacena el propietario, el delegado y la cantidad delegada.                                                                                       | [Código fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Código fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Approve`_         | Una instrucción de aprobación de delegado que registra el delegado y la asignación para una cuenta de token sin requerir que el llamador proporcione el mint o los decimales.      | [Código fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L109-L127) | [Código fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L150-L168) |
| _rs`ApproveChecked`_  | Una instrucción de aprobación de delegado que requiere que el llamador proporcione el mint y los decimales y verifica esos valores antes de registrar el delegado y la asignación. | [Código fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L274-L300) | [Código fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L340-L366) |
| _rs`process_approve`_ | Lógica compartida del procesador para la aprobación de delegado.                                                                                                                   | [Código fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L344-L392)     | [Código fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L582-L640)     |
