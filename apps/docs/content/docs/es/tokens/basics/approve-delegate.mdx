...
description:
  Autoriza a otra dirección a transferir o quemar una cantidad limitada de
  tokens desde una cuenta de tokens.
...
limitada de tokens desde una token account en nombre del propietario de la
cuenta de tokens.

Una token account almacena un delegado actual y una cantidad delegada a la vez.
Aprobar un nuevo delegado reemplaza el delegado anterior y la cantidad
...
Los ejemplos a continuación usan _rs`ApproveChecked`_, que requiere que el
...
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_         | El estado de la token account almacena el propietario, delegado y cantidad delegada.                                                                                                        | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Approve`_         | Una instrucción de aprobación de delegado que registra el delegado y la cantidad autorizada para una token account sin requerir que el llamador proporcione el mint o los decimales.        | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L109-L127) | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L150-L168) |
| _rs`ApproveChecked`_  | Una instrucción de aprobación de delegado que requiere que el llamador proporcione el mint y los decimales y verifica esos valores antes de registrar el delegado y la cantidad autorizada. | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L274-L300) | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L340-L366) |
| _rs`process_approve`_ | Lógica compartida del procesador para la aprobación de delegado.                                                                                                                            | [Fuente](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L344-L392)     | [Fuente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L582-L640)     |
