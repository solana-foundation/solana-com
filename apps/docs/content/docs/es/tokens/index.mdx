...
Crear una ATA requiere un saldo mínimo reembolsable para el almacenamiento de su cuenta.
El pagador de la instrucción financia ese saldo incluso cuando otra billetera es la propietaria de la
ATA. Consulte
[Costo y pagador de ATA](/docs/tokens/basics/create-token-account#cost-and-payer)
para conocer los costos actuales y las diferencias de tamaño de Token-2022.
