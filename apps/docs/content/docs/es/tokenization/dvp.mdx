...
Las transacciones de Solana tienen un límite de tamaño (~1232 bytes). Cada instrucción de transferencia agrega ~200 bytes. Para liquidaciones multiparte muy grandes, considera usar
[Address Lookup Tables](/developers/cookbook/transactions/lookup-tables) para
comprimir direcciones de cuentas y ajustar más transferencias por transacción.
