...
La tarifa de priorización es una tarifa opcional que aumenta la prioridad de programación de una transacción. Una unidad de cómputo (CU) es una unidad de cálculo que el entorno de ejecución mide durante la ejecución de la transacción. Cada operación (aritmética, acceso a memoria, syscall) tiene un costo fijo en CUs. Puedes establecer la tarifa de priorización incluyendo instrucciones de presupuesto de cómputo en tu transacción. (Consulta la [guía de Cómo usar tarifas de prioridad](/docs/core/fees) para más detalles.)
...
<Callout type="info" title="Las transacciones v1 establecen la tarifa directamente">
  Esta fórmula de precio por límite se aplica a las transacciones heredadas y v0. En el
  próximo [formato
  v1](/docs/core/transactions/versioned-transactions#v1-message-format), la
  tarifa de prioridad es un total absoluto en lamports establecido directamente en la
  configuración del mensaje — sin precio por CU, sin multiplicación, sin redondeo.
</Callout>
