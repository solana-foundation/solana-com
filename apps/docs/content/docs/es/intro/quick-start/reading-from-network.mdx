...
Lee datos de la red Solana obteniendo diferentes cuentas. Esta guía
explica la estructura de las [cuentas](/docs/core/accounts) de Solana. Cada cuenta de Solana
tiene una
[dirección](/docs/core/accounts/account-structure#account-address) única que se utiliza para
localizar los datos onchain de la cuenta. Las cuentas de Solana contienen
