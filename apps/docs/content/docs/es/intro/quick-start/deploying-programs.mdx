...
La dirección onchain de tu programa. Se actualizará cuando compiles el proyecto
...
- La macro [`declare_id!`](mention:one) especifica la dirección onchain de tu
...
<Callout>
  Tu [ID de programa](/docs/intro/quick-start/build-first-program), definido en
  _rs`declare_id!()`_, ahora será actualizado.
</Callout>

2. Añade SOL a tu billetera _(Opcional)_

Desplegar un programa requiere SOL en la cuenta onchain del programa. Si es
necesario,
[agrega SOL a tu billetera](/docs/intro/quick-start#add-sol-to-your-wallet)
...
Cierra el programa para recuperar el SOL asignado al programa onchain. Para
...
[direcciones derivadas de programas](/docs/core/pda) e
[invocación entre programas](/docs/core/cpi).
