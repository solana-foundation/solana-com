...
0.001 SOL desde la cuenta del usuario a la cuenta de bóveda.
...
- `to` - La cuenta del depósito (destino de los fondos)
...
Esto permite transferir cualquier SOL en el depósito de vuelta al usuario cuando
cierre su cuenta de mensaje.
...
la cuenta vault del usuario durante la instrucción de eliminación para
...
cuenta vault en las instrucciones. Esto requiere derivar el PDA vault e
