...
Después de derivar la dirección del ATA, verifica si la token account existe en
la cadena. Si el ATA no existe, puedes incluir una instrucción para crear la
token account del destinatario en la misma transacción que la transferencia. Sin
