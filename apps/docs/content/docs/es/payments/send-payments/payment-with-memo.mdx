---
title: Pago con memo
description: Aprende cómo adjuntar IDs de factura o notas a un pago.
---

El programa de memo de Solana te permite adjuntar números de factura, IDs de
pedido o referencias personalizadas a cualquier pago. Estos memos se registran
permanentemente en la cadena y son visibles en los registros de transacciones,
lo que facilita relacionar los pagos con tus sistemas internos.

## Cómo funciona

El programa Memo escribe texto en los registros de la transacción. Estos
registros son indexados por exploradores y proveedores RPC, haciendo que los
memos sean buscables para la reconciliación de pagos.
...
Agregar un memo requiere construir instrucciones directamente, lo que te da
control sobre lo que se incluye en la transacción.
...
Importa `getAddMemoInstruction` desde `@solana-program/memo` para crear
instrucciones de memo.

<CodePlaceholder title="Pago con memo" />
...
Crea la instrucción de transferencia de tokens especificando el ATA de origen,
el ATA de destino, la autoridad (firmante) y el monto en unidades base.
...
## !!steps Crear instrucción de memo

Crea una instrucción de memo con un mensaje. Este mensaje será visible en los
registros del programa de la transacción.
...
## !!steps Enviar transacción con memo

Combina las instrucciones de transferencia y memo en una sola transacción.
...
## !!steps Ver memo en los registros de transacciones

Después de que la transacción se confirme, recupérala para ver el memo en los
registros. El memo aparece como un mensaje de registro del programa Memo.
