...
description: Aprende cómo pagar a múltiples destinatarios en una sola transacción.
---
...
eleva el límite de tamaño a 4096 bytes, lo que permite aproximadamente tres veces más
transferencias por transacción. La agrupación en lotes sigue siendo necesaria más allá de ese límite, ya que el
runtime carga como máximo 64 cuentas por transacción independientemente del formato.
