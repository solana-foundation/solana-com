...
description:
  Aprende cómo funciona el patrocinio de tarifas e implementa la abstracción de tarifas con Kora.
---
...
<Cards>
  ...
  <Card title="Demo de Transacción Completa" href="/docs/tools/kora/guides/full-demo">
