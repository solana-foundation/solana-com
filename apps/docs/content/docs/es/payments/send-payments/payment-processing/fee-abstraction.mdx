...
[Kora](/docs/products/kora) maneja esta complejidad. Es un servidor JSON-RPC que
...
<Cards>
  ...
  <Card title="Referencia de API" href="/docs/products/kora/json-rpc-api">
    Métodos JSON-RPC y documentación del SDK.
  </Card>
  <Card title="Guía del operador de nodo" href="/docs/products/kora/operators">
