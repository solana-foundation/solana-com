...
cuentas. Las cuentas de tokens son gestionadas por un **Programa de Tokens**—el
código onchain que verifica transferencias y actualiza saldos de forma atómica.
...
Token-2022 (también conocido como "Token Extensions") añade funciones como hooks de transferencia,
tarifas de transferencia y saldos confidenciales. Ambos programas funcionan de manera similar para las
transferencias básicas, pero debes usar el correcto al derivar ATAs.
...
<Callout type="info">
  Solana utiliza mercados de tarifas locales: las transacciones compiten con otras transacciones
  que escriben en el mismo estado. Esto significa que las tarifas de pago se mantienen bajas y predecibles
  incluso durante períodos de alta actividad en la red.
</Callout>
