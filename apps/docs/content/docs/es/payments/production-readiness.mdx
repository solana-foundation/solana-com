...
Para el firmado de backend en producción, considera usar
[solana-keychain](https://github.com/solana-foundation/solana-keychain)—una
biblioteca de firmado unificada que abstrae múltiples backends de gestión de
...
claves en memoria y luego cambiar a backends de nivel de producción sin
