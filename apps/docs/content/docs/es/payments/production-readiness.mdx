...
Fireblocks, GCP KMS, CDP, Para, Dfns. Esto te permite desarrollar localmente con
claves en memoria y luego cambiar a backends de nivel producción sin modificar
