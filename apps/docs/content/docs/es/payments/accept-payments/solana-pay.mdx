...
| ----------- | ----------- | ------------------------------------------------------ |
| `recipient` | `Address`   | Dirección de billetera del comerciante (obligatorio)   |
| `amount`    | `bigint`    | Cantidad en lamports o unidades menores de token       |
| `splToken`  | `Address`   | Dirección de acuñación del token SPL (omitir para SOL) |
...
| `memo`      | `string`    | Nota en cadena adjunta a la transacción                |
