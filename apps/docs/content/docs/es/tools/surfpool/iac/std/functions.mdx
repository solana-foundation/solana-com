...
description: Funciones de utilidad disponibles en la biblioteca estándar
---

Estas funciones están disponibles en todos los Runbooks como parte de la
biblioteca estándar.

## Operadores

Operadores matemáticos y de comparación básicos:
