...
description: Métodos para gestionar cuentas, saldos y rent
---
...
Donde `TransactionResult` es
`Result<TransactionMetadata, FailedTransactionMetadata>`.

Añade fondos a una cuenta en lamports. Devuelve los metadatos de la transacción
...
Establece directamente el estado de la cuenta.
...
Obtiene el saldo en lamports de una cuenta. Devuelve `None` si la cuenta no
existe.
...
Calcula el mínimo de lamports necesarios para la exención de rent.
