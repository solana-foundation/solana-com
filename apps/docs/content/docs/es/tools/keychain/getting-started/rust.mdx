...
| -------------- | ----------------------------------------- |
| `memory`       | Firma de keypair local (predeterminado)   |
| `vault`        | Motor Transit de HashiCorp Vault          |
| `aws_kms`      | AWS KMS con Ed25519                       |
| `gcp_kms`      | GCP Cloud KMS con Ed25519                 |
| `privy`        | Wallets embebidas de Privy                |
| `turnkey`      | API de Turnkey                            |
| `fireblocks`   | MPC de Fireblocks                         |
| `cdp`          | Plataforma de Desarrolladores de Coinbase |
| `crossmint`    | Wallets administradas de Crossmint        |
| `dfns`         | Infraestructura de wallets Dfns           |
| `openfort`     | Wallets embebidas de Openfort             |
| `para`         | Wallets MPC de Para                       |
| `all`          | Habilita todos los backends               |
