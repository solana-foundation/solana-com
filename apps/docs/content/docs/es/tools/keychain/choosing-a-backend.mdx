...
description:
  "Elige un backend de firma Keychain según tus requisitos: custodia, infraestructura existente, controles de aprobación y si firmas para tu propia aplicación o aprovisionas carteras para usuarios finales."
related:
...
Si las firmas deben pasar por una política de aprobación, límite de gasto o flujo
de trabajo de cumplimiento normativo antes de generarse — o necesitas un custodio
regulado que gestione las claves — utiliza un backend de **MPC / custodia institucional**:
Fireblocks, Dfns, Para, Utila o Fordefi. Estos dividen o custodian la clave y co-firman
según tu política.

Si solo necesitas una clave que firme bajo demanda, continúa a continuación.
...
- **KMS en la nube / HSM** — un proveedor de nube almacena la clave en
  ...
  KMS**.
- **MPC y custodia institucional** — la clave se divide o custodia a través de un
  proveedor, que co-firma según tu política (aprobaciones, límites).
...
| Fordefi         | Custodia MPC / institucional  | Custodia institucional con controles de política | El modo nativo transmite automáticamente; en el modo caja negra, eres tú quien envía |
