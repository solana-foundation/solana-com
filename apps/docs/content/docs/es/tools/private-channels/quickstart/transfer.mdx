...
description:
  Envía una transferencia de tokens SPL fuera de la cadena a través del gateway de Private Channels
---
...
**[Retirar Fondos](/docs/tools/private-channels/quickstart/withdraw)** -
retira tokens de vuelta a tu wallet de Solana
