...
- [Token Programit](#token-programs) sisältävät kaiken ohjelogiikan tokenien
...
käytännössä [data accounteja](/docs/core/accounts/account-types#data-accounts),
jotka Token Program omistaa.
...
[Account](/docs/core/accounts/account-structure#account-fields) -tyypin
määrittämästä ohjelman omistajasta, joka on Token Program kaikille token
accounteille.
...
On kaksi tapaa lisätä metadataa (nimi, symboli, kuva) tokeneihin Solanassa:

1. **[Metaplex Token Metadata](/docs/tokens/metaplex)** - Luo erillisen
   metadata-tilin, joka on linkitetty mint-tiliisi. Toimii alkuperäisen Token
   Programin ja Token-2022:n kanssa ja on laajasti tuettu lompakoissa ja
   markkinapaikoilla.

2. **[Token Extensions Metadata](/docs/tokens/extensions/metadata)** - Tallentaa
   metadatan suoraan mint-tilille käyttäen Token-2022:ta. Uudempi lähestymistapa
   sisäänrakennetulla tuella. Metadata-laajennus on saatavilla vain
   Token-2022:lla luoduille mint-tileille. Lisätäksesi metadataa alkuperäisellä
   Token Programilla luoduille mint-tileille, käytä Metaplex Token Metadata
   Programia.

#### SPL Token CLI -esimerkki

Token Extensions Program mahdollistaa metadatan tallentamisen suoraan
mint-tilille. Luodaksesi tokenin metadata-laajennuksella:
...
Lue lisää [Token Extensions -osiossa](/docs/tokens/extensions/metadata).
Lisätietoja Token Extensionsista löydät Token Extensions
[-osiosta](/docs/tokens/extensions) ja
