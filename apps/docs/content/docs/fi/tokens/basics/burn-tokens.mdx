...
description: Polta tokeneita token-tiiltä ja vähennä mintin kokonaistarjontaa.
...
## Miten polttaa tokeneita

Tokenien polttaminen käyttää Token Program -ohjelman _rs`Burn`_- tai
_rs`BurnChecked`_-käskyä.

Alla olevat esimerkit käyttävät _rs`BurnChecked`_-käskyä, joka vaatii kutsujaa
toimittamaan mintin desimaalit, jotta käsky voi varmistaa odotetun
token-tarkkuuden ennen polttamista.

[Native mint](/docs/tokens/basics/sync-native) ei tue polttamista. Käytä sen
sijaan _rs`CloseAccount`_-käskyä.

Token-tilin omistaja tai hyväksytty edustaja allekirjoittaa tapahtuman. Token
Extensions Program -ohjelmassa mintin pysyvä edustaja voi myös valtuuttaa
polttamisen, jos mintillä on pysyvän edustajan laajennus käytössä.
...
| _rs`Burn`_         | Polttokäsky, joka vähentää token-tilin saldoa ja mintin tarjontaa ilman, että kutsujan tarvitsee toimittaa mintin desimaaleja.                 | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L178-L196) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L221-L239) |
| _rs`BurnChecked`_  | Polttokäsky, joka vaatii kutsujan toimittamaan mintin desimaalit ja tarkistaa arvon ennen token-tilin saldon ja mintin tarjonnan vähentämistä. | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L326-L350) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L393-L417) |
| _rs`process_burn`_ | Jaettu prosessorilogiikka tokenien polttamiseen.                                                                                               | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L586-L668)     | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1070-L1194)   |
