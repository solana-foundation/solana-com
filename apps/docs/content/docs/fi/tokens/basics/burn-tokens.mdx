...
[`BurnChecked`](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/interface/src/instruction.rs#L359C5-L359C16)-käsky
tuhoaa tokeneja pysyvästi vähentämällä saldoa token-tilillä. Poltetut tokenit
poistetaan liikkeestä ja vähentävät `supply`-arvoa, jota seurataan mint-tilillä.
Vain token-tilin omistaja voi polttaa tokeneita tililtään.
