---
title: Poleta tokeneita
description: Poleta tokeneita token-tilistä ja vähennä mintin kokonaistarjontaa.
...
## Mitä polttaminen tekee?

Tokenien polttaminen vähentää pysyvästi token-tilin saldoa ja vähentää mintin
kokonaistarjontaa samalla määrällä.

## Kuinka poltetaan tokeneita

Tokenien polttaminen käyttää Token Program -ohjelman _rs`Burn`_- tai
_rs`BurnChecked`_-komentoa.

Alla olevat esimerkit käyttävät _rs`BurnChecked`_-komentoa, joka vaatii kutsujaa
toimittamaan mintin desimaalit, jotta komento voi vahvistaa odotetun tokenin
tarkkuuden ennen polttamista.

[Native mint](/docs/tokens/basics/sync-native) ei tue polttamista. Käytä sen
sijaan _rs`CloseAccount`_-komentoa.

Token-tilin omistaja tai hyväksytty delegaatti allekirjoittaa tapahtuman. Token
Extensions Program -ohjelmassa mintin pysyvä delegaatti voi myös valtuuttaa
polton, jos mintissä on pysyvä delegaatti -laajennus käytössä.

### Lähdeviite

| Kohde              | Kuvaus                                                                                                                                                    | Token Program                                                                                                 | Token Extensions Program                                                                                            |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_         | Mintin tila tallentaa tokenien kokonaistarjonnan.                                                                                                         | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_      | Token-tilin tila tallentaa token-saldon, jota polttaminen vähentää.                                                                                       | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Burn`_         | Polttokomento, joka vähentää token-tilin saldoa ja mintin tarjontaa vaatimatta kutsujaa toimittamaan mintin desimaaleja.                                  | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L178-L196) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L221-L239) |
| _rs`BurnChecked`_  | Polttokomento, joka vaatii kutsujaa toimittamaan mintin desimaalit ja tarkistaa kyseisen arvon ennen token-tilin saldon ja mintin tarjonnan vähentämistä. | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L326-L350) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L393-L417) |
| _rs`process_burn`_ | Jaettu prosessorin logiikka tokenien polttoihin.                                                                                                          | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L586-L668)     | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1070-L1194)   |
