...
[`ApproveChecked`](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/instruction.rs#L295)-käsky
myöntää toiselle tilille (delegaatille) luvan siirtää tietyn määrän tokeneita
token account -tililtäsi. Delegaatti voi siirtää tokeneita hyväksyttyyn määrään
asti, mutta ei voi ylittää sitä. Vain token account -tilin omistaja voi hyväksyä
delegaatin, ja jokaisella token account -tilillä voi olla vain yksi delegaatti
kerrallaan. Jokainen uusi hyväksyntä korvaa edellisen.
