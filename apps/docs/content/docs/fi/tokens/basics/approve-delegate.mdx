---
title: Hyväksy delegaatti
description:
  Valtuuta toinen osoite siirtämään tai polttamaan rajoitetun määrän tokeneita
  token-tilin puolesta.
...
## Mitä delegaatin hyväksyminen tekee?

Delegaatin hyväksyminen sallii toisen osoitteen siirtää tai polttaa rajoitetun
määrän tokeneita token-tililtä token-tilin omistajan puolesta.

Token-tili tallentaa yhden nykyisen delegaatin ja yhden delegoidun määrän
kerrallaan. Uuden delegaatin hyväksyminen korvaa edellisen delegaatin ja
valtuutuksen tilillä.

## Kuinka hyväksyä delegaatti

Delegaatin hyväksyminen käyttää Token Program -ohjelman _rs`Approve`_- tai
_rs`ApproveChecked`_-käskyä.

Alla olevat esimerkit käyttävät _rs`ApproveChecked`_-käskyä, joka edellyttää
kutsujalta mintin ja desimaalien toimittamista, jotta käsky voi varmistaa
odotetun mintin ja token-tarkkuuden ennen hyväksynnän käsittelyä.

Token-tilin omistaja allekirjoittaa hyväksynnän.

### Lähdeviittaus

| Kohde                 | Kuvaus                                                                                                                                                             | Token Program                                                                                                 | Token Extensions Program                                                                                            |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_         | Token-tilin tila tallentaa omistajan, delegaatin ja delegoidun määrän.                                                                                             | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Approve`_         | Delegaatin hyväksymiskäsky, joka tallentaa delegaatin ja valtuutuksen token-tilille ilman, että kutsujalta vaaditaan mintin tai desimaalien toimittamista.         | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L109-L127) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L150-L168) |
| _rs`ApproveChecked`_  | Delegaatin hyväksymiskäsky, joka edellyttää kutsujalta mintin ja desimaalien toimittamista ja tarkistaa nämä arvot ennen delegaatin ja valtuutuksen tallentamista. | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L274-L300) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L340-L366) |
| _rs`process_approve`_ | Jaettu prosessorilogiikka delegaatin hyväksymiselle.                                                                                                               | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L344-L392)     | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L582-L640)     |
