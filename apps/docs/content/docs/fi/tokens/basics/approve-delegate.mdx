...
kerrallaan. Uuden delegaatin hyväksyminen korvaa aiemman delegaatin ja
käyttörajan tilillä.

## Kuinka Hyväksyä Delegaatti

Delegaatin hyväksyminen käyttää Token Programin _rs`Approve`_- tai
_rs`ApproveChecked`_-käskyä.

Alla olevat esimerkit käyttävät _rs`ApproveChecked`_-käskyä, joka edellyttää
kutsujalta mintin ja desimaalien antamista, jotta käsky voi varmistaa odotetun
mintin ja token-tarkkuuden ennen hyväksynnän käsittelyä.
...
| _rs`Approve`_         | Delegaatin hyväksymiskäsky, joka tallentaa delegaatin ja käyttörajan token-tilille ilman, että kutsujan tarvitsee antaa minttiä tai desimaaleja.         | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L109-L127) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L150-L168) |
| _rs`ApproveChecked`_  | Delegaatin hyväksymiskäsky, joka edellyttää kutsujan antavan mintin ja desimaalit ja tarkistaa nämä arvot ennen delegaatin ja käyttörajan tallentamista. | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L274-L300) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L340-L366) |
