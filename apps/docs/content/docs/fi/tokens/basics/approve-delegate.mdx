...
description:
  Valtuuta toinen osoite siirtämään tai polttamaan rajoitettu määrä tokeneita
  token accountista.
...
## Mitä valtuutetun hyväksyminen tekee?

Valtuutetun hyväksyminen sallii toisen osoitteen siirtää tai polttaa rajoitetun
määrän tokeneita token accountista token accountin omistajan puolesta.

Token account tallentaa yhden nykyisen valtuutetun ja yhden valtuutetun määrän
kerrallaan. Uuden valtuutetun hyväksyminen korvaa aiemman valtuutetun ja
sallitun määrän accountissa.

## Kuinka hyväksyä valtuutettu

Valtuutetun hyväksyminen käyttää Token Programin _rs`Approve`_- tai
_rs`ApproveChecked`_-instruktiota.

Alla olevat esimerkit käyttävät _rs`ApproveChecked`_-instruktiota, joka
edellyttää kutsujalta mintin ja desimaalien toimittamista, jotta instruktio voi
vahvistaa odotetun mintin ja tokenin tarkkuuden ennen hyväksynnän käsittelyä.

Token accountin omistaja allekirjoittaa hyväksynnän.

### Lähdeviitteet

| Kohde                 | Kuvaus                                                                                                                                                                        | Token Program                                                                                                 | Token Extensions Program                                                                                            |
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_         | Token accountin tila tallentaa omistajan, valtuutetun ja valtuutetun määrän.                                                                                                  | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Approve`_         | Valtuutuksen hyväksymisinstruktio, joka tallentaa valtuutetun ja sallitun määrän token accountiin ilman, että kutsuja joutuu toimittamaan minttiä tai desimaaleja.            | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L109-L127) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L150-L168) |
| _rs`ApproveChecked`_  | Valtuutuksen hyväksymisinstruktio, joka edellyttää kutsujalta mintin ja desimaalien toimittamista ja tarkistaa nämä arvot ennen valtuutetun ja sallitun määrän tallentamista. | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L274-L300) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L340-L366) |
| _rs`process_approve`_ | Jaettu prosessorilogiikka valtuutuksen hyväksymiselle.                                                                                                                        | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L344-L392)     | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L582-L640)     |
