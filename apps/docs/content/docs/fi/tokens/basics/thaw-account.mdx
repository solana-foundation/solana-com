...
[`ThawAccount`](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/instruction.rs#L243)-käsky
kumoaa jäädytyksen ja palauttaa aiemmin jäädytetyn token accountin täyden
toiminnallisuuden. Sulattamisen jälkeen tili voi jälleen lähettää ja
vastaanottaa tokeneita normaalisti. Vain tokenin mintin jäädytysvaltuutus voi
sulattaa tilejä.
