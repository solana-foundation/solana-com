...
description:
  Luo token-mint ja määritä mintin desimaalit, mint-valtuutus ja
  jäädytysvaltuutus.
...
Mint account määrittelee ja yksilöi tokenin Solanassa ainutlaatuisesti sekä
tallentaa jaetun tilan, jota sovelletaan kaikkiin kyseisen mintin
token-tileihin.

Token Program määrittelee _rs`Mint`_ -tilityypin seuraavasti:
...
Jokaisella tokenilla on yksi mint account, ja mint-osoite on tokenin
ainutlaatuinen tunniste lompakoissa, sovelluksissa ja tutkimuksessa.

Esimerkiksi USD Coinilla (USDC) on mint-osoite
`EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v`. Mint-osoite yksilöi USDC:n
...
mint-valtuutuksen, jäädytysvaltuutuksen, desimaalit ja _rs`is_initialized`_
-lipun mint account -dataan.

### Lähdeviittaus

| Kohde                          | Kuvaus                                                                   | Token Program                                                                                                 | Token Extensions Program                                                                                            |
| ------------------------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                     | Jokaiseen mint accountiin tallennettu perus-mint-tila.                   | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
...
Mint account tallentaa vain perustiedot tokenista (tarjonta, desimaalit,
valtuudet). Jotta voit lisätä ihmisluettavaa metadataa, kuten nimen, symbolin ja
kuvan tokeniisi, sinulla on kaksi vaihtoehtoa:

<Cards>
  <Card title="Metaplex Token Metadata" href="/docs/tokens/metaplex">
   Lisää metadata käyttämällä Metaplex Token Metadata -ohjelmaa. Toimii sekä alkuperäisen Token Program -ohjelman että Token-2022:n kanssa.
  </Card>
  ...
  <Card title="Token Extensions Metadata" href="/docs/tokens/extensions/metadata">
   ...
   Jotta voit lisätä metadataa alkuperäisellä Token Program -ohjelmalla luoduille mint account -tileille, käytä Metaplex Token Metadata -ohjelmaa.
  </Card>
</Cards>
