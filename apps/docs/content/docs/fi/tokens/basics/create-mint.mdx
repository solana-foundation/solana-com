---
title: Luo Token-mintti
description:
  Luo token-mintti ja määritä mintin desimaalit, mintin auktoriteetti ja
  jäädytysauktoriteetti.
...
Minttitili määrittelee ja yksilöi tokenin Solanassa sekä tallentaa jaetun tilan,
joka koskee kaikkia kyseisen mintin token-tilejä.

Token Program määrittelee _rs`Mint`_ -tilityypiksi:
...
Jokaisella tokenilla on yksi minttitili, ja mintin osoite on tokenin
...
Mintin alustuksen aikana Token Program tarkistaa, ettei minttitiliä ole jo
alustettu ja että se on rent-vapautettu. Token Program kirjoittaa sitten mintin
auktoriteetin, jäädytysauktoriteetin, desimaalit ja _rs`is_initialized`_ -lipun
minttitilin dataan.
...
| ------------------------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                     | Perustason minttitila, joka tallennetaan jokaiseen minttitiliin.         | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`InitializeMint`_           | Mintin alustuskäsky, joka odottaa rent sysvar -tilin tililuettelossaan.  | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L24-L44)   | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L50-L74)   |
...
| _rs`_process_initialize_mint`_ | Jaettu prosessorin logiikka mintin alustukselle.                         | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L27-L60)       | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L87-L130)      |
...
Alla olevat `Kit` -esimerkit esittävät suositellun lähestymistavan käyttäen
...
Mint account tallentaa vain perustietoja tokenista (tarjonta, desimaalit,
oikeudet). Voidaksesi lisätä ihmisluettavaa metadataa, kuten nimen, symbolin ja
kuvan tokenillesi, sinulla on kaksi vaihtoehtoa:

<Cards>
  <Card title="Metaplex Token Metadata" href="/docs/tokens/metaplex">
   Lisää metadata käyttäen Metaplex Token Metadata -ohjelmaa. Toimii sekä alkuperäisen Token Program -ohjelman että Token-2022:n kanssa.
  </Card>

  <Card title="Token Extensions Metadata" href="/docs/tokens/extensions/metadata">
   Käytä Token-2022:n sisäänrakennettua metadata-laajennusta. 
   Metadata-laajennus on saatavilla vain Token-2022:lla luoduille mint account -tileille.
   Lisätäksesi metadataa alkuperäisellä Token Program -ohjelmalla luoduille mint account -tileille, käytä Metaplex Token Metadata -ohjelmaa.
  </Card>
</Cards>
