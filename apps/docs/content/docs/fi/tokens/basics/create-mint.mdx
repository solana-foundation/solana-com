...
`EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v`. Tämä osoite yksilöi USDC:n
...
## Seuraavat vaiheet: Metatietojen lisääminen

Mint account tallentaa vain perustilit tokenin tiedot (tarjonta, desimaalit,
valtuutukset). Jos haluat lisätä tokeniisi ihmisluettavia metatietoja, kuten
nimen, symbolin ja kuvan, sinulla on kaksi vaihtoehtoa:

<Cards>
  <Card title="Metaplex Token Metadata" href="/docs/tokens/metaplex">
   Lisää metatiedot käyttämällä Metaplex Token Metadata -ohjelmaa. Toimii sekä alkuperäisen Token Program -ohjelman että Token-2022:n kanssa.
  </Card>
  ...
  <Card title="Token Extensions Metadata" href="/docs/tokens/extensions/metadata">
   ...
   Alkuperäisellä Token Program -ohjelmalla luotuihin mint account -tileihin metatietojen lisäämiseen käytä Metaplex Token Metadata -ohjelmaa.
  </Card>
</Cards>
