...
Token-tilin jäädyttäminen säilyttää saman omistajan, mintin ja saldon, mutta
estää token-tiliä siirtämästä tai polttamasta tokeneita, kunnes token-tili on
sulatettu.
