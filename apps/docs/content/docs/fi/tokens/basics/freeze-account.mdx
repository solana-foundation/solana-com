...
description: Opi jäädyttämään token-tilejä.
---
...
estää kaikki token-siirrot ja token-polttamiset tietystä token-tilistä. Kun tili
on jäädytetty, se ei voi lähettää tai vastaanottaa tokeneita ennen kuin se
vapautetaan. Jäädytetty tili voidaan silti sulkea, jos sen token-saldo on nolla.
Vain tokenin mint accountin jäädytysvaltuutus voi jäädyttää tilejä. Jos
jäädytysvaltuutus peruutetaan (asetetaan null-arvoksi) mint accountilla,
tokeneita ei voida koskaan jäädyttää.
