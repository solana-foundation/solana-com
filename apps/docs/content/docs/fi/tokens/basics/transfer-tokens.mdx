...
description:
  Siirrä tokeneita token-tilien välillä samalle mintille Token Program
  -siirto-ohjeilla.
...
Tokenien siirtäminen siirtää tokeneita yhdeltä token-tililtä toiselle
token-tilille samalle mintille.

Siirrot eivät muuta mintin tarjontaa. Siirrot päivittävät vain saldoja
...
kutsujaa toimittamaan mintin ja desimaalit, jotta ohje voi vahvistaa odotetun
mintin ja token-tarkkuuden ennen tokenien siirtämistä tilien välillä.

Token Extensions Programissa _rs`Transfer`_ on vanhentunut ja sen sijaan
suositellaan _rs`TransferChecked`_- tai _rs`TransferCheckedWithFee`_-ohjeen
käyttöä.

Lähdetilin omistaja tai hyväksytty delegaatti allekirjoittaa siirron. Token
Extensions Programissa mintin pysyvä delegaatti voi myös valtuuttaa siirron, jos
mintissä on pysyvä delegaatti -laajennus käytössä.

### Lähdeviitteet

| Kohde                  | Kuvaus                                                                                                                                                                                          | Token Program                                                                                                 | Token Extensions Program                                                                                            |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_          | Token account -tila tallentaa siirron päivittämät saldot.                                                                                                                                       | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Transfer`_         | Siirto-ohje, joka siirtää tokeneita token-tilien välillä vaatimatta kutsujaa toimittamaan minttiä tai desimaaleja. Token Extensions Programissa käytä sen sijaan _rs`TransferChecked`_-ohjetta. | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L89-L108)  | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L121-L149) |
| _rs`TransferChecked`_  | Siirto-ohje, joka vaatii kutsujaa toimittamaan mintin ja desimaalit ja tarkistaa nämä arvot ennen tokenien siirtämistä saman mintin token-tilien välillä.                                       | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L245-L273) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L308-L339) |
| _rs`process_transfer`_ | Jaettu prosessorilogiikka token-siirroille.                                                                                                                                                     | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L227-L341)     | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L308-L579)     |
