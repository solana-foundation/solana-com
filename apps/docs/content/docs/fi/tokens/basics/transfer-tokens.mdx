...
description:
  Siirrä tokeneita token accountien välillä samalle mintille Token Programin
  siirto-ohjeilla.
...
## Mitä tokenien siirtäminen tekee?

Tokenien siirtäminen siirtää tokeneita yhdestä token accountista toiseen token
accountiin samalle mintille.

Siirrot eivät muuta mintin tarjontaa. Siirrot päivittävät vain saldoja token
accountien välillä.

## Kuinka siirtää tokeneita

Tokenien siirtäminen käyttää Token Programin _rs`Transfer`_- tai
_rs`TransferChecked`_-ohjetta.

Alla olevat esimerkit käyttävät _rs`TransferChecked`_-ohjetta, joka vaatii
kutsujalta mintin ja desimaalien toimittamista, jotta ohje voi varmistaa
odotetun mintin ja token-tarkkuuden ennen tokenien siirtämistä tilien välillä.

Token Extensions Programissa _rs`Transfer`_ on vanhentunut ja sen sijaan
suositellaan _rs`TransferChecked`_- tai _rs`TransferCheckedWithFee`_-ohjetta.

Lähdetilin omistaja tai hyväksytty edustaja allekirjoittaa siirron. Token
Extensions Programissa mintin pysyvä edustaja voi myös valtuuttaa siirron, jos
mintillä on pysyvän edustajan laajennus käytössä.

### Lähdekoodiviitteet

| Kohde                  | Kuvaus                                                                                                                                                                                                      | Token Program                                                                                                      | Token Extensions Program                                                                                                 |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| _rs`Account`_          | Token account -tila tallentaa siirron päivittämät saldot.                                                                                                                                                   | [Lähdekoodi](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Lähdekoodi](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Transfer`_         | Siirto-ohje, joka siirtää tokeneita token accountien välillä ilman, että kutsujan tarvitsee toimittaa minttiä tai desimaaleja. Token Extensions Programissa käytä sen sijaan _rs`TransferChecked`_-ohjetta. | [Lähdekoodi](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L89-L108)  | [Lähdekoodi](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L121-L149) |
| _rs`TransferChecked`_  | Siirto-ohje, joka vaatii kutsujan toimittamaan mintin ja desimaalit ja tarkistaa nämä arvot ennen tokenien siirtämistä saman mintin token accountien välillä.                                               | [Lähdekoodi](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L245-L273) | [Lähdekoodi](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L308-L339) |
| _rs`process_transfer`_ | Jaettu prosessorilogiikka token-siirroille.                                                                                                                                                                 | [Lähdekoodi](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L227-L341)     | [Lähdekoodi](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L308-L579)     |
