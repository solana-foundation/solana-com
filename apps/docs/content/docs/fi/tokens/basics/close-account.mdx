...
description: Sulje token-tili ja palauta tilin lamportit kohdetilille.
...
Token-tilin sulkeminen poistaa tilin ja palauttaa token-tilin rent-lamportit
kohdetilille.
...
token-tilit ovat poikkeus ja ne voidaan sulkea token-saldolla taustalla olevan
SOL:n takaisin saamiseksi. Tilin omistaja tai tilin sulkemisvaltuutettu
allekirjoittaa sulkemiskäskyn.

## Kuinka sulkea token-tili

Token-tilin sulkeminen käyttää Token Programin _rs`CloseAccount`_-käskyä.

_rs`CloseAccount`_-käsky siirtää lähdetilin lamportit kohdetilille, tyhjentää
