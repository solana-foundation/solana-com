...
voidaan silti sulkea, jos jäädytetyn tilin token-saldo on nolla. Wrapatut SOL
token-tilit ovat poikkeus ja ne voidaan sulkea token-saldon kanssa taustalla
olevan SOL:n takaisin saamiseksi. Tilin omistaja tai tilin sulkemisvaltuutettu
allekirjoittaa sulkemisohjeen.
