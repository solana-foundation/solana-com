...
description:
  Vaihda tai peruuta valtuutusrooleja mint- tai token account -tilillä, mukaan
  lukien mint-, freeze-, owner- ja close-valtuutukset.
...
## Mitä valtuutuksen asettaminen tekee?

Valtuutuksen asettaminen vaihtaa tai peruuttaa tietyt valtuutusroolit mint
account -tilillä tai token account -tilillä.

Mint account -tilit voivat tallentaa mint-valtuutuksen ja freeze-valtuutuksen.
Token account -tilit tallentavat omistajan ja voivat valinnaisesti tallentaa
close-valtuutuksen. Jokainen rooli hallitsee tiettyä käyttöoikeuskokonaisuutta,
ja valtuutuksen asettaminen arvoon _rs`None`_ poistaa valitun valtuutusroolin
pysyvästi.

Token Extensions Program määrittelee myös lisävaltuutustyyppejä tietyille
laajennuksille.

## Kuinka valtuutus asetetaan

Valtuutuksen vaihtaminen käyttää Token Program -ohjelman
_rs`SetAuthority`_-käskyä.

Jokainen kutsu päivittää yhden valtuutustyypin yhdellä mint account -tilillä tai
token account -tilillä. Nykyinen valtuutus allekirjoittaa muutoksen, ja uusi
valtuutus voi olla toinen osoite tai _rs`None`_ valitun valtuutuksen pysyvää
...
| --------------------------- | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                  | Mint-tila tallentaa _rs`mint_authority`_- ja _rs`freeze_authority`_-arvot.                             | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)           |
| _rs`Account`_               | Token account -tila tallentaa _rs`owner`_- ja _rs`close_authority`_-arvot.                             | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)          |
| _rs`AuthorityType`_         | Valtuutusroolit, joita _rs`SetAuthority`_ voi päivittää.                                               | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L739-L751) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L1116-L1157) |
| _rs`SetAuthority`_          | Käsky, joka vaihtaa tai peruuttaa yhden valtuutuksen mint account -tilillä tai token account -tilillä. | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L141-L158) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L183-L200)   |
| _rs`process_set_authority`_ | Jaettu prosessorilogiikka valtuutuspäivityksille.                                                      | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L423-L518)     | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L677-L978)       |
