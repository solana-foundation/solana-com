...
description:
  Poista token-tilin nykyinen delegaatti ja tyhjennä sen jäljellä oleva
  delegoitu käyttöoikeus.
...
## Mitä delegaatin peruuttaminen tekee?

Delegaatin peruuttaminen tyhjentää token-tilin nykyisen delegaatin ja nollaa
delegoidun määrän.

Peruuttamisen jälkeen aiemmalla delegaatilla ei ole enää valtuuksia siirtää tai
polttaa tokeneita token-tilin puolesta.

## Kuinka delegaatti peruutetaan

Delegaatin peruuttaminen käyttää Token Programin _rs`Revoke`_-käskyä.

_rs`Revoke`_-käsky tyhjentää delegaattikentät lähde-token-tilillä. Token
Programissa token-tilin omistaja allekirjoittaa peruutuksen. Token Extensions
Programissa nykyinen delegaatti voi myös peruuttaa delegoinnin.

### Lähdeviite

| Kohde                | Kuvaus                                                      | Token Program                                                                                                 | Token Extensions Program                                                                                            |
| -------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_        | Token-tilin tila tallentaa delegaatin ja delegoidun määrän. | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Revoke`_         | Käsky, joka poistaa nykyisen delegaatin token-tililtä.      | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L128-L140) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L170-L182) |
| _rs`process_revoke`_ | Jaettu prosessorilogiikka delegaatin peruuttamiselle.       | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L395-L420)     | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L643-L674)     |

### Typescript

Alla olevat `Kit`-esimerkit esittävät suositellun lähestymistavan käyttäen
`@solana/kit`-kirjastoa. `@solana/web3.js`-kirjastoa käyttävät vanhat esimerkit
