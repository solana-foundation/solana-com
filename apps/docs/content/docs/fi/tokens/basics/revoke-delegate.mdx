...
description:
  Poista token-tilin nykyinen edustaja ja tyhjennä sen jäljellä oleva
  valtuutettu määrä.
...
## Mitä edustajan peruuttaminen tekee?

Edustajan peruuttaminen tyhjentää token-tilin nykyisen edustajan ja nollaa
valtuutetun määrän.

Peruuttamisen jälkeen aiemmalla edustajalla ei ole enää valtuutta siirtää tai
polttaa tokeneita token-tilin puolesta.

## Kuinka peruuttaa edustaja

Edustajan peruuttaminen käyttää Token Programin _rs`Revoke`_-käskyä.

_rs`Revoke`_-käsky tyhjentää edustajan kentät lähde-token-tilillä. Token
Programissa token-tilin omistaja allekirjoittaa peruutuksen. Token Extensions
Programissa nykyinen edustaja voi myös peruuttaa valtuutuksen.

### Lähdeviite

| Kohde                | Kuvaus                                                      | Token Program                                                                                                 | Token Extensions Program                                                                                            |
| -------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_        | Token-tilin tila tallentaa edustajan ja valtuutetun määrän. | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Revoke`_         | Käsky, joka poistaa nykyisen edustajan token-tililtä.       | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L128-L140) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L170-L182) |
| _rs`process_revoke`_ | Jaettu prosessorilogiikka edustajan peruuttamiseen.         | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L395-L420)     | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L643-L674)     |
