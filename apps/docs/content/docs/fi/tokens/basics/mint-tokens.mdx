...
description: Lyö uusia token-yksiköitä token-tilille mint-valtuutuksella.
...
Lyöminen luo uusia yksiköitä olemassa olevasta tokenista ja kasvattaa mintin
kokonaistarjontaa.

Vain mint-valtuutus voi lyödä uusia tokeneita. Kohde-token-tilin täytyy jo olla
olemassa ja sen täytyy kuulua samaan minttiin.

## Kuinka lyödä tokeneita

Tokenien lyöminen käyttää Token Program -ohjelman _rs`MintTo`_- tai
_rs`MintToChecked`_-käskyä.

Alla olevat esimerkit käyttävät _rs`MintToChecked`_-käskyä, joka vaatii
kutsujalta mintin desimaalien toimittamisen, jotta käsky voi varmistaa odotetun
token-tarkkuuden ennen lyömistä.

[Native mint](/docs/tokens/basics/sync-native) ei tue lyömistä.

### Lähdeviite

| Kohde                 | Kuvaus                                                                                                                                          | Token Program                                                                                                 | Token Extensions Program                                                                                            |
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_            | Mint-tila tallentaa mint-valtuutuksen ja tokenien kokonaistarjonnan.                                                                            | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_         | Token-tilin tila tallentaa kohteen saldon, joka päivitetään lyömisen yhteydessä.                                                                | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`MintTo`_          | Mint-käsky, joka lyö tokeneita olemassa olevalle token-tilille ilman, että kutsuja tarvitsee toimittaa mintin desimaaleja.                      | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L159-L177) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L202-L220) |
| _rs`MintToChecked`_   | Mint-käsky, joka vaatii kutsujalta mintin desimaalien toimittamisen ja tarkistaa arvon ennen tokenien lyömistä olemassa olevalle token-tilille. | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L301-L325) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L367-L391) |
| _rs`process_mint_to`_ | Jaettu prosessorilogiikka tokenien lyömiselle.                                                                                                  | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L521-L583)     | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L981-L1067)    |
