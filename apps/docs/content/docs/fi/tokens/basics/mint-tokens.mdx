...
description: Luo uusia token-yksiköitä token-tilille mint-valtuutuksella.
...
Mintaus luo uusia yksiköitä olemassa olevasta tokenista ja kasvattaa mintin
kokonaistarjontaa.

Vain mint-valtuutus voi mintata uusia tokeneita. Kohde-token-tilin on jo oltava
olemassa ja sen on kuuluttava samaan minttiin.

## Kuinka Mintata Tokeneita

Tokenien mintaus käyttää Token Programin _rs`MintTo`_- tai
_rs`MintToChecked`_-käskyä.

Alla olevat esimerkit käyttävät _rs`MintToChecked`_-käskyä, joka edellyttää
kutsujalta mintin desimaalien toimittamista, jotta käsky voi varmistaa odotetun
token-tarkkuuden ennen mintausta.

[Native mint](/docs/tokens/basics/sync-native) ei tue mintausta.
...
| _rs`Account`_         | Token-tilin tila tallentaa kohdealdon, jota mintaus päivittää.                                                                                  | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`MintTo`_          | Mint-käsky, joka mintaa tokeneita olemassa olevalle token-tilille ilman, että kutsujan tarvitsee toimittaa mintin desimaaleja.                  | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L159-L177) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L202-L220) |
| _rs`MintToChecked`_   | Mint-käsky, joka edellyttää kutsujan toimittavan mintin desimaalit ja tarkistaa arvon ennen tokenien mintausta olemassa olevalle token-tilille. | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L301-L325) | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L367-L391) |
| _rs`process_mint_to`_ | Jaettu prosessorilogiikka tokenien mintaukseen.                                                                                                 | [Lähde](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L521-L583)     | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L981-L1067)    |

### Typescript

Alla olevat `Kit`-esimerkit näyttävät suositellun lähestymistavan käyttäen
`@solana/kit`-käskyä. Vanhat esimerkit käyttäen `@solana/web3.js`-käskyä on
