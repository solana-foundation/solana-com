...
description: Opi ottamaan käyttöön ImmutableOwner-laajennus.
---

## ImmutableOwner-laajennuksen käyttöönotto

[`ImmutableOwner`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L511)-laajennus
estää omistajuuden muutokset token accounteille. Kun token account alustetaan
tällä laajennuksella, määritetty omistaja on pysyvä eikä sitä voi siirtää
toiselle tilille.
