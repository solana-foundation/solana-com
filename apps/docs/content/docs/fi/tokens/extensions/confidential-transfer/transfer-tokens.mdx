...
sekä lähettäjällä että vastaanottajalla täytyy olla token accountit, jotka on
määritetty _rs`ConfidentialTransferAccount`_-tilalla ja hyväksytty
luottamuksellisia siirtoja varten. Lähettäjän token accountilla täytyy myös olla
...
Seuraava esimerkki siirtää tokeneita luottamuksellisesti tililtä toiselle.
Molempien tilien täytyy olla jo määritetty luottamuksellisia siirtoja varten, ja
lähettäjällä täytyy olla käytettävissä oleva luottamuksellinen saldo.
...
sitä käyttöön, mutta mainnettia haaruttava paikallinen validator, kuten
[Surfpool](https://surfpool.run), tekee niin. Suorita esimerkki jotakin näistä
vasten (koodi käyttää devnetiä) rahoitetun maksajan kanssa ja korvaa
paikkamerkit omalla mintilläsi sekä lähettäjän ja vastaanottajan tileillä.
