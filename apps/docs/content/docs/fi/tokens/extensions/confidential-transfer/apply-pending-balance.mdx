...
## Miten odottava saldo sovelletaan käytettävissä olevaan saldoon

Ennen kuin tokeneita voidaan siirtää luottamuksellisesti, julkinen token-saldo
...
luottamuksellisesti token-tilin välillä, tokenit lisätään aluksi
luottamukselliseen odottavaan saldoon. Ennen kuin tokeneita voidaan käyttää
luottamuksellisiin siirtoihin, odottava saldo on "sovellettava" käytettävissä
olevaan saldoon.
...
Odottavan saldon muuntamiseksi käytettävissä olevaksi saldoksi kutsu
...
-metodin, joka rakentaa ja lähettää transaktion `ApplyPendingBalance` -käskyllä,
...
<Callout type="info">
  Tätä kirjoitettaessa Confidential Transfers -toimintoa ei ole otettu käyttöön
