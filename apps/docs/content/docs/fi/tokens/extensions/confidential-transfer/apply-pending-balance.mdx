...
sitä käyttöön, mutta mainnet-haarukoiva paikallinen validator, kuten
[Surfpool](https://surfpool.run), ottaa. Suorita esimerkki jompaakumpaa vasten
(koodi käyttää devnetiä) rahoitetulla maksajalla ja korvaa paikkamerkkimintit ja
