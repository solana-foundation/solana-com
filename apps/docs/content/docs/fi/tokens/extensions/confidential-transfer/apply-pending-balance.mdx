...
`spl_token_client`-crate tarjoaa
`confidential_transfer_apply_pending_balance`-metodin, joka rakentaa ja lähettää
transaktion `ApplyPendingBalance`-käskyllä, kuten alla olevassa esimerkissä
esitetään.
