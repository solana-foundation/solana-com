...
Sinulla täytyy olla Solana CLI asennettuna käyttääksesi paikallista
validaattoria.
...
| _rs`EmptyAccount`_                  | Tyhjentää odottavat ja käytettävissä olevat luottamukselliset saldot, jotta token accountin sulkeminen on mahdollista.                                                     |
...
| _rs`EnableConfidentialCredits`_     | Sallii token accountin vastaanottaa luottamuksellisia token-siirtoja.                                                                                                      |
| _rs`DisableConfidentialCredits`_    | Estää saapuvat luottamukselliset siirrot, mutta sallii edelleen julkiset siirrot.                                                                                          |
| _rs`EnableNonConfidentialCredits`_  | Sallii token accountin vastaanottaa julkisia token-siirtoja.                                                                                                               |
| _rs`DisableNonConfidentialCredits`_ | Estää tavalliset siirrot, jotta account vastaanottaa vain luottamuksellisia siirtoja.                                                                                      |
| _rs`TransferWithFee`_               | Siirtää tokeneita token accountien välillä luottamuksellisesti maksun kanssa.                                                                                              |
| _rs`ConfigureAccountWithRegistry`_  | Vaihtoehtoinen tapa määrittää token accountit luottamuksellisia siirtoja varten käyttämällä _rs`ElGamalRegistry`_ -accountia _rs`VerifyPubkeyValidity`_ -todisteen sijaan. |
