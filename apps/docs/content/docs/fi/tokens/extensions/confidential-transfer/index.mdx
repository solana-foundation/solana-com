...
<Cards>
  ...
  >
    Kuinka siirtää odottava saldo käytettävissä olevaan luottamukselliseen
    saldoon
  </Card>
  <Card
  ...
  >
    Kuinka siirtää tokeneita luottamuksellisesti token accounts -tilien välillä
  </Card>
  <Card
    title="Liikkeeseenlaskijan opas"
    href="/docs/tokens/extensions/confidential-transfer/issuer-guide"
  >
    Kuinka laskea liikkeelle ja hallinnoida luottamuksellista siirto-tokenia
    (hyväksymiskäytäntö, tarkastajat, maksut, luonti ja poltto)
  </Card>
</Cards>
