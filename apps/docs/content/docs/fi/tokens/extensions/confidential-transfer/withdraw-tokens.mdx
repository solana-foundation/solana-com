...
Seuraava esimerkki nostaa tokenit luottamuksellisesta käytettävissä olevasta
saldosta takaisin julkiseen saldoon. Tilin täytyy olla jo määritetty
luottamuksellisia siirtoja varten ja sen täytyy sisältää käytettävissä oleva
luottamuksellinen saldo.
...
[Surfpool](https://surfpool.run), ottaa. Aja esimerkki jotakin näistä vasten
(koodi käyttää devnettiä) rahoitetulla maksajalla ja korvaa paikanvaraukset
omalla mintilläsi ja token account -tililläsi.
