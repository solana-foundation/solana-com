...
määrittää mintin ryhmämintiksi (kuten kokoelma-NFT) osoittamalla tiliin, joka
sisältää
[ryhmäkonfiguraatiot](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16),
kuten päivitysvaltuutuksen ja enimmäiskoon.
...
määrittää mintin jäsenmintiksi (kuten NFT kokoelmassa) osoittamalla tiliin, joka
sisältää
[jäsenyysdatan](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67),
kuten ryhmäosoitteen ja jäsennumeron.
