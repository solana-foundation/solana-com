...
-tilillä. Tässä on esimerkki siitä, miten luodaan token, jossa Skaalatun
...
`update-ui-amount-multiplier` -komentoa. Aikaleima, sekunteina Unix epochista,
on valinnainen ja sitä voidaan käyttää asettamaan mukautettu aloitusaika uudelle
