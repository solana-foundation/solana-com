...
mahdollistaa koron asettamisen suoraan mint accountille. Korko kasvaa jatkuvasti
verkon aikaleiman perusteella, mutta varsinainen token-saldo, joka on
tallennettu kuhunkin token accountiin, pysyy muuttumattomana. Kokonaisarvo
(token-saldo plus kertynyt korko) on vain laskelma. Tällä laajennuksella ei
