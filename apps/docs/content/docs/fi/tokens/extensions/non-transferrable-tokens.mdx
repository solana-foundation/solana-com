...
estää tokenien siirtämisen token-tilien välillä lyönnin jälkeen. Kerran lyötyinä
tokenit pysyvät pysyvästi token-tilillä. Token-tilin omistaja voi kuitenkin
edelleen polttaa tokeneita ja sulkea token-tilin, kun saldo saavuttaa nollan.
