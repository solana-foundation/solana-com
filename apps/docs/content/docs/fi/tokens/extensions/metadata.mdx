...
mahdollistaa mint-tilin määrittää sen metadata-tilin osoitteen. Tämä osoitin voi
viitata mihin tahansa tiliin, jonka omistaa ohjelma, joka toteuttaa
[Token Metadata Interface](https://github.com/solana-program/token-metadata/tree/main)
-rajapinnan, tarjoten joustavuutta metadatan tallennuspaikkaan.
