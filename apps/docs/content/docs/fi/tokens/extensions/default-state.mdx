...
asettaa oletustilan kaikille uusille token-tileille, jotka luodaan mintille. Kun
tämä laajennus on käytössä, se alustaa automaattisesti jokaisen uuden
token-tilin määritetyllä tilalla, kuten jäädytettynä. Tämän avulla tokenin
luojat voivat pakottaa tiettyjä toimintoja, kuten vaatia, että kaikki uudet
tilit ovat oletuksena jäädytettyjä, kunnes ne erikseen vapautetaan.
