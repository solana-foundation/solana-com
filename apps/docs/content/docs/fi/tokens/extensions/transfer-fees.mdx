...
mahdollistaa automaattisen maksujen keräämisen jokaisessa token-siirrossa.
Maksut kertyvät vastaanottajan token-tileille, ja ne voi nostaa
nostovaltuutettu, joka on asetettu mint-tilille.
