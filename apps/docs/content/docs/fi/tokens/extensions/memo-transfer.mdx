...
vaatii, että kaikki saapuvat token-siirrot sisältävät muistion, kun se on otettu
käyttöön token-tilillä. Tilin omistaja voi ottaa tämän laajennuksen käyttöön tai
