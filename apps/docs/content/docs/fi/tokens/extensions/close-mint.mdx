...
[`MintCloseAuthority`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L569)-laajennus
mahdollistaa mint-tilien sulkemisen ja niiden vuokran takaisin saamisen. Tämä
laajennus on alustettava mintin luomisen yhteydessä.
