...
Solana-transaktioilla on kokorajoitus (~1232 tavua). Jokainen siirtoinstruktiо
lisää ~200 tavua. Hyvin suurissa moniosapuolisissa selvityksissä harkitse
[Address Lookup Tables](/developers/cookbook/transactions/lookup-tables) -taulukoiden käyttöä
tilitietojen pakkaamiseen, jotta useampia siirtoja mahtuu yhteen transaktioon.

Tuleva
[v1-transaktioformaatti](/docs/core/transactions/versioned-transactions#v1-message-format)
nostaa rajan 4096 tavuun, mutta poistaa Address Lookup Table -tuen, joten v1-selvitykset
sisällyttävät osoitteet suoraan. Joka tapauksessa ajonaikainen ympäristö lataa
enintään 64 tiliä per transaktio.
