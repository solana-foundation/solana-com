...
seoTitle: Solana-lompakon integrointi Next.js:n ja @solana/react-hooksin kanssa
description:
  Määritä Solana-lompakon integrointi Next.js:ssä @solana/clientin ja
  @solana/react-hooksin avulla SOL-siirtojen lähettämiseksi.
---
...
- [Framework Kit -repositorio](https://github.com/solana-foundation/framework-kit)
...
voivat käyttää lompakon tilaa ja hookeja.

## !!steps 3. Lompakon yhdistämispainike
...
![Lompakkoalasvalikko vaihtoehdot](/assets/docs/frontend/02-wallet-dropdown-options.webp)

![Lompakkoalasvalikko yhdistetty](/assets/docs/frontend/03-wallet-dropdown-connected.webp)
...
Liittimet ovat sama Wallet Standard -joukko
(Phantom/Solflare/Backpack/automaattinen löytäminen); yhdistämisen jälkeen
SOL-siirrot käyttävät yhdistettyä allekirjoittajaa.
