...
<Callout type="info">
  Ajetaanko headless-tilassa — API-reitissä, workerissa tai skriptissä ilman
  selainlompakkoa? Allekirjoita taustajärjestelmän avaintenhallinnan avulla
  raaka keypair:n sijaan. Katso [Keychain](/docs/tools/keychain) ja
  [Allekirjoittaminen
...
- **Headless-tilakoneet**: Aja asiakas API-reiteissä, skripteissä tai
  workereissa käyttääksesi uudelleen samaa lompakko- ja
  RPC-orkestrointilogiikkaa, joka toimii käyttöliittymäsi pohjana.
- **Reaaliaikaiset koontinäytöt**: Yhdistä tarkkailijat (saldot, tilit,
  allekirjoitukset) haluamasi käyttöliittymäkirjaston kanssa; asiakas hoitaa
  websocket-jakelun ja välimuistin mitätöinnin.
- **Mukautetut tallennukset**: Injektoi oma Zustand-tallennuksesi
  hydratoidaksesi IndexedDB:stä tai localStoragesta, peilataksesi tilan
  palvelinistuntoihin tai koordinoidaksesi selaimen välilehtien välillä.
- **Silta React-hookeille**: Välitä konfiguroitu asiakasinstanssi
  `@solana/react-hooks`:lle, kun haluat ergonomiset hookit saman
  suoritusympäristön päälle.
- **Testattavuus**: Yksittäinen asiakasrajapinta voidaan simuloida
  yksikkötesteissä, jolloin RPC-vastausten tai lompakkoistuntojen simulointi
  onnistuu ilman selainlompakkoa.
