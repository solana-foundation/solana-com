...
4. **Olemattomia tilejä**: Tilit, joita ei ole olemassa lohkoketjussa, ladataan
   oletustileinä (0 lamport, tyhjä data, System Program omistaa)
   `rent_epoch`-arvon ollessa `u64::MAX`.
