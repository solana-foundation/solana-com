...
title: PDA-tilit
description:
  Luo onchain-tilejä Solanan PDA-osoitteisiin käyttäen invoke_signed- ja
  Anchor-rajoitetta init. invoke_signed-varmennusprosessi ja Anchorin
  PDA-luontimallit koodiesimerkkeineen.
