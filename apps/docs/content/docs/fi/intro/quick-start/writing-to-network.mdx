...
Luo uusi avainpari käytettäväksi `sender` -tilillä.

### !receiver

Luo uusi avainpari käytettäväksi `receiver` -tilillä.

### !airdrop

Pyydä SOL-ilmapudotus `sender` -tilin rahoittamiseksi.
...
{/_ CODE_PLACEHOLDER_8d2da120d816b1cb2741a34e1b4dccc2 _/
