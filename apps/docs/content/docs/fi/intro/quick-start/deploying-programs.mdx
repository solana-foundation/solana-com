...
Ohjelmasi ketjussa oleva osoite. Se päivitetään, kun rakennat projektin
...
- [`declare_id!`](mention:one)-makro määrittää ohjelmasi ketjussa olevan
  osoitteen. Solana Playground päivittää tämän osoitteen automaattisesti, kun
  rakennat ohjelman.
...
<Callout>
  [Ohjelmatunnuksesi](/docs/intro/quick-start/build-first-program), joka on
  määritelty _rs`declare_id!()`_ -tiedostossa, päivitetään nyt.
</Callout>

2. Lisää SOL lompakkoosi _(Valinnainen)_

Ohjelman käyttöönotto vaatii SOL-tokeneita program account -tilillä.
Tarvittaessa
[lisää SOL-tokeneita lompakkoosi](/docs/intro/quick-start#add-sol-to-your-wallet)
ennen kuin jatkat vaiheeseen 3.
...
Sulje ohjelma palauttaaksesi ketjussa olevalle ohjelmalle varatut SOL-tokenit.
Tee tämä suorittamalla `solana program close [ProgramID]` käyttäen
_rs`declare_id!()`_-makrossa tallennettua ohjelman osoitetta.
...
[ohjelmasta johdettuihin osoitteisiin](/docs/core/pda) ja
[ohjelmien välisiin kutsuihin](/docs/core/cpi).
