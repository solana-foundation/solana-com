...
Lue dataa Solana-verkosta hakemalla eri tilejä. Tämä osio auttaa sinua
ymmärtämään Solanan [tilien](/docs/core/accounts) rakenteen. Jokaisella
Solana-tilillä on yksilöllinen [osoite](/docs/core/accounts#account-address),
jota käytetään sen vastaavan onchain-datan paikantamiseen. Tilit sisältävät joko
