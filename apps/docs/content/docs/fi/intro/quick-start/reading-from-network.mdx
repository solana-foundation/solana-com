...
Lue tietoja Solana-verkosta hakemalla eri tilejä. Tässä oppaassa
selvitetään Solana [tilien](/docs/core/accounts) rakennetta. Jokaisella Solana-
tilillä on yksilöllinen
[osoite](/docs/core/accounts/account-structure#account-address), jonka avulla tilin ketjussa olevat tiedot
paikannetaan. Solana-tilit sisältävät joko
[tilatietoja tai suoritettavan ohjelman](/docs/core/accounts/account-types).
