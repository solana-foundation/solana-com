...
[verify-ohjelman](https://explorer.solana.com/address/63XDCHrwZu3mXsw2RUFb4tbNpChuUHx4eA5aJMnHkpQQ/anchor-account)
[PDA](https://github.com/otter-sec/otter-verify).
...
luottamuksettomasti tai käyttää omaa [OtterSecin](https://github.com/otter-sec/solana-verified-programs-api)
ylläpitämää
[verify API:a](https://github.com/otter-sec), joka
...
[Solanan vahvistettujen buildien](/docs/programs/verified-builds) käyttö varmistaa ohjelmistojesi eheyden ja luotettavuuden verkossa sekä mahdollistaa kehittäjien löytää SDK:t suoraan Solana Explorerista. Hyödyntämällä työkaluja kuten Solana Verify CLI ja Docker voit ylläpitää todennettavia ja turvallisia buildeja, jotka vastaavat lähdekoodiasi. Käytä aina johdonmukaisia ympäristöjä tarvittavine varotoimineen ja harkitse hallintoratkaisuja turvallisia päivityksiä ja käyttöönottoja varten.
