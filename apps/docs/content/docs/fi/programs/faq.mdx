...
- [Rust-ohjelmien sisääntulopisteet](/docs/programs/rust#program-entrypoint)
...
- [Rust-ohjelman parametrien deserialisointi](/docs/programs/rust#parameter-deserialization)
