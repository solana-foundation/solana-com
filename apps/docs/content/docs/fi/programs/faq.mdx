...
- [Rust-ohjelmien sisääntulopisteet](https://docs.rs/solana-program-entrypoint/latest/solana_program_entrypoint/macro.entrypoint.html)
...
- [Rust-ohjelman parametrien deserialisointi](https://docs.rs/solana-program-entrypoint/latest/solana_program_entrypoint/fn.deserialize.html)
