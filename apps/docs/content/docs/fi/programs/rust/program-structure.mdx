...
description:
  Opi rakentamaan Solana-ohjelmia Rustilla, mukaan lukien sisääntulopisteet,
  tilan hallinta, käskyjen käsittely ja testaus.
...
- `processor.rs`: Määrittää käskykäsittelijät (funktiot), jotka toteuttavat
...
Havainnollistaaksemme, miten rakennetaan natiivi Rust-ohjelma useilla käskyillä,
...
<Accordions>
<Accordion title="Koko ohjelman koodi">
...
laskurin alkuarvolla ja kasvattaa sitä.
...
Jokaisella Solana-ohjelmalla on sisääntulopiste, joka on funktio, jota
kutsutaan, kun ohjelma suoritetaan. Aloitetaan lisäämällä tarvittavat importit
ohjelmaan ja määrittelemällä sisääntulopiste.
...
[Entrypoint](https://github.com/anza-xyz/solana-sdk/blob/449d97c0ed164611dae538e2ee91ca0caaaec515/program-entrypoint/src/lib.rs#L126-L140)-makro
...
## !!steps Määrittele ohjelman tila
...
## !!steps Määrittele käskyenum

Määritellään käskyt, joita ohjelmamme voi suorittaa. Käytämme enumia, jossa
jokainen variantti edustaa eri käskyä.
...
## !!steps Toteuta käskyn deserialisointi
...
## !!steps Ohjaa käskyt käsittelijöille
...
<Callout type="warn">
  Tämä ohje on vain esittelytarkoituksiin. Se ei sisällä turvallisuus- ja
  validointitarkistuksia, joita tuotanto-ohjelmissa vaaditaan.
</Callout>
...
## !!steps Toteuta kasvatuskäsittelijä
...
Onnittelut! Olet rakentanut täydellisen Solana-ohjelman, joka demonstroi
perusrakenteen, joka on yhteinen kaikille Solana-ohjelmille:

- **Entrypoint**: Määrittää, mistä ohjelman suoritus alkaa ja reitittää kaikki
  saapuvat pyynnöt asianmukaisille ohjekäsittelijöille
- **Ohjeiden käsittely**: Määrittää ohjeet ja niiden käsittelijäfunktiot
- **Tilan hallinta**: Määrittää tilidatarakenteet ja hallitsee niiden tilaa
...
Testataan nyt laskuriohjelmaamme. Käytämme
[LiteSVM](https://github.com/LiteSVM/litesvm)-testikehystä, jonka avulla voimme
testata ohjelmia ilman niiden julkaisemista klusteriin.
...
Lisätään nyt testimoduuli ohjelmaamme. Aloitetaan perusrakenteella ja
importeilla.
...
LiteSVM simuloi Solana-ajoympäristöä, jolloin voimme testata ohjelmaamme ilman
julkaisemista oikeaan klusteriin.
...
## !!steps Testaa alustusinstruktio
...
Alustuksen jälkeen varmistetaan, että laskuritili luotiin oikein odotetulla
arvolla.
...
## !!steps Testaa kasvattamisinstruktio

Testataan nyt kasvattamisinstruktio varmistaaksemme, että se päivittää
laskuriarvon oikein.
...
## !!steps Varmista lopputulokset

Lopuksi varmistetaan, että kasvattaminen toimi oikein tarkistamalla päivitetty
laskuriarvo.
...
Nyt kun ohjelmamme ja asiakkasmme ovat valmiit, rakennetaan, otetaan käyttöön ja
kutsutaan ohjelmaa.
