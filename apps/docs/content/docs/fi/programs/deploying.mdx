...
- **Ohjelmatunnus (Program ID)**: Ohjelmasi ketjussa oleva osoite. Käyttäjät
  ovat vuorovaikutuksessa ohjelmasi kanssa viittaamalla ohjelmatunnukseen.
- **program account**: Ketjussa oleva tili, joka tallentaa ohjelmasi metatiedot.
  program accountin osoite on ohjelmatunnus. program account tallentaa myös
  programdata accountin osoitteen.
- **programdata account**: Ketjussa oleva tili, joka tallentaa ohjelmasi
  käyttöönotetun suoritettavan koodin.
- **Ohjelman valtuutus (Program Authority)**: Tili, jolla on oikeus päivittää
  tai sulkea ohjelma. Oletusarvoisesti tämä on CLI-lompakkosi.
...
Ohjelmatunnus on ohjelmatilin ketjussa oleva osoite. Käyttäjät ja muut ohjelmat
...
- **`--use-rpc`**: Lähettää transaktiot määritettyyn RPC:hen. Tämä lippu vaatii
  [stake-weighted](/docs/defi/stake-weighted-qos) RPC-yhteyden palveluntarjoajilta,
  kuten [Triton](https://triton.one/) tai [Helius](https://www.helius.dev/).
