...
| **Klusteri** | **Päätepiste**                   | **Tarkoitus**                      | **Huomiot**                         |
| ------------ | -------------------------------- | ---------------------------------- | ----------------------------------- |
| Mainnet      | `https://api.mainnet.solana.com` | Tuotantoympäristö                  | Vaatii SOL-tokeneita transaktioihin |
| Devnet       | `https://api.devnet.solana.com`  | Julkinen testaus ja kehitys        | Ilmainen SOL-pudotus testaukseen    |
| Testnet      | `https://api.testnet.solana.com` | Validaattorien ja kuormitustestaus | Saattaa olla ajoittain alhaalla     |
...
- Potentiaalisten validaattorien tulisi ensin käyttää Devnetiä.
- Keskeiset erot Devnetin ja Mainnetin välillä:
  - Devnetin tokenit **eivät ole oikeita**
  - Devnet sisältää token-hanan pudotuksia varten sovellustestaukseen
  - Devnet saattaa olla altis kirjanpidon nollauksille
  - Devnet käyttää tyypillisesti samaa ohjelmistojulkaisuhaaraa kuin Mainnet
    Beta, mutta saattaa käyttää uudempaa aliversiota kuin Mainnet.
...
- Testnet saattaa olla altis kirjanpidon nollauksille.
- Testnet sisältää token-hanan pudotuksia varten sovellustestaukseen
- Testnet käyttää tyypillisesti uudempaa ohjelmistojulkaisuhaaraa kuin Devnet ja
  Mainnet
- Gossip-aloituspiste Testnetille: `entrypoint.testnet.solana.com:8001`

### Testnet-päätepiste

- `https://api.testnet.solana.com` - yksittäinen Solana Labsin API-solmu;
  nopeusrajoitettu
...
- Mainnetissä liikkeeseen lasketut tokenit ovat **oikeaa** SOL-kryptovaluuttaa
- Gossip-aloituspiste Mainnetille: `entrypoint.mainnet.solana.com:8001`

### Mainnet-päätepiste

- `https://api.mainnet.solana.com` - Solana Labsin isännöimä API-solmujen
  klusteri, jota tukee kuormantasaaja; nopeusrajoitettu
