...
<Callout type="caution" title="Älä käytä julkista RPC:tä tuotannossa">
  Julkiset päätepisteet (`api.mainnet.solana.com`, `api.devnet.solana.com`) ovat
  nopeusrajoitettuja, niillä ei ole SLA:ta, eivätkä ne sovellu tuotantotason maksuliikenteeseen.
  Käytä [RPC-palveluntarjoajaa](https://solana.com/rpc) yksityisen RPC-päätepisteen hankkimiseen
  tuotantokäyttöönottoja varten.
</Callout>
