...
| ----------- | ----------- | --------------------------------------------------- |
| `recipient` | `Address`   | Kauppiaan lompakon osoite (pakollinen)              |
| `amount`    | `bigint`    | Summa lamporteina tai tokenin pienimpinä yksikköinä |
...
| `label`     | `string`    | Lompakossa näkyvä kauppiaan nimi                    |
| `message`   | `string`    | Ennen maksua näytettävä viesti                      |
| `memo`      | `string`    | Tapahtumaan liitetty lohkoketjumuistiinpano         |
