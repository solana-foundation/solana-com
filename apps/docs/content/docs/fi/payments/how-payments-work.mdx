...
Solanassa ohjelmat ovat suoritettavaa logiikkaa, joka hallitsee tilien tilaa.
Token-tilejä hallinnoi **Token-ohjelma** – ketjussa oleva koodi, joka varmistaa
siirrot ja päivittää saldot atomaarisesti.
...
Token-2022 (tunnetaan myös nimellä "Token Extensions") lisää ominaisuuksia, kuten siirtokoukkuja,
siirtomaksuja ja luottamuksellisia saldoja. Molemmat ohjelmat toimivat samalla tavoin perus-
siirroissa, mutta oikean ohjelman käyttäminen ATA-osoitteiden johtamisessa on välttämätöntä.
...
<Callout type="info">
  Solana käyttää paikallisia maksumarkkinoita – transaktiot kilpailevat muiden transaktioiden kanssa,
  jotka kirjoittavat samaan tilaan. Tämä tarkoittaa, että maksut pysyvät alhaisina ja ennakoitavina
  myös silloin, kun verkossa on muualla runsaasti toimintaa.
</Callout>
