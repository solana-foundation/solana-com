...
- Käytä olemassa olevaa Subscription Authoritya uudelleen myöhemmissä
  delegoinneissa samalla mintillä.
- Sulje Subscription Authority vasta sen jälkeen, kun jokainen siitä riippuva
  delegointi on peruutettu tai suljettu.
