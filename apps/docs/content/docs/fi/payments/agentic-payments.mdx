...
Agenttiset maksut tarvitsevat tavan, jolla asiakkaat ja palvelimet voivat
neuvotella maksuehdoista standardin web-infrastruktuurin kautta häiritsemättä
perinteisiä web-käyttöliittymiä. Mikromaksutila on vielä alkuvaiheessa, ja uusia
työkaluja ja standardeja tulee todennäköisesti esiin alan kehittyessä.
[x402-protokolla](https://www.x402.org/) on kuitenkin noussut varhaiseksi
standardiksi vahvan ekosysteemituen myötä. x402 käyttää
...
Asiakas tekee pyynnön, vastaanottaa 402-koodin maksuehdoilla ja yrittää sitten
uudelleen allekirjoitetulla maksulla. Palvelin delegoi vahvistamisen ja
selvityksen fasilitaattorille, valinnaiselle välittäjälle, joka käsittelee
onchain-tapahtuman lähettämisen. Kun fasilitaattori vahvistaa selvityksen,
palvelin palauttaa pyydetyn sisällön. Tämä erottelu mahdollistaa sen, että
API-tarjoajat voivat vastaanottaa maksuja hallitsematta suoraan mitään
onchain-infrastruktuuria.
...
hyväksyy. Tässä koodinpätkä siitä, miten Express-palvelin konfiguroidaan
käyttäen x402-middlewarea:
...
Oppiaksesi lisää x402:sta, tutustu oppaisiimme:

<Cards>
  <Card
    title="Johdanto x402-protokollaan"
  ...
  />
  <Card
    title="Rakenna Koralla"
    href="/developers/guides/getstarted/build-a-x402-facilitator"
    description="Toteuta kaasuttomat x402-maksut Koran allekirjoitusinfrastruktuurilla."
  />
</Cards>
...
| [A2A x402](https://github.com/google-agentic-commerce/a2a-x402) | Googlen agenttienvälinen maksujärjestelmä |
