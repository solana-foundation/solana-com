...
lohkoketjutapahtuman lähettämisen. Kun fasilitaattori vahvistaa selvityksen,
palvelin palauttaa pyydetyn sisällön. Tämä erottelu mahdollistaa API-tarjoajien
hyväksyä maksuja ilman, että heidän tarvitsee hallita lohkoketjuinfrastruktuuria
suoraan.
