...
vastaanottajan token accountin luomiseksi samaan transaktioon siirron kanssa.
Tämä kuitenkin edellyttää rent-maksun suorittamista uudelle token accountille.
Koska vastaanottaja omistaa ATA:n, lähettäjä ei voi periä takaisin rentiin
maksettua SOL:ia.
