...
nostaa kokorajaksi 4096 tavua, mikä mahdollistaa noin kolme kertaa enemmän
siirtoja per transaktio. Eräajo on silti tarpeen sen lisäksi, sillä
suoritusympäristö lataa enintään 64 tiliä per transaktio muodosta riippumatta.
