...
description:
  Opi, miten maksujen sponsorointi toimii ja toteuta maksujen abstraktio Koralla.
---
...
<Cards>
  ...
  <Card title="Täydellinen transaktiodemo" href="/docs/tools/kora/guides/full-demo">
