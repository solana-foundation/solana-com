...
[Kora](/docs/products/kora) käsittelee tämän monimutkaisuuden. Se on
JSON-RPC-palvelin, joka tarjoaa maksun abstrahoinnin, joten käyttäjät eivät
koskaan tarvitse SOL:ia. Voit täysin sponsoroida maksut tai hyväksyä maksun
missä tahansa tokenissa.
...
<Cards>
  ...
  <Card title="API-viite" href="/docs/products/kora/json-rpc-api">
    JSON-RPC-metodit ja SDK-dokumentaatio.
  </Card>
  <Card title="Solmuoperaattorin opas" href="/docs/products/kora/operators">
