...
-kirjaston käyttöä—se on yhdistetty allekirjoituskirjasto, joka abstrahoi useita
avainhallinnan taustajärjestelmiä yhden rajapinnan kautta: Memory, Vault, Privy,
Turnkey, AWS KMS, Fireblocks, GCP KMS, CDP, Para, Dfns. Tämän avulla voit
kehittää paikallisesti muistissa olevilla avaimilla ja vaihtaa sitten
tuotantotason taustajärjestelmiin muuttamatta sovelluskoodia.
