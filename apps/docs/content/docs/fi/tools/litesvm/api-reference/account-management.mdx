---
title: Tilinhallinta
description: Menetelmät tilien, saldojen ja rent-maksujen hallintaan
---
...
Missä `TransactionResult` on
`Result<TransactionMetadata, FailedTransactionMetadata>`.

Rahoita tili lamport-yksiköillä. Palauttaa tapahtuman metatiedot onnistuessaan.
...
Hae tilin lamport-saldo. Palauttaa `None`, jos tiliä ei ole olemassa.
