---
title: Tapahtumat
description: Jäsennä ja varmista Anchor-tapahtumat tapahtumalokista
---

## Anchor-tapahtumien ymmärtäminen

Anchor-ohjelmat voivat lähettää tapahtumia, jotka kirjataan lokiin tapahtuman
suorituksen aikana. Nämä tapahtumat on Base64-koodattu tapahtumalokissa
etuliitteellä `Program data:`. `anchor-litesvm`-crate tarjoaa apuvälineitä
näiden tapahtumien jäsentämiseen ja varmistamiseen.
...
## Tapahtumien määrittäminen

Määritä ensin tapahtumat Anchor-ohjelmassasi:
...
### Jäsennä kaikki tietyn tyypin tapahtumat
...
## Tapahtumien varmistaminen

### Varmista, että tapahtuma lähetettiin
...
<Callout type="info">
  `assert_event_emitted` paniikkiin, jos lokista ei löydy yhtään määritetyn
  tyypin tapahtumaa tapahtumalokista.
</Callout>

### Varmista tapahtumien määrä
...
### Tarkista tapahtuman olemassaolo
...
## Manuaalinen tapahtumien jäsentäminen

Edistyneisiin käyttötapauksiin voit jäsentää tapahtumatiedot suoraan:
...
`EventError`-luettelointi tarjoaa yksityiskohtaiset virhetiedot:
...
| Virhe                 | Kuvaus                                        |
| --------------------- | --------------------------------------------- |
| `EventNotFound`       | Lokissa ei ole tapahtumaa määritettyä tyyppiä |
| `ParseError(String)`  | Tapahtumatietojen jäsentäminen epäonnistui    |
| `Base64Error`         | Base64-dekoodaus epäonnistui                  |
| `InvalidFormat`       | Tapahtumatiedoilla on virheellinen rakenne    |
| `AnchorError(String)` | Anchor-deserialisointi epäonnistui            |

## Täydellinen esimerkki

Tässä on kattava esimerkki tapahtumankäsittelyn havainnollistamiseksi:
...
<Callout type="info">
  Tapahtumat ovat erinomainen tapa varmistaa, että ohjelmasi suoritettiin oikein
  ilman, että sinun täytyy hakea ja deserialisoida tilejä. Ne ovat erityisen
  hyödyllisiä tilamuutosten seurantaan ajan myötä.
</Callout>
