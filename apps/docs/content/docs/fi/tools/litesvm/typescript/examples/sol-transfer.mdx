---
title: SOL-siirto
description: Rakenna ja lähetä SOL-siirtotransaktio LiteSVM:n avulla
---

Yksinkertaisin Solana-transaktio: siirrä SOL yhdeltä tililtä toiselle. Tämä on
hyvä ensimmäinen testi varmistaaksesi, että LiteSVM-asetuksesi toimii ennen
monimutkaisempien ohjelmien logiikan testaamista.
...
<Callout type="info">
  Lähettäjän loppusaldo on hieman alle 9 SOL transaktiomaksujen vuoksi
  (5 000 lamport per allekirjoitus).
</Callout>

Tämä kattaa yksinkertaisimman transaktiontyypin. Mukautettujen ohjelmien testaamiseksi katso
[Ohjelmien testaus](/docs/tools/litesvm/typescript/examples/program-testing). Token-siirtoja (mintit, ATA:t) varten katso
