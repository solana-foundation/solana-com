---
title: Miksi LiteSVM
description: Ymmärrä miten LiteSVM toimii ja miksi se on erilainen
---

## Yleiskatsaus

Ajattele LiteSVM:ää Solana VM:nä, joka toimii testifunktiosi sisällä. Ei
erillisenä prosessina, ei verkkopalveluna – se on vain kirjastokutsu koodissasi.
...
### 1. Kaikki on synkronista

Ei `async`, ei `await`, ei viiveitä:
...
### 4. Virheet ovat välittömiä ja selkeitä
...
<Tabs items={["Rust", "TypeScript"]} groupId="litesvm-lang">
  <Tab value="Rust">
    **[Ohjelmasi testaaminen →](/docs/tools/litesvm/testing-your-program)** Opi
    ...
    →](/docs/tools/litesvm/examples)** Tutustu kopioitaviin ratkaisuihin
    yleisiin tilanteisiin ja koko repositorion esimerkkeihin <br /> **[API-viite
    →](/docs/tools/litesvm/api-reference)** Opi kehittyneitä ominaisuuksia ja
    mukautettuja konfiguraatioita
  </Tab>
  <Tab value="TypeScript">
    **[Ohjelmasi testaaminen
    →](/docs/tools/litesvm/typescript/getting-started)** Opi testaamaan omaa
    Solana-ohjelmaasi LiteSVM:llä TypeScriptille <br /> **[Esimerkit
    →](/docs/tools/litesvm/typescript/examples)** Tutustu kopioitaviin
    ratkaisuihin yleisiin tilanteisiin <br /> **[API-viite
    →](/docs/tools/litesvm/typescript/api-reference)** Opi kehittyneitä
    ominaisuuksia ja mukautettuja konfiguraatioita
  </Tab>
</Tabs>
