...
Avaa viisi terminaalia ja suorita seuraavat komennot:
...
- Voit halutessasi määrittää mukautetun maksajan ATA-generointia varten käyttämällä
  `--fee-payer-key`-lippua.
