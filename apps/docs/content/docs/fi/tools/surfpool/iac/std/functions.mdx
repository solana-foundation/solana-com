...
description: Vakiokirjastossa saatavilla olevat apufunktiot
---

Nämä funktiot ovat käytettävissä kaikissa Runbook-kirjoissa osana
vakiokirjastoa.

## Operaattorit

Perusmatematiikan ja vertailun operaattorit:
