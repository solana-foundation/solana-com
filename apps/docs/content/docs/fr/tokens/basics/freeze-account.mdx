...
Le gel d'un token account conserve le même propriétaire, mint et solde, mais
empêche le token account de recevoir, transférer ou brûler des tokens jusqu'à ce
que le token account soit dégelé.
