...
description:
  Gelage d'un compte de jetons avec l'autorité de gel de la frappe pour bloquer
  les transferts, les destructions et les modifications de délégation.
...
jetons jusqu'à ce que le compte soit dégelé.

Un compte gelé peut toujours être fermé si le compte gelé a un solde de jetons
nul.
...
l'état du compte de jetons d'initialisé à gelé.
...
| _rs`FreezeAccount`_                 | Une instruction qui change un compte de jetons en état gelé.                                        | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L213-L228) | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L276-L291) |
