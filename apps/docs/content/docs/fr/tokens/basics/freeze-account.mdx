...
empêche tous les transferts de jetons ou destructions de jetons à partir d'un
compte de jetons spécifique. Une fois gelé, le compte ne peut plus envoyer ni
recevoir de jetons tant qu'il n'est pas dégelé. Un compte gelé peut toujours
être fermé s'il a un solde de jetons nul. Seule l'autorité de gel du mint
account du jeton peut geler les comptes. Si l'autorité de gel est révoquée
(définie sur null) sur le mint account, les jetons ne pourront jamais être
gelés.
