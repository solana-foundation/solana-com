...
description:
  Fermer un compte de jeton et retourner les lamports du compte vers un compte
  de destination.
...
La fermeture d'un compte de jeton supprime le compte et retourne les lamports de
rent du compte de jeton vers un compte de destination.

Le solde de jetons doit être à zéro avant que le compte puisse être fermé. Un
compte gelé peut toujours être fermé si son solde de jetons est à zéro. Les
comptes de jetons SOL encapsulés constituent l'exception et peuvent être fermés
avec un solde de jetons pour récupérer le SOL sous-jacent. Le propriétaire du
compte ou l'autorité de fermeture du compte signe l'instruction de fermeture.
