...
description:
  Fermez un compte de jetons et renvoyez les lamports du compte vers un compte
  de destination.
...
## Que fait la fermeture d'un compte de jetons ?

La fermeture d'un compte de jetons supprime le compte et renvoie les lamports de
loyer du compte de jetons vers un compte de destination.

Le solde de jetons doit être nul avant que le compte puisse être fermé. Un
compte gelé peut toujours être fermé si le solde de jetons du compte gelé est
nul. Les comptes de jetons SOL encapsulés constituent une exception et peuvent
être fermés avec un solde de jetons pour récupérer le SOL sous-jacent. Le
propriétaire du compte ou l'autorité de fermeture du compte signe l'instruction
de fermeture.

## Comment fermer un compte de jetons

La fermeture d'un compte de jetons utilise l'instruction _rs`CloseAccount`_ du
Token Program.
...
Token Extension Program applique des vérifications de fermeture supplémentaires
