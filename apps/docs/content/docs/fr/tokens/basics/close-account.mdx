...
description:
  Fermer un compte de jetons et retourner les lamports du compte à un compte de
  destination.
...
La fermeture d'un compte de jetons supprime le compte et retourne les lamports
de loyer du compte de jetons à un compte de destination.
...
nul. Les comptes de jetons SOL encapsulés constituent l'exception et peuvent
être fermés avec un solde de jetons pour récupérer les SOL sous-jacents. Le
