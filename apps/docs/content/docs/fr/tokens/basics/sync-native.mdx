---
title: Sync Native
description: Apprenez comment convertir du SOL natif en SOL encapsulé.
---
...
protocoles DeFi pour transférer du SOL comme un token SPL.
...
synchronise le solde d'un compte de jetons SOL encapsulés (WSOL) avec le SOL
réel (lamports) qui y est stocké. Lorsque vous transférez du SOL natif vers un
compte de jetons WSOL, le solde de jetons ne se met pas automatiquement à jour.
