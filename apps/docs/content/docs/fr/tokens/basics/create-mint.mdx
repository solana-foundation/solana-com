...
## Prochaines étapes : Ajout de métadonnées

Un mint account ne stocke que les informations de base du jeton (offre,
décimales, autorités). Pour ajouter des métadonnées lisibles par l'humain comme
un nom, un symbole et une image à votre jeton, vous avez deux options :

<Cards>
  <Card title="Metaplex Token Metadata" href="/docs/tokens/metaplex">
   Ajoutez des métadonnées en utilisant le Metaplex Token Metadata Program. Fonctionne avec le Token Program d'origine et Token-2022.
  </Card>
  ...
  <Card title="Token Extensions Metadata" href="/docs/tokens/extensions/metadata">
   ...
   Pour ajouter des métadonnées aux mint accounts créés avec le Token Program d'origine, utilisez le Metaplex Token Metadata Program.
  </Card>
</Cards>
...
Un compte mint ne stocke que les informations de base du token (offre,
décimales, autorités). Pour ajouter des métadonnées lisibles par l'humain telles
qu'un nom, un symbole et une image à votre token, vous avez deux options :

<Cards>
  <Card title="Métadonnées de token Metaplex" href="/docs/tokens/metaplex">
   Ajoutez des métadonnées en utilisant le programme Metaplex Token Metadata. Fonctionne avec le Token Program original et Token-2022.
  </Card>

  <Card title="Métadonnées des extensions de token" href="/docs/tokens/extensions/metadata">
   Utilisez l'extension de métadonnées intégrée avec Token-2022. 
   L'extension de métadonnées n'est disponible que pour les comptes mint créés avec Token-2022.
   Pour ajouter des métadonnées aux comptes mint créés avec le Token Program original, utilisez le programme Metaplex Token Metadata.
  </Card>
</Cards>
