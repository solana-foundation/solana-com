...
description:
  Autoriser une autre adresse à transférer ou brûler une quantité limitée de
  jetons depuis un token account.
...
## Qu'est-ce que l'approbation d'un délégué ?

L'approbation d'un délégué permet à une autre adresse de transférer ou de brûler
une quantité limitée de jetons depuis un token account au nom du propriétaire du
token account.

Un token account stocke un délégué actuel et un montant délégué à la fois.
L'approbation d'un nouveau délégué remplace le délégué précédent et l'allocation
sur le compte.
