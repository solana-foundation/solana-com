...
L'approbation d'un délégué permet à une autre adresse de transférer ou de brûler
un montant limité de jetons depuis un token account au nom du propriétaire du
token account.
...
Les exemples ci-dessous utilisent _rs`ApproveChecked`_, qui exige que l'appelant
fournisse le mint et les décimales afin que l'instruction puisse vérifier le
mint attendu et la précision des jetons avant de traiter l'approbation.
