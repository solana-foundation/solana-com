...
description:
  Supprimer le délégué actuel d'un compte de jetons et effacer son allocation
  déléguée restante.
...
L'instruction _rs`Revoke`_ efface les champs de délégué sur le compte de jetons
...
| _rs`process_revoke`_ | Logique de processeur partagée pour la révocation de délégué.         | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L395-L420)     | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L643-L674)     |
