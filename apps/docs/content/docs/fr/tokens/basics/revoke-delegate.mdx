...
Après la révocation, le délégué ne peut plus transférer de jetons depuis votre
compte. Pour le Token Program, seul le propriétaire du token account peut
révoquer un délégué. Pour le Token Extension Program, le propriétaire du token
account et le délégué actuel peuvent révoquer la délégation.
