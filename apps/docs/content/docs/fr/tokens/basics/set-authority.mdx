...
un compte de mint ou de jeton.

Les comptes de mint peuvent stocker une autorité de mint et une autorité de gel.
...
spécifique, et définir une autorité sur _rs`None`_ supprime définitivement le
...
Chaque appel met à jour un type d'autorité sur un compte de mint ou de jeton.
L'autorité actuelle signe la modification, et la nouvelle autorité peut être une
autre adresse ou _rs`None`_ pour révoquer définitivement l'autorité
sélectionnée.
