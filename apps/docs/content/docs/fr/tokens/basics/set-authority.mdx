...
description:
  Apprenez à définir l'autorité pour les comptes mint ou les comptes de jetons.
---

## Comprendre les autorités de jetons

### Autorités du mint account

- **Autorité de mint** : Contrôle la création de nouveaux jetons. Peut créer des
  jetons vers n'importe quel compte de jetons. Souvent révoquée après la
  création de l'offre initiale pour créer un jeton à offre fixe.
- **Autorité de gel** : Contrôle la capacité de geler et dégeler les comptes de
  jetons. Peut empêcher tout compte de jetons de transférer des jetons. Souvent
  révoquée pour garantir aux utilisateurs que leurs jetons ne peuvent pas être
  gelés.

### Autorités du token account

- **Propriétaire du compte** : A le contrôle total sur le compte de jetons. Peut
  transférer des jetons, brûler des jetons, approuver des délégués et fermer le
  compte lorsque le solde est nul.
- **Autorité de fermeture** : Peut fermer le compte de jetons lorsque son solde
  est nul. Par défaut, il s'agit du propriétaire du compte, mais peut être
  délégué à un autre compte.
...
modifie ou révoque les autorités sur les comptes mint et les comptes de jetons.
Seule l'autorité actuelle peut transférer ses permissions à une nouvelle adresse
ou les révoquer définitivement en définissant l'autorité sur null. Une fois
révoquée, l'autorité ne peut pas être restaurée.
