...
Après un dégel réussi, le compte peut à nouveau transférer, détruire et fermer
des jetons. Seule l'autorité de gel du mint peut dégeler les comptes de jetons.
...
mint et que le signataire est l'autorité de gel du mint, puis change l'état du
compte de jetons de gelé à initialisé.
...
| _rs`AccountState`_                  | Les états du compte de jetons, incluant _rs`Frozen`_ et _rs`Initialized`_.                       | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L185-L195)       | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L203-L213)       |
| _rs`ThawAccount`_                   | Une instruction qui fait passer un compte de jetons gelé à l'état initialisé.                    | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L229-L243) | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L292-L306) |
| _rs`process_toggle_freeze_account`_ | Logique de processeur partagée pour le gel et le dégel des comptes de jetons.                    | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L713-L754)     | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1293-L1341)   |
