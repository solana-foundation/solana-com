...
invocations de programmes croisés (CPI). Lorsqu'elle est activée, cette
extension garantit que les jetons ne peuvent être transférés que par des appels
directs à l'instruction de transfert du Token Extensions Program, bloquant tous
les autres programmes qui tenteraient de transférer des jetons via CPI.
