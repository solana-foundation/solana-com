...
description:
  Créez un mint du programme Token Extensions avec un taux d'intérêt onchain, mettez à jour ce taux et convertissez les montants de jetons en un montant d'interface utilisateur avec intérêts.
