---
title: Mint pausable
description: Découvrez comment activer l'extension PausableMintExtension.
---
...
Lorsqu'il est en pause, le programme Token-2022 rejette tous les transferts,
mints et burns pour ce jeton. Lorsqu'il n'est plus en pause, les opérations
normales reprennent.

Il s'agit d'un modèle courant dans les systèmes de jetons blockchain et la
finance traditionnelle, où la capacité de geler l'activité est nécessaire pour
la conformité, la réponse aux incidents ou le contrôle administratif.
