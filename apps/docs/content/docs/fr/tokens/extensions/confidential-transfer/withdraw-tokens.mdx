...
L'exemple suivant retire des tokens du solde disponible confidentiel pour les
reverser dans le solde public. Le compte doit déjà être configuré pour les
transferts confidentiels et détenir un solde confidentiel disponible.
...
code utilise le devnet) avec un payeur financé, et remplacez les espaces
réservés par votre mint et votre token account.
