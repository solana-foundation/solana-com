...
description:
  Apprenez à transférer des jetons de manière privée d'un compte de jetons à un
  autre.
---
...
autre, l'expéditeur et le destinataire doivent tous deux disposer de token
accounts configurés avec l'état _rs`ConfidentialTransferAccount`_ et approuvés
pour les transferts confidentiels. Le token account de l'expéditeur doit
également disposer d'un solde confidentiel disponible à transférer.
...
L'exemple suivant transfère des tokens de manière confidentielle d'un compte à
un autre. Les deux comptes doivent déjà être configurés pour les transferts
confidentiels, et l'expéditeur doit disposer d'un solde confidentiel disponible.
...
mainnet tel que [Surfpool](https://surfpool.run) le fait. Exécutez l'exemple sur
l'un d'eux (le code utilise le devnet) avec un payer financé, et remplacez les
espaces réservés par votre mint ainsi que les comptes de l'expéditeur et du
destinataire.
