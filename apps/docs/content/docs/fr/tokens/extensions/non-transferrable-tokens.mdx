...
empêche les tokens d'être transférés entre les comptes de tokens après la
création. Une fois créés, les tokens restent définitivement dans le compte de
tokens. Cependant, le propriétaire du compte de tokens peut toujours brûler les
tokens et fermer le compte de tokens lorsque le solde atteint zéro.
