...
description:
  Comment les concepts de @solana/web3.js et de wallet-adapter s'appliquent à @solana/kit.
---
...
<Callout type="warn" title="Transactions v1 et web3.js v1">
  web3.js v1 lit le [format de transaction
  v1](/docs/core/transactions/versioned-transactions#v1-message-format) à partir de
