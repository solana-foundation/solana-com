...
signez avec la paire de clés du délégué au lieu du propriétaire :
...
| --------------------- | -------------------------------- | --------------------------------------- |
| Propriété des tokens  | L'utilisateur conserve           | L'utilisateur transfère au dépositaire  |
...
| -------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| [Approve Delegate](/docs/tokens/basics/approve-delegate) | Comment accorder à un autre compte la permission de dépenser depuis votre token account. |
| [Revoke Delegate](/docs/tokens/basics/revoke-delegate)   | Comment supprimer un délégué existant et révoquer ses permissions de dépense.            |
| [Transfer Token](/docs/tokens/basics/transfer-tokens)    | Comment transférer des tokens entre token accounts.                                      |
