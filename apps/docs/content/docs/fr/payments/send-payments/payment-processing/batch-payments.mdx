...
description: Découvrez comment payer plusieurs destinataires en une seule transaction.
---
...
porte la limite de taille à 4 096 octets, ce qui permet d'inclure environ trois fois plus de
virements par transaction. Le regroupement reste nécessaire au-delà de cette limite, car le
runtime charge au maximum 64 comptes par transaction, quel que soit le format.
