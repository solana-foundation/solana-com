...
[Kora](/docs/products/kora) gère cette complexité. C'est un serveur JSON-RPC qui
fournit une abstraction des frais afin que les utilisateurs n'aient jamais
besoin de SOL. Vous pouvez entièrement sponsoriser les frais ou accepter le
paiement des frais dans n'importe quel token.
...
<Cards>
  ...
  <Card title="Référence API" href="/docs/products/kora/json-rpc-api">
