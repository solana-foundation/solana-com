...
description:
  Découvrez comment fonctionne le parrainage des frais et implémentez l'abstraction des frais avec Kora.
---
...
<Cards>
  ...
  <Card title="Démo de transaction complète" href="/docs/tools/kora/guides/full-demo">
