...
Le programme de mémo de Solana vous permet de joindre des numéros de facture,
des identifiants de commande ou des références personnalisées à n'importe quel
paiement. Ces mémos sont enregistrés de manière permanente on-chain et visibles
dans les journaux de transaction, ce qui facilite la correspondance des
paiements avec vos systèmes internes.
