...
description: Concepts fondamentaux pour envoyer et recevoir des paiements sur Solana
---
...
comptes. Les comptes de jetons sont gérés par un **Programme de jetons** — le
code onchain qui vérifie les transferts et met à jour les soldes de manière
atomique.
...
Token-2022 (également appelé "Token Extensions") ajoute des fonctionnalités telles que les hooks de transfert,
les frais de transfert et les soldes confidentiels. Les deux programmes fonctionnent de manière similaire pour les transferts de base,
mais vous devez utiliser le bon lorsque vous dérivez des ATA.
...
<Callout type="info">
  Solana utilise des marchés de frais locaux — les transactions sont en concurrence avec d'autres transactions
  qui écrivent dans le même état. Cela signifie que les frais de paiement restent bas et prévisibles
  même pendant les périodes de forte activité réseau ailleurs.
</Callout>
...
<Cards>
  ...
  <Card title="Envoyez votre premier paiement" href="/docs/payments/send-payments">
