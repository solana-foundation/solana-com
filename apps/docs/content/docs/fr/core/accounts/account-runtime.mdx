...
4. **Comptes inexistants** : Les comptes qui n'existent pas onchain sont chargés
   en tant que comptes par défaut (0 lamport, données vides, détenus par System
   Program) avec `rent_epoch` défini sur `u64::MAX`.
