---
title: Transfert SOL
description: Créez et envoyez une transaction de transfert SOL avec litesvm-go
---
...
Ceci couvre le type de transaction le plus simple. Pour tester avec des programmes personnalisés, consultez
[Tests de programmes](/docs/tools/litesvm/go/examples/program-testing). Pour
la logique dépendante du temps, consultez
[Tests temporels](/docs/tools/litesvm/go/examples/time-based).
