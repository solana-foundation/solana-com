...
description: Méthodes pour gérer les comptes, les soldes et le rent
---
...
Où `TransactionResult` est
`Result<TransactionMetadata, FailedTransactionMetadata>`.

Alimenter un compte en lamport. Retourne les métadonnées de la transaction en
cas de succès.
...
Définir directement l'état du compte.
...
Obtenir le solde en lamport du compte. Retourne `None` si le compte n'existe
pas.
...
### Inspection de l'état du compte
