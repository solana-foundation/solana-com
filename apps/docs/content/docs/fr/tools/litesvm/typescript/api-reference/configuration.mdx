...
LiteSVM utilise un patron de construction pour la configuration. Toutes les méthodes retournent `LiteSVM`
pour le chaînage.
...
<Callout type="info">
  Désactiver la vérification des signatures rend les tests plus rapides mais moins réalistes.
</Callout>
...
Activer ou désactiver la vérification d'expiration du blockhash.
...
Configurer l'ensemble de fonctionnalités pour tester des versions spécifiques de Solana.
