...
description: Fonctions utilitaires disponibles dans la bibliothèque standard
---

Ces fonctions sont disponibles dans tous les Runbooks dans le cadre de la
bibliothèque standard.

## Opérateurs

Opérateurs mathématiques et de comparaison de base :
