...
- [Points d'entrée des programmes Rust](https://docs.rs/solana-program-entrypoint/latest/solana_program_entrypoint/macro.entrypoint.html)
...
- [Désérialisation des paramètres de programme Rust](https://docs.rs/solana-program-entrypoint/latest/solana_program_entrypoint/fn.deserialize.html)
