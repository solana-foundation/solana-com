...
L'utilisation de [builds vérifiés sur Solana](/docs/programs/verified-builds) garantit l'intégrité et la fiabilité de vos programmes sur le réseau, et permet aux développeurs de trouver vos SDK directement depuis un Solana Explorer. En tirant parti d'outils tels que le Solana Verify CLI et Docker, vous pouvez maintenir des builds vérifiables et sécurisés qui correspondent à votre code source. Prenez toujours les précautions nécessaires pour utiliser des environnements cohérents, et envisagez des solutions de gouvernance pour des mises à jour et des déploiements sécurisés.
