...
Solana-Transaktionen haben eine Größenbeschränkung (~1232 Bytes). Jede Transfer- Anweisungen fügt ~200 Bytes hinzu. Für sehr große mehrseitige Abwicklungen sollten Sie [Address Lookup Tables](/developers/cookbook/transactions/lookup-tables) verwenden, um Kontenadressen zu komprimieren und mehr Übertragungen pro Transaktion zu ermöglichen.
