...
Signatur für das [Fee-Konten](#fee-account) haben. Daher kann die erste Signatur
in der Transaktion als [Transaktions-ID](#transaction-id) behandelt werden
...
Slots, erhöht nicht die [Block-Höhe](#block-height) und lässt nicht die älteste
