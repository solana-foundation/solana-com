...
- **Programm-ID**: Die Onchain-Adresse Ihres Programms. Benutzer interagieren
  mit Ihrem Programm, indem sie die Programm-ID referenzieren.
- **Program Account**: Das Onchain-Konto, das die Metadaten Ihres Programms
  speichert. Die Adresse des Program Accounts ist die Programm-ID. Das Program
  Account speichert auch die Adresse des ProgramData Accounts.
- **ProgramData Account**: Das Onchain-Konto, das den bereitgestellten
  ausführbaren Code Ihres Programms speichert.
- **Programmberechtigung**: Das Konto, das die Erlaubnis hat, das Programm zu
  aktualisieren oder zu schließen. Standardmäßig ist dies Ihr CLI-Wallet.
...
Die Programm-ID ist die Onchain-Adresse Ihres Program Accounts. Benutzer und
...
- **`--use-rpc`**: Sendet Transaktionen an den konfigurierten RPC. Dieses Flag erfordert eine
  [stake-gewichtete](/docs/defi/stake-weighted-qos) RPC-Verbindung von Anbietern
  wie [Triton](https://triton.one/) oder [Helius](https://www.helius.dev/).
