...
Die Verwendung von [verifizierten Builds auf Solana](/docs/programs/verified-builds) gewährleistet die
Integrität und Vertrauenswürdigkeit Ihrer Programme im Netzwerk und ermöglicht es
Entwicklern, Ihre SDKs direkt über einen Solana Explorer zu finden. Durch den Einsatz
von Tools wie der Solana Verify CLI und Docker können Sie verifizierbare und
sichere Builds pflegen, die mit Ihrem Quellcode übereinstimmen. Treffen Sie stets die
erforderlichen Vorkehrungen für konsistente Umgebungen und ziehen Sie Governance-Lösungen
für sichere Upgrades und Deployments in Betracht.
