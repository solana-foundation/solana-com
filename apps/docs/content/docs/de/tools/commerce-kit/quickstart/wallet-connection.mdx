...
Das Paket `@solana-commerce/connector` bietet eine Headless-Wallet-Verbindung,
die auf dem
[Wallet Standard](https://github.com/wallet-standard/wallet-standard) aufbaut. Es
verwaltet die Wallet-Erkennung, den Verbindungsstatus, die Kontenverwaltung und die automatische
Wiederverbindung. Das Paket ist framework-agnostisch konzipiert und enthält React-
Bindings. Es ist für die nahtlose Verwendung im Solana Commerce Kit optimiert und
kompatibel mit [@solana/kit](https://github.com/anza-xyz/kit).
