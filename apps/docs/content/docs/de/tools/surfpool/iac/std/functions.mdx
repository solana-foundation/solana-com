...
description: Hilfsfunktionen der Standardbibliothek
---

Diese Funktionen sind in allen Runbooks als Teil der Standardbibliothek
verfügbar.

## Operatoren

Grundlegende mathematische und Vergleichsoperatoren:
