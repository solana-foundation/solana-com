...
description:
  Wählen Sie ein Keychain-Signing-Backend basierend auf Ihren Anforderungen — Verwahrung, bestehende Infrastruktur, Genehmigungskontrollen und ob Sie für Ihre eigene App signieren oder Wallets für Endnutzer bereitstellen.
related:
...
Compliance-Workflow durchlaufen müssen, bevor sie erzeugt werden — oder Sie einen
regulierten Verwahrer benötigen, der die Schlüssel hält — verwenden Sie ein
**MPC / institutionelles Custody**-Backend: Fireblocks, Dfns, Para, Utila oder
Fordefi. Diese teilen oder verwahren den Schlüssel und co-signieren gemäß Ihrer
Richtlinie.
...
- **Cloud KMS / HSM** — ein Cloud-Anbieter speichert den Schlüssel in
  ...
  **GCP KMS**.
- **MPC & institutionelles Custody** — der Schlüssel wird aufgeteilt oder bei einem
  Anbieter verwahrt, der gemäß Ihrer Richtlinie co-signiert (Genehmigungen, Limits).
...
| Fordefi         | MPC / institutionelle Verwahrung  | Institutionelle Verwahrung mit Richtlinienkontrollen | Im nativen Modus wird automatisch übertragen; im Black-Box-Modus senden Sie selbst |
