...
## Erstellen benutzerdefinierter Signer

Implementieren Sie die `SolanaSigner`-Schnittstelle, um benutzerdefinierte
Signer zu erstellen:
...
weitere Schlüsselverwaltungsdienste zu integrieren.
