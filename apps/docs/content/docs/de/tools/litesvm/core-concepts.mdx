---
title: Warum LiteSVM
description: Verstehen Sie, wie LiteSVM funktioniert und was es besonders macht
---

## Übersicht

Stellen Sie sich LiteSVM als eine Solana-VM vor, die innerhalb Ihrer
Testfunktion läuft. Nicht als separater Prozess, nicht als Netzwerkdienst – es
ist einfach ein Bibliotheksaufruf in Ihrem Code.
...
### 1. Alles ist synchron

Kein `async`, kein `await`, keine Verzögerungen:
...
### 2. Direkte Zustandsmanipulation
...
### 4. Fehler sind sofort und klar erkennbar
...
<Tabs items={["Rust", "TypeScript"]} groupId="litesvm-lang">
  <Tab value="Rust">
    **[Dein Programm testen →](/docs/tools/litesvm/testing-your-program)**
    Lerne, wie du dein eigenes Solana-Programm testest <br /> **[Beispiele
    →](/docs/tools/litesvm/examples)** Sieh dir Copy-Paste-Lösungen für häufige
    Szenarien und vollständige Repository-Beispiele an <br /> **[API-Referenz
    →](/docs/tools/litesvm/api-reference)** Lerne erweiterte Funktionen und
    benutzerdefinierte Konfigurationen kennen
  </Tab>
  <Tab value="TypeScript">
    **[Dein Programm testen →](/docs/tools/litesvm/typescript/getting-started)**
    Lerne, wie du dein eigenes Solana-Programm mit LiteSVM für TypeScript
    testest <br /> **[Beispiele →](/docs/tools/litesvm/typescript/examples)**
    Sieh dir Copy-Paste-Lösungen für häufige Szenarien an <br /> **[API-Referenz
    →](/docs/tools/litesvm/typescript/api-reference)** Lerne erweiterte
