...
LiteSVM verwendet ein Builder-Muster zur Konfiguration. Alle Methoden geben `LiteSVM`
zur Verkettung zurück.
...
<Callout type="info">
  Das Deaktivieren der Signaturverifizierung macht Tests schneller, aber weniger realistisch.
</Callout>
...
Ablaufprüfung für Blockhashes aktivieren oder deaktivieren.
