---
title: SOL Transfer
description: Erstelle und sende eine SOL-Transfertransaktion mit LiteSVM
---

Die grundlegendste Solana-Transaktion: SOL von einem Konten auf ein anderes übertragen. Dies ist ein guter erster Test, um zu überprüfen, ob dein LiteSVM-Setup funktioniert, bevor du komplexere Programmlogik testest.
...
<Callout type="info">
  Das abschließende Guthaben des Absenders ist aufgrund von Transaktions-Fee leicht unter 9 SOL (5.000 lamport pro Signatur).
</Callout>

Dies behandelt den einfachsten Transaktionstyp. Für Tests mit benutzerdefinierten Programmen, siehe [Programm-Tests](/docs/tools/litesvm/typescript/examples/program-testing). Für Token-Transfers (Mints, ATAs), siehe [Token-Tests](/docs/tools/litesvm/typescript/tokens).
