...
title: Assertions
description:
  Konten-Zustände, Guthaben und Eigentümerschaft mit Assertion-Hilfsfunktionen
  überprüfen
---

## Konten-Existenz

Überprüfen Sie, ob Konten existieren oder geschlossen wurden.

### Assertion: Konten existiert
...
<Callout type="info">
  `assert_account_closed` ist erfolgreich, wenn ein Konten entweder nicht
  existiert, null lamports hat oder leere Daten enthält. Verwenden Sie dies, um
  die Bereinigung nach dem Schließen von Konten zu überprüfen.
</Callout>

## Guthaben-Assertions

SOL- und token account-Guthaben überprüfen.
...
## Konten-Eigenschaften

Konten-Eigentümerschaft und Dateneigenschaften überprüfen.

### Konten-Eigentümer prüfen
...
<Callout type="info">
  Gängige Konten-Größen: - **Mint Account**: 82 Bytes - **token account**: 165
  Bytes - **System Account**: 0 Bytes (nur lamports)
</Callout>

## Vollständiges Beispiel

Hier ist ein umfassender Test, der mehrere Assertions demonstriert:
...
## Umgang mit fehlgeschlagenen Assertions

Wenn eine Assertion fehlschlägt, wird ein Panic mit einer beschreibenden
...
<Callout type="warn">
  Assertions sind darauf ausgelegt, schnell mit klaren Fehlermeldungen zu
  scheitern. Verwende sie großzügig in deinen Tests, um Probleme frühzeitig zu
  erkennen.
</Callout>
