---
title: Transaktions-Hilfsfunktionen
description:
  Transaktionen ausführen und Ergebnisse mit umfangreichem Fehlerhandling
  analysieren
---
...
<Callout type="info">
  Die Überwachung von Compute Units ist nützlich für die Optimierung. Solana
  begrenzt Transaktionen auf 1,4 Mio. Compute Units, und eine höhere Auslastung
  kostet mehr.
</Callout>
