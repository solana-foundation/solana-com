...
"Spielen", um mit einer vorab geladenen Devnet-Wallet zu starten, und nutze die
Pfeiltasten zum Spielen. Auf dem Handy kannst du wischen, um die Kacheln zu
steuern.
...
<Cards>
  ...
  <Card title="Fees on Solana" href="/docs/core/fees">
    Kosten für Transaktionen auf Solana
  </Card>
