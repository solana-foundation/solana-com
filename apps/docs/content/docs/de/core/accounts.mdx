...
Feld werden als beliebig betrachtet, da sie jede beliebige Byte-Sequenz
enthalten können. Jedes Programm definiert die Struktur der in diesem Feld
gespeicherten Daten.
...
die `data` des Kontos ändern oder Lamports abziehen kann, wie durch die
