...
4. **Nicht existierende Konten**: Konten, die nicht onchain existieren, werden
   als Standard-Konten geladen (0 lamport, leere Daten, im Besitz des System
   Program) mit `rent_epoch` gesetzt auf `u64::MAX`.
