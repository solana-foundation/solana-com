...
Anweisung ändert oder widerruft Berechtigungen für Mints und Token-Konten. Nur
die aktuelle Berechtigung kann ihre Rechte an eine neue Adresse übertragen oder
sie dauerhaft widerrufen, indem die Berechtigung auf null gesetzt wird. Nach dem
Widerruf kann die Berechtigung nicht wiederhergestellt werden.
