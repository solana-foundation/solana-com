...
Anweisung hebt das Einfrieren auf und stellt die volle Funktionalität eines
zuvor eingefrorenen Token-Kontos wieder her. Nach dem Auftauen kann das Konto
wieder normal Token senden und empfangen. Nur die Freeze-Authority der
Token-Mint kann Konten auftauen.
