...
description:
  Entsperren Sie ein eingefrorenes Token-Konto, damit Überweisungen,
  Verbrennungen und Delegierungsänderungen wieder möglich sind.
...
## Was bewirkt das Entsperren eines Token-Kontos?

Das Entsperren ändert den Zustand eines Token-Kontos vom eingefrorenen Zustand
zurück in den initialisierten Zustand.

Nach erfolgreichem Entsperren kann das Konto wieder Token übertragen, verbrennen
und schließen. Nur die Freeze-Autorisierung des Mints kann Token-Konten
entsperren.

## So entsperren Sie ein Token-Konto

Zum Entsperren eines Token-Kontos wird die _rs`ThawAccount`_- Anweisung des
Token Program verwendet.

Die _rs`ThawAccount`_- Anweisung überprüft, dass das Token-Konto zum Mint gehört
und dass der Signer die Freeze-Autorisierung des Mints ist, und ändert dann den
Zustand des Token-Kontos von eingefroren zurück auf initialisiert.

[Native Token-Konten](/docs/tokens/basics/sync-native) unterstützen das
Entsperren nicht.
...
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                          | Der Mint-Zustand speichert die optionale Freeze-Autorisierung, die zum Entsperren von Token-Konten verwendet wird. | [Quelle](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Quelle](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`AccountState`_                  | Die Token-Konto-Zustände, einschließlich _rs`Frozen`_ und _rs`Initialized`_.                                       | [Quelle](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L185-L195)       | [Quelle](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L203-L213)       |
| _rs`ThawAccount`_                   | Eine Anweisung, die ein eingefrorenes Token-Konto zurück in den initialisierten Zustand ändert.                    | [Quelle](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L229-L243) | [Quelle](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L292-L306) |
| _rs`process_toggle_freeze_account`_ | Gemeinsame Prozessorlogik zum Einfrieren und Entsperren von Token-Konten.                                          | [Quelle](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L713-L754)     | [Quelle](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1293-L1341)   |
