...
Das Entsperren ändert den Status eines Token-Kontos vom eingefrorenen Zustand
zurück in den initialisierten Zustand.

Nach erfolgreichem Entsperren kann das Konto wieder Token übertragen, verbrennen
und schließen. Nur die Freeze-Autorität der Mint kann Token-Konten entsperren.

## So entsperren Sie ein Token-Konto

Das Entsperren eines Token-Kontos verwendet die Anweisung _rs`ThawAccount`_ des
Token Program.

Die Anweisung _rs`ThawAccount`_ überprüft, ob das Token-Konto zur Mint gehört
und ob der Signer die Freeze-Autorität der Mint ist, und ändert dann den Status
des Token-Kontos von eingefroren zurück zu initialisiert.
...
| ----------------------------------- | ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                          | Der Mint-Status speichert die optionale Freeze-Autorität zum Entsperren von Token-Konten.       | [Quelle](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Quelle](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`AccountState`_                  | Die Token-Kontostatus, einschließlich _rs`Frozen`_ und _rs`Initialized`_.                       | [Quelle](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L185-L195)       | [Quelle](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L203-L213)       |
