...
eindeutig im gesamten Solana-Ökosystem. Sie können dieses Mint auf
...
Das Erstellen eines Mint-Kontos erfordert die
...
## Nächste Schritte: Metadaten hinzufügen

Ein mint account speichert nur grundlegende Token-Informationen (Umlaufmenge,
Dezimalstellen, Berechtigungen). Um Ihrem Token menschenlesbare Metadaten wie
Name, Symbol und Bild hinzuzufügen, haben Sie zwei Möglichkeiten:

<Cards>
  <Card title="Metaplex Token Metadata" href="/docs/tokens/metaplex">
   Fügen Sie Metadaten mithilfe des Metaplex Token Metadata Program hinzu. Funktioniert sowohl mit dem ursprünglichen Token Program als auch mit Token-2022.
  </Card>
...
Ein Mint-Konten speichert nur grundlegende Token-Informationen (Angebot,
Dezimalstellen, Berechtigungen). Um für Benutzer lesbare Metadaten wie Name,
Symbol und Bild zu Ihrem Token hinzuzufügen, haben Sie zwei Optionen:

<Cards>
  <Card title="Metaplex Token Metadata" href="/docs/tokens/metaplex">
   Fügen Sie Metadaten mit dem Metaplex Token Metadata Program hinzu. Funktioniert sowohl mit dem ursprünglichen Token Program als auch mit Token-2022.
  </Card>

  <Card title="Token Extensions Metadata" href="/docs/tokens/extensions/metadata">
   Verwenden Sie die integrierte Metadaten-Erweiterung mit Token-2022. 
   Die Metadaten-Erweiterung ist nur für Mint-Konten verfügbar, die mit Token-2022 erstellt wurden.
   Um Metadaten zu Mint-Konten hinzuzufügen, die mit dem ursprünglichen Token Program erstellt wurden, verwenden Sie das Metaplex Token Metadata Program.
  </Card>
</Cards>
