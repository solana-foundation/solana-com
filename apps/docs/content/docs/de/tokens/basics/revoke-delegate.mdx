...
Konten übertragen. Beim Token Program kann nur der Besitzer des Token-Kontens
einen Delegierten widerrufen. Beim Token Extension Program können der Besitzer
des Token-Kontens und der aktuelle Delegierte die Delegierung widerrufen.
