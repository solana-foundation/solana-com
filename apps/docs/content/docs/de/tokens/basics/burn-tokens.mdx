...
description:
  Brennen Sie Token von einem Token-Konto und reduzieren Sie den Gesamtvorrat
  des Mints.
...
reduziert den Gesamtvorrat des Mints um denselben Betrag.

## So brennen Sie Token

Das Brennen von Token verwendet die _rs`Burn`_- oder _rs`BurnChecked`_-
Anweisungen des Token-Programms.

Die folgenden Beispiele verwenden _rs`BurnChecked`_, was erfordert, dass der
Aufrufer die Dezimalstellen des Mints angibt, damit die Anweisung die erwartete
Token-Genauigkeit vor dem Brennen überprüfen kann.

Der [native Mint](/docs/tokens/basics/sync-native) unterstützt kein Brennen.
Verwenden Sie stattdessen _rs`CloseAccount`_.

Der Besitzer des Token-Kontos oder ein genehmigter Delegierter signiert die
Transaktion. Im Token Extensions Program kann ein permanenter Mint-Delegierter
das Brennen ebenfalls autorisieren, wenn für den Mint die Erweiterung für
permanente Delegierte aktiviert ist.

### Quellreferenz

| Element            | Beschreibung                                                                                                                                                                            | Token Program                                                                                                  | Token Extensions Program                                                                                             |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_         | Der Mint-Status speichert den gesamten Token-Vorrat.                                                                                                                                    | [Quelle](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Quelle](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_      | Der Token-Konto-Status speichert den Token-Saldo, der durch einen Brennvorgang reduziert wird.                                                                                          | [Quelle](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Quelle](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Burn`_         | Eine Brennanweisung, die einen Token-Konto-Saldo und den Mint-Vorrat verringert, ohne dass der Aufrufer die Dezimalstellen des Mints angeben muss.                                      | [Quelle](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L178-L196) | [Quelle](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L221-L239) |
| _rs`BurnChecked`_  | Eine Brennanweisung, die erfordert, dass der Aufrufer die Dezimalstellen des Mints angibt und diesen Wert überprüft, bevor ein Token-Konto-Saldo und der Mint-Vorrat verringert werden. | [Quelle](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L326-L350) | [Quelle](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L393-L417) |
