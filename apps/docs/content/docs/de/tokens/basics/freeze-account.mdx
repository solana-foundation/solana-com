...
Das Einfrieren eines Token-Kontos behält denselben Eigentümer, Mint und Saldo
bei, verhindert jedoch, dass das Token-Konto Tokens überträgt oder verbrennt,
bis das Token-Konto wieder aufgetaut wird.
