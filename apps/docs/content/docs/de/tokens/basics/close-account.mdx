...
Anweisung schließt ein Token-Konten dauerhaft und überträgt alle verbleibenden
SOL (Miete) auf ein angegebenes Zielkonto. Der Saldo des Token-Kontens muss vor
dem Schließen null sein. Nur der Eigentümer des Token-Kontens oder die benannte
