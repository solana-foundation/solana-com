...
Das Schließen eines Token-Kontos löscht das Konto und gibt die Rent-Lamports des
Token-Kontos an ein Zielkonto zurück.

Der Token-Saldo muss null sein, bevor das Konto geschlossen werden kann. Ein
eingefrorenes Konto kann dennoch geschlossen werden, wenn der Token-Saldo des
...
signiert die Schließungsanweisung.
...
ein Zielkonto, löscht das Quellkonto und entfernt das Quellkonto. Das Token
Extensions Program wendet zusätzliche Schließungsprüfungen für bestimmte
Erweiterungen an, aber der grundlegende Schließungsablauf bleibt derselbe.
