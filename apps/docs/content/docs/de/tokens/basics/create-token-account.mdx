...
<Callout type="info">
  Beachten Sie, dass Entwickler im Quellcode ein Token-Konten als `Account` Typ
  bezeichnen. Sowohl das [Token
  ...
  teilen dieselbe Basisimplementierung für das Token-Konten.
</Callout>
...
- Token-Konten von Circle: `3emsAVdmGKERbHjmGfQ6oZ1e35dkf5iYcS6U4CPKFVaa`
- Dieses Konten enthält ausschließlich USDC-Token
- Circle kontrolliert Token über die Eigentümerberechtigung des Token-Kontens:
...
Das Erstellen eines Token-Kontens erfordert die
