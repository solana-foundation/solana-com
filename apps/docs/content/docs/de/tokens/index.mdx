...
- [Token Programs](#token-programs) enthalten die gesamte Instruktionslogik für
...
Solana sind effektiv
[Data Accounts](/docs/core/accounts/account-types#data-accounts), die einem
...
Basis-[Konto](/docs/core/accounts/account-structure#account-fields)-Typ
angegeben ist, welcher für alle token accounts das Token Program ist.
...
Es gibt zwei Möglichkeiten, um Metadaten (Name, Symbol, Bild) zu Tokens auf
Solana hinzuzufügen:

1. **[Metaplex Token Metadata](/docs/tokens/metaplex)** - Erstellt ein separates
   Metadaten-Konten, das mit Ihrem Mint verknüpft ist. Funktioniert mit dem
   ursprünglichen Token Program und Token-2022 und wird von Wallets und
   Marktplätzen umfassend unterstützt.

2. **[Token Extensions Metadata](/docs/tokens/extensions/metadata)** - Speichert
   Metadaten direkt auf dem Mint-Konten mithilfe von Token-2022. Ein neuerer
   Ansatz mit integrierter Unterstützung. Die Metadaten-Erweiterung ist nur für
   Mint-Konten verfügbar, die mit Token-2022 erstellt wurden. Um Metadaten zu
   Mint-Konten hinzuzufügen, die mit dem ursprünglichen Token Program erstellt
   wurden, verwenden Sie das Metaplex Token Metadata Program.

#### SPL Token CLI Beispiel

Das Token Extensions Program ermöglicht es Ihnen, Metadaten direkt auf dem
Mint-Konten zu speichern. Um einen Token mit der Metadaten-Erweiterung zu
erstellen:
...
Der Token-URI verweist auf Off-Chain-Metadaten. Ein Beispiel für das JSON-Format
finden Sie
...
Die Metadaten können Sie im
[Solana Explorer](https://explorer.solana.com/address/BdhzpzhTD1MFqBiwNdrRy4jFo2FHFufw3n9e8sVjJczP?cluster=devnet)
anzeigen.

Weitere Informationen finden Sie im Abschnitt
[Token Extensions](/docs/tokens/extensions/metadata). Details zum Token
Extensions Program finden Sie im Abschnitt
[Token Extensions](/docs/tokens/extensions) und in der
