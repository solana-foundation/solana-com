...
kennzeichnet einen Mint als Gruppen-Mint (wie z. B. ein Collection-NFT), indem
sie auf ein Konto verweist, das
...
wie Update-Authority und maximale Größe enthält.
...
kennzeichnet einen Mint als Mitglieds-Mint (wie z. B. ein NFT in einer
Collection), indem sie auf ein Konto verweist, das
