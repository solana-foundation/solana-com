...
description: Erfahren Sie, wie Sie die PausableMintExtension aktivieren.
---

## So aktivieren Sie die PausableExtension

Die
[`PausableExtension`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L733)
ermöglicht es einer designierten Pause-Autorität, alle Token-Aktivitäten auf
einer Prägung anzuhalten. Die Pause-Autorität kann die Prägung jederzeit
pausieren oder fortsetzen.

Im pausierten Zustand lehnt das Token-2022-Programm alle Transfers, Prägungen
und Verbrennungen für diesen Token ab. Im nicht pausierten Zustand werden die
normalen Vorgänge fortgesetzt.

Dies ist ein gängiges Muster sowohl in Blockchain-Token-Systemen als auch in der
traditionellen Finanzwelt, wo die Möglichkeit, Aktivitäten einzufrieren, für
Compliance, Vorfallreaktion oder administrative Kontrolle erforderlich ist.
