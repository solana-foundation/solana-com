...
## So aktivieren Sie die ImmutableOwner-Erweiterung
...
Erweiterung verhindert Eigentumsänderungen für Token-Konten. Wenn ein
Token-Konto mit dieser Erweiterung initialisiert wird, ist der festgelegte
Eigentümer dauerhaft und kann nicht auf ein anderes Konto übertragen werden.
