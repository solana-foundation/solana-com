...
zusätzlichen Zustand zu einem Mint oder Token-Konto hinzufügt. Alle
erweiterungsspezifischen Zustände werden im
...
Feld gespeichert, das auf den Basis-Kontendatentyp folgt. Sie müssen das
