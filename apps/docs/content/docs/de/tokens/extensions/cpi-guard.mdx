...
schützt Token-Konten vor unerwarteten Transfers durch Cross Program Invocations
(CPIs). Wenn aktiviert, stellt diese Erweiterung sicher, dass Token nur durch
direkte Aufrufe der Transfer-Anweisung des Token Extensions Program übertragen
werden können, und blockiert alle anderen Programme daran, Token über CPI zu
übertragen.
