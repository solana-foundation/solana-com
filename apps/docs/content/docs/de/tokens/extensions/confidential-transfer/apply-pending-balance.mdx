...
description:
  Erfahren Sie, wie Sie den ausstehenden Saldo anwenden, um Guthaben verfügbar
  zu machen.
---
...
das auf Mainnet und Devnet aktiviert ist. Ein standardmäßiger
`solana-test-validator` aktiviert es nicht, aber ein Mainnet-forkender lokaler
Validatoren wie [Surfpool](https://surfpool.run) schon. Führen Sie das Beispiel
