...
Vertrauliche Übertragungen sind abhängig vom ZK ElGamal Proof-Programm, das im
Mainnet und Devnet aktiviert ist. Ein Standard-`solana-test-validator` aktiviert
es nicht, jedoch ein Mainnet-forkender lokaler Validatoren wie
...
ersetzen Sie die Platzhalter für Mint- und Konten-Adressen durch Ihre eigenen.
