...
Konten zu übertragen, ohne den Transferbetrag offenzulegen.
...
<Cards>
  ...
  >
    So geben Sie einen vertraulichen Transfer-Token aus und betreiben ihn
...
| _rs`UpdateMint`_                    | Aktualisiert die Einstellungen für vertrauliche Transfers eines Mint.                                                                                                                       |
