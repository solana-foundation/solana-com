...
| ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`InitializeMint`_                | Richtet ein Mint-Konten für vertrauliche Transfers ein. Diese Anweisung muss in derselben Transaktion wie die Anweisung _rs`TokenInstruction::InitializeMint`_ enthalten sein.                 |
| _rs`UpdateMint`_                    | Aktualisiert die Einstellungen für vertrauliche Transfers eines Mint-Kontens.                                                                                                                  |
| _rs`ConfigureAccount`_              | Richtet ein Token-Konten für vertrauliche Transfers ein.                                                                                                                                       |
| _rs`ApproveAccount`_                | Genehmigt ein Token-Konten für vertrauliche Transfers, wenn das Mint-Konten eine Genehmigung für neue Token-Konten erfordert.                                                                  |
| _rs`EmptyAccount`_                  | Leert die ausstehenden und verfügbaren vertraulichen Guthaben, um das Schließen eines Token-Kontens zu ermöglichen.                                                                            |
...
| _rs`Transfer`_                      | Überträgt Token zwischen Token-Konten vertraulich.                                                                                                                                             |
| _rs`ApplyPendingBalance`_           | Wandelt ausstehendes Guthaben nach Einzahlungen oder Transfers in verfügbares Guthaben um.                                                                                                     |
| _rs`EnableConfidentialCredits`_     | Ermöglicht einem Token-Konten den Empfang vertraulicher Token-Transfers.                                                                                                                       |
...
| _rs`EnableNonConfidentialCredits`_  | Ermöglicht einem Token-Konten den Empfang öffentlicher Token-Transfers.                                                                                                                        |
| _rs`DisableNonConfidentialCredits`_ | Blockiert reguläre Transfers, sodass das Konten nur vertrauliche Transfers empfangen kann.                                                                                                     |
| _rs`TransferWithFee`_               | Überträgt Token zwischen Token-Konten vertraulich mit einer Gebühr.                                                                                                                            |
| _rs`ConfigureAccountWithRegistry`_  | Alternative Möglichkeit, Token-Konten für vertrauliche Transfers zu konfigurieren, indem ein _rs`ElGamalRegistry`_-Konten anstelle eines _rs`VerifyPubkeyValidity`_-Nachweises verwendet wird. |
