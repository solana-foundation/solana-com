...
<Cards>
  ...
  >
    So wenden Sie den ausstehenden Saldo auf das verfügbare vertrauliche
    Guthaben an
  </Card>
  <Card
    title="Token abheben"
  ...
  >
    So heben Sie Token vom verfügbaren vertraulichen Guthaben ab
  </Card>
  <Card
  ...
  <Card
    title="Herausgeberleitfaden"
    href="/docs/tokens/extensions/confidential-transfer/issuer-guide"
  >
    So geben Sie einen Confidential Transfer-Token aus und betreiben ihn
