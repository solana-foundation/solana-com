...
Das folgende Beispiel überträgt Token vertraulich von einem Konten auf ein
anderes. Beide Konten müssen bereits für vertrauliche Transfers konfiguriert
sein, und der Absender muss ein verfügbares vertrauliches Guthaben haben.
