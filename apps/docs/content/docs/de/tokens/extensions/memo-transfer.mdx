...
erfordert, dass alle eingehenden Token-Transfers ein begleitendes Memo
enthalten, wenn sie auf einem Token-Konten aktiviert ist. Diese Erweiterung kann
vom Besitzer des Token-Kontens aktiviert oder deaktiviert werden.
