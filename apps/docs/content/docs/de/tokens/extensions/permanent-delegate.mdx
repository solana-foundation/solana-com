...
weist einen Delegierten mit Befugnis über alle Token-Konten für einen Mint zu.
Im Gegensatz zu regulären Delegierten, die Token-Konten-Besitzer widerrufen
können, kann ein permanenter Delegierter nicht von Token-Konten-Besitzern
geändert oder entfernt werden. Der permanente Delegierte kann Token in jedem
Token-Konto dieses Mints übertragen oder verbrennen. Die Rolle des permanenten
Delegierten kann vom aktuellen permanenten Delegierten auf ein neues Konto
geändert werden.
