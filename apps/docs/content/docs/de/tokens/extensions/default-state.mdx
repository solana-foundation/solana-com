...
legt einen Standardzustand für alle neuen Token-Konten fest, die für einen Mint
erstellt werden. Wenn diese Erweiterung aktiviert ist, initialisiert sie
automatisch jedes neue Token-Konto mit einem bestimmten Zustand, wie z. B.
eingefroren. Dies ermöglicht es Token-Erstellern, bestimmte Verhaltensweisen zu
erzwingen, wie z. B. die Anforderung, dass alle neuen Konten standardmäßig
eingefroren sind, bis sie explizit aufgetaut werden.
