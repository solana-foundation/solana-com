...
description:
  Erstellen Sie eine Token Extensions Program-Mint mit einem Onchain-Zinssatz,
  aktualisieren Sie diesen Zinssatz und konvertieren Sie Token-Beträge in einen
  UI-Betrag mit Zinsen.
...
<Callout
  type="info"
  title="Offchain- und Onchain-Konvertierung von UI-Beträgen"
>
