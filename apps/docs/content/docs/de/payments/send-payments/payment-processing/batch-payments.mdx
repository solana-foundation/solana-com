...
description: Erfahren Sie, wie Sie mehrere Empfänger in einer einzigen Transaktion bezahlen können.
---
...
erhöht das Größenlimit auf 4096 Bytes, was etwa dreimal so viele Überweisungen pro Transaktion ermöglicht. Darüber hinaus ist weiterhin Batching erforderlich, da die Laufzeitumgebung unabhängig vom Format maximal 64 Konten pro Transaktion lädt.
