...
| `USER_VERIFICATION` | Adresse erfordert Empfängerbestätigung | Explizite Prüfung vor dem Senden von SPL-Token oder der Finanzierung einer ATA verlangen |
