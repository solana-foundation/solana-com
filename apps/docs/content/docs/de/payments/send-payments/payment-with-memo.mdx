...
Das Memo-Programm von Solana ermöglicht es Ihnen, Rechnungsnummern, Bestell-IDs
oder benutzerdefinierte Referenzen an jede Zahlung anzuhängen. Diese Memos
werden dauerhaft on-chain gespeichert und sind in Transaktionsprotokollen
sichtbar, was es einfach macht, Zahlungen mit Ihren internen Systemen
abzugleichen.
