...
<Callout type="caution">
  Das Commerce Kit befindet sich derzeit in der Beta-Phase. Die APIs können sich
  vor der stabilen Veröffentlichung noch ändern. Weitere Informationen zum
  Commerce Kit finden Sie in der [Commerce
  Kit-Dokumentation](/docs/tools/commerce-kit).
</Callout>
