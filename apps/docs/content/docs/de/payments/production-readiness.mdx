...
Für die Backend-Signierung in der Produktion sollten Sie
[solana-keychain](https://github.com/solana-foundation/solana-keychain) in
Betracht ziehen—eine unifizierte Signierungsbibliothek, die mehrere
Key-Management-Backends über eine einzige Schnittstelle abstrahiert: Memory,
Vault, Privy, Turnkey, AWS KMS, Fireblocks, GCP KMS, CDP, Para, Dfns. Dies
ermöglicht es Ihnen, lokal mit In-Memory-Keys zu entwickeln und dann zu
produktionsreifen Backends zu wechseln, ohne den Anwendungscode ändern zu
müssen.
