...
Für die Signierung im Produktions-Backend sollten Sie
[solana-keychain](https://github.com/solana-foundation/solana-keychain) in
Betracht ziehen—eine vereinheitlichte Signierungsbibliothek, die mehrere
...
Dies ermöglicht es Ihnen, lokal mit In-Memory-Schlüsseln zu entwickeln und dann
zu produktionsreifen Backends zu wechseln, ohne den Anwendungscode zu ändern.
