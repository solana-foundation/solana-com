...
description: Verbinden Sie sich mit dem Netzwerk und erkunden Sie Blockchain-Daten
---
...
<Callout type="caution" title="Verwenden Sie keine öffentliche RPC für die Produktion">
  Die öffentlichen Endpunkte (`api.mainnet.solana.com`, `api.devnet.solana.com`) sind
  ratenlimitiert, haben keine SLA und sind für produktive Zahlungsabläufe ungeeignet.
  Verwenden Sie einen [RPC-Anbieter](https://solana.com/rpc), um einen privaten RPC-Endpunkt
  für Produktivumgebungen zu sichern.
</Callout>
