...
[verfügbaren 402-SDKs](#sdks-und-ihr-solana-support) mit ihrem aktuellen Solana-Support.
...
- **Hochauflösende Bilder**: Vollauflösende Downloads nach Zahlung freischalten
  ...
  [x402 Coinbase-Beispiel](https://github.com/x402-foundation/x402/tree/main/typescript/packages/http/paywall)
...
| [Natives Beispiel](#natives-beispiel)       | Ja                      | Minimales Beispiel ohne Abhängigkeiten                       | [Beispiele](https://github.com/Woody4618/x402-solana-examples) |
