...
- **Hochauflösende Bilder**: Vollauflösende Downloads nach Zahlung freischalten
  ...
  [x402 Coinbase-Beispiel](https://github.com/coinbase/x402/tree/main/typescript/packages/http/paywall)
