...
erläutert die Struktur von Solana-[Konten](/docs/core/accounts). Jedes Solana-
Konto hat eine eindeutige
[Adresse](/docs/core/accounts/account-structure#account-address), die verwendet wird, um
die On-Chain-Daten des Kontos zu finden. Solana-Konten enthalten entweder
