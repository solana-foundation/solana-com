...
[Adresse](/docs/core/accounts/account-structure#account-address), die verwendet
wird, um die Onchain-Daten des Kontos zu lokalisieren. Solana-Konten enthalten
entweder
[Zustandsdaten oder ein ausführbares Programm](/docs/core/accounts/account-types).
