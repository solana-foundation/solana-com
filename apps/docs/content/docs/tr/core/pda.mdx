...
sahip bump seed'in hala geçerli bir PDA türetebileceği anlamına gelir.
...
[Anchor framework](https://www.anchor-lang.com/docs) kullanır. Program, yeni
hesabı oluşturacak tek bir [`initialize`](mention:initialize) talimatı içerir ve
bu hesap PDA'yı türetmek için kullanılan
[kullanıcı adresini](mention:user-address) ve [bump seed'i](mention:bump)
saklayacaktır.
...
PDA'yı oluşturmak için kullanılan [seed'ler](mention:seeds) şunlardır:
