...
Programlar durumlarını korumak için veri hesapları kullanır. Bunu yapmak için
öncelikle yeni bir veri hesabı oluşturmaları gerekir. Bir program durum hesabı
oluşturma süreci genellikle soyutlanır, ancak altta yatan süreci anlamak
faydalıdır.
