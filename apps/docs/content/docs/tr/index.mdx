...
Her hamlenin bir işlem gönderdiği Solana üzerinde 2048 oynayın. Fonlanmış bir
devnet cüzdanıyla başlamak için "Oyna"ya tıklayın ve oynamak için ok tuşlarını
kullanın. Mobil cihazda iseniz, karoları kontrol etmek için kaydırın.
...
ne gerektirdiğini keşfedin.

<Cards>
  <Card title="Validator'lar" href="https://docs.anza.xyz/validator/anatomy">
    Solana ağının güvenliğini sağlayan bireysel düğümler
  </Card>
  <Card
    title="Sistem gereksinimleri"
    href="https://docs.anza.xyz/operations/requirements"
  >
    Önerilen donanım gereksinimleri ve bir validator işletmek için gereken SOL
  </Card>
  <Card
