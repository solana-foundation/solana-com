...
[verify programının](https://explorer.solana.com/address/63XDCHrwZu3mXsw2RUFb4tbNpChuUHx4eA5aJMnHkpQQ/anchor-account) bir
[PDA'sı](https://github.com/otter-sec/otter-verify)
...
bir erişim noktası sağlamak üzere [OtterSec](https://github.com/otter-sec/solana-verified-programs-api)
tarafından sürdürülen kendi
[doğrulama API'lerini](https://github.com/otter-sec)
...
[doğrulama programından](https://explorer.solana.com/address/63XDCHrwZu3mXsw2RUFb4tbNpChuUHx4eA5aJMnHkpQQ/anchor-account)
türetilen bir
[PDA](https://explorer.solana.com/address/verifycLy8mB96wd9wqq3WDXQwM4oU6r42Th37Db9fC)'da
saklanmaktadır.
