...
Şimdi, `litesvm` crate'ini kullanarak programı test edin. Aşağıdaki
...
`cargo test` komutunu kullanarak testi çalıştırın. Program günlüğü "Hello,
...
Şimdi, programı deploy edin. Yerel olarak geliştirme yaparken,
