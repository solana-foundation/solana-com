...
[x402](https://www.x402.org/), API erişimi için kesintisiz mikro ödemeleri mümkün kılan açık bir ödeme standardıdır. Geleneksel abonelik modellerinin veya API anahtarlarının aksine, x402 sunucuların bireysel API çağrıları için ücret almasına olanak tanıyarak gerçek bir kullandıkça öde altyapısı oluşturur.
