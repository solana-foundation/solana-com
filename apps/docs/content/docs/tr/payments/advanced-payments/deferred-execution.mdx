...
Güncel bir blockhash yerine, işlemin ömrü olarak nonce değerini kullanın. Bunu
yapmak için önce nonce hesabından nonce değerini getirmeli, ardından işlemin
ömrünü ayarlamak için kullanmalısınız.
...
Süresi dolan güncel bir blockhash kullanmak yerine,
...
<Callout type="caution">
  ...
  hazırlamadan önce nonce'u ilerlettirmelisiniz.
</Callout>
