...
- `initSubscriptionAuthority` komutunu yalnızca Subscription Authority hesabı
  henüz mevcut olmadığında çalıştırın.
- Kullanıcı kurulum ve iptal işlemlerini imzalar. Delege edilen kişi
