...
description: Tek bir işlemde birden fazla alıcıya nasıl ödeme yapılacağını öğrenin.
---
...
boyut sınırını 4096 bayta yükseltiyor; bu da işlem başına yaklaşık üç kat daha fazla
transfer sığdırılmasını sağlıyor. Bu sınırın ötesinde toplu işlem hâlâ gereklidir; zira
çalışma zamanı, formattan bağımsız olarak işlem başına en fazla 64 hesap yükler.
