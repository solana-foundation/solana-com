...
[Kora](/docs/tools/kora) bu karmaşıklığı yönetir. Kullanıcıların asla SOL'a
...
<Cards>
  ...
  <Card title="Tam işlem demosu" href="/docs/tools/kora/guides/full-demo">
  ...
  <Card title="Node operatör kılavuzu" href="/docs/tools/kora/operators">
