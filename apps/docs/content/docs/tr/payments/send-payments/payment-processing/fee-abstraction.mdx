...
[Kora](/docs/products/kora) bu karmaşıklığı yönetir. Kullanıcıların asla SOL'a
ihtiyaç duymayacağı şekilde ücret soyutlama sağlayan bir JSON-RPC sunucusudur.
...
<Cards>
  ...
  <Card title="Tam işlem demosu" href="/docs/products/kora/guides/full-demo">
    Eksiksiz ücret soyutlama işlem uygulama kılavuzu.
  </Card>
  <Card title="API referansı" href="/docs/products/kora/json-rpc-api">
    JSON-RPC metodları ve SDK dokümantasyonu.
  </Card>
  <Card title="Node operatör kılavuzu" href="/docs/products/kora/operators">
