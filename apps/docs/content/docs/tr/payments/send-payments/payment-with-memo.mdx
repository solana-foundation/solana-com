...
kimlikleri veya özel referanslar eklemenizi sağlar. Bu memolar kalıcı olarak
zincir üzerinde kaydedilir ve işlem kayıtlarında görünür hale gelir, böylece
ödemeleri dahili sistemlerinizle eşleştirmek kolaylaşır.
