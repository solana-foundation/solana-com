...
talimatı, belirli bir token hesabından tüm token transferlerini veya token yakma
...
yetkisi hesapları dondurabilir. Mint hesabında dondurma yetkisi iptal edilirse
(null olarak ayarlanırsa), token'lar asla dondurulamaz.
