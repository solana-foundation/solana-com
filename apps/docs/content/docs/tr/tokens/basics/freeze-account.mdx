...
gönderemez veya token alamaz. Donmuş bir hesap, token bakiyesi sıfırsa yine de
kapatılabilir. Yalnızca tokenin mint hesabının dondurma yetkisi, hesapları
dondurabilir. Mint hesabında dondurma yetkisi iptal edilirse (null olarak
ayarlanırsa), tokenler hiçbir zaman dondurulamaz.
