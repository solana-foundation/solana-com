...
hesabı çözülene kadar token hesabının token transferi yapmasını veya yakmasını
engeller.
...
başlatılmış durumdan dondurulmuş duruma değiştirir.

[Native token hesapları](/docs/tokens/basics/sync-native) dondurma işlemini
desteklemez.
...
| _rs`FreezeAccount`_                 | Bir token hesabını dondurulmuş duruma dönüştüren talimat.                                        | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L213-L228) | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L276-L291) |
