...
komutu, belirli bir token hesabından tüm token transferlerini veya token yakma
işlemlerini engeller. Dondurulduktan sonra, hesap çözülene kadar token
gönderemez veya alamaz. Dondurulmuş bir hesap, sıfır token bakiyesine sahipse
yine de kapatılabilir. Yalnızca tokenin mint hesabının dondurma yetkisi,
hesapları dondurabilir. Mint hesabındaki dondurma yetkisi iptal edilirse (null
olarak ayarlanırsa), tokenler asla dondurulamaz.
