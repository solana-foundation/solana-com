...
adresine sahiptir. Bu adres, Solana ekosistemi genelinde USDC'yi benzersiz
...
[Uygulama detaylarını buradan](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/processor.rs#L27)
görüntüleyin.
...
## Sonraki Adımlar: Metadata Ekleme

Bir mint account yalnızca temel token bilgilerini (arz, ondalık basamak sayısı,
yetkiler) saklar. Token'ınıza isim, sembol ve görsel gibi insan tarafından
