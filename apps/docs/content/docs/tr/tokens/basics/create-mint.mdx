...
description:
  Bir token mint'i oluşturun ve mint'in ondalık basamaklarını, mint yetkisini ve
...
tanımlar, ayrıca o mint için tüm token hesaplarına uygulanan paylaşılan durumu
saklar.

Token Program, _rs`Mint`_ hesap türünü şu şekilde tanımlar:
...
Bir mint oluşturmak için iki talimat gerekir:
...
Mint başlatma sırasında, Token Program mint account'unun henüz başlatılmadığını
ve rent muafiyetli olduğunu kontrol eder. Token Program daha sonra mint
yetkisini, dondurma yetkisini, ondalık basamakları ve _rs`is_initialized`_
bayrağını mint account verisine yazar.

### Kaynak Referansı

| Öğe                            | Açıklama                                                                        | Token Program                                                                                                  | Token Extensions Program                                                                                             |
| ------------------------------ | ------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                     | Her mint account'unda saklanan temel mint durumu.                               | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`InitializeMint`_           | Hesap listesinde rent sysvar hesabını bekleyen bir mint başlatma talimatı.      | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L24-L44)   | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L50-L74)   |
| _rs`InitializeMint2`_          | Hesap listesinde rent sysvar hesabını gerektirmeyen bir mint başlatma talimatı. | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L401-L414) | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L471-L486) |
...
Bir mint account yalnızca temel token bilgilerini (arz, ondalık sayılar,
yetkiler) saklar. Token'ınıza isim, sembol ve görsel gibi okunabilir metadata
eklemek için iki seçeneğiniz vardır:

<Cards>
  <Card title="Metaplex Token Metadata" href="/docs/tokens/metaplex">
   Metaplex Token Metadata Program kullanarak metadata ekleyin. Hem orijinal Token Program hem de Token-2022 ile çalışır.
  </Card>

  <Card title="Token Extensions Metadata" href="/docs/tokens/extensions/metadata">
   Token-2022 ile birlikte gelen yerleşik metadata uzantısını kullanın. 
