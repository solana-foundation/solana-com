...
## Token Hesabını Kapatmak Ne Yapar?
...
dondurulmuş hesabın token bakiyesi sıfırsa yine de kapatılabilir. Wrapped SOL
token hesapları istisnadır ve altta yatan SOL'u geri almak için token bakiyesi
ile kapatılabilir. Hesap sahibi veya hesabın kapatma yetkisi, kapatma talimatını
imzalar.
...
transfer eder, kaynak hesabı temizler ve kaynak hesabı siler. Token Extensions
