...
talimatı, bir token hesabını kalıcı olarak kapatır ve kalan tüm SOL'u (rent)
belirtilen bir hedef hesaba aktarır. Token hesabı kapatılmadan önce bakiyesi
sıfır olmalıdır. Bu talimatı yalnızca token hesabı sahibi veya belirlenmiş
kapatma yetkisi yürütebilir.
