...
Token hesabını kapatmak, hesabı siler ve token hesabının rent lamport'larını bir
hedef hesaba iade eder.

Hesap kapatılmadan önce token bakiyesi sıfır olmalıdır. Dondurulmuş bir hesap,
token bakiyesi sıfırsa yine de kapatılabilir. Sarılmış SOL token hesapları
istisnadır ve altta yatan SOL'u geri almak için token bakiyesi ile
kapatılabilir. Hesap sahibi veya hesabın kapatma yetkisi, kapatma talimatını
imzalar.
...
aktarır, kaynak hesabı temizler ve kaynak hesabı siler. Token Extensions
