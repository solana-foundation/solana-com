...
hesabına tam işlevselliğini geri kazandırır. Çözme işleminden sonra hesap,
token'ları tekrar normal şekilde gönderip alabilir. Yalnızca token'ın mint'inin
dondurma yetkisi hesapları çözebilir.
