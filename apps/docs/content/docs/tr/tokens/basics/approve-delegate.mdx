...
talimatı, başka bir hesaba (temsilciye) token hesabınızdan belirli bir miktarda
token transfer etme izni verir. Temsilci, onaylanan miktara kadar token transfer
edebilir ancak bu miktarı aşamaz. Yalnızca token hesabı sahibi bir temsilciyi
onaylayabilir ve her token hesabının aynı anda yalnızca bir temsilcisi olabilir.
Yeni bir onay, öncekinin üzerine yazar.
