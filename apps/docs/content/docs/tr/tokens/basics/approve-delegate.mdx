...
description:
  Bir token hesabından sınırlı miktarda token'ın aktarılmasına veya yakılmasına
  başka bir adresin yetkisini verin.
...
## Bir Delegeyi Onaylamak Ne İşe Yarar?

Bir delegeyi onaylamak, başka bir adresin token hesabı sahibi adına token
hesabından sınırlı miktarda token aktarmasına veya yakmasına izin verir.

Bir token hesabı aynı anda yalnızca bir güncel delege ve bir yetkilendirilmiş
miktar saklar. Yeni bir delege onaylamak, hesaptaki önceki delegeyi ve izin
miktarını değiştirir.

## Bir Delege Nasıl Onaylanır

Bir delegeyi onaylamak Token Program'ın _rs`Approve`_ veya _rs`ApproveChecked`_
talimatını kullanır.

Aşağıdaki örnekler _rs`ApproveChecked`_ kullanır; bu, çağrıcının mint ve ondalık
basamak sayısını sağlamasını gerektirir, böylece talimat onayı işlemeden önce
...
| --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_         | Token hesabı durumu, sahibi, delegeyi ve yetkilendirilmiş miktarı saklar.                                                                                             | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Approve`_         | Çağrıcının mint veya ondalık basamak sayısını sağlamasını gerektirmeden bir token hesabı için delegeyi ve izin miktarını kaydeden bir delege onay talimatı.           | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L109-L127) | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L150-L168) |
| _rs`ApproveChecked`_  | Çağrıcının mint ve ondalık basamak sayısını sağlamasını gerektiren ve delegeyi ve izin miktarını kaydetmeden önce bu değerleri kontrol eden bir delege onay talimatı. | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L274-L300) | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L340-L366) |
| _rs`process_approve`_ | Delege onayı için paylaşılan işlemci mantığı.                                                                                                                         | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L344-L392)     | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L582-L640)     |
