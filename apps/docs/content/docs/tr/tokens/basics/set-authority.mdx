---
title: Yetki belirleme
description:
  Bir mint veya token hesabı üzerinde mint, dondurma, sahip ve kapatma yetkisi
  gibi yetki rollerini değiştirin veya iptal edin.
...
## Yetki Ayarlama Ne İşe Yarar?

Yetki ayarlama, bir mint veya token hesabı üzerindeki belirli yetki rollerini
değiştirir veya iptal eder.

Mint hesapları bir mint yetkisi ve bir dondurma yetkisi saklayabilir. Token
hesapları bir sahip saklar ve isteğe bağlı olarak bir kapatma yetkisi
saklayabilir. Her rol belirli bir izin setini kontrol eder ve bir yetkiyi
_rs`None`_ olarak ayarlamak, seçilen yetki rolünü kalıcı olarak kaldırır.

Token Extensions Program ayrıca belirli uzantılar için ek yetki türleri
tanımlar.

## Yetki Nasıl Ayarlanır

Bir yetkiyi değiştirmek Token Program'ın _rs`SetAuthority`_ talimatını kullanır.

Her çağrı, bir mint veya token hesabı üzerinde bir yetki türünü günceller.
Mevcut yetki değişikliği imzalar ve yeni yetki başka bir adres veya seçilen
yetkiyi kalıcı olarak iptal etmek için _rs`None`_ olabilir.

### Kaynak Referansı

| Öğe                         | Açıklama                                                                                | Token Program                                                                                                  | Token Extensions Program                                                                                               |
| --------------------------- | --------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                  | Mint durumu _rs`mint_authority`_ ve _rs`freeze_authority`_ saklar.                      | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)           |
| _rs`Account`_               | Token hesabı durumu _rs`owner`_ ve _rs`close_authority`_ saklar.                        | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)          |
| _rs`AuthorityType`_         | _rs`SetAuthority`_ tarafından güncellenebilen yetki rolleri.                            | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L739-L751) | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L1116-L1157) |
| _rs`SetAuthority`_          | Bir mint veya token hesabı üzerinde bir yetkiyi değiştiren veya iptal eden bir talimat. | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L141-L158) | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L183-L200)   |
| _rs`process_set_authority`_ | Yetki güncellemeleri için paylaşılan işlemci mantığı.                                   | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L423-L518)     | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L677-L978)       |

### Typescript

Aşağıdaki `Kit` örnekleri, `@solana/kit` kullanımıyla önerilen yaklaşımı
