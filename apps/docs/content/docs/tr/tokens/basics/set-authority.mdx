...
description:
  Bir mint veya token hesabında mint, freeze, owner ve close yetkisi dahil olmak
  üzere yetki rollerini değiştirin veya iptal edin.
...
Yetki ayarlama, bir mint veya token hesabındaki belirli yetki rollerini
değiştirir veya iptal eder.

Mint hesapları bir mint yetkisi ve bir freeze yetkisi saklayabilir. Token
hesapları bir owner saklar ve isteğe bağlı olarak bir close yetkisi
...
Bir yetkiyi değiştirmek Token Program'ın _rs`SetAuthority`_ komutunu kullanır.

Her çağrı, bir mint veya token hesabında bir yetki türünü günceller. Mevcut
yetki değişikliği imzalar ve yeni yetki başka bir adres veya seçilen yetkiyi
kalıcı olarak iptal etmek için _rs`None`_ olabilir.
...
| _rs`Account`_               | Token hesap durumu _rs`owner`_ ve _rs`close_authority`_ saklar.             | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)          |
| _rs`AuthorityType`_         | _rs`SetAuthority`_ komutunun güncelleyebileceği yetki rolleri.              | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L739-L751) | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L1116-L1157) |
| _rs`SetAuthority`_          | Bir mint veya token hesabında bir yetkiyi değiştiren veya iptal eden komut. | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L141-L158) | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L183-L200)   |
