...
description:
  Bir token hesabının mevcut temsilcisini kaldırın ve kalan yetkilendirilmiş
  izin miktarını sıfırlayın.
...
## Temsilci İptali Ne İşe Yarar?

Bir temsilciyi iptal etmek, token hesabının mevcut temsilcisini temizler ve
yetkilendirilmiş miktarı sıfıra sıfırlar.

İptalden sonra, önceki temsilcinin artık token hesabı adına token transfer etme
veya yakma yetkisi kalmaz.

## Temsilci Nasıl İptal Edilir

Bir temsilciyi iptal etmek, Token Program'ın _rs`Revoke`_ talimatını kullanır.

_rs`Revoke`_ talimatı, kaynak token hesabındaki temsilci alanlarını temizler.
Token Program'da, token hesabı sahibi iptali imzalar. Token Extensions
Program'da ise mevcut temsilci de yetkilendirmeyi iptal edebilir.

### Kaynak Referansı

| Öğe                  | Açıklama                                                           | Token Program                                                                                                  | Token Extensions Program                                                                                             |
| -------------------- | ------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_        | Token hesap durumu, temsilciyi ve yetkilendirilmiş miktarı saklar. | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Revoke`_         | Bir token hesabından mevcut temsilciyi kaldıran bir talimat.       | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L128-L140) | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L170-L182) |
| _rs`process_revoke`_ | Temsilci iptali için paylaşılan işlemci mantığı.                   | [Kaynak](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L395-L420)     | [Kaynak](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L643-L674)     |
