...
bir mint için oluşturulan tüm yeni token hesapları için varsayılan bir durum
belirler. Etkinleştirildiğinde, bu uzantı her yeni token hesabını otomatik
olarak dondurulmuş gibi belirli bir durumla başlatır. Bu, token yaratıcılarının
tüm yeni hesapların açıkça çözülene kadar varsayılan olarak dondurulmasını
gerektirmek gibi belirli davranışları zorunlu kılmasına olanak tanır.
