...
Aşağıdaki örnek, token'ları gizli kullanılabilir bakiyeden geri genel bakiyeye
çeker. Hesabın gizli transferler için önceden yapılandırılmış olması ve
kullanılabilir bir gizli bakiye tutması gerekir.
