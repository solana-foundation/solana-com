...
kullanmak için Solana CLI'nin kurulu olması gerekir.
...
| Talimat                             | Açıklama                                                                                                                                                   |
| ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`InitializeMint`_                | Gizli transferler için mint hesabını ayarlar. Bu talimat, _rs`TokenInstruction::InitializeMint`_ talimatıyla aynı işlemde yer almalıdır.                   |
| _rs`UpdateMint`_                    | Bir mint için gizli transfer ayarlarını günceller.                                                                                                         |
| _rs`ConfigureAccount`_              | Gizli transferler için bir token hesabı ayarlar.                                                                                                           |
| _rs`ApproveAccount`_                | Mint yeni token hesapları için onay gerektiriyorsa, gizli transferler için bir token hesabını onaylar.                                                     |
| _rs`EmptyAccount`_                  | Bir token hesabının kapatılmasına izin vermek için bekleyen ve mevcut gizli bakiyeleri boşaltır.                                                           |
| _rs`Deposit`_                       | Genel token bakiyesini bekleyen gizli bakiyeye dönüştürür.                                                                                                 |
...
| _rs`EnableConfidentialCredits`_     | Bir token hesabının gizli token transferleri almasına izin verir.                                                                                          |
| _rs`DisableConfidentialCredits`_    | Gelen gizli transferleri engeller ancak genel transferlere izin vermeye devam eder.                                                                        |
| _rs`EnableNonConfidentialCredits`_  | Bir token hesabının genel token transferleri almasına izin verir.                                                                                          |
| _rs`DisableNonConfidentialCredits`_ | Hesabın yalnızca gizli transferler almasını sağlamak için normal transferleri engeller.                                                                    |
| _rs`TransferWithFee`_               | Token hesapları arasında ücretli olarak gizli token transferi yapar.                                                                                       |
| _rs`ConfigureAccountWithRegistry`_  | _rs`VerifyPubkeyValidity`_ kanıtı yerine _rs`ElGamalRegistry`_ hesabı kullanarak token hesaplarını gizli transferler için yapılandırmanın alternatif yolu. |
