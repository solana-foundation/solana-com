...
bir mint için tüm token hesapları üzerinde yetkiye sahip bir delege atar. Token
hesabı sahiplerinin iptal edebileceği normal delegelerden farklı olarak, kalıcı
bir delege token hesabı sahipleri tarafından değiştirilemez veya kaldırılamaz.
Kalıcı delege, o mint'e ait herhangi bir token hesabındaki tokenları transfer
edebilir veya yakabilir. Kalıcı delege rolü, mevcut kalıcı delege tarafından
yeni bir hesaba değiştirilebilir.
