...
description:
  Zincirleme bir faiz oranı ile Token Extensions Program mint hesabı oluşturun, bu oranı güncelleyin ve token miktarlarını faizli UI miktarına dönüştürün.
