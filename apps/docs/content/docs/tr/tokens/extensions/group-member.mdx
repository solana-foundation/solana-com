...
içeren bir hesaba işaret ederek bir mint'i grup mint'i (örneğin bir koleksiyon
NFT'si) olarak belirler. Bu yapılandırmalar güncelleme yetkisi ve maksimum boyut
...
içeren bir hesaba işaret ederek bir mint'i üye mint'i (örneğin bir
koleksiyondaki NFT) olarak belirler. Bu veriler grup adresi ve üye numarası gibi
bilgileri içerir.
