...
title: Cheatcode'lar
description:
  İşlemleri atlayın ve Surfnet durumunu doğrudan değiştirin. SOL ve token fonlayın, rastgele hesap verisi ayarlayın, önbelleğe alınmış upstream hesaplarını sıfırlayın ve canlı mainnet hesaplarını akış olarak izleyin.
---
