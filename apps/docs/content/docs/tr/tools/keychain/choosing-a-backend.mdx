...
description:
  Keychain imzalama backend'ini gereksinimlerinize göre seçin — gözetim, mevcut altyapı, onay kontrolleri ve kendi uygulamanız için mi yoksa son kullanıcılar için cüzdan mı sağladığınız.
related:
...
İmzalar üretilmeden önce bir onay politikasından, harcama limitinden veya uyumluluk
iş akışından geçmesi gerekiyorsa — ya da anahtarları tutan düzenlenmiş bir saklama
hizmeti kullanmak istiyorsanız — bir **MPC / kurumsal saklama** arka ucu kullanın:
Fireblocks, Dfns, Para, Utila veya Fordefi. Bu çözümler anahtarı böler veya saklar
ve politikanıza göre ortak imzalar.
...
- **MPC ve kurumsal saklama** — anahtar, politikanıza göre (onaylar, limitler)
  ortak imzalayan bir sağlayıcı aracılığıyla bölünür veya saklanır.
  Arka uçlar: **Fireblocks**, **Dfns**, **Para**, **Utila**, **Fordefi**.
...
| Fordefi         | MPC / kurumsal saklama  | Politika kontrolleriyle kurumsal saklama | Yerel mod otomatik yayınlar; kara kutu modunda siz gönderirsiniz |
