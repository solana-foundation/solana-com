...
Beş terminal açın ve aşağıdaki komutları çalıştırın:
...
- ATA oluşturma işlemi için isteğe bağlı olarak `--fee-payer-key` bayrağını kullanarak özel bir ücret ödeyici belirtebilirsiniz.
