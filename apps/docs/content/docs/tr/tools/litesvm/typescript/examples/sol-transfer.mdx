...
En temel Solana işlemi: SOL'u bir hesaptan diğerine taşımak. Bu, daha karmaşık
...
<Callout type="info">
  Gönderenin nihai bakiyesi, işlem ücretleri nedeniyle 9 SOL'dan biraz daha azdır
  (imza başına 5.000 lamport).
</Callout>

Bu, en basit işlem türünü kapsar. Özel programlarla test etmek için
[Program Testi](/docs/tools/litesvm/typescript/examples/program-testing) bölümüne bakın. Token
transferlerinde (mint'ler, ATA'lar) ise
[Token Testi](/docs/tools/litesvm/typescript/tokens) bölümüne bakın.
