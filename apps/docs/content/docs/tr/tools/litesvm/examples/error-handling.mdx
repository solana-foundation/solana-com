---
title: Hata Yönetimi
description: Hata koşulları ve sınır durumları nasıl test edilir
---
...
## Farklı Hata Türlerini Test Etme
...
1. **Hata Doğrulamaları**: Hataların oluştuğunu doğrulamak için
   `assert!(result.is_err())` kullanın
2. **Hata Eşleştirme**: Doğru hata yönetimini sağlamak için belirli hata
   türleriyle eşleştirin
3. **Durum Doğrulama**: Hata oluştuğunda durumun değişmediğini doğrulayın
4. **Özel Hatalar**: Programınızın özel hata kodlarını test edin
5. **Sınır Durumları**: Sınır koşullarını ve geçersiz girdileri test edin
