...
`@solana-commerce/connector` paketi, [Wallet Standard](https://github.com/wallet-standard/wallet-standard) üzerine inşa edilmiş, bağımsız cüzdan bağlantısı sağlar. Cüzdan keşfi, bağlantı durumu, hesap yönetimi ve otomatik yeniden bağlantıyı yönetir. Paket, React bağlamaları dahil olmak üzere çerçeveden bağımsız olacak şekilde tasarlanmıştır. Solana Commerce Kit'te sorunsuz kullanım için özelleştirilmiş olup [@solana/kit](https://github.com/anza-xyz/kit) ile uyumludur.
