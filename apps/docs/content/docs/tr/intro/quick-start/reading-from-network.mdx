...
Solana ağından farklı hesapları sorgulayarak veri okuyun. Bu bölüm, Solana
[hesaplarının](/docs/core/accounts) yapısını anlamanıza yardımcı olacaktır. Her
Solana hesabının, karşılık gelen zincir üstü verilerini bulmak için kullanılan
benzersiz bir [adresi](/docs/core/accounts#account-address) vardır. Hesaplar,
[durum verileri veya çalıştırılabilir bir program](/docs/core/accounts#types-of-accounts)
içerir.
...
[yükleyici programına](/docs/core/programs#loader-programs) aittir. Bu örnekte,
...
deserialize etmeniz gerekir, bu [sonraki örnekte](#deserialize-mint-account)
gösterilmiştir.
...
veri tipine deserialize etmeye yardımcı olan [_ts`getMint()`_](mention:one)
fonksiyonunu içerir.
