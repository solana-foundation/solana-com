...
Solana işlemlerinin boyut sınırı vardır (~1232 bayt). Her transfer talimatı
yaklaşık ~200 bayt ekler. Çok taraflı büyük ödemeler için, hesap adreslerini
sıkıştırmak ve işlem başına daha fazla transfer sığdırmak amacıyla
[Adres Arama Tabloları](/developers/cookbook/transactions/lookup-tables)'nı
kullanmayı düşünebilirsiniz.

Yakında gelecek olan
[v1 işlem formatı](/docs/core/transactions/versioned-transactions#v1-message-format)
sınırı 4096 bayta yükseltir ancak Adres Arama Tablosu desteğini kaldırır; bu nedenle v1
ödemeleri adresleri doğrudan içerir. Her iki durumda da çalışma zamanı işlem başına
en fazla 64 hesap yükler.
