...
Bu kılavuz, yerel olarak çalıştırabileceğiniz eksiksiz ve işlevsel bir uygulama içermektedir.
[Kaynak kod](https://github.com/Woody4618/access-control-list-acl-demo)
keşfetme ve eğitim amaçları için referans uygulamalar sunmaktadır.

ACL programlarının kodu
[token-acl deposunda](https://github.com/solana-foundation/token-acl) mevcuttur ve
ABL Gate Programı
[token-acl-gate deposunda](https://github.com/solana-foundation/token-acl-gate) bulunmaktadır.

**Önemli**: Bu kılavuzda kullanılan ABL (İzin Engel Listesi) Gate Programı bir
**referans uygulamasıdır**. Denetlenmiş ve üretime hazır olsa da, ihraççılar kendi özel uyumluluk ihtiyaçlarına daha uygun özel Gate Programları oluşturmakta özgürdür. Yalnızca Token ACL spesifikasyonu (sRFC37) ile bağlısınız,
bu belirli Gate Programı tasarımıyla değil.

**Bu kodu doğrudan üretimde KULLANMAYIN** aşağıdakiler olmadan:
...
4. **Teknik Özellikleri Okuyun**: Eksiksiz teknik özellikler için [sRFC37](https://github.com/solana-foundation/token-acl/blob/master/srfc37.md)'yi inceleyin ve [sRFC37 tartışmasına](https://github.com/solana-foundation/SRFCs/discussions/2) katılın
