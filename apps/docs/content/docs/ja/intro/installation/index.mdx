...
1つのコマンドでローカルのSolana開発環境をセットアップできます。このコマンドにより、Rust、Solana CLI、Anchor フレームワーク、Surfpool、Node.js、およびYarnがWindows（WSL）、Linux、Macにインストールされます。
...
<Callout>
  インストールコマンドが失敗した場合は、[各依存関係を個別にインストール](/docs/intro/installation/dependencies)してください。
</Callout>
...
<Cards>
  ...
  >
    各ツールを個別にインストールするか、ワンコマンドインストーラーのトラブルシューティングを行います。
  </Card>
  <Card
    title="Solana CLI の基本"
    href="/docs/intro/installation/solana-cli-basics"
  >
    クラスターの設定、keypairの管理、およびよく使われるSolana CLIコマンドの使い方を学びます。
  </Card>
  <Card
    title="Anchor CLI の基本"
    href="/docs/intro/installation/anchor-cli-basics"
  >
    Anchorプロジェクトの作成、ビルド、テスト、およびデプロイを行います。
  </Card>
  <Card
    title="Surfpool CLI の基本"
    href="/docs/intro/installation/surfpool-cli-basics"
  >
    ローカルvalidatorを起動し、Surfpool Studioで検査します。
  </Card>
</Cards>
