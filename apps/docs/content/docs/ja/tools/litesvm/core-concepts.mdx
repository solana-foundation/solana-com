---
title: LiteSVMを選ぶ理由
description: LiteSVMの仕組みと他との違いを理解する
---

## 概要

LiteSVMは、テスト関数の内部で動作するSolana
VMとして考えてください。別プロセスでもネットワークサービスでもなく、コード内のライブラリ呼び出しに過ぎません。
...
<Tabs items={["Rust", "TypeScript"]} groupId="litesvm-lang">
  <Tab value="Rust">
    **[プログラムのテスト →](/docs/tools/litesvm/testing-your-program)**
    自分のSolanaプログラムをテストする方法を学ぶ <br /> **[サンプル
    →](/docs/tools/litesvm/examples)**
    よくあるシナリオのコピペ用ソリューションとリポジトリサンプルを見る <br />{" "}
    **[APIリファレンス →](/docs/tools/litesvm/api-reference)**
    高度な機能とカスタム設定を学ぶ
  </Tab>
  <Tab value="TypeScript">
    **[プログラムのテスト →](/docs/tools/litesvm/typescript/getting-started)**
    TypeScript向けLiteSVMを使って自分のSolanaプログラムをテストする方法を学ぶ{" "}
    <br /> **[サンプル →](/docs/tools/litesvm/typescript/examples)**
    よくあるシナリオのコピペ用ソリューションを見る <br /> **[APIリファレンス
    →](/docs/tools/litesvm/typescript/api-reference)**
    高度な機能とカスタム設定を学ぶ
  </Tab>
</Tabs>
