---
title: SOL転送
description: LiteSVMを使ってSOL転送トランザクションを構築・送信する
---
...
これは最もシンプルなトランザクションタイプについての説明です。カスタムプログラムを使ったテストについては、[プログラムテスト](/docs/tools/litesvm/typescript/examples/program-testing)を参照してください。トークン転送（ミント、ATA）については、[トークンテスト](/docs/tools/litesvm/typescript/tokens)を参照してください。
