...
- **`--use-rpc`**: トランザクションを設定済みのRPCに送信します。このフラグには、[ステーク加重](/docs/defi/stake-weighted-qos)RPCへの接続が必要であり、[Triton](https://triton.one/)や[Helius](https://www.helius.dev/)などのプロバイダーから提供されます。
