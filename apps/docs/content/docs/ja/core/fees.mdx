...
[デフォルト](https://github.com/anza-xyz/agave/blob/v2.1.13/compute-budget/src/compute_budget.rs#L149-L197)では、各命令に[200,000 CU](https://github.com/anza-xyz/agave/blob/v2.1.13/compute-budget/src/compute_budget_limits.rs#L10)が割り当てられ、各トランザクションに[1.4百万CU](https://github.com/anza-xyz/agave/blob/v2.1.13/compute-budget/src/compute_budget_limits.rs#L14)が割り当てられます。トランザクションに[`SetComputeUnitLimit`](https://github.com/anza-xyz/agave/blob/v2.1.13/sdk/src/compute_budget.rs#L42-L44)命令を含めることで、これらのデフォルト値を変更できます。
...
コンピュートユニット価格は、リクエストされた各CUに対して支払われる[マイクロlamport](/docs/references/terminology#micro-lamports)の任意の金額です。CU価格は、validatorにトランザクションを優先的に処理するよう促すチップと考えることができます。CU価格を設定するには、トランザクションに[`SetComputeUnitPrice`](https://github.com/anza-xyz/agave/blob/v2.1.13/sdk/src/compute_budget.rs#L48-L50)命令を含めます。
