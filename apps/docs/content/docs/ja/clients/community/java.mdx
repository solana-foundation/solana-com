...
[Sava Engineering](https://sava.engineering/)によって構築された[Java SDK](https://sava.software/welcome)があり、Solanaとやり取りするための大部分の機能をサポートしています。Solanaプログラムに対してAnchorを使用している場合、IDLと共に[anchor-src-gen](https://github.com/sava-software/anchor-src-gen)を使用してJava互換のクライアントを生成することができます。
