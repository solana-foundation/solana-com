...
title: Java SDK
description:
  Java SDK（sava-software/sava）を使用してSolanaとやり取りする方法を学びましょう。
h1: SolanaのためのJava SDK
---

[Sava Engineering](https://sava.software/welcome)によって構築された[Java SDK](https://sava.engineering/)があり、Solanaとやり取りするための大部分の機能をサポートしています。Solanaプログラムに対してAnchorを使用している場合、IDLと共に[anchor-src-gen](https://github.com/sava-software/anchor-src-gen)を使用してJava互換のクライアントを生成することができます。
...
このJava
SDKをSolanaで使用する方法の詳細については、[Sava Softwareのドキュメント](https://sava.software/welcome)をご覧ください。
