...
title: 利子付きトークン
description:
  オンチェーン金利を持つToken Extensions Programミントを作成し、その金利を更新し、トークン量を金利を含むUI量に変換します。
