...
は、ミントのすべてのトークンアカウントに対する権限を持つデリゲートを割り当てます。トークンアカウントの所有者が取り消すことができる通常のデリゲートとは異なり、パーマネントデリゲートはトークンアカウントの所有者によって変更または削除することができません。パーマネントデリゲートは、そのミントの任意のトークンアカウント内のトークンを転送または焼却することができます。パーマネントデリゲートの役割は、現在のパーマネントデリゲートによって新しいアカウントに変更することができます。
