...
Extensions
Programでローカルバリデータを起動します。ローカルバリデータを使用するには、Solana
...
| 命令                                | 説明                                                                                                                                        |
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`InitializeMint`_                | 秘匿転送用のmint accountを設定します。この命令は、_rs`TokenInstruction::InitializeMint`_ 命令と同じトランザクションに含める必要があります。 |
| _rs`UpdateMint`_                    | mintの秘匿転送設定を更新します。                                                                                                            |
| _rs`ConfigureAccount`_              | token accountを秘匿転送用に設定します。                                                                                                     |
| _rs`ApproveAccount`_                | mintが新しいtoken accountの承認を必要とする場合、token accountを秘匿転送用に承認します。                                                    |
| _rs`EmptyAccount`_                  | token accountを閉じることができるように、保留中および利用可能な秘匿残高を空にします。                                                       |
| _rs`Deposit`_                       | 公開トークン残高を保留中の秘匿残高に変換します。                                                                                            |
| _rs`Withdraw`_                      | 利用可能な秘匿残高を公開残高に戻します。                                                                                                    |
| _rs`Transfer`_                      | token account間でトークンを秘匿的に転送します。                                                                                             |
| _rs`ApplyPendingBalance`_           | 入金または転送後、保留残高を利用可能残高に変換します。                                                                                      |
| _rs`EnableConfidentialCredits`_     | token accountが秘匿トークン転送を受信できるようにします。                                                                                   |
| _rs`DisableConfidentialCredits`_    | 公開転送は許可したまま、秘匿転送の受信をブロックします。                                                                                    |
| _rs`EnableNonConfidentialCredits`_  | token accountが公開トークン転送を受信できるようにします。                                                                                   |
| _rs`DisableNonConfidentialCredits`_ | 通常の転送をブロックし、アカウントが秘匿転送のみを受信するようにします。                                                                    |
| _rs`TransferWithFee`_               | token account間で手数料付きでトークンを秘匿的に転送します。                                                                                 |
| _rs`ConfigureAccountWithRegistry`_  | _rs`VerifyPubkeyValidity`_ proofの代わりに _rs`ElGamalRegistry`_ accountを使用して、token accountを秘匿転送用に設定する代替方法です。       |
