...
は、[グループ設定](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16)
を含むアカウントを指すことで、ミントをグループミント(コレクションNFTなど)として指定します。グループ設定には、更新権限や最大サイズなどが含まれます。
...
は、[メンバーシップデータ](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67)
を含むアカウントを指すことで、ミントをメンバーミント(コレクション内のNFTなど)として指定します。メンバーシップデータには、グループアドレスやメンバー番号などが含まれます。
