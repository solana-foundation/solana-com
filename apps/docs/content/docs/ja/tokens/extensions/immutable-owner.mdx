---
title: 不変所有者
description: ImmutableOwner拡張機能を有効にする方法を学びます。
---

## ImmutableOwner拡張機能を有効にする方法

[`ImmutableOwner`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L511)拡張機能は、トークンアカウントの所有権変更を防止します。トークンアカウントがこの拡張機能で初期化されると、指定された所有者は永続的となり、他のアカウントに譲渡することはできません。
