...
トークン転送は、[`TransferChecked`](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/instruction.rs#L268)命令を使用して、同じミントのトークンアカウント間でトークンを移動します。
