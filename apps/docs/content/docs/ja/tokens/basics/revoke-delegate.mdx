...
title: 委任の取り消し
description:
  token accountの現在の委任者を削除し、残りの委任許可量をクリアします。
...
委任者を取り消すと、token
accountの現在の委任者がクリアされ、委任量がゼロにリセットされます。

取り消し後、以前の委任者はtoken
accountに代わってトークンを転送または焼却する権限を持たなくなります。

## 委任者を取り消す方法

委任者の取り消しにはToken Programの*rs`Revoke`* instructionを使用します。

_rs`Revoke`_ instructionは、送信元token
accountの委任者フィールドをクリアします。Token Programでは、token
accountの所有者が取り消しに署名します。Token Extensions
Programでは、現在の委任者も委任を取り消すことができます。

### ソースリファレンス

| 項目                 | 説明                                                  | Token Program                                                                                                  | Token Extensions Program                                                                                             |
| -------------------- | ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_        | token accountの状態には委任者と委任量が保存されます。 | [ソース](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [ソース](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Revoke`_         | token accountから現在の委任者を削除するinstruction。  | [ソース](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L128-L140) | [ソース](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L170-L182) |
| _rs`process_revoke`_ | 委任者取り消しの共有プロセッサロジック。              | [ソース](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L395-L420)     | [ソース](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L643-L674)     |
