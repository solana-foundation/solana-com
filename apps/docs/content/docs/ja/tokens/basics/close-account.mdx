...
description: トークンアカウントをクローズし、アカウントのlamportを宛先アカウントに返却します。
...
トークンアカウントのクローズは、アカウントを削除し、トークンアカウントのrentのlamportを宛先アカウントに返却します。

アカウントをクローズする前に、トークン残高はゼロでなければなりません。凍結されたアカウントでも、トークン残高がゼロであればクローズできます。ラップされたSOLトークンアカウントは例外で、トークン残高があってもクローズして基礎となるSOLを回収できます。アカウント所有者またはアカウントのクローズ権限者がクローズinstructionに署名します。
