...
命令は、特定のトークンアカウントからのすべてのトークン転送またはトークンバーンを防止します。凍結されると、アカウントは解凍されるまでトークンを送信したり受信したりすることができなくなります。凍結されたアカウントは、トークン残高がゼロの場合は閉鎖することができます。トークンのミントの凍結権限者のみがアカウントを凍結できます。ミントアカウントで凍結権限が取り消された（nullに設定された）場合、トークンは永久に凍結できなくなります。
