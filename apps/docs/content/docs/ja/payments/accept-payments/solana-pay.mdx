...
<Callout type="caution">
  ...
  Kitドキュメント](/docs/products/commerce-kit)を参照してください。
</Callout>
...
| パラメータ  | 型          | 説明                                           |
| ----------- | ----------- | ---------------------------------------------- |
| `recipient` | `Address`   | マーチャントのウォレットアドレス（必須）       |
| `amount`    | `bigint`    | lamport単位またはトークンの最小単位での金額    |
| `splToken`  | `Address`   | SPLトークンのミントアドレス（SOLの場合は省略） |
