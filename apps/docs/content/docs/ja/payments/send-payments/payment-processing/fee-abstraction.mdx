...
[Kora](/docs/products/kora)は、この複雑さを処理します。これは、ユーザーがSOLを必要としないように手数料抽象化を提供するJSON-RPCサーバーです。手数料を完全にスポンサーするか、任意のトークンで手数料の支払いを受け入れることができます。
...
<Cards>
  ...
  <Card title="APIリファレンス" href="/docs/products/kora/json-rpc-api">
    JSON-RPCメソッドとSDKドキュメント。
  </Card>
  <Card title="ノードオペレーターガイド" href="/docs/products/kora/operators">
