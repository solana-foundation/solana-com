...
تعاملات سولانا لها حد للحجم (~1232 بايت). كل تعليمة تحويل
تضيف ~200 بايت. بالنسبة للتسويات الكبيرة متعددة الأطراف، فكّر في استخدام
[جداول بحث العناوين](/developers/cookbook/transactions/lookup-tables) لضغط
عناوين الحسابات وتضمين المزيد من التحويلات في كل معاملة.

تنسيق المعاملات القادم
[v1 transaction format](/docs/core/transactions/versioned-transactions#v1-message-format)
يرفع الحد إلى 4096 بايت لكنه يُلغي دعم جداول بحث العناوين، لذا تُدرج تسويات v1
عناوينها مباشرةً. في كلتا الحالتين، يحمّل وقت التشغيل 64 حسابًا كحد أقصى لكل معاملة.
