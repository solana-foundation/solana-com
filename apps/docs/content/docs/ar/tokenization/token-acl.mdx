...
يتضمن هذا الدليل تطبيقاً كاملاً وقابلاً للتشغيل يمكنك تشغيله محلياً.
[الكود المصدري](https://github.com/Woody4618/access-control-list-acl-demo)
يوفر تطبيقات مرجعية للاستكشاف والأغراض التعليمية.

كود برامج ACL متاح في
[مستودع token-acl](https://github.com/solana-foundation/token-acl) وبرنامج
ABL Gate متاح في
[مستودع abl-gate-program](https://github.com/solana-foundation/abl-gate-program).

**مهم**: برنامج ABL (قائمة السماح والحظر) Gate المستخدم في هذا الدليل هو
**تطبيق مرجعي**. وعلى الرغم من أنه خضع للتدقيق وجاهز للإنتاج، فإن المُصدِرين
أحرار في إنشاء Gate Programs مخصصة تناسب احتياجات الامتثال الخاصة بهم.
أنت مُقيَّد فقط بمواصفات Token ACL (sRFC37)،
وليس بتصميم هذا Gate Program بالتحديد.
