...
title: أكواد الغش
description:
  تخطَّ المعاملات وغيِّر حالة Surfnet مباشرةً. موِّل SOL والرموز، وعيِّن بيانات حساب عشوائية، وأعد تعيين الحسابات المخزنة مؤقتاً، وبثَّ حسابات الشبكة الرئيسية مباشرةً.
---
