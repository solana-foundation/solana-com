---
title: الدوال القياسية
description: دوال الأدوات المساعدة المتاحة في المكتبة القياسية
---

هذه الدوال متاحة في جميع Runbooks كجزء من المكتبة القياسية.

## العوامل

العوامل الرياضية والمقارنة الأساسية:
