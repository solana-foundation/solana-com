...
تم بناء Solana Commerce Kit على قمة مكتبة سولانا Kit، لذا فهو
متوافق مع سولانا Kit وبرامج سولانا
[العملاء](https://github.com/solana-program)، و
[عملاء JS المُولَّدون بواسطة Codama](https://github.com/codama-idl/renderers-js).
