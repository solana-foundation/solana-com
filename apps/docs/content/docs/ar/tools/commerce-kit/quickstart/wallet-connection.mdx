...
توفر حزمة `@solana-commerce/connector` اتصالاً مرناً بالمحفظة مبنياً على
[Wallet Standard](https://github.com/wallet-standard/wallet-standard).
تتولى إدارة اكتشاف المحافظ، وحالة الاتصال، وإدارة الحسابات، وإعادة الاتصال التلقائية. صُممت الحزمة لتكون مستقلة عن أطر العمل مع تضمين روابط React. وهي مصممة للاستخدام السلس في سولانا Commerce Kit وتتوافق مع [@solana/kit](https://github.com/anza-xyz/kit).
