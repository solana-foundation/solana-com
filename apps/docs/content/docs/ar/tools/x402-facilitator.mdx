...
[x402](https://www.x402.org/) هو معيار دفع مفتوح يتيح مدفوعات صغيرة سلسة للوصول إلى واجهات برمجة التطبيقات. بدلاً من نماذج الاشتراك التقليدية أو مفاتيح API، يتيح x402 للخوادم تحصيل رسوم مقابل كل طلب API على حدة، مما يُنشئ بنية تحتية حقيقية للدفع مقابل الاستخدام.
