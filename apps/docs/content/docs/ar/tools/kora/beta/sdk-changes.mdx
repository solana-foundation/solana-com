---
title: تغييرات SDK (بيتا)
description:
  تغييرات TypeScript SDK في Kora v2.2.0-beta — منشئ جديد، إضافة Kit، وطرق الحزم.
---

تم تحديث `@solana/kora` SDK بواجهات برمجة تطبيقات جديدة لإصدار v2.2.0-beta. قم
بتثبيت SDK النسخة التجريبية:
...
يدعم SDK الآن جميع عمليات الحزم:
