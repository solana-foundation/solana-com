...
> _ملاحظة: عندما يكون `fallback_if_unavailable` صحيحاً، يسمح النظام للمعاملات
> بالمتابعة إذا كان Redis غير متاح مؤقتاً، مما يمنع انقطاع الخدمة.
> سيؤدي تعيين `max_transactions` إلى 0 إلى السماح بعدد غير محدود من المعاملات._
...
| `get_payer_signer`          | إرجاع دافع الرسوم التالي وعنوان الدفع        | ✅       | منطقي |
...
[وثائق سولانا](https://solana.com/developers/cookbook/transactions/durable-nonces).
...
| اسم الامتداد               | الوصف                                      |
| ---------------------------- | ------------------------------------------------ |
| `confidential_transfer_mint` | إعداد الأرصدة السرية للصك |
...
| اسم الامتداد                  | الوصف                                 |
| ------------------------------- | ------------------------------------------- |
| `confidential_transfer_account` | حالة الأرصدة السرية للحساب |
