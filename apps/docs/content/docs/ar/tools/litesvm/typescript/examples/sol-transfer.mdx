...
أبسط معاملة على سولانا: نقل SOL من حساب إلى آخر. يُعدّ هذا اختباراً أولياً جيداً للتحقق من أن إعداد LiteSVM لديك يعمل بشكل صحيح قبل اختبار منطق برامج أكثر تعقيداً.
...
<Callout type="info">
  الرصيد النهائي للمرسل أقل قليلاً من 9 SOL بسبب رسوم المعاملات
  (5,000 lamport لكل توقيع).
</Callout>

يغطي هذا أبسط أنواع المعاملات. لاختبار البرامج المخصصة، راجع
[اختبار البرامج](/docs/tools/litesvm/typescript/examples/program-testing). لتحويلات الرموز (المints وATAs)، راجع
