---
title: عمليات الرمز المميز
description: العمل مع عمليات الرمز المميز - الإصدار، والتحويلات، وإدارة الحسابات
---

## إنشاء نقطة إصدار للرمز المميز

نقطة الإصدار هي أساس أي رمز مميز من نوع SPL. فهي تحدد خصائص الرمز المميز وتتحكم
في من يمكنه إصدار رموز مميزة جديدة.
...
يحتفظ token account برصيد رمز spl-token محدد لمستخدم معين. لفهم الفرق بينه وبين
associated token account، اقرأ
[هذا القسم](/docs/tools/litesvm/additional-crates/testing-with-spl-tokens#types-of-token-accounts).
...
إن associated token accounts (ATAs) هي عناوين حتمية لحفظ الرموز المميزة لمستخدم
معين. لفهم الفرق بينها وبين associated token account، اقرأ
[هذا القسم](/docs/tools/litesvm/additional-crates/testing-with-spl-tokens#types-of-token-accounts).
...
## إصدار الرموز المميزة إلى token account

بمجرد أن تمتلك نقطة إصدار وحسابات رموز مميزة، يمكنك إصدار الرموز المميزة إلى تلك
الحسابات.
...
## إجراء تحويل للرمز المميز

قم بتحويل الرموز المميزة بين الحسابات باستخدام تعليمة Transfer.
...
تستخدم معظم الرموز المميزة الكسور العشرية لتمثيل المبالغ الجزئية. إليك كيفية
