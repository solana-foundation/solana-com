...
description: طرق لإدارة الحسابات والأرصدة وrent
---
...
تمويل حساب بـ lamports. يُعيد بيانات المعاملة عند النجاح.
...
الحصول على رصيد lamport للحساب. يُعيد `None` إذا لم يكن الحساب موجوداً.
...
احتساب الحد الأدنى من lamports المطلوبة للإعفاء من rent.
