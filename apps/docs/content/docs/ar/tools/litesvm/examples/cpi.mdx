...
description: كيفية اختبار البرامج التي تستدعي برامج أخرى
---
...
1. **برامج متعددة**: نشر جميع البرامج المشاركة في سلسلة Cross Program Invocation
2. **معرّفات البرامج**: تمرير معرّف البرنامج المستدعى كحساب في التعليمات
3. **System Program**: مطلوب في الغالب لعمليات Cross Program Invocation
   (التحويلات، إنشاء الحسابات، إلخ)
4. **التحقق من السجلات**: فحص السجلات للتأكد من تنفيذ جميع البرامج في سلسلة
   الاستدعاء

لمزيد من المعلومات التفصيلية حول النشر، اقرأ
[هذا القسم](/docs/tools/litesvm/testing-your-program/deploy).

## فهم سجلات Cross Program Invocation

عند حدوث Cross Program Invocation، ستظهر سجلات مثل:
...
الأرقام الموجودة بين الأقواس تشير إلى عمق الاستدعاء.
