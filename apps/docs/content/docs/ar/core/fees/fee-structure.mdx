...
رسوم الأولوية هي رسوم اختيارية تزيد من أولوية جدولة المعاملة. وحدة الحوسبة (CU) هي وحدة قياس للعمليات الحسابية التي يقيسها وقت التشغيل أثناء تنفيذ المعاملة. كل عملية (حسابية، أو وصول إلى الذاكرة، أو استدعاء نظام) تكلّف عدداً ثابتاً من وحدات الحوسبة. يمكنك تحديد رسوم الأولوية عن طريق تضمين تعليمات ميزانية الحوسبة في معاملتك. (راجع [دليل كيفية استخدام رسوم الأولوية](/docs/core/fees) لمزيد من التفاصيل.)
...
<Callout type="info" title="معاملات v1 تحدد الرسوم مباشرةً">
  تنطبق صيغة السعر مضروبًا في الحد على معاملات legacy وv0. في
  تنسيق [v1
  القادم](/docs/core/transactions/versioned-transactions#v1-message-format)، تكون رسوم الأولوية إجمالاً مطلقاً بوحدة lamport يُحدَّد مباشرةً في
  إعداد الرسالة — دون سعر لكل وحدة حوسبة، ودون ضرب، ودون تقريب.
</Callout>
