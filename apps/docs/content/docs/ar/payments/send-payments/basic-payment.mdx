...
[`@solana/client`](https://solana.com/docs/frontend/client) مع اشتقاق ATA وتحويل
...
- **حل ATA**: يشتق تلقائياً حسابات الرمز المرتبطة (ATAs) للمرسل والمستلم. إذا لم
  يكن ATA الخاص بالمستلم موجوداً، يتم إضافة التعليمات لإنشاء الحساب تلقائياً إلى
  نفس المعاملة.
- **تحويل الكسور العشرية**: يقبل مبالغ الرموز ويحولها تلقائياً إلى وحدات أساسية
  بناءً على الكسور العشرية للسك (مثلاً 0.25 رمز -> 250000 وحدة أساسية، إذا كان
  السك يحتوي على 6 كسور عشرية)
