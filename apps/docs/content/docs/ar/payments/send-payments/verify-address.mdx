...
بعد اشتقاق عنوان ATA، تحقق مما إذا كان حساب الرمز موجودًا على السلسلة. إذا لم
يكن ATA موجودًا، يمكنك تضمين تعليمات لإنشاء حساب الرمز الخاص بالمستلم في نفس
المعاملة التي تتم فيها عملية التحويل. ومع ذلك، يتطلب هذا دفع rent لحساب الرمز
الجديد. نظرًا لأن المستلم يمتلك ATA، فإن SOL المدفوعة مقابل rent لا يمكن
استردادها من قبل المرسل.
