...
القادم حد الحجم إلى 4096 بايت، مما يتسع لما يقارب ثلاثة أضعاف عدد التحويلات لكل معاملة. لا يزال التجميع مطلوبًا بعد ذلك الحد، إذ يحمّل وقت التشغيل 64 حسابًا كحدٍّ أقصى لكل معاملة بصرف النظر عن التنسيق.
