...
[Kora](/docs/products/kora) يتعامل مع هذا التعقيد. إنه خادم JSON-RPC يوفر تجريد
الرسوم بحيث لا يحتاج المستخدمون أبدًا إلى SOL. يمكنك تمويل الرسوم بالكامل أو
قبول دفع الرسوم بأي رمز.
...
<Cards>
  ...
  <Card title="مرجع API" href="/docs/products/kora/json-rpc-api">
    طرق JSON-RPC وتوثيق SDK.
  </Card>
  <Card title="دليل مشغل العقدة" href="/docs/products/kora/operators">
