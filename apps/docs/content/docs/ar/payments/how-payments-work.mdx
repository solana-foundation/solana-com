...
على سولانا، البرامج هي منطق قابل للتنفيذ يتحكم في حالة الحساب. حسابات الرموز
تُدار بواسطة **برنامج الرموز**—الكود الموجود على السلسلة الذي يتحقق من التحويلات
ويحدّث الأرصدة بشكل ذري.
...
يضيف Token-2022 (المعروف أيضًا بـ "Token Extensions") ميزات مثل خطافات النقل،
ورسوم النقل، والأرصدة السرية. يعمل كلا البرنامجين بشكل مشابه للتحويلات الأساسية،
ولكن يجب استخدام البرنامج الصحيح عند اشتقاق حسابات ATA.
...
<Callout type="info">
  تستخدم سولانا أسواق الرسوم المحلية — حيث تتنافس المعاملات مع المعاملات الأخرى
  التي تكتب إلى نفس الحالة. وهذا يعني أن رسوم الدفع تظل منخفضة ويمكن التنبؤ بها
  حتى خلال فترات النشاط الشبكي المرتفع في أماكن أخرى.
</Callout>
