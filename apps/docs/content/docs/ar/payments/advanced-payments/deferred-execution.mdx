...
بذلك، يجب علينا أولاً جلب قيمة nonce من حساب nonce ثم استخدامها لتعيين العمر
الافتراضي للمعاملة.
...
المطلوبة، قم بالإرسال إلى الشبكة.
...
- تتحكم صلاحية nonce في إمكانية إبطال المعاملات. يُنصح بفصل صلاحية nonce عن
  الموقعين على المعاملات للحصول على تحكم إضافي وفصل المسؤوليات
- يمكن لـ _أي شخص_ لديه بايتات المعاملة المتسلسلة إرسالها إلى الشبكة
