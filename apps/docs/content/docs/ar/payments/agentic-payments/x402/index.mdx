...
في ما يلي قائمة بـ
[حزم SDK المتاحة لـ 402](#حزم-sdk-ودعمها-لسولانا) مع مستوى دعمها الحالي لسولانا.
...
[مثال x402 coinbase](https://github.com/x402-foundation/x402/tree/main/typescript/packages/http/paywall)
...
| [مثال أصيل](#المثال-الأصيل)       | نعم                      | مثال بسيط بدون تبعيات                       | [الأمثلة](https://github.com/Woody4618/x402-solana-examples) |
