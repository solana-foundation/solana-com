...
| [`@codama/nodes-from-anchor`](https://github.com/codama-idl/codama/tree/main/packages/nodes-from-anchor) | تحويل IDLs الخاصة بـ Anchor إلى IDLs الخاصة بـ Codama لإنشاء العملاء               |
