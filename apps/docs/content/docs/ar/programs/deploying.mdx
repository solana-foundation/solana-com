...
- **حساب البرنامج (program account)**: الحساب على السلسلة الذي يخزن البيانات
  الوصفية لبرنامجك. عنوان حساب البرنامج هو معرّف البرنامج. يخزن حساب البرنامج
  أيضًا عنوان حساب بيانات البرنامج (programdata account).
- **حساب بيانات البرنامج (programdata account)**: الحساب على السلسلة الذي يخزن
  الكود القابل للتنفيذ المنشور لبرنامجك.
- **صلاحية البرنامج**: الحساب الذي يمتلك إذن تحديث أو إغلاق البرنامج. افتراضيًا،
  هذه هي محفظة واجهة سطر الأوامر الخاصة بك.
...
معرّف البرنامج هو العنوان على السلسلة لحساب برنامجك. يستدعي المستخدمون والبرامج
الأخرى برنامجك من خلال الإشارة إلى هذا المعرّف في معاملاتهم.
...
- **`--use-rpc`**: إرسال المعاملات إلى RPC المُكوَّن. يتطلب هذا العلم اتصال RPC [مرجَّحًا بالحصة](/docs/defi/stake-weighted-qos) من مزودين مثل [Triton](https://triton.one/) أو [Helius](https://www.helius.dev/).
