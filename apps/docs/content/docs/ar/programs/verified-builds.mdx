...
يضمن استخدام [البنيات الموثّقة على سولانا](/docs/programs/verified-builds) سلامة برامجك وموثوقيتها على الشبكة، ويتيح للمطوّرين العثور على حزم SDK الخاصة بك مباشرةً من مستكشف سولانا. من خلال الاستفادة من أدوات مثل Solana Verify CLI وDocker، يمكنك الحفاظ على بنيات قابلة للتحقق وآمنة تتوافق مع الكود المصدري الخاص بك. احرص دائمًا على اتخاذ الاحتياطات اللازمة لاستخدام بيئات متسقة، وفكّر في حلول الحوكمة للترقيات والنشر الآمن.
