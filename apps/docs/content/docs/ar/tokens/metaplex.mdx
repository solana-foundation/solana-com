...
ينشئ برنامج بيانات التوكن الوصفية عنوان مشتق من البرنامج (PDA) لكل عملية سك
توكن. يخزن حساب البيانات الوصفية هذا المعلومات على السلسلة مثل اسم التوكن ورمزه،
بالإضافة إلى URI يشير إلى البيانات الوصفية بصيغة JSON خارج السلسلة (الصور
