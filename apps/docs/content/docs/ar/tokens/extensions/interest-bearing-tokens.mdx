...
description:
  إنشاء عملة برنامج Token Extension مع معدل فائدة على السلسلة، وتحديث هذا
  المعدل، وتحويل مبالغ الرموز إلى مبلغ واجهة المستخدم مع الفائدة.
...
<Callout
  type="info"
  title="تحويل المبلغ بين واجهة المستخدم خارج السلسلة وعلى السلسلة"
>
