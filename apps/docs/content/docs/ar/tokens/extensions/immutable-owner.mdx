---
title: المالك الثابت
description: تعرف على كيفية تفعيل امتداد ImmutableOwner.
---

## كيفية تفعيل امتداد ImmutableOwner
...
امتداد ImmutableOwner تغييرات الملكية لحسابات الرموز. عند تهيئة حساب رمز بهذا
الامتداد، يصبح المالك المحدد دائمًا ولا يمكن نقله إلى حساب آخر.
