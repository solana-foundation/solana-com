...
يسحب المثال التالي الرموز المميزة من الرصيد المتاح السري إلى الرصيد العام. يجب
أن يكون الحساب مُهيَّأً مسبقاً لإجراء التحويلات السرية وأن يحتوي على رصيد سري
متاح.
...
validator محلياً يعمل بالتشعيب من mainnet مثل [Surfpool](https://surfpool.run)
