...
تعتمد التحويلات السرية على برنامج ZK ElGamal Proof، والذي يكون مفعّلاً على
الشبكة الرئيسية وشبكة devnet. لا يُفعّله validator المحلي الافتراضي
`solana-test-validator`، لكن يفعله validator محلي يعمل بالتفرع من الشبكة
الرئيسية مثل [Surfpool](https://surfpool.run). شغّل المثال على إحداهما (يستخدم
الكود شبكة devnet) مع حساب ممول، واستبدل عناوين المصكوكات والحسابات النائبة
بعناوينك الخاصة.
