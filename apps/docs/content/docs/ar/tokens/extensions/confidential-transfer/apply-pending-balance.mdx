...
قبل أن يمكن تحويل الرموز بشكل سري، يجب تحويل الرصيد العام للرموز إلى رصيد سري.
يحدث هذا التحويل على مرحلتين:
...
حساب رموز إلى آخر، تتم إضافة الرموز في البداية إلى الرصيد السري المعلق. قبل أن
يمكن استخدام الرموز للتحويلات السرية، يجب "تطبيق" الرصيد المعلق على الرصيد
المتاح.
...
يوضح الرسم التخطيطي التالي الخطوات المتضمنة في تطبيق الرصيد المعلق على الرصيد
المتاح:
...
لتحويل رصيد معلق إلى رصيد متاح، قم باستدعاء تعليمة
...
التي تبني وترسل معاملة مع تعليمة `ApplyPendingBalance`، كما هو موضح في المثال
أدناه.
...
<Callout type="info">
  في وقت كتابة هذا المقال، لم يتم تفعيل التحويلات السرية على المدقق المحلي
