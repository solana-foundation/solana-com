...
امتلاك token accounts مُهيَّأة بحالة _rs`ConfidentialTransferAccount`_ ومُعتمَدة
...
يوضح المثال التالي كيفية نقل الرموز بشكل سري من حساب إلى آخر. يجب أن يكون كلا
الحسابين مُهيَّأين مسبقًا للتحويلات السرية، ويجب أن يمتلك المرسل رصيدًا سريًا
متاحًا.
...
[Surfpool](https://surfpool.run) يُفعِّله. قم بتشغيل المثال مقابل أحد هذين
