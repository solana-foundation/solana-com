...
بتعيين حالة افتراضية لجميع حسابات الرموز الجديدة التي يتم إنشاؤها لعملة معدنية.
عند تفعيلها، تقوم هذه الإضافة تلقائياً بتهيئة كل حساب رمز جديد بحالة محددة، مثل
المجمد. يتيح هذا لمنشئي الرموز فرض سلوكيات معينة، مثل طلب تجميد جميع الحسابات
الجديدة افتراضياً حتى يتم إلغاء تجميدها صراحةً.
