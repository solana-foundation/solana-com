...
حساب mint من تحديد عنوان حساب البيانات الوصفية الخاص به. يمكن لهذا المؤشر
الإشارة إلى أي حساب مملوك لبرنامج يطبق
[واجهة البيانات الوصفية للرمز المميز](https://github.com/solana-program/token-metadata/tree/main)،
