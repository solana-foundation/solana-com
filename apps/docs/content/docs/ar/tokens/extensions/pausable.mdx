...
description: تعلم كيفية تفعيل امتداد PausableMintExtension.
---

## كيفية تفعيل امتداد PausableExtension
...
لصلاحية الإيقاف المؤقت المحددة بإيقاف جميع أنشطة الرمز المميز على عملية السك.
يمكن لصلاحية الإيقاف المؤقت إيقاف أو استئناف السك في أي وقت.

عند الإيقاف المؤقت، يرفض برنامج Token-2022 جميع عمليات التحويل والسك والحرق لذلك
الرمز المميز. عند الاستئناف، تعود العمليات العادية للعمل.

هذا نمط شائع في كل من أنظمة الرموز المميزة على البلوكشين والتمويل التقليدي، حيث
تكون القدرة على تجميد النشاط ضرورية للامتثال أو الاستجابة للحوادث أو التحكم
الإداري.
