...
تقوم بمزامنة رصيد حساب رمز SOL المغلف (WSOL) مع رصيد SOL الفعلي (lamports)
المخزن فيه. عند تحويل SOL الأصلي إلى حساب رمز WSOL، لا يتم تحديث رصيد الرمز
تلقائياً. يجب عليك استدعاء SyncNative لعكس رصيد WSOL الصحيح.
