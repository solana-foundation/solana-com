...
تقوم بتغيير أو إلغاء الصلاحيات على عمليات السك وحسابات الرموز. يمكن فقط للسلطة
الحالية نقل أذوناتها إلى عنوان جديد أو إلغاؤها بشكل دائم عن طريق تعيين السلطة
إلى null. بمجرد الإلغاء، لا يمكن استعادة السلطة.
