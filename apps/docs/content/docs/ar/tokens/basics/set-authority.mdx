...
description: تعلم كيفية تعيين الصلاحية لحسابات mint أو حسابات الرموز.
---
...
- **صلاحية Mint**: تتحكم في إنشاء رموز جديدة. يمكنها إصدار رموز إلى أي حساب
  رموز. غالباً ما يتم إلغاؤها بعد إنشاء العرض الأولي لإنشاء رمز بعرض ثابت.
- **صلاحية التجميد**: تتحكم في القدرة على تجميد وإذابة حسابات الرموز. يمكنها منع
  أي حساب رموز من نقل الرموز. غالباً ما يتم إلغاؤها لضمان عدم إمكانية تجميد رموز
  المستخدمين.

### صلاحيات حساب الرموز

- **مالك الحساب**: لديه سيطرة كاملة على حساب الرموز. يمكنه نقل الرموز، وحرق
  الرموز، والموافقة على المفوضين، وإغلاق الحساب عندما يكون الرصيد صفراً.
- **صلاحية الإغلاق**: يمكنها إغلاق حساب الرموز عندما يكون رصيده صفراً. بشكل
  افتراضي، هذه الصلاحية لمالك الحساب ولكن يمكن تفويضها إلى حساب آخر.
...
تغير أو تلغي الصلاحيات على حسابات mint وحسابات الرموز. يمكن للصلاحية الحالية فقط
نقل أذوناتها إلى عنوان جديد أو إلغائها بشكل دائم عن طريق تعيين الصلاحية إلى
null. بمجرد الإلغاء، لا يمكن استعادة الصلاحية.
