...
تغلق حساب الرمز المميز بشكل دائم وتحول جميع رموز SOL المتبقية (الإيجار) إلى حساب
وجهة محدد. يجب أن يكون رصيد حساب الرمز المميز صفرًا قبل الإغلاق. يمكن فقط لمالك
حساب الرمز المميز أو سلطة الإغلاق المعينة تنفيذ هذه التعليمة.
