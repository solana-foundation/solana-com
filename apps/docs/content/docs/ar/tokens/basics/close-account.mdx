...
description: إغلاق حساب رمز مميز وإرجاع lamports الحساب إلى حساب الوجهة.
...
يؤدي إغلاق token account إلى حذف الحساب وإرجاع lamports الخاصة بـ rent إلى حساب
الوجهة.

يجب أن يكون رصيد الرموز المميزة صفراً قبل إمكانية إغلاق الحساب. يمكن إغلاق
الحساب المجمد إذا كان رصيد الرموز المميزة للحساب المجمد صفراً. حسابات الرموز
المميزة لـ SOL الملتفة هي الاستثناء ويمكن إغلاقها مع رصيد رمزي لاستعادة SOL
الأساسي. يقوم مالك الحساب أو سلطة الإغلاق الخاصة بالحساب بالتوقيع على تعليمة
الإغلاق.
