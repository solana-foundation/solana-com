---
title: حرق الرموز
description: حرق الرموز من حساب رمزي وتقليل إجمالي العرض للسك.
...
حرق الرموز يقلل بشكل دائم رصيد حساب رمزي ويقلل إجمالي العرض للسك بنفس المقدار.
...
العشرية للسك حتى تتمكن التعليمة من التحقق من دقة الرمز المتوقعة قبل الحرق.

[السك الأصلي](/docs/tokens/basics/sync-native) لا يدعم الحرق. استخدم
_rs`CloseAccount`_ بدلاً من ذلك.

مالك token account أو مفوض معتمد يوقع على المعاملة. في Token Extension Program،
يمكن للمفوض الدائم للسك أيضاً تفويض الحرق إذا كان السك يحتوي على إضافة المفوض
الدائم مفعلة.
...
| ------------------ | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_         | حالة السك تخزن إجمالي عرض الرموز.                                                                                   | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_      | حالة token account تخزن رصيد الرموز الذي يتم تقليله عن طريق الحرق.                                                  | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Burn`_         | تعليمة حرق تقلل رصيد token account وعرض السك دون مطالبة المستدعي بتوفير الكسور العشرية للسك.                        | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L178-L196) | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L221-L239) |
| _rs`BurnChecked`_  | تعليمة حرق تتطلب من المستدعي توفير الكسور العشرية للسك وتتحقق من تلك القيمة قبل تقليل رصيد token account وعرض السك. | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L326-L350) | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L393-L417) |
| _rs`process_burn`_ | منطق المعالج المشترك لحرق الرموز.                                                                                   | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L586-L668)     | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1070-L1194)   |
