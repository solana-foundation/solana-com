---
title: حرق الرموز
description: حرق الرموز من حساب رمزي وتقليل إجمالي المعروض من السك.
...
حرق الرموز يقلل بشكل دائم رصيد حساب رمزي ويقلل إجمالي المعروض من السك بنفس
المقدار.
...
الأمثلة أدناه تستخدم _rs`BurnChecked`_، والتي تتطلب من المستدعي تقديم الكسور
العشرية للسك بحيث يمكن للتعليمة التحقق من دقة الرمز المتوقعة قبل الحرق.

السك الأصلي [native mint](/docs/tokens/basics/sync-native) لا يدعم الحرق. استخدم
_rs`CloseAccount`_ بدلاً من ذلك.

مالك حساب الرمزي أو مفوض معتمد يوقع المعاملة. في Token Extension Program، يمكن
للمفوض الدائم للسك أيضاً تفويض الحرق إذا كان السك يحتوي على امتداد المفوض الدائم
مفعلاً.
...
| ------------------ | ----------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_         | حالة السك تخزن إجمالي المعروض من الرمز.                                                                           | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_      | حالة حساب الرمزي تخزن رصيد الرمز المخفض بواسطة الحرق.                                                             | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Burn`_         | تعليمة حرق تقلل رصيد حساب رمزي ومعروض السك دون مطالبة المستدعي بتقديم الكسور العشرية للسك.                        | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L178-L196) | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L221-L239) |
| _rs`BurnChecked`_  | تعليمة حرق تتطلب من المستدعي تقديم الكسور العشرية للسك وتتحقق من تلك القيمة قبل تقليل رصيد حساب رمزي ومعروض السك. | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L326-L350) | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L393-L417) |
