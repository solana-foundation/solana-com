...
تدمر الرموز بشكل دائم عن طريق تقليل الرصيد في حساب الرمز. يتم إزالة الرموز
المحروقة من التداول وتقلل من `supply` المتتبع في حساب mint. يمكن لمالك حساب
الرمز فقط حرق الرموز من حسابه.
