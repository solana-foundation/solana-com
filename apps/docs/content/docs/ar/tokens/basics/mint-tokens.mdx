...
يمكن لصلاحية السك فقط سك رموز جديدة. يجب أن يكون حساب الرموز الوجهة موجوداً
...
تستخدم الأمثلة أدناه _rs`MintToChecked`_، والتي تتطلب من المستدعي توفير الأرقام
...
| _rs`Account`_         | تخزن حالة حساب الرموز رصيد الوجهة الذي يتم تحديثه عن طريق السك.                                                | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`MintTo`_          | تعليمة سك تقوم بسك الرموز إلى حساب رموز موجود دون أن تتطلب من المستدعي توفير الأرقام العشرية للسك.             | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L159-L177) | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L202-L220) |
| _rs`MintToChecked`_   | تعليمة سك تتطلب من المستدعي توفير الأرقام العشرية للسك وتتحقق من تلك القيمة قبل سك الرموز إلى حساب رموز موجود. | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L301-L325) | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L367-L391) |
...
توضح الأمثلة `Kit` أدناه النهج الموصى به باستخدام `@solana/kit`. تم تضمين
