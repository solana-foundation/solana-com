...
يؤدي إلغاء المفوض إلى مسح المفوض الحالي لحساب الرمز وإعادة تعيين المبلغ المفوض
إلى الصفر.

بعد الإلغاء، لم يعد المفوض السابق يمتلك صلاحية نقل أو حرق الرموز نيابة عن حساب
الرمز.

## كيفية إلغاء المفوض

يستخدم إلغاء المفوض تعليمة _rs`Revoke`_ من Token Program.

تعمل تعليمة _rs`Revoke`_ على مسح حقول المفوض في حساب الرمز المصدر. في Token
Program، يقوم مالك حساب الرمز بالتوقيع على الإلغاء. في Token Extensions Program،
يمكن للمفوض الحالي أيضًا إلغاء التفويض.

### المرجع المصدري

| العنصر               | الوصف                                       | Token Program                                                                                                  | Token Extensions Program                                                                                             |
| -------------------- | ------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_        | تخزن حالة حساب الرمز المفوض والمبلغ المفوض. | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
