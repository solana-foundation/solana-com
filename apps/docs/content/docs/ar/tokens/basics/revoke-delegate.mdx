...
بإزالة جميع أذونات التحويل من المفوض المعتمد حالياً. بعد الإلغاء، لن يتمكن
المفوض من تحويل أي رموز من حسابك. بالنسبة لبرنامج الرموز (Token Program)، يمكن
لمالك حساب الرمز فقط إلغاء تفويض المفوض. بالنسبة لبرنامج امتدادات الرموز (Token
Extension Program)، يمكن لمالك حساب الرمز والمفوض الحالي إلغاء التفويض.
...
{/_ CODE_PLACEHOLDER_2a9a380a871bc36311b18a4df2b3ec0f _/
