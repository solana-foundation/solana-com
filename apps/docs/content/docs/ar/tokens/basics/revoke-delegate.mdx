...
تزيل جميع أذونات التحويل من المفوض المعتمد حالياً. بعد الإلغاء، لن يتمكن المفوض
من تحويل أي رموز مميزة من حسابك. بالنسبة لبرنامج Token Program، يمكن لمالك حساب
الرمز المميز فقط إلغاء المفوض. بالنسبة لبرنامج Token Extension Program، يمكن
لمالك حساب الرمز المميز والمفوض الحالي إلغاء التفويض.
