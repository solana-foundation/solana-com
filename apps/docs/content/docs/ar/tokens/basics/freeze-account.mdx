...
للحساب إرسال الرموز أو استقبالها حتى يتم إلغاء التجميد. يمكن إغلاق الحساب المجمد
إذا كان رصيد الرموز فيه صفراً. فقط سلطة التجميد الخاصة بسك الرمز يمكنها تجميد
الحسابات. إذا تم إلغاء سلطة التجميد (تعيينها إلى null) على mint account، فلن
يمكن تجميد الرموز أبداً.
