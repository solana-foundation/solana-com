...
جميع عمليات نقل الرموز أو حرق الرموز من حساب رموز محدد. بمجرد التجميد، لا يمكن
للحساب إرسال أو استقبال الرموز حتى يتم إلغاء تجميده. لا يزال بإمكان الحساب
المجمد أن يُغلق إذا كان رصيد الرموز فيه صفرًا. فقط سلطة التجميد الخاصة بإصدار
الرمز يمكنها تجميد الحسابات. إذا تم إلغاء سلطة التجميد (تعيينها إلى قيمة فارغة)
على حساب الإصدار، فلن يمكن تجميد الرموز أبدًا.
