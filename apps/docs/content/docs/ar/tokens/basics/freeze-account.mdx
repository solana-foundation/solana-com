...
جميع عمليات نقل الرموز أو حرق الرموز من حساب رمز معين. بمجرد التجميد، لا يمكن
للحساب إرسال الرموز أو استقبال الرموز أو إغلاقه حتى يتم إلغاء التجميد. يمكن فقط
لسلطة التجميد الخاصة بسك الرمز تجميد الحسابات. إذا تم إلغاء سلطة التجميد
(تعيينها إلى null) على حساب السك، فلن يمكن تجميد الرموز أبداً.
