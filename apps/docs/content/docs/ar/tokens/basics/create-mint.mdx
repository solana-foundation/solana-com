...
## الخطوات التالية: إضافة البيانات الوصفية

يخزن mint account فقط معلومات الرمز الأساسية (العرض، الكسور العشرية، الصلاحيات).
لإضافة بيانات وصفية قابلة للقراءة مثل الاسم والرمز والصورة إلى رمزك، لديك
خياران:

<Cards>
  <Card title="Metaplex Token Metadata" href="/docs/tokens/metaplex">
   أضف البيانات الوصفية باستخدام Metaplex Token Metadata Program. يعمل مع كل من Token Program الأصلي و Token-2022.
  </Card>
  ...
  <Card title="Token Extensions Metadata" href="/docs/tokens/extensions/metadata">
   ...
   امتداد البيانات الوصفية متاح فقط لحسابات mint المنشأة باستخدام Token-2022.
   لإضافة البيانات الوصفية إلى حسابات mint المنشأة باستخدام Token Program الأصلي، استخدم Metaplex Token Metadata Program.
  </Card>
</Cards>
...
يخزن حساب السك فقط معلومات الرمز الأساسية (الإمداد، الكسور العشرية، الصلاحيات).
لإضافة بيانات وصفية يمكن قراءتها مثل الاسم والرمز والصورة إلى رمزك المميز، لديك
خياران:

<Cards>
  <Card title="بيانات رمز Metaplex الوصفية" href="/docs/tokens/metaplex">
   أضف البيانات الوصفية باستخدام برنامج بيانات رمز Metaplex الوصفية. يعمل مع كل من Token Program الأصلي وToken-2022.
  </Card>

  <Card title="البيانات الوصفية لامتدادات الرمز" href="/docs/tokens/extensions/metadata">
   استخدم امتداد البيانات الوصفية المدمج مع Token-2022. 
   امتداد البيانات الوصفية متاح فقط لحسابات السك التي تم إنشاؤها باستخدام Token-2022.
   لإضافة بيانات وصفية إلى حسابات السك التي تم إنشاؤها باستخدام Token Program الأصلي، استخدم برنامج بيانات رمز Metaplex الوصفية.
  </Card>
</Cards>
