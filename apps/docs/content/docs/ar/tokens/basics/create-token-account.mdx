...
<Callout type="info">
  لاحظ أنه في الكود المصدري، يطلق المطورون على حساب الرمز المميز اسم `Account`
  type. كل من [Token
  ...
  يشتركان في نفس التطبيق الأساسي لحساب الرمز المميز.
</Callout>
...
- حساب الرمز المميز الخاص بـ Circle:
  `3emsAVdmGKERbHjmGfQ6oZ1e35dkf5iYcS6U4CPKFVaa`
- يحتفظ هذا الحساب برموز USDC فقط
- تتحكم Circle في الرمز المميز من خلال صلاحية مالك حساب الرمز المميز:
