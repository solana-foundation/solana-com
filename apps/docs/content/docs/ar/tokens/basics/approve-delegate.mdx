...
حساباً آخر (المفوض) إذناً لتحويل مبلغ محدد من الرموز من حساب الرموز الخاص بك.
يمكن للمفوض تحويل الرموز حتى المبلغ المعتمد، ولكن لا يمكنه تجاوزه. يمكن لمالك
حساب الرموز فقط الموافقة على مفوض، ويمكن أن يكون لكل حساب رموز مفوض واحد فقط في
كل مرة. أي موافقة جديدة تستبدل الموافقة السابقة.
