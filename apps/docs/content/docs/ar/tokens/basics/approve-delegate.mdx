...
description: تفويض عنوان آخر لنقل أو حرق كمية محدودة من الرموز من حساب رمزي.
...
## ما الذي تفعله الموافقة على المفوض؟

الموافقة على مفوض تسمح لعنوان آخر بنقل أو حرق كمية محدودة من الرموز من حساب رمزي
نيابة عن مالك الحساب الرمزي.

يخزن حساب الرموز مفوضاً واحداً حالياً ومبلغاً مفوضاً واحداً في كل مرة. الموافقة
على مفوض جديد تستبدل المفوض السابق والمخصصات على الحساب.
...
الأمثلة أدناه تستخدم _rs`ApproveChecked`_، والتي تتطلب من المُستدعي تقديم السك
والكسور العشرية حتى تتمكن التعليمة من التحقق من السك المتوقع ودقة الرمز قبل
معالجة الموافقة.

مالك الحساب الرمزي يوقع على الموافقة.

### المرجع المصدري

| العنصر                | الوصف                                                                                                                          | Token Program                                                                                                  | Token Extensions Program                                                                                             |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_         | حالة الحساب الرمزي تخزن المالك والمفوض والمبلغ المفوض.                                                                         | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Approve`_         | تعليمة الموافقة على المفوض التي تسجل المفوض والمخصصات لحساب رمزي دون مطالبة المُستدعي بتقديم السك أو الكسور العشرية.           | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L109-L127) | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L150-L168) |
| _rs`ApproveChecked`_  | تعليمة الموافقة على المفوض التي تتطلب من المُستدعي تقديم السك والكسور العشرية والتحقق من تلك القيم قبل تسجيل المفوض والمخصصات. | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L274-L300) | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L340-L366) |
...
الأمثلة القديمة التي تستخدم `@solana/web3.js` للرجوع إليها.
