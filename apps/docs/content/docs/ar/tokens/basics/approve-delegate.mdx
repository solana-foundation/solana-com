...
الموافقة على مفوض تستخدم تعليمة _rs`Approve`_ أو _rs`ApproveChecked`_ من Token
Program.

الأمثلة أدناه تستخدم _rs`ApproveChecked`_، والتي تتطلب من المستدعي تقديم السك
...
| _rs`Approve`_         | تعليمة موافقة المفوض التي تسجل المفوض والحد المسموح به لحساب رمزي دون مطالبة المستدعي بتقديم السك أو الكسور العشرية.          | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L109-L127) | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L150-L168) |
| _rs`ApproveChecked`_  | تعليمة موافقة المفوض التي تتطلب من المستدعي تقديم السك والكسور العشرية وتتحقق من هذه القيم قبل تسجيل المفوض والحد المسموح به. | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L274-L300) | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L340-L366) |
| _rs`process_approve`_ | منطق المعالج المشترك لموافقة المفوض.                                                                                          | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L344-L392)     | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L582-L640)     |
