...
description:
  قم بإلغاء تجميد حساب الرمز المجمد بحيث يمكن استئناف عمليات التحويل والحرق
  وتغييرات التفويض.
...
## ماذا يفعل إلغاء تجميد حساب الرمز؟

يؤدي إلغاء التجميد إلى تغيير حساب الرمز من الحالة المجمدة إلى الحالة المهيأة.

بعد نجاح إلغاء التجميد، يمكن للحساب تحويل الرموز وحرقها وإغلاقها مرة أخرى. فقط
سلطة التجميد الخاصة بالسك يمكنها إلغاء تجميد حسابات الرموز.

## كيفية إلغاء تجميد حساب رمز

يستخدم إلغاء تجميد حساب الرمز تعليمة _rs`ThawAccount`_ من Token Program.

تتحقق تعليمة _rs`ThawAccount`_ من أن حساب الرمز ينتمي إلى السك وأن الموقّع هو
سلطة التجميد الخاصة بالسك، ثم تغيّر حالة حساب الرمز من مجمد إلى مهيأ.

[حسابات الرموز الأصلية](/docs/tokens/basics/sync-native) لا تدعم إلغاء التجميد.

### مرجع المصدر

| العنصر                              | الوصف                                                                        | Token Program                                                                                                  | Token Extensions Program                                                                                             |
| ----------------------------------- | ---------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                          | تخزن حالة السك سلطة التجميد الاختيارية المستخدمة لإلغاء تجميد حسابات الرموز. | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`AccountState`_                  | حالات حساب الرمز، بما في ذلك _rs`Frozen`_ و _rs`Initialized`_.               | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L185-L195)       | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L203-L213)       |
| _rs`ThawAccount`_                   | تعليمة تغيّر حساب الرمز المجمد إلى الحالة المهيأة.                           | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L229-L243) | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L292-L306) |
| _rs`process_toggle_freeze_account`_ | منطق معالج مشترك لتجميد وإلغاء تجميد حسابات الرموز.                          | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L713-L754)     | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1293-L1341)   |

### TypeScript

توضح أمثلة `Kit` أدناه النهج الموصى به باستخدام `@solana/kit`. تم تضمين الأمثلة
القديمة باستخدام `@solana/web3.js` للمرجعية.
