...
تعكس عملية التجميد، وتستعيد الوظائف الكاملة لحساب الرمز المميز المجمد مسبقاً.
بعد إلغاء التجميد، يمكن للحساب مرة أخرى إرسال واستقبال الرموز المميزة بشكل
طبيعي. فقط سلطة التجميد الخاصة بإصدار الرمز المميز يمكنها إلغاء تجميد الحسابات.
