...
description:
  إلغاء تجميد حساب رمزي مجمّد لاستئناف عمليات التحويل والحرق وتغييرات التفويض.
...
## ماذا يفعل إلغاء تجميد حساب رمزي؟

يُغيّر إلغاء التجميد حالة حساب رمزي من الحالة المجمّدة إلى الحالة المُهيأة.

بعد نجاح إلغاء التجميد، يمكن للحساب نقل الرموز وحرقها وإغلاقها مرة أخرى. فقط
صلاحية التجميد الخاصة بالنعناع يمكنها إلغاء تجميد الحسابات الرمزية.

## كيفية إلغاء تجميد حساب رمزي

يستخدم إلغاء تجميد حساب رمزي تعليمة _rs`ThawAccount`_ من Token Program.

تتحقق تعليمة _rs`ThawAccount`_ من أن الحساب الرمزي ينتمي إلى النعناع وأن الموقّع
هو صلاحية التجميد الخاصة بالنعناع، ثم تُغيّر حالة الحساب الرمزي من مجمّد إلى
مُهيأ.

[الحسابات الرمزية الأصلية](/docs/tokens/basics/sync-native) لا تدعم إلغاء
التجميد.
...
| ----------------------------------- | --------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                          | تُخزّن حالة النعناع صلاحية التجميد الاختيارية المُستخدمة لإلغاء تجميد الحسابات الرمزية. | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`AccountState`_                  | حالات الحساب الرمزي، بما في ذلك _rs`Frozen`_ و _rs`Initialized`_.                       | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L185-L195)       | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L203-L213)       |
| _rs`ThawAccount`_                   | تعليمة تُغيّر حساباً رمزياً مجمّداً إلى الحالة المُهيأة.                                | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L229-L243) | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L292-L306) |
| _rs`process_toggle_freeze_account`_ | منطق المعالج المشترك لتجميد وإلغاء تجميد الحسابات الرمزية.                              | [المصدر](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L713-L754)     | [المصدر](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1293-L1341)   |
