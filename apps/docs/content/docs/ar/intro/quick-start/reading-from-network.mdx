...
حقل `rentEpoch` هو حقل قديم من آلية إيجار متوقفة. (تم تضمين هذا الحقل للتوافق مع
الإصدارات السابقة.)
...
توفر معظم برامج سولانا مكتبات عميل مع دوال مساعدة تجرد عملية إلغاء التسلسل. تقوم
هذه الدوال بتحويل بايتات الحساب الخام إلى أنواع بيانات منظمة، مما يجعل العمل مع
بيانات الحساب أسهل.
