...
اقرأ البيانات من شبكة سولانا من خلال جلب حسابات مختلفة. سيساعدك هذا القسم على
فهم بنية [الحسابات](/docs/core/accounts) في سولانا. كل حساب في سولانا له
[عنوان](/docs/core/accounts#account-address) فريد يُستخدم لتحديد موقع البيانات
المقابلة له على السلسلة. تحتوي الحسابات إما على
