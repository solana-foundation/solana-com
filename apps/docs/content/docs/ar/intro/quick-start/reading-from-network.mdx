...
اقرأ البيانات من شبكة سولانا عن طريق جلب حسابات مختلفة. يشرح هذا الدليل
بنية [حسابات](/docs/core/accounts) سولانا. لكل حساب من حسابات سولانا
عنوان فريد
[يُستخدم لتحديد](/docs/core/accounts/account-structure#account-address) موقع البيانات المخزنة على السلسلة الخاصة بالحساب. تحتوي حسابات سولانا إما على
