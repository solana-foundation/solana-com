...
description:
  تعلم كيفية بناء برنامج CRUD (إنشاء، قراءة، تحديث، حذف) على سولانا باستخدام
  Program Derived Address والإطار Anchor. يوضح هذا الدليل خطوة بخطوة كيفية إنشاء
  وتحديث وحذف حسابات الرسائل على السلسلة باستخدام PDAs، وتنفيذ التحقق من
  الحسابات، وكتابة الاختبارات. مثالي للمطورين الذين يرغبون في فهم كيفية استخدام
