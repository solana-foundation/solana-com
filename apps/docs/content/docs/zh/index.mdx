...
以下 SDK 由 [Anza](https://anza.xyz) 构建，是 Solana 的官方 SDK。
...
<Callout type="warn">
  社区 SDK 可能不是最新版本，或不包含官方 SDK 的全部功能。
</Callout>

## 运行 validator

了解如何运行 Solana validator 并帮助保障网络安全。
