---
title: 账户管理
description: 在 TypeScript 中管理账户、余额和 rent 的方法
---
...
<Callout type="info">
  批量设置账户时，使用 `setAccount` 比 `airdrop` 更快，因为它
  无需执行交易。
</Callout>
