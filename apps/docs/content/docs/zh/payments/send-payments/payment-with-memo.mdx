---
title: 带备注的支付
description: 了解如何为支付附加发票 ID 或备注信息。
---

Solana的备忘录程序允许您在任何支付中附加发票号、订单ID或自定义引用。这些备忘录会永久记录在链上，并在交易日志中可见，使您可以轻松将支付与内部系统匹配。
...
<CodePlaceholder title="带有 Memo 的支付" />
