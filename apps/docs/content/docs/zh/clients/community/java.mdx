...
title: Java SDK
description:
  了解如何使用 Java SDK (sava-software/sava) 与 Solana 交互。
h1: Solana 的 Java SDK
---

[Sava Engineering](https://sava.software/welcome) 构建了一个
[Java SDK](https://sava.engineering/)，支持与 Solana 交互的大多数功能。如果您在为 Solana 程序使用 Anchor，您可以使用
