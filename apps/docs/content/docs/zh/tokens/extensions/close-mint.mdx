...
该
[/_ INLINE_CODE_PLACEHOLDER_7c7774f80b85b0778d5e517fd4fdb8f1 _/](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L569)
扩展允许关闭 mint 账户并回收其 rent。此扩展必须在创建 mint 时进行初始化。
