---
title: 可暂停铸造
description: 了解如何启用 PausableMintExtension。
---

## 如何启用 PausableExtension
...
允许指定的暂停权限方暂停某个 mint 上的所有代币活动。暂停权限方可以随时暂停或恢复该 mint。

当被暂停时，Token-2022 程序会拒绝该代币的所有转账、铸造和销毁操作。解除暂停后，所有操作将恢复正常。

这种模式在区块链代币系统和传统金融中都很常见，需要具备冻结活动的能力以满足合规、事件响应或管理控制等需求。
