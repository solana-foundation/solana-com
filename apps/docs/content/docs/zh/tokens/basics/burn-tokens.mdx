---
title: 销毁代币
description: 从代币账户中销毁代币并减少铸造账户的总供应量。
...
销毁代币会永久减少代币账户余额,并将铸造账户的总供应量减少相同数量。

## 如何销毁代币

销毁代币使用 Token Program 的 _rs`Burn`_ 或 _rs`BurnChecked`_ 指令。

下面的示例使用
_rs`BurnChecked`_,它要求调用者提供铸造账户的小数位数,以便指令在销毁前验证预期的代币精度。

[原生铸造账户](/docs/tokens/basics/sync-native)不支持销毁。请改用
_rs`CloseAccount`_。

代币账户所有者或已批准的委托人签署交易。在 Token Extensions
Program 中,如果铸造账户启用了永久委托人扩展,铸造永久委托人也可以授权销毁。

### 源代码参考

| 项目               | 描述                                                                                     | Token Program                                                                                                  | Token Extensions Program                                                                                             |
| ------------------ | ---------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_         | 铸造账户状态存储代币总供应量。                                                           | [源代码](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [源代码](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_      | 代币账户状态存储因销毁而减少的代币余额。                                                 | [源代码](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [源代码](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Burn`_         | 销毁指令,减少代币账户余额和铸造供应量,无需调用者提供铸造账户的小数位数。                 | [源代码](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L178-L196) | [源代码](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L221-L239) |
| _rs`BurnChecked`_  | 销毁指令,要求调用者提供铸造账户的小数位数,并在减少代币账户余额和铸造供应量之前检查该值。 | [源代码](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L326-L350) | [源代码](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L393-L417) |
| _rs`process_burn`_ | 代币销毁的共享处理器逻辑。                                                               | [源代码](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L586-L668)     | [源代码](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1070-L1194)   |
