---
title: 销毁代币
description: 从代币账户销毁代币并减少铸币的总供应量。
...
下面的示例使用
_rs`BurnChecked`_,它要求调用者提供铸币的小数位数,以便指令在销毁前可以验证预期的代币精度。

[原生铸币](/docs/tokens/basics/sync-native)不支持销毁。请使用 _rs`CloseAccount`_
代替。

代币账户所有者或获批准的委托人签署交易。在 Token Extensions
Program 中,如果铸币启用了永久委托人扩展,铸币的永久委托人也可以授权销毁。
...
| _rs`Burn`_         | 减少代币账户余额和铸币供应量的销毁指令,无需调用者提供铸币的小数位数。              | [源代码](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L178-L196) | [源代码](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L221-L239) |
| _rs`BurnChecked`_  | 需要调用者提供铸币小数位数并在减少代币账户余额和铸币供应量之前检查该值的销毁指令。 | [源代码](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L326-L350) | [源代码](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L393-L417) |
