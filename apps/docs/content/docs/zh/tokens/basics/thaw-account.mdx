...
解冻操作会将代币账户从冻结状态恢复到已初始化状态。

解冻成功后,该账户可以再次进行代币转账、销毁和关闭操作。只有铸币厂的冻结权限持有者才能解冻代币账户。

## 如何解冻代币账户

解冻代币账户使用 Token Program 的 _rs`ThawAccount`_ 指令。

_rs`ThawAccount`_
指令会验证该代币账户是否属于该铸币厂,以及签名者是否为铸币厂的冻结权限持有者,然后将代币账户状态从冻结状态恢复到已初始化状态。
...
| ----------------------------------- | ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                          | 铸币厂状态存储用于解冻代币账户的可选冻结权限。        | [源代码](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [源代码](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`AccountState`_                  | 代币账户状态,包括 _rs`Frozen`_ 和 _rs`Initialized`_。 | [源代码](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L185-L195)       | [源代码](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L203-L213)       |
| _rs`ThawAccount`_                   | 将已冻结的代币账户恢复到已初始化状态的指令。          | [源代码](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L229-L243) | [源代码](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L292-L306) |
| _rs`process_toggle_freeze_account`_ | 用于冻结和解冻代币账户的共享处理器逻辑。              | [源代码](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L713-L754)     | [源代码](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1293-L1341)   |
