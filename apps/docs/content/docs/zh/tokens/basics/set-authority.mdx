...
该
[指令](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/instruction.rs#L153)
用于更改或撤销 mint 和 token 账户的权限。只有当前权限持有者才能将其权限转移到新地址，或通过将权限设置为 null 永久撤销。一旦撤销，权限将无法恢复。
