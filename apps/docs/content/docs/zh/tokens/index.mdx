...
创建 ATA 需要为其账户存储缴纳可退还的最低余额。
该指令的付款方负责支付该余额，即使 ATA 由其他钱包持有也是如此。请参阅
[ATA 费用与付款方](/docs/tokens/basics/create-token-account#cost-and-payer)
了解当前费用及 Token-2022 的大小差异。
