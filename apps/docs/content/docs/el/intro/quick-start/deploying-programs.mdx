...
Η διεύθυνση onchain του προγράμματός σας. Θα ενημερωθεί όταν κάνετε build το
έργο
...
- Η μακροεντολή [`declare_id!`](mention:one) καθορίζει τη διεύθυνση onchain του
...
<Callout>
  Το [αναγνωριστικό προγράμματος](/docs/intro/quick-start/build-first-program)
  σας, που ορίζεται στο _rs`declare_id!()`_, θα ενημερωθεί τώρα.
</Callout>

2. Προσθήκη SOL στο πορτοφόλι σας _(Προαιρετικό)_

Η ανάπτυξη ενός προγράμματος απαιτεί SOL στον λογαριασμό onchain του
...
Κλείστε το πρόγραμμα για να ανακτήσετε το SOL που έχει εκχωρηθεί στο onchain
...
[διευθύνσεις παραγόμενες από προγράμματα](/docs/core/pda) και
[διαπρογραμματική κλήση](/docs/core/cpi).
