...
επίκληση μεταξύ προγραμμάτων (Cross Program Invocation - CPI).
...
Στην εντολή `update`, η υλοποίηση περιλαμβάνει μια επίκληση μεταξύ προγραμμάτων
(Cross Program Invocation - CPI) για να επικαλεστεί την εντολή `transfer` του
System Program. Αυτό δείχνει πώς να εκτελέσετε ένα CPI από μέσα στο πρόγραμμα,
επιτρέποντας τη συνθεσιμότητα των προγραμμάτων Solana.
...
- Το πρόγραμμα που θα επικληθεί (System Program)
...
Η συνάρτηση `transfer` στη συνέχεια επικαλείται την εντολή μεταφοράς στο System
Program, περνώντας:
...
instruction data για μια συγκεκριμένη εντολή που θα επικληθεί. Όταν η εντολή
`update` του προγράμματος λάβει μια επίκληση, επικαλείται εσωτερικά την εντολή
μεταφοράς του System Program.
...
και τη συμπερίληψή του στις κλήσεις των εντολών update και delete.
