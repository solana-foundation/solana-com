...
[λογαριασμών](/docs/core/accounts) του Solana. Κάθε λογαριασμός Solana διαθέτει
μια μοναδική [διεύθυνση](/docs/core/accounts#account-address) που
χρησιμοποιείται για τον εντοπισμό των αντίστοιχων δεδομένων onchain. Οι
λογαριασμοί περιέχουν είτε
...
[loader program](/docs/core/programs#loader-programs) του. Σε αυτό το
