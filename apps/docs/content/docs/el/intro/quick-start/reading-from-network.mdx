...
[διεύθυνση](/docs/core/accounts/account-structure#account-address) που
χρησιμοποιείται για τον εντοπισμό των onchain δεδομένων του λογαριασμού. Οι
λογαριασμοί Solana περιέχουν είτε
[δεδομένα κατάστασης είτε εκτελέσιμο πρόγραμμα](/docs/core/accounts/account-types).
