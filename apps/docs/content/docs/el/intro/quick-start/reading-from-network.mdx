...
Διαβάστε δεδομένα από το δίκτυο Solana ανακτώντας διάφορους λογαριασμούς. Αυτός ο οδηγός
εξηγεί τη δομή των [λογαριασμών](/docs/core/accounts) Solana. Κάθε λογαριασμός Solana
έχει μια μοναδική
[διεύθυνση](/docs/core/accounts/account-structure#account-address) που χρησιμοποιείται για την
εύρεση των onchain δεδομένων του λογαριασμού. Οι λογαριασμοί Solana περιέχουν είτε
[δεδομένα κατάστασης είτε ένα εκτελέσιμο πρόγραμμα](/docs/core/accounts/account-types).
