...
<Callout type="caution" title="Μην χρησιμοποιείτε δημόσιο RPC για παραγωγή">
  Τα δημόσια endpoints (`api.mainnet.solana.com`, `api.devnet.solana.com`) έχουν
  περιορισμό ρυθμού, δεν διαθέτουν SLA και δεν είναι κατάλληλα για ροές πληρωμών παραγωγής.
  Χρησιμοποιήστε έναν [πάροχο RPC](https://solana.com/rpc) για να αποκτήσετε ένα ιδιωτικό endpoint RPC
