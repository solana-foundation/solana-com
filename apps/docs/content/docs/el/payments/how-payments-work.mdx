...
Στο Solana, τα προγράμματα είναι εκτελέσιμη λογική που διέπει την κατάσταση των
λογαριασμών. Οι λογαριασμοί token διαχειρίζονται από ένα **Token Program**—τον
onchain κώδικα που επαληθεύει τις μεταφορές και ενημερώνει τα υπόλοιπα ατομικά.
...
Το Token-2022 (γνωστό και ως "Token Extensions") προσθέτει λειτουργίες όπως transfer hooks,
τέλη μεταφοράς και Εμπιστευτικά Υπόλοιπα. Και τα δύο προγράμματα λειτουργούν παρόμοια για βασικές
μεταφορές, αλλά πρέπει να χρησιμοποιείτε το σωστό κατά την παραγωγή ATAs.
...
<Callout type="info">
  Το Solana χρησιμοποιεί τοπικές αγορές τελών — οι συναλλαγές ανταγωνίζονται με άλλες συναλλαγές
  που γράφουν στην ίδια κατάσταση. Αυτό σημαίνει ότι τα τέλη πληρωμής παραμένουν χαμηλά και προβλέψιμα
  ακόμα και κατά τη διάρκεια περιόδων υψηλής δικτυακής δραστηριότητας αλλού.
</Callout>
...
<Cards>
  ...
  <Card title="Στείλτε την πρώτη σας πληρωμή" href="/docs/payments/send-payments">
