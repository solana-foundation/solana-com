...
description:
  Μάθετε πώς λειτουργεί η χορηγία προμηθειών και υλοποιήστε την αφαίρεση προμηθειών με το Kora.
---
...
<Cards>
  ...
  <Card title="Πλήρης Επίδειξη Συναλλαγής" href="/docs/tools/kora/guides/full-demo">
