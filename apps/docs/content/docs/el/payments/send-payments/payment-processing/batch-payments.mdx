...
aυξάνει το όριο μεγέθους στα 4096 bytes, που χωράει περίπου τρεις φορές περισσότερες
μεταφορές ανά συναλλαγή. Η ομαδοποίηση εξακολουθεί να απαιτείται πέραν αυτού, καθώς το
περιβάλλον εκτέλεσης φορτώνει το πολύ 64 λογαριασμούς ανά συναλλαγή ανεξαρτήτως μορφής.
