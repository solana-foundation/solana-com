...
Αφού παραγάγετε τη διεύθυνση ATA, ελέγξτε αν υπάρχει ο λογαριασμός token
onchain. Αν το ATA δεν υπάρχει, μπορείτε να συμπεριλάβετε μια εντολή για τη
δημιουργία του λογαριασμού token του παραλήπτη στην ίδια συναλλαγή με τη
μεταφορά. Ωστόσο, αυτό απαιτεί την καταβολή rent για τον νέο λογαριασμό token.
Εφόσον ο παραλήπτης κατέχει το ATA, το SOL που καταβλήθηκε για το rent δεν
μπορεί να ανακτηθεί από τον αποστολέα.
