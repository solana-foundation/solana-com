...
Αντί να χρησιμοποιήσετε ένα πρόσφατο blockhash που λήγει, χρησιμοποιήστε την
τιμή nonce:
...
Κάθε durable nonce συναλλαγή **πρέπει** να περιλαμβάνει `advanceNonceAccount` ως
την πρώτη της οδηγία. Αυτό αποτρέπει επιθέσεις επανάληψης ακυρώνοντας την τιμή
nonce μετά τη χρήση και ενημερώνοντας την τιμή nonce.
...
<Callout type="caution">
  ...
  ή αποφασίσετε να μην την υποβάλετε, πρέπει να προωθήσετε το nonce πριν
...
- Δημιουργήστε ένα σύνολο λογαριασμών nonce για παράλληλη προετοιμασία
  συναλλαγών
