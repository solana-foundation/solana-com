...
<Callout type="caution">
  Το Commerce Kit βρίσκεται αυτή τη στιγμή σε beta έκδοση. Τα APIs ενδέχεται να
  αλλάξουν πριν από τη σταθερή κυκλοφορία. Για περισσότερες λεπτομέρειες, δείτε
  την [τεκμηρίωση του Commerce Kit](/docs/tools/commerce-kit).
</Callout>
