...
(`api.mainnet.solana.com`) έχουν περιορισμό ρυθμού χωρίς SLA. Είναι κατάλληλα για
ανάπτυξη, αλλά θα αποτύχουν σε ροές πληρωμών παραγωγής—όπως το να προσπαθείς να εκτελέσεις έναν επεξεργαστή πληρωμών μέσω ενός κοινόχρηστου API χωρίς εγγύηση διαθεσιμότητας.

<Callout type="caution" title="Ποτέ μην χρησιμοποιείτε δημόσιο RPC για παραγωγή">
...
- [Οδηγός: Επιβεβαίωση & Λήξη Συναλλαγών](https://solana.com/developers/cookbook/transactions/confirmation)
