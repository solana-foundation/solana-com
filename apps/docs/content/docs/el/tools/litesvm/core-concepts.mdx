---
title: Γιατί LiteSVM
description: Κατανοήστε πώς λειτουργεί το LiteSVM και γιατί είναι διαφορετικό
---

## Επισκόπηση

Σκεφτείτε το LiteSVM ως ένα Solana VM που τρέχει μέσα στη συνάρτηση δοκιμής σας.
Όχι ως ξεχωριστή διεργασία, όχι ως υπηρεσία δικτύου - είναι απλώς μια κλήση
βιβλιοθήκης στον κώδικά σας.

### Παραδοσιακός Έλεγχος
...
### 1. Όλα είναι Σύγχρονα

Χωρίς `async`, χωρίς `await`, χωρίς καθυστερήσεις:
...
### 2. Άμεση Χειραγώγηση Κατάστασης
...
### 3. Ο Χρόνος Είναι Υπό Τον Έλεγχό Σας
...
### 4. Τα Σφάλματα Είναι Άμεσα και Σαφή
...
<Tabs items={["Rust", "TypeScript"]} groupId="litesvm-lang">
  <Tab value="Rust">
    **[Δοκιμή του Προγράμματός Σας
    ...
    →](/docs/tools/litesvm/api-reference)** Μάθετε για προχωρημένες δυνατότητες
    και προσαρμοσμένες ρυθμίσεις
  </Tab>
  <Tab value="TypeScript">
    **[Δοκιμή του Προγράμματός Σας
    ...
    →](/docs/tools/litesvm/typescript/api-reference)** Μάθετε για προχωρημένες
    δυνατότητες και προσαρμοσμένες ρυθμίσεις
  </Tab>
</Tabs>
