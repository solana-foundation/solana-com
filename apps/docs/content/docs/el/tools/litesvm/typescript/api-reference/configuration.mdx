...
Το LiteSVM χρησιμοποιεί το μοτίβο builder για τη διαμόρφωση. Όλες οι μέθοδοι επιστρέφουν `LiteSVM`
για αλυσίδωση.
...
<Callout type="info">
  Η απενεργοποίηση της επαλήθευσης υπογραφής κάνει τις δοκιμές πιο γρήγορες αλλά λιγότερο ρεαλιστικές.
</Callout>
...
Ενεργοποίηση ενσωματωμένων προγραμμάτων (επαλήθευση υπογραφής ed25519, secp256k1).
