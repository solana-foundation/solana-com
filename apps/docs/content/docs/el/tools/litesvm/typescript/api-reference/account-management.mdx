...
description:
  Μέθοδοι για τη διαχείριση λογαριασμών, υπολοίπων και rent σε TypeScript
---

# Διαχείριση Λογαριασμών

Μέθοδοι για τη διαχείριση λογαριασμών, υπολοίπων και ρύθμιση κατάστασης
λογαριασμού.
...
Χρηματοδότηση ενός λογαριασμού με lamport.
...
Άμεση ρύθμιση κατάστασης λογαριασμού χωρίς συναλλαγή.
...
| `programAddress` | `Address`    | Πρόγραμμα ιδιοκτήτη                 |
...
Υπολογισμός του ελάχιστου αριθμού lamport που απαιτούνται για απαλλαγή από rent.
...
Φόρτωση προγράμματος από διαδρομή αρχείου τύπου `.so`.
...
Για δοκιμές, μπορείτε να ρυθμίσετε πολλούς λογαριασμούς αποτελεσματικά:
...
<Callout type="info">
  Η χρήση `setAccount` είναι ταχύτερη από `airdrop` για μαζική ρύθμιση
  λογαριασμών, καθώς δεν εκτελεί συναλλαγές.
</Callout>
