...
ένα καλό πρώτο τεστ για να επαληθεύσετε ότι η ρύθμιση του LiteSVM σας λειτουργεί πριν δοκιμάσετε πιο σύνθετη
λογική προγράμματος.
...
<Callout type="info">
  Το τελικό υπόλοιπο του αποστολέα είναι ελαφρώς μικρότερο από 9 SOL λόγω των τελών συναλλαγής
  (5.000 lamport ανά υπογραφή).
</Callout>

Αυτό καλύπτει τον απλούστερο τύπο συναλλαγής. Για δοκιμές με προσαρμοσμένα προγράμματα, δείτε
[Δοκιμή Προγραμμάτων](/docs/tools/litesvm/typescript/examples/program-testing). Για
μεταφορές token (mints, ATAs), δείτε
