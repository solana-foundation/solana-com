...
description: Μέθοδοι για τη διαχείριση λογαριασμών, υπολοίπων και rent
---
...
Όπου το `TransactionResult` είναι
`Result<TransactionMetadata, FailedTransactionMetadata>`.

Χρηματοδοτήστε έναν λογαριασμό με lamports. Επιστρέφει μεταδεδομένα συναλλαγής
...
Άμεσος ορισμός κατάστασης λογαριασμού.
...
Λήψη υπολοίπου lamport λογαριασμού. Επιστρέφει `None` αν ο λογαριασμός δεν
υπάρχει.
...
Υπολογισμός των ελάχιστων lamports που απαιτούνται για απαλλαγή από rent.
