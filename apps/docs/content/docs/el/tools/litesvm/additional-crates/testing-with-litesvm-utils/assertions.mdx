...
title: Ισχυρισμοί
description:
  Επαληθεύστε καταστάσεις λογαριασμών, υπόλοιπα και ιδιοκτησία με βοηθούς
  ισχυρισμών
---

## Ύπαρξη Λογαριασμού

Επαληθεύστε αν οι λογαριασμοί υπάρχουν ή έχουν κλειστεί.

### Ισχυρισμός Ύπαρξης Λογαριασμού
...
### Ισχυρισμός Κλεισίματος Λογαριασμού
...
<Callout type="info">
  `assert_account_closed` επιτυγχάνει όταν ένας λογαριασμός είτε δεν υπάρχει,
  έχει μηδενικά lamports, ή έχει κενά δεδομένα. Χρησιμοποιήστε το για να
  επαληθεύσετε τον καθαρισμό μετά το κλείσιμο λογαριασμών.
</Callout>

## Ισχυρισμοί Υπολοίπου

Επαληθεύστε υπόλοιπα SOL και token.

### Ισχυρισμός Υπολοίπου SOL
...
Επαληθεύστε ιδιοκτησία λογαριασμού και ιδιότητες δεδομένων.

### Ισχυρισμός Ιδιοκτήτη Λογαριασμού
...
### Ισχυρισμός Μήκους Δεδομένων Λογαριασμού
...
<Callout type="info">
  Κοινά μεγέθη λογαριασμών: - **Λογαριασμός Mint**: 82 bytes - **token
  account**: 165 bytes - **Λογαριασμός Συστήματος**: 0 bytes (μόνο lamports)
</Callout>

## Πλήρες Παράδειγμα

Ακολουθεί ένα ολοκληρωμένο τεστ που επιδεικνύει πολλαπλές διαβεβαιώσεις:
...
## Διαχείριση Αποτυχιών Διαβεβαίωσης

Όταν μια διαβεβαίωση αποτυγχάνει, θα προκαλέσει panic με ένα περιγραφικό μήνυμα:
...
<Callout type="warn">
  Οι διαβεβαιώσεις είναι σχεδιασμένες να αποτυγχάνουν γρήγορα με σαφή μηνύματα
  σφάλματος. Χρησιμοποιήστε τις ελεύθερα σε όλα τα τεστ σας για να εντοπίζετε
  προβλήματα έγκαιρα.
</Callout>
