---
title: Τυπικές Συναρτήσεις
description: Βοηθητικές συναρτήσεις διαθέσιμες στην τυπική βιβλιοθήκη
---

Αυτές οι συναρτήσεις είναι διαθέσιμες σε όλα τα Runbooks ως μέρος της τυπικής
βιβλιοθήκης.

## Τελεστές

Βασικοί μαθηματικοί και τελεστές σύγκρισης:
