...
Η διεπαφή `SolanaSigner` επεκτείνει τους τύπους `@solana/signers` για πλήρη
συμβατότητα:
...
## Δημιουργία Προσαρμοσμένων Υπογραφέων

Υλοποιήστε τη διεπαφή `SolanaSigner` για να δημιουργήσετε προσαρμοσμένους
υπογραφείς:
