...
Ανοίξτε πέντε τερματικά και εκτελέστε τις παρακάτω εντολές:
...
- Μπορείτε προαιρετικά να ορίσετε έναν προσαρμοσμένο υπεύθυνο πληρωμής τελών για τη δημιουργία ATA χρησιμοποιώντας τη σημαία
  `--fee-payer-key`.
