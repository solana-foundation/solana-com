...
seoTitle: Ενσωμάτωση πορτοφολιού Solana με Next.js και @solana/react-hooks
description:
  Ρυθμίστε την ενσωμάτωση πορτοφολιού Solana στο Next.js με @solana/client και
  @solana/react-hooks για να στέλνετε μεταφορές SOL.
---
...
- [Αποθετήριο Framework Kit](https://github.com/solana-foundation/framework-kit)
...
στοιχεία να μπορούν να έχουν πρόσβαση στην κατάσταση πορτοφολιού και στα hooks.
...
Οι συνδέσεις είναι το ίδιο σύνολο Wallet Standard
(Phantom/Solflare/Backpack/αυτόματη ανακάλυψη)· μόλις συνδεθείτε, οι μεταφορές
SOL χρησιμοποιούν τον συνδεδεμένο υπογράφοντα.
