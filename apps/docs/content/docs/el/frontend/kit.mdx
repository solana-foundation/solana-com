...
Ρυθμίστε μια ελάχιστη ενσωμάτωση πορτοφολιού Solana στο Next.js με το Solana
Kit.

Αυτός ο οδηγός παρέχει ένα ελάχιστο παράδειγμα υλοποίησης λειτουργικότητας
πορτοφολιού Solana σε μια εφαρμογή Next.js χρησιμοποιώντας το `@solana/kit`. Θα
...
- [Τεκμηρίωση Solana Kit](https://www.solanakit.com/docs)
- [Αποθετήριο GitHub του Solana Kit](https://github.com/anza-xyz/kit)
...
στοιχεία διεπαφής χρήστη και εγκαταστήστε τις απαιτούμενες εξαρτήσεις Solana.
...
## !!steps 1. Δημιουργία Solana Context
...
- Φιλτράρει για διαθέσιμα πορτοφόλια Solana εγκατεστημένα στον browser του
  χρήστη
...
- Δημιουργεί μια συναλλαγή Solana με μια εντολή που επικαλείται το πρόγραμμα
  memo
...
<Callout type="info">
  ...
  SOL](https://faucet.solana.com/) για να στέλνει συναλλαγές.
</Callout>
