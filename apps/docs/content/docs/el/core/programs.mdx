...
Στο Solana, ένα smart contract ονομάζεται πρόγραμμα. Ένα πρόγραμμα είναι ένας
...
ονομάζονται οδηγίες (instructions). Οι χρήστες αλληλεπιδρούν με ένα πρόγραμμα
στέλνοντας μια [συναλλαγή](/docs/core/transactions) (transaction) που περιέχει
μία ή περισσότερες [οδηγίες](/docs/core/instructions) (instructions). Μια
συναλλαγή μπορεί να περιλαμβάνει οδηγίες από πολλαπλά προγράμματα.
...
[ανέπτυξε το πρόγραμμα](/docs/programs/deploying).) Αν η αρχή αναβάθμισης
...
| [Μεταφορά SOL](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/system/src/system_processor.rs#L215)                     | Μεταφέρει lamports (SOL) από System Accounts σε άλλους λογαριασμούς.                                                                                                                                                                                                          |

Η διεύθυνση του System Program είναι {/_
INLINE_CODE_PLACEHOLDER_4b162a2099efe9ee0654eed9565b21a8 _}.
...
| v4       | `LoaderV411111111111111111111111111111111111` | Υπό ανάπτυξη (μη κυκλοφορημένο)                                                                                                                 | [Οδηγίες](https://docs.rs/solana-loader-v4-interface/latest/solana_loader_v4_interface/instruction/enum.LoaderV4Instruction.html)          |
