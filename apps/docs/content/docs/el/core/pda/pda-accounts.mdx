...
description:
  Δημιουργήστε λογαριασμούς onchain σε διευθύνσεις Solana PDA χρησιμοποιώντας το
  invoke_signed και τον περιορισμό init του Anchor. Ροή επαλήθευσης
  invoke_signed και μοτίβα δημιουργίας PDA στο Anchor με παραδείγματα κώδικα.
