...
Η χρέωση προτεραιότητας είναι ένα προαιρετικό τέλος που αυξάνει την προτεραιότητα χρονοπρογραμματισμού
μιας συναλλαγής. Μια μονάδα υπολογισμού (CU) είναι μια μονάδα υπολογισμού που το περιβάλλον εκτέλεσης
μετράει κατά την εκτέλεση της συναλλαγής. Κάθε λειτουργία (αριθμητική, πρόσβαση μνήμης,
syscall) κοστίζει έναν σταθερό αριθμό CU. Μπορείτε να ορίσετε τη χρέωση προτεραιότητας
συμπεριλαμβάνοντας οδηγίες προϋπολογισμού υπολογισμού στη συναλλαγή σας. (Δείτε τον
[Οδηγό Χρήσης Τελών Προτεραιότητας](/docs/core/fees) για λεπτομέρειες.)
...
<Callout type="info" title="Οι συναλλαγές v1 ορίζουν το τέλος απευθείας">
  Αυτός ο τύπος τιμή-επί-όριο ισχύει για τις συναλλαγές legacy και v0. Στην επερχόμενη [μορφή
  v1](/docs/core/transactions/versioned-transactions#v1-message-format), το τέλος προτεραιότητας είναι ένα απόλυτο σύνολο σε lamports που ορίζεται απευθείας στη διαμόρφωση του μηνύματος — χωρίς τιμή ανά CU, χωρίς πολλαπλασιασμό, χωρίς στρογγυλοποίηση.
</Callout>
