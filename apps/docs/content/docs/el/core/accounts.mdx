...
- [`owner`](mention:owner): Το ID του προγράμματος που κατέχει τον λογαριασμό
- [`executable`](mention:executable): Υποδεικνύει αν ο λογαριασμός περιέχει
  εκτελέσιμο binary
...
Αυτό το πεδίο αναφέρεται συνήθως ως "δεδομένα λογαριασμού". Το `data` σε αυτό το
πεδίο θεωρείται αυθαίρετο καθώς μπορεί να περιέχει οποιαδήποτε ακολουθία bytes.
Κάθε πρόγραμμα ορίζει τη δομή των δεδομένων που αποθηκεύονται σε αυτό το πεδίο.
...
1. Ανάκτηση του λογαριασμού χρησιμοποιώντας τη [διεύθυνσή](#account-address) του
...
Κάθε λογαριασμός Solana έχει ένα [πρόγραμμα](/docs/core/programs) ορισμένο ως
κάτοχός του. Ο κάτοχος του λογαριασμού είναι το μόνο πρόγραμμα που μπορεί να
αλλάξει το `data` του λογαριασμού ή να αφαιρέσει lamports, όπως υποδεικνύεται
από τις οδηγίες του προγράμματος.
...
- Αν `true`: Ο λογαριασμός είναι λογαριασμός προγράμματος
...
Τα προγράμματα που αναπτύσσονται χρησιμοποιώντας το loader-v3 δεν περιέχουν
κώδικα προγράμματος στο πεδίο `data` τους. Αντίθετα, το πεδίο `data` τους
δείχνει σε έναν ξεχωριστό **λογαριασμό δεδομένων προγράμματος**, ο οποίος
...
Δεν εκχωρούνται όλοι οι λογαριασμοί σε νέο κάτοχο μετά τη δημιουργία τους από το
System Program. Οι λογαριασμοί που ανήκουν στο System Program ονομάζονται
...
Στο παρακάτω παράδειγμα, δημιουργείται ένα νέο ζεύγος κλειδιών και
χρηματοδοτείται με SOL. Αφού εκτελέσετε τον κώδικα, μπορείτε να δείτε ότι η
διεύθυνση του πεδίου `owner` του λογαριασμού είναι
`11111111111111111111111111111111` (το
