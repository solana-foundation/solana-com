...
4. **Ανύπαρκτοι λογαριασμοί**: Οι λογαριασμοί που δεν υπάρχουν onchain
   φορτώνονται ως προεπιλεγμένοι λογαριασμοί (0 lamport, κενά δεδομένα,
   ιδιοκτησία του System Program) με `rent_epoch` ορισμένο σε `u64::MAX`.
