...
- [`accounts`](mention:accounts): Ένας πίνακας από
  [μεταδεδομένα λογαριασμού](#account-metadata)
...
- [is_signer](mention:is-signer): Ορίζεται σε `true` εάν ο λογαριασμός πρέπει να
  υπογράψει τη συναλλαγή
- [is_writable](mention:is-writable): Ορίζεται σε `true` εάν η εντολή τροποποιεί
