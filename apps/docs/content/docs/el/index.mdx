...
Τα ακόλουθα SDKs είναι τα επίσημα SDKs για το Solana που δημιουργήθηκαν από την
[Anza](https://anza.xyz).
...
<Cards>
  <Card title="Validators" href="https://docs.anza.xyz/validator/anatomy">
    Μεμονωμένοι κόμβοι που ασφαλίζουν το δίκτυο της Solana
  </Card>
  <Card
    title="Απαιτήσεις συστήματος"
    href="https://docs.anza.xyz/operations/requirements"
  >
    Συνιστώμενες απαιτήσεις υλικού και SOL που απαιτούνται για τη λειτουργία
    ενός validator
  </Card>
  <Card
