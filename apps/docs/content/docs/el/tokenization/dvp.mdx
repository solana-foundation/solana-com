...
Οι συναλλαγές Solana έχουν όριο μεγέθους (~1232 bytes). Κάθε εντολή μεταφοράς
προσθέτει ~200 bytes. Για διακανονισμούς πολλών μερών σε μεγάλη κλίμακα, εξετάστε τη χρήση
[Address Lookup Tables](/developers/cookbook/transactions/lookup-tables) για
συμπίεση διευθύνσεων λογαριασμών και την ενσωμάτωση περισσότερων μεταφορών ανά συναλλαγή.

Η επερχόμενη
[μορφή συναλλαγών v1](/docs/core/transactions/versioned-transactions#v1-message-format)
ανεβάζει το όριο στα 4096 bytes, αλλά καταργεί την υποστήριξη Address Lookup Table, οπότε οι διακανονισμοί v1
ενσωματώνουν απευθείας τις διευθύνσεις τους. Σε κάθε περίπτωση, το περιβάλλον εκτέλεσης φορτώνει κατά ανώτατο όριο
64 λογαριασμούς ανά συναλλαγή.
