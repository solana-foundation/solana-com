...
Το Token Metadata Program δημιουργεί μια Program Derived Address (PDA) για κάθε
token mint. Αυτός ο λογαριασμός μεταδεδομένων αποθηκεύει onchain πληροφορίες
όπως το όνομα και το σύμβολο του token, καθώς και ένα URI που δείχνει σε
off-chain JSON μεταδεδομένα (εικόνες, περιγραφές, κ.λπ.).
...
Ο onchain λογαριασμός μεταδεδομένων περιέχει:
