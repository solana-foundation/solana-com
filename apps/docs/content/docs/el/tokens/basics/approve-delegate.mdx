...
παρέχει σε έναν άλλο λογαριασμό (τον εκπρόσωπο) άδεια να μεταφέρει ένα
συγκεκριμένο ποσό tokens από τον λογαριασμό tokens σας. Ο εκπρόσωπος μπορεί να
μεταφέρει tokens μέχρι το εγκεκριμένο ποσό, αλλά δεν μπορεί να το υπερβεί. Μόνο
ο κάτοχος του λογαριασμού tokens μπορεί να εγκρίνει έναν εκπρόσωπο, και κάθε
λογαριασμός tokens μπορεί να έχει μόνο έναν εκπρόσωπο τη φορά. Κάθε νέα έγκριση
