...
description:
  Εξουσιοδοτήστε μια άλλη διεύθυνση να μεταφέρει ή να καταστρέψει περιορισμένο
  αριθμό tokens από έναν λογαριασμό token.
...
Η έγκριση αντιπροσώπου επιτρέπει σε μια άλλη διεύθυνση να μεταφέρει ή να
καταστρέψει περιορισμένο αριθμό tokens από έναν λογαριασμό token εκ μέρους του
κατόχου του λογαριασμού token.

Ένας λογαριασμός token αποθηκεύει έναν τρέχοντα αντιπρόσωπο και ένα
εξουσιοδοτημένο ποσό κάθε φορά. Η έγκριση ενός νέου αντιπροσώπου αντικαθιστά τον
προηγούμενο αντιπρόσωπο και το επιτρεπόμενο όριο στον λογαριασμό.
...
μπορεί να επαληθεύσει το αναμενόμενο mint και την ακρίβεια του token πριν από
την επεξεργασία της έγκρισης.
