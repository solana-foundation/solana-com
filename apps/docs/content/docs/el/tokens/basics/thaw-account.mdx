...
αναιρεί το πάγωμα, αποκαθιστώντας την πλήρη λειτουργικότητα σε έναν λογαριασμό
token που είχε παγώσει προηγουμένως. Μετά το ξεπάγωμα, ο λογαριασμός μπορεί και
πάλι να στέλνει και να λαμβάνει tokens κανονικά. Μόνο η αρχή πάγωσης του mint
του token μπορεί να ξεπαγώσει λογαριασμούς.
