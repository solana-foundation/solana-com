...
Μετά την επιτυχή ξεπάγωση, ο λογαριασμός μπορεί να λαμβάνει, να μεταφέρει και να
καταστρέφει tokens ξανά. Μόνο η αρχή πάγωσης του mint μπορεί να ξεπαγώσει token
accounts.
