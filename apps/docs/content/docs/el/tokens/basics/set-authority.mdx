...
description:
  Αλλαγή ή ανάκληση ρόλων εξουσιοδότησης σε λογαριασμό mint ή token,
  συμπεριλαμβανομένης της εξουσιοδότησης mint, freeze, owner και close.
...
## Τι Κάνει η Ρύθμιση Εξουσιοδότησης;

Η ρύθμιση εξουσιοδότησης αλλάζει ή ανακαλεί συγκεκριμένους ρόλους εξουσιοδότησης
σε λογαριασμό mint ή token.

Οι λογαριασμοί mint μπορούν να αποθηκεύουν εξουσιοδότηση mint και εξουσιοδότηση
freeze. Οι λογαριασμοί token αποθηκεύουν έναν owner και μπορούν προαιρετικά να
αποθηκεύσουν εξουσιοδότηση close. Κάθε ρόλος ελέγχει ένα συγκεκριμένο σύνολο
δικαιωμάτων, και η ρύθμιση μιας εξουσιοδότησης σε _rs`None`_ αφαιρεί οριστικά
τον επιλεγμένο ρόλο εξουσιοδότησης.

Το Token Extensions Program ορίζει επίσης επιπλέον τύπους εξουσιοδότησης για
συγκεκριμένες επεκτάσεις.

## Πώς να Ρυθμίσετε την Εξουσιοδότηση
...
Η τρέχουσα εξουσιοδότηση υπογράφει την αλλαγή, και η νέα εξουσιοδότηση μπορεί να
είναι μια άλλη διεύθυνση ή _rs`None`_ για να ανακληθεί οριστικά η επιλεγμένη
εξουσιοδότηση.
...
| _rs`SetAuthority`_          | Μια εντολή που αλλάζει ή ανακαλεί μία εξουσιοδότηση σε λογαριασμό mint ή token. | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L141-L158) | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L183-L200)   |
| _rs`process_set_authority`_ | Κοινή λογική επεξεργαστή για ενημερώσεις εξουσιοδότησης.                        | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L423-L518)     | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L677-L978)       |
