...
description:
  Αλλαγή ή ανάκληση ρόλων εξουσιοδότησης σε λογαριασμό mint ή token account,
  συμπεριλαμβανομένων των εξουσιοδοτήσεων mint, freeze, owner και close.
...
Ο ορισμός εξουσιοδότησης αλλάζει ή ανακαλεί συγκεκριμένους ρόλους εξουσιοδότησης
σε έναν λογαριασμό mint ή token account.

Οι λογαριασμοί mint μπορούν να αποθηκεύουν μια εξουσιοδότηση mint και μια
εξουσιοδότηση freeze. Οι λογαριασμοί token account αποθηκεύουν έναν owner και
μπορούν προαιρετικά να αποθηκεύουν μια εξουσιοδότηση close. Κάθε ρόλος ελέγχει
ένα συγκεκριμένο σύνολο δικαιωμάτων, και ο ορισμός μιας εξουσιοδότησης σε
_rs`None`_ αφαιρεί οριστικά τον επιλεγμένο ρόλο εξουσιοδότησης.

Το Token Extensions Program ορίζει επίσης πρόσθετους τύπους εξουσιοδότησης για
συγκεκριμένες επεκτάσεις.

## Πώς να Ορίσετε Εξουσιοδότηση

Η αλλαγή μιας εξουσιοδότησης χρησιμοποιεί την εντολή _rs`SetAuthority`_ του
Token Program.

Κάθε κλήση ενημερώνει έναν τύπο εξουσιοδότησης σε έναν λογαριασμό mint ή token
account. Η τρέχουσα εξουσιοδότηση υπογράφει την αλλαγή, και η νέα εξουσιοδότηση
μπορεί να είναι μια άλλη διεύθυνση ή _rs`None`_ για να ανακληθεί οριστικά η
επιλεγμένη εξουσιοδότηση.

### Αναφορά Πηγής

| Στοιχείο                    | Περιγραφή                                                                               | Token Program                                                                                                | Token Extensions Program                                                                                             |
| --------------------------- | --------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                  | Η κατάσταση mint αποθηκεύει _rs`mint_authority`_ και _rs`freeze_authority`_.            | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)           |
| _rs`Account`_               | Η κατάσταση token account αποθηκεύει _rs`owner`_ και _rs`close_authority`_.             | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)          |
| _rs`AuthorityType`_         | Οι ρόλοι εξουσιοδότησης που μπορεί να ενημερώσει η _rs`SetAuthority`_.                  | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L739-L751) | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L1116-L1157) |
| _rs`SetAuthority`_          | Μια εντολή που αλλάζει ή ανακαλεί μία εξουσιοδότηση σε λογαριασμό mint ή token account. | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L141-L158) | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L183-L200)   |
| _rs`process_set_authority`_ | Κοινή λογική επεξεργασίας για ενημερώσεις εξουσιοδότησης.                               | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L423-L518)     | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L677-L978)       |
