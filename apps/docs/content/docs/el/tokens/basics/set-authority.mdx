...
description: Μάθετε πώς να ορίζετε εξουσιοδότηση για mints ή token accounts.
---
...
- **Mint authority**: Ελέγχει τη δημιουργία νέων tokens. Μπορεί να κάνει mint
  tokens σε οποιοδήποτε token account. Συχνά ανακαλείται μετά τη δημιουργία της
  αρχικής προσφοράς για να δημιουργηθεί ένα token σταθερής προσφοράς.
- **Freeze authority**: Ελέγχει τη δυνατότητα πάγωσης και απόψυξης token
  accounts. Μπορεί να εμποδίσει οποιοδήποτε token account από τη μεταφορά
  tokens. Συχνά ανακαλείται για να εγγυηθεί στους χρήστες ότι τα tokens τους δεν
  μπορούν να παγώσουν.

### Εξουσιοδοτήσεις token account

- **Account owner**: Έχει πλήρη έλεγχο του token account. Μπορεί να μεταφέρει
  tokens, να κάψει tokens, να εγκρίνει delegates και να κλείσει το account όταν
  το υπόλοιπο είναι μηδέν.
- **Close authority**: Μπορεί να κλείσει το token account όταν το υπόλοιπό του
  είναι μηδέν. Από προεπιλογή, αυτός είναι ο κάτοχος του account αλλά μπορεί να
  ανατεθεί σε άλλο account.
...
αλλάζει ή ανακαλεί εξουσιοδοτήσεις σε mints και token accounts. Μόνο η τρέχουσα
εξουσιοδότηση μπορεί να μεταφέρει τα δικαιώματά της σε μια νέα διεύθυνση ή να τα
ανακαλέσει οριστικά ορίζοντας την εξουσιοδότηση σε null. Μόλις ανακληθεί, η
εξουσιοδότηση δεν μπορεί να αποκατασταθεί.
