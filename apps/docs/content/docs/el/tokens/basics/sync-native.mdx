...
συγχρονίζει το υπόλοιπο ενός λογαριασμού token wrapped SOL (WSOL) με τα
πραγματικά SOL (lamports) που είναι αποθηκευμένα σε αυτόν. Όταν μεταφέρετε
native SOL σε έναν λογαριασμό token WSOL, το υπόλοιπο του token δεν ενημερώνεται
αυτόματα. Πρέπει να καλέσετε την SyncNative για να αντικατοπτρίσετε το σωστό
υπόλοιπο WSOL.
