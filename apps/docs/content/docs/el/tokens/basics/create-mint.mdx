...
`EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v`. Αυτή η διεύθυνση αναγνωρίζει
...
## Επόμενα Βήματα: Προσθήκη Μεταδεδομένων

Ένας λογαριασμός mint αποθηκεύει μόνο βασικές πληροφορίες token (προσφορά,
δεκαδικά ψηφία, εξουσίες). Για να προσθέσετε μεταδεδομένα που μπορούν να
διαβαστούν από ανθρώπους, όπως όνομα, σύμβολο και εικόνα στο token σας, έχετε
δύο επιλογές:

<Cards>
  <Card title="Metaplex Token Metadata" href="/docs/tokens/metaplex">
   Προσθέστε μεταδεδομένα χρησιμοποιώντας το Metaplex Token Metadata Program. Λειτουργεί και με το αρχικό Token Program και με το Token-2022.
  </Card>
