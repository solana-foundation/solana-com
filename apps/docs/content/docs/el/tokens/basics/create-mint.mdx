...
description:
  Δημιουργήστε ένα token mint και ρυθμίστε τα δεκαδικά ψηφία, την αρχή έκδοσης
  και την αρχή δέσμευσης του mint.
...
αποθηκεύει την κοινή κατάσταση που ισχύει για όλους τους λογαριασμούς token για
αυτό το mint.
...
μοναδικά το USDC σε όλο το οικοσύστημα Solana. Μπορείτε να δείτε αυτό το mint
στο
...
Token Program γράφει την αρχή έκδοσης, την αρχή δέσμευσης, τα δεκαδικά ψηφία και
τη σημαία _rs`is_initialized`_ στα δεδομένα του λογαριασμού mint.
...
| _rs`process_initialize_mint`_  | Δημόσιος χειριστής για το _rs`InitializeMint`_.                                                     | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L62-L70)       | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L132-L140)     |
| _rs`process_initialize_mint2`_ | Δημόσιος χειριστής για το _rs`InitializeMint2`_.                                                    | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L72-L81)       | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L142-L151)     |

### Typescript

Τα παρακάτω παραδείγματα `Kit` δείχνουν την προτεινόμενη προσέγγιση
χρησιμοποιώντας `@solana/kit`. Τα παλαιότερα παραδείγματα που χρησιμοποιούν
...
δεκαδικά, αρχές). Για να προσθέσετε αναγνώσιμα από τον άνθρωπο μεταδεδομένα όπως
όνομα, σύμβολο και εικόνα στο token σας, έχετε δύο επιλογές:

<Cards>
  <Card title="Metaplex Token Metadata" href="/docs/tokens/metaplex">
   Προσθέστε μεταδεδομένα χρησιμοποιώντας το Metaplex Token Metadata Program. Λειτουργεί και με τα δύο, το αρχικό Token Program και το Token-2022.
  </Card>
