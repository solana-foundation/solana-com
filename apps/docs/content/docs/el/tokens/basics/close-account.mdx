...
description:
  Κλείστε έναν λογαριασμό token και επιστρέψτε τα lamports του λογαριασμού σε
  έναν λογαριασμό προορισμού.
...
Το κλείσιμο ενός λογαριασμού token διαγράφει τον λογαριασμό και επιστρέφει τα
lamports ενοικίου (rent) του λογαριασμού token σε έναν λογαριασμό προορισμού.

Το υπόλοιπο token πρέπει να είναι μηδέν πριν ο λογαριασμός μπορέσει να κλείσει.
Ένας παγωμένος λογαριασμός μπορεί ακόμα να κλείσει εάν το υπόλοιπο token του
παγωμένου λογαριασμού είναι μηδέν. Οι λογαριασμοί Wrapped SOL token αποτελούν
την εξαίρεση και μπορούν να κλείσουν με υπόλοιπο token για να ανακτηθεί το
υποκείμενο SOL. Ο κάτοχος του λογαριασμού ή η εξουσία κλεισίματος του
λογαριασμού υπογράφει την εντολή κλεισίματος.
...
Η εντολή _rs`CloseAccount`_ μεταφέρει τα lamports του λογαριασμού προέλευσης σε
έναν λογαριασμό προορισμού, διαγράφει τον λογαριασμό προέλευσης και διαγράφει
τον λογαριασμό προέλευσης. Το Token Extensions Program εφαρμόζει πρόσθετους
ελέγχους κλεισίματος για ορισμένες επεκτάσεις, αλλά η βασική ροή κλεισίματος
είναι η ίδια.
...
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| _rs`Account`_               | Η κατάσταση του λογαριασμού token αποθηκεύει το υπόλοιπο, την εγγενή κατάσταση και την εξουσία κλεισίματος που χρησιμοποιούνται κατά το κλείσιμο του λογαριασμού. | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
...
χρησιμοποιώντας `@solana/kit`. Παλαιού τύπου παραδείγματα χρησιμοποιώντας
