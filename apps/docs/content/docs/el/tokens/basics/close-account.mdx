...
lamports ενοικίου του λογαριασμού token σε έναν λογαριασμό προορισμού.

Το υπόλοιπο token πρέπει να είναι μηδέν προτού μπορέσει να κλείσει ο
λογαριασμός. Ένας δεσμευμένος λογαριασμός μπορεί ακόμα να κλείσει εάν το
υπόλοιπο token του δεσμευμένου λογαριασμού είναι μηδέν. Οι λογαριασμοί token
Wrapped SOL αποτελούν την εξαίρεση και μπορούν να κλείσουν με υπόλοιπο token για
να ανακτηθεί το υποκείμενο SOL. Ο κάτοχος του λογαριασμού ή η εξουσία
κλεισίματος του λογαριασμού υπογράφει την εντολή κλεισίματος.
