...
- Πρέπει να υπάρχει ένας λογαριασμός token προορισμού για να λάβει τα
  δημιουργημένα tokens
...
async fn main() -> Result<()> {
    ...
    // Δημιουργία νέου keypair για τον fee payer
    let fee_payer = Keypair::new();

    // Airdrop 1 SOL στον fee payer
    ...
    // Λήψη προεπιλεγμένου μεγέθους λογαριασμού mint (σε bytes), χωρίς ενεργοποιημένες επεκτάσεις
    ...
    // Εντολή για αρχικοποίηση δεδομένων λογαριασμού mint
    ...
    let create_ata_instruction = create_associated_token_account(
        &fee_payer.pubkey(), // διεύθυνση χρηματοδότησης
        &fee_payer.pubkey(), // διεύθυνση πορτοφολιού
        &mint.pubkey(),      // διεύθυνση mint
        &token_program_id(), // program id
    );
...
{/* CODE_PLACEHOLDER_8c5e6d9f3a2b1e4d7c8f9a0b1c2d3e4f */}
