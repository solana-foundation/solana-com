...
## Τι Κάνει η Δημιουργία Tokens;

Η δημιουργία tokens δημιουργεί νέες μονάδες ενός υπάρχοντος token και αυξάνει τη
συνολική προσφορά του mint.
...
από τον καλούντα να παρέχει τα δεκαδικά ψηφία του mint ώστε η εντολή να μπορεί
να επαληθεύσει την αναμενόμενη ακρίβεια του token πριν από τη δημιουργία.
...
| --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| _rs`Mint`_            | Η κατάσταση του mint αποθηκεύει την εξουσία δημιουργίας και τη συνολική προσφορά token.                                                                                      | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_         | Η κατάσταση του token account αποθηκεύει το υπόλοιπο προορισμού που ενημερώνεται με τη δημιουργία.                                                                           | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`MintTo`_          | Μια εντολή δημιουργίας που δημιουργεί tokens σε ένα υπάρχον token account χωρίς να απαιτεί από τον καλούντα να παρέχει τα δεκαδικά ψηφία του mint.                           | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L159-L177) | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L202-L220) |
| _rs`MintToChecked`_   | Μια εντολή δημιουργίας που απαιτεί από τον καλούντα να παρέχει τα δεκαδικά ψηφία του mint και ελέγχει αυτήν την τιμή πριν τη δημιουργία tokens σε ένα υπάρχον token account. | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L301-L325) | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L367-L391) |
...
χρησιμοποιώντας το `@solana/kit`. Παραδείγματα παλαιού τύπου χρησιμοποιώντας το
