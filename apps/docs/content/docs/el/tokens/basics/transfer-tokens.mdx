...
description:
  Μεταφέρετε tokens μεταξύ token accounts για το ίδιο mint με εντολές μεταφοράς
  του Token Program.
...
τα υπόλοιπα μεταξύ των token accounts.

## Πώς να Μεταφέρετε Tokens

Η μεταφορά tokens χρησιμοποιεί την εντολή _rs`Transfer`_ ή _rs`TransferChecked`_
του Token Program.

Τα παρακάτω παραδείγματα χρησιμοποιούν την _rs`TransferChecked`_, η οποία
απαιτεί από τον καλούντα να παρέχει το mint και τα δεκαδικά ψηφία ώστε η εντολή
να επαληθεύσει το αναμενόμενο mint και την ακρίβεια του token πριν μετακινήσει
tokens μεταξύ accounts.

Στο Token Extension Program, η _rs`Transfer`_ είναι παρωχημένη και προτιμώνται
οι _rs`TransferChecked`_ ή _rs`TransferCheckedWithFee`_.

Ο ιδιοκτήτης του source account ή ένας εγκεκριμένος αντιπρόσωπος υπογράφει τη
μεταφορά. Στο Token Extension Program, ένας μόνιμος αντιπρόσωπος του mint μπορεί
επίσης να εξουσιοδοτήσει τη μεταφορά εάν το mint έχει ενεργοποιημένη την
...
| _rs`Transfer`_         | Εντολή μεταφοράς που μετακινεί tokens μεταξύ token accounts χωρίς να απαιτεί από τον καλούντα να παρέχει το mint ή τα δεκαδικά ψηφία. Στο Token Extension Program, χρησιμοποιήστε αντί αυτού την _rs`TransferChecked`_. | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L89-L108)  | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L121-L149) |
| _rs`TransferChecked`_  | Εντολή μεταφοράς που απαιτεί από τον καλούντα να παρέχει το mint και τα δεκαδικά ψηφία και ελέγχει αυτές τις τιμές πριν μετακινήσει tokens μεταξύ token accounts του ίδιου mint.                                        | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L245-L273) | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L308-L339) |
| _rs`process_transfer`_ | Κοινή λογική επεξεργαστή για μεταφορές tokens.                                                                                                                                                                          | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L227-L341)     | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L308-L579)     |
