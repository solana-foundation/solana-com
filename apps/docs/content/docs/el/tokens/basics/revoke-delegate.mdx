...
description:
  Αφαιρέστε τον τρέχοντα εκπρόσωπο ενός token account και μηδενίστε το
  εναπομένον αντιπροσωπευόμενο ποσό.
...
Η ανάκληση εκπροσώπου διαγράφει τον τρέχοντα εκπρόσωπο του token account και
επαναφέρει το αντιπροσωπευόμενο ποσό στο μηδέν.

Μετά την ανάκληση, ο προηγούμενος εκπρόσωπος δεν έχει πλέον εξουσία να μεταφέρει
ή να καταστρέψει tokens εκ μέρους του token account.

## Πώς να Ανακαλέσετε Εκπρόσωπο

Η ανάκληση εκπροσώπου χρησιμοποιεί την οδηγία _rs`Revoke`_ του Token Program.

Η οδηγία _rs`Revoke`_ διαγράφει τα πεδία του εκπροσώπου στο token account
προέλευσης. Στο Token Program, ο κάτοχος του token account υπογράφει την
...
| -------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| _rs`Account`_        | Η κατάσταση του token account αποθηκεύει τον εκπρόσωπο και το αντιπροσωπευόμενο ποσό. | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Revoke`_         | Οδηγία που αφαιρεί τον τρέχοντα εκπρόσωπο από ένα token account.                      | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L128-L140) | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L170-L182) |
| _rs`process_revoke`_ | Κοινή λογική επεξεργαστή για την ανάκληση εκπροσώπου.                                 | [Πηγή](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L395-L420)     | [Πηγή](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L643-L674)     |
