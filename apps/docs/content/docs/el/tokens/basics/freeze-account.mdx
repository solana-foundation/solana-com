...
Το πάγωμα ενός token account διατηρεί τον ίδιο ιδιοκτήτη, mint και υπόλοιπο,
αλλά αποτρέπει τον token account από το να μεταφέρει ή να κάψει tokens μέχρι ο
token account να αποπαγώσει.
