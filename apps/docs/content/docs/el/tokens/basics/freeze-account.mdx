...
λογαριασμό token. Μόλις παγώσει, ο λογαριασμός δεν μπορεί να στείλει token, να
λάβει token ή να κλείσει μέχρι να ξεπαγώσει. Μόνο η αρχή πάγωσης του mint του
token μπορεί να παγώσει λογαριασμούς. Εάν η αρχή πάγωσης ανακληθεί (οριστεί σε
null) στον λογαριασμό mint, τα token δεν μπορούν ποτέ να παγώσουν.
