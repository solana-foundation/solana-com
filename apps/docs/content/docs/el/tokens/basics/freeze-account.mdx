...
αποτρέπει όλες τις μεταφορές token ή την καταστροφή token από έναν συγκεκριμένο
λογαριασμό token. Μόλις παγώσει, ο λογαριασμός δεν μπορεί να στείλει token ή να
λάβει token έως ότου ξεπαγώσει. Ένας παγωμένος λογαριασμός μπορεί ακόμα να
κλείσει εάν έχει μηδενικό υπόλοιπο token. Μόνο η αρχή πάγωσης του mint account
του token μπορεί να παγώσει λογαριασμούς. Εάν η αρχή πάγωσης ανακληθεί (οριστεί
σε null) στον λογαριασμό mint, τα token δεν μπορούν ποτέ να παγώσουν.
