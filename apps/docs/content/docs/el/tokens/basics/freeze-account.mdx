...
αποτρέπει όλες τις μεταφορές ή καταστροφές tokens από έναν συγκεκριμένο
λογαριασμό token. Όταν παγώσει, ο λογαριασμός δεν μπορεί να στείλει tokens ή να
λάβει tokens μέχρι να ξεπαγώσει. Ένας παγωμένος λογαριασμός μπορεί ακόμα να
κλείσει εάν έχει μηδενικό υπόλοιπο tokens. Μόνο η αρχή πάγωσης του mint account
του token μπορεί να παγώσει λογαριασμούς. Εάν η αρχή πάγωσης ανακληθεί (οριστεί
σε null) στον λογαριασμό mint, τα tokens δεν μπορούν ποτέ να παγώσουν.
