...
- Τα [Token Programs](#token-programs) περιέχουν όλη τη λογική εντολών για την
...
είναι ουσιαστικά
[data accounts](/docs/core/accounts/account-types#data-accounts) που ανήκουν σε
ένα Token Program.
...
Υπάρχουν δύο τρόποι για να προσθέσετε μεταδεδομένα (όνομα, σύμβολο, εικόνα) σε
tokens στο Solana:

1. **[Metaplex Token Metadata](/docs/tokens/metaplex)** - Δημιουργεί έναν
   ξεχωριστό λογαριασμό μεταδεδομένων συνδεδεμένο με το mint σας. Λειτουργεί με
   το αρχικό Token Program και το Token-2022 και υποστηρίζεται ευρέως από
   πορτοφόλια και αγορές.

2. **[Token Extensions Metadata](/docs/tokens/extensions/metadata)** -
   Αποθηκεύει μεταδεδομένα απευθείας στον mint account χρησιμοποιώντας το
   Token-2022. Μια νεότερη προσέγγιση με ενσωματωμένη υποστήριξη. Η επέκταση
   μεταδεδομένων είναι διαθέσιμη μόνο για mint accounts που δημιουργήθηκαν με το
   Token-2022. Για να προσθέσετε μεταδεδομένα σε mint accounts που
   δημιουργήθηκαν με το αρχικό Token Program, χρησιμοποιήστε το Metaplex Token
   Metadata Program.

#### Παράδειγμα SPL Token CLI

Το Token Extensions Program σας επιτρέπει να αποθηκεύετε μεταδεδομένα απευθείας
στον Mint Account. Για να δημιουργήσετε ένα token με την επέκταση μεταδεδομένων:
...
Το URI του token συνδέεται με εκτός αλυσίδας μεταδεδομένα. Δείτε ένα παράδειγμα
μορφής JSON
...
Μάθετε περισσότερα στην ενότητα
[Token Extensions](/docs/tokens/extensions/metadata). Για λεπτομέρειες σχετικά
με τα Token Extensions, δείτε την ενότητα
[Token Extensions](/docs/tokens/extensions) και την
