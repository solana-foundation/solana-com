...
ορίζει μια προεπιλεγμένη κατάσταση για όλους τους νέους λογαριασμούς token που
δημιουργούνται για ένα mint. Όταν ενεργοποιηθεί, αυτή η επέκταση αρχικοποιεί
αυτόματα κάθε νέο λογαριασμό token με μια καθορισμένη κατάσταση, όπως παγωμένη.
Αυτό επιτρέπει στους δημιουργούς token να επιβάλλουν συγκεκριμένες συμπεριφορές,
όπως να απαιτούν όλοι οι νέοι λογαριασμοί να είναι παγωμένοι από προεπιλογή
μέχρι να ξεπαγώσουν ρητά.
