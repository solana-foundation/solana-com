...
αυτόματα κάθε νέο λογαριασμό token με μια καθορισμένη κατάσταση, όπως frozen.
Αυτό επιτρέπει στους δημιουργούς token να επιβάλλουν συγκεκριμένες συμπεριφορές,
όπως να απαιτείται όλοι οι νέοι λογαριασμοί να είναι frozen από προεπιλογή μέχρι
να ξεπαγώσουν ρητά.
