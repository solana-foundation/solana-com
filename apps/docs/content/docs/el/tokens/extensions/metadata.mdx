...
δίνει τη δυνατότητα σε ένα mint account να καθορίσει τη διεύθυνση του
λογαριασμού μεταδεδομένων του. Αυτός ο δείκτης μπορεί να αναφέρεται σε
...
παρέχοντας ευελιξία ως προς το πού αποθηκεύονται τα μεταδεδομένα.
