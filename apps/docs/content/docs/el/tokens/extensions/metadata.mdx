...
description:
  Δημιουργήστε ένα mint που αποθηκεύει μεταδεδομένα απευθείας στο λογαριασμό mint χρησιμοποιώντας τις επεκτάσεις MetadataPointer και TokenMetadata, και στη συνέχεια ενημερώστε, αφαιρέστε και κλειδώστε αυτά τα μεταδεδομένα μέσω της διεπαφής token-metadata.
...
Το παρακάτω παράδειγμα `Kit` χρησιμοποιεί απευθείας τις παραγόμενες οδηγίες. Παλαιότερα
παραδείγματα που χρησιμοποιούν `@solana/web3.js`, `@solana/spl-token` και
`@solana/spl-token-metadata` περιλαμβάνονται για αναφορά. Τα παλαιότερα παραδείγματα ορίζουν
το `maxSupportedTransactionVersion` στο `0` επειδή το web3.js v1 δεν μπορεί να αποσειριοποιήσει
