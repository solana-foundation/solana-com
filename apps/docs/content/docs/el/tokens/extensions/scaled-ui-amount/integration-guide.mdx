...
- Αν χρειάζεται να γνωρίζετε το UI Amount για ένα αυθαίρετο ποσό μπορείτε να
  λάβετε αυτόν τον υπολογισμό καλώντας τη
  [`amountToUiAmountForMintWithoutSimulation`](https://github.com/solana-program/token-2022/blob/main/clients/js-legacy/src/actions/amountToUiAmount.ts#L164)
  (web3.js v1) συνάρτηση ή προσομοιώνοντας μια συναλλαγή χρησιμοποιώντας το
  amountToUiAmount.
...
- Οι χρήστες θα πρέπει να εισάγουν ποσά που θα ερμηνευτούν ως το κλιμακωμένο
  ...
  - Για να κάνετε αυτήν τη μετατροπή μπορείτε να χρησιμοποιήσετε τη
...
- Ο τρέχων πολλαπλασιαστής μπορεί να διαβαστεί από το token mint ανά πάσα στιγμή
  καλώντας το `getAccountInfo`. Επιπλέον, αν έχει οριστεί ένας μελλοντικός
