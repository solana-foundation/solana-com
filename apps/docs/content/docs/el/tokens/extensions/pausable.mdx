---
title: Παυσίμη κοπής
description: Μάθετε πώς να ενεργοποιήσετε το PausableMintExtension.
---

## Πώς να ενεργοποιήσετε το PausableExtension
...
επιτρέπει σε μια καθορισμένη αρχή παύσης να διακόψει όλη τη δραστηριότητα token
σε ένα mint. Η αρχή παύσης μπορεί να παύσει ή να αναπαύσει το mint ανά πάσα
στιγμή.

Όταν είναι σε παύση, το πρόγραμμα Token-2022 απορρίπτει όλες τις μεταφορές,
κοπές και καύσεις για αυτό το token. Όταν αναπαύεται, οι κανονικές λειτουργίες
συνεχίζονται.

Αυτό είναι ένα κοινό μοτίβο τόσο στα συστήματα blockchain token όσο και στα
παραδοσιακά χρηματοοικονομικά, όπου η δυνατότητα παγώματος της δραστηριότητας
είναι απαραίτητη για συμμόρφωση, αντίδραση σε περιστατικά ή διοικητικό έλεγχο.
