...
ορίζει ένα mint ως group mint (όπως ένα Collection NFT) δείχνοντας σε έναν
...
όπως η αρχή ενημέρωσης και το μέγιστο μέγεθος.
...
ορίζει ένα mint ως member mint (όπως ένα NFT σε μια συλλογή) δείχνοντας σε έναν
λογαριασμό που περιέχει
...
όπως η διεύθυνση ομάδας και ο αριθμός μέλους.
