...
ενεργοποιεί την αυτόματη συλλογή προμηθειών σε κάθε μεταφορά token. Οι
προμήθειες συσσωρεύονται στους λογαριασμούς token του παραλήπτη και μπορούν να
αποσυρθούν από την αρχή ανάληψης που έχει οριστεί στον λογαριασμό mint.
