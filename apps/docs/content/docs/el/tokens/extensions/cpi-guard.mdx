...
προστατεύει τους λογαριασμούς token από απροσδόκητες μεταφορές μέσω Cross
Program Invocations (CPIs). Όταν είναι ενεργοποιημένη, αυτή η επέκταση
...
προγράμματα από το να μεταφέρουν tokens μέσω CPI.
