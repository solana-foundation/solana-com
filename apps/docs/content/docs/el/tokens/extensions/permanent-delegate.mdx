...
αναθέτει έναν εκπρόσωπο με εξουσία σε όλους τους λογαριασμούς token για ένα
mint. Σε αντίθεση με τους κανονικούς εκπροσώπους που οι κάτοχοι λογαριασμών
token μπορούν να ανακαλέσουν, ένας μόνιμος εκπρόσωπος δεν μπορεί να αλλάξει ή να
αφαιρεθεί από τους κατόχους λογαριασμών token. Ο μόνιμος εκπρόσωπος μπορεί να
μεταφέρει ή να καταστρέψει tokens σε οποιονδήποτε λογαριασμό token αυτού του
mint. Ο ρόλος του μόνιμου εκπροσώπου μπορεί να αλλάξει σε νέο λογαριασμό από τον
τρέχοντα μόνιμο εκπρόσωπο.
