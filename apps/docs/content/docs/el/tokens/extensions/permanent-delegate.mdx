...
ορίζει έναν αντιπρόσωπο με εξουσία σε όλους τους λογαριασμούς token για ένα
mint. Σε αντίθεση με τους κανονικούς αντιπροσώπους που οι κάτοχοι λογαριασμών
token μπορούν να ανακαλέσουν, ένας μόνιμος αντιπρόσωπος δεν μπορεί να αλλάξει ή
να αφαιρεθεί από τους κατόχους λογαριασμών token. Ο μόνιμος αντιπρόσωπος μπορεί
να μεταφέρει ή να καταστρέψει token σε οποιονδήποτε λογαριασμό token αυτού του
mint. Ο ρόλος του μόνιμου αντιπροσώπου μπορεί να αλλάξει σε νέο λογαριασμό από
τον τρέχοντα μόνιμο αντιπρόσωπο.
