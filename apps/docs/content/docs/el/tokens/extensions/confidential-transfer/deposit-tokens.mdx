...
`solana-test-validator` δεν το ενεργοποιεί, αλλά ένας topικός validator με
forking του mainnet όπως το [Surfpool](https://surfpool.run) το κάνει. Εκτελέστε
το παράδειγμα σε έναν από αυτούς (ο κώδικας χρησιμοποιεί το devnet) με έναν
