...
Προτού τα tokens μπορέσουν να μεταφερθούν εμπιστευτικά, το δημόσιο υπόλοιπο
token πρέπει να μετατραπεί σε εμπιστευτικό υπόλοιπο. Αυτή η μετατροπή
...
μεταφέρονται εμπιστευτικά από έναν λογαριασμό token σε άλλον, τα tokens
προστίθενται αρχικά στο εμπιστευτικό εκκρεμές υπόλοιπο. Προτού τα tokens
μπορέσουν να χρησιμοποιηθούν για εμπιστευτικές μεταφορές, το εκκρεμές υπόλοιπο
πρέπει να "εφαρμοστεί" στο διαθέσιμο υπόλοιπο.
...
Το `spl_token_client` crate παρέχει μια μέθοδο
...
<Callout type="info">
  Τη στιγμή που γράφτηκε αυτό, οι Confidential Transfers δεν είναι
