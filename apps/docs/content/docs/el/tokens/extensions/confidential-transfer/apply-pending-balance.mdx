...
description:
  Μάθετε πώς να εφαρμόσετε το εκκρεμές υπόλοιπο για να καταστήσετε τα κεφάλαια
  διαθέσιμα.
---
...
είναι ενεργοποιημένο στο mainnet και στο devnet. Ένα τυπικό
`solana-test-validator` δεν το ενεργοποιεί, αλλά ένας topικός validator που
κάνει fork του mainnet, όπως το [Surfpool](https://surfpool.run), το κάνει.
Εκτελέστε το παράδειγμα με έναν από αυτούς (ο κώδικας χρησιμοποιεί devnet) με
έναν χρηματοδοτημένο payer, και αντικαταστήστε τις placeholder διευθύνσεις mint
και account με τις δικές σας.
