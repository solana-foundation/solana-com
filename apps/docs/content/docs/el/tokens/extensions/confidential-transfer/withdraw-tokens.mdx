...
Το παρακάτω παράδειγμα αναλαμβάνει tokens από το διαθέσιμο εμπιστευτικό υπόλοιπο
πίσω στο δημόσιο υπόλοιπο. Ο λογαριασμός πρέπει να έχει ήδη ρυθμιστεί για
εμπιστευτικές μεταφορές και να διατηρεί ένα διαθέσιμο εμπιστευτικό υπόλοιπο.
...
του mainnet όπως το [Surfpool](https://surfpool.run) το κάνει. Εκτελέστε το
