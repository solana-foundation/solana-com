...
description: Μάθετε πώς να κάνετε ανάληψη tokens από εμπιστευτική κατάσταση.
---

## Πώς να αποσύρετε tokens από το εμπιστευτικό διαθέσιμο υπόλοιπο

Για να αποσύρετε tokens από το εμπιστευτικό διαθέσιμο υπόλοιπο στο δημόσιο
υπόλοιπο:
...
1. Δημιουργήστε
   ...
   **Απόδειξη Ισότητας
   ...
   Επαληθεύει ότι το εναπομείναν κρυπτογραφημένο κείμενο διαθέσιμου υπολοίπου
   μετά την ανάληψη αντιστοιχεί στην
   [δέσμευση Pedersen](https://en.wikipedia.org/wiki/Commitment_scheme) που του
   αντιστοιχεί, εξασφαλίζοντας ότι το νέο διαθέσιμο υπόλοιπο του λογαριασμού
   υπολογίζεται σωστά ως
   ...
   **Απόδειξη Εύρους
   ...
   αρνητικό και εντός καθορισμένου εύρους.

2. Για κάθε απόδειξη:
   - Καλέστε το πρόγραμμα απόδειξης ZK ElGamal για επαλήθευση των δεδομένων της
     απόδειξης.
   - Αποθηκεύστε τα μεταδεδομένα που αφορούν την απόδειξη σε έναν λογαριασμό
     "context state" για χρήση σε άλλες εντολές.
...
4. Κλείστε τους λογαριασμούς απόδειξης για να ανακτήσετε το SOL που
...
- Δημιουργήστε μια απόδειξη ισότητας και μια απόδειξη εύρους από την πλευρά του
  client
- Καλέστε το πρόγραμμα απόδειξης Zk ElGamal για επαλήθευση των αποδείξεων και
  αρχικοποίηση των λογαριασμών "context state"
- Καλέστε την εντολή
  [ConfidentialTransferInstruction::Withdraw](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L493)
  παρέχοντας τους δύο λογαριασμούς απόδειξης.
...
Το παρακάτω παράδειγμα αναλαμβάνει tokens από το εμπιστευτικό διαθέσιμο υπόλοιπο
πίσω στο δημόσιο υπόλοιπο. Ο λογαριασμός πρέπει να έχει ήδη διαμορφωθεί για
Εμπιστευτικά Υπόλοιπα και να διατηρεί ένα διαθέσιμο εμπιστευτικό υπόλοιπο.

Τα Εμπιστευτικά Υπόλοιπα βασίζονται στο πρόγραμμα ZK ElGamal Proof, το οποίο είναι ενεργοποιημένο
στο mainnet και στο devnet. Ένα τυπικό `solana-test-validator` δεν το ενεργοποιεί, αλλά ένα
τοπικό validator που κάνει fork του mainnet, όπως το [Surfpool](https://surfpool.run), το κάνει.
Εκτελέστε το παράδειγμα με ένα από αυτά (ο κώδικας χρησιμοποιεί το devnet) με έναν χρηματοδοτημένο payer,
και αντικαταστήστε τους placeholders με το mint και το token account σας.
