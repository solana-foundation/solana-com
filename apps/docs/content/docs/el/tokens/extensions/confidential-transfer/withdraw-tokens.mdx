...
1. Δημιουργήστε
   ...
   **Απόδειξη ισότητας
   ...
   Επαληθεύει ότι το κρυπτοκείμενο του υπόλοιπου διαθέσιμου υπολοίπου μετά την
   ανάληψη ταιριάζει με το αντίστοιχο
   ...
   **Απόδειξη εύρους
   ...
   Επαληθεύει ότι το υπόλοιπο διαθέσιμο υπόλοιπο μετά την ανάληψη είναι μη
   αρνητικό και εντός καθορισμένου εύρους.

2. Για κάθε απόδειξη:
   - Καλέστε το ZK ElGamal proof program για να επαληθεύσετε τα δεδομένα της
     απόδειξης.
...
3. Καλέστε την εντολή
   ...
   παρέχοντας τους δύο λογαριασμούς αποδείξεων.

4. Κλείστε τους λογαριασμούς αποδείξεων για να ανακτήσετε το SOL που
   χρησιμοποιήθηκε για τη δημιουργία τους.

Το ακόλουθο διάγραμμα δείχνει τα βήματα που εμπλέκονται στην ανάληψη tokens από
...
- Δημιουργήσετε μια απόδειξη ισότητας και μια απόδειξη εύρους από την πλευρά του
  client
- Καλέσετε το Zk ElGamal proof program για να επαληθεύσετε τις αποδείξεις και να
  αρχικοποιήσετε τους λογαριασμούς "context state"
- Καλέσετε την εντολή
  [ConfidentialTransferInstruction::Withdraw](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L493)
  παρέχοντας τους δύο λογαριασμούς αποδείξεων.
- Κλείσετε τους δύο λογαριασμούς αποδείξεων για να ανακτήσετε το rent.
...
Το ακόλουθο παράδειγμα δείχνει πώς να κάνετε ανάληψη tokens από το εμπιστευτικό
...
<Callout type="info">
  ...
  Extension Program του mainnet για να εκτελέσετε τον παράδειγμα κώδικα.
</Callout>
