...
description:
  Μάθετε πώς να δημιουργήσετε ένα token mint με ενεργοποιημένα τα Confidential Balances.
---

## Πώς να δημιουργήσετε ένα mint με Confidential Balances

Τα Confidential Balances επιτρέπουν ιδιωτικές μεταφορές token προσθέτοντας επιπλέον κατάσταση στο
mint account. Αυτή η ενότητα εξηγεί πώς να δημιουργήσετε ένα token mint με την
απαιτούμενη επέκταση ενεργοποιημένη.

Το παρακάτω διάγραμμα δείχνει τα βήματα που απαιτούνται για τη δημιουργία ενός mint με την
επέκταση Confidential Balances:
...
### Κατάσταση Mint των Confidential Balances
...
- **authority**: Ο λογαριασμός που έχει άδεια να αλλάζει τις ρυθμίσεις των Confidential Balances
  για το mint και να εγκρίνει νέα εμπιστευτικά accounts αν η αυτόματη έγκριση
  είναι απενεργοποιημένη.

- **auto_approve_new_accounts**: Όταν οριστεί σε true, οι χρήστες μπορούν να δημιουργούν token
  accounts με ενεργοποιημένα τα Confidential Balances από προεπιλογή. Όταν είναι false, η
  authority πρέπει να εγκρίνει κάθε νέο token account πριν μπορεί να χρησιμοποιηθεί για
...
Η δημιουργία ενός mint με ενεργοποιημένα τα Confidential Balances απαιτεί τρεις εντολές
...
2. **Αρχικοποίηση Confidential Balances**: Καλέστε την εντολή
   ...
   του Token Extension Program για να διαμορφώσετε την κατάσταση _rs`ConfidentialTransferMint`_ για το
   mint.
...
Ο παρακάτω κώδικας δείχνει πώς να δημιουργήσετε ένα mint με ενεργοποιημένα τα Confidential Balances.
...
τοπικός validator με fork του mainnet, όπως το [Surfpool](https://surfpool.run), το υποστηρίζει.
Εκτελέστε το παράδειγμα σε ένα από αυτά (ο κώδικας χρησιμοποιεί devnet) με έναν χρηματοδοτημένο payer,
και αντικαταστήστε τις διευθύνσεις mint και account που χρησιμοποιούνται ως παραδείγματα με τις δικές σας.
