...
<Cards>
  ...
  >
    Πώς να αναλάβετε tokens από το διαθέσιμο εμπιστευτικό υπόλοιπο
  </Card>
  <Card
  ...
  >
    Πώς να εκδώσετε και να διαχειριστείτε ένα εμπιστευτικό token μεταφοράς
    (πολιτική έγκρισης, ελεγκτές, προμήθειες, έκδοση και καταστροφή)
  </Card>
</Cards>
