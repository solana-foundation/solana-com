...
| _rs`DisableNonConfidentialCredits`_ | Αποκλείει τις κανονικές μεταφορές για να κάνει τον λογαριασμό να λαμβάνει μόνο εμπιστευτικές μεταφορές.                                                                      |
| _rs`TransferWithFee`_               | Μεταφέρει tokens μεταξύ λογαριασμών token εμπιστευτικά με χρέωση.                                                                                                            |
| _rs`ConfigureAccountWithRegistry`_  | Εναλλακτικός τρόπος διαμόρφωσης λογαριασμών token για εμπιστευτικές μεταφορές χρησιμοποιώντας λογαριασμό _rs`ElGamalRegistry`_ αντί για απόδειξη _rs`VerifyPubkeyValidity`_. |
