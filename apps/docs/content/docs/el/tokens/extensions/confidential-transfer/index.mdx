...
συναλλαγές που διατηρούν την ιδιωτικότητα. Μόνο τα ποσά μεταφοράς και τα
...
accounts χωρίς να αποκαλύπτετε το ποσό της μεταφοράς.
...
1. Δημιουργία mint account με την επέκταση εμπιστευτικής μεταφοράς.
2. Δημιουργία token accounts με την επέκταση εμπιστευτικής μεταφοράς για τον
...
<Cards>
  ...
  >
    ...
    (πολιτική έγκρισης, ελεγκτές, χρεώσεις, έκδοση και καύση)
  </Card>
</Cards>
...
| Εντολή                              | Περιγραφή                                                                                                                                                                      |
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| _rs`InitializeMint`_                | Διαμορφώνει το mint account για εμπιστευτικές μεταφορές. Αυτή η εντολή πρέπει να συμπεριληφθεί στην ίδια συναλλαγή με την εντολή _rs`TokenInstruction::InitializeMint`_.       |
| _rs`UpdateMint`_                    | Ενημερώνει τις ρυθμίσεις εμπιστευτικής μεταφοράς για ένα mint.                                                                                                                 |
| _rs`ConfigureAccount`_              | Διαμορφώνει ένα token account για εμπιστευτικές μεταφορές.                                                                                                                     |
