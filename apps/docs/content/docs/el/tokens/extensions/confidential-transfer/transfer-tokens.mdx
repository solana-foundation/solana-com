...
κατάσταση _rs`ConfidentialTransferAccount`_ και εγκεκριμένους για εμπιστευτικές
μεταφορές. Ο token account του αποστολέα πρέπει επίσης να έχει διαθέσιμο
εμπιστευτικό υπόλοιπο για μεταφορά.
...
4. Κλείστε τους λογαριασμούς context state απόδειξης για να ανακτήσετε το SOL
