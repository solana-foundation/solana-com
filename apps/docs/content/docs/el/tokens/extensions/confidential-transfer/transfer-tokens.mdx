...
την κατάσταση _rs`ConfidentialTransferAccount`_ και εγκεκριμένα για
...
Το παρακάτω παράδειγμα μεταφέρει εμπιστευτικά tokens από έναν λογαριασμό σε έναν
άλλο. Και οι δύο λογαριασμοί πρέπει να έχουν ήδη διαμορφωθεί για εμπιστευτικές
μεταφορές, και ο αποστολέας πρέπει να διαθέτει διαθέσιμο εμπιστευτικό υπόλοιπο.
...
κάνει fork από το mainnet, όπως το [Surfpool](https://surfpool.run), το κάνει.
