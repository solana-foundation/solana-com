...
## Πώς να μεταφέρετε εμπιστευτικά tokens από έναν λογαριασμό token σε άλλον

Για να μεταφέρετε εμπιστευτικά tokens από έναν λογαριασμό token σε άλλον, τόσο ο
αποστολέας όσο και ο παραλήπτης πρέπει να έχουν λογαριασμούς token
διαμορφωμένους με την κατάσταση _rs`ConfidentialTransferAccount`_ και
εγκεκριμένους για εμπιστευτικές μεταφορές. Ο λογαριασμός token του αποστολέα
πρέπει επίσης να έχει διαθέσιμο εμπιστευτικό υπόλοιπο για μεταφορά.
...
1. Δημιουργήστε
   ...
   **Απόδειξη ισότητας
   ...
   Επαληθεύει ότι το νέο κρυπτοκείμενο διαθέσιμου υπολοίπου μετά τη μεταφορά
   ...
   **Απόδειξη εγκυρότητας κρυπτοκειμένου
   ...
   Επαληθεύει ότι τα κρυπτοκείμενα του ποσού μεταφοράς δημιουργούνται σωστά για
   και τα τρία μέρη (προέλευση, προορισμός και ελεγκτής), διασφαλίζοντας ότι το
   ποσό μεταφοράς κρυπτογραφείται σωστά με το δημόσιο κλειδί κάθε μέρους.
   ...
   **Απόδειξη εύρους
   ...
   χαμηλά/υψηλά bits) είναι όλα μη αρνητικά και εντός καθορισμένου εύρους.

2. Για κάθε απόδειξη:
   - Καλέστε το ZK ElGamal proof program για να επαληθεύσετε τα δεδομένα
     απόδειξης.
   - Αποθηκεύστε τα μεταδεδομένα της συγκεκριμένης απόδειξης σε έναν λογαριασμό
...
3. Καλέστε την εντολή
   ...
   παρέχοντας τους λογαριασμούς context state των αποδείξεων.

4. Κλείστε τους λογαριασμούς κατάστασης απόδειξης για να ανακτήσετε τα SOL που
   χρησιμοποιήθηκαν για τη δημιουργία τους.

Το ακόλουθο διάγραμμα δείχνει τα βήματα που εμπλέκονται στη μεταφορά tokens από
τον token account ενός αποστολέα σε έναν token account παραλήπτη.
...
Για να μεταφέρετε εμπιστευτικά tokens από έναν token account σε άλλον, πρέπει
να:

- Δημιουργήσετε μια απόδειξη ισότητας, απόδειξη εγκυρότητας κρυπτοκειμένου και
  απόδειξη εύρους από την πλευρά του πελάτη
...
- Κλείστε τους τρεις λογαριασμούς απόδειξης για να ανακτήσετε το rent.
...
Το ακόλουθο παράδειγμα δείχνει πώς να μεταφέρετε εμπιστευτικά tokens μεταξύ
token accounts.
...
<Callout type="info">
  Τη στιγμή της συγγραφής, οι εμπιστευτικές μεταφορές δεν είναι ενεργοποιημένες
  στον προεπιλεγμένο τοπικό validator. Πρέπει να κλωνοποιήσετε το Token
  Extension Program του mainnet για να εκτελέσετε τον κώδικα παραδείγματος.
</Callout>
