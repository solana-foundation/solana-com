...
απαιτεί όλες οι εισερχόμενες μεταφορές tokens να περιλαμβάνουν συνοδευτικό
σημείωμα όταν είναι ενεργοποιημένη σε έναν λογαριασμό token. Αυτή η επέκταση
μπορεί να ενεργοποιηθεί ή να απενεργοποιηθεί από τον κάτοχο του λογαριασμού
token.
