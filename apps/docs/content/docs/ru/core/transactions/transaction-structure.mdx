...
<WithMentions>
Ниже приведён вывод предыдущих фрагментов кода.
...
После отправки получите детали транзакции, используя подпись транзакции и
RPC-метод [getTransaction](/docs/rpc/http/gettransaction).

<Callout>
  Найти транзакцию также можно через [Solana
