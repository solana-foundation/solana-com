...
title: PDA аккаунты
description:
  Создавайте ончейн-аккаунты по адресам Solana PDA с помощью invoke_signed и
  ограничения init в Anchor. Процесс верификации invoke_signed и паттерны
  создания PDA в Anchor с примерами кода.
