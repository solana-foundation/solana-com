...
description:
  Узнайте, как работает спонсорство комиссий, и реализуйте абстракцию комиссий с помощью Kora.
---
...
<Cards>
  ...
  <Card title="Полная демонстрация транзакции" href="/docs/tools/kora/guides/full-demo">
