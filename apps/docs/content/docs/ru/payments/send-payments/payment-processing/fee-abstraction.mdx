...
[Kora](/docs/products/kora) берёт на себя эту сложность. Это JSON-RPC сервер,
который обеспечивает абстракцию комиссии, чтобы пользователям не требовался SOL.
Вы можете полностью спонсировать комиссии или принимать оплату комиссии в любом
токене.
...
<Cards>
  ...
  <Card title="API Reference" href="/docs/products/kora/json-rpc-api">
    Методы JSON-RPC и документация по SDK.
  </Card>
  <Card
    title="Руководство для операторов нод"
    href="/docs/products/kora/operators"
  >
