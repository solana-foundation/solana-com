...
Мемо-программа Solana позволяет прикреплять номера счетов, идентификаторы
заказов или пользовательские ссылки к любому платежу. Эти мемо навсегда
записываются в блокчейн и отображаются в логах транзакций, что облегчает
сопоставление платежей с вашими внутренними системами.
