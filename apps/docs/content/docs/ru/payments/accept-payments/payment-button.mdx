...
<Callout type="caution">
  ...
  до стабильного релиза. Для получения дополнительной информации о Commerce Kit
  см. [документацию Commerce Kit](/docs/tools/commerce-kit).
</Callout>
...
| `onPaymentError`   | `(error: Error)`      | Платёж не выполнен на любом этапе   |
| `onPaymentStart`   | `()`                  | Процесс платежа инициирован         |
