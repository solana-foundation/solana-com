...
## Многосторонний процесс утверждения
...
Транзакцию можно сериализовать, сохранить и передавать между утверждающими.
После сбора всех необходимых подписей отправьте её в сеть.

## Выполнение после готовности

Когда все утверждения получены, отправьте сериализованную транзакцию в сеть:
...
<Callout type="caution">
  ...
  или вы решили её не отправлять, необходимо продвинуть nonce перед подготовкой
  следующей транзакции с тем же nonce-аккаунтом.
</Callout>
