...
обозначает выпуск как групповой (например, Collection NFT), указывая на аккаунт,
содержащий
[групповые настройки](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16),
такие как управляющий обновлениями и максимальный размер.
...
обозначает выпуск как членский (например, NFT в коллекции), указывая на аккаунт,
содержащий
[данные о членстве](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67),
