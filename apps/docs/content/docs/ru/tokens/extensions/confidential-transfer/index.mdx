...
<Cards>
  ...
  >
    Как пополнить конфиденциальный ожидающий баланс токенами
  </Card>
  <Card
  ...
  >
    Как выпускать и управлять токеном с конфиденциальным переводом (политика
    одобрения, аудиторы, комиссии, выпуск и сжигание)
  </Card>
</Cards>
