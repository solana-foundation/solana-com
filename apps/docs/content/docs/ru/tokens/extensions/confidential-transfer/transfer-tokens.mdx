...
Следующий пример конфиденциально переводит токены с одного аккаунта на другой.
Оба аккаунта должны быть заранее настроены для конфиденциальных переводов, а у
отправителя должен быть доступный конфиденциальный баланс.
...
[Surfpool](https://surfpool.run), — активирует. Запустите пример в одной из этих
