...
перечисление, в котором перечислены все доступные расширения, которые можно
добавить к токену или аккаунту. Каждый вариант представляет отдельное расширение
с уникальной функциональностью.
