...
description: Узнайте, как включить расширение PausableMintExtension.
---

## Как включить PausableExtension
...
позволяет назначенному управляющему паузой приостанавливать всю активность
токена на выпуске. Управляющий паузой может в любой момент приостановить или
возобновить выпуск.

Когда выпуск приостановлен, программа Token-2022 отклоняет все переводы, эмиссии
и сжигания для этого токена. После снятия паузы обычные операции возобновляются.

Это распространённая практика как в блокчейн-токенах, так и в традиционных
финансовых системах, где возможность заморозки активности необходима для
соблюдения требований, реагирования на инциденты или административного контроля.
