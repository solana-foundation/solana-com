...
Заморозка токен-аккаунта сохраняет того же владельца, минт и баланс, но
предотвращает перевод или сжигание токенов из токен-аккаунта до тех пор, пока
токен-аккаунт не будет разморожен.
