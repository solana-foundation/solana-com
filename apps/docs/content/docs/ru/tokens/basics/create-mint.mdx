...
Например, USD Coin (USDC) имеет mint-адрес
...
Создание mint аккаунта требует инструкции
...
Подробнее смотрите
[реализацию здесь](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/processor.rs#L27).
...
## Дальнейшие шаги: Добавление метаданных

Mint account хранит только базовую информацию о токене (эмиссию, количество
десятичных знаков, авторизации). Чтобы добавить к вашему токену метаданные,
понятные для человека, такие как название, символ и изображение, у вас есть два
варианта:
...
<Cards>
  ...
  <Card title="Метаданные через Token Extensions" href="/docs/tokens/extensions/metadata">
   ...
   Чтобы добавить метаданные к mint account, созданным с оригинальным Token Program, используйте Metaplex Token Metadata Program.
  </Card>
</Cards>
