...
description:
  Изменение или отзыв ролей полномочий для минта или токенового аккаунта,
  включая полномочия на создание, заморозку, владение и закрытие.
...
Установка полномочий изменяет или отзывает определенные роли полномочий для
минта или токенового аккаунта.

Аккаунты минта могут хранить полномочия на создание и полномочия на заморозку.
Токеновые аккаунты хранят владельца и могут опционально хранить полномочия на
закрытие. Каждая роль контролирует определенный набор разрешений, и установка
полномочий в _rs`None`_ навсегда удаляет выбранную роль полномочий.
...
Каждый вызов обновляет один тип полномочий для одного минта или токенового
аккаунта. Текущие полномочия подписывают изменение, а новые полномочия могут
быть другим адресом или _rs`None`_ для безвозвратного отзыва выбранных
полномочий.
...
| --------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                  | Состояние минта хранит _rs`mint_authority`_ и _rs`freeze_authority`_.                        | [Исходный код](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Исходный код](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)           |
| _rs`Account`_               | Состояние токенового аккаунта хранит _rs`owner`_ и _rs`close_authority`_.                    | [Исходный код](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Исходный код](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)          |
