...
удаляет все разрешения на перевод у текущего утверждённого делегата. После
отзыва делегат больше не сможет переводить токены с вашего аккаунта. В Token
Program только владелец токен-аккаунта может отозвать делегирование. В Token
Extension Program делегирование могут отозвать как владелец токен-аккаунта, так
и текущий делегат.
