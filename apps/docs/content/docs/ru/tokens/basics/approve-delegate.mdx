...
количество токенов из token account от имени владельца этого аккаунта.

Token account хранит одного текущего делегата и одну делегированную сумму
...
использованием `@solana/kit`. Устаревшие примеры с использованием
