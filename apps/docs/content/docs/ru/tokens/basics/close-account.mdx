...
description:
  Закройте токен-аккаунт и верните lamports аккаунта на аккаунт назначения.
...
исключением и могут быть закрыты с балансом токенов для возврата базового SOL.
Владелец аккаунта или уполномоченный на закрытие аккаунта подписывает инструкцию
закрытия.
