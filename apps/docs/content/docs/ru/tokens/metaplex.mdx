...
Программа Token Metadata создает Program Derived Address (PDA) для каждого минта
токена. Этот аккаунт метаданных хранит информацию в блокчейне, такую как
название токена и символ, а также URI, указывающий на метаданные JSON вне
блокчейна (изображения, описания и т.д.).
