...
информацию для сборки и верификации программы, создаётся на основе адреса
...
Добавьте зависимость `solana-security-txt` в файл `Cargo.toml`:
...
о безопасности. Вы можете указать контактные данные, URL проекта и даже политику
