...
<Card title="Изучить шаблоны для разработчиков" href="/developers/templates">
  Ускорьте разработку с помощью готовых к использованию шаблонов для dApps,
...
Следующие SDK являются официальными SDK для Solana, разработанными компанией
[Anza](https://anza.xyz).
...
<Callout type="warn">
  ...
  все функции официальных SDK.
</Callout>

## Запуск validator

Узнайте, что необходимо для работы validator в Solana и как вы можете помочь в
...
<Cards>
  ...
  >
    Как настроить validator и впервые подключиться к кластеру
  </Card>
</Cards>
