...
добавляет ~200 байт. Для очень крупных многосторонних расчётов рассмотрите использование
[Address Lookup Tables](/developers/cookbook/transactions/lookup-tables) для
сжатия адресов аккаунтов и размещения большего количества переводов в одной транзакции.
