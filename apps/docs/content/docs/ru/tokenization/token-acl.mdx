...
Это руководство содержит полную рабочую реализацию, которую можно запустить локально.
[Исходный код](https://github.com/Woody4618/access-control-list-acl-demo)
предоставляет справочные реализации для изучения и образовательных целей.

Код программ ACL доступен в
[репозитории token-acl](https://github.com/solana-foundation/token-acl), а
ABL Gate Program доступна в
[репозитории abl-gate-program](https://github.com/solana-foundation/abl-gate-program).

**Важно**: ABL (Allow Block List) Gate Program, используемая в этом руководстве, является
**справочной реализацией**. Несмотря на то что она прошла аудит и готова к продакшну, эмитенты
могут создавать собственные Gate Programs, лучше соответствующие их конкретным
требованиям соответствия. Вы ограничены только спецификацией Token ACL (sRFC37),
а не конкретным дизайном этой Gate Program.
