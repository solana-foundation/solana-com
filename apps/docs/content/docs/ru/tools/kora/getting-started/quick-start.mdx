...
Откройте пять терминалов и выполните следующие команды:
...
- Вы можете дополнительно указать пользовательского плательщика комиссий для генерации ATA, используя флаг
  `--fee-payer-key`.
