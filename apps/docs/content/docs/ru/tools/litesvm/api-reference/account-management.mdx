...
description: Методы для управления аккаунтами, балансами и rent
---
...
Где `TransactionResult` —
`Result<TransactionMetadata, FailedTransactionMetadata>`.

Пополнить аккаунт lamport'ами. В случае успеха возвращает метаданные транзакции.
...
Напрямую задать состояние аккаунта.
...
Получить баланс аккаунта в lamport. Возвращает `None`, если аккаунт не
существует.
