...
description: Узнайте, как работает LiteSVM и чем он отличается
---

## Обзор

Представьте LiteSVM как виртуальную машину Solana, работающую внутри вашей
тестовой функции. Не как отдельный процесс, не как сетевой сервис — это просто
вызов библиотеки в вашем коде.
...
Никаких `async`, никаких `await`, никаких задержек:
...
### 2. Прямое управление состоянием
...
<Tabs items={["Rust", "TypeScript"]} groupId="litesvm-lang">
  <Tab value="Rust">
    **[Тестирование вашей программы
    ...
    →](/docs/tools/litesvm/examples)** Просматривайте готовые решения для
    типовых сценариев и примеры полных репозиториев <br /> **[Справочник API
  ...
  <Tab value="TypeScript">
    **[Тестирование вашей программы
    ...
    <br /> **[Примеры →](/docs/tools/litesvm/typescript/examples)**
    Просматривайте готовые решения для типовых сценариев <br /> **[Справочник
    API →](/docs/tools/litesvm/typescript/api-reference)** Изучите расширенные
