...
description: Вспомогательные функции, доступные в стандартной библиотеке
---

Эти функции доступны во всех Runbooks как часть стандартной библиотеки.

## Операторы

Основные математические операторы и операторы сравнения:
