...
- [`data`](mention:instruction-data): Tablica bajtów z dodatkowymi [danymi],
  które mają być użyte przez instrukcję.
...
- [pubkey](mention:pubkey): Adres public key konta
- [is_signer](mention:is-signer): Ustaw na `true`, jeśli konto musi podpisać
  transakcję
- [is_writable](mention:is-writable): Ustaw na `true`, jeśli instrukcja
...
informacje: [`program_id`](mention:program-id), [`accounts`](mention:accounts),
[`data`](mention:data).
