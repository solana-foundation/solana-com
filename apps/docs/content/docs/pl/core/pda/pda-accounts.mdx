...
title: Konta PDA
description:
  Twórz konta onchain pod adresami Solana PDA używając invoke_signed i
  ograniczenia init frameworka Anchor. Proces weryfikacji invoke_signed oraz
  wzorce tworzenia PDA w Anchor z przykładami kodu.
