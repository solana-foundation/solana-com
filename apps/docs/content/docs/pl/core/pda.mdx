...
innej wartości nadal może wygenerować poprawny PDA.
...
z adresem program-derived. Program zawiera pojedynczą instrukcję
...
program-derived. Plik zawiera kod do [wyprowadzenia PDA](mention:pda).
