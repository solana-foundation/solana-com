...
description:
  Utwórz mint Token Extensions Program ze stopą procentową zapisaną w łańcuchu, zaktualizuj tę stopę i przekonwertuj kwoty tokenów na kwotę UI z uwzględnieniem odsetek.
