...
zapobiega zmianie właściciela token account. Gdy token account zostanie
zainicjowany z tym rozszerzeniem, wyznaczony właściciel jest stały i nie może
być przeniesiony na inne konto.
