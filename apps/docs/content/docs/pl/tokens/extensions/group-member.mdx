...
wyznacza mint jako mint grupowy (np. Collection NFT), wskazując na konto
zawierające
[konfiguracje grupy](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16),
takie jak uprawnienia do aktualizacji i maksymalny rozmiar.
...
wyznacza mint jako mint członkowski (np. NFT w kolekcji), wskazując na konto
zawierające
