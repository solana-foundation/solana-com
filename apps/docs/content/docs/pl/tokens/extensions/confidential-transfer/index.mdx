...
<Cards>
  ...
  >
    Jak utworzyć konto mint z rozszerzeniem poufnego transferu
  </Card>
  <Card
    title="Utwórz konto tokenów"
    href="/docs/tokens/extensions/confidential-transfer/create-token-account"
  >
    Jak skonfigurować konto tokenów z rozszerzeniem poufnego transferu
  </Card>
  <Card
    title="Wpłać tokeny"
  ...
  >
    Jak wypłacić tokeny z dostępnego poufnego salda
  </Card>
  <Card
