...
Poniższy przykład wypłaca tokeny z poufnego dostępnego salda z powrotem do salda
publicznego. Konto musi być już skonfigurowane do poufnych transferów i posiadać
