...
1. Utwórz
   ...
   **Dowód równości
   ([CiphertextCommitmentEqualityProofData](https://github.com/anza-xyz/agave/blob/8b33d6d311c95780362a7d235919e7b8d2345939/zk-token-sdk/src/instruction/ciphertext_commitment_equality.rs#L56))**:
   Weryfikuje, że szyfrogram dostępnego salda po wypłacie odpowiada swojemu
   [zaangażowaniu Pedersena](https://pl.wikipedia.org/wiki/Schemat_zobowiązania),
...
4. Zamknij konta dowodowe, aby odzyskać SOL użyte do ich utworzenia.
...
Musisz mieć zainstalowane Solana CLI, aby uruchomić lokalny validator.
