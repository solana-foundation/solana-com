...
pozwala mint account na określenie adresu swojego konta z metadanymi. Ten
wskaźnik może wskazywać na dowolne konto należące do programu implementującego
[Token Metadata Interface](https://github.com/solana-program/token-metadata/tree/main),
zapewniając elastyczność w wyborze miejsca przechowywania metadanych.
