...
Program Invocations (CPI). Po włączeniu ta rozszerzenie zapewnia, że tokeny mogą
być przesyłane wyłącznie poprzez bezpośrednie wywołania instrukcji transferu
