...
tokenów. Po zamrożeniu konto nie może wysyłać ani otrzymywać tokenów, dopóki nie
zostanie odmrożone. Zamrożone konto można nadal zamknąć, jeśli ma zerowe saldo
tokenów. Tylko uprawnienie do zamrażania (freeze authority) konta mint może
zamrażać konta. Jeśli uprawnienie do zamrażania zostanie odwołane (ustawione na
null) na koncie mint, tokeny nie będą mogły zostać zamrożone.
