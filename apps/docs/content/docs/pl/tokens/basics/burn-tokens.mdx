...
trwale niszczy tokeny poprzez zmniejszenie salda na token account. Spalone
tokeny są usuwane z obiegu i zmniejszają `supply` śledzoną na mint account.
Tylko właściciel token account może spalać tokeny ze swojego konta.
