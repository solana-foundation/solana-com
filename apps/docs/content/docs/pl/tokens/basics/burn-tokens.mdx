...
description: Spal tokeny z konta tokenowego i zmniejsz całkowitą podaż minta.
...
Spalanie tokenów trwale zmniejsza saldo konta tokenowego i redukuje całkowitą
podaż minta o tę samą wartość.

## Jak spalać tokeny

Spalanie tokenów wykorzystuje instrukcję _rs`Burn`_ lub _rs`BurnChecked`_ Token
Program.

Poniższe przykłady używają _rs`BurnChecked`_, która wymaga od wywołującego
podania dziesiętnych minta, aby instrukcja mogła zweryfikować oczekiwaną
precyzję tokena przed spaleniem.

[Native mint](/docs/tokens/basics/sync-native) nie obsługuje spalania. Zamiast
tego użyj _rs`CloseAccount`_.

Właściciel konta tokenowego lub zatwierdzony delegat podpisuje transakcję. W
Token Extension Program stały delegat minta może również autoryzować spalanie,
...
| _rs`Account`_      | Stan konta tokenowego przechowuje saldo tokenów zmniejszone przez spalanie.                                                                                   | [Źródło](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Źródło](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Burn`_         | Instrukcja spalania, która zmniejsza saldo konta tokenowego i podaż minta bez wymagania od wywołującego podania dziesiętnych minta.                           | [Źródło](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L178-L196) | [Źródło](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L221-L239) |
| _rs`BurnChecked`_  | Instrukcja spalania, która wymaga od wywołującego podania dziesiętnych minta i sprawdza tę wartość przed zmniejszeniem salda konta tokenowego i podaży minta. | [Źródło](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L326-L350) | [Źródło](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L393-L417) |
| _rs`process_burn`_ | Współdzielona logika procesora dla spalania tokenów.                                                                                                          | [Źródło](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L586-L668)     | [Źródło](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1070-L1194)   |
...
dołączone w celach informacyjnych.
