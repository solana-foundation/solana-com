...
cofnięciu upoważnienia delegat nie może już przenosić żadnych tokenów z Twojego
konta. W przypadku Token Program tylko właściciel token account może cofnąć
upoważnienie delegata. W przypadku Token Extension Program zarówno właściciel
token account, jak i obecny delegat mogą cofnąć delegację.
