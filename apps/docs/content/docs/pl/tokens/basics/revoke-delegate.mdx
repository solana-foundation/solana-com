...
description:
  Usuń obecnego delegata z konta tokenów i wyzeruj pozostały delegowany limit.
...
## Co Powoduje Cofnięcie Delegata?

Cofnięcie delegata usuwa obecnego delegata z konta tokenów i resetuje delegowaną
kwotę do zera.

Po cofnięciu poprzedni delegat nie ma już uprawnień do transferowania ani
spalania tokenów w imieniu konta tokenów.
...
| _rs`Revoke`_         | Instrukcja usuwająca obecnego delegata z konta tokenów.     | [Źródło](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L128-L140) | [Źródło](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L170-L182) |
| _rs`process_revoke`_ | Wspólna logika procesora do cofania delegacji.              | [Źródło](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L395-L420)     | [Źródło](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L643-L674)     |
