...
cofa zamrożenie, przywracając pełną funkcjonalność wcześniej zamrożonemu token
account. Po odmrożeniu konto może ponownie normalnie wysyłać i odbierać tokeny.
Tylko autorytet zamrażania danej emisji tokena (mint) może odmrażać konta.
