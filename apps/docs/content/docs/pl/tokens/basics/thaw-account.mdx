...
Odblokowanie zmienia stan konta tokenów ze stanu zamrożonego z powrotem do stanu
zainicjowanego.

Po pomyślnym odblokowaniu konto może ponownie transferować, spalać i zamykać
tokeny. Tylko uprawniony do zamrażania (freeze authority) może odblokowywać
konta tokenów.
...
Instrukcja _rs`ThawAccount`_ weryfikuje, że konto tokenów należy do mintu oraz
że podpisujący jest uprawniony do zamrażania (freeze authority) mintu, a
następnie zmienia stan konta tokenów z zamrożonego z powrotem na zainicjowany.
...
| ----------------------------------- | ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                          | Stan mintu przechowuje opcjonalny freeze authority używany do odblokowywania kont tokenów. | [Źródło](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Źródło](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`AccountState`_                  | Stany konta tokenów, w tym _rs`Frozen`_ i _rs`Initialized`_.                               | [Źródło](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L185-L195)       | [Źródło](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L203-L213)       |
| _rs`ThawAccount`_                   | Instrukcja, która zmienia zamrożone konto tokenów z powrotem do stanu zainicjowanego.      | [Źródło](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L229-L243) | [Źródło](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L292-L306) |
...
`@solana/kit`. Przykłady legacy wykorzystujące `@solana/web3.js` zostały
