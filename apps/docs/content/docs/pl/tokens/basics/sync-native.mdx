...
description: Dowiedz się, jak zamienić natywny SOL na opakowany SOL.
---

## Synchronizacja natywnego SOL

Opakowany SOL (WSOL) to konto tokenowe, które śledzi liczbę lamportów na koncie
...
synchronizuje saldo konta tokenowego wrapped SOL (WSOL) z faktyczną ilością SOL
(lamportów) przechowywaną na tym koncie. Gdy przelewasz natywny SOL na konto
tokenowe WSOL, saldo tokena nie aktualizuje się automatycznie. Aby
odzwierciedlić poprawne saldo WSOL, musisz wywołać SyncNative.
