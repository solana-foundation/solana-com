...
trwale zamyka token account i przekazuje wszystkie pozostałe SOL (rent) na
wskazane konto docelowe. Saldo token account musi wynosić zero przed
zamknięciem. Tylko właściciel token account lub wyznaczony uprawniony do
zamknięcia może wykonać tę instrukcję.
