...
Mintowanie polega na tworzeniu nowych jednostek tokena za pomocą instrukcji
...
- Tylko autorytet mintowania (mint authority) może tworzyć nowe tokeny
- Musi istnieć docelowy token account, aby otrzymać wyemitowane tokeny
