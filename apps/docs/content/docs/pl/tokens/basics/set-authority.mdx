...
zmienia lub cofa uprawnienia do mintów i kont tokenów. Tylko obecny właściciel
uprawnień może przekazać swoje uprawnienia na nowy adres lub trwale je odebrać,
ustawiając uprawnienie na null. Po cofnięciu uprawnienia nie można go już
przywrócić.
