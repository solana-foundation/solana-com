...
przyznaje innemu kontu (delegatowi) uprawnienie do transferu określonej liczby
tokenów z twojego token account. Delegat może przelać tokeny do zatwierdzonej
kwoty, ale nie może jej przekroczyć. Tylko właściciel token account może
zatwierdzić delegata, a każde token account może mieć w danym momencie tylko
jednego delegata. Każde nowe zatwierdzenie nadpisuje poprzednie.
