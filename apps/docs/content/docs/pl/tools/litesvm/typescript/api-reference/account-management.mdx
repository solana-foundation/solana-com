...
Metody zarządzania kontami, saldami i ustawiania stanu kont.
...
| `programAddress` | `Address`    | Program właściciel                 |
...
## Zbiorcza konfiguracja kont

Na potrzeby testowania możesz efektywnie skonfigurować wiele kont jednocześnie:
...
<Callout type="info">
  Użycie `setAccount` jest szybsze niż `airdrop` przy zbiorczej konfiguracji kont, ponieważ
