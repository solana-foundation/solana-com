...
LiteSVM używa wzorca buildera do konfiguracji. Wszystkie metody zwracają `LiteSVM`
dla łańcuchowania.
...
Włącz lub wyłącz weryfikację podpisu.
...
<Callout type="info">
  Wyłączenie weryfikacji podpisu przyspiesza testy, ale zmniejsza ich realizm.
</Callout>
...
Włącz lub wyłącz sprawdzanie wygasania blockhasha.
...
Ustaw limit bajtów wyjścia dziennika.
...
Skonfiguruj zestaw funkcji do testowania określonych wersji Solany.
