...
description: Metody zarządzania kontami, saldami i rent
---
...
Gdzie `TransactionResult` to
`Result<TransactionMetadata, FailedTransactionMetadata>`.

Zasilenie konta lamports. W przypadku powodzenia zwraca metadane transakcji.
...
Bezpośrednie ustawienie stanu konta.
...
Pobieranie salda lamport konta. Zwraca `None`, jeśli konto nie istnieje.
...
Obliczanie minimalnej liczby lamports potrzebnej do zwolnienia z rent.
