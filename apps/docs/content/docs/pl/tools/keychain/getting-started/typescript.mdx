...
## Tworzenie własnych signerów

Zaimplementuj interfejs `SolanaSigner`, aby stworzyć własne signery:
...
Zobacz [przewodnik dodawania signerów](/docs/tools/keychain/adding-signers), aby
