...
description:
  Wybierz backend podpisywania Keychain zgodnie ze swoimi wymaganiami — custody, istniejąca infrastruktura, mechanizmy zatwierdzania oraz to, czy podpisujesz dla własnej aplikacji, czy udostępniasz portfele użytkownikom końcowym.
related:
...
procedurę compliance zanim zostaną wygenerowane — albo potrzebujesz regulowanego
powiernika przechowującego klucze — użyj backendu **MPC / instytucjonalnej
opieki nad kluczami**: Fireblocks, Dfns, Para, Utila lub Fordefi. Rozdzielają one
lub przechowują klucz i współpodpisują zgodnie z Twoją polityką.
...
- **MPC i instytucjonalna opieka nad kluczami** — klucz jest rozdzielony lub
  przechowywany przez dostawcę, który współpodpisuje zgodnie z Twoją polityką
...
| Fordefi         | MPC / instytucjonalna opieka  | Instytucjonalna opieka nad kluczami z kontrolą polityk | Tryb natywny rozgłasza automatycznie; w trybie czarnej skrzynki wysyłasz samodzielnie |
...
<Cards>
  <Card title="Przewodnik Rust" href="/docs/tools/keychain/getting-started/rust">
