...
Pakiet `@solana-commerce/connector` zapewnia bezstanowe połączenie z portfelem
zbudowane na
[Wallet Standard](https://github.com/wallet-standard/wallet-standard). Zarządza
odkrywaniem portfeli, stanem połączenia, zarządzaniem kontami oraz automatycznym
ponownym połączeniem. Pakiet jest zaprojektowany tak, aby być niezależnym od frameworka,
z dołączonymi powiązaniami dla React. Jest dostosowany do płynnego użytkowania
w Solana Commerce Kit i jest zgodny z [@solana/kit](https://github.com/anza-xyz/kit).
