...
- [Punkty wejścia programów w Rust](/docs/programs/rust#program-entrypoint)
...
- [Deserializacja parametrów programu w Rust](/docs/programs/rust#parameter-deserialization)
