...
- [Programy Solana w ogóle](/docs/core/programs)
- [Tworzenie niestandardowych programów Solana](/docs/programs/rust/)
...
- **Identyfikator programu**: Adres onchain Twojego programu. Użytkownicy
  wchodzą w interakcję z Twoim programem, odwołując się do identyfikatora
  programu.
- **Konto programu**: Konto onchain, które przechowuje metadane Twojego
  programu. Adres konta programu to identyfikator programu. Konto programu
  przechowuje również adres konta ProgramData.
- **Konto ProgramData**: Konto onchain, które przechowuje wdrożony kod
  wykonywalny Twojego programu.
- **Uprawnienia programu**: Konto, które ma pozwolenie na aktualizację lub
  zamknięcie programu. Domyślnie jest to Twój portfel CLI.
...
Identyfikator programu to adres onchain konta Twojego programu. Użytkownicy i
inne programy wywołują Twój program, odwołując się do tego identyfikatora w
swoich transakcjach.
