...
Ten przewodnik zawiera kompletną, działającą implementację, którą możesz uruchomić lokalnie.
[Kod źródłowy](https://github.com/Woody4618/access-control-list-acl-demo)
dostarcza implementacji referencyjnych do eksploracji i celów edukacyjnych.

Kod programów ACL jest dostępny w
[repozytorium token-acl](https://github.com/solana-foundation/token-acl), a
ABL Gate Program jest dostępny w
[repozytorium abl-gate-program](https://github.com/solana-foundation/abl-gate-program).

**Ważne**: ABL (Allow Block List) Gate Program użyty w tym przewodniku jest
**implementacją referencyjną**. Choć jest audytowany i gotowy do produkcji, wydawcy
mogą tworzyć własne Gate Programy lepiej dopasowane do ich specyficznych
potrzeb zgodności. Jesteś związany wyłącznie specyfikacją Token ACL (sRFC37),
nie tym konkretnym projektem Gate Programu.
