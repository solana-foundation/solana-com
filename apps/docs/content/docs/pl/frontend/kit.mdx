...
portfela Solana w aplikacji Next.js przy użyciu `@solana/kit`. Utworzysz
...
w repozytorium Solana Kit.

## Zasoby

- [Dokumentacja Solana Kit](https://www.solanakit.com/docs)
- [Repozytorium GitHub Solana Kit](https://github.com/anza-xyz/kit)
...
interfejsu użytkownika i zainstaluj wymagane zależności Solana.
...
## !!steps 1. Utwórz kontekst Solana
...
<Callout type="info">
  ...
  klastrem devnet i [zasilony SOL z devnet](https://faucet.solana.com/), aby
  wysyłać transakcje.
</Callout>
