...
Odczytuj dane z sieci Solana, pobierając różne konta. Ten przewodnik
wyjaśnia strukturę [kont](/docs/core/accounts) Solana. Każde konto Solana
posiada unikalny
[adres](/docs/core/accounts/account-structure#account-address), który służy do
lokalizowania danych onchain konta. Konta Solana zawierają
[dane stanu lub wykonywalny program](/docs/core/accounts/account-types).
