...
unikalny [adres](/docs/core/accounts#account-address) służący do zlokalizowania
danych konta w łańcuchu. Konta Solana zawierają albo
[dane stanu, albo wykonywalny program](/docs/core/accounts#types-of-accounts).
