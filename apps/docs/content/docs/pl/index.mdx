...
Poznaj kluczowe pojęcia specyficzne dla programowania na Solanie.

<Cards>
  <Card title="Konta" href="/docs/core/accounts">
    Jak Solana przechowuje dane
  </Card>
  <Card title="Opłaty w Solana" href="/docs/core/fees">
    Koszty wysyłania transakcji w sieci Solana
  </Card>
  <Card title="Transakcje" href="/docs/core/transactions">
    Jak komunikować się z siecią Solana
  </Card>
...
Poniższe SDK to oficjalne narzędzia dla Solany stworzone przez
[Anza](https://anza.xyz).
...
Poniżej znajdziesz SDK tworzone przez społeczność dla różnych języków
programowania:
...
<Callout type="warn">
  SDK tworzone przez społeczność mogą nie być aktualne lub nie zawierać
