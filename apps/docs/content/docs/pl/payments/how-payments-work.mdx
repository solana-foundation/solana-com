...
description: Podstawowe pojęcia dotyczące wysyłania i odbierania płatności w Solanie
---
...
W Solanie programy to wykonywalny kod logiczny, który zarządza stanem kont.
Konta tokenów są zarządzane przez **Token Program** — kod onchain, który
weryfikuje transfery i aktualizuje salda atomowo.
...
Token-2022 (znany również jako "Token Extensions") dodaje funkcje takie jak hooki transferów,
opłaty za transfery i Poufne Salda. Oba programy działają podobnie w przypadku podstawowych
transferów, ale podczas wyprowadzania ATA należy używać właściwego.
...
<Callout type="info">
  Solana wykorzystuje lokalne rynki opłat — transakcje konkurują z innymi transakcjami
  zapisującymi do tego samego stanu. Oznacza to, że opłaty transakcyjne pozostają niskie i przewidywalne
  nawet w okresach dużej aktywności sieciowej w innych miejscach.
</Callout>
...
<Cards>
  ...
  <Card title="Wyślij swoją pierwszą płatność" href="/docs/payments/send-payments">
