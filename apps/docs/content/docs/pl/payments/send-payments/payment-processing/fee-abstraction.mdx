...
[Kora](/docs/products/kora) upraszcza tę złożoność. To serwer JSON-RPC, który
zapewnia abstrakcję opłat, dzięki czemu użytkownicy nie potrzebują SOL. Możesz
całkowicie sponsorować opłaty lub akceptować płatności opłat w dowolnym tokenie.
...
<Cards>
  ...
  <Card title="Node Operator Guide" href="/docs/products/kora/operators">
