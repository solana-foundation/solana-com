...
zwiększa limit rozmiaru do 4096 bajtów, co pozwala na około trzykrotnie więcej
przelewów w jednej transakcji. Grupowanie nadal jest wymagane powyżej tego limitu, ponieważ
środowisko uruchomieniowe ładuje co najwyżej 64 konta na transakcję, niezależnie od formatu.
