...
Program memo Solany pozwala dołączać numery faktur, identyfikatory zamówień lub
własne odniesienia do każdej płatności. Te notatki są trwale zapisywane on-chain
i widoczne w logach transakcji, co ułatwia powiązanie płatności z Twoimi
