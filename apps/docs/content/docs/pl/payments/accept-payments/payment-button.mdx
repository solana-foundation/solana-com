...
<Callout type="caution">
  ...
  przed stabilnym wydaniem. Aby uzyskać więcej informacji na temat Commerce Kit,
  zobacz [dokumentację Commerce Kit](/docs/tools/commerce-kit).
</Callout>
...
| ------------------ | --------------------- | -------------------------------------------- |
| `onPaymentSuccess` | `(signature: string)` | Transakcja potwierdzona w łańcuchu           |
| `onPaymentError`   | `(error: Error)`      | Płatność nie powiodła się na dowolnym etapie |
