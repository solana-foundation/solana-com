...
description: Stel Solana wallet-integratie in Next.js op met Solana Kit.
---

Stel een minimale Solana wallet-integratie op in Next.js met Solana Kit.

Deze gids biedt een minimaal voorbeeld van het implementeren van Solana
...
in de Solana Kit repository.

## Bronnen

- [Solana Kit Documentatie](https://www.solanakit.com/docs)
...
UI-componenten en installeer de vereiste Solana-afhankelijkheden.
...
Installeer de volgende Solana-afhankelijkheden:
...
- Verbinding maken met Solana's devnet RPC-eindpunten
- Filteren op beschikbare Solana wallets geïnstalleerd in de browser van de
  gebruiker
...
Omsluit vervolgens de gehele Next.js-applicatie met de Solana provider.
...
- Maakt een Solana-transactie met een instructie die het memo-programma aanroept
- Vraagt de verbonden wallet om de transactie te ondertekenen en te verzenden
- Toont een link om de transactie te bekijken op Solana Explorer
...
<Callout type="info">
  ...
  SOL](https://faucet.solana.com/) om transacties te kunnen verzenden.
</Callout>
