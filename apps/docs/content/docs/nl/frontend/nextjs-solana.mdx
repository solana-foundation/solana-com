...
seoTitle: Solana wallet-integratie met Next.js en @solana/react-hooks
description:
  Stel Solana wallet-integratie in Next.js in met @solana/client en
  @solana/react-hooks om SOL-overdrachten te verzenden.
---
...
Dit wikkelt de hele app in met de Solana-context, zodat alle child-componenten
toegang hebben tot wallet-status en hooks.

## !!steps 3. Wallet Connect-knop
...
Connectors zijn dezelfde Wallet Standard-set
(Phantom/Solflare/Backpack/automatische detectie); eenmaal verbonden gebruiken
SOL-overdrachten de verbonden ondertekenaar.
...
## !!steps 6. Voer de applicatie uit

```terminal
$ npm run dev
```

Open http://localhost:3000, verbind een Devnet-wallet en verzend een
SOL-overdracht.
