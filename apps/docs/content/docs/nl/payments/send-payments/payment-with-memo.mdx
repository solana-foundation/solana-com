...
description: Leer hoe je factuur-ID's of notities aan een betaling kunt toevoegen.
---

Met het memo-programma van Solana kun je factuurnummers, bestelreferenties of
aangepaste verwijzingen aan elke betaling toevoegen. Deze memo's worden
permanent onchain vastgelegd en zijn zichtbaar in transactielogboeken, waardoor
het eenvoudig is om betalingen te koppelen aan je interne systemen.
