...
Controleer na het afleiden van het ATA-adres of de token account onchain
bestaat. Als de ATA niet bestaat, kun je een instructie toevoegen om de token
account van de ontvanger aan te maken in dezelfde transactie als de overdracht.
Dit vereist echter het betalen van rent voor de nieuwe token account. Aangezien
de ontvanger eigenaar is van de ATA, kan de SOL die voor de rent is betaald niet
worden teruggevorderd door de verzender.
