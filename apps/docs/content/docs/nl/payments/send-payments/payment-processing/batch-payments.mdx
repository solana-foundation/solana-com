...
verhoogt de maximale grootte naar 4096 bytes, wat ruimte biedt voor ongeveer drie keer zoveel
overdrachten per transactie. Batching blijft vereist daarboven, omdat de
runtime maximaal 64 accounts per transactie laadt, ongeacht het formaat.
