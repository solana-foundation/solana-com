...
[Kora](/docs/products/kora) handelt deze complexiteit af. Het is een JSON-RPC
server die fee-abstractie biedt zodat gebruikers nooit SOL nodig hebben. Je kunt
kosten volledig sponsoren of betaling accepteren in elke token.
...
<Cards>
  ...
  <Card title="API-referentie" href="/docs/products/kora/json-rpc-api">
    JSON-RPC methoden en SDK-documentatie.
  </Card>
  <Card title="Node operator gids" href="/docs/products/kora/operators">
