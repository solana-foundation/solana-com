...
| ----------- | ----------- | --------------------------------------------------- |
| `recipient` | `Address`   | Portemonnee-adres van handelaar (verplicht)         |
| `amount`    | `bigint`    | Bedrag in lamports of kleinste token-eenheden       |
...
| `label`     | `string`    | Handelaarsnaam weergegeven in portemonnee           |
| `message`   | `string`    | Bericht weergegeven vóór betaling                   |
| `memo`      | `string`    | Onchain memo toegevoegd aan transactie              |
