...
Solana-transacties hebben een groottelimiet (~1232 bytes). Elke overdrachtsinstrictie voegt ~200 bytes toe. Voor zeer grote meerpartijenafwikkelingen kunt u overwegen om [Address Lookup Tables](/developers/cookbook/transactions/lookup-tables) te gebruiken om accountadressen te comprimeren en meer overdrachten per transactie te verwerken.
