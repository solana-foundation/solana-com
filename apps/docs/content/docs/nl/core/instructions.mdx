...
Instructies zijn de fundamentele bouwsteen voor interactie met de Solana
blockchain. Een instructie is in essentie een publieke functie die iedereen die
het Solana netwerk gebruikt kan aanroepen. Elke instructie wordt gebruikt om een
...
eigen set instructies definieert. Om te interacteren met het Solana netwerk
...
wordt SOL overgedragen van één account naar een ander.
...
SOL-overdracht instructie bevat.

![SOL overdracht diagram](/assets/docs/core/transactions/sol-transfer.svg)
...
![SOL overdracht proces diagram](/assets/docs/core/transactions/sol-transfer-process.svg)
...
- [`data`](mention:instruction-data): Een byte-array met aanvullende [data] voor
  gebruik door de instructie.
...
vereiste informatiestukken bevat: [`program_id`](mention:program-id),
