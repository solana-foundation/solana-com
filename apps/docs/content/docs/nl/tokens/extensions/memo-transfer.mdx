...
vereist dat alle inkomende tokenoverdrachten een bijbehorende memo bevatten
wanneer ingeschakeld op een tokenaccount. Deze extensie kan worden in- of
uitgeschakeld door de eigenaar van het tokenaccount.
