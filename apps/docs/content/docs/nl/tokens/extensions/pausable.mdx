...
description: Leer hoe je de PausableMintExtension inschakelt.
---

## Hoe de PausableExtension in te schakelen
...
stelt een aangewezen pauze-autoriteit in staat om alle tokenactiviteit op een
mint te stoppen. De pauze-autoriteit kan de mint op elk moment pauzeren of
hervatten.

Wanneer gepauzeerd, weigert het Token-2022 programma alle transfers, mints en
burns voor dat token. Wanneer hervat, worden normale operaties voortgezet.

Dit is een veelvoorkomend patroon in zowel blockchain tokensystemen als
traditionele financiën, waar de mogelijkheid om activiteit te bevriezen nodig is
voor compliance, incidentrespons of administratieve controle.
