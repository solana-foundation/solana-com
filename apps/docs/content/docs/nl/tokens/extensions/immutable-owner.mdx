...
description: Leer hoe je de ImmutableOwner-extensie inschakelt.
---

## Hoe de ImmutableOwner-extensie in te schakelen
...
extensie voorkomt wijzigingen van eigenaarschap voor token accounts. Wanneer een
token account wordt geïnitialiseerd met deze extensie, is de aangewezen eigenaar
permanent en kan deze niet worden overgedragen naar een ander account.
