...
Je moet de Solana CLI geïnstalleerd hebben om de lokale validator te gebruiken.
...
| Instructie                          | Beschrijving                                                                                                                                                                            |
| ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`InitializeMint`_                | Stelt mint account in voor vertrouwelijke overdrachten. Deze instructie moet worden opgenomen in dezelfde transactie als de _rs`TokenInstruction::InitializeMint`_ instructie.          |
...
| _rs`EmptyAccount`_                  | Maakt de lopende en beschikbare vertrouwelijke saldi leeg om het sluiten van een token account mogelijk te maken.                                                                       |
| _rs`Deposit`_                       | Converteert openbaar tokensaldo naar lopend vertrouwelijk saldo.                                                                                                                        |
| _rs`Withdraw`_                      | Converteert beschikbaar vertrouwelijk saldo terug naar openbaar saldo.                                                                                                                  |
| _rs`Transfer`_                      | Draagt tokens vertrouwelijk over tussen token accounts.                                                                                                                                 |
| _rs`ApplyPendingBalance`_           | Converteert lopend saldo naar beschikbaar saldo na stortingen of overdrachten.                                                                                                          |
| _rs`EnableConfidentialCredits`_     | Stelt een token account in staat om vertrouwelijke tokenoverdrachten te ontvangen.                                                                                                      |
...
| _rs`EnableNonConfidentialCredits`_  | Stelt een token account in staat om openbare tokenoverdrachten te ontvangen.                                                                                                            |
