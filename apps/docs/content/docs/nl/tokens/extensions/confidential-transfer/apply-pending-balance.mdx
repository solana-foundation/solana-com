...
schakelt het niet in, maar een mainnet-forking lokale validator zoals
[Surfpool](https://surfpool.run) wel. Voer het voorbeeld uit tegen een van deze
omgevingen (de code gebruikt devnet) met een gefund betalende partij, en vervang
de tijdelijke aanduidingen voor mint- en accountadressen door uw eigen adressen.
