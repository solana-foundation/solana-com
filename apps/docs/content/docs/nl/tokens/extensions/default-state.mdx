...
stelt een standaardstatus in voor alle nieuwe tokenaccounts die voor een mint
worden aangemaakt. Wanneer ingeschakeld, initialiseert deze extensie automatisch
elk nieuw tokenaccount met een gespecificeerde status, zoals bevroren. Hierdoor
kunnen tokencreators specifieke gedragingen afdwingen, zoals het vereisen dat
alle nieuwe accounts standaard bevroren zijn totdat ze expliciet worden
ontdooid.
