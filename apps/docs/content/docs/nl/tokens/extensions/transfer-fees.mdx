...
schakelt automatische kosteninning in bij elke tokenoverdracht. Kosten
accumuleren in de ontvangende tokenaccounts en kunnen worden opgenomen door de
opnameautoriteit die is ingesteld op het mint account.
