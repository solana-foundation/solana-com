...
Een lokale test validator bevat ook een oudere Token-2022-build, dus om de
voorbeelden op deze pagina uit te voeren, laad het v11.0.0-programma van devnet
in je test validator:
...
## Hoe een Mint en Burn met Toestemming te Maken

Om een mint te maken met toestemmingsvereiste verbranding en tokens te
verbranden:
...
4. Verbrand met _rs`PermissionedBurnInstruction::BurnChecked`_, ondertekend door
   zowel de token account-eigenaar als de verbrandingsautoriteit.
5. Schakel optioneel toestemmingsvereiste verbranding uit met _rs`SetAuthority`_
   via _rs`AuthorityType::PermissionedBurn`_ en een `None`-autoriteit, waardoor
   de standaard verbrandingsinstructies weer worden ingeschakeld. De volledige
...
Bereken de mint account-grootte voor de basisémissie plus de
...
## !!steps Het mint account aanmaken
...
| _rs`PermissionedBurnInstruction::Burn`_        | Verbrandingsinstructie die handtekeningen vereist van de verbrandingsautoriteit en de eigenaar of gedelegeerde van het token account.              | [Bron](https://github.com/solana-program/token-2022/blob/program%40v11.0.0/interface/src/extension/permissioned_burn/instruction.rs#L50-L71) |
| _rs`PermissionedBurnInstruction::BurnChecked`_ | Verbrandingsinstructie met een decimaalcontrole die dezelfde accounts gebruikt als _rs`PermissionedBurnInstruction::Burn`_.                        | [Bron](https://github.com/solana-program/token-2022/blob/program%40v11.0.0/interface/src/extension/permissioned_burn/instruction.rs#L72-L79) |
| _rs`AuthorityType::PermissionedBurn`_          | Autoriteit-discriminator gebruikt met _rs`SetAuthority`_ om de verbrandingsautoriteit op een mint te roteren of uit te schakelen.                  | [Bron](https://github.com/solana-program/token-2022/blob/program%40v11.0.0/interface/src/instruction.rs#L1276-L1277)                         |
...
Het onderstaande voorbeeld met `Kit` maakt direct gebruik van de gegenereerde
