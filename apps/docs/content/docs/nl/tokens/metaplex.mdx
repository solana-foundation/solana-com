...
Het Token Metadata Program creëert een Program Derived Address (PDA) voor elke
token mint. Dit metadata-account slaat onchain informatie op zoals de naam en
...
Het onchain metadata-account bevat:
