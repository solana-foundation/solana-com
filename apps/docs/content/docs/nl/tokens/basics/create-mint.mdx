...
uniek binnen het Solana-ecosysteem. Je kunt deze mint bekijken op
...
Het aanmaken van een mint account vereist de
...
## Volgende Stappen: Metadata Toevoegen

Een mint account slaat alleen basisinformatie over tokens op (voorraad,
decimalen, bevoegdheden). Om leesbare metadata zoals een naam, symbool en
afbeelding aan uw token toe te voegen, heeft u twee opties:

<Cards>
  <Card title="Metaplex Token Metadata" href="/docs/tokens/metaplex">
   Voeg metadata toe met behulp van het Metaplex Token Metadata Program. Werkt met zowel het originele Token Program als Token-2022.
  </Card>
...
Een mint account slaat alleen basisinformatie over tokens op (voorraad,
decimalen, autoriteiten). Om voor mensen leesbare metadata zoals een naam,
symbool en afbeelding aan je token toe te voegen, heb je twee opties:

<Cards>
  <Card title="Metaplex Token Metadata" href="/docs/tokens/metaplex">
   Voeg metadata toe met het Metaplex Token Metadata Program. Werkt met zowel het oorspronkelijke Token Program als Token-2022.
  </Card>

  <Card title="Token Extensions Metadata" href="/docs/tokens/extensions/metadata">
   Gebruik de ingebouwde metadata-extensie met Token-2022. 
   De metadata-extensie is alleen beschikbaar voor mint accounts die zijn aangemaakt met Token-2022.
   Om metadata toe te voegen aan mint accounts die zijn aangemaakt met het oorspronkelijke Token Program, gebruik je het Metaplex Token Metadata Program.
  </Card>
</Cards>
