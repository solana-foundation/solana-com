...
instructie verwijdert alle overdrachtsmachtigingen van de momenteel goedgekeurde
gemachtigde. Na intrekking kan de gemachtigde geen tokens meer overdragen van uw
account. Voor het Token Program kan alleen de eigenaar van het token account een
gemachtigde intrekken. Voor het Token Extension Program kunnen de eigenaar van
het token account en de huidige gemachtigde de machtiging intrekken.
