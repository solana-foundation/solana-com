...
description:
  Verwijder de huidige gemachtigde van een token account en wis de resterende
...
account en stelt het gedelegeerde bedrag opnieuw in op nul.

Na intrekking heeft de vorige gemachtigde niet langer de bevoegdheid om tokens
over te dragen of te verbranden namens het token account.

## Hoe trek je een gemachtigde in

Het intrekken van een gemachtigde maakt gebruik van de _rs`Revoke`_-instructie
van het Token Program.

De _rs`Revoke`_-instructie wist de gemachtigdevelden op het bron-token account.
In het Token Program ondertekent de eigenaar van het token account de
intrekking. In het Token Extensions Program kan de huidige gemachtigde ook de
delegatie intrekken.
...
| -------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| _rs`Account`_        | De token account-status slaat de gemachtigde en het gedelegeerde bedrag op. | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Revoke`_         | Een instructie die de huidige gemachtigde verwijdert van een token account. | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L128-L140) | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L170-L182) |
