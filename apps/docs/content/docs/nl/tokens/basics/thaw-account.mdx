...
instructie keert een bevriezing om en herstelt de volledige functionaliteit van
een eerder bevroren token account. Na het ontdooien kan het account weer normaal
tokens verzenden en ontvangen. Alleen de freeze authority van de mint van de
token kan accounts ontdooien.
