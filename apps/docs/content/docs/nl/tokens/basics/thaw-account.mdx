...
description:
  ...
  wijzigingen van gemachtigden weer kunnen plaatsvinden.
...
Ontdooien verandert een token account van de bevroren staat terug naar de
geïnitialiseerde staat.

Nadat het ontdooien is geslaagd, kan het account weer tokens overdragen,
verbranden en sluiten. Alleen de freeze-autoriteit van de mint kan token
accounts ontdooien.

## Hoe ontdooi je een token account

Het ontdooien van een token account maakt gebruik van de
_rs`ThawAccount`_-instructie van het Token Program.

De _rs`ThawAccount`_-instructie verifieert dat het token account tot de mint
behoort en dat de ondertekenaar de freeze-autoriteit van de mint is, waarna de
status van het token account wordt gewijzigd van bevroren naar geïnitialiseerd.
...
| ----------------------------------- | -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| _rs`Mint`_                          | De mint-staat slaat de optionele freeze-autoriteit op die wordt gebruikt om token accounts te ontdooien. | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`AccountState`_                  | De token account-statussen, waaronder _rs`Frozen`_ en _rs`Initialized`_.                                 | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L185-L195)       | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L203-L213)       |
| _rs`ThawAccount`_                   | Een instructie die een bevroren token account terugverandert naar de geïnitialiseerde staat.             | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L229-L243) | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L292-L306) |
