...
instructie voorkomt alle tokenoverdrachten of token-verbrandingen van een
specifieke tokenaccount. Eenmaal bevroren kan de account geen tokens verzenden
of ontvangen totdat deze wordt ontdooid. Een bevroren account kan nog steeds
worden gesloten als deze een nul tokensaldo heeft. Alleen de bevries-autoriteit
van de token mint kan accounts bevriezen. Als de bevries-autoriteit wordt
ingetrokken (ingesteld op null) op de mint account, kunnen tokens nooit meer
worden bevroren.
