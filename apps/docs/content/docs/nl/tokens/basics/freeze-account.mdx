...
description:
  Bevries een token account met de bevries-autoriteit van de mint om
...
maar voorkomt dat het token account tokens kan overdragen of verbranden totdat
het token account wordt ontdooid.

Een bevroren account kan nog steeds worden gesloten als het bevroren account een
saldo van nul tokens heeft.

Alleen een mint die nog steeds een bevries-autoriteit heeft, kan token accounts
bevriezen. Als de bevries-autoriteit van een mint wordt ingetrokken, kunnen
accounts voor die mint niet langer worden bevroren.

## Hoe een Token Account Bevriezen

Het bevriezen van een token account maakt gebruik van de
_rs`FreezeAccount`_-instructie van het Token Program.

De _rs`FreezeAccount`_-instructie verifieert dat het token account toebehoort
aan de mint en dat de ondertekenaar de bevries-autoriteit van de mint is, waarna
de status van het token account wordt gewijzigd van geïnitialiseerd naar
bevroren.

[Native token accounts](/docs/tokens/basics/sync-native) ondersteunen het
bevriezen niet.
...
| ----------------------------------- | ---------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| _rs`Mint`_                          | De mint-status slaat de optionele bevries-autoriteit op die wordt gebruikt om token accounts te bevriezen. | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`AccountState`_                  | De statussen van het token account, inclusief _rs`Initialized`_ en _rs`Frozen`_.                           | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L185-L195)       | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L203-L213)       |
| _rs`FreezeAccount`_                 | Een instructie die een token account in de bevroren status brengt.                                         | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L213-L228) | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L276-L291) |
