...
instructie voorkomt alle tokenoverdrachten of het verbranden van tokens van een
specifiek tokenaccount. Eenmaal bevroren kan het account geen tokens verzenden
of ontvangen totdat het wordt ontdooid. Een bevroren account kan nog steeds
worden gesloten als het een nul tokensaldo heeft. Alleen de bevriez-authority
van de mint van de token kan accounts bevriezen. Als de bevriez-authority wordt
ingetrokken (op null gezet) op het mint account, kunnen tokens nooit meer worden
bevroren.
