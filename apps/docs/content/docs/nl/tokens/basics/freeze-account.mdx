...
instructie voorkomt alle tokenoverdrachten of tokenverbrandingen van een
specifiek tokenaccount. Eenmaal bevroren kan het account geen tokens verzenden,
ontvangen of worden gesloten totdat het wordt ontdooid. Alleen de
bevries-autoriteit van de mint van het token kan accounts bevriezen. Als de
bevries-autoriteit wordt ingetrokken (ingesteld op null) op het mint-account,
kunnen tokens nooit worden bevroren.
