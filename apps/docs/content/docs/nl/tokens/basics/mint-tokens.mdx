...
title: Tokens minten
description:
  Mint nieuwe token-eenheden naar een token account met de mint-autoriteit.
...
Minting creëert nieuwe eenheden van een bestaande token en verhoogt de totale
voorraad van de mint.

Alleen de mint-autoriteit kan nieuwe tokens minten. Het bestemmings-token
account moet al bestaan en moet tot dezelfde mint behoren.

## Hoe Tokens te Minten

Het minten van tokens maakt gebruik van de _rs`MintTo`_- of
_rs`MintToChecked`_-instructie van het Token Program.

De onderstaande voorbeelden gebruiken _rs`MintToChecked`_, waarbij de aanroeper
de decimalen van de mint moet opgeven, zodat de instructie de verwachte
tokenprecisie kan verifiëren voordat er wordt gemint.

De [native mint](/docs/tokens/basics/sync-native) ondersteunt geen minting.

### Bronverwijzing

| Item                  | Beschrijving                                                                                                                                                           | Token Program                                                                                                | Token Extensions Program                                                                                           |
| --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| _rs`Mint`_            | De mint-state slaat de mint-autoriteit en totale tokenvoorraad op.                                                                                                     | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_         | De token account-state slaat het bestemmingssaldo op dat wordt bijgewerkt door het minten.                                                                             | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`MintTo`_          | Een mint-instructie die tokens mint naar een bestaand token account zonder dat de aanroeper de decimalen van de mint hoeft op te geven.                                | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L159-L177) | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L202-L220) |
| _rs`MintToChecked`_   | Een mint-instructie waarbij de aanroeper de decimalen van de mint moet opgeven en die waarde controleert voordat tokens naar een bestaand token account worden gemint. | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L301-L325) | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L367-L391) |
| _rs`process_mint_to`_ | Gedeelde processorlogica voor het minten van tokens.                                                                                                                   | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L521-L583)     | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L981-L1067)    |
