...
title: Tokens minten
description:
  Maak nieuwe token-eenheden aan voor een token account met de mint-autoriteit.
...
Alleen de mint-autoriteit kan nieuwe tokens aanmaken. Het bestemmings-token
account moet al bestaan en moet bij dezelfde mint horen.

## Hoe Tokens Te Minten

Het minten van tokens gebruikt de _rs`MintTo`_- of
...
de decimalen van de mint moet verstrekken zodat de instructie de verwachte
...
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| _rs`Mint`_               | De mint-status slaat de mint-autoriteit en de totale tokenvoorraad op.                                                                                                     | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_            | De token account-status slaat het bestemmingssaldo op dat wordt bijgewerkt door minting.                                                                                   | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`MintTo`_             | Een mint-instructie die tokens mint naar een bestaand token account zonder dat de aanroeper de decimalen van de mint hoeft te verstrekken.                                 | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L159-L177) | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L202-L220) |
| _rs`MintToChecked`_      | Een mint-instructie waarbij de aanroeper de decimalen van de mint moet verstrekken en die waarde controleert voordat tokens naar een bestaand token account worden gemint. | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L301-L325) | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L367-L391) |
| _rsINL`process_mint_to`_ | Gedeelde processorlogica voor het minten van tokens.                                                                                                                       | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L521-L583)     | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L981-L1067)    |
