...
description:
  Sluit een token account en retourneer de lamports van het account naar een
  bestemmingsaccount.
...
Het sluiten van een token account verwijdert het account en retourneert de rent
lamports van het token account naar een bestemmingsaccount.
...
bevoren account nul is. Wrapped SOL token accounts zijn de uitzondering en
kunnen worden gesloten met een tokensaldo om de onderliggende SOL terug te
vorderen. De accounteigenaar of de close authority van het account ondertekent
de sluitingsinstructie.

## Hoe sluit je een token account

Het sluiten van een token account maakt gebruik van de _rs`CloseAccount`_
...
Het Token Extensions Program voert aanvullende controles uit bij het sluiten
voor bepaalde extensies, maar de basis sluitingsflow is hetzelfde.

### Bronreferentie

| Item                        | Beschrijving                                                                                                                         | Token Program                                                                                                | Token Extensions Program                                                                                           |
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| _rs`Account`_               | De token account state slaat het saldo, native status en close authority op die worden gebruikt tijdens het sluiten van het account. | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`CloseAccount`_          | Een instructie die een token account sluit en de lamports van het token account overdraagt naar een bestemmingsaccount.              | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L197-L212) | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L240-L274) |
| _rs`process_close_account`_ | Gedeelde processorlogica voor het sluiten van token accounts.                                                                        | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L671-L709)     | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1197-L1289)   |
