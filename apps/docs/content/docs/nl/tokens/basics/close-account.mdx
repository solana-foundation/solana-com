...
instructie sluit permanent een token account en draagt alle resterende SOL
(rent) over naar een opgegeven bestemmingsaccount. Het saldo van het token
account moet nul zijn voordat het kan worden gesloten. Alleen de eigenaar van
het token account of de aangewezen close authority kan deze instructie
uitvoeren.
