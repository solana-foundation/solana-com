...
Het sluiten van een token-account verwijdert het account en retourneert de
rent-lamports van het token-account naar een bestemmingsaccount.
...
bevroren account nul is. Wrapped SOL-token-accounts vormen hierop een
uitzondering en kunnen met een tokensaldo worden gesloten om de onderliggende
SOL terug te vorderen. De accounteigenaar of de sluitingsautoriteit van het
account ondertekent de sluitingsinstructie.
