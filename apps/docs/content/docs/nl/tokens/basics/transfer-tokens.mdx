...
## Wat Doet het Overdragen van Tokens?

Het overdragen van tokens verplaatst tokens van het ene token account naar een
ander token account voor dezelfde mint.

Overdrachten veranderen het mint supply niet. Overdrachten werken alleen de
saldi bij tussen token accounts.

## Hoe Tokens Overdragen

Het overdragen van tokens maakt gebruik van de _rs`Transfer`_ of
_rs`TransferChecked`_ instructie van het Token Program.

De onderstaande voorbeelden gebruiken _rs`TransferChecked`_, waarvoor de
aanroeper de mint en decimalen moet opgeven zodat de instructie de verwachte
mint en tokenprecisie kan verifiëren voordat tokens tussen accounts worden
verplaatst.
...
overdracht. In het Token Extensions Program kan een permanente mint-gemachtigde
de overdracht ook autoriseren als de mint de permanente gemachtigde-extensie
heeft ingeschakeld.
...
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| _rs`Account`_          | De token account state slaat de saldi op die worden bijgewerkt door een overdracht.                                                                                                                                     | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Transfer`_         | Een overdrachts-instructie die tokens verplaatst tussen token accounts zonder dat de aanroeper de mint of decimalen hoeft op te geven. Gebruik in het Token Extensions Program in plaats daarvan _rs`TransferChecked`_. | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L89-L108)  | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L121-L149) |
| _rs`TransferChecked`_  | Een overdrachts-instructie waarbij de aanroeper de mint en decimalen moet opgeven en deze waarden controleert voordat tokens worden verplaatst tussen token accounts van dezelfde mint.                                 | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L245-L273) | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L308-L339) |
| _rs`process_transfer`_ | Gedeelde processorlogica voor tokenoverdrachten.                                                                                                                                                                        | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L227-L341)     | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L308-L579)     |
