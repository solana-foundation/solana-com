...
Een token account slaat op elk moment één huidige gemachtigde en één gedelegeerd
bedrag op. Het goedkeuren van een nieuwe gemachtigde vervangt de vorige
gemachtigde en het bijbehorende bedrag op het account.

## Hoe Een Gemachtigde Goedkeuren

Het goedkeuren van een gemachtigde gebruikt de _rs`Approve`_ of
...
aanroeper de mint en decimalen moet verstrekken zodat de instructie de verwachte
mint en tokenprecisie kan verifiëren voordat de goedkeuring wordt verwerkt.
...
| _rs`Approve`_         | Een goedkeuringsinstructie voor gemachtigden die de gemachtigde en het toegestane bedrag voor een token account registreert zonder dat de aanroeper de mint of decimalen hoeft te verstrekken.                     | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L109-L127) | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L150-L168) |
| _rs`ApproveChecked`_  | Een goedkeuringsinstructie voor gemachtigden waarbij de aanroeper de mint en decimalen moet verstrekken en deze waarden worden gecontroleerd voordat de gemachtigde en het toegestane bedrag worden geregistreerd. | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L274-L300) | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L340-L366) |
| _rs`process_approve`_ | Gedeelde processorlogica voor goedkeuring van gemachtigden.                                                                                                                                                        | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L344-L392)     | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L582-L640)     |
