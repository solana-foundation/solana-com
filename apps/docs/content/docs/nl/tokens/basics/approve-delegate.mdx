...
description:
  Autoriseer een ander adres om een beperkte hoeveelheid tokens over te dragen
  of te verbranden van een token account.
...
Het goedkeuren van een gemachtigde stelt een ander adres in staat om namens de
eigenaar van het token account een beperkte hoeveelheid tokens over te dragen of
te verbranden van een token account.

Een token account bewaart op elk moment één huidige gemachtigde en één
gedelegeerd bedrag. Het goedkeuren van een nieuwe gemachtigde vervangt de vorige
gemachtigde en het toegestane bedrag op het account.

## Hoe Een Gemachtigde Goed Te Keuren
...
De onderstaande voorbeelden gebruiken _rs`ApproveChecked`_, die vereist dat de
aanroeper de mint en decimalen verstrekt zodat de instructie de verwachte mint
en tokenprecisie kan verifiëren voordat de goedkeuring wordt verwerkt.
...
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| _rs`Account`_         | De token account status slaat de eigenaar, gemachtigde en gedelegeerd bedrag op.                                                                                                                                     | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
