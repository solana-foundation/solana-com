...
specifiek aantal tokens van je token account over te maken. De gemachtigde kan
tokens overmaken tot het goedgekeurde bedrag, maar kan dit niet overschrijden.
Alleen de eigenaar van het token account kan een gemachtigde goedkeuren, en elk
token account kan slechts één gemachtigde tegelijk hebben. Elke nieuwe
goedkeuring overschrijft de vorige.
