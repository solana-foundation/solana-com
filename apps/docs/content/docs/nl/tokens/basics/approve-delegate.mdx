...
instructie verleent een ander account (de gemachtigde) toestemming om een
specifiek aantal tokens over te maken vanaf jouw token account. De gemachtigde
kan tokens overmaken tot het goedgekeurde bedrag, maar kan dit niet
overschrijden. Alleen de eigenaar van het token account kan een gemachtigde
goedkeuren, en elk token account kan slechts één gemachtigde tegelijk hebben.
Elke nieuwe goedkeuring overschrijft de vorige.
