...
instructie wijzigt of herroept autorisaties op mints en token accounts. Alleen
de huidige autorisatie kan hun rechten overdragen aan een nieuw adres of deze
permanent herroepen door de autorisatie op null te zetten. Eenmaal herroepen,
kan de autorisatie niet worden hersteld.
