...
description:
  Wijzig of intrekken van machtigingsrollen op een mint of token account,
  inclusief mint-, freeze-, owner- en close-machtiging.
...
## Wat Doet Het Instellen van Machtiging?

Het instellen van machtiging wijzigt of intrekt specifieke machtigingsrollen op
een mint of token account.

Mint accounts kunnen een mint-machtiging en een freeze-machtiging opslaan. Token
accounts slaan een owner op en kunnen optioneel een close-machtiging opslaan.
Elke rol beheert een specifieke set machtigingen, en het instellen van een
machtiging op _rs`None`_ verwijdert de geselecteerde machtigingsrol permanent.

Het Token Extensions Program definieert ook aanvullende machtigingstypen voor
specifieke extensies.

## Hoe Machtiging In Te Stellen

Het wijzigen van een machtiging gebruikt de _rs`SetAuthority`_-instructie van
het Token Program.

Elke aanroep werkt één machtigingstype bij op één mint of token account. De
huidige machtiging ondertekent de wijziging, en de nieuwe machtiging kan een
ander adres zijn of _rs`None`_ om de geselecteerde machtiging permanent in te
trekken.
...
| --------------------------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                  | De mint-status slaat _rs`mint_authority`_ en _rs`freeze_authority`_ op.            | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)           |
| _rs`Account`_               | De token account-status slaat _rs`owner`_ en _rs`close_authority`_ op.             | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)          |
| _rs`AuthorityType`_         | De machtigingsrollen die _rs`SetAuthority`_ kan bijwerken.                         | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L739-L751) | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L1116-L1157) |
| _rs`SetAuthority`_          | Een instructie die één machtiging op een mint of token account wijzigt of intrekt. | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L141-L158) | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L183-L200)   |
| _rs`process_set_authority`_ | Gedeelde processorlogica voor machtigingsupdates.                                  | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L423-L518)     | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L677-L978)       |
