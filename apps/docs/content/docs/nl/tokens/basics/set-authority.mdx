...
description: Leer hoe je autoriteit instelt voor mints of token accounts.
---
...
- **Mint authority**: Beheert het aanmaken van nieuwe tokens. Kan tokens minten
...
- **Freeze authority**: Beheert de mogelijkheid om token accounts te bevriezen
  en te ontdooien. Kan voorkomen dat een token account tokens overdraagt. Wordt
  vaak ingetrokken om gebruikers te garanderen dat hun tokens niet bevroren
  kunnen worden.

### Token account-autoriteiten

- **Account owner**: Heeft volledige controle over het token account. Kan tokens
  overdragen, tokens verbranden, delegates goedkeuren en het account sluiten
  wanneer het saldo nul is.
- **Close authority**: Kan het token account sluiten wanneer het saldo nul is.
  Standaard is dit de account owner, maar kan worden gedelegeerd naar een ander
  account.

## Hoe autoriteit in te stellen
...
de huidige autoriteit kan hun rechten overdragen naar een nieuw adres of deze
