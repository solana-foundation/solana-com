...
description:
  Wijzig of intrekk autorisatierollen op een mint of token account, inclusief
  mint-, freeze-, owner- en close-autorisatie.
...
## Wat Doet Het Instellen van Autorisatie?

Het instellen van autorisatie wijzigt of intrekt specifieke autorisatierollen op
een mint of token account.

Mint accounts kunnen een mint-autorisatie en een freeze-autorisatie opslaan.
Token accounts slaan een eigenaar op en kunnen optioneel een close-autorisatie
opslaan. Elke rol beheert een specifieke set van machtigingen, en het instellen
van een autorisatie op _rs`None`_ verwijdert de geselecteerde autorisatierol
permanent.

Het Token Extensions Program definieert ook aanvullende autorisatietypes voor
specifieke extensies.

## Hoe Autorisatie In Te Stellen

Het wijzigen van een autorisatie gebruikt de _rs`SetAuthority`_-instructie van
het Token Program.

Elke aanroep werkt één autorisatietype bij op één mint of token account. De
huidige autorisatie ondertekent de wijziging, en de nieuwe autorisatie kan een
ander adres zijn of _rs`None`_ om de geselecteerde autorisatie permanent in te
trekken.
...
| _rs`AuthorityType`_         | De autorisatierollen die _rs`SetAuthority`_ kan bijwerken.                          | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L739-L751) | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L1116-L1157) |
| _rs`SetAuthority`_          | Een instructie die één autorisatie op een mint of token account wijzigt of intrekt. | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L141-L158) | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L183-L200)   |
| _rs`process_set_authority`_ | Gedeelde processorlogica voor autorisatie-updates.                                  | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L423-L518)     | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L677-L978)       |
