...
verlagen. Verbrande tokens worden uit circulatie gehaald en verlagen het
`supply` dat wordt bijgehouden op het mint account. Alleen de eigenaar van het
token account kan tokens van hun account verbranden.
