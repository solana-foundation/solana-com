...
description:
  Verbrand tokens van een token account en verlaag de totale voorraad van de
  mint.
...
vermindert de totale voorraad van de mint met hetzelfde bedrag.

## Hoe Tokens Verbranden
...
tokenprecisie kan verifiëren voordat deze wordt verbrand.
...
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| _rs`Mint`_         | De mint-status slaat de totale tokenvoorraad op.                                                                                                                                 | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_      | De token account-status slaat het tokensaldo op dat wordt verlaagd door een verbranding.                                                                                         | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Burn`_         | Een verbrandingsinstructie die een token account-saldo en mintvoorraad verlaagt zonder dat de aanroeper de decimalen van de mint hoeft op te geven.                              | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L178-L196) | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L221-L239) |
| _rs`BurnChecked`_  | Een verbrandingsinstructie waarbij de aanroeper de decimalen van de mint moet opgeven en die waarde controleert voordat een token account-saldo en mintvoorraad worden verlaagd. | [Bron](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L326-L350) | [Bron](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L393-L417) |
