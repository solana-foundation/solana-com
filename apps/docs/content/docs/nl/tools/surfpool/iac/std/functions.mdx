...
description: Hulpfuncties beschikbaar in de standaardbibliotheek
---

Deze functies zijn beschikbaar in alle Runbooks als onderdeel van de
standaardbibliotheek.

## Operatoren

Basis wiskundige en vergelijkingsoperatoren:
