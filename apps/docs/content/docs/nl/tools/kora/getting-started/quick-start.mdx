...
Open vijf terminals en voer de volgende opdrachten uit:
...
- Je kunt optioneel een aangepaste vergoedingsbetaler voor ATA-generatie opgeven door de
  `--fee-payer-key` vlag te gebruiken.
