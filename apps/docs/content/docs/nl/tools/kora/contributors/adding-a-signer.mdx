...
Voeg je service toe aan de validator-lijst in de hoofd-README.

## Indieningschecklist

- [ ] Je signer wordt ondersteund in de `solana-keychain` crate
- [ ] `solana-keychain` afhankelijkheid bijgewerkt in Cargo.toml naar de
      nieuwste versie
...
Welkom in het Kora-ecosysteem! We zijn blij dat je sleutelbeheeroplossing deel
