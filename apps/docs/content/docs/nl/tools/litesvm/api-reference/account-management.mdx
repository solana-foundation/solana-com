---
title: Accountbeheer
description: Methoden voor het beheren van accounts, saldi en rent
---
...
Waar `TransactionResult` is
`Result<TransactionMetadata, FailedTransactionMetadata>`.

Crediteer een account met lamports. Geeft transactiemetadata terug bij succes.
...
Accountstatus rechtstreeks instellen.
...
Haal het lamport-saldo van een account op. Geeft `None` terug als het account
niet bestaat.
