...
description: Bouw en verstuur een SOL-overdrachtstransactie met LiteSVM
---

De meest eenvoudige Solana-transactie: SOL verplaatsen van het ene account naar het andere. Dit is een goede eerste test om te controleren of je LiteSVM-configuratie werkt voordat je complexere programmalogica test.
...
[Programma testen](/docs/tools/litesvm/typescript/examples/program-testing). Voor
tokenoverdrachten (mints, ATA's), zie
