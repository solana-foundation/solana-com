---
title: Tokenbewerkingen
description:
  Werken met tokenbewerkingen - aanmaken, overdrachten en accountbeheer
---

## Een Token Mint Aanmaken

Een mint is de basis van elk SPL-token. Het definieert de eigenschappen van het
token en bepaakt wie nieuwe tokens kan aanmaken.
...
Een token account bevat het saldo van een specifiek spl-token voor een
specifieke gebruiker. Lees voor meer informatie over het verschil tussen dit en
een ATA
...
Associated Token Accounts (ATAs) zijn deterministische adressen voor het bewaren
van tokens voor een specifieke gebruiker. Lees voor meer informatie over het
verschil tussen dit en een ATA
[dit gedeelte](/docs/tools/litesvm/additional-crates/testing-with-spl-tokens#types-of-token-accounts).
...
## Tokens Aanmaken in een Token Account

Zodra u een mint en token accounts heeft, kunt u tokens naar die accounts
aanmaken.
...
## Een Tokenoverdracht Uitvoeren

Draag tokens over tussen accounts met behulp van de Transfer-instructie.
...
De meeste tokens gebruiken decimalen om fractionele bedragen weer te geven. Zo
gaat u er correct mee om:
