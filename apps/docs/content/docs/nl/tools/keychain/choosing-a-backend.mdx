...
description:
  Kies een Keychain-ondertekeningsbackend op basis van uw vereisten — beheer, bestaande infrastructuur, goedkeuringscontroles en of u ondertekent voor uw eigen app of wallets inricht voor eindgebruikers.
related:
...
### Heeft u goedkeuring door meerdere partijen, institutionele bewaring of regelgevingscontroles nodig?

Als handtekeningen een goedkeuringsbeleid, bestedingslimiet of compliance-workflow moeten doorlopen voordat ze worden gegenereerd — of als u een gereguleerde bewaarder nodig heeft die de sleutels beheert — gebruik dan een **MPC / institutionele bewaring**-backend: Fireblocks, Dfns, Para, Utila of Fordefi. Deze splitsen of bewaren de sleutel en ondertekenen mee op basis van uw beleid.

Als u alleen een sleutel nodig heeft die op verzoek ondertekent, gaat u hieronder verder.
...
- **MPC & institutionele bewaring** — de sleutel wordt gesplitst of bewaard bij een
  provider, die mede ondertekent op basis van uw beleid (goedkeuringen, limieten).
...
| Fordefi         | MPC / institutioneel beheer  | Institutionele bewaring met beleidscontroles | Native modus verzendt automatisch; black box-modus verstuurt u zelf |
