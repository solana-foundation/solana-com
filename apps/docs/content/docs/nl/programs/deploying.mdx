...
- [Solana accountmodel](/docs/core/accounts)
- [Solana programma's in het algemeen](/docs/core/programs)
- [Ontwikkelen van aangepaste Solana programma's](/docs/programs/rust/)
...
- **Program ID**: Het onchain-adres van je programma. Gebruikers communiceren
  met je programma door te verwijzen naar de Program ID.
- **Program Account**: Het onchain-account dat de metadata van je programma
  opslaat. Het adres van het program account is de Program ID. Het program
  account slaat ook het adres van het ProgramData Account op.
- **ProgramData Account**: Het onchain-account dat de geïmplementeerde
  uitvoerbare code van je programma opslaat.
- **Program Authority**: Het account dat toestemming heeft om het programma bij
  te werken of te sluiten. Standaard is dit je CLI-wallet.
...
De Program ID is het onchain-adres van je program account. Gebruikers en andere
programma's roepen je programma aan door naar deze ID te verwijzen in hun
transacties.
...
- **`--use-rpc`**: Stuur transacties naar de geconfigureerde RPC. Deze vlag
  vereist een [stake-weighted](/docs/defi/stake-weighted-qos) RPC-verbinding van
  providers zoals [Triton](https://triton.one/) of
