...
- [Rust-programma entrypoints](https://docs.rs/solana-program-entrypoint/latest/solana_program_entrypoint/macro.entrypoint.html)
...
- [Deserialisatie van Rust-programmaparameters](https://docs.rs/solana-program-entrypoint/latest/solana_program_entrypoint/fn.deserialize.html)
