...
Trường này thường được gọi là "dữ liệu tài khoản". `data` trong trường này được
...
2. Giải mã hóa trường `data` của tài khoản từ byte thô thành cấu trúc dữ liệu
   phù hợp, như được định nghĩa bởi chương trình sở hữu tài khoản.
