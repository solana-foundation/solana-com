...
Phí ưu tiên là một khoản phí tùy chọn giúp tăng mức độ ưu tiên lên lịch
của một giao dịch. Đơn vị tính toán (CU) là đơn vị đo lường tài nguyên tính toán mà hệ thống
theo dõi trong quá trình thực thi giao dịch. Mỗi thao tác (số học, truy cập bộ nhớ,
syscall) tiêu tốn một số lượng CU cố định. Bạn có thể đặt phí ưu tiên bằng cách
đưa các lệnh ngân sách tính toán vào giao dịch của mình. (Xem
[Hướng dẫn Cách Sử Dụng Phí Ưu Tiên](/docs/core/fees) để biết thêm chi tiết.)
...
<Callout type="info" title="Giao dịch v1 đặt phí trực tiếp">
  Công thức giá nhân với giới hạn này áp dụng cho các giao dịch legacy và v0. Trong [định dạng v1](/docs/core/transactions/versioned-transactions#v1-message-format) sắp ra mắt, phí ưu tiên là tổng tuyệt đối tính bằng lamport được đặt trực tiếp trong cấu hình message — không có giá trên mỗi CU, không nhân, không làm tròn.
</Callout>
