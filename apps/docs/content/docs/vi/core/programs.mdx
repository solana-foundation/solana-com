...
một chương trình hiện có, một tài khoản phải được chỉ định làm
[upgrade authority](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/bpf_loader/src/lib.rs#L894).
(Thông thường là cùng tài khoản đã
[triển khai chương trình](/docs/programs/deploying) ban đầu.) Nếu upgrade
authority bị thu hồi và đặt thành `None`, chương trình không thể được cập nhật
nữa.
...
| ------ | --------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| native | `NativeLoader1111111111111111111111111111111` | Sở hữu bốn loader khác                                                                                                           | —                                                                                                                                            |
...
Chương trình ed25519 xử lý một hướng dẫn. `u8` đầu tiên của instruction data
chứa số lượng chữ ký cần kiểm tra, theo sau là một byte đệm. Sau đó, cấu trúc
sau được tuần tự hóa, một cấu trúc cho mỗi chữ ký cần kiểm tra.
