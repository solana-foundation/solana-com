...
description:
  Rã đông tài khoản token đã bị đóng băng để có thể tiếp tục chuyển khoản, đốt
  token và thay đổi ủy quyền.
...
## Rã Đông Tài Khoản Token Có Tác Dụng Gì?

Rã đông chuyển tài khoản token từ trạng thái đóng băng trở lại trạng thái đã
khởi tạo.

Sau khi rã đông thành công, tài khoản có thể chuyển, đốt và đóng token trở lại.
Chỉ có quyền hạn đóng băng (freeze authority) của mint mới có thể rã đông tài
khoản token.

## Cách Rã Đông Tài Khoản Token

Rã đông tài khoản token sử dụng chỉ thị _rs`ThawAccount`_ của Token Program.

Chỉ thị _rs`ThawAccount`_ xác minh rằng tài khoản token thuộc về mint và người
ký là quyền hạn đóng băng của mint, sau đó chuyển trạng thái tài khoản token từ
đóng băng trở lại đã khởi tạo.

[Tài khoản token gốc](/docs/tokens/basics/sync-native) không hỗ trợ rã đông.

### Tham Chiếu Nguồn

| Mục                                 | Mô Tả                                                                                         | Token Program                                                                                                 | Token Extension Program                                                                                             |
| ----------------------------------- | --------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                          | Trạng thái mint lưu trữ quyền hạn đóng băng tùy chọn được sử dụng để rã đông tài khoản token. | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`AccountState`_                  | Các trạng thái tài khoản token, bao gồm _rs`Frozen`_ và _rs`Initialized`_.                    | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L185-L195)       | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L203-L213)       |
| _rs`ThawAccount`_                   | Chỉ thị chuyển tài khoản token đã đóng băng trở lại trạng thái đã khởi tạo.                   | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L229-L243) | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L292-L306) |
| _rs`process_toggle_freeze_account`_ | Logic xử lý chung cho đóng băng và rã đông tài khoản token.                                   | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L713-L754)     | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1293-L1341)   |
