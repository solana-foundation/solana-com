...
đảo ngược trạng thái đóng băng, khôi phục đầy đủ chức năng cho token account đã
bị đóng băng trước đó. Sau khi rã đông, tài khoản có thể gửi và nhận token bình
thường trở lại. Chỉ freeze authority của mint của token mới có thể rã đông các
tài khoản.
