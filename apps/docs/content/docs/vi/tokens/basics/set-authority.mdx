...
description:
  Thay đổi hoặc thu hồi các vai trò quyền hạn trên tài khoản mint hoặc token
  account, bao gồm quyền mint, đóng băng, sở hữu và đóng tài khoản.
...
## Thiết Lập Quyền Hạn Làm Gì?

Thiết lập quyền hạn thay đổi hoặc thu hồi các vai trò quyền hạn cụ thể trên mint
account hoặc token account.

Mint account có thể lưu trữ quyền mint và quyền đóng băng. Token account lưu trữ
chủ sở hữu và có thể tùy chọn lưu trữ quyền đóng tài khoản. Mỗi vai trò kiểm
soát một bộ quyền cụ thể, và việc đặt quyền hạn thành _rs`None`_ sẽ thu hồi vĩnh
viễn vai trò quyền hạn đã chọn.

Token Extensions Program cũng định nghĩa các loại quyền hạn bổ sung cho các tiện
ích mở rộng cụ thể.

## Cách Thiết Lập Quyền Hạn

Thay đổi quyền hạn sử dụng lệnh _rs`SetAuthority`_ của Token Program.

Mỗi lệnh gọi cập nhật một loại quyền hạn trên một mint account hoặc token
account. Quyền hạn hiện tại ký xác nhận thay đổi, và quyền hạn mới có thể là một
địa chỉ khác hoặc _rs`None`_ để thu hồi vĩnh viễn quyền hạn đã chọn.

### Tham Chiếu Nguồn

| Mục                         | Mô tả                                                                          | Token Program                                                                                                 | Token Extensions Program                                                                                              |
| --------------------------- | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                  | Trạng thái mint lưu trữ _rs`mint_authority`_ và _rs`freeze_authority`_.        | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)           |
| _rs`Account`_               | Trạng thái token account lưu trữ _rs`owner`_ và _rs`close_authority`_.         | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)          |
| _rs`AuthorityType`_         | Các vai trò quyền hạn mà _rs`SetAuthority`_ có thể cập nhật.                   | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L739-L751) | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L1116-L1157) |
| _rs`SetAuthority`_          | Lệnh thay đổi hoặc thu hồi một quyền hạn trên mint account hoặc token account. | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L141-L158) | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L183-L200)   |
| _rs`process_set_authority`_ | Logic xử lý dùng chung cho cập nhật quyền hạn.                                 | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L423-L518)     | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L677-L978)       |
