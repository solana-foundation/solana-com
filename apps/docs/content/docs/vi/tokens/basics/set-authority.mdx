...
thay đổi hoặc thu hồi quyền trên các mint và tài khoản token. Chỉ có quyền hiện
tại mới có thể chuyển quyền hạn của họ sang địa chỉ mới hoặc thu hồi vĩnh viễn
bằng cách đặt quyền thành null. Sau khi bị thu hồi, quyền không thể được khôi
phục.
