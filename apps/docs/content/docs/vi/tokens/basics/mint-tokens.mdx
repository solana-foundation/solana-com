---
title: Đúc token
description: Đúc các đơn vị token mới vào token account với quyền đúc.
...
Chỉ có quyền đúc (mint authority) mới có thể đúc token mới. Token account đích
phải đã tồn tại và phải thuộc về cùng một mint.

## Cách Đúc Token

Việc đúc token sử dụng lệnh _rs`MintTo`_ hoặc _rs`MintToChecked`_ của Token
Program.
...
| _rs`Account`_         | Trạng thái token account lưu trữ số dư đích được cập nhật bởi quá trình đúc.                                                    | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`MintTo`_          | Lệnh đúc token vào token account hiện có mà không yêu cầu người gọi cung cấp số thập phân của mint.                             | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L159-L177) | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L202-L220) |
| _rs`MintToChecked`_   | Lệnh đúc yêu cầu người gọi cung cấp số thập phân của mint và kiểm tra giá trị đó trước khi đúc token vào token account hiện có. | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L301-L325) | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L367-L391) |
| _rs`process_mint_to`_ | Logic xử lý chung để đúc token.                                                                                                 | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L521-L583)     | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L981-L1067)    |
