...
gây cản tất cả các giao dịch chuyển token hoặc đốt token từ một tài khoản token
cụ thể. Sau khi bị đóng băng, tài khoản không thể gửi hoặc nhận token cho đến
khi được rã đông. Tài khoản đóng băng vẫn có thể được đóng nếu số dư token bằng
không. Chỉ có quyền hạn đóng băng (freeze authority) của mint account mới có thể
đóng băng các tài khoản. Nếu quyền hạn đóng băng bị thu hồi (đặt thành null)
