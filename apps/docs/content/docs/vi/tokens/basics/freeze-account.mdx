...
ngăn chặn tất cả các giao dịch chuyển token hoặc đốt token từ một tài khoản
token cụ thể. Sau khi bị đóng băng, tài khoản không thể gửi token hoặc nhận
token cho đến khi được rã đông. Một tài khoản bị đóng băng vẫn có thể bị đóng
nếu nó có số dư token bằng không. Chỉ có quyền hạn đóng băng của mint account
của token mới có thể đóng băng các tài khoản. Nếu quyền hạn đóng băng bị thu hồi
(đặt thành null) trên mint account, các token sẽ không bao giờ có thể bị đóng
băng.
