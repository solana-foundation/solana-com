...
token cụ thể. Sau khi bị đóng băng, tài khoản không thể gửi token, nhận token
hoặc bị đóng cho đến khi được rã đông. Chỉ có quyền đóng băng của mint token mới
có thể đóng băng các tài khoản. Nếu quyền đóng băng bị thu hồi (đặt thành null)
trên tài khoản mint, các token sẽ không bao giờ có thể bị đóng băng.
