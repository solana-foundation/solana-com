...
Đóng băng tài khoản token giữ nguyên chủ sở hữu, mint và số dư, nhưng ngăn tài
khoản token chuyển hoặc đốt token cho đến khi tài khoản token được mở băng.
