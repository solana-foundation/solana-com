...
## Đốt Token Có Tác Dụng Gì?

Đốt token sẽ giảm vĩnh viễn số dư tài khoản token và giảm tổng nguồn cung của
mint cùng một lượng tương ứng.
...
[Native mint](/docs/tokens/basics/sync-native) không hỗ trợ đốt token. Hãy sử
dụng _rs`CloseAccount`_ thay thế.

Chủ sở hữu tài khoản token hoặc một delegate được phê duyệt ký giao dịch. Trong
Token Extension Program, một mint permanent delegate cũng có thể ủy quyền đốt
token nếu mint đã kích hoạt extension permanent delegate.

### Tham Chiếu Nguồn

| Mục                | Mô tả                                                                                                                                     | Token Program                                                                                                 | Token Extension Program                                                                                             |
| ------------------ | ----------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_         | Trạng thái mint lưu trữ tổng nguồn cung token.                                                                                            | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_      | Trạng thái tài khoản token lưu trữ số dư token bị giảm khi đốt.                                                                           | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Burn`_         | Lệnh đốt giảm số dư tài khoản token và nguồn cung mint mà không yêu cầu người gọi cung cấp số thập phân của mint.                         | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L178-L196) | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L221-L239) |
| _rs`BurnChecked`_  | Lệnh đốt yêu cầu người gọi cung cấp số thập phân của mint và kiểm tra giá trị đó trước khi giảm số dư tài khoản token và nguồn cung mint. | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L326-L350) | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L393-L417) |
| _rs`process_burn`_ | Logic xử lý chung cho việc đốt token.                                                                                                     | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L586-L668)     | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1070-L1194)   |

### Typescript

Các ví dụ `Kit` bên dưới thể hiện phương pháp được khuyến nghị sử dụng
