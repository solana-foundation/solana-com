...
đóng vĩnh viễn một tài khoản token và chuyển toàn bộ SOL còn lại (rent) đến một
tài khoản đích được chỉ định. Số dư tài khoản token phải bằng không trước khi
đóng. Chỉ chủ sở hữu tài khoản token hoặc quyền đóng được chỉ định mới có thể
thực thi lệnh này.
