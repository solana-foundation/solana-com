...
vĩnh viễn đóng một token account và chuyển toàn bộ SOL còn lại (rent) đến một
tài khoản đích được chỉ định. Số dư của token account phải bằng không trước khi
đóng. Chỉ chủ sở hữu token account hoặc quyền đóng được chỉ định mới có thể thực
thi lệnh này.
