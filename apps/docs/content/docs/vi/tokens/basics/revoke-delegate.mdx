...
description:
  Xóa người được ủy quyền hiện tại của token account và xóa hạn mức ủy quyền còn
  lại của nó.
...
## Thu hồi quyền ủy quyền làm gì?

Thu hồi quyền ủy quyền sẽ xóa người được ủy quyền hiện tại của token account và
đặt lại số lượng được ủy quyền về không.

Sau khi thu hồi, người được ủy quyền trước đó sẽ không còn quyền chuyển hoặc đốt
token thay mặt cho token account.

## Cách thu hồi quyền ủy quyền

Thu hồi quyền ủy quyền sử dụng lệnh _rs`Revoke`_ của Token Program.

Lệnh _rs`Revoke`_ xóa các trường người được ủy quyền trên token account nguồn.
Trong Token Program, chủ sở hữu token account ký xác nhận việc thu hồi. Trong
Token Extensions Program, người được ủy quyền hiện tại cũng có thể thu hồi quyền
ủy quyền.
...
| -------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_        | Trạng thái token account lưu trữ người được ủy quyền và số lượng được ủy quyền. | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Revoke`_         | Lệnh xóa người được ủy quyền hiện tại khỏi token account.                       | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L128-L140) | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L170-L182) |
| _rs`process_revoke`_ | Logic xử lý chung cho việc thu hồi quyền ủy quyền.                              | [Nguồn](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L395-L420)     | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L643-L674)     |

### Typescript

Các ví dụ `Kit` bên dưới cho thấy cách tiếp cận được khuyến nghị khi sử dụng
