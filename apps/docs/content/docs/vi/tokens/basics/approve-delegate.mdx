...
trong phạm vi số lượng đã được phê duyệt, nhưng không thể vượt quá giới hạn đó.
Chỉ chủ sở hữu token account mới có thể phê duyệt người được ủy quyền, và mỗi
token account chỉ có thể có một người được ủy quyền tại một thời điểm. Bất kỳ
phê duyệt mới nào sẽ ghi đè lên phê duyệt trước đó.
