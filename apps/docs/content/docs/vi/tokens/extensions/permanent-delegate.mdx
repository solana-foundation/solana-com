...
gán quyền cho một đại biểu có thẩm quyền đối với tất cả các token account của
một mint. Không giống như các đại biểu thông thường mà chủ sở hữu token account
có thể thu hồi, một đại biểu vĩnh viễn không thể bị thay đổi hoặc xóa bỏ bởi chủ
sở hữu token account. Đại biểu vĩnh viễn có thể chuyển hoặc đốt token trong bất
kỳ token account nào của mint đó. Vai trò đại biểu vĩnh viễn có thể được chuyển
sang một tài khoản mới bởi đại biểu vĩnh viễn hiện tại.
