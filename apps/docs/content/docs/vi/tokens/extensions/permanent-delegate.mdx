...
gán quyền cho một delegate đối với tất cả các token account của một mint. Không
giống như các delegate thông thường mà chủ sở hữu token account có thể thu hồi,
permanent delegate không thể bị thay đổi hoặc xóa bỏ bởi chủ sở hữu token
account. Permanent delegate có thể chuyển hoặc đốt token trong bất kỳ token
account nào của mint đó. Vai trò permanent delegate có thể được chuyển sang một
account mới bởi permanent delegate hiện tại.
