...
chỉ định một mint là group mint (như Collection NFT) bằng cách trỏ đến một tài
khoản chứa
...
chỉ định một mint là member mint (như một NFT trong collection) bằng cách trỏ
