...
gây chặn việc thay đổi quyền sở hữu đối với token account. Khi một token account
được khởi tạo với phần mở rộng này, chủ sở hữu được chỉ định là vĩnh viễn và
không thể được chuyển giao cho tài khoản khác.
