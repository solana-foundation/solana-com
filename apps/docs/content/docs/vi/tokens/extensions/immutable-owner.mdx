...
găn chặn việc thay đổi quyền sở hữu đối với token account. Khi một token account
được khởi tạo với tiện ích mở rộng này, chủ sở hữu được chỉ định sẽ là vĩnh viễn
và không thể chuyển giao cho tài khoản khác.
