...
description:
  Tạo một mint lưu trữ metadata trực tiếp trên mint account bằng cách sử dụng
  các extension MetadataPointer và TokenMetadata, sau đó cập nhật, xóa và khóa
  metadata đó thông qua giao diện token-metadata.
