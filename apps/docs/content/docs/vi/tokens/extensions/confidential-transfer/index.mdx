...
được sao chép từ mainnet bằng lệnh sau. Bạn phải cài đặt Solana CLI để sử dụng
validator cục bộ.
...
| _rs`EmptyAccount`_                  | Làm trống số dư bảo mật đang chờ và khả dụng để cho phép đóng token account.                                                                                      |
| _rs`Deposit`_                       | Chuyển đổi số dư token công khai thành số dư bảo mật đang chờ.                                                                                                    |
| _rs`Withdraw`_                      | Chuyển đổi số dư bảo mật khả dụng trở lại thành số dư công khai.                                                                                                  |
| _rs`Transfer`_                      | Chuyển token giữa các token account một cách bảo mật.                                                                                                             |
| _rs`ApplyPendingBalance`_           | Chuyển đổi số dư đang chờ thành số dư khả dụng sau khi nạp hoặc chuyển khoản.                                                                                     |
