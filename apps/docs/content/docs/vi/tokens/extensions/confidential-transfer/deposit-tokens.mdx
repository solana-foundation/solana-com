...
Chuyển giao dịch bảo mật phụ thuộc vào chương trình ZK ElGamal Proof, được kích
...
[Surfpool](https://surfpool.run) thì có. Chạy ví dụ trên một trong các môi
trường đó (code sử dụng devnet) với tài khoản payer có đủ số dư, và thay thế địa
chỉ mint và tài khoản giả bằng địa chỉ của bạn.
