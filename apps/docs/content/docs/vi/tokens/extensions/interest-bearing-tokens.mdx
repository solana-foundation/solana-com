...
description:
  Tạo một mint của Token Extensions Program với lãi suất onchain, cập nhật lãi suất đó, và chuyển đổi số lượng token thành số lượng UI có lãi.
...
## !!steps Tính toán số lượng UI với trình trợ giúp offchain

Lấy mint account và clock sysvar, sau đó tính toán số lượng UI mà không cần gửi
giao dịch.
...
<Callout type="info" title="Thứ tự lệnh">
  _rs`InterestBearingMintInstruction::Initialize`_ phải được thực hiện trước
  _rs`InitializeMint`_. _rs`CreateAccount`_,
  _rs`InterestBearingMintInstruction::Initialize`_ và _rs`InitializeMint`_ phải
...
| Mục                                             | Mô tả                                                                                                                   | Nguồn                                                                                                                                              |
| ------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`InterestBearingConfig`_                      | Phần mở rộng mint lưu trữ quyền lãi suất, dấu thời gian và các mức lãi suất hiện tại cũng như lịch sử.                         | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/extension/interest_bearing_mint/mod.rs#L40-L153)         |
| _rs`InterestBearingMintInstruction::Initialize`_ | Lệnh khởi tạo cấu hình sinh lãi trước _rs`InitializeMint`_.                                         | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/extension/interest_bearing_mint/instruction.rs#L17-L90)  |
| _rs`InterestBearingMintInstruction::UpdateRate`_ | Lệnh thay đổi lãi suất hiện tại của mint.                                                                    | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/extension/interest_bearing_mint/instruction.rs#L35-L113) |
| _rs`AmountToUiAmount`_                           | Lệnh trả về chuỗi số lượng UI hiện tại cho một số lượng token sử dụng cấu hình đang hoạt động của mint.                      | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L520-L538)                                |
| _rs`InterestBearingConfig::amount_to_ui_amount`_ | Trình trợ giúp chuyển đổi số lượng token thành số lượng UI có lãi suất cho một dấu thời gian.                                           | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/extension/interest_bearing_mint/mod.rs#L85-L96)          |
| _rs`process_initialize`_                         | Logic xử lý khởi tạo _rs`InterestBearingConfig`_ và ghi lại dấu thời gian cũng như lãi suất ban đầu.                     | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/extension/interest_bearing_mint/processor.rs#L21-L43)      |
| _rs`process_update_rate`_                        | Logic xử lý cập nhật lãi suất hiện tại, tính toán lại lãi suất trung bình có trọng số theo thời gian và ghi lại dấu thời gian cập nhật. | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/extension/interest_bearing_mint/processor.rs#L46-L77)      |
| _rs`process_amount_to_ui_amount`_                | Logic xử lý trả về chuỗi số lượng UI sử dụng cấu hình sinh lãi đang hoạt động của mint.                     | [Nguồn](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1548-L1569)                                  |
