...
yêu cầu tất cả các giao dịch chuyển token đến phải bao gồm một memo đi kèm khi
được bật trên token account. Extension này có thể được bật hoặc tắt bởi chủ sở
hữu token account.
