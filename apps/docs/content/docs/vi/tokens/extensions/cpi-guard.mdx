...
bảo vệ các tài khoản token khỏi các giao dịch chuyển khoản không mong muốn thông
qua Cross Program Invocations (CPI). Khi được kích hoạt, tiện ích mở rộng này
đảm bảo rằng token chỉ có thể được chuyển thông qua các lệnh gọi trực tiếp đến
lệnh transfer của Token Extensions Program, chặn tất cả các chương trình khác
