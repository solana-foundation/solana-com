...
ngăn chặn token được chuyển giữa các token account sau khi mint. Sau khi được
mint, các token sẽ ở lại vĩnh viễn trong token account. Tuy nhiên, chủ sở hữu
token account vẫn có thể đốt token và đóng token account khi số dư về không.
