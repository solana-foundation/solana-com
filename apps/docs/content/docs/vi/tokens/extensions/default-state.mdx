...
mint. Khi được bật, extension này tự động khởi tạo mỗi token account mới với một
trạng thái được chỉ định, chẳng hạn như bị đóng băng. Điều này cho phép người
tạo token thực thi các hành vi cụ thể, như yêu cầu tất cả các account mới bị
đóng băng theo mặc định cho đến khi được mở đóng băng một cách rõ ràng.
