...
title: Chọn backend
description:
  Chọn backend ký Keychain phù hợp với yêu cầu của bạn — quyền giám sát, cơ sở hạ tầng hiện có, kiểm soát phê duyệt, và việc bạn ký cho ứng dụng của chính mình hay cấp ví cho người dùng cuối.
related:
...
### Bạn có cần phê duyệt đa bên, lưu ký tổ chức, hoặc kiểm soát tuân thủ quy định không?

Nếu chữ ký phải qua chính sách phê duyệt, giới hạn chi tiêu, hoặc quy trình tuân thủ trước khi được tạo ra — hoặc bạn cần một đơn vị lưu ký được quản lý nắm giữ khóa — hãy sử dụng backend **MPC / lưu ký tổ chức**: Fireblocks, Dfns, Para, Utila, hoặc Fordefi. Các dịch vụ này phân tách hoặc lưu ký khóa và đồng ký theo chính sách của bạn.
...
- **MPC & lưu ký tổ chức** — khóa được phân tách hoặc lưu ký qua một nhà cung cấp, đơn vị này đồng ký theo chính sách của bạn (phê duyệt, giới hạn).
...
| Fordefi         | MPC / lưu ký tổ chức  | Lưu ký tổ chức với kiểm soát chính sách | Chế độ native tự động phát sóng; chế độ black box bạn tự gửi |
