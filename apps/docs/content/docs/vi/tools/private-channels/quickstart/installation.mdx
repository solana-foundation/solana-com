...
gói `@private-channels/client` nào trên npm. Các đoạn code trong phần này sử dụng
đường dẫn tương đối (`../private-channel-escrow-program/...`) với giả định rằng code
của bạn nằm cùng thư mục với repository đã sao chép; hãy điều chỉnh cho phù hợp với vị trí
