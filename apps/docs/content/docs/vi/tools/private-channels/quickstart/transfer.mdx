---
title: Gửi Một Giao Dịch Chuyển Khoản
description:
  Gửi giao dịch chuyển token SPL off-chain qua cổng Private Channels
---

## Tổng Quan

Các giao dịch chuyển khoản qua Channel là các giao dịch chuyển token SPL tiêu chuẩn được gửi đến cổng -
không có lệnh chuyển khoản riêng cho Private Channels. Cổng định tuyến
giao dịch đến write node, nơi thực thi giao dịch đó trên lớp tài khoản
off-chain của channel. Các giao dịch chuyển khoản được xác nhận khi sequencer xử lý chúng,
không phải khi một block Solana được xác nhận, và không xuất hiện trên Mainnet.

## Chuyển Đổi RPC Của Ví

Trước khi gửi giao dịch chuyển khoản, hãy chuyển endpoint RPC của ví sang URL cổng
...
Truy vấn số dư channel của người nhận thông qua cổng để xác nhận
...
**[Rút Tiền](/docs/tools/private-channels/quickstart/withdraw)** -
