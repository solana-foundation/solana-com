...
Gói `@solana-commerce/connector` cung cấp khả năng kết nối ví headless
được xây dựng trên
[Wallet Standard](https://github.com/wallet-standard/wallet-standard). Gói này
quản lý việc khám phá ví, trạng thái kết nối, quản lý tài khoản và tự động
kết nối lại. Gói được thiết kế theo hướng độc lập với framework và có kèm theo
các liên kết React. Gói được tối ưu hóa để sử dụng liền mạch trong Solana Commerce Kit và
tương thích với [@solana/kit](https://github.com/anza-xyz/kit).
