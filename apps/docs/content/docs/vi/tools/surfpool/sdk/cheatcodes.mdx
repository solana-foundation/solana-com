...
title: Cheatcodes
description:
  Bỏ qua giao dịch và trực tiếp thay đổi trạng thái Surfnet. Nạp SOL và token, đặt dữ liệu tài khoản tùy ý, đặt lại các tài khoản được lưu cache từ upstream, và truyền trực tiếp các tài khoản mainnet.
---
