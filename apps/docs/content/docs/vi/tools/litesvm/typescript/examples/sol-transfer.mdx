...
Giao dịch Solana cơ bản nhất: chuyển SOL từ tài khoản này sang tài khoản khác. Đây là bài kiểm tra đầu tiên để xác minh rằng cài đặt LiteSVM của bạn hoạt động tốt trước khi kiểm tra các logic chương trình phức tạp hơn.
...
[Kiểm Tra Chương Trình](/docs/tools/litesvm/typescript/examples/program-testing). Để kiểm tra chuyển token (mint, ATA), xem
