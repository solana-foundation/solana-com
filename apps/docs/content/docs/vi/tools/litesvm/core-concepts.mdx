---
title: Tại Sao Dùng LiteSVM
description: Tìm hiểu cách LiteSVM hoạt động và điều gì làm nó khác biệt
---

## Tổng Quan

Hãy nghĩ về LiteSVM như một Solana VM chạy bên trong hàm kiểm thử của bạn. Không
phải là một tiến trình riêng biệt, không phải là một dịch vụ mạng - nó chỉ là
một lời gọi thư viện trong mã của bạn.
...
### 1. Mọi Thứ Đều Đồng Bộ

Không có `async`, không có `await`, không có độ trễ:
...
### 2. Thao Tác Trạng Thái Trực Tiếp
...
### 3. Thời Gian Nằm Trong Tầm Kiểm Soát Của Bạn
...
### 4. Lỗi Được Hiển Thị Ngay Lập Tức và Rõ Ràng
...
<Tabs items={["Rust", "TypeScript"]} groupId="litesvm-lang">
  <Tab value="Rust">
    **[Kiểm Tra Chương Trình Của Bạn
    →](/docs/tools/litesvm/testing-your-program)** Tìm hiểu cách kiểm tra chương
    trình Solana của riêng bạn <br /> **[Ví Dụ
    →](/docs/tools/litesvm/examples)** Xem các giải pháp sao chép-dán cho các
    tình huống phổ biến và ví dụ kho lưu trữ đầy đủ <br /> **[Tài Liệu API
    →](/docs/tools/litesvm/api-reference)** Tìm hiểu các tính năng nâng cao và
    cấu hình tùy chỉnh
  </Tab>
  <Tab value="TypeScript">
    **[Kiểm Tra Chương Trình Của Bạn
    →](/docs/tools/litesvm/typescript/getting-started)** Tìm hiểu cách kiểm tra
    chương trình Solana của riêng bạn bằng LiteSVM cho TypeScript <br /> **[Ví
    Dụ →](/docs/tools/litesvm/typescript/examples)** Xem các giải pháp sao
    chép-dán cho các tình huống phổ biến <br /> **[Tài Liệu API
