...
sẽ giúp bạn hiểu cấu trúc của [tài khoản](/docs/core/accounts) Solana. Mỗi tài
khoản Solana có một [địa chỉ](/docs/core/accounts#account-address) duy nhất được
sử dụng để xác định vị trí dữ liệu onchain tương ứng. Các tài khoản chứa
...
trong [kiểu Account](/docs/core/accounts#account-structure) mà được bao gồm
trong phản hồi.
...
[loader program](/docs/core/programs#loader-programs). Trong ví dụ này, `owner`
