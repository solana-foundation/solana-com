...
description:
  ...
  dụng Program Derived Address (PDA) và framework Anchor. Hướng dẫn từng bước
  này trình bày cách tạo, cập nhật và xóa các tài khoản tin nhắn onchain bằng
  PDA, triển khai xác thực tài khoản và viết các bài kiểm tra. Hoàn hảo cho các
  nhà phát triển muốn hiểu cách sử dụng PDA trong các chương trình Solana.
