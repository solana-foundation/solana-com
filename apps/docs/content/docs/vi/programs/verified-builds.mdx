...
sẽ chứa khóa công khai của người xác minh để dễ dàng truy cập dữ liệu xác minh
được lưu trữ trong PDA xác minh. PDA chứa tất cả thông tin cần thiết để xây dựng
và xác minh chương trình được tạo ra từ địa chỉ chương trình và pubkey của người
xác minh. Theo mặc định, đây là cùng một pubkey đã xây dựng và triển khai chương
