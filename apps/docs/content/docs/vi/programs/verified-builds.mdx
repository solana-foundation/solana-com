...
Sử dụng
[các bản build đã được xác minh trên Solana](/developers/guides/advanced/verified-builds)
...
trì các bản build có thể xác minh và bảo mật phù hợp với mã nguồn của bạn. Luôn
thực hiện các biện pháp phòng ngừa cần thiết để sử dụng môi trường nhất quán, và
xem xét các giải pháp quản trị để nâng cấp và triển khai an toàn.
