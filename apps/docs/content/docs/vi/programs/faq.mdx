...
- [Điểm vào chương trình Rust](/docs/programs/rust#program-entrypoint)
...
- [Giải tuần tự hóa tham số chương trình Rust](/docs/programs/rust#parameter-deserialization)
