...
description: Thiết lập tích hợp ví Solana trong Next.js với Solana Kit.
---

Thiết lập tích hợp ví Solana tối giản trong Next.js với Solana Kit.

Hướng dẫn này cung cấp một ví dụ tối giản về việc triển khai chức năng ví Solana
...
trong kho lưu trữ Solana Kit.

## Tài nguyên

- [Tài liệu Solana Kit](https://www.solanakit.com/docs)
- [Kho lưu trữ GitHub Solana Kit](https://github.com/anza-xyz/kit)
...
giao diện người dùng và cài đặt các phụ thuộc Solana cần thiết.
...
<Callout type="info">
  ...
  nạp SOL devnet](https://faucet.solana.com/) để gửi giao dịch.
</Callout>
