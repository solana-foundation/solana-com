...
Client gửi yêu cầu, nhận phản hồi 402 kèm điều khoản thanh toán, sau đó thử lại
với thanh toán đã ký. Server ủy quyền xác minh và thanh quyết toán cho
facilitator, một bên trung gian tùy chọn xử lý việc gửi giao dịch onchain. Khi
facilitator xác nhận thanh quyết toán, server trả về nội dung được yêu cầu. Sự
tách biệt này cho phép các nhà cung cấp API chấp nhận thanh toán mà không cần
trực tiếp quản lý bất kỳ cơ sở hạ tầng onchain nào.
...
| [PayAI](https://payai.network/)                                 | Nền tảng hỗ trợ x402 với Solana         |
| [x402 GitHub](https://github.com/coinbase/x402)                 | Triển khai tham chiếu                   |
| [ACK](https://github.com/agentcommercekit/ack)                  | Bộ công cụ thương mại agent             |
| [A2A x402](https://github.com/google-agentic-commerce/a2a-x402) | Thanh toán giữa các agent của Google    |
