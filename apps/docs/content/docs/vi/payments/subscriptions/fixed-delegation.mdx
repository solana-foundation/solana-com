...
- Số lượng được tính theo đơn vị cơ bản. Đối với token có 6 chữ số thập phân,
  `1_000_000` có nghĩa là `1` token.
- Chỉ chạy `initSubscriptionAuthority` khi tài khoản Subscription Authority chưa
  tồn tại.
