---
title: Ủy Quyền Cố Định
description: Hướng dẫn thiết lập các giao dịch ủy quyền cố định.
---

Ủy quyền cố định cho phép người dùng phê duyệt một ví hoặc dịch vụ khác rút lên
đến một số lượng token cố định. Mỗi lần chuyển thành công sẽ giảm hạn mức còn
lại. Sử dụng `expiryTs = 0` để không có thời hạn hết hạn.

Hướng dẫn này giữ quy trình rõ ràng. Mỗi đoạn mã sử dụng trực tiếp các hàm SDK
để bạn có thể thấy tài khoản nào được tạo, chỉ thị nào được gửi, và người ký nào
trả phí hoặc ủy quyền từng bước.
...
Người được ủy quyền ký giao dịch chuyển. SDK cần cùng một PDA ủy quyền, token
account của người dùng và token account của người nhận.
...
Người ủy quyền có thể thu hồi ủy quyền bất cứ lúc nào. Việc thu hồi sẽ đóng PDA
ủy quyền và trả lại tiền rent cho người ký.
...
- Số tiền tính theo đơn vị cơ sở. Với token có 6 chữ số thập phân, `1_000_000`
  nghĩa là `1` token.
- Chạy `initSubscriptionAuthority` chỉ khi tài khoản Subscription Authority chưa
  tồn tại.
- `expiryTs` là thời hạn cứng: một khi đã qua, các giao dịch chuyển khoản sẽ
