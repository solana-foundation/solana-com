...
Trên Solana, các chương trình là logic thực thi điều khiển trạng thái tài khoản.
Các tài khoản token được quản lý bởi **Chương trình Token**—mã onchain xác minh
các giao dịch chuyển và cập nhật số dư một cách nguyên tử.
...
Token-2022 (còn được gọi là "Token Extensions") bổ sung các tính năng như transfer hooks,
phí chuyển khoản và Số dư Bảo mật. Cả hai chương trình đều hoạt động tương tự nhau đối với các
giao dịch chuyển khoản cơ bản, nhưng bạn phải sử dụng đúng chương trình khi tạo ATA.
...
<Callout type="info">
  Solana sử dụng thị trường phí cục bộ — các giao dịch cạnh tranh với các giao dịch khác
  ghi vào cùng một trạng thái. Điều này có nghĩa là phí thanh toán luôn thấp và ổn định
  ngay cả trong các giai đoạn hoạt động mạng cao ở nơi khác.
</Callout>
...
<Cards>
  ...
  <Card title="Gửi khoản thanh toán đầu tiên" href="/docs/payments/send-payments">
