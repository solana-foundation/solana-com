...
Sau khi suy ra địa chỉ ATA, hãy kiểm tra xem token account có tồn tại trên chuỗi
hay không. Nếu ATA không tồn tại, bạn có thể bao gồm một lệnh để tạo token
account của người nhận trong cùng một giao dịch với việc chuyển khoản. Tuy
nhiên, điều này yêu cầu thanh toán rent cho token account mới. Vì người nhận sở
hữu ATA, SOL đã trả cho rent không thể được người gửi thu hồi.
