...
Chương trình memo của Solana cho phép bạn đính kèm số hóa đơn, ID đơn hàng hoặc
tham chiếu tùy chỉnh vào bất kỳ khoản thanh toán nào. Các memo này được ghi lại
vĩnh viễn trên chuỗi và hiển thị trong nhật ký giao dịch, giúp dễ dàng đối chiếu
thanh toán với hệ thống nội bộ của bạn.
