...
description: Tìm hiểu cách thanh toán cho nhiều người nhận trong một giao dịch duy nhất.
---
...
sắp ra mắt sẽ nâng giới hạn kích thước lên 4096 byte, cho phép chứa gấp khoảng ba lần số lượng
transfer trong mỗi giao dịch. Việc gộp lô vẫn cần thiết khi vượt quá ngưỡng đó, vì
runtime chỉ tải tối đa 64 tài khoản mỗi giao dịch bất kể định dạng nào.
