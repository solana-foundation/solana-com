...
[Kora](/docs/tools/kora) xử lý độ phức tạp này. Đây là máy chủ JSON-RPC cung cấp
fee abstraction để người dùng không bao giờ cần SOL. Bạn có thể tài trợ hoàn
