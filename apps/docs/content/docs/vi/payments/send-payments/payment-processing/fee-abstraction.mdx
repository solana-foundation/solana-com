...
Sử dụng `prepareAndSend` với cả `authority` (người gửi ký chuyển khoản) và
`feePayer` (nhà tài trợ trả phí). Cả hai đều phải ký giao dịch.
...
[Kora](/docs/products/kora) xử lý độ phức tạp này. Đây là máy chủ JSON-RPC cung
cấp fee abstraction để người dùng không bao giờ cần SOL. Bạn có thể tài trợ hoàn
toàn phí hoặc chấp nhận thanh toán phí bằng bất kỳ token nào.
...
<Cards>
  <Card
    title="Khởi động nhanh Kora"
    href="/docs/products/kora/getting-started/quick-start"
  >
    Chạy Kora trên máy local trong vài phút.
  </Card>
  <Card
    title="Demo giao dịch đầy đủ"
    href="/docs/products/kora/guides/full-demo"
  >
    Hướng dẫn triển khai giao dịch fee abstraction hoàn chỉnh.
  </Card>
  <Card title="Tài liệu API" href="/docs/products/kora/json-rpc-api">
    Tài liệu các phương thức JSON-RPC và SDK.
  </Card>
  <Card title="Hướng dẫn vận hành node" href="/docs/products/kora/operators">
    Triển khai và cấu hình instance Kora của riêng bạn.
  </Card>
</Cards>
