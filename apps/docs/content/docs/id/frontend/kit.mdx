...
description: Siapkan integrasi dompet Solana di Next.js dengan Solana Kit.
---

Siapkan integrasi dompet Solana minimal di Next.js dengan Solana Kit.

Panduan ini memberikan contoh minimal untuk mengimplementasikan fungsionalitas
dompet Solana dalam aplikasi Next.js menggunakan `@solana/kit`. Anda akan
...
di repositori Solana Kit.

## Sumber Daya

- [Dokumentasi Solana Kit](https://www.solanakit.com/docs)
- [Repositori GitHub Solana Kit](https://github.com/anza-xyz/kit)
...
UI dan instal dependensi Solana yang diperlukan.
...
Instal dependensi Solana berikut:
...
## !!steps 1. Membuat Solana Context
...
- Terhubung ke endpoint RPC devnet Solana
- Memfilter dompet Solana yang tersedia yang terpasang di browser pengguna
...
Selanjutnya, bungkus seluruh aplikasi Next.js dengan provider Solana.
...
- Membuat transaksi Solana dengan instruksi yang memanggil program memo
- Meminta dompet yang terhubung untuk menandatangani dan mengirim transaksi
- Menampilkan tautan untuk melihat transaksi di Solana Explorer
...
<Callout type="info">
  ...
  cluster devnet dan [diisi dengan devnet SOL](https://faucet.solana.com/) untuk
  mengirim transaksi.
</Callout>
