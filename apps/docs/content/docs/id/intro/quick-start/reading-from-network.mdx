...
digunakan untuk menemukan data onchain yang sesuai. Akun berisi baik
[data state maupun program yang dapat dijalankan](/docs/core/accounts#types-of-accounts).
