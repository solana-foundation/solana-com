...
[Kora](/docs/products/kora) menangani kompleksitas ini. Ini adalah server
JSON-RPC yang menyediakan abstraksi biaya sehingga pengguna tidak pernah
memerlukan SOL. Anda dapat sepenuhnya mensponsori biaya atau menerima pembayaran
biaya dalam token apa pun.
...
<Cards>
  ...
  <Card title="Referensi API" href="/docs/products/kora/json-rpc-api">
    Metode JSON-RPC dan dokumentasi SDK.
  </Card>
  <Card title="Panduan operator node" href="/docs/products/kora/operators">
