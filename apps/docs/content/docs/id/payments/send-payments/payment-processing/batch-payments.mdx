...
meningkatkan batas ukuran menjadi 4096 byte, yang muat sekitar tiga kali lebih banyak
transfer per transaksi. Pengelompokan masih diperlukan di luar itu, karena
runtime memuat maksimal 64 akun per transaksi terlepas dari formatnya.
