...
Setelah mendapatkan alamat ATA, periksa apakah token account tersebut ada di
onchain. Jika ATA tidak ada, Anda dapat menyertakan instruksi untuk membuat
token account penerima dalam transaksi yang sama dengan transfer. Namun, ini
memerlukan pembayaran rent untuk token account baru. Karena penerima memiliki
ATA, SOL yang dibayarkan untuk rent tidak dapat dikembalikan oleh pengirim.
