...
Saat bertindak sebagai delegasi, gunakan transfer standar tetapi tanda tangani
...
Setiap transfer mengurangi sisa allowance. Ketika allowance mencapai nol,
delegasi tidak dapat lagi mentransfer token.
...
| -------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| [Approve delegate](/docs/tokens/basics/approve-delegate) | Cara memberikan izin kepada akun lain untuk membelanjakan dari token account Anda. |
| [Revoke delegate](/docs/tokens/basics/revoke-delegate)   | Cara menghapus delegasi yang ada dan mencabut izin pembelanjaannya.                |
| [Transfer token](/docs/tokens/basics/transfer-tokens)    | Cara mentransfer token antar token account.                                        |
