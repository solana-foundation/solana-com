...
Simpan string yang diserialisasi di database Anda—tetap valid hingga nonce
dimajukan.

## Alur kerja persetujuan multi-pihak

Deserialisasi transaksi untuk menambahkan tanda tangan tambahan, lalu
...
- Lacak nonce mana yang "sedang digunakan" (memiliki transaksi tertanda tangan
  yang tertunda)
...
- _Siapa pun_ dengan byte transaksi yang telah diserialisasi dapat
  mengirimkannya ke jaringan
