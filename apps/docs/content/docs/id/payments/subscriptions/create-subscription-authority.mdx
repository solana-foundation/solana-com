...
- Gunakan kembali Otoritas Berlangganan yang ada untuk delegasi selanjutnya pada
  mint yang sama.
- Tutup Otoritas Berlangganan hanya setelah setiap delegasi yang bergantung
