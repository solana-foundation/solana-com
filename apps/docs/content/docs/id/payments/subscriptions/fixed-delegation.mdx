...
- Jumlah dalam satuan dasar. Untuk token 6 desimal, `1_000_000` berarti `1`
  token.
- Jalankan `initSubscriptionAuthority` hanya ketika akun Subscription Authority
  belum ada.
- Pengguna menandatangani transaksi setup dan revoke. Penerima delegasi
