...
<Callout type="caution" title="Jangan gunakan RPC publik untuk produksi">
  Endpoint publik (`api.mainnet.solana.com`, `api.devnet.solana.com`) memiliki
  pembatasan laju, tidak memiliki SLA, dan tidak cocok untuk alur pembayaran produksi.
  Gunakan [penyedia RPC](https://solana.com/rpc) untuk mengamankan endpoint RPC privat
