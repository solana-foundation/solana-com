...
- **Idempotency**: Transaksi yang ditandatangani sama selalu menghasilkan
  signature yang sama—mengirim ulang aman dilakukan
...
untuk biaya jaringan. Transaksi tanpa gas menyelesaikan masalah ini—mirip dengan
...
Untuk penandatanganan backend produksi, pertimbangkan untuk menggunakan
[solana-keychain](https://github.com/solana-foundation/solana-keychain)—sebuah
library penandatanganan terpadu yang mengabstraksi berbagai backend manajemen
kunci melalui satu interface: Memory, Vault, Privy, Turnkey, AWS KMS,
Fireblocks, GCP KMS, CDP, Para, Dfns, Crossmint. Ini memungkinkan Anda untuk
mengembangkan secara lokal dengan kunci in-memory, kemudian beralih ke backend
tingkat produksi tanpa mengubah kode aplikasi.

Tersedia untuk [Rust](https://crates.io/crates/solana-keychain) dan
[TypeScript](https://www.npmjs.com/package/@solana/keychain).

Lihat
[panduan Menambahkan Signer](https://github.com/solana-foundation/solana-keychain/blob/main/docs/ADDING_SIGNERS.md)
