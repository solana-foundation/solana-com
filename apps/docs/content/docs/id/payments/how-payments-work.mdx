...
Di Solana, program adalah logika yang dapat dieksekusi untuk mengatur state
akun. Akun token dikelola oleh **Program Token**—kode onchain yang memverifikasi
...
Token-2022 (juga disebut "Token Extensions") menambahkan fitur seperti transfer hooks,
biaya transfer, dan Saldo Rahasia. Kedua program bekerja serupa untuk transfer
dasar, namun Anda harus menggunakan yang tepat saat menurunkan ATA.
...
<Callout type="info">
  Solana menggunakan pasar biaya lokal—transaksi bersaing dengan transaksi lain
  yang menulis ke state yang sama. Ini berarti biaya pembayaran tetap rendah dan dapat diprediksi
  bahkan selama periode aktivitas jaringan yang tinggi di tempat lain.
</Callout>
...
<Cards>
  ...
  <Card title="Kirim pembayaran pertama Anda" href="/docs/payments/send-payments">
