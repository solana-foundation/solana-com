...
Token Metadata Program membuat Program Derived Address (PDA) untuk setiap token
mint. Akun metadata ini menyimpan informasi onchain seperti nama dan simbol
