...
[Surfpool](https://surfpool.run) mendukungnya. Jalankan contoh ini pada salah
satu dari keduanya (kode menggunakan devnet) dengan payer yang memiliki dana,
dan ganti placeholder alamat mint dan akun dengan milik Anda sendiri.
