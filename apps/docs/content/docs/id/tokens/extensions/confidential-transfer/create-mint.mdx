...
1. **Buat akun mint**: Panggil instruksi _rs`CreateAccount`_ dari System Program
   untuk membuat akun mint.
...
transaksi dengan ketiga instruksi tersebut dalam satu pemanggilan fungsi,
