...
description:
  Pelajari tentang ekstensi Confidential Balances dan cara menggunakannya untuk menambahkan fitur opsional ke mint account dan token account.
---
...
| ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`InitializeMint`_                | Mengaktifkan Confidential Balances pada mint account. Instruksi ini harus disertakan dalam transaksi yang sama dengan instruksi _rs`TokenInstruction::InitializeMint`_. |
| _rs`UpdateMint`_                    | Memperbarui kebijakan persetujuan akun mint dan kunci publik ElGamal auditor global yang bersifat opsional.                                                                        |
| _rs`ConfigureAccount`_              | Mengaktifkan Confidential Balances pada token account.                                                                                                                 |
| _rs`ApproveAccount`_                | Menyetujui token account untuk Confidential Balances jika mint memerlukan persetujuan untuk token account baru.                                                          |
...
| _rs`ConfigureAccountWithRegistry`_  | Cara alternatif untuk mengonfigurasi token account untuk Confidential Balances menggunakan akun _rs`ElGamalRegistry`_ sebagai pengganti bukti _rs`VerifyPubkeyValidity`_.         |
