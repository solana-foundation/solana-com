...
transfer rahasia. Token account pengirim juga harus memiliki saldo rahasia yang
tersedia untuk ditransfer.
...
4. Tutup akun status konteks bukti untuk mendapatkan kembali SOL yang digunakan
   untuk membuatnya.
