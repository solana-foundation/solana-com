...
Contoh berikut menarik token dari saldo tersedia rahasia kembali ke saldo
publik. Akun harus sudah dikonfigurasi untuk transfer rahasia dan memiliki saldo
...
[Surfpool](https://surfpool.run) mengaktifkannya. Jalankan contoh ini pada salah
satunya (kode menggunakan devnet) dengan payer yang memiliki saldo, dan ganti
placeholder dengan mint dan token account Anda.
