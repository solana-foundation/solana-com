...
## Cara menarik token dari saldo tersedia konfidensial

Untuk menarik token dari saldo tersedia konfidensial ke saldo publik:
...
1. Buat
   ...
   **Equality proof
   ...
   sesuai, memastikan saldo tersedia baru akun dihitung dengan benar sebagai
   ...
   **Range proof
   ...
   Memverifikasi bahwa saldo tersedia yang tersisa setelah penarikan adalah
   non-negatif dan berada dalam rentang yang ditentukan.
...
dari saldo tersedia konfidensial ke saldo publik:
...
Untuk menarik token dari saldo tersedia konfidensial ke saldo publik, Anda
harus:

- Menghasilkan equality proof dan range proof di sisi klien
- Memanggil Zk ElGamal proof program untuk memverifikasi bukti dan
  menginisialisasi akun "context state"
- Memanggil instruksi
  [ConfidentialTransferInstruction::Withdraw](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L493)
  dengan menyediakan dua akun bukti.
- Menutup dua akun bukti untuk memulihkan rent.
