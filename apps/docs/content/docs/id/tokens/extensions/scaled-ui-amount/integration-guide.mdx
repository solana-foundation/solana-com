...
- Multiplier saat ini dapat dibaca dari token mint kapan saja dengan memanggil
  `getAccountInfo`. Selain itu, jika multiplier masa depan telah ditetapkan,
  informasi ini juga tersedia dari token mint. Kami menyarankan untuk tidak
  menampilkan multiplier ini karena dapat membingungkan UX.
