---
title: Pausable mint
description: Pelajari cara mengaktifkan PausableMintExtension.
---

## Cara mengaktifkan PausableExtension
...
memungkinkan otoritas jeda yang ditunjuk untuk menghentikan semua aktivitas
token pada mint. Otoritas jeda dapat menjeda atau melanjutkan mint kapan saja.

Ketika dijeda, program Token-2022 menolak semua transfer, minting, dan burning
untuk token tersebut. Ketika dilanjutkan, operasi normal kembali berjalan.

Ini adalah pola umum dalam sistem token blockchain maupun keuangan tradisional,
di mana kemampuan untuk membekukan aktivitas diperlukan untuk kepatuhan, respons
insiden, atau kontrol administratif.
