...
setiap token account baru dengan status yang ditentukan, seperti frozen. Ini
memungkinkan pembuat token untuk menerapkan perilaku tertentu, seperti
mengharuskan semua akun baru dibekukan secara default hingga secara eksplisit
dicairkan.
