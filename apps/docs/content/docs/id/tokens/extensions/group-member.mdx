...
menunjuk sebuah mint sebagai group mint (seperti Collection NFT) dengan mengarah
ke akun yang berisi
...
seperti update authority dan ukuran maksimum.
...
menunjuk sebuah mint sebagai member mint (seperti NFT dalam sebuah koleksi)
dengan mengarah ke akun yang berisi
