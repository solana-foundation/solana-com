...
Token Extensions Program memungkinkan Anda menyimpan metadata (nama, simbol,
tautan gambar) langsung pada mint account.
...
[Panduan Metadata Extension](/developers/guides/token-extensions/metadata-pointer).
