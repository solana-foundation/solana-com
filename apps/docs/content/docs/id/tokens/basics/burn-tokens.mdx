---
title: Bakar Token
description: Bakar token dari token account dan kurangi total pasokan mint.
...
total pasokan mint dengan jumlah yang sama.
...
Pemilik token account atau delegasi yang disetujui menandatangani transaksi. Di
Token Extensions Program, delegasi permanen mint juga dapat mengotorisasi
...
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_         | State mint menyimpan total pasokan token.                                                                                                                             | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
