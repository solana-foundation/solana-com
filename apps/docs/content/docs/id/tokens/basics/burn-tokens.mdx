...
secara permanen menghancurkan token dengan mengurangi saldo dalam akun token.
Token yang dibakar dihapus dari sirkulasi dan mengurangi `supply` yang dilacak
pada akun mint. Hanya pemilik akun token yang dapat membakar token dari akun
mereka.
