---
title: Bakar Token
description: Bakar token dari token account dan kurangi total supply mint.
...
## Apa yang Dilakukan Pembakaran Token?

Membakar token secara permanen mengurangi saldo token account dan mengurangi
total supply mint dengan jumlah yang sama.

## Cara Membakar Token

Membakar token menggunakan instruksi _rs`Burn`_ atau _rs`BurnChecked`_ dari
Token Program.

Contoh di bawah ini menggunakan _rs`BurnChecked`_, yang mengharuskan pemanggil
untuk menyediakan desimal mint sehingga instruksi dapat memverifikasi presisi
token yang diharapkan sebelum membakar.

[Native mint](/docs/tokens/basics/sync-native) tidak mendukung pembakaran.
Gunakan _rs`CloseAccount`_ sebagai gantinya.

Pemilik token account atau delegasi yang disetujui menandatangani transaksi.
Dalam Token Extensions Program, delegasi permanen mint juga dapat mengotorisasi
pembakaran jika mint memiliki ekstensi delegasi permanen yang diaktifkan.

### Referensi Sumber

| Item               | Deskripsi                                                                                                                                                            | Token Program                                                                                                  | Token Extensions Program                                                                                             |
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_         | State mint menyimpan total supply token.                                                                                                                             | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_      | State token account menyimpan saldo token yang dikurangi melalui pembakaran.                                                                                         | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Burn`_         | Instruksi pembakaran yang mengurangi saldo token account dan supply mint tanpa mengharuskan pemanggil untuk menyediakan desimal mint.                                | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L178-L196) | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L221-L239) |
| _rs`BurnChecked`_  | Instruksi pembakaran yang mengharuskan pemanggil untuk menyediakan desimal mint dan memeriksa nilai tersebut sebelum mengurangi saldo token account dan supply mint. | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L326-L350) | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L393-L417) |
| _rs`process_burn`_ | Logika prosesor bersama untuk pembakaran token.                                                                                                                      | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L586-L668)     | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1070-L1194)   |
