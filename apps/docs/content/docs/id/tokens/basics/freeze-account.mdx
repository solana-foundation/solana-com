...
mencegah semua transfer token atau pembakaran token dari akun token tertentu.
Setelah dibekukan, akun tersebut tidak dapat mengirim token atau menerima token
sampai dicairkan kembali. Akun yang dibekukan masih dapat ditutup jika memiliki
saldo token nol. Hanya otoritas pembekuan dari mint account token yang dapat
membekukan akun. Jika otoritas pembekuan dicabut (diatur ke null) pada mint
