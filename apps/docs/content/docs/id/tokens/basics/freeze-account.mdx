...
description:
  Bekukan akun token dengan freeze authority mint untuk memblokir transfer,
  burn, dan perubahan delegasi.
...
## Apa yang Dilakukan Pembekuan Token Account?

Membekukan token account tetap mempertahankan owner, mint, dan balance yang
sama, tetapi mencegah token account dari mentransfer atau membakar token hingga
token account dicairkan.

Akun yang dibekukan masih dapat ditutup jika akun yang dibekukan memiliki saldo
token nol.

Hanya mint yang masih memiliki freeze authority yang dapat membekukan token
account. Jika freeze authority mint dicabut, akun untuk mint tersebut tidak
dapat lagi dibekukan.

## Cara Membekukan Token Account

Membekukan token account menggunakan instruksi _rs`FreezeAccount`_ dari Token
Program.

Instruksi _rs`FreezeAccount`_ memverifikasi bahwa token account tersebut milik
mint dan bahwa penandatangan adalah freeze authority mint, kemudian mengubah
status token account dari initialized menjadi frozen.
...
| ----------------------------------- | --------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                          | State mint menyimpan freeze authority opsional yang digunakan untuk membekukan token account. | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`AccountState`_                  | State token account, termasuk _rs`Initialized`_ dan _rs`Frozen`_.                             | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L185-L195)       | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L203-L213)       |
| _rs`FreezeAccount`_                 | Instruksi yang mengubah token account menjadi state frozen.                                   | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L213-L228) | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L276-L291) |
| _rs`process_toggle_freeze_account`_ | Logika prosesor bersama untuk membekukan dan mencairkan token account.                        | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L713-L754)     | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1293-L1341)   |
