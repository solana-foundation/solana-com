...
mencegah semua transfer token atau pembakaran token dari mint account tertentu.
Setelah dibekukan, akun tidak dapat mengirim token atau menerima token hingga
dicairkan kembali. Akun yang dibekukan masih dapat ditutup jika memiliki saldo
token nol. Hanya otoritas pembekuan dari mint token yang dapat membekukan akun.
Jika otoritas pembekuan dicabut (diatur ke null) pada mint account, token tidak
akan pernah bisa dibekukan.
