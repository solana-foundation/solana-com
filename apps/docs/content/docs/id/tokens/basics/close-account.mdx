...
secara permanen menutup token account dan mentransfer semua SOL yang tersisa
(rent) ke akun tujuan yang ditentukan. Saldo token account harus nol sebelum
ditutup. Hanya pemilik token account atau close authority yang ditunjuk yang
dapat menjalankan instruksi ini.
