...
description: Tutup akun token dan kembalikan lamport akun ke akun tujuan.
...
mengklaim kembali SOL yang mendasarinya. Pemilik akun atau otoritas penutupan
akun menandatangani instruksi penutupan.
...
membersihkan akun sumber, dan menghapus akun sumber. Token Extensions Program
...
| --------------------------- | ------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_               | State akun token menyimpan saldo, status native, dan otoritas penutupan yang digunakan selama penutupan akun. | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
