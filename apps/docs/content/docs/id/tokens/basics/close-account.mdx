...
## Apa yang Dilakukan dengan Menutup Akun Token?
...
dapat ditutup jika saldo token akun yang dibekukan tersebut adalah nol. Akun
token SOL yang dibungkus merupakan pengecualian dan dapat ditutup dengan saldo
token untuk mengklaim kembali SOL yang mendasarinya. Pemilik akun atau otoritas
penutupan akun menandatangani instruksi penutupan.
...
menghapus akun sumber, dan menghapus akun sumber. Token Extensions Program
menerapkan pemeriksaan penutupan tambahan untuk ekstensi tertentu, tetapi alur
penutupan dasarnya tetap sama.

### Referensi Sumber

| Item                        | Deskripsi                                                                                                      | Token Program                                                                                                  | Token Extensions Program                                                                                             |
| --------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_               | Status akun token menyimpan saldo, status native, dan otoritas penutupan yang digunakan selama penutupan akun. | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`CloseAccount`_          | Instruksi yang menutup akun token dan mentransfer lamport akun token ke akun tujuan.                           | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L197-L212) | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L240-L274) |
| _rs`process_close_account`_ | Logika prosesor bersama untuk penutupan akun token.                                                            | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L671-L709)     | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1197-L1289)   |
