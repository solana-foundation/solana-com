...
description: Mencetak unit token baru ke akun token dengan otoritas pencetakan.
...
## Apa yang Dilakukan Pencetakan?

Pencetakan menciptakan unit baru dari token yang sudah ada dan meningkatkan
total pasokan mint.

Hanya otoritas mint yang dapat mencetak token baru. Token account tujuan harus
sudah ada dan harus milik mint yang sama.

## Cara Mencetak Token

Mencetak token menggunakan instruksi _rs`MintTo`_ atau _rs`MintToChecked`_ dari
Token Program.

Contoh di bawah menggunakan _rs`MintToChecked`_, yang mengharuskan pemanggil
menyediakan desimal mint sehingga instruksi dapat memverifikasi presisi token
yang diharapkan sebelum mencetak.

[Native mint](/docs/tokens/basics/sync-native) tidak mendukung pencetakan.

### Referensi Sumber

| Item                  | Deskripsi                                                                                                                                                | Token Program                                                                                                  | Token Extensions Program                                                                                             |
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_            | State mint menyimpan otoritas mint dan total pasokan token.                                                                                              | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_         | State token account menyimpan saldo tujuan yang diperbarui oleh pencetakan.                                                                              | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`MintTo`_          | Instruksi mint yang mencetak token ke token account yang sudah ada tanpa mengharuskan pemanggil menyediakan desimal mint.                                | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L159-L177) | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L202-L220) |
| _rs`MintToChecked`_   | Instruksi mint yang mengharuskan pemanggil menyediakan desimal mint dan memeriksa nilai tersebut sebelum mencetak token ke token account yang sudah ada. | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L301-L325) | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L367-L391) |
| _rs`process_mint_to`_ | Logika processor bersama untuk mencetak token.                                                                                                           | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L521-L583)     | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L981-L1067)    |

### Typescript

Contoh `Kit` di bawah menunjukkan pendekatan yang direkomendasikan menggunakan
`@solana/kit`. Contoh legacy menggunakan `@solana/web3.js` disertakan sebagai
referensi.
