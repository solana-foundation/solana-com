...
description: Cetak unit token baru ke token account dengan otoritas pencetakan.
...
## Apa Fungsi Pencetakan?

Pencetakan membuat unit baru dari token yang sudah ada dan meningkatkan total
pasokan mint.

Hanya otoritas mint yang dapat mencetak token baru. Token account tujuan harus
sudah ada dan harus terkait dengan mint yang sama.

## Cara Mencetak Token

Pencetakan token menggunakan instruksi _rs`MintTo`_ atau _rs`MintToChecked`_
dari Token Program.

Contoh di bawah ini menggunakan _rs`MintToChecked`_, yang mengharuskan pemanggil
...
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_            | State mint menyimpan otoritas mint dan total pasokan token.                                                                                              | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_         | State token account menyimpan saldo tujuan yang diperbarui melalui pencetakan.                                                                           | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
...
| _rs`MintToChecked`_   | Instruksi mint yang mengharuskan pemanggil menyediakan desimal mint dan memeriksa nilai tersebut sebelum mencetak token ke token account yang sudah ada. | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L301-L325) | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L367-L391) |
| _rs`process_mint_to`_ | Logika prosesor bersama untuk mencetak token.                                                                                                            | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L521-L583)     | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L981-L1067)    |
