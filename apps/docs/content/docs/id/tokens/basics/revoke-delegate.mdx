...
description:
  Hapus delegasi saat ini dari akun token dan kosongkan sisa allowance yang
  didelegasikan.
...
mentransfer atau membakar token atas nama token account.
