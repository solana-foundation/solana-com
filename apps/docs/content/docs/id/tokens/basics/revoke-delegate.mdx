...
menghapus semua izin transfer dari delegate yang saat ini disetujui. Setelah
pencabutan, delegate tidak dapat lagi mentransfer token apa pun dari akun Anda.
Untuk Token Program, hanya pemilik token account yang dapat mencabut delegate.
Untuk Token Extension Program, pemilik token account dan delegate saat ini dapat
mencabut delegasi.
