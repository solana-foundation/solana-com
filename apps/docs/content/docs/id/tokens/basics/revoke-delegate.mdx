...
description:
  Hapus delegasi saat ini dari token account dan kosongkan sisa allowance yang
  didelegasikan.
...
## Apa yang Dilakukan Pencabutan Delegasi?

Mencabut delegasi akan menghapus delegasi saat ini dari token account dan
mengatur ulang jumlah yang didelegasikan menjadi nol.

Setelah pencabutan, delegasi sebelumnya tidak lagi memiliki wewenang untuk
mentransfer atau membakar token atas nama token account tersebut.

## Cara Mencabut Delegasi

Mencabut delegasi menggunakan instruksi _rs`Revoke`_ dari Token Program.

Instruksi _rs`Revoke`_ menghapus field delegasi pada token account sumber. Dalam
Token Program, pemilik token account menandatangani pencabutan. Dalam Token
Extensions Program, delegasi saat ini juga dapat mencabut delegasinya sendiri.

### Referensi Sumber

| Item                 | Deskripsi                                                             | Token Program                                                                                                  | Token Extensions Program                                                                                             |
| -------------------- | --------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_        | State token account menyimpan delegasi dan jumlah yang didelegasikan. | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Revoke`_         | Instruksi yang menghapus delegasi saat ini dari token account.        | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L128-L140) | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L170-L182) |
| _rs`process_revoke`_ | Logika processor bersama untuk pencabutan delegasi.                   | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L395-L420)     | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L643-L674)     |
