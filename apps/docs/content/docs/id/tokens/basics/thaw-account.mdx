...
description:
  Cairkan akun token yang dibekukan agar transfer, pembakaran, dan perubahan
  delegasi dapat dilanjutkan kembali.
...
## Apa yang Dilakukan Pencairan Akun Token?

Pencairan mengubah token account dari status beku kembali ke status
terinisialisasi.

Setelah pencairan berhasil, akun dapat mentransfer, membakar, dan menutup token
kembali. Hanya freeze authority milik mint yang dapat mencairkan token account.

## Cara Mencairkan Akun Token

Pencairan token account menggunakan instruksi _rs`ThawAccount`_ dari Token
Program.

Instruksi _rs`ThawAccount`_ memverifikasi bahwa token account milik mint
tersebut dan bahwa penandatangan adalah freeze authority milik mint, kemudian
mengubah status token account dari beku kembali ke terinisialisasi.

[Akun token asli](/docs/tokens/basics/sync-native) tidak mendukung pencairan.

### Referensi Sumber

| Item                                | Deskripsi                                                                                      | Token Program                                                                                                  | Token Extensions Program                                                                                             |
| ----------------------------------- | ---------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                          | Status mint menyimpan freeze authority opsional yang digunakan untuk mencairkan token account. | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`AccountState`_                  | Status token account, termasuk _rs`Frozen`_ dan _rs`Initialized`_.                             | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L185-L195)       | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L203-L213)       |
| _rs`ThawAccount`_                   | Instruksi yang mengubah token account yang dibekukan kembali ke status terinisialisasi.        | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L229-L243) | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L292-L306) |
| _rs`process_toggle_freeze_account`_ | Logika prosesor bersama untuk membekukan dan mencairkan token account.                         | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L713-L754)     | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1293-L1341)   |
