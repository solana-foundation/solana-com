...
description:
  Berikan otorisasi kepada alamat lain untuk mentransfer atau membakar sejumlah
  token terbatas dari sebuah token account.
...
## Apa Fungsi Menyetujui Delegasi?
...
delegasi sebelumnya dan batas alokasi pada akun tersebut.
...
Contoh di bawah ini menggunakan _rs`ApproveChecked`_, yang memerlukan pemanggil
untuk menyediakan mint dan desimal sehingga instruksi dapat memverifikasi mint
yang diharapkan dan presisi token sebelum memproses persetujuan.

Pemilik token account menandatangani persetujuan tersebut.
...
| _rs`Approve`_         | Instruksi persetujuan delegasi yang mencatat delegasi dan batas alokasi untuk sebuah token account tanpa mengharuskan pemanggil menyediakan mint atau desimal.            | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L109-L127) | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L150-L168) |
| _rs`ApproveChecked`_  | Instruksi persetujuan delegasi yang mengharuskan pemanggil menyediakan mint dan desimal serta memeriksa nilai-nilai tersebut sebelum mencatat delegasi dan batas alokasi. | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L274-L300) | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L340-L366) |
| _rs`process_approve`_ | Logika prosesor bersama untuk persetujuan delegasi.                                                                                                                       | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L344-L392)     | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L582-L640)     |
