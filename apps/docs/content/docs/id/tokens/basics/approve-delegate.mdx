...
description:
  Mengotorisasi alamat lain untuk mentransfer atau membakar sejumlah token
  terbatas dari sebuah token account.
...
## Apa yang Dilakukan Menyetujui Delegasi?

Menyetujui delegasi memungkinkan alamat lain untuk mentransfer atau membakar
sejumlah token terbatas dari sebuah token account atas nama pemilik token
account.

Sebuah token account menyimpan satu delegasi aktif dan satu jumlah yang
didelegasikan pada satu waktu. Menyetujui delegasi baru akan menggantikan
delegasi sebelumnya dan batasan jumlah pada akun tersebut.

## Cara Menyetujui Delegasi

Menyetujui delegasi menggunakan instruksi _rs`Approve`_ atau
_rs`ApproveChecked`_ dari Token Program.

Contoh di bawah ini menggunakan _rs`ApproveChecked`_, yang mengharuskan
pemanggil untuk menyediakan mint dan decimals sehingga instruksi dapat
memverifikasi mint yang diharapkan dan presisi token sebelum memproses
persetujuan.

Pemilik token account menandatangani persetujuan.

### Referensi Sumber

| Item                  | Deskripsi                                                                                                                                                                   | Token Program                                                                                                  | Token Extensions Program                                                                                             |
| --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_         | State token account menyimpan pemilik, delegasi, dan jumlah yang didelegasikan.                                                                                             | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Approve`_         | Instruksi persetujuan delegasi yang mencatat delegasi dan batasan jumlah untuk sebuah token account tanpa mengharuskan pemanggil menyediakan mint atau decimals.            | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L109-L127) | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L150-L168) |
| _rs`ApproveChecked`_  | Instruksi persetujuan delegasi yang mengharuskan pemanggil menyediakan mint dan decimals serta memeriksa nilai-nilai tersebut sebelum mencatat delegasi dan batasan jumlah. | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L274-L300) | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L340-L366) |
| _rs`process_approve`_ | Logika pemroses bersama untuk persetujuan delegasi.                                                                                                                         | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L344-L392)     | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L582-L640)     |
