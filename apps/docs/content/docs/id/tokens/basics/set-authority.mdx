...
description:
  Mengubah atau mencabut peran otoritas pada mint account atau token account,
  termasuk otoritas mint, freeze, owner, dan close.
...
## Apa Fungsi Menetapkan Otoritas?

Menetapkan otoritas mengubah atau mencabut peran otoritas tertentu pada mint
account atau token account.

Mint account dapat menyimpan otoritas mint dan otoritas freeze. Token account
menyimpan owner dan dapat secara opsional menyimpan otoritas close. Setiap peran
mengontrol set izin tertentu, dan menetapkan otoritas ke _rs`None`_ secara
permanen menghapus peran otoritas yang dipilih.

Token Extensions Program juga mendefinisikan tipe otoritas tambahan untuk
ekstensi tertentu.

## Cara Menetapkan Otoritas

Mengubah otoritas menggunakan instruksi _rs`SetAuthority`_ dari Token Program.

Setiap panggilan memperbarui satu tipe otoritas pada satu mint account atau
token account. Otoritas saat ini menandatangani perubahan, dan otoritas baru
dapat berupa alamat lain atau _rs`None`_ untuk mencabut otoritas yang dipilih
secara permanen.
...
| --------------------------- | ----------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                  | State mint menyimpan _rs`mint_authority`_ dan _rs`freeze_authority`_.                     | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)           |
| _rs`Account`_               | State token account menyimpan _rs`owner`_ dan _rs`close_authority`_.                      | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)          |
| _rs`AuthorityType`_         | Peran otoritas yang dapat diperbarui oleh _rs`SetAuthority`_.                             | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L739-L751) | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L1116-L1157) |
| _rs`SetAuthority`_          | Instruksi yang mengubah atau mencabut satu otoritas pada mint account atau token account. | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L141-L158) | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L183-L200)   |
| _rs`process_set_authority`_ | Logika prosesor bersama untuk pembaruan otoritas.                                         | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L423-L518)     | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L677-L978)       |
