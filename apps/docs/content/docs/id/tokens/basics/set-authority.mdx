...
description:
  Mengubah atau mencabut peran otoritas pada mint atau token account, termasuk
  otoritas mint, freeze, owner, dan close.
...
## Apa yang Dilakukan oleh Pengaturan Otoritas?

Pengaturan otoritas mengubah atau mencabut peran otoritas tertentu pada mint
atau token account.

Mint account dapat menyimpan mint authority dan freeze authority. Token account
menyimpan owner dan dapat secara opsional menyimpan close authority. Setiap
peran mengontrol set izin tertentu, dan mengatur otoritas menjadi _rs`None`_
akan menghapus peran otoritas yang dipilih secara permanen.
...
Setiap pemanggilan memperbarui satu tipe otoritas pada satu mint atau token
account. Otoritas saat ini menandatangani perubahan tersebut, dan otoritas baru
...
| _rs`SetAuthority`_          | Instruksi yang mengubah atau mencabut satu otoritas pada mint atau token account. | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L141-L158) | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L183-L200)   |
| _rs`process_set_authority`_ | Logika processor bersama untuk pembaruan otoritas.                                | [Sumber](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L423-L518)     | [Sumber](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L677-L978)       |
