...
Menggunakan [verified builds pada Solana](/docs/programs/verified-builds) memastikan
integritas dan keterpercayaan program Anda di jaringan serta memungkinkan
pengembang menemukan SDK Anda langsung dari Solana Explorer. Dengan memanfaatkan
alat seperti Solana Verify CLI dan Docker, Anda dapat mempertahankan build yang
dapat diverifikasi dan aman sesuai dengan kode sumber Anda. Selalu ambil
tindakan pencegahan yang diperlukan untuk menggunakan lingkungan yang konsisten,
dan pertimbangkan solusi tata kelola untuk peningkatan dan penerapan yang aman.
