...
Paket `@solana-commerce/connector` menyediakan koneksi dompet tanpa antarmuka yang dibangun di atas
[Wallet Standard](https://github.com/wallet-standard/wallet-standard). Paket ini
mengelola penemuan dompet, status koneksi, manajemen akun, dan
rekoneksi otomatis. Paket ini dirancang agar tidak bergantung pada framework dengan
binding React yang disertakan. Paket ini disesuaikan untuk penggunaan yang mulus di Solana Commerce Kit dan
kompatibel dengan [@solana/kit](https://github.com/anza-xyz/kit).
