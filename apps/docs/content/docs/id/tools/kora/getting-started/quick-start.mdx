...
Buka lima terminal dan jalankan perintah berikut:
...
- Anda dapat secara opsional menentukan pembayar biaya khusus untuk pembuatan ATA dengan menggunakan flag
  `--fee-payer-key`.
