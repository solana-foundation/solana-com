---
title: Integrasi Kode QR
description: Hasilkan dan sesuaikan kode QR untuk pembayaran dompet seluler
---

Kode QR adalah cara paling umum untuk menjembatani kesenjangan antara aplikasi
web dan dompet seluler. Solana Pay menyertakan fungsi `createQR` bawaan yang
didukung oleh `@solana/qr-code-styling` — tidak memerlukan paket kode QR
tambahan.

## Pembuatan Kode QR Dasar

### Menghasilkan dan Menampilkan Kode QR
...
Fungsi `createQR` menerima parameter opsional untuk ukuran, warna latar
belakang, dan warna latar depan:
...
### Mendapatkan Opsi QR untuk Penggunaan Lanjutan

Gunakan `createQROptions` untuk mendapatkan objek konfigurasi mentah guna
...
## Menggunakan Klien Merchant

Klien merchant juga menyediakan metode kode QR:
...
### QR Pembayaran dengan Pembaruan Status
...
### Tampilan Dioptimalkan untuk Seluler

Pada perangkat seluler, pertimbangkan untuk menyediakan tautan langsung di
samping kode QR:
