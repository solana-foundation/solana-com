...
description:
  Cara Private Channels menggunakan Sparse Merkle Tree untuk mencegah double-spend pada penarikan
---
...
1. `verify_smt_exclusion_proof` membuktikan bahwa daun nonce saat ini kosong terhadap
   `Instance.withdrawal_transactions_root` saat ini
2. `verify_smt_inclusion_proof` membuktikan bahwa daun nonce ada dalam
