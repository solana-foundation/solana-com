...
description:
  Pilih backend penandatanganan Keychain sesuai kebutuhan Anda — custody, infrastruktur yang sudah ada, kontrol persetujuan, dan apakah Anda menandatangani untuk aplikasi Anda sendiri atau menyediakan dompet bagi pengguna akhir.
related:
...
### Apakah Anda memerlukan persetujuan multi-pihak, penyimpanan institusional, atau kontrol regulasi?

Jika tanda tangan harus melewati kebijakan persetujuan, batas pengeluaran, atau
alur kerja kepatuhan sebelum dihasilkan — atau Anda memerlukan kustodian teregulasi yang menyimpan
kunci — gunakan backend **MPC / penyimpanan institusional**: Fireblocks, Dfns, Para,
Utila, atau Fordefi. Backend ini membagi atau menyimpan kunci dan menandatangani bersama sesuai kebijakan Anda.

Jika Anda hanya memerlukan kunci yang menandatangani sesuai permintaan, lanjutkan di bawah.
...
- **Cloud KMS / HSM** — penyedia cloud menyimpan kunci dalam infrastruktur
  ...
  KMS**, **GCP KMS**.
- **MPC & penyimpanan institusional** — kunci dibagi atau disimpan melalui
  penyedia, yang menandatangani bersama sesuai kebijakan Anda (persetujuan, batas).
  Backend: **Fireblocks**, **Dfns**, **Para**, **Utila**, **Fordefi**.
...
| Fordefi         | Kustodi MPC / institusional  | Penyimpanan institusional dengan kontrol kebijakan | Mode native melakukan siaran otomatis; mode black box Anda yang mengirim |
