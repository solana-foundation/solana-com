...
description: Pahami cara kerja LiteSVM dan perbedaannya
---

## Ikhtisar

Bayangkan LiteSVM sebagai VM Solana yang berjalan di dalam fungsi pengujian
Anda. Bukan sebagai proses terpisah, bukan sebagai layanan jaringan - ini
hanyalah pemanggilan library dalam kode Anda.
...
### 1. Semuanya Bersifat Sinkron

Tidak ada `async`, tidak ada `await`, tidak ada penundaan:
...
### 3. Waktu Ada di Bawah Kendali Anda
...
### 4. Error Bersifat Langsung dan Jelas
