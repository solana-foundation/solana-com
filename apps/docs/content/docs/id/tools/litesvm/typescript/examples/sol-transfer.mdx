...
Transaksi Solana paling dasar: memindahkan SOL dari satu akun ke akun lain. Ini adalah uji coba pertama yang baik untuk memverifikasi bahwa pengaturan LiteSVM Anda berfungsi sebelum menguji logika program yang lebih kompleks.
...
[Pengujian Program](/docs/tools/litesvm/typescript/examples/program-testing). Untuk
transfer token (mint, ATA), lihat
