...
title: Cheatcodes
description:
  Lewati transaksi dan langsung ubah status Surfnet. Dana SOL dan token, atur data akun sembarang, reset akun yang di-cache upstream, dan streaming akun mainnet secara langsung.
---
