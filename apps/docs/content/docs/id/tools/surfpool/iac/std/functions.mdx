---
title: Fungsi Standar
description: Fungsi utilitas yang tersedia di pustaka standar
---

Fungsi-fungsi ini tersedia di semua Runbook sebagai bagian dari pustaka standar.

## Operator

Operator matematika dan perbandingan dasar:
