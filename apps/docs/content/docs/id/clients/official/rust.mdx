...
Gunakan `solana-program` untuk membangun program onchain.

- [Contoh: Membangun program Solana](/docs/programs/rust)

| Crate          | Deskripsi                 | Dokumentasi                             | GitHub                                                               |
| -------------- | ------------------------- | --------------------------------------- | -------------------------------------------------------------------- |
| solana-program | Membangun program onchain | [Lihat](https://docs.rs/solana-program) | [Sumber](https://github.com/anza-xyz/solana-sdk/tree/master/program) |

Pinocchio adalah pustaka tanpa dependensi untuk membuat program Solana di Rust
dan dapat digunakan sebagai pengganti `solana-program` untuk menulis program
onchain.

| Crate     | Deskripsi                        | Dokumentasi                        | GitHub                                          |
| --------- | -------------------------------- | ---------------------------------- | ----------------------------------------------- |
| pinocchio | Program onchain tanpa dependensi | [Lihat](https://docs.rs/pinocchio) | [Sumber](https://github.com/anza-xyz/pinocchio) |
...
| Crate           | Deskripsi                                                                                                        | Dokumentasi                                       | GitHub                                                         |
| --------------- | ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- | -------------------------------------------------------------- |
| solana-keychain | Penandatanganan terpadu: Memory, Vault, Privy, Turnkey, AWS KMS, Fireblocks, GCP KMS, CDP, Para, Dfns, Crossmint | [Crate](https://crates.io/crates/solana-keychain) | [Source](https://github.com/solana-foundation/solana-keychain) |

Gunakan feature flag untuk menyertakan hanya backend yang Anda butuhkan. Lihat
