...
| Crate           | Deskripsi                                                                                                                         | Docs                                              | GitHub                                                         |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- | -------------------------------------------------------------- |
| solana-keychain | Penandatanganan terpadu: Memory, Vault, Privy, Turnkey, AWS KMS, Fireblocks, GCP KMS, CDP, Para, Dfns, Crossmint, Openfort, Utila | [Crate](https://crates.io/crates/solana-keychain) | [Source](https://github.com/solana-foundation/solana-keychain) |

Gunakan feature flag untuk menyertakan hanya backend yang Anda butuhkan. Lihat
[dokumentasi Keychain](/docs/tools/keychain) dan
[Memilih backend](/docs/tools/keychain/choosing-a-backend) untuk panduan
pengaturan dan model penyimpanan aset.
