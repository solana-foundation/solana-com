...
Panduan ini mencakup implementasi lengkap yang berfungsi dan dapat Anda jalankan secara lokal. 
[Kode sumber](https://github.com/Woody4618/access-control-list-acl-demo)
menyediakan implementasi referensi untuk keperluan eksplorasi dan edukasi.

Kode program ACL tersedia di
[repositori token-acl](https://github.com/solana-foundation/token-acl) dan
Program ABL Gate tersedia di
[repositori token-acl-gate](https://github.com/solana-foundation/token-acl-gate).

**Penting**: Program ABL (Allow Block List) Gate yang digunakan dalam panduan ini adalah
**implementasi referensi**. Meskipun telah diaudit dan siap untuk produksi, para penerbit
bebas membuat Program Gate khusus yang lebih sesuai dengan kebutuhan kepatuhan mereka. Anda hanya terikat oleh spesifikasi Token ACL (sRFC37),
bukan desain Program Gate tertentu ini.
