...
menambahkan ~200 byte. Untuk penyelesaian multi-pihak yang sangat besar, pertimbangkan untuk menggunakan
[Address Lookup Tables](/developers/cookbook/transactions/lookup-tables) untuk
mengompresi alamat akun dan memasukkan lebih banyak transfer per transaksi.
