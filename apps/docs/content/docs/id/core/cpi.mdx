...
<Callout>
  ...
  dan diatur ke konstanta [MAX_INSTRUCTION_STACK_DEPTH](https://github.com/anza-xyz/agave/blob/v2.1.13/compute-budget/src/compute_budget.rs#L13)
  sebesar 5.
...
Ketika CPI memerlukan penandatangan PDA, fungsi
[`invoke_signed`](https://github.com/anza-xyz/agave/blob/v2.1.13/sdk/program/src/program.rs#L51-L73)
digunakan. Fungsi ini menerima [signer seeds](mention:signer-seeds) yang
digunakan untuk menurunkan [PDA](<(/docs/core/pda)>) penandatangan. Runtime
Solana secara internal memanggil
...
diverifikasi, ia
[ditambahkan sebagai penandatangan yang valid](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/bpf_loader/src/syscalls/cpi.rs#L554).
...
- **Contoh 1**: Menggunakan _rs`CpiContext`_ Anchor dan fungsi helper.
...
Ketika CPI tidak memerlukan penandatangan PDA, fungsi
...
`signers_seeds` yang kosong. Array signers yang kosong menunjukkan bahwa tidak
