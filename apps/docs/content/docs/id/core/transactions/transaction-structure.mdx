...
namun perhatikan bahwa setiap instruksi berisi informasi wajib yang sama.
...
Setelah pengiriman, ambil detail transaksi menggunakan signature transaksi dan
metode RPC [getTransaction](/docs/rpc/http/gettransaction).
