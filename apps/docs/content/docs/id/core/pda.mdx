...
Ini berarti bahwa dengan seed opsional yang sama dan `programId`, bump seed
dengan nilai yang berbeda masih dapat menurunkan PDA yang valid.
...
[Anchor framework](https://www.anchor-lang.com/docs) untuk membuat akun baru
dengan program-derived address. Program ini mencakup satu instruksi
...
akun baru menggunakan PDA sebagai alamatnya. [Seed](mention:seeds) yang
digunakan untuk membuat PDA adalah:
