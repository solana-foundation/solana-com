...
description: Métodos para gerenciar contas, saldos e rent
---
...
Onde `TransactionResult` é
`Result<TransactionMetadata, FailedTransactionMetadata>`.

Financia uma conta com lamports. Retorna os metadados da transação em caso de
sucesso.
...
Definir diretamente o estado da conta.
...
Obter o saldo em lamports da conta. Retorna `None` se a conta não existir.
...
Calcular o mínimo de lamports necessários para isenção de rent.
