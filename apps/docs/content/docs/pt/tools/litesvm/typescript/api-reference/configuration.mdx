...
O LiteSVM utiliza um padrão de construção para configuração. Todos os métodos retornam `LiteSVM`
para encadeamento.
...
Definir o valor padrão de lamport para contas.
...
Configurar o conjunto de funcionalidades para testar versões específicas do Solana.
