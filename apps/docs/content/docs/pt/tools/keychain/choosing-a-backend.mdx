...
description:
  Escolha um backend de assinatura Keychain com base nos seus requisitos — custódia, infraestrutura existente, controles de aprovação e se você assina para seu próprio aplicativo ou provisiona carteiras para usuários finais.
related:
...
Se as assinaturas precisam passar por uma política de aprovação, limite de gastos ou fluxo de conformidade antes de serem produzidas — ou se você precisa de um custodiante regulado mantendo as chaves — use um backend de **MPC / custódia institucional**: Fireblocks, Dfns, Para, Utila ou Fordefi. Esses serviços dividem ou custodia a chave e co-assinam de acordo com sua política.
...
| Fordefi         | Custódia MPC / institucional  | Custódia institucional com controles de política | O modo nativo transmite automaticamente; no modo caixa-preta você envia |
