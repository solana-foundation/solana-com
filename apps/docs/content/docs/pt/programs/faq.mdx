...
- [Pontos de entrada de programas Rust](https://docs.rs/solana-program-entrypoint/latest/solana_program_entrypoint/macro.entrypoint.html)
...
- [Desserialização de parâmetros de programa Rust](https://docs.rs/solana-program-entrypoint/latest/solana_program_entrypoint/fn.deserialize.html)
