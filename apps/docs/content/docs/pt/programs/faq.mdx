...
- [Pontos de entrada de programas Rust](/docs/programs/rust#program-entrypoint)
...
- [Desserialização de parâmetros de programa Rust](/docs/programs/rust#parameter-deserialization)
