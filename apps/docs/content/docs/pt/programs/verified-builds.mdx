...
dados de verificação armazenados na PDA de verificação. A PDA contendo toda a
informação necessária para construir e verificar um programa é derivada do
...
potencialmente prevenindo explorações e garantindo relatórios de bugs oportunos.
