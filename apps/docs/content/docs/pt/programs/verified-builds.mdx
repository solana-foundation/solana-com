...
Usar [builds verificadas no Solana](/docs/programs/verified-builds) garante a integridade e a confiabilidade dos seus programas na rede e permite que os desenvolvedores encontrem seus SDKs diretamente no Solana Explorer. Ao aproveitar ferramentas como o Solana Verify CLI e o Docker, você pode manter builds verificáveis e seguras que estão alinhadas com o seu código-fonte. Tome sempre as precauções necessárias para usar ambientes consistentes e considere soluções de governança para atualizações e implantações seguras.
