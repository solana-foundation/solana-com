...
seoTitle: Integração de carteira Solana com Next.js e @solana/react-hooks
description:
  Configure a integração de carteira Solana no Next.js com @solana/client e
  @solana/react-hooks para enviar transferências de SOL.
---
...
![Aplicação Next.js Hooks](/assets/docs/frontend/01-hero-wallet.webp)

## Recursos

- [Repositório Framework Kit](https://github.com/solana-foundation/framework-kit)
...
Isto envolve toda a aplicação com o contexto Solana para que todos os
componentes filhos possam aceder ao estado da carteira e aos hooks.
...
![Menu suspenso da carteira conectada](/assets/docs/frontend/03-wallet-dropdown-connected.webp)
...
![Transferência de SOL bem-sucedida](/assets/docs/frontend/05-sol-transfer-success.webp)

Os conectores são o mesmo conjunto do Wallet Standard
(Phantom/Solflare/Backpack/descoberta automática); uma vez conectados, as
transferências de SOL usam o signatário conectado.
...
Abra http://localhost:3000, conecte uma carteira Devnet e envie uma
