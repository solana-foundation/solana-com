...
define um estado padrão para todas as novas contas de token criadas para um
mint. Quando ativada, esta extensão inicializa automaticamente cada nova conta
de token com um estado especificado, como congelado. Isto permite que os
