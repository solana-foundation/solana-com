...
atribui um delegado com autoridade sobre todas as contas de token para um mint.
Ao contrário dos delegados regulares que os proprietários de contas de token
podem revogar, um delegado permanente não pode ser alterado ou removido pelos
proprietários de contas de token. O delegado permanente pode transferir ou
queimar tokens em qualquer conta de token desse mint. A função de delegado
permanente pode ser alterada para uma nova conta pelo delegado permanente atual.
