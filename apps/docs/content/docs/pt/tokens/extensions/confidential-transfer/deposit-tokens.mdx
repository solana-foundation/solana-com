...
Antes que os tokens possam ser transferidos de forma confidencial, o saldo
público de tokens deve ser convertido em um saldo confidencial. Essa conversão
...
Esta seção explica a primeira etapa: depositar o saldo público de tokens no
saldo pendente confidencial.

O diagrama a seguir mostra as etapas envolvidas no depósito de tokens do saldo
público para o saldo pendente confidencial:
...
Para converter um saldo público em um saldo pendente confidencial, invoque a
instrução
...
O
[valor máximo](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/mod.rs#L21)
por instrução de depósito é limitado a 2^48.
...
O exemplo a seguir demonstra como depositar o saldo público de tokens no saldo
pendente confidencial.

Confidential Balances depende do programa ZK ElGamal Proof, que está habilitado
...
e substitua os endereços de mint e conta de espaço reservado pelos seus próprios.
