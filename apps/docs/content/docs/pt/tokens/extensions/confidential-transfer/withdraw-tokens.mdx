...
1. Crie
   ...
   **Prova de igualdade
   ...
   garantindo que o novo saldo disponível da conta seja calculado corretamente
   como `remaining_balance = current_balance - withdraw_amount`.
...
4. Feche as contas de prova para recuperar o SOL usado para criá-las.

O diagrama seguinte mostra os passos envolvidos na retirada de tokens do saldo
...
- Gerar uma prova de igualdade e uma prova de intervalo no lado do cliente
