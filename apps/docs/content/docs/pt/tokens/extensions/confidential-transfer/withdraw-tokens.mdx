...
O exemplo a seguir retira tokens do saldo confidencial disponível de volta ao
saldo público. A conta já deve estar configurada para transferências
confidenciais e ter um saldo confidencial disponível.
...
[Surfpool](https://surfpool.run), sim. Execute o exemplo em um desses (o código
usa a devnet) com um pagador com fundos, e substitua os marcadores pelo seu mint
e token account.
