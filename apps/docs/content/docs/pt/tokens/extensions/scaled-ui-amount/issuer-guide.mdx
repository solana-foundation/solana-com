...
Para atualizar o multiplicador da quantia na interface do usuário, você precisa
usar o comando `update-ui-amount-multiplier`. Um timestamp, em segundos desde a
época Unix, é opcional e pode ser usado para definir um horário de início
personalizado para o novo multiplicador. Se nenhum timestamp for fornecido, o
timestamp atual será usado.
...
Para obter o saldo, você precisa usar o comando `balance`.
