...
impede alterações de propriedade para token accounts. Quando uma token account é
inicializada com esta extensão, o proprietário designado é permanente e não pode
