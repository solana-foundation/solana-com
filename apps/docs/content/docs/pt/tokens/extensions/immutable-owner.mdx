...
description: Aprenda como ativar a extensão ImmutableOwner.
---

## Como ativar a extensão ImmutableOwner
...
extensão impede alterações de propriedade para token accounts. Quando uma token
