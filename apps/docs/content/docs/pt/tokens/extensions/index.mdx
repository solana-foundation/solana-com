...
O Token Extensions Program define uma enumeração
...
A enumeração _rs`ExtensionType`_ é definida da seguinte forma:
...
específicos habilitados para aquela conta.
