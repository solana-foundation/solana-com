...
description: Aprenda como ativar a PausableMintExtension.
---

## Como ativar a PausableExtension
...
permite que uma autoridade de pausa designada interrompa toda a atividade de
tokens numa cunhagem. A autoridade de pausa pode pausar ou retomar a cunhagem a
qualquer momento.

Quando pausado, o programa Token-2022 rejeita todas as transferências, cunhagens
e queimas para esse token. Quando retomado, as operações normais são
reiniciadas.

Este é um padrão comum tanto em sistemas de tokens blockchain como em finanças
tradicionais, onde a capacidade de congelar atividade é necessária para
conformidade, resposta a incidentes ou controlo administrativo.
