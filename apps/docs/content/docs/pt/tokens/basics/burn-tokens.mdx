...
destrói permanentemente tokens ao reduzir o saldo numa token account. Os tokens
queimados são removidos de circulação e diminuem o `supply` registado na mint
account. Apenas o proprietário da token account pode queimar tokens da sua
conta.
