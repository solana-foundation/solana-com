...
para transferir SOL como um token SPL.
...
sincroniza o saldo de uma conta de token SOL empacotado (WSOL) com o SOL real
(lamports) armazenado nela. Quando você transfere SOL nativo para uma conta de
