...
title: Sync Native
description:
  Atualiza o valor de uma conta de token SOL encapsulado após transferir SOL
  para a conta.
...
SOL Encapsulado (WSOL) é SOL mantido em uma token account do Token Program para
o mint nativo. O mint nativo é o endereço de mint que o Token Program usa para
contas de token que encapsulam SOL. O mint nativo permite que SOL seja usado
...
token através do campo _rs`amount`_ da conta de token. Se você transferir SOL
...
_rs`amount`_ da conta de token para corresponder aos lamports mantidos na conta
...
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_             | O estado da conta de token usa _rs`is_native`_ para marcar a conta como WSOL e armazena a reserva nativa, o saldo mínimo em lamports isento de aluguel que a conta deve manter, e o valor do token rastreado. | [Origem](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Origem](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`SyncNative`_          | Uma instrução que atualiza o campo _rs`amount`_ de uma token account de SOL encapsulado para corresponder aos lamports mantidos na conta acima de sua reserva isenta de aluguel.                              | [Origem](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L366-L376) | [Origem](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L434-L444) |
| _rs`process_sync_native`_ | Lógica compartilhada do processador para sincronização de saldos de SOL encapsulado.                                                                                                                          | [Origem](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L757-L779)     | [Origem](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1344-L1371)   |
