...
## Compreender as autoridades de tokens
...
- **Autoridade de mint**: Controla a criação de novos tokens. Pode criar tokens
  ...
  fornecimento inicial para criar um token de fornecimento fixo.
- **Autoridade de congelamento**: Controla a capacidade de congelar e
  ...
  tokens. Frequentemente revogada para garantir aos utilizadores que os seus
  tokens não podem ser congelados.

### Autoridades de token account

- **Proprietário da conta**: Tem controlo total sobre a token account. Pode
  transferir tokens, queimar tokens, aprovar delegados e fechar a conta quando o
  saldo é zero.
- **Autoridade de fecho**: Pode fechar a token account quando o seu saldo é
  zero. Por predefinição, este é o proprietário da conta, mas pode ser delegado
  a outra conta.
...
altera ou revoga autoridades em mint accounts e token accounts. Apenas a
autoridade atual pode transferir as suas permissões para um novo endereço ou
revogá-las permanentemente ao definir a autoridade como nula. Uma vez revogada,
a autoridade não pode ser restaurada.
...
<Callout type="info">
  ...
  partilham implementações semelhantes para alcançar a mesma funcionalidade.
</Callout>
