...
description:
  Alterar ou revogar funções de autoridade em uma conta de mint ou token
  account, incluindo autoridade de mint, congelamento, proprietário e
  fechamento.
...
## O Que Faz a Definição de Autoridade?

A definição de autoridade altera ou revoga funções de autoridade específicas em
uma conta de mint ou token account.
...
armazenar uma autoridade de fechamento. Cada função controla um conjunto de
permissões específico, e definir uma autoridade como _rs`None`_ remove
permanentemente a função de autoridade selecionada.

O Token Extensions Program também define tipos de autoridade adicionais para
...
account. A autoridade atual assina a alteração, e a nova autoridade pode ser
outro endereço ou _rs`None`_ para revogar permanentemente a autoridade
selecionada.
...
| --------------------------- | ---------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                  | O estado de mint armazena _rs`mint_authority`_ e _rs`freeze_authority`_.                 | [Código-Fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Código-Fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)           |
| _rs`Account`_               | O estado de token account armazena _rs`owner`_ e _rs`close_authority`_.                  | [Código-Fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Código-Fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)          |
| _rs`AuthorityType`_         | As funções de autoridade que _rs`SetAuthority`_ pode atualizar.                          | [Código-Fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L739-L751) | [Código-Fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L1116-L1157) |
| _rs`SetAuthority`_          | Uma instrução que altera ou revoga uma autoridade em uma conta de mint ou token account. | [Código-Fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L141-L158) | [Código-Fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L183-L200)   |
| _rs`process_set_authority`_ | Lógica compartilhada do processador para atualizações de autoridade.                     | [Código-Fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L423-L518)     | [Código-Fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L677-L978)       |
