...
Após a revogação, o delegado não pode mais transferir quaisquer tokens da sua
conta. Para o Token Program, apenas o proprietário da token account pode revogar
um delegado. Para o Token Extension Program, o proprietário da token account e o
delegado atual podem revogar a delegação.
