...
description:
  Feche uma conta de token e retorne os lamports da conta para uma conta de
  destino.
...
## O Que Faz o Fechamento de uma Conta de Token?
...
zero. Contas de token SOL encapsulado são a exceção e podem ser fechadas com um
saldo de tokens para recuperar o SOL subjacente. O proprietário da conta ou a
autoridade de fechamento da conta assina a instrução de fechamento.

## Como Fechar uma Conta de Token

Fechar uma conta de token utiliza a instrução _rs`CloseAccount`_ do Token
Program.
