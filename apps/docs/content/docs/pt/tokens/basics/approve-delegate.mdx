...
description:
  Autorizar outro endereço a transferir ou queimar uma quantidade limitada de
...
Aprovar um novo delegado substitui o delegado anterior e o limite de utilização
na conta.
...
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_         | O estado da token account armazena o proprietário, o delegado e a quantidade delegada.                                                                                     | [Código-Fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Código-Fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Approve`_         | Uma instrução de aprovação de delegado que registra o delegado e o limite de utilização para uma token account sem exigir que o chamador forneça o mint ou decimais.       | [Código-Fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L109-L127) | [Código-Fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L150-L168) |
| _rs`ApproveChecked`_  | Uma instrução de aprovação de delegado que exige que o chamador forneça o mint e decimais e verifica esses valores antes de registrar o delegado e o limite de utilização. | [Código-Fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L274-L300) | [Código-Fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L340-L366) |
| _rs`process_approve`_ | Lógica compartilhada do processador para aprovação de delegado.                                                                                                            | [Código-Fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L344-L392)     | [Código-Fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L582-L640)     |

### Typescript

Os exemplos de `Kit` abaixo mostram a abordagem recomendada usando
`@solana/kit`. Exemplos legados usando `@solana/web3.js` estão incluídos para
referência.
