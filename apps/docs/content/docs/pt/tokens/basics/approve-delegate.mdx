...
Aprovar um novo delegado substitui o delegado anterior e a quantidade permitida
na conta.

## Como Aprovar um Delegado

Aprovar um delegado usa a instrução _rs`Approve`_ ou _rs`ApproveChecked`_ do
Token Program.

Os exemplos abaixo usam _rs`ApproveChecked`_, que exige que o chamador forneça o
mint e os decimais para que a instrução possa verificar o mint esperado e a
precisão do token antes de processar a aprovação.
...
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_         | O estado da token account armazena o proprietário, o delegado e a quantidade delegada.                                                                                        | [Código](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Código](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Approve`_         | Uma instrução de aprovação de delegado que registra o delegado e a quantidade permitida para uma token account sem exigir que o chamador forneça o mint ou os decimais.       | [Código](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L109-L127) | [Código](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L150-L168) |
| _rs`ApproveChecked`_  | Uma instrução de aprovação de delegado que exige que o chamador forneça o mint e os decimais e verifica esses valores antes de registrar o delegado e a quantidade permitida. | [Código](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L274-L300) | [Código](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L340-L366) |
| _rs`process_approve`_ | Lógica compartilhada do processador para aprovação de delegado.                                                                                                               | [Código](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L344-L392)     | [Código](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L582-L640)     |
