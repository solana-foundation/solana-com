...
até o valor aprovado, mas não pode excedê-lo. Apenas o proprietário da conta de
tokens pode aprovar um delegado, e cada conta de tokens pode ter apenas um
