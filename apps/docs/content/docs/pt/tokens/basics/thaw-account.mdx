...
description:
  ...
  mudanças de delegação possam ser retomadas.
...
Descongelar altera uma conta de token do estado congelado de volta ao estado
inicializado.

Após um descongelamento bem-sucedido, a conta pode transferir, queimar e fechar
tokens novamente. Somente a autoridade de congelamento da mint pode descongelar
contas de token.

## Como Descongelar uma Conta de Token

Descongelar uma conta de token usa a instrução _rs`ThawAccount`_ do Token
Program.

A instrução _rs`ThawAccount`_ verifica que a conta de token pertence à mint e
que o signatário é a autoridade de congelamento da mint, então altera o estado
da conta de token de congelado de volta para inicializado.
...
| ----------------------------------- | ------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                          | O estado da mint armazena a autoridade de congelamento opcional usada para descongelar contas de token. | [Código-fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Código-fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`AccountState`_                  | Os estados da conta de token, incluindo _rs`Frozen`_ e _rs`Initialized`_.                               | [Código-fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L185-L195)       | [Código-fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L203-L213)       |
| _rs`ThawAccount`_                   | Uma instrução que altera uma conta de token congelada de volta ao estado inicializado.                  | [Código-fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L229-L243) | [Código-fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L292-L306) |
| _rs`process_toggle_freeze_account`_ | Lógica de processamento compartilhada para congelar e descongelar contas de token.                      | [Código-fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L713-L754)     | [Código-fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1293-L1341)   |
