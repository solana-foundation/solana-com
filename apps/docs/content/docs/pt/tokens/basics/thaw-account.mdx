...
reverte um congelamento, restaurando a funcionalidade completa de uma conta de
token previamente congelada. Após o descongelamento, a conta pode novamente
