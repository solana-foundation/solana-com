...
description:
  Descongele uma conta de token congelada para que transferências, queimas e
  alterações de delegação possam ser retomadas.
...
## O Que Faz o Descongelamento de uma Conta de Token?

O descongelamento altera uma token account do estado congelado de volta para o
estado inicializado.

Após um descongelamento bem-sucedido, a conta pode receber, transferir e queimar
tokens novamente. Apenas a autoridade de congelamento da cunhagem pode
descongelar contas de tokens.

## Como Descongelar uma Conta de Token

Descongelar uma token account utiliza a instrução _rs`ThawAccount`_ do Token
Program.

A instrução _rs`ThawAccount`_ verifica se a token account pertence ao mint e se
o signatário é a autoridade de congelamento do mint, em seguida, altera o estado
da token account de congelado de volta para inicializado.

[Contas de token nativas](/docs/tokens/basics/sync-native) não suportam
descongelamento.
...
| ----------------------------------- | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_                          | O estado do mint armazena a autoridade de congelamento opcional usada para descongelar token accounts. | [Fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`AccountState`_                  | Os estados da token account, incluindo _rs`Frozen`_ e _rs`Initialized`_.                               | [Fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L185-L195)       | [Fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L203-L213)       |
| _rs`ThawAccount`_                   | Uma instrução que altera uma token account congelada de volta para o estado inicializado.              | [Fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L229-L243) | [Fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L292-L306) |
| _rs`process_toggle_freeze_account`_ | Lógica compartilhada do processador para congelamento e descongelamento de token accounts.             | [Fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L713-L754)     | [Fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1293-L1341)   |
