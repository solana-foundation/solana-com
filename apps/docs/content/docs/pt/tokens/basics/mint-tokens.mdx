...
title: Cunhar tokens
description:
  Cunhe novas unidades de token para uma token account com a autoridade de
  cunhagem.
...
A cunhagem de tokens usa a instrução _rs`MintTo`_ ou _rs`MintToChecked`_ do
Token Program.

Os exemplos abaixo usam _rs`MintToChecked`_, que exige que o chamador forneça os
decimais da cunhagem para que a instrução possa verificar a precisão esperada do
token antes de cunhar.
...
| _rs`MintToChecked`_   | Uma instrução de cunhagem que exige que o chamador forneça os decimais da cunhagem e verifica esse valor antes de cunhar tokens para uma token account existente. | [Fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L301-L325) | [Fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L367-L391) |
| _rs`process_mint_to`_ | Lógica compartilhada do processador para cunhagem de tokens.                                                                                                      | [Fonte](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L521-L583)     | [Fonte](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L981-L1067)    |
