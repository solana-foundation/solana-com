---
title: Criar um Mint de Token
description:
  Crie um mint de token e configure os decimais do mint, a autoridade de mint e
  a autoridade de congelamento.
...
## O Que É uma Conta de Mint

Uma mint account define e identifica exclusivamente um token na Solana, e
armazena o estado compartilhado que se aplica a todas as token accounts para
esse mint.
...
do token em carteiras, aplicações e exploradores.
...
autoridade de mint, a autoridade de congelamento, os decimais e o sinalizador
...
Uma mint account armazena apenas informações básicas do token (oferta, casas
decimais, autoridades). Para adicionar metadados legíveis como nome, símbolo e
imagem ao seu token, você tem duas opções:

<Cards>
  <Card title="Metaplex Token Metadata" href="/docs/tokens/metaplex">
   Adicione metadados usando o Metaplex Token Metadata Program. Funciona tanto com o Token Program original quanto com o Token-2022.
  </Card>

  <Card title="Extensão de Metadados do Token" href="/docs/tokens/extensions/metadata">
   Use a extensão de metadados integrada com o Token-2022. 
   A extensão de metadados está disponível apenas para contas mint criadas com o Token-2022.
   Para adicionar metadados a contas mint criadas com o Token Program original, use o Metaplex Token Metadata Program.
  </Card>
</Cards>
