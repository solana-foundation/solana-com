...
unicamente o USDC em todo o ecossistema Solana. Pode visualizar este mint no
...
Criar um mint account requer a instrução
...
## Próximos Passos: Adicionando Metadados
