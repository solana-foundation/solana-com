...
description:
  ...
  bloquear transferências, queimas e alterações de delegado.
...
Apenas um mint que ainda possui uma autoridade de congelamento pode congelar
...
Congelar uma token account utiliza a instrução _rs`FreezeAccount`_ do Token
Program.
