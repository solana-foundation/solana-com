...
impede todas as transferências ou queimas de tokens de uma conta de tokens
específica. Uma vez congelada, a conta não pode enviar tokens ou receber tokens
até ser descongelada. Uma conta congelada ainda pode ser encerrada se tiver
saldo zero de tokens. Apenas a autoridade de congelamento da mint account do
token pode congelar contas. Se a autoridade de congelamento for revogada
