...
<Callout type="caution">
  ...
  Se precisar reduzir o limite, aprove o mesmo delegado com um valor menor.
</Callout>
...
Cada transferência reduz o limite restante. Quando o limite chega a zero, o
delegado não pode mais transferir tokens.
...
limita a exposição ao risco ao montante aprovado.

## Recursos relacionados

| Recurso                                                  | Descrição                                                                 |
| -------------------------------------------------------- | ------------------------------------------------------------------------- |
| [Aprovar delegado](/docs/tokens/basics/approve-delegate) | Como conceder a outra conta permissão para gastar da sua token account.   |
| [Revogar delegado](/docs/tokens/basics/revoke-delegate)  | Como remover um delegado existente e revogar as suas permissões de gasto. |
| [Transferir token](/docs/tokens/basics/transfer-tokens)  | Como transferir tokens entre token accounts.                              |
