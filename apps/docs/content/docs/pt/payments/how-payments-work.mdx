...
As contas de token são geridas por um **Programa de Token**—o código onchain que
...
O Token-2022 (também chamado de "Token Extensions") adiciona funcionalidades como transfer hooks,
tarifas de transferência e Saldos Confidenciais. Ambos os programas funcionam de forma semelhante para transferências básicas,
...
<Callout type="info">
  A Solana usa mercados de taxas locais — as transações competem com outras transações
  que escrevem no mesmo estado. Isso significa que as taxas de pagamento permanecem baixas e previsíveis
  mesmo durante períodos de alta atividade da rede em outros lugares.
</Callout>
...
<Cards>
  ...
  <Card title="Enviar o seu primeiro pagamento" href="/docs/payments/send-payments">
