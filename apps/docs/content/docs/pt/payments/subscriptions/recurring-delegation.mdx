...
- O programa rejeita transferências que excedam o limite restante do período
  atual.
- Assim que o próximo período começar, o valor retirado é reiniciado.
- O usuário assina as transações de configuração e revogação. O delegatário
  assina as transferências.
