...
aumenta o limite de tamanho para 4096 bytes, o que comporta aproximadamente três vezes mais
transferências por transação. O agrupamento em lote ainda é necessário além disso, pois o
runtime carrega no máximo 64 contas por transação independentemente do formato.
