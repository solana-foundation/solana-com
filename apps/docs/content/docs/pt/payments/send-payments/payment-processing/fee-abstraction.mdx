...
[Kora](/docs/tools/kora) lida com esta complexidade. É um servidor JSON-RPC que
fornece abstração de taxas para que os utilizadores nunca precisem de SOL. Você
pode patrocinar totalmente as taxas ou aceitar pagamento de taxas em qualquer
token.
