...
description:
  Aprenda como funciona o patrocínio de taxas e implemente a abstração de taxas com Kora.
---
...
<Cards>
  ...
  <Card title="Demonstração Completa de Transação" href="/docs/tools/kora/guides/full-demo">
