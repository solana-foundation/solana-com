...
[Kora](/docs/products/kora) lida com esta complexidade. É um servidor JSON-RPC
que fornece abstração de taxas para que os utilizadores nunca precisem de SOL.
Você pode patrocinar totalmente as taxas ou aceitar pagamento de taxas em
qualquer token.
...
<Cards>
  ...
  <Card title="Referência da API" href="/docs/products/kora/json-rpc-api">
    Métodos JSON-RPC e documentação do SDK.
  </Card>
  <Card title="Guia do operador de nó" href="/docs/products/kora/operators">
