...
Na Solana, um smart contract é chamado de programa. Um programa é uma
...
[implementou o programa](/docs/programs/deploying).) Se a autoridade de
...
| Loader | ID do Programa                                | Notas                                                                                                                       | Link das Instruções                                                                                                                           |
| ------ | --------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| native | `NativeLoader1111111111111111111111111111111` | Possui os outros quatro loaders                                                                                             | —                                                                                                                                             |
...
Além dos programas de carregamento, a Solana fornece os seguintes programas
pré-compilados.
