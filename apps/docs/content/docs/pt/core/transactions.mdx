...
[taxa base](/docs/core/fees#base-fee) da transação e é a assinatura da
transação. A assinatura da transação pode ser usada para consultar os detalhes
da transação na rede.
