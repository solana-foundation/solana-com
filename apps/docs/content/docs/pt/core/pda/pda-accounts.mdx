...
title: Contas PDA
description:
  Crie contas onchain em endereços Solana PDA usando invoke_signed e a restrição
  init do Anchor. Fluxo de verificação invoke_signed e padrões de criação de PDA
  no Anchor com exemplos de código.
