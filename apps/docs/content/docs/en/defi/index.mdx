...
Solana's single global state,
[fast slot times](https://solana.com/upgrades/reduced-slot-times), and sub-cent
fees make it the home of onchain finance and DeFi: every program - DEXs, lending
markets, oracles, perps - is composable within a single atomic transaction. This
section is the workflow layer for building financial applications; it links down
to [Core Concepts](/docs/core/transactions) and the
