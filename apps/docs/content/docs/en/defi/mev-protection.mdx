...
expire after their recent blockhash exceeds
[`MAX_PROCESSING_AGE`](/docs/core/constants-reference#transactions). This
significantly narrows the window for searchers to observe and act on pending
transactions.
