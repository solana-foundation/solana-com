...
<Callout type="info" title="Summary">
  The Instructions sysvar (`Sysvar1nstructions1111111111111111111111111`) lets
  a program read all top-level instructions in the current transaction by index
  or relative offset. CPI inner instructions are not accessible.
</Callout>
