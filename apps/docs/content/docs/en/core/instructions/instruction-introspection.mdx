...
description:
  How programs inspect other instructions in the current transaction via the
  Instructions sysvar.
...
<Callout type="info" title="Summary">
  The Instructions sysvar lets a program inspect the other instructions in the
  same transaction.
</Callout>
