...
description:
  The 12-step CPI execution flow through the Solana runtime, privilege extension
...
[Account data synchronization](/docs/core/cpi/cpi-cost-model#account-data-synchronization) for the detailed
field mapping.
