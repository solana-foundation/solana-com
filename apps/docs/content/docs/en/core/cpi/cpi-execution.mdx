...
[charge the fixed invocation cost](https://github.com/anza-xyz/agave/blob/v4.2.1/program-runtime/src/cpi.rs#L785-L786)
from the shared compute meter:
[`invoke_units`](https://github.com/anza-xyz/agave/blob/v4.2.1/program-runtime/src/execution_budget.rs#L204)
= 946 CUs.
...
1. [Validates the account info count](https://github.com/anza-xyz/agave/blob/v4.2.1/program-runtime/src/cpi.rs#L146-L157)
   against _rs`MAX_CPI_ACCOUNT_INFOS`_ (255).
2. [Charges account info translation cost](https://github.com/anza-xyz/agave/blob/v4.2.1/program-runtime/src/cpi.rs#L933-L938):
   `(num_account_infos * 80) / 250` CUs.
