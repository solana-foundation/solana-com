...
title: CPI Invoke
description:
  How to use invoke and invoke_signed for Cross-Program Invocations on Solana,
  with Anchor CpiContext and Native Rust examples.
---

{/* TOC: CPIs without PDA signers, CPIs with PDA signers, invoke vs invoke_signed */}
...
- **Example 2**: Constructs the CPI instruction manually. This approach is
...
see [PDA Signing](/docs/core/cpi/cpi-advanced#pda-signing).
