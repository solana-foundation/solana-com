...
| Limit                            | Value                 | Source                                                                                                                                                                                                                                                          |
| -------------------------------- | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Max instruction stack depth      | 5 (9 with SIMD-0268)  | [`MAX_INSTRUCTION_STACK_DEPTH`](https://github.com/anza-xyz/agave/blob/v4.2.1/program-runtime/src/execution_budget.rs#L8), [`MAX_INSTRUCTION_STACK_DEPTH_SIMD_0268`](https://github.com/anza-xyz/agave/blob/v4.2.1/program-runtime/src/execution_budget.rs#L10) |
| CPI invocation cost              | 946 CUs               | [`DEFAULT_INVOCATION_COST`](https://github.com/anza-xyz/agave/blob/v4.2.1/program-runtime/src/execution_budget.rs#L21)                                                                                                                                          |
| Max PDA signers per CPI          | 16                    | [`MAX_SIGNERS`](https://github.com/anza-xyz/agave/blob/v4.2.1/program-runtime/src/cpi.rs#L62)                                                                                                                                                                   |
| Max CPI instruction data         | 10 KiB (10,240 bytes) | [`MAX_INSTRUCTION_DATA_LEN`](https://github.com/anza-xyz/agave/blob/v4.2.1/transaction-context/src/lib.rs#L18)                                                                                                                                                  |
| Max return data                  | 1,024 bytes           | [`MAX_RETURN_DATA`](https://github.com/anza-xyz/solana-sdk/blob/clock%40v2.2.3/cpi/src/lib.rs#L329)                                                                                                                                                             |
| Max CPI account infos            | 255                   | [`MAX_CPI_ACCOUNT_INFOS`](https://github.com/anza-xyz/agave/blob/v4.2.1/program-runtime/src/cpi.rs#L106)                                                                                                                                                        |
| CPI serialization cost           | 1 CU per 250 bytes    | [`cpi_bytes_per_unit`](https://github.com/anza-xyz/agave/blob/v4.2.1/program-runtime/src/execution_budget.rs#L208)                                                                                                                                              |
