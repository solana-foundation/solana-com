...
on mainnet `lamports_per_byte_year` = 3,480 and `exemption_threshold` = 2.0, so the effective rate is 3,480 * 2 = 6,960 lamports/byte; `ACCOUNT_STORAGE_OVERHEAD` = 128 bytes.)
