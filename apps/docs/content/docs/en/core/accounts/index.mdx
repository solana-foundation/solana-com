...
title: Accounts
description:
  Learn about Solana accounts, the fundamental data unit that stores state on
  the network. Covers account structure, addresses, program and data accounts,
  rent, ownership, and account modification rules.
...
See [Transactions](/docs/core/transactions) for per-transaction account limits.
See [Fees](/docs/core/fees) for loaded accounts data size limits.
