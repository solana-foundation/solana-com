...
Programs deployed using loader-v3 (see [Loader programs](/docs/core/programs/builtin-programs#loader-programs))
...
1. Invoke the [System Program](/docs/core/programs/builtin-programs#the-system-program) to
