...
| `MAX_PROCESSING_AGE`           | 150         | Validator blockhash recency limit; permits the 151 most recently registered blockhashes                                                                                                                                                                                                                        | [`MAX_PROCESSING_AGE`](https://github.com/anza-xyz/solana-sdk/blob/clock%40v3.2.0/clock/src/lib.rs#L98-L101)             |
...
Validators accept the 151 most recently registered blockhashes. This is usually
roughly one minute, but applications should use the `lastValidBlockHeight`
