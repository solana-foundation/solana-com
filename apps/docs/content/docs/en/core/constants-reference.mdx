...
| `MAX_PROCESSING_AGE`           | 150         | Maximum accepted recent-blockhash age; ages 0 through 150 are accepted                                                                                                                                                                                                                                         | [`MAX_PROCESSING_AGE`](https://github.com/anza-xyz/solana-sdk/blob/clock%40v3.2.0/clock/src/lib.rs#L98-L101)             |
| `MAX_RECENT_BLOCKHASHES`       | 300 entries | BlockhashQueue size                                                                                                                                                                                                                                                                                            | [`MAX_RECENT_BLOCKHASHES`](https://github.com/anza-xyz/solana-sdk/blob/clock%40v3.2.0/clock/src/lib.rs#L92-L96)          |
...
Validators accept a recent blockhash through age 150 inclusive, representing 151
accepted age values and usually about 60 seconds. Because skipped slots and
changing slot duration make time conversions unreliable, applications should use
the `lastValidBlockHeight` returned by
[`getLatestBlockhash`](/docs/rpc/http/getlatestblockhash) to determine when a
specific blockhash expires.
