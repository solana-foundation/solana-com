...
| **BPF Loader Upgradeable** | `BPFLoaderUpgradeab1e11111111111111111111111` | Yes, if upgrade authority is set    | Loader-v3 programs                                    |
| **Loader v4**              | `CoreBPFLoaderV41111111111111111111111111111` | Yes, until the program is finalized | Loader-v4 programs                                    |
