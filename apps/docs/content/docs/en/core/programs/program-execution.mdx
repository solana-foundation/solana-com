...
2. **Checks precompiles.** If the program is a
   [precompile](/docs/core/programs/precompiles),
...
See [Syscall Reference](/docs/core/programs/syscall-reference) for the complete
list of syscalls and their compute costs.
