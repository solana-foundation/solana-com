...
[Rust](https://rust-book.cs.brown.edu/title-page.html) using one of three
approaches:
...
<Cards>
  ...
  <Card title="Pinocchio" href="/docs/clients/official/rust#program-crates">
    A lightweight, zero-copy Rust library optimized for compute consumption and
    binary size. Includes program-specific crates for common CPIs.
  </Card>
...
See [Cross-Program Invocations](/docs/core/cpi) for CPI concepts and examples
that apply across these approaches.
