...
are stateless: they store no mutable data in their own account. All mutable
state lives in separate data accounts passed via
...
<Cards>
  ...
  >
    ...
    reference. Program types taxonomy.
  </Card>
  <Card title="Built-in Programs" href="/docs/core/programs/builtin-programs">
    System Program, Loaders, Core programs (Vote, Stake, Config, Compute Budget,
    ALT).
  </Card>
...
- **System Program**: The System Program address is
...
See [Fees](/docs/core/fees) for compute unit limits and loaded data size
constraints.
