...
<Callout type="info" title="Summary">
  ...
  (CU_price * CU_limit / 1M lamports, 100% to validator). Charged whether
  the transaction succeeds or fails.
</Callout>
...
- `lamports_per_signature`: currently
  [5,000 lamports](https://github.com/anza-xyz/solana-sdk/blob/clock%40v2.2.3/fee-structure/src/lib.rs#L102).
...
- **Base fee (transaction_fee)**: 50% is
  ...
  [`DEFAULT_BURN_PERCENT = 50`](https://github.com/anza-xyz/solana-sdk/blob/clock%40v2.2.3/fee-calculator/src/lib.rs#L72).
