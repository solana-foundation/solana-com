...
<Cards>
  ...
  <Card title="Production Readiness" href="/docs/payments/production-readiness">
...
- **Size limit**: 1,232 bytes maximum, derived from the IPv6 minimum MTU (1,280
  bytes) minus 48 bytes for network headers. The upcoming
  [v1 format](/docs/core/transactions/versioned-transactions#v1-message-format)
  raises this to 4,096 bytes.
