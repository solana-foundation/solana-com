...
[Signature verification (sigverify)](/docs/core/transactions/transaction-pipeline#2-signature-verification-sigverify).
...
unless it is a valid [durable nonce transaction](/docs/core/transactions/durable-nonces).
