...
| [`AccountLoadedTwice`](https://github.com/anza-xyz/solana-sdk/blob/clock%40v2.2.3/transaction-error/src/lib.rs#L22)                     | Sanitize               | A pubkey appears twice in the transaction's `account_keys`                                                     |
