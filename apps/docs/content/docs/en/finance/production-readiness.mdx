...
url: /docs/finance/production-readiness
type: conceptual
related:
...
- **Separation**: Which provider serves reads, and which serves transaction
  sends
- **History**: Whether the endpoint retains enough history for the
  reconciliation window your books require
...
that aren't bundled into client code.
...
- [Payments production readiness](/docs/payments/production-readiness) -
