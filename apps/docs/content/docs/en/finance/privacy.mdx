...
- **Custom Rings:** Solana programs with configurable policy, compliance
  controls, and auditor visibility. Privacy can be configured to be confidential
  (encrypted asset and amount), or anonymous (encrypted asset, amount, sender,
  recipient).
