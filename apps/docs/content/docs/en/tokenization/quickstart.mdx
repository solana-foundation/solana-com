...
- [Token extensions](/docs/tokens/extensions) - choose only the controls your
  asset needs
- [Token ACL](/docs/tokenization/compliance/token-acl) - enforce allowlists and
  blocklists
- [Delivery versus payment](/docs/tokenization/settlement/dvp) - settle an asset
  and its payment atomically
