...
The Solana Foundation maintains a public RPC endpoint for each Cluster. These
shared endpoints are subject to rate limits, but are available for users and
developers to interact with the Solana blockchain.
...
- `https://api.devnet.solana.com` - shared public API endpoint maintained by the
  Solana Foundation; rate-limited
...
- `https://api.testnet.solana.com` - shared public API endpoint maintained by
  the Solana Foundation; rate-limited
...
- `https://api.mainnet.solana.com` - shared public API endpoint maintained by
  the Solana Foundation; rate-limited
