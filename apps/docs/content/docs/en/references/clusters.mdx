...
Solana provides a shared public RPC endpoint for each Cluster. These endpoints
are subject to rate limits, but are available for users and developers to
...
- `https://api.devnet.solana.com` - shared public API endpoint; rate-limited
...
- `https://api.testnet.solana.com` - shared public API endpoint; rate-limited
...
- `https://api.mainnet.solana.com` - shared public API endpoint; rate-limited
