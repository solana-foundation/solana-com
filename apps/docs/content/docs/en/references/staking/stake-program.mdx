...
community have developed several onchain and offchain programs to make stakes
easier to manage.
...
This onchain program pools together SOL to be staked by a manager, allowing SOL
...
[Stake Pool documentation](https://www.solana-program.com/docs/stake-pool).
