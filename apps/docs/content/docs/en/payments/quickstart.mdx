...
amount; see [payment modes](/docs/tools/commerce-kit/quickstart/payment-button)
for fixed-price and cart checkouts.
...
- [Send payments](/docs/payments/send-payments) - payouts and transfers from
  your own backend
- [Production readiness](/docs/tools/production-readiness) - before real money
  moves
