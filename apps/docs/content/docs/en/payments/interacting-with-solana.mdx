...
> A recent blockhash is accepted at ages 0 through 150 inclusive, usually for
> about 60 seconds. Fetch a fresh one immediately before signing and sending,
> and use its `lastValidBlockHeight` to detect expiration.
