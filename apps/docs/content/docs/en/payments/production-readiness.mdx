...
| Devnet | Mainnet |
|--------|---------|
| Free SOL from faucets | SOL costs money |
...
| `INSUFFICIENT_FUNDS_FOR_FEE` | Not enough SOL | Fund fee payer or use [gasless](/docs/payments/send-payments/payment-processing/send-gasless) |
...
Users expect to pay in stablecoins, not acquire SOL for network fees. Gasless transactions solve this—similar to how Venmo users don't think about ACH fees. See [Gasless Payments](/docs/payments/send-payments/payment-processing/send-gasless) for complete implementation.
