...
description:
  Learn how fee sponsorship works and implement gasless payments with Kora.
---
...
token balance. Gasless payments remove this friction by having someone else pay
the fees.
