...
Program-controlled wallets, commonly referred to as smart wallets or smart
accounts, have off-curve addresses. This guide uses the term "smart wallet"
throughout.
...
the user to verify they intend to send funds to a smart wallet.
