...
Fee sponsorship allows a third party (the sponsor) to pay transaction fees on
behalf of the sender. This is useful for onboarding users who don't have SOL or
for services that cover fees for their customers.
