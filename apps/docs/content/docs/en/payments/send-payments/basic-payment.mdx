...
The `splToken` helper from [`@solana/client`](https://solana.com/docs/frontend/client) handles ATA derivation, decimal
conversion, and transaction building automatically. This is ideal for single
payment transfers.
