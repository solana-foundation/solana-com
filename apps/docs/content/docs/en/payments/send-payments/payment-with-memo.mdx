...
Adding a memo to a payment attaches a message to the program logs of the
transaction.
...
Create a memo instruction with message. This message will be visible in the
...
```ts title="Example Transaction Logs"
[
