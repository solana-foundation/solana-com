...
New to how balances and ownership work on Solana? Read [Concepts](/docs/core),
then review [Assets](/docs/tokens) for the token accounts and stablecoins used
in payment flows.
...
Moving real money? Review
[Production Readiness](/docs/tools/production-readiness) for RPC infrastructure,
transaction confirmation, monitoring, and key management before you launch.
