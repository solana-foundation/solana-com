...
[x402](https://pay.sh/) is an open payment standard that enables seamless
...
- **Web3 Payments**: Transparent, verifiable payments onchain
...
5. Transaction confirmed onchain, Facilitator notifies API
