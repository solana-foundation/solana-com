...
<Cards>
  <Card title="Quickstart" href="/docs/payments/agentic-payments/quickstart">
    Make a sandbox payment and put a paid HTTP gateway in front of an API.
  </Card>
  ...
  >
    Choose how your resource server verifies and settles x402 payments.
  </Card>
</Cards>
