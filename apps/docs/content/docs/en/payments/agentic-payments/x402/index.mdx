...
To exercise the complete flow first, follow
[Making an x402 Payment](/docs/payments/agentic-payments/x402/making-a-payment)
and make one payment against a local sandbox API.
...
<Cards>
  <Card
    title="Making an x402 Payment"
    href="/docs/payments/agentic-payments/x402/making-a-payment"
  >
    Complete one x402 V2 payment against a local sandbox API without moving real
    funds.
  </Card>
  <Card title="Become an x402 Facilitator" href="/docs/tools/x402-facilitator">
    Compare managed, self-hosted, and in-process verification and settlement.
  </Card>
  <Card title="Use x402 with Kora" href="/docs/tools/kora/guides/x402">
    Run a reference facilitator with Solana transaction policy and fee
    sponsorship provided by Kora.
  </Card>
</Cards>
