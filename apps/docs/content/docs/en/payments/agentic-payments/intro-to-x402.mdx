...
- **High-Resolution Images**: Unlock full-resolution downloads after payment
  ...
  [x402 coinbase example](https://github.com/coinbase/x402/tree/main/typescript/packages/http/paywall)
...
already confirmed onchain. However, this approach deviates from the x402.org
