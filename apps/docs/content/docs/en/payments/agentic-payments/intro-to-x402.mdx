...
To exercise the complete flow first, follow the
[x402 quickstart](/docs/payments/agentic-payments/x402-quickstart) and make one
payment against a local sandbox API.
...
<Cards>
  <Card
    title="Choose and operate an x402 facilitator"
