...
<Callout type="caution">
  The Commerce Kit is currently in beta. APIs may change before the stable release. For additional details on Commerce Kit, see the [Commerce Kit documentation](https://launch.solana.com/docs/commerce-kit).
</Callout>

The `PaymentButton` component from the [Commerce Kit](https://www.npmjs.com/package/@solana-commerce/kit) provides a complete payment interface—handling wallet connection, token selection, transaction processing, and UI state out of the box.
...
Check out the [Commerce Kit Playground](https://launch.solana.com/products/commercekit/playground) to configure and test the component.

### Tip Button

![Tip Button](/docs/payments/tip-button.png)

### Pay Modal

![Pay Modal](/docs/payments/pay-modal.png)

### Solana Pay QR Code Modal

![Solana Pay QR Code Modal](/docs/payments/scan-modal.png)
