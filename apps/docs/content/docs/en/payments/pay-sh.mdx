...
<Callout type="info" title="Prefer video?">
  Watch the [12-part Pay.sh video series](/docs/payments/pay-sh-video-tutorials)
  — the same material, walked through step by step.
</Callout>
