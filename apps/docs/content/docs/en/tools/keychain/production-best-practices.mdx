...
see the metrics in
[Production Readiness](/docs/finance/production-readiness#monitoring-and-reconciliation).
Enable provider-side audit logs (KMS, Vault, or custodian) and reconcile them
against the transactions your application submits.
