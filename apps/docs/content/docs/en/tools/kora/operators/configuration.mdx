...
> _Note: When `fallback_if_unavailable` is true, the system allows transactions
> to proceed if Redis is temporarily unavailable, preventing service disruption.
> Setting `max_transactions` to 0 will allow unlimited transactions._
...
| `get_payer_signer`          | Return the next fee payer and payment address        | ✅       | boolean |
...
| ---------------------------- | ------------------------------------------------ |
| `confidential_transfer_mint` | Confidential Balances configuration for the mint |
...
| Extension Name                  | Description                                 |
| ------------------------------- | ------------------------------------------- |
| `confidential_transfer_account` | Confidential Balances state for the account |
