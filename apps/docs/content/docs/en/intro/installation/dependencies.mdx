...
| -------- | ----------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| MCP      | MCP server that you can connect to with cursor to improve Solana AI assisted development. | https://solana.com/developers/guides/getstarted/intro-to-ai     |
