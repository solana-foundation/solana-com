...
Anchor uses Node.js package tooling during project initialization. Node.js and
Yarn are also required when you select a TypeScript test template. The default
LiteSVM test template runs in Rust.
