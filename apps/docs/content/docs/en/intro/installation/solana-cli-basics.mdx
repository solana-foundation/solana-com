...
This section provides common commands and examples to help you get started with
the Solana CLI.
...
To see your current configuration settings, run:
...
Before you can send transactions using the Solana CLI, you need a Solana wallet
funded with SOL.
