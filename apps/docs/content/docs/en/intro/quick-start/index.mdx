...
[connected cluster](/docs/references/terminology#cluster) (`devnet`), the
[wallet address](/docs/references/terminology#wallet), and your
...
<Callout type="warn">
  ...
  assets (from [`mainnet`](/docs/references/terminology#cluster)) to this
  address.
</Callout>
