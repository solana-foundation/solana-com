...
# Part 1: AI-Assisted Development with Solana MCP

# Using AI Tools with Solana MCP

One of the most powerful ways to leverage AI for Solana development is through
the [Solana Developer MCP](https://mcp.solana.com/) (Machine Conversation
Protocol). This integration brings specialized Solana knowledge directly into
your IDE, making your agents more knowledgeable about up to date Solana
documentations. This makes Solana development faster and more efficient.

## What is Solana MCP?

Solana MCP (Machine Conversation Protocol) is a specialized AI assistant that
integrates directly into AI-supported IDEs like Cursor and Windsurf. When you
ask Solana-specific questions, it automatically queries the MCP server to
provide accurate, up-to-date information. The MCP tool is trained on
comprehensive Solana resources including:
...
- [Solana Stackexchange](https://solana.stackexchange.com/) questions and
  answers
...
- Understand onchain AI integration options
...
SOLANA_PRIVATE_KEY=             # Get this from: https://solana.com/wallets
SOLANA_PUBLIC_KEY=
...
[official eliza documentation](https://docs.elizaos.ai/quickstart)
