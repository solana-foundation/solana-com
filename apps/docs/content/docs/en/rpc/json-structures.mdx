...
"innerInstructions": [
  {
    // !hover index
    "index": 0,
    // !hover(1:31) instructions
    "instructions": [
      {
        // !hover(1:9) instructions.parsed
        "parsed": {
          // !hover(1:6) instructions.parsed.info
          "info": {
            "extensionTypes": [
              "immutableOwner"
            ],
            "mint": "5kR7n7QJv85..WNcfDV6e"
          },
          // !hover instructions.parsed.type
          "type": "getAccountDataSize"
        },
        // !hover instructions.program
        "program": "spl-token",
        // !hover instructions.programId
        "programId": "Tokenke...feZyiNwA",
        // !hover instructions.stackHeight
        "stackHeight": 2
      },
      {
        // !hover(1:10) instructions.parsed
        "parsed": {
          // !hover(1:7) instructions.parsed.info
          "info": {
            "lamports": 2039280,
            "newAccount": "9v...rF3fp6Btx",
            "owner": "Tokenke...s623VQ5DA",
            "source": "47eFuH...hmE62Jovb",
            "space": 165
          },
          // !hover instructions.parsed.type
          "type": "createAccount"
...
Name of the program the CPI is being made to.
...
Parser output when the program is recognized:
...
"innerInstructions": [
  {
    // !hover index
    "index": 0,
    // !hover(1:14) instructions
    "instructions": [
      {
        // !hover instructions.accounts
        "accounts": [3],
        // !hover instructions.data
        "data": "84eT",
        // !hover instructions.programIdIndex
        "programIdIndex": 5,
        // !hover instructions.stackHeight
        "stackHeight": 2
      },
      {
        ...
        "accounts": [0, 1],
        // !hover instructions.data
        "data": "1111...DmvKGmLdUxYdg3h7QSrL",
        // !hover instructions.programIdIndex
        "programIdIndex": 2,
        // !hover instructions.stackHeight
        "stackHeight": 2
...
Index into `transaction.message.accountKeys` of the Program ID for the program
the CPI is being made to.

##### !! accounts

!type array[number]

Indexes into `transaction.message.accountKeys` for the accounts passed to the
program the CPI is being made to.
...
{/* prettier-ignore */}
```jsonc !! title="postTokenBalances"
"postTokenBalances": [
  {
    // !hover balances.accountIndex
    "accountIndex": 1,
    // !hover balances.mint
    "mint": "6Hv...THqetPLgb6NnxKZLHQxNp",
    // !hover balances.owner
    "owner": "DKy...fZrDNVTf6QcUyW4trvkB",
    // !hover balances.programId
    "programId": "Tok...C1PHnBqCXEpPxuEb",
    // !hover(1:6) balances.uiTokenAmount
    "uiTokenAmount": {
      // !hover balances.uiTokenAmount.amount
      "amount": "0",
      // !hover balances.uiTokenAmount.decimals
      "decimals": 2,
      // !hover balances.uiTokenAmount.uiAmount
      "uiAmount": null,
      // !hover balances.uiTokenAmount.uiAmountString
      "uiAmountString": "0"
    }
  },
  {
    ...
    "mint": "6Hv...THqetPLgb6NnxKZLHQxNp",
    // !hover balances.owner
    "owner": "8xm9...52whAVCiDEV1qREGHNV",
    // !hover balances.programId
    "programId": "Tok...C1PHnBqCXEpPxuEb",
    // !hover(1:6) balances.uiTokenAmount
    "uiTokenAmount": {
...
"preTokenBalances": [
  ...
  },
  {
    ...
    "mint": "6Hv...THqetPLgb6NnxKZLHQxNp",
    // !hover balances.owner
    "owner": "8xm9...J2whAVCiDEV1qREGHNV",
    // !hover balances.programId
    "programId": "Tok...C1PHnBqCXEpPxuEb",
    // !hover(1:6) balances.uiTokenAmount
    "uiTokenAmount": {
...
<Accordions>
<Accordion title="Reference transaction">
