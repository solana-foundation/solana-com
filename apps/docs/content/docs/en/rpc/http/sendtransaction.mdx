...
The default `base58` encoding is capped at 1,232 bytes and cannot carry a
[v1 transaction](/docs/core/transactions/versioned-transactions#v1-message-format)
larger than that — use `base64` for transactions over 1,232 bytes.
