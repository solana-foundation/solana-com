...
description: >-
  ...
  exempt.
url: /docs/rpc/http/getminimumbalanceforrentexemption
type: reference
...
<Callout type="info" title="Source">
  [`get_minimum_balance_for_rent_exemption`](https://github.com/anza-xyz/agave/blob/v3.1.8/rpc/src/rpc.rs#L590)
</Callout>
