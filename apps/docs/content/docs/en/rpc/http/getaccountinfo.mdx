...
The RPC protocol still defaults to `binary` for backwards compatibility, even
though that encoding is deprecated. New integrations should explicitly request
`base64`.
