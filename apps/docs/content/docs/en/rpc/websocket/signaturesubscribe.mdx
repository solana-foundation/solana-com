...
!type RpcResponse&lt;RpcSignatureResult&gt;
...
String form of `ReceivedSignatureResult::ReceivedSignature`. Agave serializes
this enum variant as the plain JSON string `"receivedSignature"`.
