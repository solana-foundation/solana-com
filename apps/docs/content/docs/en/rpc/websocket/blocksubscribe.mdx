...
`0`, and version `1` with the
[v1 format](/docs/core/transactions/versioned-transactions#v1-format) — set this
to `1` to keep the subscription working on slots that carry v1 transactions.
