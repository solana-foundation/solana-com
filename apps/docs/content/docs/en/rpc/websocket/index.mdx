...
For production guidance on reconnecting, backfilling missed data, ordering, and
rate limits, see [WebSockets vs Polling](/docs/rpc/choosing-a-transport).
