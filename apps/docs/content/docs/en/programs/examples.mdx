...
| [Realloc](https://github.com/solana-foundation/program-examples/tree/main/basics/realloc)                                     | Shows how to resize an existing account within the [runtime limits](/docs/core/accounts/modification-rules#data-rules). | Native, Anchor            |
