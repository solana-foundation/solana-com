...
4. Use _rs`TransferCheckedWithFee`_ to transfer tokens. The configured fee is
   automatically withheld on the destination token account.
...
| ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`TransferFeeConfig`_                                          | Mint extension that stores the fee authorities, accumulated withheld amount, and the older and newer transfer fee configurations.                                                                   | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/extension/transfer_fee/mod.rs#L128-L167)         |
...
| _rs`TransferFeeAmount`_                                          | Token account extension that stores the amount withheld during transfers for a token account.                                                                                                       | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/extension/transfer_fee/mod.rs#L169-L188)         |
