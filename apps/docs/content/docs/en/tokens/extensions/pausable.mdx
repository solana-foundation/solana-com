---
title: Pausable Mint
description: Learn how to enable the PausableMintExtension.
---

## How to enable the PausableExtension
...
allows a designated pause authority to halt all token activity on a mint. The
pause authority can pause or unpause the mint at any time.

When paused, the Token-2022 program rejects all transfers, mints, and burns for
that token. When unpaused, normal operations resume.

This is a common pattern in both blockchain token systems and traditional
finance, where the ability to freeze activity is needed for compliance, incident
response, or administrative control.
