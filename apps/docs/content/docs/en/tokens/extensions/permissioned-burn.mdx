...
<Callout type="warn" title="Program Version">
  Permissioned burn ships in Token-2022
  [`program@v11.0.0`](https://github.com/solana-program/token-2022/releases/tag/program%40v11.0.0).
  Confirm the cluster you target runs v11.0.0 or later before using the
  extension.
</Callout>
...
console.log("Source Amount After Burn:", sourceAccount.data.amount);
console.log("Permissioned Burn Extension:", permissionedBurnConfig);
```
