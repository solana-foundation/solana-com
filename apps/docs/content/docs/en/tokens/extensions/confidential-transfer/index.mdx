...
A confidential transfer mint can store an optional global auditor ElGamal public
...
The confidential transfer authority sets the auditor key when initializing the
