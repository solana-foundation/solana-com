...
- Confidential transfers have historically spanned a few dependent transactions
  because the proofs exceeded the transaction size limit. The transaction v1
  format raises that limit, which lets a confidential transfer execute in a
