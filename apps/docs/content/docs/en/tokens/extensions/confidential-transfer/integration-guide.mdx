---
title: Confidential Balances Integration Guide
description:
  Learn how to integrate tokens that use Confidential Balances into wallets,
  explorers, exchanges, and other applications.
---

# Supporting Confidential Balances on Solana

## Background

The Confidential Balances extension lets Token-2022 mints keep transfer amounts
...
This guide is for teams **integrating** Confidential Balances tokens (wallets,
...
- [Confidential Balances overview and step-by-step guides](/docs/tokens/extensions/confidential-transfer)
...
When an account is configured for Confidential Balances, the
...
use, or when the user opts into Confidential Balances.
...
Two optional extensions build on Confidential Balances. Both are mainly the
...
| :---------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------- |
| Detect the extension          | Recognize Confidential Balances on mints and accounts and handle these tokens explicitly rather than assuming a public-only model.                              | **P0**   |
