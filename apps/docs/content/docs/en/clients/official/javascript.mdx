...
`@solana/client` is the headless Solana runtime that bundles RPC, wallets,
transactions, and subscriptions in one store.
...
`@solana/react-hooks` layers a React provider and hooks on top of
`@solana/client`, reusing the same runtime and cache.
...
| Package          | Description                                                                                   | GitHub                                                         |
| ---------------- | --------------------------------------------------------------------------------------------- | -------------------------------------------------------------- |
| @solana/keychain | Unified signing: Memory, Vault, Privy, Turnkey, AWS KMS, Fireblocks, GCP KMS, CDP, Para, Dfns | [Source](https://github.com/solana-foundation/solana-keychain) |
