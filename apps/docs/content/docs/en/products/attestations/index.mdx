...
**[→ Installation Quick Start](/docs/products/attestations/quickstart/installation)** -
Get up and running quickly

**[→ Overview](/docs/products/attestations/overview)** - Detailed overview and
architecture
...
- **[Quick Start Guides](/docs/products/attestations/quickstart/installation)** -
  Get up and running quickly
- **[Credentials](/docs/products/attestations/credentials)** - Learn about
  attestation authorities
- **[Schemas](/docs/products/attestations/schemas)** - Define data structures
  for attestations
- **[Attestations](/docs/products/attestations/attestations)** - Create and
  manage verifiable claims
- **[Instructions](/docs/products/attestations/instructions/create-credential)** -
