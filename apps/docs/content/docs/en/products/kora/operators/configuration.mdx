...
> [Beta Configuration](/docs/products/kora/beta/configuration) for new options:
...
> [Authentication Guide](/docs/products/kora/operators/authentication)._
...
**[→ Kora Monitoring Reference Guide](/docs/products/kora/operators/monitoring)**
...
[Signers Guide](/docs/products/kora/operators/signers).
...
- Check [Authentication Guide](/docs/products/kora/operators/authentication) for
  auth setup
- Check [Signers Guide](/docs/products/kora/operators/signers) for signer
  configuration
- Check [Operator Guide](/docs/products/kora/operators) for more information on
  how to run a Kora node
