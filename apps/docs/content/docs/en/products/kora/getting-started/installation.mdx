...
> [Beta Installation](/docs/products/kora/beta/installation) for Docker images
> and `kora-cli@2.2.0-beta.7`.
...
See the [JSON-RPC API Overview](/docs/products/kora/json-rpc-api) for detailed
