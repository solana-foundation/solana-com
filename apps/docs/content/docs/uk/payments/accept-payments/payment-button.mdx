...
<Callout type="caution">
  ...
  стабільного релізу. Для отримання додаткової інформації про Commerce Kit
  дивіться [документацію Commerce Kit](/docs/tools/commerce-kit).
</Callout>
...
| `onPaymentStart`   | `()`                  | Процес платежу розпочато             |
