...
Програма memo Solana дозволяє додавати номери рахунків, ідентифікатори замовлень
або власні посилання до будь-якого платежу. Ці memo назавжди записуються в
блокчейн і відображаються в логах транзакцій, що спрощує зіставлення платежів з
вашими внутрішніми системами.
