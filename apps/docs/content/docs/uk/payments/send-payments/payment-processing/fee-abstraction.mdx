...
[Kora](/docs/products/kora) обробляє цю складність. Це JSON-RPC сервер, який
забезпечує абстракцію комісій, тому користувачам ніколи не потрібен SOL. Ви
можете повністю спонсорувати комісії або приймати оплату комісій у будь-якому
токені.
...
<Cards>
  <Card
    ...
    href="/docs/products/kora/getting-started/quick-start"
  >
    Запустіть Kora локально за лічені хвилини.
  </Card>
  <Card
    title="Повна демонстрація транзакції"
    href="/docs/products/kora/guides/full-demo"
  >
    Повний посібник з реалізації транзакції з абстракцією комісій.
  </Card>
  <Card title="Довідник API" href="/docs/products/kora/json-rpc-api">
    Документація JSON-RPC методів та SDK.
  </Card>
  <Card title="Посібник оператора вузла" href="/docs/products/kora/operators">
