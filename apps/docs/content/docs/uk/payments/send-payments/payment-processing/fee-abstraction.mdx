...
description:
  Дізнайтеся, як працює спонсорство комісій та впровадьте абстракцію комісій за допомогою Kora.
---
...
<Cards>
  ...
  <Card title="Посібник для операторів вузлів" href="/docs/tools/kora/operators">
