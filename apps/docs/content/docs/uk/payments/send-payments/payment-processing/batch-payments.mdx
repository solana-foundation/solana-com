...
description: Дізнайтеся, як здійснювати платежі кільком одержувачам в одній транзакції.
---
...
збільшує обмеження розміру до 4096 байт, що дозволяє вмістити приблизно втричі більше
переказів в одній транзакції. Групування все одно необхідне понад цей ліміт, оскільки
середовище виконання завантажує щонайбільше 64 акаунти на транзакцію незалежно від формату.
