...
Після отримання адреси ATA перевірте, чи існує token account онлайн. Якщо ATA не
існує, ви можете включити інструкцію для створення token account одержувача в
тій самій транзакції, що й переказ. Однак це вимагає сплати rent за новий token
account. Оскільки одержувач володіє ATA, SOL, сплачений за rent, не може бути
відшкодований відправником.
