...
- Суми вказані в базових одиницях. Для токена з 6 десятковими знаками,
  `1_000_000` означає `1` токен.
- Виконуйте `initSubscriptionAuthority` лише тоді, коли акаунт Subscription
  Authority ще не існує.
