...
У Solana програми — це виконувана логіка, яка керує станом облікових записів.
Токен-акаунтами керує **Token Program** — ончейн-код, який перевіряє перекази та
атомарно оновлює баланси.
...
Token-2022 (також відомий як "Token Extensions") додає такі функції, як transfer hooks,
комісії за переказ і конфіденційні баланси. Обидві програми працюють подібно для базових
переказів, але ви повинні використовувати правильну при визначенні ATA.
...
<Callout type="info">
  Solana використовує локальні ринки комісій — транзакції конкурують з іншими транзакціями,
  які записують у той самий стан. Це означає, що комісії за платежі залишаються низькими та передбачуваними
  навіть у періоди високої мережевої активності в інших місцях.
</Callout>
...
<Cards>
  ...
  <Card title="Надішліть свій перший платіж" href="/docs/payments/send-payments">
