---
title: Rust
description: Встановлення та використання solana-keychain у застосунках Rust
---
...
Перегляньте
[посібник з додавання підписувачів](/docs/tools/keychain/adding-signers) для
інтеграції додаткових сервісів керування ключами.
