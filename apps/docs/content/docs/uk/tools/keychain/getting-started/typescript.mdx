...
## Створення користувацьких підписантів

Реалізуйте інтерфейс `SolanaSigner` для створення користувацьких підписантів:
...
Дивіться [посібник з додавання підписантів](/docs/tools/keychain/adding-signers)
для інтеграції додаткових сервісів управління ключами.
