---
title: Стандартні функції
description: Утилітарні функції, доступні у стандартній бібліотеці
---

Ці функції доступні у всіх Runbooks як частина стандартної бібліотеки.

## Оператори

Основні математичні та порівняльні оператори:
