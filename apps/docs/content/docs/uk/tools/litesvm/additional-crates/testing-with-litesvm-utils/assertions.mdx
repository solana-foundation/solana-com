...
title: Перевірки
description:
  Перевіряйте стани акаунтів, баланси та власність за допомогою помічників
  перевірок
---

## Існування акаунту

Перевірте, чи існують акаунти або чи були вони закриті.

### Перевірити існування акаунту
...
<Callout type="info">
  `assert_account_closed` спрацьовує, коли акаунт або не існує, має нульовий
  баланс у lamports, або має порожні дані. Використовуйте це для перевірки
  очищення після закриття акаунтів.
</Callout>

## Перевірки балансу

Перевіряйте баланси SOL та токенів.

### Перевірити баланс SOL
...
Перевіряйте власність акаунту та властивості даних.

### Перевірити власника акаунту
...
### Перевірити довжину даних акаунту
...
<Callout type="info">
  Типові розміри акаунтів: - **Mint Account**: 82 байти - **token account**: 165
  байт - **System Account**: 0 байт (лише lamports)
</Callout>

## Повний приклад

Ось комплексний тест, що демонструє кілька перевірок:
...
Коли перевірка не проходить, вона завершується панікою з описовим повідомленням:
...
<Callout type="warn">
  Перевірки розроблені для швидкого виявлення помилок із зрозумілими
  повідомленнями. Використовуйте їх активно у своїх тестах, щоб виявляти
