---
title: Переказ SOL
description: Створення та надсилання транзакції переказу SOL за допомогою LiteSVM
---

Найпростіша транзакція у Solana: переміщення SOL з одного акаунта на інший. Це
гарний перший тест для перевірки правильності налаштування LiteSVM перед тестуванням складнішої
логіки програми.
...
[Тестування програм](/docs/tools/litesvm/typescript/examples/program-testing). Для
переказів токенів (монетні двори, ATA) дивіться
