---
title: Чому LiteSVM
description: Зрозумійте, як працює LiteSVM і чим він відрізняється
---

## Огляд

Уявіть LiteSVM як Solana VM, що працює всередині вашої тестової функції. Не як
окремий процес, не як мережевий сервіс — це просто виклик бібліотеки у вашому
коді.
...
Ніяких `async`, ніяких `await`, ніяких затримок:
...
### 4. Помилки є Негайними та Зрозумілими
...
<Tabs items={["Rust", "TypeScript"]} groupId="litesvm-lang">
  <Tab value="Rust">
    **[Тестування Вашої Програми →](/docs/tools/litesvm/testing-your-program)**
    ...
    →](/docs/tools/litesvm/examples)** Перегляньте готові рішення для поширених
  ...
  <Tab value="TypeScript">
    ...
    **[Приклади →](/docs/tools/litesvm/typescript/examples)** Перегляньте готові
    рішення для поширених сценаріїв <br /> **[Довідник API
