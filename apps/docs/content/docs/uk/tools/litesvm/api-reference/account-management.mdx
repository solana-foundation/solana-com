...
description: Методи для управління акаунтами, балансами та rent
---
...
Де `TransactionResult` — це
`Result<TransactionMetadata, FailedTransactionMetadata>`.

Поповнити акаунт lamport. Повертає метадані транзакції в разі успіху.
...
Безпосередньо встановити стан акаунта.
...
Отримати баланс акаунта в lamport. Повертає `None`, якщо акаунт не існує.
