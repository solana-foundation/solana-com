...
description:
  Створюйте онлайн-акаунти за адресами Solana PDA, використовуючи invoke_signed
  та обмеження init від Anchor. Процес перевірки invoke_signed та шаблони
  створення PDA в Anchor з прикладами коду.
