...
- [Модель облікових записів Solana](/docs/core/accounts)
- [Програми Solana загалом](/docs/core/programs)
- [Розробка користувацьких програм Solana](/docs/programs/rust/)
...
- **Ідентифікатор програми (Program ID)**: Адреса вашої програми в блокчейні.
  Користувачі взаємодіють з вашою програмою, посилаючись на ідентифікатор
  програми.
- **program account**: Обліковий запис у блокчейні, що зберігає метадані вашої
  програми. Адреса program account є ідентифікатором програми. program account
  також зберігає адресу programdata account.
- **programdata account**: Обліковий запис у блокчейні, що зберігає розгорнутий
  виконуваний код вашої програми.
- **Повноваження програми (Program Authority)**: Обліковий запис, який має
  дозвіл оновлювати або закривати програму. За замовчуванням це ваш гаманець
  CLI.
...
Ідентифікатор програми (Program ID) — це адреса вашого облікового запису
програми в блокчейні. Користувачі та інші програми викликають вашу програму,
посилаючись на цей ідентифікатор у своїх транзакціях.
...
- **`--use-rpc`**: надсилає транзакції до налаштованого RPC. Цей прапорець
  вимагає [stake-weighted](/docs/defi/stake-weighted-qos) RPC-з'єднання від
  провайдерів, таких як [Triton](https://triton.one/) або
