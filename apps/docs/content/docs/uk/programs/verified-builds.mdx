...
Якщо ви хочете мати повністю безпечне налаштування без довіри, ви можете
запустити
[API верифікації](https://github.com/otter-sec/solana-verified-programs-api)
самостійно або виконати верифікацію програми локально, використовуючи команду
`verify-from-repo` з даними верифікації в мережі, які зберігаються в
[PDA](https://explorer.solana.com/address/63XDCHrwZu3mXsw2RUFb4tbNpChuUHx4eA5aJMnHkpQQ/anchor-account),
що походить від повноважень розгортання програми та
...
вашої програми. У майбутньому, після впровадження, `security.txt` міститиме
...
збірки та верифікації програми, походить від адреси програми та публічного ключа
