...
- Адреса акаунта походить від PDA, виведеного з використанням сідів
...
- Як тип _rs`SystemAccount`_, ним володіє System Program, як звичайними
  акаунтами гаманців
...
інструкції `transfer` System Program. Це демонструє, як виконувати CPI всередині
...
переказу будь-якого накопиченого SOL назад користувачу.
