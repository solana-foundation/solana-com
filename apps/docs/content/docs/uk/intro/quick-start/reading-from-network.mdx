...
унікальну [адресу](/docs/core/accounts/account-structure#account-address), яка
використовується для пошуку даних акаунту в мережі. Акаунти Solana містять або
[дані стану, або виконувану програму](/docs/core/accounts/account-types).
