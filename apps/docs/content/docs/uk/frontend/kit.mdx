...
Налаштуйте мінімальну інтеграцію гаманця Solana у Next.js за допомогою Solana
Kit.

Цей посібник надає мінімальний приклад реалізації функціональності гаманця
Solana у додатку Next.js за допомогою `@solana/kit`. Ви створите кнопку
...
у репозиторії Solana Kit.

## Ресурси

- [Документація Solana Kit](https://www.solanakit.com/docs)
- [GitHub-репозиторій Solana Kit](https://github.com/anza-xyz/kit)
...
UI-компонентів та встановіть необхідні залежності Solana.
...
Встановіть такі залежності Solana:
...
## !!steps 1. Створення контексту Solana
...
- Підключатися до кінцевих точок RPC devnet Solana
- Фільтрувати доступні гаманці Solana, встановлені в браузері користувача
...
Далі обгорніть весь застосунок Next.js провайдером Solana.
...
- Створює транзакцію Solana з інструкцією, що викликає програму memo
- Запитує підключений гаманець для підписання та надсилання транзакції
- Відображає посилання для перегляду транзакції в Solana Explorer
...
<Callout type="info">
  ...
  до кластера devnet і [поповнений devnet SOL](https://faucet.solana.com/) для
