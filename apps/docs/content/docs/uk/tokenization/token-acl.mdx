...
надає еталонні реалізації для дослідження та навчальних цілей.

Код програм ACL доступний у
[репозиторії token-acl](https://github.com/solana-foundation/token-acl), а
програма ABL Gate доступна у
[репозиторії token-acl-gate](https://github.com/solana-foundation/token-acl-gate).

**Важливо**: Програма ABL (Allow Block List) Gate, використана в цьому посібнику, є
**еталонною реалізацією**. Хоча вона перевірена аудитом і готова до використання в продакшені, емітенти
мають право створювати власні програми Gate, які краще відповідають їхнім конкретним
вимогам щодо відповідності нормативним вимогам. Ви зобов'язані дотримуватися лише специфікації Token ACL (sRFC37),
а не цього конкретного дизайну програми Gate.

**НЕ використовуйте цей код безпосередньо в продакшені** без:

- Комплексного аудиту безпеки
