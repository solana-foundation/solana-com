...
[Address Lookup Tables](/developers/cookbook/transactions/lookup-tables) для
стиснення адрес акаунтів і розміщення більшої кількості переказів в одній транзакції.

Наступний
[формат транзакцій v1](/docs/core/transactions/versioned-transactions#v1-message-format)
підвищує ліміт до 4096 байтів, але прибирає підтримку Address Lookup Tables, тому розрахунки v1
вставляють адреси безпосередньо. У будь-якому разі середовище виконання завантажує не більше
64 акаунтів на транзакцію.
