...
Див.
[деталі реалізації тут](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/processor.rs#L27).
...
## Наступні кроки: Додавання метаданих

Обліковий запис mint зберігає лише основну інформацію про токен (пропозицію,
десяткові знаки, повноваження). Щоб додати зрозумілі людині метадані, такі як
назва, символ та зображення до вашого токена, у вас є два варіанти:

<Cards>
  <Card title="Metaplex Token Metadata" href="/docs/tokens/metaplex">
   Додайте метадані за допомогою Metaplex Token Metadata Program. Працює як з оригінальною Token Program, так і з Token-2022.
  </Card>
...
Mint account зберігає лише базову інформацію про токен (загальну кількість,
десяткові знаки, повноваження). Щоб додати зрозумілі людині метадані, такі як
назва, символ та зображення до вашого токена, ви маєте два варіанти:
...
<Cards>
  ...
  <Card title="Token Extensions Metadata" href="/docs/tokens/extensions/metadata">
   Використовуйте вбудоване розширення метаданих з Token-2022. 
   Розширення метаданих доступне лише для mint accounts, створених з Token-2022.
   Щоб додати метадані до mint accounts, створених з оригінальною Token Program, використовуйте Metaplex Token Metadata Program.
  </Card>
</Cards>
