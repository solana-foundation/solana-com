...
токен-акаунта. Після розморожування акаунт знову може надсилати та отримувати
токени в звичайному режимі. Тільки freeze authority токена mint може
розморожувати акаунти.
