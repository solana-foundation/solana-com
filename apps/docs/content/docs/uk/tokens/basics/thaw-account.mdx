...
Після успішного розморожування обліковий запис знову може переказувати,
спалювати та закривати токени. Тільки freeze authority мінту може розморожувати
token accounts.
...
Інструкція _rs`ThawAccount`_ перевіряє, що token account належить мінту і що
підписувач є freeze authority мінту, потім змінює стан token account із
замороженого назад на ініціалізований.
