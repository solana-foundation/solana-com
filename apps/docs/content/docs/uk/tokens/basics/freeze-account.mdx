...
запобігає всім переказам токенів або спалюванню токенів з певного токен-акаунта.
Після заморожування акаунт не може відправляти або отримувати токени, доки його
не буде розморожено. Заморожений акаунт все ще можна закрити, якщо його баланс
токенів дорівнює нулю. Тільки уповноважена особа на заморожування mint account
токена може заморожувати акаунти. Якщо повноваження на заморожування відкликано
(встановлено на null) для mint account, токени ніколи не зможуть бути
заморожені.
