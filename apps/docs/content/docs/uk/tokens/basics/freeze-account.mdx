...
запобігає всім переказам токенів або спалюванню токенів з конкретного
токен-акаунта. Після заморожування акаунт не може надсилати токени або
отримувати токени, доки його не буде розморожено. Заморожений акаунт все ще
можна закрити, якщо він має нульовий баланс токенів. Тільки орган заморожування
mint-акаунта токена може заморожувати акаунти. Якщо орган заморожування
відкликано (встановлено значення null) на mint-акаунті, токени ніколи не можуть
бути заморожені.
