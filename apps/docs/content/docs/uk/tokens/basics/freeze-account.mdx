...
запобігає всім переказам токенів або спаленню токенів з конкретного
токен-акаунта. Після заморожування акаунт не може надсилати токени, отримувати
токени або бути закритим, доки його не буде розморожено. Тільки freeze authority
мінту токена може заморожувати акаунти. Якщо freeze authority відкликано
(встановлено в null) на акаунті мінту, токени ніколи не можуть бути заморожені.
