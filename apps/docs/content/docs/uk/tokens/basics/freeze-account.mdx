...
Заморожування токен-акаунта зберігає того самого власника, mint і баланс, але
запобігає перекладу або спалюванню токенів з токен-акаунта, доки токен-акаунт не
буде розморожено.
