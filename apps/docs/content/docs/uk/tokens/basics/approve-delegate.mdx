...
надає іншому акаунту (делегату) дозвіл на переказ певної кількості токенів з
вашого токен-акаунта. Делегат може переказувати токени в межах затвердженої
суми, але не може її перевищити. Тільки власник токен-акаунта може затвердити
делегата, і кожен токен-акаунт може мати лише одного делегата одночасно.
