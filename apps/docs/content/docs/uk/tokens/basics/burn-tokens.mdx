...
description:
  Спалюйте токени з облікового запису токенів і зменшуйте загальну пропозицію
  mint.
...
Спалювання токенів назавжди зменшує баланс облікового запису токенів і одночасно
зменшує загальну пропозицію mint на ту саму кількість.
...
Наведені нижче приклади використовують _rs`BurnChecked`_, яка вимагає від
викликаючої сторони надати значення decimals mint, щоб інструкція могла
перевірити очікувану точність токена перед спалюванням.

[Нативний mint](/docs/tokens/basics/sync-native) не підтримує спалювання.
...
У Token Extension Program постійний делегат mint також може авторизувати
спалювання, якщо для mint увімкнено розширення постійного делегата.

### Посилання на джерело

| Елемент            | Опис                                                                                                                                                                                   | Token Program                                                                                                   | Token Extension Program                                                                                               |
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_         | Стан mint зберігає загальну пропозицію токенів.                                                                                                                                        | [Джерело](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Джерело](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
...
| _rs`Burn`_         | Інструкція спалювання, яка зменшує баланс облікового запису токенів і пропозицію mint без вимоги до викликаючої сторони надавати значення decimals mint.                               | [Джерело](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L178-L196) | [Джерело](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L221-L239) |
| _rs`BurnChecked`_  | Інструкція спалювання, яка вимагає від викликаючої сторони надати значення decimals mint і перевіряє це значення перед зменшенням балансу облікового запису токенів і пропозиції mint. | [Джерело](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L326-L350) | [Джерело](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L393-L417) |
