...
назавжди знищує токени, зменшуючи баланс у токен-акаунті. Спалені токени
вилучаються з обігу та зменшують `supply`, який відстежується в mint account.
Тільки власник токен-акаунта може спалювати токени зі свого акаунта.
