...
Закриття токен-акаунта видаляє акаунт і повертає lamport rent токен-акаунта на
акаунт призначення.

Баланс токенів має бути нульовим перед тим, як акаунт можна буде закрити.
Заморожений акаунт все ще можна закрити, якщо баланс токенів замороженого
акаунта дорівнює нулю. Токен-акаунти Wrapped SOL є винятком і можуть бути
закриті з балансом токенів для повернення базового SOL. Власник акаунта або
повноваження на закриття акаунта підписує інструкцію закриття.
