...
description:
  Видаліть поточного делегата облікового запису токенів та скасуйте залишковий
  делегований ліміт.
...
Інструкція _rs`Revoke`_ очищує поля делегата в вихідному обліковому записі
токенів. У Token Program власник облікового запису токенів підписує скасування.
У Token Extensions Program поточний делегат також може скасувати делегування.
...
Приклади `Kit` нижче демонструють рекомендований підхід із використанням
