...
2. **Ініціалізація розширення Confidential Transfer**: Викликати інструкцію
   ...
   Token Extension Program для налаштування стану _rs`ConfidentialTransferMint`_
   для мінту.

3. **Ініціалізація мінту**: Викликати інструкцію
   _rs`Instruction::InitializeMint`_ Token Extension Program для ініціалізації
