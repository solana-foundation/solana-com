...
1. Створіть
   ...
   **Доказ рівності
   ([CiphertextCommitmentEqualityProofData](https://github.com/anza-xyz/agave/blob/8b33d6d311c95780362a7d235919e7b8d2345939/zk-token-sdk/src/instruction/ciphertext_commitment_equality.rs#L56))**:
   Перевіряє, що шифротекст залишку доступного балансу після зняття відповідає
   його
   [зобов'язанню Педерсена](https://en.wikipedia.org/wiki/Commitment_scheme),
   гарантуючи, що новий доступний баланс облікового запису правильно обчислено
   як `remaining_balance = current_balance - withdraw_amount`.
...
4. Закрийте рахунки доказів, щоб повернути SOL, використаний для їх створення.
...
запуску локального validator у вас має бути встановлений Solana CLI.
