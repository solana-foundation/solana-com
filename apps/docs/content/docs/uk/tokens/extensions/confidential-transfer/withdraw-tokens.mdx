...
<Callout type="warn">
  ZK ElGamal Program тимчасово вимкнено в основній мережі та devnet, оскільки
...
1. Створіть
   ...
   **Доказ рівності
   ...
   гарантуючи, що новий доступний баланс акаунта правильно обчислено як
   ...
   **Доказ діапазону
   ...
   знаходиться в межах вказаного діапазону.

2. Для кожного доказу:
   - Викличте програму ZK ElGamal proof для перевірки даних доказу.
   - Збережіть метадані, специфічні для доказу, в акаунті "context state" для
     використання в інших інструкціях.
...
3. Викличте інструкцію
   ...
   надавши два акаунти доказів.

4. Закрийте акаунти доказів, щоб повернути SOL, використаний для їх створення.
...
- Викликати програму Zk ElGamal proof для перевірки доказів та ініціалізації
  акаунтів "context state"
- Викликати інструкцію
  [ConfidentialTransferInstruction::Withdraw](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L493),
  надавши два акаунти доказів.
- Закрити два акаунти доказів для повернення rent.
...
Наступний приклад демонструє, як вивести токени з конфіденційного доступного
...
<Callout type="info">
  ...
  локальному валідаторі. Ви повинні клонувати Token Extension Program з mainnet,
