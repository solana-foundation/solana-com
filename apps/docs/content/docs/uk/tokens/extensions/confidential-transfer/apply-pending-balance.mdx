...
description:
  Дізнайтеся, як застосувати очікуваний баланс, щоб зробити кошти доступними.
---

<Callout type="warn">
  ZK ElGamal Program тимчасово вимкнено в мережах mainnet та devnet, оскільки
  проводиться аудит безпеки. Це означає, що розширення конфіденційних переказів
  наразі недоступне. Хоча концепції залишаються актуальними, приклади коду не
  працюватимуть.
</Callout>

## Як застосувати очікуваний баланс до доступного балансу

Перш ніж токени можна буде переказувати конфіденційно, публічний баланс токенів
має бути конвертовано в конфіденційний баланс. Ця конвертація відбувається у два
етапи:

1. **Конфіденційний очікуваний баланс**: Спочатку токени "депонуються" з
   публічного балансу в "очікуваний" конфіденційний баланс.
...
Цей розділ пояснює другий етап: застосування очікуваного балансу до доступного
балансу.

Коли токени "депонуються" з публічного балансу або коли токени конфіденційно
переказуються з одного token account в інший, токени спочатку додаються до
конфіденційного очікуваного балансу. Перш ніж токени можна буде використовувати
для конфіденційних переказів, очікуваний баланс має бути "застосовано" до
доступного балансу.
...
Наступна діаграма показує кроки, необхідні для застосування очікуваного балансу
...
Щоб конвертувати очікуваний баланс у доступний баланс, викличте інструкцію
...
Наступний приклад демонструє, як застосувати конфіденційний очікуваний баланс до
конфіденційного доступного балансу.
...
<Callout type="info">
  На момент написання, Confidential Transfers не ввімкнено на стандартному
  локальному validator. Ви повинні клонувати mainnet Token Extension Program,
