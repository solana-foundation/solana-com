...
description: Дізнайтеся, як застосувати очікуваний баланс, щоб зробити кошти доступними.
---

## Як застосувати відкладений баланс до доступного балансу

Перш ніж токени можна буде конфіденційно переказати, публічний баланс токенів
необхідно конвертувати в конфіденційний баланс. Це перетворення відбувається в
два етапи:

1. **Конфіденційний відкладений баланс**: Спочатку токени «вносяться» з
   публічного балансу до «відкладеного» конфіденційного балансу.
2. **Конфіденційний доступний баланс**: Відкладений баланс потім
...
Коли токени «вносяться» з публічного балансу або коли токени конфіденційно
переказуються з одного token account до іншого, токени спочатку додаються до
конфіденційного відкладеного балансу. Перш ніж токени можна буде використовувати
для конфіденційних переказів, відкладений баланс необхідно «застосувати» до
доступного балансу.
...
Наступна діаграма показує кроки, задіяні в застосуванні відкладеного балансу до
доступного балансу:
...
`confidential_transfer_apply_pending_balance`, який будує та надсилає транзакцію
з інструкцією `ApplyPendingBalance`, як показано у прикладі нижче.
...
в мережах mainnet та devnet. Стандартний `solana-test-validator` не вмикає її, але
локальний validator з форком mainnet, наприклад [Surfpool](https://surfpool.run), — вмикає.
Запустіть приклад у одній із цих мереж (у коді використовується devnet) із фінансованим платником,
та замініть заповнювачі адрес mint і акаунтів на власні.
