...
`ConfidentialTransferAccount` та схвалені для конфіденційних переказів.
...
4. Закрийте облікові записи стану контексту доказу, щоб повернути SOL,
...
запуску локального валідатора у вас має бути встановлений Solana CLI.
