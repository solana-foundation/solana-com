...
_rs`ConfidentialTransferAccount`_ та затверджені для конфіденційних переказів.
...
Наведений нижче приклад конфіденційно переказує токени з одного облікового
запису на інший. Обидва облікові записи вже мають бути налаштовані для
конфіденційних переказів, а відправник повинен мати доступний конфіденційний
баланс.
...
[Surfpool](https://surfpool.run), вмикає. Запустіть приклад проти одного з них
