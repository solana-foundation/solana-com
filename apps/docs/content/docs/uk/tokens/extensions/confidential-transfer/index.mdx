...
<Cards>
  ...
  >
    Як поповнити токени на конфіденційний очікуваний баланс
  </Card>
  <Card
  ...
  >
    Як випускати та керувати токеном конфіденційного переказу (політика
    підтвердження, аудитори, комісії, емісія та спалення)
  </Card>
</Cards>
