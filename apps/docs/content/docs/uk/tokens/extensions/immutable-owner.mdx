...
запобігає зміні власника для токен-акаунтів. Коли токен-акаунт ініціалізується з
цим розширенням, призначений власник є постійним і не може бути переданий іншому
акаунту.
