...
захищає токен-акаунти від несподіваних переказів через міжпрограмні виклики
(CPI). Коли увімкнено, це розширення гарантує, що токени можна переказувати лише
через прямі виклики інструкції transfer програми Token Extensions Program,
блокуючи всі інші програми від переказу токенів через CPI.
