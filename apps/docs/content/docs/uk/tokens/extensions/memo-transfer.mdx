...
вимагає, щоб усі вхідні перекази токенів включали супровідну примітку, коли цю
функцію увімкнено для облікового запису токена. Це розширення може бути
увімкнено або вимкнено власником облікового запису токена.
