...
призначає mint як груповий mint (наприклад, колекційний NFT), вказуючи на
...
такі як орган оновлення та максимальний розмір.
...
призначає mint як mint-учасник (наприклад, NFT у колекції), вказуючи на
обліковий запис, що містить
