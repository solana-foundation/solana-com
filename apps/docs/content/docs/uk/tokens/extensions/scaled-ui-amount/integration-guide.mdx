...
- Для отримання актуального балансу користувача ви можете отримати оновлену
...
- Користувачі повинні вводити суми, які інтерпретуються як масштабований
  “UIAmount”. Застосунок, який має це обробляти, повинен конвертувати в сиру
  суму токенів для транзакції.
  - Якщо виникають проблеми з округленням, округлюйте вниз і краще залиште
    невелику кількість залишку, ніж ризикуйте невдачею транзакції
...
- Поточний множник можна прочитати з токен mint у будь-який час, викликавши
  `getAccountInfo`. Крім того, якщо встановлено майбутній множник, ця інформація
  також доступна з токен mint. Ми рекомендуємо не показувати цей множник,
