...
встановлює стандартний стан для всіх нових токен-акаунтів, створених для mint.
Коли увімкнено, це розширення автоматично ініціалізує кожен новий токен-акаунт
із заданим станом, наприклад, замороженим. Це дозволяє творцям токенів
застосовувати певну поведінку, як-от вимагати, щоб усі нові акаунти були
заморожені за замовчуванням, доки їх явно не розморозять.
