...
дозволяє встановити процентну ставку безпосередньо на mint account. Відсотки
безперервно нараховуються на основі мережевої мітки часу, але фактичний баланс
токенів, збережений у кожному token account, залишається незмінним. Загальна
вартість (баланс токенів плюс нараховані відсотки) є лише розрахунком. Жодні
нові токени не карбуються з цим розширенням.
