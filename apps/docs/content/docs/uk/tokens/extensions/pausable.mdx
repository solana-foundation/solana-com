...
description: Дізнайтеся, як увімкнути PausableMintExtension.
---

## Як увімкнути PausableExtension
...
дозволяє призначеному органу призупинення зупинити всю активність токенів на
mint. Орган призупинення може призупинити або відновити mint у будь-який момент.

Коли призупинено, програма Token-2022 відхиляє всі перекази, карбування та
спалювання для цього токена. Коли відновлено, звичайні операції продовжуються.

Це поширений патерн як у блокчейн-системах токенів, так і в традиційних
фінансах, де можливість заморозити активність потрібна для дотримання вимог,
реагування на інциденти або адміністративного контролю.
