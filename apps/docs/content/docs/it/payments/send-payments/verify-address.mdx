...
del destinatario nella stessa transazione del trasferimento. Tuttavia, ciò
richiede il pagamento della rent per il nuovo token account. Poiché il
destinatario possiede l'ATA, il SOL pagato per la rent non può essere recuperato
dal mittente.
