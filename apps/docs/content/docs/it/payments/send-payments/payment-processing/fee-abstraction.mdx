...
description:
  Scopri come funziona la sponsorizzazione delle commissioni e implementa l'astrazione delle commissioni con Kora.
---
...
<Cards>
  ...
  <Card title="Demo transazione completa" href="/docs/tools/kora/guides/full-demo">
