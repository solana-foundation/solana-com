...
[Kora](/docs/products/kora) gestisce questa complessità. È un server JSON-RPC
che fornisce l'astrazione delle commissioni in modo che gli utenti non abbiano
mai bisogno di SOL. Puoi sponsorizzare completamente le commissioni o accettare
il pagamento delle commissioni in qualsiasi token.
...
<Cards>
  ...
  <Card title="Riferimento API" href="/docs/products/kora/json-rpc-api">
