...
<Callout type="caution">
  ...
  prima del rilascio stabile. Per ulteriori dettagli sul Commerce Kit, consulta
  la [documentazione del Commerce Kit](/docs/tools/commerce-kit).
</Callout>
...
| ------------------ | --------------------- | ----------------------------------- |
| `onPaymentSuccess` | `(signature: string)` | Transazione confermata onchain      |
