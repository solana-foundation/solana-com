...
description:
  Scegli un backend di firma Keychain in base ai tuoi requisiti — custodia, infrastruttura esistente, controlli di approvazione e se firmi per la tua applicazione o fornisci wallet agli utenti finali.
related:
...
custode regolamentato che gestisca le chiavi — utilizza un backend **MPC / custodia istituzionale**: Fireblocks, Dfns, Para,
Utila o Fordefi. Questi suddividono o custodiscono la chiave e co-firmano in base alla tua
policy.
...
| Fordefi         | Custodia MPC / istituzionale  | Custodia istituzionale con controlli di policy | La modalità nativa trasmette automaticamente; in modalità black box sei tu a inviare |
