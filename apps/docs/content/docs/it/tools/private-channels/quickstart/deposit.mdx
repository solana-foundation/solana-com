...
description:
  Deposita token SPL in un'istanza di escrow di Private Channels su devnet
---
...
**[Invia un Trasferimento](/docs/tools/private-channels/quickstart/transfer)** - invia il tuo primo trasferimento off-chain
