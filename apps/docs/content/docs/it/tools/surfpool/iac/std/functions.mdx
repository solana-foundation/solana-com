---
title: Funzioni Standard
description: Funzioni di utilità disponibili nella libreria standard
---

Queste funzioni sono disponibili in tutti i Runbook come parte della libreria
standard.

## Operatori

Operatori matematici e di confronto di base:
