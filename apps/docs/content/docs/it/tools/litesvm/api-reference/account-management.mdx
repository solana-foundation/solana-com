...
description: Metodi per la gestione degli account, dei saldi e del rent
---
...
Dove `TransactionResult` è
`Result<TransactionMetadata, FailedTransactionMetadata>`.

Finanzia un account con lamport. Restituisce i metadati della transazione in
caso di successo.
...
Imposta direttamente lo stato dell'account.
...
Ottieni il saldo in lamport dell'account. Restituisce `None` se l'account non
esiste.
