...
description: Metodi per la gestione di account, saldi e rent in TypeScript
---

Metodi per la gestione di account, saldi e impostazione dello stato degli account.
...
## Configurazione in Blocco degli Account
...
<Callout type="info">
  L'utilizzo di `setAccount` è più rapido di `airdrop` per la configurazione in blocco degli account, poiché
