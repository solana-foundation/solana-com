...
LiteSVM utilizza un pattern builder per la configurazione. Tutti i metodi restituiscono `LiteSVM`
...
Abilita o disabilita la verifica delle firme.
...
Abilita i programmi integrati (verifica delle firme ed25519, secp256k1).
...
Imposta il limite in byte per l'output dei log.
...
Abilita la memorizzazione della cronologia delle transazioni.
