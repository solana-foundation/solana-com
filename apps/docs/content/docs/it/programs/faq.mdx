...
- [Punti di ingresso dei programmi Rust](/docs/programs/rust#program-entrypoint)
...
- [Deserializzazione dei parametri del programma Rust](/docs/programs/rust#parameter-deserialization)
