...
- [Punti di ingresso dei programmi Rust](https://docs.rs/solana-program-entrypoint/latest/solana_program_entrypoint/macro.entrypoint.html)
...
- [Deserializzazione dei parametri del programma Rust](https://docs.rs/solana-program-entrypoint/latest/solana_program_entrypoint/fn.deserialize.html)
