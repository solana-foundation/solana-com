...
title: Coniare token
description:
  Conia nuove unità di token in un token account con l'autorità di conio.
...
Il conio crea nuove unità di un token esistente e aumenta l'offerta totale del
mint.

Solo l'autorità di conio può coniare nuovi token. Il token account di
destinazione deve già esistere e deve appartenere allo stesso mint.

## Come Coniare Token

Il conio di token utilizza l'istruzione _rs`MintTo`_ o _rs`MintToChecked`_ del
Token Program.

Gli esempi seguenti utilizzano _rs`MintToChecked`_, che richiede al chiamante di
fornire i decimali del mint affinché l'istruzione possa verificare la precisione
attesa del token prima di coniare.

Il [native mint](/docs/tokens/basics/sync-native) non supporta il conio.

### Riferimento Sorgente

| Elemento              | Descrizione                                                                                                                                                  | Token Program                                                                                                    | Token Extensions Program                                                                                               |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_            | Lo stato del mint memorizza l'autorità di conio e l'offerta totale di token.                                                                                 | [Sorgente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Sorgente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_         | Lo stato del token account memorizza il saldo di destinazione aggiornato dal conio.                                                                          | [Sorgente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Sorgente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`MintTo`_          | Un'istruzione di conio che conia token in un token account esistente senza richiedere al chiamante di fornire i decimali del mint.                           | [Sorgente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L159-L177) | [Sorgente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L202-L220) |
| _rs`MintToChecked`_   | Un'istruzione di conio che richiede al chiamante di fornire i decimali del mint e verifica quel valore prima di coniare token in un token account esistente. | [Sorgente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L301-L325) | [Sorgente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L367-L391) |
| _rs`process_mint_to`_ | Logica del processore condivisa per il conio di token.                                                                                                       | [Sorgente](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L521-L583)     | [Sorgente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L981-L1067)    |
