...
title: Brucia Token
description:
  Brucia token da un token account e riduce l'offerta totale del mint.
...
## Cosa Fa la Combustione?

Bruciare token riduce permanentemente il saldo di un token account e riduce
l'offerta totale del mint della stessa quantità.

## Come Bruciare Token

La combustione di token utilizza l'istruzione _rs`Burn`_ o _rs`BurnChecked`_ del
Token Program.
...
attesa del token prima della combustione.

Il [native mint](/docs/tokens/basics/sync-native) non supporta la combustione.
...
autorizzare la combustione se il mint ha l'estensione permanent delegate
abilitata.
...
| _rs`Account`_      | Lo stato del token account memorizza il saldo dei token ridotto dalla combustione.                                                                                               | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Burn`_         | Un'istruzione di combustione che riduce il saldo di un token account e l'offerta del mint senza richiedere al chiamante di fornire i decimali del mint.                          | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L178-L196) | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L221-L239) |
| _rs`BurnChecked`_  | Un'istruzione di combustione che richiede al chiamante di fornire i decimali del mint e verifica quel valore prima di ridurre il saldo di un token account e l'offerta del mint. | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L326-L350) | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L393-L417) |
| _rs`process_burn`_ | Logica condivisa del processore per le combustioni di token.                                                                                                                     | [Source](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L586-L668)     | [Source](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1070-L1194)   |
