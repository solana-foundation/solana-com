---
title: Bruciare Token
description:
  Brucia token da un token account e riduci l'offerta totale del mint.
...
## Cosa Fa la Bruciatura?

La bruciatura di token riduce permanentemente il saldo di un token account e
diminuisce l'offerta totale del mint dello stesso importo.

## Come Bruciare Token

La bruciatura di token utilizza l'istruzione _rs`Burn`_ o _rs`BurnChecked`_ del
Token Program.
...
prevista del token prima della bruciatura.

Il [native mint](/docs/tokens/basics/sync-native) non supporta la bruciatura.
...
autorizzare la bruciatura se il mint ha abilitato l'estensione permanent
delegate.
...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| _rs`Mint`_         | Lo stato del mint memorizza l'offerta totale di token.                                                                                                                          | [Sorgente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L13-L30)         | [Sorgente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L25-L42)         |
| _rs`Account`_      | Lo stato del token account memorizza il saldo dei token ridotto da una bruciatura.                                                                                              | [Sorgente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Sorgente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Burn`_         | Un'istruzione di bruciatura che riduce il saldo di un token account e l'offerta del mint senza richiedere al chiamante di fornire i decimali del mint.                          | [Sorgente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L178-L196) | [Sorgente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L221-L239) |
| _rs`BurnChecked`_  | Un'istruzione di bruciatura che richiede al chiamante di fornire i decimali del mint e verifica tale valore prima di ridurre il saldo di un token account e l'offerta del mint. | [Sorgente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L326-L350) | [Sorgente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L393-L417) |
| _rs`process_burn`_ | Logica di elaborazione condivisa per le bruciature di token.                                                                                                                    | [Sorgente](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L586-L668)     | [Sorgente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L1070-L1194)   |
