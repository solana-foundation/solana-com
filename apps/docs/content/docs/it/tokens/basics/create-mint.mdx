...
Un mint account rappresenta in modo univoco un token su Solana e memorizza i
...
## Passi Successivi: Aggiungere i Metadati

Un mint account memorizza solo le informazioni di base del token (offerta,
...
## Come Aggiungere Metadata

Un mint account memorizza solo le informazioni base del token (supply, decimali,
autorità). Per aggiungere metadata leggibili come nome, simbolo e immagine al
tuo token, hai due opzioni:

<Cards>
  <Card title="Metaplex Token Metadata" href="/docs/tokens/metaplex">
   Aggiungi metadata utilizzando il Metaplex Token Metadata Program. Funziona sia con il Token Program originale che con Token-2022.
  </Card>

  <Card title="Token Extensions Metadata" href="/docs/tokens/extensions/metadata">
   Utilizza l'estensione metadata integrata con Token-2022. 
   L'estensione metadata è disponibile solo per i mint account creati con Token-2022.
   Per aggiungere metadata ai mint account creati con il Token Program originale, utilizza il Metaplex Token Metadata Program.
  </Card>
</Cards>
