...
<Cards>
  ...
  <Card title="Token Extensions Metadata" href="/docs/tokens/extensions/metadata">
   Utilizza l'estensione metadati integrata con Token-2022. 
   L'estensione metadati è disponibile solo per mint account creati con Token-2022.
   Per aggiungere metadati a mint account creati con il Token Program originale, utilizza il Metaplex Token Metadata Program.
  </Card>
</Cards>
