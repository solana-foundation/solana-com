...
description:
  Modifica o revoca ruoli di autorità su un mint account o token account,
  incluse le autorità di mint, freeze, owner e close.
...
L'impostazione dell'autorità modifica o revoca specifici ruoli di autorità su un
mint account o token account.

I mint account possono memorizzare un'autorità di mint e un'autorità di freeze.
I token account memorizzano un owner e possono opzionalmente memorizzare
un'autorità di close. Ogni ruolo controlla un insieme specifico di permessi, e
impostare un'autorità a _rs`None`_ rimuove permanentemente il ruolo di autorità
selezionato.
...
sono inclusi a scopo di riferimento.
