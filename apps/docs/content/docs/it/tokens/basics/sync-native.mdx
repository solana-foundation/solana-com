...
sincronizza il saldo di un token account wrapped SOL (WSOL) con il SOL nativo
(lamports) effettivamente memorizzato in esso. Quando trasferisci SOL nativo a
