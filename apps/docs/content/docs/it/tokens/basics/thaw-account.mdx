...
Dopo che lo sblocco ha successo, l'account può trasferire, bruciare e chiudere
token nuovamente. Solo l'autorità di congelamento del mint può sbloccare i token
account.
