...
description:
  Autorizza un altro indirizzo a trasferire o bruciare una quantità limitata di
  token da un token account.
...
## Cosa Fa l'Approvazione di un Delegato?

L'approvazione di un delegato consente a un altro indirizzo di trasferire o
bruciare una quantità limitata di token da un token account per conto del
proprietario del token account.

Un token account memorizza un delegato corrente e un importo delegato alla
volta. L'approvazione di un nuovo delegato sostituisce il delegato precedente e
l'importo consentito sull'account.

## Come Approvare un Delegato

L'approvazione di un delegato utilizza l'istruzione _rs`Approve`_ o
_rs`ApproveChecked`_ del Token Program.

Gli esempi seguenti utilizzano _rs`ApproveChecked`_, che richiede al chiamante
di fornire il mint e i decimali in modo che l'istruzione possa verificare il
mint previsto e la precisione del token prima di elaborare l'approvazione.

Il proprietario del token account firma l'approvazione.

### Riferimento al Codice Sorgente

| Elemento              | Descrizione                                                                                                                                                                         | Token Program                                                                                                    | Token Extensions Program                                                                                               |
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| _rs`Account`_         | Lo stato del token account memorizza il proprietario, il delegato e l'importo delegato.                                                                                             | [Sorgente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L84-L108)        | [Sorgente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L99-L123)        |
| _rs`Approve`_         | Un'istruzione di approvazione del delegato che registra il delegato e l'importo consentito per un token account senza richiedere al chiamante di fornire il mint o i decimali.      | [Sorgente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L109-L127) | [Sorgente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L150-L168) |
| _rs`ApproveChecked`_  | Un'istruzione di approvazione del delegato che richiede al chiamante di fornire il mint e i decimali e verifica tali valori prima di registrare il delegato e l'importo consentito. | [Sorgente](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/instruction.rs#L274-L300) | [Sorgente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/instruction.rs#L340-L366) |
| _rs`process_approve`_ | Logica condivisa del processore per l'approvazione del delegato.                                                                                                                    | [Sorgente](https://github.com/solana-program/token/blob/program%40v9.0.0/program/src/processor.rs#L344-L392)     | [Sorgente](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/program/src/processor.rs#L582-L640)     |
