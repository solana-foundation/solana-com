...
specifico account token. Una volta congelato, l'account non può inviare token,
ricevere token o essere chiuso finché non viene scongelato. Solo l'autorità di
congelamento del mint del token può congelare gli account. Se l'autorità di
congelamento viene revocata (impostata a null) sull'account mint, i token non
