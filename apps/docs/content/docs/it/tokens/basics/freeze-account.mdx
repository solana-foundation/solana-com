...
impedisce tutti i trasferimenti di token o la distruzione di token da uno
specifico account token. Una volta congelato, l'account non può inviare né
ricevere token finché non viene scongelato. Un account congelato può comunque
essere chiuso se ha un saldo token pari a zero. Solo l'autorità di congelamento
del mint del token può congelare gli account. Se l'autorità di congelamento
viene revocata (impostata su null) sull'account mint, i token non potranno mai
essere congelati.
