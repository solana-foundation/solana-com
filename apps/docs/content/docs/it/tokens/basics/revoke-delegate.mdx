...
Per il Token Program, solo il proprietario del token account può revocare un
delegato. Per il Token Extension Program, il proprietario del token account e il
delegato corrente possono revocare la delega.
