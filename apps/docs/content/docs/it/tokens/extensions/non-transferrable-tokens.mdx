...
impedisce il trasferimento dei token tra token account dopo il minting. Una
volta mintati, i token rimangono permanentemente nel token account. Tuttavia, il
proprietario del token account può comunque bruciare i token e chiudere il token
