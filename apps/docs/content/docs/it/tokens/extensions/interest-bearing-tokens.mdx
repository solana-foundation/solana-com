...
description:
  Crea un mint del Token Extensions Program con un tasso di interesse onchain, aggiorna quel tasso e converti gli importi dei token in un importo UI con interesse.
