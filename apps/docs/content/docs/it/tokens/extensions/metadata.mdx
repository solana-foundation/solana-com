...
permette a un mint account di specificare l'indirizzo del proprio account di
metadati. Questo puntatore può fare riferimento a qualsiasi account di proprietà
di un programma che implementa la
[Token Metadata Interface](https://github.com/solana-program/token-metadata/tree/main),
offrendo flessibilità nella posizione di archiviazione dei metadati.
