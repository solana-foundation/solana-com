...
1. Crea un mint account con l'estensione per il trasferimento riservato.
2. Crea token account con l'estensione per il trasferimento riservato per il
...
| _rs`UpdateMint`_                    | Aggiorna le impostazioni di trasferimento riservato per un mint account.                                                                                                        |
...
| _rs`ConfigureAccountWithRegistry`_  | Metodo alternativo per configurare i token account per i trasferimenti riservati utilizzando un account _rs`ElGamalRegistry`_ anziché la prova _rs`VerifyPubkeyValidity`_.      |
