...
1. Crea
   ...
   **Equality Proof
   ...
   Verifica che il nuovo ciphertext del saldo disponibile dopo il trasferimento
   corrisponda al suo
   [Pedersen commitment](https://en.wikipedia.org/wiki/Commitment_scheme)
   corrispondente, garantendo che il nuovo saldo disponibile dell'account
   sorgente sia calcolato correttamente come
