...
Il seguente esempio preleva i token dal saldo disponibile riservato riportandoli
al saldo pubblico. L'account deve essere già configurato per i trasferimenti
riservati e disporre di un saldo riservato disponibile.
...
un payer finanziato, e sostituisci i segnaposto con il tuo mint e token account.
