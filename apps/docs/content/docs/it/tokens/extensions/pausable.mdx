---
title: Pausable mint
description: Scopri come abilitare la PausableMintExtension.
---

## Come abilitare la PausableExtension
...
consente a un'autorità di pausa designata di interrompere tutte le attività dei
token su un mint. L'autorità di pausa può mettere in pausa o riattivare il mint
in qualsiasi momento.

Quando è in pausa, il programma Token-2022 rifiuta tutti i trasferimenti, i mint
e i burn per quel token. Quando viene riattivato, le operazioni normali
riprendono.

Questo è un pattern comune sia nei sistemi di token blockchain che nella finanza
tradizionale, dove la capacità di bloccare l'attività è necessaria per
conformità, risposta agli incidenti o controllo amministrativo.
