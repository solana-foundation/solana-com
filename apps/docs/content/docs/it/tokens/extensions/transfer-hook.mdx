...
l'[interfaccia Transfer Hook](https://github.com/solana-program/token-2022/tree/main/interface/src/extension/transfer_hook)
...
[istruzioni](https://github.com/solana-program/token-2022/blob/main/interface/src/extension/transfer_hook/instruction.rs):
