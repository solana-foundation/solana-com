...
abilita la raccolta automatica delle commissioni su ogni trasferimento di token.
Le commissioni si accumulano negli account token del destinatario e possono
essere prelevate dall'autorità di prelievo impostata sull' account mint.
