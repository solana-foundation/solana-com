...
- **Dashboard in tempo reale**: Combina i watcher (saldi, account, firme) con la
  tua libreria UI preferita; il client gestisce il fan-out dei websocket e
...
- **Bridge verso gli hook React**: Passa un'istanza client configurata a
...
- **Testabilità**: L'interfaccia del client singolo può essere simulata nei test
  unitari, rendendo semplice simulare risposte RPC o sessioni wallet senza un
