...
seoTitle: Integrazione del wallet Solana con Next.js e Solana Kit
description:
...
del wallet Solana in un'applicazione Next.js utilizzando `@solana/kit`. Creerai
...
- [Documentazione di Solana Kit](https://www.solanakit.com/docs)
- [Repository GitHub di Solana Kit](https://github.com/anza-xyz/kit)
...
componenti dell'interfaccia utente e installa le dipendenze Solana necessarie.
...
## !!steps 1. Crea il contesto Solana
...
<Callout type="info">
  ...
  devnet e [finanziato con SOL devnet](https://faucet.solana.com/) per inviare
  transazioni.
</Callout>
