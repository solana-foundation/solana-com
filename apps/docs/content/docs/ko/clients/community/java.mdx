...
title: Java SDK
description:
  Java SDK(sava-software/sava)를 사용하여 Solana와 상호작용하는 방법을 알아보세요.
h1: Solana용 Java SDK
---

[Sava Engineering](https://sava.software/welcome)에서 개발한
[Java SDK](https://sava.engineering/)는 Solana와 상호작용하기 위한 대부분의
기능을 지원합니다. Solana 프로그램에 Anchor를 사용하고 있다면,
[anchor-src-gen](https://github.com/sava-software/anchor-src-gen)을 idl과 함께
...
Solana에서 이 Java SDK를 사용하는 방법에 대한 자세한 정보는
