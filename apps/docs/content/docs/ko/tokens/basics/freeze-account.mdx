...
account가 해제될 때까지 토큰 수신, 전송 또는 소각이 방지됩니다.
...
| _rs`AccountState`_                  | _rs`Initialized`_ 및 _rs`Frozen`_ 를 포함한 토큰 계정 상태입니다.           | [소스](https://github.com/solana-program/token/blob/program%40v9.0.0/interface/src/state.rs#L185-L195)       | [소스](https://github.com/solana-program/token-2022/blob/program%40v10.0.0/interface/src/state.rs#L203-L213)       |
