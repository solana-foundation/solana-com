...
title: SPL 토큰 기초
description:
  Solana에서 민트 및 token account 생성, 토큰 잔액, 권한, 래핑된 SOL 관리를 위한
  핵심 Token Program 명령어를 알아보세요.
...
SPL 토큰 기본 섹션에서는 SPL 토큰과 상호작용하기 위한 기본 명령어를 다루며, 기존
Token Program과 Token Extensions Program(Token 2022) 모두에서 공유되는 기능에
중점을 둡니다.
