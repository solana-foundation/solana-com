...
명령어는 현재 승인된 위임자로부터 모든 전송 권한을 제거합니다. 취소 후, 위임자는
더 이상 귀하의 계정에서 토큰을 전송할 수 없습니다. Token Program의 경우, 토큰
계정 소유자만 위임자를 취소할 수 있습니다. Token Extension Program의 경우, 토큰
계정 소유자와 현재 위임자가 위임을 취소할 수 있습니다.
