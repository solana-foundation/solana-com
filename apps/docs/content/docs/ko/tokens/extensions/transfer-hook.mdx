...
이를 구현하기 위해 개발자는 [Transfer Hook 인터페이스](https://github.com/solana-labs/solana-program-library/tree/master/token/transfer-hook/interface)를 구현하는 프로그램을 빌드하고, Transfer Hook 확장이 활성화된 mint account를 초기화해야 합니다.
...
Transfer Hook 인터페이스는 다음 [명령어](https://github.com/solana-labs/solana-program-library/blob/master/token/transfer-hook/interface/src/instruction.rs)를 지정합니다:
