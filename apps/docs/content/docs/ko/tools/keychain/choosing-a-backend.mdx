...
title: 백엔드 선택
description:
  보관 방식, 기존 인프라, 승인 제어, 자체 앱 서명 여부 또는 최종 사용자를 위한 지갑 프로비저닝 여부 등 요구 사항에 맞는 Keychain 서명 백엔드를 선택하세요.
related:
...
### 다자 승인, 기관 수탁, 또는 규정 준수 제어가 필요하신가요?

서명이 생성되기 전에 승인 정책, 지출 한도, 또는 컴플라이언스 워크플로를 통과해야 하거나 — 규제된 수탁자가 키를 보관해야 하는 경우 — **MPC / 기관 수탁** 백엔드를 사용하세요: Fireblocks, Dfns, Para, Utila, 또는 Fordefi. 이들은 키를 분산하거나 수탁하며, 정책에 따라 공동 서명합니다.

요청 시 서명하는 키만 필요하다면 아래로 계속하세요.
...
- **MPC 및 기관 수탁** — 키는 제공업체 전반에 걸쳐 분산되거나 수탁되며, 정책(승인, 한도)에 따라 공동 서명합니다.
  백엔드: **Fireblocks**, **Dfns**, **Para**, **Utila**, **Fordefi**.
...
| Fordefi         | MPC / 기관 수탁  | 정책 제어 기능을 갖춘 기관 수탁 | 네이티브 모드는 자동 브로드캐스트; 블랙박스 모드는 직접 전송 |
