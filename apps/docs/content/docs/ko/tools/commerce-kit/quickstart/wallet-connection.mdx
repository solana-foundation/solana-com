...
`@solana-commerce/connector` 패키지는 [Wallet Standard](https://github.com/wallet-standard/wallet-standard)를 기반으로 구축된 헤드리스 지갑 연결 기능을 제공합니다. 이 패키지는 지갑 검색, 연결 상태 관리, 계정 관리 및 자동 재연결을 처리합니다. 프레임워크에 구애받지 않도록 설계되었으며 React 바인딩이 포함되어 있습니다. Solana Commerce Kit에서 원활하게 사용할 수 있도록 최적화되었으며 [@solana/kit](https://github.com/anza-xyz/kit)와 호환됩니다.
