...
프로그램의 온체인 주소입니다. 프로젝트를 빌드하면 자동으로 업데이트됩니다
...
프로그램을 배포하려면 program account에 SOL이 필요합니다. 필요한 경우 3단계로
진행하기 전에
[지갑에 SOL을 추가](/docs/intro/quick-start#add-sol-to-your-wallet)하세요.
