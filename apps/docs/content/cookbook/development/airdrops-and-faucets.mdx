...
See more:
[`requestAirdrop()`](https://solana-foundation.github.io/solana-web3.js/v1.x/classes/Connection.html#requestairdrop)
...
7. [solanadevnetfaucet.com](https://solanadevnetfaucet.com) - A web faucet with
   its own daily limit, separate from the public RPC airdrop
