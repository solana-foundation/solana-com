...
[getting the token verified through Jupiter Verification](https://developers.jup.ag/docs/tokens/verification)
is recommended.
...
[Helium's Proof of Coverage design](https://github.com/helium/whitepaper)).
...
[liquid restaking](https://docs.fragmetric.xyz/assets/fragsol).

For examples, see [Modular Governance by Helium](https://heliumvote.com/hnt) or
...
There are
[specific resources to help developers make the transition from EVM to SVM](/developers/migrate-to-solana/ethereum).
...
- [Reward Distribution examples](https://github.com/solana-developers/solana-depin-examples)
...
- [Write Sensor data on chain](https://github.com/solana-developers/solana-depin-examples):
...
Access the full
[Solana DePIN examples repo](https://github.com/solana-developers/solana-depin-examples).
