...
[Kora](/docs/products/kora), that can process a transaction for end users only
if it is paid for in a configured token like USDC or USDT.
...
information can be found in the [Kora documentation](/docs/products/kora).
