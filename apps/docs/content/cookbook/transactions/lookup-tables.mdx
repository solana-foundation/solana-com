...
A single lookup table can store up to 256 addresses, and a transaction may
reference more than one table. That storage capacity is separate from how many
addresses a transaction can actually use: the runtime loads at most 64 accounts
per transaction regardless of how many addresses the tables it references hold.
...
[`createLookupTable`](https://solana-foundation.github.io/solana-web3.js/v1.x/classes/AddressLookupTableProgram.html#createlookuptable)
...
[`extendLookupTable`](https://solana-foundation.github.io/solana-web3.js/v1.x/classes/AddressLookupTableProgram.html#extendlookuptable)
method:
...
[`getAddressLookupTable`](https://solana-foundation.github.io/solana-web3.js/v1.x/classes/Connection.html#getaddresslookuptable)
method:
