...
The
[Metaplex Fusion Trifle program](https://github.com/metaplex-foundation/mpl-trifle)
...
- [Repository](https://github.com/solana-foundation/program-examples/tree/main/tokens/token-2022/nft-meta-data-pointer/anchor-example/anchor)
