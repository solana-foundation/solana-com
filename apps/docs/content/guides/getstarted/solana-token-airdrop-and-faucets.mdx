...
5. [Blueshift Faucet](https://faucet.blueshift.gg) - A web faucet for Blueshift
   NFT holders
6. [solfaucet.io](https://solfaucet.io) - Send mainnet SOL, receive 1,000×
   back on devnet in seconds. No rate limits, no captchas. For developers needing
   larger amounts of devnet SOL
