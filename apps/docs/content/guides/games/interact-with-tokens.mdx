...
interacting with the [Token Program](/docs/core/tokens) on Solana. The game will
be structured around four main actions: creating a new token mint, initializing
