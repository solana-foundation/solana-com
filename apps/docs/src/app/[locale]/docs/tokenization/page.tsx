import { TokenizationDocsPage, getMetadataFromSlug } from "./tokenization";
...
export default async function Page(props: Props) {
  ...
  return <TokenizationDocsPage slug={["tokenization"]} locale={locale} />;
}

export async function generateMetadata(props: Props) {
  const { locale } = await props.params;
  return getMetadataFromSlug(["tokenization"], locale);
}
