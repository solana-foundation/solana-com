import { ProductsDocsPage, getMetadataFromSlug } from "./products";
...
export default async function Page(props: Props) {
  ...
  return <ProductsDocsPage slug={["products"]} locale={locale} />;
}

export async function generateMetadata(props: Props) {
  const { locale } = await props.params;
  return getMetadataFromSlug(["products"], locale);
}
