import { InstitutionalDocsPage, getMetadataFromSlug } from "./institutional";
...
export default async function Page(props: Props) {
  ...
  return <InstitutionalDocsPage slug={["institutional"]} locale={locale} />;
}

export async function generateMetadata(props: Props) {
  const { locale } = await props.params;
  return getMetadataFromSlug(["institutional"], locale);
}
