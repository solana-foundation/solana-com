...
export async function GET() {
  const lines: string[] = [
    ...
    "  https://solana.com/docs/tokenization/llms.txt or",
    "  https://solana.com/docs/institutional/llms.txt - prefer these when",
    ...
    "  tokenized assets under /docs/tokenization, issuance by a regulated",
    "  institution under /docs/institutional, and markets and DeFi under",
