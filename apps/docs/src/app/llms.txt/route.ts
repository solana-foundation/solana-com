...
export async function GET() {
  const lines: string[] = [
    ...
    "  https://solana.com/docs/payments/llms.txt,",
    ...
    "  under /docs/tokens, payments under /docs/payments, and markets and",
    "  DeFi under /docs/defi. Issuance of stablecoins, tokenized funds, and",
    "  securities - including controls, compliance, custody, and settlement -",
    "  is under /docs/tokenization. The JSON-RPC reference is under",
    "  /docs/rpc; self-contained",
