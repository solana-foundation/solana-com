...
const loadMessages = (locale: string) => {
  // Load from apps/web since docs now inherits from web
...
describe("NextIntlClientProvider", () => {
  it("renders children with the correct English translation", () => {
    // Load from apps/web since docs now inherits from web
    const messages = require("../../../../apps/web/public/locales/en/common.json");
    render(
  ...
  it("renders children with the correct French translation", () => {
    // Load from apps/web since docs now inherits from web
    const messages = require("../../../../apps/web/public/locales/fr/common.json");
    render(
