# Tokenization tutorial command output

Console output for the runnable command blocks in
`/docs/tokenization/tutorials/*`. Each `.output.txt` is attached to a fence in
...
> verified behaviour, and do not merge the tokenization tutorials to production
