...
export const osl = {
  ...
  profile: {
    ...
    summary:
      "Licensed digital asset exchange providing secure trading, fiat deposits, and custody services.",
    description:
      "OSL offers regulated trading, OTC services, custody, trading APIs, tokenization, and payment infrastructure for individuals and institutions, backed by global compliance coverage.",
    sector: "Exchange",
    type: "Platform",
    links: {
