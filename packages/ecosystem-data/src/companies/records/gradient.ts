...
export const gradient = {
  ...
  "profile": {
    ...
    "summary": "Gradient Network is a decentralized AI infrastructure platform on Solana that enables distributed training, serving, and agentic systems through its Open Intelligence Stack.",
    "description": "Gradient is an AI R&D lab building the Open Intelligence Stack (OIS), a fully decentralized infrastructure on Solana for distributed AI workloads. The network transforms idle devices into compute nodes via a lightweight Chrome extension called Sentry Node, with over 1.6 million active nodes deployed across 190+ countries. Its core protocols enable AI models to run across distributed devices at scale.",
    "sector": "DePIN",
    "type": "Protocol",
    "links": {
