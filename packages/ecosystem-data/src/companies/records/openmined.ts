...
export const openmined = {
  ...
  profile: {
    ...
    summary:
      "OpenMined is a nonprofit, open-source organization building technology that enables access to insights from non-public data without requiring direct access to or centralized copies of that data.",
    description:
