...
export const solflare = {
  ...
  profile: {
    ...
    summary:
      "Solflare is a self-custody wallet for the Solana ecosystem, enabling users to buy, store, stake, swap tokens, and manage NFTs across web, browser extension, and mobile platforms.",
    description:
      "Solflare is a non-custodial wallet built for Solana, available as a web wallet, Chrome extension, and mobile app on iOS and Android. It supports buying, storing, staking, and swapping tokens as well as managing NFTs. Solflare integrates with hardware wallets like Ledger and Keystone for offline key management and features a built-in privacy layer with Private Send functionality.",
    sector: "Wallet",
    type: "Platform",
    links: {
