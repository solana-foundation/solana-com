...
export const coinbase = {
  ...
  "profile": {
    ...
    "summary": "Coinbase is a publicly traded cryptocurrency exchange that provides a platform for buying, selling, storing, and managing digital assets including Solana and SPL tokens.",
    "description": "Coinbase is one of the largest regulated cryptocurrency exchanges, offering trading, custody, and staking services for a wide range of digital assets. The platform provides full Solana ecosystem support including native DEX trading via Jupiter integration, cbBTC on Solana, and Coinbase Wallet compatibility with SPL tokens and Solana dApps. The company is publicly traded on NASDAQ under ticker COIN.",
    "sector": "Exchange",
    "type": "Company",
    "links": {
