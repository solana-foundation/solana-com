...
export const darkresearch = {
  ...
  profile: {
    ...
    summary:
      "Dark Research is an applied AI lab building production applications at the intersection of blockchain infrastructure and artificial intelligence, with tools for Solana.",
    description:
      "Dark Research is a technology company focused on closing the gap between frontier technology and human cognition through production applications. The company operates at the intersection of blockchain infrastructure and artificial intelligence, building tools including Model Context Protocol servers for interacting with the Solana blockchain powered by the Solana Agent Kit.",
