...
export const walletData = [
  ...
  },
  {
    ...
    body: "Self-custody wallet and exchange for Solana, Ethereum, and BTC, with mobile apps, a browser extension, SOL staking, hardware wallet import, and multisig support",
    website: "https://backpack.app/",
    additionalInfo:
      "Non-Custodial - Buy Crypto - Sell Crypto - Hold NFTs - Staking - Open Source - Hardware - Multisig",
    icon: backpackIcon,
    custodial: false,
    non_custodial: true,
    te: false,
  ...
  },
  {
    ...
    solana_native: true,
    last_verified: "2026-07-14",
    body: "Solana self-custody wallet for trading, staking SOL, managing tokens and NFTs, and pairing the Solflare Shield hardware card with mobile and browser-extension apps",
    website: "https://www.solflare.com/",
    additionalInfo:
      "Non-Custodial - Buy Crypto - Hold NFTs - Staking - Open Source - Hardware",
    icon: solflareIcon,
    custodial: false,
    non_custodial: true,
    te: false,
  ...
  },
  {
    ...
    solana_native: true,
    last_verified: "2026-07-14",
    body: "Solana link wallet for sending SOL, SPL tokens, NFTs, and SFTs through shareable URLs, with Gmail or wallet-based claiming and Solana Pay checkout use cases",
    website: "https://tiplink.io/",
    additionalInfo: "Non-Custodial - Solana Pay - Hold NFTs",
    icon: tiplinkIcon,
    custodial: false,
    non_custodial: true,
    te: false,
  ...
  },
  {
    ...
    solana_native: false,
    last_verified: "2026-07-14",
    body: "Multi-chain self-custody wallet available as mobile apps and browser extensions, with buying, selling, staking, swaps, and NFT support",
  ...
  },
  {
    ...
    additionalInfo: "Non-Custodial - Hold NFTs - Staking",
    icon: glowIcon,
    custodial: false,
    non_custodial: true,
    te: false,
  ...
  },
  {
    ...
    solana_native: true,
    last_verified: "2026-07-14",
    body: "Non-custodial wallet for USDC payments, payment links, local-currency transfers, cash pickup, and Visa card spending",
    website: "https://www.decaf.so/",
    additionalInfo: "Non-Custodial - Buy Crypto - Sell Crypto",
    icon: decafIcon,
    custodial: false,
    non_custodial: true,
    te: false,
