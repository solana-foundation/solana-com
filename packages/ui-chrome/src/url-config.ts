...
const APP_INTERNAL_ROUTES: Record<string, RegExp> = {
  // docs app handles: /docs/*, /learn/*, /data, /developers, /developers/cookbook/*, /developers/guides/*, /developers/bootcamp/*
  docs: /^\/(?:docs|learn|data)(?:\/|$)|^\/developers(?:$|\/(?:cookbook|guides|bootcamp)(?:\/|$))/,
  media: /^\/(?:news|podcasts)(?:\/|$)/,
