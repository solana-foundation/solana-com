...
ENGLISH_EXTRAS = {
    ...
    "Learn": [
        ...
        ("A Poker Player's Guide to Crypto Trading on Solana", "poker-players-guide-to-crypto", "An introduction to crypto trading for poker players, built around skills you already have."),
