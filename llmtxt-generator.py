...
CURATED_SECTIONS = {
    ...
    "Institutional Finance": [
        ("Institutional Finance on Solana", "docs/institutional", "What a regulated institution needs to know to issue a token"),
        ("Choosing Token Controls", "docs/institutional/token-design/choosing-controls", "Pick between frozen-by-default, Token ACL, and transfer hooks"),
        ("Program and Authority Design", "docs/institutional/token-design/program-and-authority-design", "Choose a token program and the shape of every authority"),
        ("Attestation-Based Compliance", "docs/institutional/compliance-and-privacy/attestation-based-compliance", "Prove KYC and sanctions checks without putting personal data onchain"),
        ("Privacy and Transfer Controls", "docs/institutional/compliance-and-privacy/privacy-and-transfer-controls", "What Confidential Balances hide and which controls still work"),
        ("Deployment Decision Guide", "docs/institutional/architecture/deployment-decision-guide", "Mainnet, Confidential Balances, privacy tooling, Private Channels, or an SPE"),
        ("Settlement Topologies", "docs/institutional/architecture/settlement-topologies", "Channel settlement, netting, and the parts that are unresolved"),
        ...
        ("Institutional Tutorials", "docs/institutional/tutorials", "Build a gated mint, then take the custodian and vault sides of it"),
        ...
        ("Enabling Settlement as a Custodian", "docs/institutional/tutorials/custodian", "Hold a gated token as a custodian and reconcile at a stated commitment"),
        ("Deploying a Vault", "docs/institutional/tutorials/vault", "Prepare an asset-manager vault to hold a gated token"),
        ("Settlement and Finality", "docs/institutional/settlement-finality", "What processed, confirmed, and finalized mean and which to trust"),
        ("Risk and Diligence", "docs/institutional/risk-and-diligence", "The questions a risk, legal, or compliance reviewer asks about Solana"),
        ("Institutional Resources", "docs/institutional/resources", "Issuance tooling, live network data, and where to take questions"),
    ],
    "Frontend": [
